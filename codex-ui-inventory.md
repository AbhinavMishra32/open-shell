...
| Opaline package | File tree | `packages/ui/src/file-tree/FileTree.tsx` | high | Current package version keeps Codex tree data attributes, selected rows, git/action lanes, `Filter files…` search wrapper, and core icon sprite. |

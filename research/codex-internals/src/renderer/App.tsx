...
const fileTreeItems = [
  {
    name: "codex-same-ui-electron",
    path: "codex-same-ui-electron",
    type: "directory" as const,
    children: [
      {
        name: "src",
        path: "codex-same-ui-electron/src",
        type: "directory" as const,
        children: [
          {
            name: "lib",
            path: "codex-same-ui-electron/src/lib",
            type: "directory" as const,
            children: [
              { name: "Dialog.tsx", path: "src/lib/codex-ui/primitives/Dialog.tsx", gitStatus: "added" as const },
              {
                name: "BottomPanel.tsx",
                path: "src/lib/codex-ui/bottom-panel/BottomPanel.tsx",
                gitStatus: "added" as const,
              },
              { name: "FileTree.tsx", path: "src/lib/codex-ui/file-tree/FileTree.tsx", gitStatus: "added" as const },
            ],
          },
          { name: "renderer", path: "codex-same-ui-electron/src/renderer", type: "directory" as const },
        ],
      },
      { name: "package.json", path: "codex-same-ui-electron/package.json", gitStatus: "modified" as const },
    ],
  },
];
...
~/solin/general/desktop-agent-app/codex-same-ui-electron main

...
import { A as t, lt as n, u as r, v as i } from "./vscode-api-sUstfl-x.js";
import { i as a, t as o } from "./use-is-plugins-enabled-DudZfU21.js";
import { _ as s, a as c, d as l } from "./use-plugins-BKOuT9XR.js";
var u = n(),
  d = [`plugins`, `detail`];
function f(n) {
  let d = (0, u.c)(31),
    { hostId: f, marketplacePath: h, pluginName: _, remoteMarketplaceName: v, enabled: y } = n,
    b = y === void 0 ? !0 : y,
    x = f ?? `local`,
    S;
  ...
  d[7] !== x || d[8] !== h || d[9] !== _ || d[10] !== v
    ? ((M = m({ hostId: x, marketplacePath: h, pluginName: _, remoteMarketplaceName: v })),
      (d[7] = x),
      (d[8] = h),
      (d[9] = _),
      (d[10] = v),
  ...
  d[12] !== x || d[13] !== h || d[14] !== _ || d[15] !== w || d[16] !== v
    ? ((N = async () => {
        ...
        return g(t, { composerIconDataUrl: a, logoDataUrl: o, skillImageDataUrls: l });
      }),
      (d[12] = x),
      (d[13] = h),
      (d[14] = _),
  ...
  return (
    d[26] !== F.isLoading || d[27] !== R || d[28] !== I || d[29] !== L
      ? ((z = { errorMessage: I, isLoading: F.isLoading, plugin: L, refetch: R }),
        (d[26] = F.isLoading),
        (d[27] = R),
        (d[28] = I),
        (d[29] = L),
...
async function p() {}
function m({ hostId: e, marketplacePath: t, pluginName: n, remoteMarketplaceName: r }) {
  return [...d, e, t ?? ``, r ?? ``, n ?? ``];
}
function h(e) {
  return d.every((t, n) => e[n] === t);
}
function g(e, { logoDataUrl: t, composerIconDataUrl: n, skillImageDataUrls: r }) {
...
//# sourceMappingURL=plugin-detail-queries-nEDuNCez.js.map

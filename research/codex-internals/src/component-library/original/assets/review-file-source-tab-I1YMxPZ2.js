...
var ir = `codex-thread-find-match`,
  ar = `codex-thread-find-active`,
  or = `data-content-search-match-id`,
  sr = `codex-thread-find-shadow-style`,
  cr = `
...
function Wi(e) {
  ...
  t[21] !== d || t[22] !== l
    ? ((te = function (e) {
        e.preventDefault();
        let t = !d;
        (l.set(St, t), t && Re(l, { eventName: `codex_file_viewer_git_blame_enabled` }), h(!1));
      }),
      (t[21] = d),
      (t[22] = l),
      (t[23] = te))

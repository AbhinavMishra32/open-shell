...
var t = e({
  ...
  n = {
    customConfig: `settings-search-custom-config`,
    approvalPolicy: `settings-search-approval-policy`,
    sandboxSettings: `settings-search-sandbox-settings`,
  },
  r = e({
    configToml: {
      id: `settings.search.customConfig.configTomlTerm`,
      defaultMessage: `config.toml`,
      description: `Settings search term for custom config settings`,
    },
  }),
  i = [
    {
      ...
      sectionSlug: `agent`,
      targetId: n.customConfig,
      terms: [r.configToml, t.projectConfig, t.globalConfig, t.userConfig, t.adminConfig],
    },
    {
      label: t.approvalPolicy,
      sectionSlug: `agent`,
      targetId: n.approvalPolicy,
      terms: [t.untrusted, t.onFailure, t.onRequest, t.never],
    },
    {
      label: t.sandboxSettings,
      sectionSlug: `agent`,
      targetId: n.sandboxSettings,
      terms: [t.readOnly, t.workspaceWrite, t.fullAccess],
    },
  ];
export { n, t as r, i as t };
//# sourceMappingURL=agent-settings.search-BHnlJV-P.js.map

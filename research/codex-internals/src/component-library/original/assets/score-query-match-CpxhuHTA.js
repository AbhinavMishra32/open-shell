var e = 100,
  ...
  a = class {
    ...
    matchingDegree(e) {
      let n = this.mainMatcher.match(e);
      if (n != null) return p(this.mainMatcher.matchingDegree(e, !1, n), n);
      if (this.fallbackMatcher == null) return t;
      let r = this.fallbackMatcher.match(e);
      return r == null ? t : p(this.fallbackMatcher.matchingDegree(e, !1, r), r);
    }
  },
  o = class {
    myPattern;
    ...
    matchingDegree(e, n = !1, r = this.match(e)) {
      if (r == null) return t;
      ...
      for (let t of r)
        for (let n = t.startOffset; n < t.endOffset; n += 1) {
          let r = n === t.startOffset && t !== i,
            a = !1;
          for (; u <= n; ) (u === n ? (a = !0) : r && (l += 1), (u = h(e, u)));
          let f = e[n];
          if (((c = v(this.myPattern, f, c + 1, this.myPattern.length, !0)), c < 0)) break;
          (a && (d = f === this.myPattern[c] && this.isUpperCase[c]),
            (s += this.evaluateCaseMatching(o, c, d, n, r, a, f)));
        }
      let f = i.startOffset,
        p = b(e, this.hardSeparators, 0, f) >= 0,
        m = f === 0 || (_(e, f) && !_(e, f - 1)),
        g = r[r.length - 1].endOffset === e.length;
      return (m ? 1e3 : 0) + s - r.length + -l * 10 + (p ? 0 : 2) + (a ? 1 : 0) + (g ? 1 : 0);
    }
    match(t) {
      if (t.length < this.minNameLength) return null;
      if (this.myPattern.length > e) return this.matchBySubstring(t);
      let n = 0;
      for (let e = 0; e < t.length && n < this.meaningfulCharacters.length; e += 1) {
        let r = t[e];
        (r === this.meaningfulCharacters[n] || r === this.meaningfulCharacters[n + 1]) && (n += 2);
      }
      if (n < this.minNameLength * 2) return null;
      let r = this.matchWildcards(t, 0, 0);
      return r == null ? null : r.reverse();
    }
    ...
    matchBySubstring(e) {
      ...
      if (t) {
        let t = S(e, n, 0, e.length);
        return t >= 0 ? [{ startOffset: t, endOffset: t + n.length }] : null;
      }
      return C(e, 0, n.length, n) ? [{ startOffset: 0, endOffset: n.length }] : null;
    }
    ...
    isUpperCaseOrDigit(e) {
      return this.isUpperCase[e] || k(this.myPattern[e]);
    }
    ...
    checkForSpecialChars(e, t, n, r) {
      return n < 0 ||
        ...
        (this.hasDots && !this.isPatternChar(r - 1, `.`) && x(e, `.`, t, n) !== -1)
        ? -1
        : n;
    }
    seemsLikeFragmentStart(e, t, n) {
      return !this.isUpperCase[t] || D(e[n]) || _(e, n)
        ? !0
    ...
    isSkippingDigitBetweenPatternDigits(e, t) {
      return k(this.myPattern[e]) && k(this.myPattern[e - 1]) && k(t);
    }
    matchInsideFragment(e, t, n, r) {
      let i = this.isMiddleMatch(e, t, n) ? 3 : 1;
      return this.improveCamelHumps(e, t, n, r, i) ?? this.findLongestMatchingPrefix(e, t, n, r, i);
    }
    isMiddleMatch(e, t, n) {
      return !this.isPatternChar(t - 1, `*`) || this.isWildcard(t + 1) || !A(e[n]) ? !1 : !_(e, n);
    }
    ...
    isWildcard(e) {
      return e >= 0 && e < this.myPattern.length && y(this.myPattern[e]);
    }
    isPatternChar(e, t) {
...
function c(e) {
  let t = f(e),
    ...
    i = u(e);
  return new a(
    new o(n, `IGNORE_CASE`, r.join(``)),
    t && e !== i ? new o(i, `IGNORE_CASE`, r.join(``)) : null,
  );
}
function l(e) {
  let t = `*${e}`;
  for (let e of r) t = t.split(e).join(`*${n}*`);
  return t;
}
function u(e) {
  let t = -1;
...
function p(e, t) {
  return t.length === 0 ? e : t[0].startOffset === 0 ? e + i : e;
}
function m(e) {
  return (
    e.trim().length === 0 ||
...
function h(e, t) {
  return t < e.length && k(e[t]) ? t + 1 : g(e, t);
}
function g(e, t) {
...
export { s as t };
//# sourceMappingURL=score-query-match-CpxhuHTA.js.map

...
import { lt as i, u as a, v as o } from "./vscode-api-sUstfl-x.js";
import { c as s, o as c } from "./lib-MoKmYgcO.js";
import { t as l } from "./queryOptions-CAm1uWNO.js";
import { n as u } from "./rpc-y95ESgjb.js";
import { o as d } from "./statsig-Cajk3UKk.js";
import { d as f } from "./apps-queries-CBUjthvi.js";
import { t as p } from "./tooltip-BhXPONlb.js";
import { _ as m } from "./mention-item-DOPWFNx_.js";
import { t as h } from "./x-DypUcSQe.js";
import { m as g } from "./use-plugins-BKOuT9XR.js";
import { d as _, t as v } from "./use-native-apps.electron-C3QfwGvh.js";
import { n as y } from "./get-file-icon-DafZgplp.js";
import { n as b } from "./use-skills-DK2PGa-B.js";
import { t as x } from "./image-preview-dialog-BBze7Upk.js";
import { t as S } from "./attachment-remove-button-KjSoGked.js";
import { n as C } from "./use-composer-controller-EmBnHezU.js";
import { i as w, t as T } from "./thread-resource-card-C7ERWGgK.js";
function E(e) {
  return (e ?? 140) + 8;
}
var D = i(),
...
function A(e) {
  ...
  if (
    ...
    let e = te({ appName: i, windowTitle: g }),
      o = d ?? ``,
      s;
    t[32] !== a || t[33] !== f || t[34] !== o
      ? ((s = { alt: o, accessibilityText: a, src: f }),
        (t[32] = a),
        (t[33] = f),
        (t[34] = o),
        (t[35] = s))
    ...
    L = h[F] ?? c;
    let x;
    (t[39] === L.accessibilityText
      ? (x = t[40])
      : ((x = L.accessibilityText?.trim() ?? ``), (t[39] = L.accessibilityText), (t[40] = x)),
      (I = x),
      (z = I.length > 0),
      (B = A && z),
      (H = F > 0 ? F - 1 : null),
      (V = F + 1 < h.length ? F + 1 : null));
    let w = m != null && m.length > 0,
      D = p ?? 140,
      O;
    t[41] !== p || t[42] !== b
      ? ((O = b === `composer` ? E(p) : void 0), (t[41] = p), (t[42] = b), (t[43] = O))
      : (O = t[43]);
    let j = O,
      M;
    (t[44] === y
    ...
    t[52] !== b
      ? ((Q =
          b === `thread`
            ? (0, k.jsx)(P, { appIconSrc: n, screenshotAlt: d, screenshotSrc: f })
            : (0, k.jsx)(N, {
                hasTransitionSnapshot: w,
                renderedSnapshotHeight: D,
                transitionSnapshotSrc: m,
              })),
        (t[46] = n),
        (t[47] = w),
      ...
      : (Q = t[53]);
    let re = Q,
      $ = b === `thread` ? `pt-[10px]` : null,
      ie = v ? `cursor-interaction` : `cursor-default`;
    (t[54] !== $ || t[55] !== ie
      ? ((K = r(
      ...
      t[57] === j
        ? (q = t[58])
        : ((q = j == null ? void 0 : { height: j }), (t[57] = j), (t[58] = q)),
      (J = v ? `button` : void 0),
      (Y = v ? e : void 0),
      (X = v ? 0 : void 0),
      t[59] !== R || t[60] !== v
        ? ((Z = v
            ? (e) => {
                (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), R(!0));
              }
            : void 0),
          (t[59] = R),
          (t[60] = v),
  ...
  let $;
  t[72] !== I || t[73] !== B
    ? (($ = B ? (0, k.jsx)(M, { accessibilityText: I }) : void 0),
      (t[72] = I),
      (t[73] = B),
      (t[74] = $))
    : ($ = t[74]);
...
function N(e) {
  let t = (0, D.c)(9),
    { hasTransitionSnapshot: n, renderedSnapshotHeight: r, transitionSnapshotSrc: i } = e,
    a;
...
function P(e) {
  let t = (0, D.c)(17),
    ...
    s;
  t[0] === a ? (s = t[1]) : ((s = ee(a)), (t[0] = a), (t[1] = s));
  let c = s,
    l;
...
function te({ appName: e, windowTitle: t }) {
  let n = t?.trim();
...
function F(e) {
  ...
  let _ = g,
    v = m
      ? `border-token-border inline-flex w-fit max-w-64 flex-shrink-0 items-center gap-2.5 overflow-visible rounded-lg border bg-token-input-background p-1.5 pr-10 text-left shadow-sm`
    ...
    y = (o || p) && `cursor-interaction`,
    b = !o && !p && `cursor-default`,
    x;
  t[13] !== a || t[14] !== v || t[15] !== y || t[16] !== b
    ? ((x = r(`text-token-foreground group relative transition-colors duration-200`, v, y, b, a)),
      (t[13] = a),
      (t[14] = v),
      (t[15] = y),
      (t[16] = b),
  ...
  let S = m
    ...
    C;
  t[18] === S ? (C = t[19]) : ((C = r(`flex-shrink-0`, S)), (t[18] = S), (t[19] = C));
  let w = m ? `size-6` : `icon-2xs`,
    T;
  t[20] === w ? (T = t[21]) : ((T = r(w)), (t[20] = w), (t[21] = T));
  let E;
  t[22] !== n || t[23] !== T
    ? ((E = (0, k.jsx)(n, { className: T })), (t[22] = n), (t[23] = T), (t[24] = E))
    : (E = t[24]);
  let O;
  t[25] !== E || t[26] !== C
    ? ((O = (0, k.jsx)(`div`, { className: C, children: E })),
      (t[25] = E),
      (t[26] = C),
      (t[27] = O))
    : (O = t[27]);
  let A = m
    ...
    j;
  t[28] === A ? (j = t[29]) : ((j = r(`relative min-w-0 flex-1`, A)), (t[28] = A), (t[29] = j));
  let M;
  t[30] !== i || t[31] !== j
    ? ((M = (0, k.jsx)(`div`, { className: j, children: i })),
      (t[30] = i),
      (t[31] = j),
      (t[32] = M))
    : (M = t[32]);
  let N;
  t[33] !== _ || t[34] !== m || t[35] !== s || t[36] !== c
    ? ((N =
        s &&
        (0, k.jsx)(`div`, {
          role: `button`,
          ...
          className: r(
            ...
            m
              ? `absolute top-1 right-1 size-4 rounded-full bg-token-foreground text-token-dropdown-background shadow-sm`
          ...
          "aria-label": c,
          children: (0, k.jsx)(h, {
            className: r(m ? `icon-xxs` : `icon-2xs text-token-foreground`),
          }),
        })),
      (t[33] = _),
      (t[34] = m),
...
function ne(e, t, n) {
  return l({
    ...
    queryFn: () => u.fileAttachments.countFolderFiles({ folderPath: e, hostId: t }),
    staleTime: a.THIRTY_SECONDS,
  });
}
function I(e) {
  let t = (0, D.c)(62),
    ...
    _ = s(),
    v;
  t[0] !== f || t[1] !== h ? ((v = f ?? y(h)), (t[0] = f), (t[1] = h), (t[2] = v)) : (v = t[2]);
  let b = v,
    x;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((x = /[\\/]$/), (t[3] = x)) : (x = t[3]);
  let C;
  t[4] === h ? (C = t[5]) : ((C = x.test(h)), (t[4] = h), (t[5] = C));
  let E = C,
    O,
    A;
  if (
      ...
      if (
        ...
        t[28] === b
          ...
          : ((s = (0, k.jsx)(`span`, {
              ...
              children: (0, k.jsx)(b, { className: `size-6` }),
            })),
            (t[28] = b),
            (t[29] = s));
        let l = o != null,
        ...
        t[30] === n
          ? (f = t[31])
          : ((f = (0, k.jsx)(`span`, { className: `block max-w-32 truncate`, children: n })),
            (t[30] = n),
            (t[31] = f));
        let p =
            m ??
        ...
        t[37] !== o || t[38] !== O
          ? ((g = o
              ? (0, k.jsx)(S, { className: `top-1 right-1 z-20`, ariaLabel: O, onRemove: o })
              : null),
            (t[37] = o),
            (t[38] = O),
            (t[39] = g))
        ...
        (t[44] !== y || t[45] !== a || t[46] !== i
          ? ((x = (0, k.jsx)(L, { folderPath: i, hostId: a, children: y })),
            (t[44] = y),
            (t[45] = a),
            (t[46] = i),
            (t[47] = x))
  ...
  t[48] === n
    ? (j = t[49])
    : ((j = (0, k.jsx)(`span`, { className: `truncate`, children: n })), (t[48] = n), (t[49] = j));
  let M;
  t[50] === d
    ? (M = t[51])
    : ((M = d
  ...
  let P;
  return (
    t[55] !== b || t[56] !== g || t[57] !== u || t[58] !== o || t[59] !== O || t[60] !== N
      ? ((P = (0, k.jsx)(F, {
          Icon: b,
          onClick: u,
          onRemove: o,
...
function L(e) {
  let t = (0, D.c)(14),
    ...
    c;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((c = ne(r, i, a)), (t[0] = r), (t[1] = i), (t[2] = a), (t[3] = c))
    : (c = t[3]);
  let { data: l } = o(c),
    u,
    d,
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = () => s(!1)),
      ...
      (t[6] = f),
      (t[7] = m))
    : ((u = t[4]), (d = t[5]), (f = t[6]), (m = t[7]));
  let h;
  t[8] === l
    ? (h = t[9])
    : ((h = l == null ? null : (0, k.jsx)(R, { count: l })), (t[8] = l), (t[9] = h));
  let g;
  return (
    t[10] !== n || t[11] !== a || t[12] !== h
      ? ((g = (0, k.jsx)(`span`, {
          className: `contents`,
          onBlur: u,
          onFocus: d,
          onPointerEnter: f,
          onPointerLeave: m,
          children: (0, k.jsx)(p, { defaultOpen: a, tooltipContent: h, children: n }),
        })),
        (t[10] = n),
        (t[11] = a),
        (t[12] = h),
...
function V(e, t) {
  return t ? e.replace(/(?:\s+\(\s*\d+(?:-\d+)?\s*\)|\s+\d+(?:-\d+)?)(\s*)$/, ``) : e;
}
function H(e) {
  let t = (0, D.c)(17),
  ...
  let s = f(o),
    c = C(n, U),
    l = a || c,
    { isLoading: u, skills: d } = b(i, r),
    p,
    m;
  (t[2] !== s || t[3] !== n || t[4] !== u || t[5] !== d
    ? ((p = () => {
        u || n.syncMentionMetadata({ skills: d, apps: s });
      }),
      (m = [s, n, u, d]),
      (t[2] = s),
      (t[3] = n),
...
function W(e) {
  ...
  t[0] !== a || t[1] !== f
    ? ((p =
        f && a ? { additionalMarketplaceKinds: [`shared-with-me`] } : { includeRemoteCatalog: a }),
      (t[0] = a),
      (t[1] = f),
      (t[2] = p))
    : (p = t[2]);
  let { availablePlugins: h } = g(i, o, p),
    y;
  t[3] === h ? (y = t[4]) : ((y = _(h)), (t[3] = h), (t[4] = y));
  let b = y != null,
    x;
  t[5] === b ? (x = t[6]) : ((x = { enabled: b }), (t[5] = b), (t[6] = x));
  let { nativeApps: S } = v(x),
    C,
    w;
  return (
    t[7] !== n ||
...
export { A as a, F as i, V as n, E as o, I as r, H as t };
//# sourceMappingURL=mention-metadata-syncer-DyVcG0Pp.js.map

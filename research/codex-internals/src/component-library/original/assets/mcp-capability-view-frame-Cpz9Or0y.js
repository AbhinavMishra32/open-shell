      ...
      switch (r) {
        ...
        case `tools/list`:
          return Y(n.data, async () => {
            let e = await Yn({
              hostId: i,
              mcpServerStatuses: m === `codex_apps` ? u : void 0,
              server: m,
            });
            return {
              tools: er({
...
function rr({ mcpAppScope: e, server: t, uri: n }) {
  if (t === `codex_apps` && (e.originResourceUri == null || n !== e.originResourceUri))
    throw $(`MCP app cannot read resource outside its widget scope: ${n}`, -32603);
}
function ir(e, t) {
  if (e !== `codex_apps` || !ar(t)) return t;
  let n = { ...t };
  return (

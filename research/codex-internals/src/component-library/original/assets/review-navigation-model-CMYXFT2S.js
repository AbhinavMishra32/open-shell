...
function ye({ codexHome: e, cwd: t, gitMetadata: n, hostId: i }) {
  return t == null
    ? { kind: `none`, codexHome: e, cwd: null, git: null, hostId: i, isCodexWorktree: !1 }
    : n == null
      ? { kind: `plain`, codexHome: e, cwd: t, git: null, hostId: i, isCodexWorktree: !1 }
      : {
          kind: `git`,
          codexHome: e,
          cwd: t,
...
var be = re(w, ({ get: e }) =>
  ...
  Se = y(w, ({ get: e }) => {
    ...
    return ye({ codexHome: e(he), cwd: e(E), gitMetadata: t, hostId: e(me) });
  }),
  A = new Map(),
  Ce = 16,
  we = `load-failed`,
...
var I = y(w, ({ get: e, scope: t }) =>
    t.value.routeKind === `remote-thread` ? `cloud` : e(Se).isCodexWorktree ? `worktree` : `local`,
  ),

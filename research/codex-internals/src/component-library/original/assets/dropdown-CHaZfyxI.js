...
import { i as u } from "./Combination-9DfZp13g.js";
import {
  _ as d,
  a as f,
  c as p,
...
import { n as k } from "./window-zoom-context-CSPQZGcc.js";
import { t as A } from "./tooltip-BhXPONlb.js";
import { n as j } from "./tooltip-dismiss-1FVw8OQP.js";
import { t as M } from "./proxy-DktXrBt_.js";
import { t as N } from "./AnimatePresence-DwAfNqj_.js";
import { t as P } from "./chevron-right-BZtXyaBk.js";
import { t as F } from "./animations-Du6t0V8Z.js";
import { t as I } from "./search-mcwajolX.js";
var L = e({
    Arrow: () => Le,
    CheckboxItem: () => Me,
    Content: () => Oe,
  ...
  G = (e) => {
    ...
    return (0, z.jsx)(ee, {
      ...
      modal: s,
      children: (0, z.jsx)(h, { ...c, open: f, onOpenChange: p, dir: r, modal: s, children: n }),
    });
  };
G.displayName = B;
  ...
  J = R.forwardRef((e, t) => {
    ...
    return (0, z.jsx)(v, {
      ...
      onCloseAutoFocus: o(e.onCloseAutoFocus, (e) => {
        (s.current || i.triggerRef.current?.focus(), (s.current = !1), e.preventDefault());
      }),
...
ye.displayName = ve;
var be = (e) => {
    let { __scopeDropdownMenu: t, children: n, open: r, onOpenChange: i, defaultOpen: a } = e,
      o = U(t),
      [s, c] = l({ prop: r, defaultProp: a ?? !1, onChange: i, caller: `DropdownMenuSub` });
...
function Xe(e) {
  ...
  return (
    t[8] !== a || t[9] !== o || t[10] !== s || t[11] !== l
      ? ((u = (0, z.jsx)(Ee, { ref: a, "aria-disabled": s, className: l, ...o })),
        (t[8] = a),
        (t[9] = o),
        (t[10] = s),
        (t[11] = l),
...
var Qe = (e) => {
    ...
    if (!r) {
      ...
      return (
        t[0] === n
          ? (e = t[1])
          : ((e = (0, z.jsx)(z.Fragment, { children: n })), (t[0] = n), (t[1] = e)),
        e
      );
    }
    let d;
    t[2] === o ? (d = t[3]) : ((d = i(`max-w-64 text-pretty`, o)), (t[2] = o), (t[3] = d));
    let f;
    t[4] !== d || t[5] !== r
      ? ((f = (0, z.jsx)(`div`, { className: d, children: r })), (t[4] = d), (t[5] = r), (t[6] = f))
      : (f = t[6]);
    let p = !s,
      m = c ?? `right`,
      h;
...
function tt(e) {
        ...
        a == null
          ? (0, z.jsxs)(`div`, {
              ...
              children: [
                F,
                (0, z.jsx)(`span`, {
                  "data-tooltip-overflow-target": S === `trigger-overflows` ? `` : void 0,
                  className: i(`flex-1 min-w-0`, E ? `whitespace-normal` : `truncate`),
                  children: M,
                }),
                ee,
              ],
              ...
              children: [
                ...
                (0, z.jsxs)(`div`, {
                  ...
                  children: [
                    (0, z.jsx)(`span`, {
                      "data-tooltip-overflow-target": S === `trigger-overflows` ? `` : void 0,
                      className: i(`min-w-0`, E ? `whitespace-normal` : `truncate`),
                      children: M,
                    }),
                    (0, z.jsx)(`span`, {
                      className: i(`min-w-0`, D ? `whitespace-normal` : `truncate`),
                      children: a,
                    }),
                  ],
                }),
  ...
  let G = W,
    ...
    K;
  t[49] !== s || t[50] !== te
    ? ((K = i(`no-drag`, $.itemBase, te, s)), (t[49] = s), (t[50] = te), (t[51] = K))
    : (K = t[51]);
  let ne = c ? void 0 : f,
    q = c ? void 0 : p,
    re = l && `!text-token-foreground focus:!outline-none`,
    J;
  t[52] === re ? (J = t[53]) : ((J = i(re, `flex flex-col`)), (t[52] = re), (t[53] = J));
  let Y;
  t[54] !== O || t[55] !== l || t[56] !== G || t[57] !== J
    ...
    : (Y = t[58]);
  let X;
  t[59] !== c || t[60] !== m || t[61] !== K || t[62] !== ne || t[63] !== q || t[64] !== Y
    ? ((X = (0, z.jsx)(je, {
        asChild: !0,
        className: K,
        onClick: ne,
...
function nt(e) {
  let t = (0, Q.c)(6),
    ...
    s;
  t[0] !== r || t[1] !== o
    ? ((s = i(`inline-flex items-center justify-center leading-none`, o, $.icon, r)),
      (t[0] = r),
      (t[1] = o),
      (t[2] = s))
    : (s = t[2]);
...
function rt(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (a = t[3]))
    : (({ onKeyDown: r, className: n, ...a } = e), (t[0] = e), (t[1] = n), (t[2] = r), (t[3] = a));
  let o;
  t[4] === n
    ? (o = t[5])
    : ((o = i(
  ...
  t[6] === r
    ? (s = t[7])
    : ((s = (e) => {
        if ((e.stopPropagation(), (e.metaKey || e.ctrlKey) && e.key.toLowerCase() === `a`)) {
  ...
  return (
    t[8] !== a || t[9] !== o || t[10] !== s
      ? ((c = (0, z.jsx)(`input`, { className: o, autoFocus: !0, onKeyDown: s, ...a })),
        (t[8] = a),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c))
...
function it(e) {
  ...
  t[0] === e
    ...
    : (({ className: n, inputClassName: r, onKeyDown: a, trailingContent: s, ...o } = e),
      (t[0] = e),
      (t[1] = n),
      (t[2] = r),
      (t[3] = a),
  ...
  t[6] === n
    ? (c = t[7])
    : ((c = i($.content, `px-[var(--padding-row-x)] py-[var(--padding-row-y)]`, n)),
      (t[6] = n),
      (t[7] = c));
  let l;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, z.jsx)(I, { className: `icon-2xs shrink-0 text-token-text-tertiary` })), (t[8] = l))
    : (l = t[8]);
  let u;
  t[9] === r
    ? (u = t[10])
  ...
  t[17] === s
    ? (p = t[18])
    : ((p = s ? (0, z.jsx)(`div`, { className: `shrink-0`, children: s }) : null),
      (t[17] = s),
      (t[18] = p));
  let m;
  return (
...
function ot(e) {
  let t = (0, Q.c)(6),
    ...
    o;
  t[0] !== n || t[1] !== a
    ? ((o = i(`w-full px-[var(--padding-row-x)]`, a, n)), (t[0] = n), (t[1] = a), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, z.jsx)(`div`, { className: `h-[1px] w-full bg-token-menu-border` })), (t[3] = s))
    : (s = t[3]);
  let c;
  return (
    t[4] === o
      ? (c = t[5])
      : ((c = (0, z.jsx)(`div`, { className: o, children: s })), (t[4] = o), (t[5] = c)),
    c
  );
}
function st(e) {
  let t = (0, Q.c)(5),
    ...
    a;
  t[0] === r ? (a = t[1]) : ((a = i($e.sectionLabel, r)), (t[0] = r), (t[1] = a));
  let o;
  return (
    t[2] !== n || t[3] !== a
      ? ((o = (0, z.jsx)(`div`, { className: a, children: n })), (t[2] = n), (t[3] = a), (t[4] = o))
      : (o = t[4]),
    o
  );
}
function ct(e) {
  let t = (0, Q.c)(8),
    ...
    u = s === void 0 ? !1 : s,
    d = l ? `py-2` : `py-3`,
    f = c === `error` ? `text-token-error-foreground` : `text-token-description-foreground`,
  ...
  return (
    t[5] !== n || t[6] !== m
      ? ((h = (0, z.jsx)(`div`, { className: m, children: n })), (t[5] = n), (t[6] = m), (t[7] = h))
      : (h = t[7]),
    h
  );
}
  ...
  let H =
      ...
      (0, z.jsx)(De, {
        ...
        children: (0, z.jsx)(ht.Content, {
          ...
          onEscapeKeyDown: m,
          onAnimationEnd: (e) => {
            e.target !== e.currentTarget || e.currentTarget.dataset.state !== `closed` || h?.();
          },
          surface: T,
          className: i(
            A,
    ...
    U;
  return (
    t[6] !== c || t[7] !== F || t[8] !== I.Root || t[9] !== B || t[10] !== V || t[11] !== H
      ? ((U = (0, z.jsxs)(I.Root, {
          dir: c,
          modal: !1,
          open: B,
...
function ut(e) {
  ...
  if (t[0] !== s || t[1] !== u || t[2] !== n) {
    ...
    t[4] !== s || t[5] !== n.props
      ? ((e = (e) => {
          (n.props.onSelect?.(e),
            !e.defaultPrevented && (e.preventDefault(), e.stopPropagation(), !s && l(dt)));
        }),
        (t[4] = s),
        (t[5] = n.props),
        (t[6] = e))
    ...
    let f;
    t[11] === c ? (f = t[12]) : ((f = (0, z.jsx)(P, { className: c })), (t[11] = c), (t[12] = f));
    let p;
    t[13] !== a || t[14] !== f
      ? ((p = (0, z.jsx)(M.span, {
          "aria-hidden": !0,
    ...
    let m;
    (t[16] !== e || t[17] !== p
      ? ((m = { onSelect: e, rightIcon: p }), (t[16] = e), (t[17] = p), (t[18] = m))
      : (m = t[18]),
  ...
  t[22] === m
    ? (h = t[23])
    : ((h = (0, z.jsx)(N, { initial: !1, children: m })), (t[22] = m), (t[23] = h));
  let g;
  return (
...
function ft(e) {
  ...
  if (
    ...
    let e =
      S === `bare`
        ? i(Z.content, `z-50 m-0 flex min-w-[180px] select-none flex-col overflow-y-auto p-0`)
        : i(
            Z.content,
    ...
    t[29] !== a || t[30] !== n || t[31] !== o || t[32] !== p
      ? ((C =
          ...
          (0, z.jsxs)(`div`, {
            className: $.content,
            children: [
              a ? (0, z.jsx)(a, { className: i(o ?? `icon-xs`, $.icon) }) : null,
              (0, z.jsx)(`span`, { className: `min-w-0 flex-1 truncate`, children: n }),
              (0, z.jsx)(P, {
                className: i(`icon-xs text-token-input-placeholder-foreground`, $.icon),
              }),
            ],
          })),
        (t[29] = a),
    ...
    (t[34] !== x || t[35] !== c || t[36] !== d || t[37] !== C
      ? ((k = (0, z.jsx)(ze, { className: c, disabled: x, onClick: d, children: C })),
        (t[34] = x),
        (t[35] = c),
        (t[36] = d),
        (t[37] = C),
      ...
      (t[21] = O),
      (t[22] = A));
  } else ((w = t[17]), (T = t[18]), (E = t[19]), (D = t[20]), (O = t[21]), (A = t[22]));
  let j = !l,
    M = l ? Ke : Ge,
    N = C === 1 ? void 0 : C,
    F;
  ...
  t[50] === r
    ? (I = t[51])
    : ((I = (0, z.jsx)(`div`, { dir: `ltr`, children: r })), (t[50] = r), (t[51] = I));
  let L;
  ...
  let R;
  t[58] !== T || t[59] !== L
    ? ((R = (0, z.jsx)(T, { children: L })), (t[58] = T), (t[59] = L), (t[60] = R))
    : (R = t[60]);
  let B;
  return (
...
function mt(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, z.jsx)(`div`, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
//# sourceMappingURL=dropdown-CHaZfyxI.js.map

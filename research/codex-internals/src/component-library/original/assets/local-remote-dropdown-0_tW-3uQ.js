...
import { O as B, s as V } from "./codex-api-DRlZt5zW.js";
...
import { n as K, t as he } from "./use-codex-home-zmo5hiIG.js";
...
import { t as Te } from "./codex-C1u5S_iM.js";
...
import { t as vt } from "./use-codex-worktrees-DNG0FQTa.js";
          ...
          children: [
            ...
            (0, Z.jsx)(`div`, {
              ref: (e) => {
                ...
                v(e?.closest(`.codex-dialog`) ?? document.body);
              },
              children: (0, Z.jsx)(Ue, {
                align: `end`,
                contentMaxHeight: `list`,
...
function bn(e) {
  ...
  let ye = D(xe, ve),
    ...
    De = D(s, o),
    { openOperation: Oe } = ut(),
    ke = r(m ? null : c.activeWorkspaceRoot, _e?.codexHome),
    Ae = ye ?? Bn(be, o) ?? (_ ? De : null),
    je = bt({ codexWorktree: ke, operation: Ce, threadHandoff: u }),
    Ne = Ct({
      conversationId: o,
      handoffBranch: Ae,
      handoffDirection: je,
  ...
  t[49] !== j || t[50] !== n || t[51] !== M || t[52] !== a
    ? ((lt = () => {
        (n !== `local` &&
          se(M, { eventName: `codex_composer_runtime_changed`, metadata: { mode: `local` } }),
          a(`local`),
          j());
      }),
      (t[49] = j),
...
function Pn(e) {
  ...
  let C = D(xe, x),
    ...
    j = Ct({
      conversationId: u,
      handoffBranch: re,
      handoffDirection: bt({ codexWorktree: !1, operation: E, threadHandoff: m }),
      operation: T,
      threadHandoff: m,
    }),
...
function Fn(e) {
  ...
  let m = D(xe, p),
    ...
    _ = D(s, i),
    v = bt({
      codexWorktree: r(u ? null : o.activeWorkspaceRoot, f?.codexHome),
      operation: g,
      threadHandoff: l,
    }),
    y;

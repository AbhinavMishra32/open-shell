...
import { i as r } from "./git-current-branch-query-VkU7ix9i.js";
var i = r({
    method: `config-value`,
    getParams: (e) => ({
      key: e.key,
  ...
  o = i.queryByMetadata$,
  s = n();
function c(n, r, i, o, c, l) {
  let u = (0, s.c)(9),
    d = n ?? null,
    f;
  u[0] === l ? (f = u[1]) : ((f = e(l, null)), (u[0] = l), (u[1] = f));
  let p;
  return (
...
//# sourceMappingURL=use-git-config-value-COaBlpXL.js.map

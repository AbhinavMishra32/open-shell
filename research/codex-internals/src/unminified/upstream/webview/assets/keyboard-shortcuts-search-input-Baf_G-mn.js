...
import { o as a } from "./electron-menu-shortcuts-CGQ9azZA.js";
var o = i({
  ...
  s = i({
    ...
    "codex.commandMenuTitle.closeTabOrWindow": {
      id: `codex.commandMenuTitle.closeTabOrWindow`,
      defaultMessage: `Close`,
      description: `Native menu item to close the active tab or window`,
    },
  ...
  c = i({
    ...
    "codex.commandDescription.settings": {
      ...
      defaultMessage: `Open Codex settings`,
    ...
    "codex.commandDescription.openFolder": {
      ...
      defaultMessage: `Add a local project to Codex`,
    ...
    "codex.commandDescription.openBrowserTab": {
      ...
      defaultMessage: `Open a browser tab`,
    ...
    "codex.commandDescription.logOut": {
      ...
      defaultMessage: `Sign out of Codex`,
    ...
    "codex.commandDescription.closeTabOrWindow": {
      id: `codex.commandDescription.closeTabOrWindow`,
      defaultMessage: `Close the active tab or window`,
      description: `Description for the Close shortcut`,
    },
...
function d(
  e,
  {
    isGlobalDictationEnabled: t,
    isHotkeyWindowEnabled: n,
    isProcessManagerEnabled: r,
...
function g(e) {
  ...
  return (
    n[27] !== S || n[28] !== C
      ? ((w = (0, h.jsxs)(`div`, { className: `relative`, children: [S, C] })),
        (n[27] = S),
        (n[28] = C),
        (n[29] = w))
      : (w = n[29]),
...
//# sourceMappingURL=keyboard-shortcuts-search-input-Baf_G-mn.js.map

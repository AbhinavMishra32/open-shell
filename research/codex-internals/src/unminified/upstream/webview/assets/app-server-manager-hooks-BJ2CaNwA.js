...
import { n as m } from "./jsx-runtime-CiQ1k8xo.js";
import {
  A as h,
  F as g,
  I as _,
...
import { p as w } from "./statsig-Cajk3UKk.js";
import { t as T } from "./remote-connection-visibility-CDSfTp_2.js";
import { j as E, k as D } from "./sidebar-signals-B0JkGccK.js";
var O = class {
    constructor(e) {
      this.scope = e;
    }
    ...
    getImplForHostId(e) {
      return this.scope.get(t).includes(e) ? this.scope.get(u, e) : null;
    }
...
function M(e, t) {
  ...
  return t.getAll().filter((t) => {
    let r = t.getHostId();
    if (r === n) return !0;
    let { error: i, state: o } = a(e, r);
    return o === `connected` || i?.code === `login-required`;
  });
}
function N(e) {
  return () => {
...
async function L({ scope: e, appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r }) {
  return (
    await Promise.all(
      M(e, t).map((e) =>
        o(`refresh-recent-conversations-for-host`, { hostId: e.getHostId(), sortKey: r }),
      ),
    ),
...
function R({ scope: e, appServerRegistry: t, sortKey: n, refreshesInFlightHostIds: r }) {
  for (let i of M(e, t)) {
    ...
    i.hasFetchedRecentConversations ||
      r.has(e) ||
      (r.add(e),
      o(`refresh-recent-conversations-for-host`, { hostId: e, sortKey: n })
        .catch((t) => {
          y.warning(`recent_conversations_refresh_failed`, {
...
function V() {
  ...
  return (
    e[2] === r
      ? ((i = e[3]), (a = e[4]))
      : ((i = (e) => r.addRegistryCallback(e)), (a = () => r), (e[2] = r), (e[3] = i), (e[4] = a)),
...
function G(e) {
  let t = (0, k.c)(6),
    ...
    a;
  t[0] !== r || t[1] !== e
    ? ((a = (t) => (e == null ? K : F(r, t))), (t[0] = r), (t[1] = e), (t[2] = a))
    : (a = t[2]);
  let o = a,
    s;
  t[3] !== r || t[4] !== e
...
function X(e) {
  let t = (0, k.c)(23),
    n = g(b),
    r = V(),
    { enabledRemoteHostIdSet: i } = T(),
    a;
  t[0] === i ? (a = t[1]) : ((a = B(i)), (t[0] = i), (t[1] = a));
  let o = a,
    s = v(w, `2413345355`),
    c = _(D),
    l = s ? E : c,
  ...
  (t[3] !== r || t[4] !== o || t[5] !== u || t[6] !== e || t[7] !== n || t[8] !== l
    ? ((p = () => {
        let t = () => {
          ...
          (u.setQueryData(
            [e, l, o],
            I({ appServerRegistry: r, enabledRemoteHostIds: t, sortKey: l }),
          ),
            R({ scope: n, appServerRegistry: r, sortKey: l, refreshesInFlightHostIds: f.current }));
        };
        return (
          t(),
          P({
  ...
  t[11] !== o || t[12] !== e || t[13] !== l
    ? ((y = [e, l, o]), (t[11] = o), (t[12] = e), (t[13] = l), (t[14] = y))
    : (y = t[14]);
  let x;
  t[15] !== r || t[16] !== o || t[17] !== n || t[18] !== l
    ? ((x = async () =>
        L({ scope: n, appServerRegistry: r, enabledRemoteHostIds: z(o), sortKey: l })),
      (t[15] = r),
      (t[16] = o),
      (t[17] = n),
      (t[18] = l),
...
export { U as a, Y as c, H as i, W as n, V as o, q as r, J as s, Q as t };
//# sourceMappingURL=app-server-manager-hooks-BJ2CaNwA.js.map

...
import { ct as t } from "./src-CYrn1fYL.js";
import { Bo as n } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { A as o, F as s, I as c, P as l, h as u, lt as d, s as f } from "./vscode-api-sUstfl-x.js";
import { c as p, o as m, r as h, t as g } from "./lib-MoKmYgcO.js";
import { _, f as v, n as y } from "./chunk-LFPYN7LY-DwFbyqR1.js";
...
import { c as b, t as x, u as S } from "./thread-context-inputs-BUuWvrJW.js";
...
import { t as O } from "./apps-DBd5dYzG.js";
import "./x-DypUcSQe.js";
import "./with-window-DPMmD2K-.js";
import { t as k } from "./folder-DTP6uOAM.js";
import { t as A } from "./settings.cog-CJF3NOGk.js";
import { a as j, d as M, i as N, l as P, n as F } from "./dialog-layout-CCvvb1Vc.js";
import "./_defineProperty-b-BZyUPb.js";
import { f as I } from "./links-DlYWpuc5.js";
import { t as L } from "./chevron-D6hquBJC.js";
import { t as R } from "./warning-y6tKEMlk.js";
import { t as z } from "./get-project-name-DwnDWXn0.js";
import { t as B } from "./building-r_Q_yEQG.js";
import "./sortBy-EVRmvlY9.js";
import "./use-connected-remote-connections-fvh51TCi.js";
import { t as V } from "./banner-CXqIwxfh.js";
import { t as H } from "./toggle-CHrq20xd.js";
import { t as U } from "./regenerate-Co1G5oL3.js";
import { a as W, i as G, r as ee } from "./hooks-settings-queries-BpMbCsRw.js";
import {
  a as te,
  f as ne,
  i as re,
  ...
  r as q,
  u as J,
} from "./hooks-settings-model-BH1RI05v.js";
import { i as oe } from "./settings-shared-BibDzP9i.js";
import { i as se } from "./hooks-settings-route-DvJStOm_.js";
import { t as ce } from "./settings-host-context-MFy9perG.js";
import { t as le } from "./settings-content-layout-sdUwAG0A.js";
import { n as Y } from "./settings-row-DOKTjAF6.js";
import { n as X, t as Z } from "./settings-group-BO3RZzLk.js";
import { t as ue } from "./hooks-Bi5GvUJV.js";
import { i as de, n as fe, r as pe, t as me } from "./hooks-settings-copy-DsWrJ1mr.js";
var Q = d(),
  he = e(r()),
  $ = i();
function ge(e, t) {
...
function ve(e) {
  ...
  if (
    ...
    let e = te(o, n);
    ((v = `border-t border-token-border px-3`), (g = `divide-y-[0.5px] divide-token-border`));
    let f;
    (t[12] !== u ||
    t[13] !== r ||
    t[14] !== l ||
                    ...
                    (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        (0, $.jsx)(`button`, {
                          ...
                          "aria-expanded": f,
                          className: a(
                            `flex min-w-0 flex-1 cursor-interaction appearance-none items-center border-0 bg-transparent py-2 text-left text-sm text-inherit [font:inherit] focus-visible:rounded-md focus-visible:ring-2 focus-visible:ring-token-focus-border focus-visible:outline-none`,
                            o ? `pr-12` : `pr-6`,
                          ),
                          onClick: () => {
                            d(f ? null : e.key);
                        ...
                        o
                          ? (0, $.jsx)(w, {
                              triggerAsChild: !0,
                              tooltipContent: (0, $.jsx)(m, { ...Ce.openConfigFile }),
                              children: (0, $.jsx)(`button`, {
                                type: `button`,
                                "aria-label": l.formatMessage(Ce.openConfigFile),
  ...
  let y;
  t[20] !== g || t[21] !== _
    ? ((y = (0, $.jsx)(`div`, { className: g, children: _ })),
      (t[20] = g),
      (t[21] = _),
      (t[22] = y))
    : (y = t[22]);
  ...
  return (
    t[23] !== v || t[24] !== y
      ? ((b = (0, $.jsx)(`div`, { className: v, children: y })),
        (t[23] = v),
        (t[24] = y),
        (t[25] = b))
      : (b = t[25]),
...
function be(e) {
  ...
  t[1] === n.handlerType
    ? (i = t[2])
    : ((i = (0, $.jsx)(xe, { label: r, children: (0, $.jsx)(Se, { handlerType: n.handlerType }) })),
      (t[1] = n.handlerType),
      (t[2] = i));
  let a;
  t[3] === n.command
...
function xe(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = (0, $.jsx)(`dt`, { className: `text-token-text-secondary`, children: n })),
      (t[0] = n),
      (t[1] = i));
  let a;
  t[2] === r
    ? (a = t[3])
    : ((a = (0, $.jsx)(`dd`, { className: `min-w-0 text-token-text-primary`, children: r })),
      (t[2] = r),
      (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, $.jsxs)($.Fragment, { children: [i, a] })), (t[4] = i), (t[5] = a), (t[6] = o))
      : (o = t[6]),
    o
  );
}
...
function we(e) {
  ...
  t[6] !== g || t[7] !== u
    ? ((y = (0, $.jsx)(j, {
        children: (0, $.jsx)(N, { title: g, subtitle: u, subtitleClassName: `break-all` }),
      })),
      (t[6] = g),
      (t[7] = u),
      (t[8] = y))
...
function Te(e) {
  ...
  if (
    ...
    (t[12] === g
      ? (d = t[13])
      : ((d = g > 0 ? (0, $.jsx)(De, {}) : null), (t[12] = g), (t[13] = d)),
      t[14] !== h || t[15] !== _ || t[16] !== c || t[17] !== p
        ? ((f =
            _ > 0
              ? (0, $.jsx)(Oe, {
                  errors: h,
              ...
              children: e.map((e) =>
                (0, $.jsxs)(
                  `div`,
                  {
                    children: [
                      (0, $.jsx)(Y, {
                        icon: (0, $.jsx)(ue, { className: `icon-xs` }),
                        label: fe(e.eventName, s),
      ...
      (t[10] = f),
      (t[11] = m));
  } else ((d = t[9]), (f = t[10]), (m = t[11]));
  let h;
  return (
    t[19] !== d || t[20] !== f || t[21] !== m
      ? ((h = (0, $.jsxs)($.Fragment, { children: [d, f, m] })),
        (t[19] = d),
        (t[20] = f),
        (t[21] = m),
        (t[22] = h))
...
function Oe(e) {
  let t = (0, Q.c)(18),
    { errors: n, expanded: r, issueCount: i, warnings: o, onToggleExpanded: s } = e,
    c;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(R, { className: `icon-xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = c))
    : (c = t[0]);
  let l;
  t[1] === i
  ...
  t[3] === u
    ? (d = t[4])
    : ((d = a(`icon-2xs shrink-0 transition-transform`, u)), (t[3] = u), (t[4] = d));
  let f;
  t[5] === d ? (f = t[6]) : ((f = (0, $.jsx)(L, { className: d })), (t[5] = d), (t[6] = f));
  let p;
  t[7] !== s || t[8] !== l || t[9] !== f
    ? ((p = (0, $.jsxs)(`button`, {
        type: `button`,
...
function Me(e) {
  ...
  let b = y,
    ...
    O,
    k;
  if (t[2] !== n || t[3] !== r || t[4] !== s || t[5] !== l || t[6] !== d) {
    ((O = n == null || s ? [] : re(n)), (x = []), (S = []), (C = null), (E = null));
    for (let e of O)
      bb0: switch (e.id) {
        case `plugin`:
          C = e;
    ...
    ((D = J(O, d)),
      (k = qe({ entry: D, hostId: r, projectRootLabels: l, selection: d })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = s),
      (t[5] = l),
      ...
      (t[12] = O),
      (t[13] = k));
  } else ((x = t[7]), (S = t[8]), (C = t[9]), (E = t[10]), (D = t[11]), (O = t[12]), (k = t[13]));
  let A = k,
    j;
  t[14] === d ? (j = t[15]) : ((j = d == null ? null : Ve(d.source)), (t[14] = d), (t[15] = j));
  let M = j,
    N = null;
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, $.jsx)(m, {
      ...
      (t[18] = I))
    : (I = t[18]);
  let L = u == null || u.length === 0 || s || c,
    R;
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, $.jsx)(U, { className: `icon-xs` })), (t[19] = R))
    : (R = t[19]);
  let z;
  ...
  let B;
  t[24] !== b || t[25] !== z
    ? ((B = (0, $.jsx)(w, { delayDuration: 0, tooltipContent: b, children: z })),
      (t[24] = b),
      (t[25] = z),
      (t[26] = B))
    : (B = t[26]);
                  ...
                  : (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        x.length > 0
                          ...
                          : null,
                        C == null ? null : (0, $.jsx)(Ie, { section: C, onSelectSourceSection: f }),
                        E == null
                          ? null
                          : (0, $.jsx)(Re, {
                              section: E,
...
function Fe(e) {
  let t = (0, Q.c)(12),
    ...
    a;
  t[0] === r ? (a = t[1]) : ((a = (0, $.jsx)(Z.Header, { title: r })), (t[0] = r), (t[1] = a));
  let o;
  if (t[2] !== i || t[3] !== n) {
    let e;
    (t[5] === i
      ? (e = t[6])
      : ((e = (e) => (0, $.jsx)(ze, { section: e, onSelectSourceSection: i }, e.id)),
        (t[5] = i),
        (t[6] = e)),
      (o = n.map(e)),
      (t[2] = i),
  ...
  let s;
  t[7] === o ? (s = t[8]) : ((s = (0, $.jsx)(Z.Content, { children: o })), (t[7] = o), (t[8] = s));
  let c;
  return (
    t[9] !== a || t[10] !== s
...
function Le(e) {
  ...
  let o = a,
    s;
  t[3] === n.entry ? (s = t[4]) : ((s = K(n.entry)), (t[3] = n.entry), (t[4] = s));
  let c = s,
    l;
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(O, { className: `icon-sm text-token-text-secondary` })), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] === o
    ? (d = t[10])
  ...
  t[11] === n.entry.hooks.length
    ? (f = t[12])
    : ((f = (0, $.jsx)(Ue, { count: n.entry.hooks.length })),
      (t[11] = n.entry.hooks.length),
      (t[12] = f));
  let m;
  t[13] === c ? (m = t[14]) : ((m = (0, $.jsx)(We, { summary: c })), (t[13] = c), (t[14] = m));
  let h;
  t[15] !== d || t[16] !== f || t[17] !== m
    ? ((h = (0, $.jsx)(Y, { icon: u, label: d, description: f, control: m })),
      (t[15] = d),
      (t[16] = f),
      (t[17] = m),
      (t[18] = h))
...
function Re(e) {
  ...
  if (t[1] !== i || t[2] !== r || t[3] !== n.projectEntries) {
    ...
    (t[5] !== i || t[6] !== r
      ? ((e = (e) =>
          (0, $.jsx)(He, { entry: e, projectRootLabels: r, onSelectSourceSection: i }, e.cwd)),
        (t[5] = i),
        (t[6] = r),
        (t[7] = e))
      : (e = t[7]),
...
function ze(e) {
  ...
  t[2] !== r || t[3] !== i
    ...
    : (c = t[4]);
  let l;
  t[5] === i ? (l = t[6]) : ((l = Ve(i)), (t[5] = i), (t[6] = l));
  let u;
  t[7] === i ? (u = t[8]) : ((u = (0, $.jsx)(Be, { source: i })), (t[7] = i), (t[8] = u));
  let d;
  t[9] === a.hooks.length
    ? (d = t[10])
    : ((d = (0, $.jsx)(Ue, { count: a.hooks.length })), (t[9] = a.hooks.length), (t[10] = d));
  let f;
  t[11] === s ? (f = t[12]) : ((f = (0, $.jsx)(We, { summary: s })), (t[11] = s), (t[12] = f));
  let p;
...
function He(e) {
  ...
  let l;
  t[6] !== n.cwd || t[7] !== r
    ? ((l = Ke(n.cwd, r)), (t[6] = n.cwd), (t[7] = r), (t[8] = l))
    : (l = t[8]);
  let u;
  t[9] === l
    ? (u = t[10])
  ...
  t[11] === n.hooks.length
    ? (d = t[12])
    : ((d = (0, $.jsx)(Ue, { count: n.hooks.length })), (t[11] = n.hooks.length), (t[12] = d));
  let f;
  t[13] === o ? (f = t[14]) : ((f = (0, $.jsx)(We, { summary: o })), (t[13] = o), (t[14] = f));
  let p;
...
function We(e) {
  let t = (0, Q.c)(5),
    { summary: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = (0, $.jsx)(Ge, { summary: n })), (t[0] = n), (t[1] = r));
  let i;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(L, { className: `icon-2xs shrink-0 -rotate-90` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Ge(e) {
  ...
  let i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(R, { className: `icon-2xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] !== r || t[2] !== n ? ((a = ge(n, r)), (t[1] = r), (t[2] = n), (t[3] = a)) : (a = t[3]);
  let o;
  return (
    t[4] === a
      ? (o = t[5])
...
function qe({ entry: e, hostId: n, projectRootLabels: r, selection: i }) {
  if (i == null) return null;
  if (i.source === `project`) return Ke(i.projectRoot, r);
  if (i.source === `plugin`) {
    let r = i.pluginId === void 0 ? null : de(i.pluginId);
    if ((r == null && e != null && (r = Je(e.hooks)), r != null)) {
      let e = i.pluginId == null ? null : t({ hostId: n, pluginId: i.pluginId });
      return e == null
        ? (0, $.jsx)(m, {
  ...
  return (0, $.jsx)(Be, { source: i.source });
}
function Je(e) {
  let t = null;
  for (let n of e) {
...
function Ye() {
  let e = (0, Q.c)(55),
    ...
    [a, d] = _(),
    f = o(),
    { selectedHostId: m, setSelectedHostId: h } = ce(),
    g = n(m),
    { data: y } = c(x),
    w = c(b),
    T;
  e[0] === m ? (T = e[1]) : ((T = { hostId: m }), (e[0] = m), (e[1] = T));
  let { data: E, isPending: D } = l(S, T),
    O;
  ...
  if (
    ...
    let t = A ? a.get(`projectRoot`) : null,
      ...
      r = null;
    (m === `local` ? (r = y?.roots?.[0] ?? null) : w?.hostId === m && (r = w.remotePath),
      (j = E == null ? void 0 : Xe(E.roots, [r, t])),
      (M = A
        ? ie({ pluginId: n, source: a.get(`source`), projectRoot: t, projectRoots: j })
        : null),
      (e[4] = y?.roots?.[0]),
      (e[5] = A),
      (e[6] = a),
  ...
  e[15] === h
    ...
    : ((I = (e) => {
      ...
      (e[15] = h),
      (e[16] = I));
  let L = (0, he.useEffectEvent)(I),
    R;
  e[17] !== f || e[18] !== m || e[19] !== k || e[20] !== L
    ? ((R = () => {
        if (k != null && k !== m) {
          L(k);
          return;
        }
        G(f, m, { refetchType: `active` });
      }),
      (e[17] = f),
      (e[18] = m),
      (e[19] = k),
    ...
    : (R = e[21]);
  let z;
  (e[22] !== i.key || e[23] !== f || e[24] !== m || e[25] !== k
    ? ((z = [i.key, f, m, k]), (e[22] = i.key), (e[23] = f), (e[24] = m), (e[25] = k), (e[26] = z))
    : (z = e[26]),
    (0, he.useEffect)(R, z));
  let B = l(W, m),
    V;
  e[27] !== F || e[28] !== r || e[29] !== f || e[30] !== t || e[31] !== m
    ? ((V = () => {
        F.refetch().then(async (e) => {
          e.isSuccess &&
            (await G(f, m, { broadcast: !0, refetchType: `none` }),
            t
              .get(C)
              .success(
                r.formatMessage({
  ...
  let H = V,
    U;
  e[33] !== a || e[34] !== m || e[35] !== d
    ? ((U = (e) => {
        let t = new URLSearchParams(a);
        (se(t, m, e), d(t, { replace: !0 }));
      }),
      (e[33] = a),
      (e[34] = m),
      (e[35] = d),
...
export { Ye as HooksSettings };
//# sourceMappingURL=hooks-settings-CDWLXYuK.js.map

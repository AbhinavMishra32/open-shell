...
import { p as N } from "./codex-api-DRlZt5zW.js";
...
var q = e(c(), 1),
  ...
  Me = f(_, ({ get: e }) => {
    let t = e(J);
    return {
      queryKey: [`codex-app-home-beacon`, t, e(pe).locale],
      enabled: e(Y),
      refetchOnMount: !1,
...
function Qe(e) {
  ...
  t[3] !== r || t[4] !== s || t[5] !== p || t[6] !== c || t[7] !== l || t[8] !== u || t[9] !== f
    ? ((v = () => {
        if (r == null) return;
        (l(!0), E(p, { eventName: `codex_fast_mode_banner_cta_clicked` }));
  ...
  t[16] !== p || t[17] !== c
    ? ((x = () => {
        (E(p, { eventName: `codex_fast_mode_banner_dismissed` }), c(!0));
      }),
      (t[16] = p),
      (t[17] = c),
      (t[18] = x))
...
function et() {
  ...
  (e[2] !== k || e[3] !== t
    ? ((A = () => {
        !k || g.current || ((g.current = !0), E(t, { eventName: `codex_fast_mode_banner_viewed` }));
      }),
      (j = [t, k]),
      (e[2] = k),
      (e[3] = t),
...
function at(e) {
  ...
  if (
    (t[1] !== g || t[2] !== r
      ? ((v = () => {
          !g ||
            h.current ||
            ((h.current = !0), E(r, { eventName: `codex_multi_agent_banner_viewed` }));
        }),
        (y = [r, g]),
        (t[1] = g),
        (t[2] = r),
  ...
  t[21] !== r || t[22] !== f
    ? ((j = () => {
        (E(r, { eventName: `codex_multi_agent_banner_dismissed` }), f(!0));
      }),
      (t[21] = r),
      (t[22] = f),
      (t[23] = j))

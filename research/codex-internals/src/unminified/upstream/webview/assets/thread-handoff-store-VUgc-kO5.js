...
import { at as n, lt as r } from "./vscode-api-sUstfl-x.js";
import { n as i, r as a } from "./react-v2Nz4MGb.js";
var o = r(),
  s = n({ activeOperationId: null, operations: [] });
function c(e) {
  return {
    ...e,
    status: `queued`,
...
function d() {
  ...
  n[0] === r
    ...
    : ((a = (e) => {
        ...
        return (r((e) => ({ activeOperationId: null, operations: [...e.operations, n] })), n);
      }),
      (n[0] = r),
      (n[1] = a));
  let c = a,
  ...
  n[6] === r
    ? (h = n[7])
    : ((h = (t, n) => {
        r((r) => ({ ...r, operations: r.operations.map((r) => (r.id === t ? e(r, n) : r)) }));
      }),
      (n[6] = r),
      (n[7] = h));
  let g = h,
...
//# sourceMappingURL=thread-handoff-store-VUgc-kO5.js.map

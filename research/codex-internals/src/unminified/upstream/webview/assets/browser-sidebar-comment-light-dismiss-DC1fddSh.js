...
async function vt(
  ...
  (S.info(`Appshot capture request created`, {
    ...
    xt(),
    N(e, { eventName: `codex_appshot_capture_started`, metadata: { source: s } }),
    ht.set(u, {
      scope: e,
      attachmentGen: n(),
...
var On = `[data-codex-terminal]`,
  kn = `[data-codex-composer]`,
...
function pa(e) {
  ...
  let E;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { fontSize: `var(--codex-chat-font-size)` }), (t[15] = E))
    : (E = t[15]);

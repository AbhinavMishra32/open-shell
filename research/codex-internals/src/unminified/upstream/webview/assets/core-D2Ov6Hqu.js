...
var t = e((e, t) => {
  ...
  var pe = (e, t) => {
    ...
    me = [`of`, `and`, `for`, `in`, `not`, `or`, `if`, `then`, `parent`, `list`, `value`],
    he = `keyword`;
  function V(e, t, n = he) {
  ...
  function ve(e) {
    if (Array.isArray(e.begin)) {
      if (e.skip || e.excludeBegin || e.returnBegin)
        throw (U(`skip, excludeBegin, returnBegin not compatible with beginScope: {}`), K);
  ...
  function ye(e) {
    if (Array.isArray(e.end)) {
      if (e.skip || e.excludeEnd || e.returnEnd)
        throw (U(`skip, excludeEnd, returnEnd not compatible with endScope: {}`), K);
    ...
    Q = function (e) {
      ...
      function d(e) {
        ...
        if (n) {
          ...
          return (
            t ||
              (W(s.replace(`{}`, n[1])), W(`Falling back to no-highlight mode for this block.`, e)),
            t ? n[1] : `no-highlight`
          );
        }
      ...
      function v(e, n, i, a) {
        ...
        function g(e, t) {
          return (
            ...
            e.beginScope &&
              (e.beginScope._wrap
                ? (m(N, E.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (N = ``))
        ...
        function T(t, r) {
          ...
          if (r.type === `illegal` && !i) {
            let e = Error(`Illegal lexeme "` + a + `" for mode "` + (k.scope || `<unnamed>`) + `"`);
            throw ((e.mode = k), e);
          } else if (r.type === `end`) {
            let e = S(r);
            if (e !== Z) return e;
...
`),
        ...
        try {
          ...
          return (
            j.finalize(),
            (O = j.toHTML()),
            { language: e, value: O, relevance: P, illegal: !1, _emitter: j, _top: k }
          );
        } catch (t) {
      ...
      function b(e) {
        let t = { value: Y(e), illegal: !1, relevance: 0, _top: c, _emitter: new l.__emitter(l) };
      ...
      function C(e) {
        let t = null,
          n = d(e);
        if (u(n)) return;
        if ((R(`before:highlightElement`, { el: e, language: n }), e.dataset.highlighted)) {
          console.log(
        ...
        ((e.innerHTML = i.value),
          ...
          i.secondBest &&
            (e.secondBest = { language: i.secondBest.language, relevance: i.secondBest.relevance }),
      ...
      function k(n, r) {
        ...
        try {
          ...
          if ((U(`Language definition for '{}' could not be registered.`.replace(`{}`, n)), o))
            U(e);
          else throw e;
          i = c;
        }
...
export { t };
//# sourceMappingURL=core-D2Ov6Hqu.js.map

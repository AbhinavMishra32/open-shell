...
import { a as s, i as c, l, n as u, o as d, r as f } from "./dialog-layout-CCvvb1Vc.js";
import { t as p } from "./check-md-CZTnvSiA.js";
import { t as m } from "./plus-_AqggHDM.js";
var h = e(t(), 1),
  g = n();
function _({
  belowFreeformContent: e,
  freeformFeedbackRequired: t,
  onClose: n,
  onSubmit: _,
  options: v,
}) {
  ...
  return (0, g.jsx)(l, {
    ...
    children: (0, g.jsxs)(u, {
      ...
      className: `gap-2`,
      onSubmit: async (e) => {
        if ((e.preventDefault(), w == null || S || k)) return;
        C(!0);
        let t = !1;
        try {
          t = (await _({ selectedOptionId: w, details: E })) !== !1;
        } finally {
          C(!1);
        }
        t && n();
...
export { _ as t };
//# sourceMappingURL=feedback-form-dialog-CD7y99P3.js.map

...
function o(e) {
  ...
  if (n[4] !== v || n[5] !== y || n[6] !== l || n[7] !== c || n[8] !== o) {
    let e;
    (n[10] !== v || n[11] !== y || n[12] !== l || n[13] !== c || n[14] !== o.length
      ? ((e = (e, n) => {
          let i = e.key === c,
            s = n === 0,
            u = n === o.length - 1,
                ...
                children: [
                  (0, a.jsxs)(`button`, {
                    ...
                    className: t(
                      ...
                      i ? `text-token-text-primary` : `text-token-text-secondary`,
                      d,
                      !v && !y && s && `rounded-l-md`,
                      !v && !y && u && `rounded-r-md`,
                      i && f,
                  ...
                  e.onClose == null
                    ...
                    : (0, a.jsx)(`button`, {
                        ...
                        className: t(
                          ...
                          v ? `flex h-7 w-5 items-center justify-center` : `px-1`,
                        ),
                        onClick: e.onClose,
                        children: (0, a.jsx)(r, { className: `icon-2xs` }),
                      }),
                  !v && !y && !u
                    ? (0, a.jsx)(`div`, { className: `h-full w-px self-stretch bg-token-border` })
                    : null,
                ],
              },
              e.key,
  ...
  let T;
  return (
    n[16] !== m || n[17] !== h || n[18] !== S || n[19] !== C || n[20] !== w || n[21] !== f
      ? ((T = (0, a.jsx)(`div`, {
          ref: f,
          role: `tablist`,
          "aria-label": m,
...
export { o as t };
//# sourceMappingURL=tabs-ji6s-l3m.js.map

...
import { t as ee } from "./proxy-DktXrBt_.js";
import { h as te, v as a, y as o } from "./window-app-action-helpers-u9SI1RSH.js";
import { t as s } from "./use-stable-callback-B56R_Ee2.js";
import { t as ne } from "./get-resize-observer-entry-size-CH0PchA7.js";
import { n as re } from "./use-resize-observer-CbHbkQNx.js";
import { t as ie } from "./app-shell-bottom-panel-scroll-sync-DpO90Rtb.js";
import { t as ae } from "./thread-layout-Dkr9s56u.js";
var c = e(t(), 1),
  oe = (0, c.createContext)(null);
function l() {
  let e = (0, c.use)(oe);
  if (e == null) throw Error(`useThreadScrollController must be used within ThreadScrollLayout`);
  return e;
}
var se = i(),
  u = n(),
...
function ue(e) {
  ...
  t[2] === v
    ? (y = t[3])
    : ((y = (e) => {
        if (((f.current = e), !(e == null || v == null)))
          return v((t) => {
            Se.current || fe(e) || o(e, a(e) + t);
          });
      }),
      (t[2] = v),
      (t[3] = y));
    ...
    ? ((N = () => {
        ...
        let n = performance.now(),
          r = (e) => {
            ...
            let ee = Math.min(1, (e - n) / ce);
            if ((o(i, t * (1 - (1 - (1 - ee) ** 3))), ee < 1 && !fe(i))) {
              _.current = window.requestAnimationFrame(r);
              return;
            }
            (o(i, 0), D());
          };
    ...
    ? ((L = () => {
        ...
        let t = () => {
          ...
          n = () => {
            ...
            g.current = i;
            let ee = a(e);
            for (let e of xe.current) e(ee, n);
          },
          r = () => {
  ...
  (t[29] === D
    ...
    (0, c.useEffect)(z, B));
  let V;
  (t[32] === P ? (V = t[33]) : ((V = () => ({ scrollToBottom: P })), (t[32] = P), (t[33] = V)),
  ...
  t[42] === A
    ...
    : ((U = (e) => {
        ...
        r !== t &&
          ...
          (ye.current = t),
          !(Se.current || Ce.current) && (r == null || fe(n) || A(`instant`, (e) => a(e) + t - r)));
      }),
      (t[42] = A),
      (t[43] = U));
  let Ne = re(U),
    ...
    W;
  t[44] === Pe ? (W = t[45]) : ((W = r(`h-full flex-1`, Pe)), (t[44] = Pe), (t[45] = W));
  let G;
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (G = t[46]);
  let K;
  t[47] === n ? (K = t[48]) : ((K = n == null ? void 0 : { x: n }), (t[47] = n), (t[48] = K));
  let q;
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = r(ae, `relative flex shrink-0 flex-col pb-8`)), (t[49] = q))
    : (q = t[49]);
  let J;
  t[50] === i
    ? (J = t[51])
    : ((J = (0, u.jsx)(`div`, { "data-mcp-app-portal-target": `true`, className: q, children: i })),
      (t[50] = i),
      (t[51] = J));
  let Y;
  t[52] !== l || t[53] !== Ne
    ? ((Y = l
        ? (0, u.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, u.jsx)(`div`, { className: r(`relative z-10 flex flex-col`, ae), children: l }),
            ],
          })
        : null),
      (t[52] = l),
  ...
  let Z;
  t[59] !== we || t[60] !== X
    ? ((Z = (0, u.jsx)(`div`, { ref: we, ...te.timelineScroll, className: G, children: X })),
      (t[59] = we),
      (t[60] = X),
      (t[61] = Z))
    : (Z = t[61]);
  let Q;
  t[62] !== W || t[63] !== Z
    ? ((Q = (0, u.jsx)(`div`, { className: W, children: Z })),
      (t[62] = W),
      (t[63] = Z),
      (t[64] = Q))
    : (Q = t[64]);
  ...
  return (
    t[65] !== Me || t[66] !== Q
      ? (($ = (0, u.jsx)(oe, { value: Me, children: Q })), (t[65] = Me), (t[66] = Q), (t[67] = $))
      : ($ = t[67]),
    $
  );
}
...
export { oe as n, l as r, ue as t };
//# sourceMappingURL=thread-scroll-layout-CaagbXVM.js.map

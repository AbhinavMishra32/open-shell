import { J as e, X as t, Y as n, Z as r, y as i } from "./vscode-api-sUstfl-x.js";
var a = class extends r {
  ...
  setOptions(e) {
    super.setOptions({ ...e, behavior: t() });
  }
  getOptimisticResult(e) {
    return ((e.behavior = t()), super.getOptimisticResult(e));
  }
  fetchNextPage(e) {
  ...
  createResult(t, r) {
    let { state: i } = t,
      a = super.createResult(t, r),
      { isFetching: o, isRefetching: s, isError: c, isRefetchError: l } = a,
    ...
    return {
      ...
      hasNextPage: e(r, i.data),
      hasPreviousPage: n(r, i.data),
...
function s(e) {
  return Array.isArray ? Array.isArray(e) : v(e) === `[object Array]`;
}
var c = 1 / 0;
function l(e) {
...
function p(e) {
  return e === !0 || e === !1 || (h(e) && v(e) == `[object Boolean]`);
}
function m(e) {
...
var y = `Incorrect 'index' type`,
  b = (e) => `Invalid value for key ${e}`,
  x = (e) => `Pattern length exceeds max of ${e}.`,
  S = (e) => `Missing ${e} property in key`,
...
function T(e) {
  let t = null,
    ...
    i = 1,
    a = null;
  if (d(e) || s(e)) ((r = e), (t = E(e)), (n = D(e)));
  else {
    if (!w.call(e, `name`)) throw Error(S(`name`));
    let o = e.name;
    if (((r = o), w.call(e, `weight`) && ((i = e.weight), i <= 0))) throw Error(C(o));
    ((t = E(o)), (n = D(o)), (a = e.getFn));
  }
  return { path: t, id: n, weight: i, src: r, getFn: a };
}
function E(e) {
  return s(e) ? e : e.split(`.`);
}
function D(e) {
  return s(e) ? e.join(`.`) : e;
}
function te(e, t) {
    ...
    i = (e, t, a) => {
      if (g(e))
        if (!t[a]) n.push(e);
          ...
          let o = e[t[a]];
          if (!g(o)) return;
          if (a === t.length - 1 && (d(o) || f(o) || p(o))) n.push(u(o));
          else if (s(o)) {
            r = !0;
  ...
  return (i(e, d(t) ? t.split(`.`) : t, 0), r ? n : n[0]);
}
var ne = { includeMatches: !1, findAllMatches: !1, minMatchCharLength: 1 },
  re = {
    isCaseSensitive: !1,
    ignoreDiacritics: !1,
    includeScore: !1,
  ...
  ie = { location: 0, threshold: 0.6, distance: 100 },
  ae = {
    useExtendedSearch: !1,
    getFn: te,
    ignoreLocation: !1,
...
var k = class {
  constructor({ getFn: e = O.getFn, fieldNormWeight: t = O.fieldNormWeight } = {}) {
...
function A(e, t, { getFn: n = O.getFn, fieldNormWeight: r = O.fieldNormWeight } = {}) {
  let i = new k({ getFn: n, fieldNormWeight: r });
  return (i.setKeys(e.map(T)), i.setSources(t), i.create(), i);
}
function ce(e, { getFn: t = O.getFn, fieldNormWeight: n = O.fieldNormWeight } = {}) {
  let { keys: r, records: i } = e,
    a = new k({ getFn: t, fieldNormWeight: n });
...
function j(
  e,
  {
    ...
    ignoreLocation: a = O.ignoreLocation,
  } = {},
) {
  let o = t / e.length;
  if (a) return o;
...
function le(e = [], t = O.minMatchCharLength) {
  let n = [],
    r = -1,
    i = -1,
    a = 0;
  for (let o = e.length; a < o; a += 1) {
    ...
    o && r === -1
      ? (r = a)
      : !o && r !== -1 && ((i = a - 1), i - r + 1 >= t && n.push([r, i]), (r = -1));
  }
...
function ue(
  ...
  n,
  {
    ...
    distance: i = O.distance,
    threshold: a = O.threshold,
    findAllMatches: o = O.findAllMatches,
    minMatchCharLength: s = O.minMatchCharLength,
    includeMatches: c = O.includeMatches,
    ignoreLocation: l = O.ignoreLocation,
  } = {},
) {
  if (t.length > M) throw Error(x(M));
  let u = t.length,
    d = e.length,
  ...
  for (; (_ = e.indexOf(t, m)) > -1; ) {
    let e = j(t, { currentLocation: _, expectedLocation: f, distance: i, ignoreLocation: l });
  ...
  let C = { isMatch: m >= 0, score: Math.max(0.001, y) };
  if (h) {
    let e = le(g, s);
...
var N = String.prototype.normalize
    ? (e) =>
        e
          .normalize(`NFD`)
          .replace(
  ...
  P = class {
    constructor(
      e,
      {
        ...
        threshold: n = O.threshold,
        distance: r = O.distance,
        includeMatches: i = O.includeMatches,
        findAllMatches: a = O.findAllMatches,
        minMatchCharLength: o = O.minMatchCharLength,
        isCaseSensitive: s = O.isCaseSensitive,
        ignoreDiacritics: c = O.ignoreDiacritics,
        ignoreLocation: l = O.ignoreLocation,
      } = {},
    ) {
      if (
        ...
        return;
      let u = (e, t) => {
          this.chunks.push({ pattern: e, alphabet: de(e), startIndex: t });
        },
      ...
      if (d > M) {
        let e = 0,
          t = d % M,
          n = d - t;
        for (; e < n; ) (u(this.pattern.substr(e, M), e), (e += M));
        if (t) {
          let e = d - M;
...
var _e = new Set([V.type, H.type]),
  ve = class {
    constructor(
      e,
      {
        isCaseSensitive: t = O.isCaseSensitive,
        ignoreDiacritics: n = O.ignoreDiacritics,
        includeMatches: r = O.includeMatches,
        minMatchCharLength: i = O.minMatchCharLength,
        ignoreLocation: a = O.ignoreLocation,
        findAllMatches: o = O.findAllMatches,
        location: s = O.location,
        threshold: c = O.threshold,
        distance: l = O.distance,
      } = {},
    ) {
      ((this.query = null),
        (this.options = {
        ...
        (e = n ? N(e) : e),
        (this.pattern = e),
        (this.query = ge(this.pattern, this.options)));
    }
...
var q = { AND: `$and`, OR: `$or` },
  J = { PATH: `$path`, PATTERN: `$val` },
  Y = (e) => !!(e[q.AND] || e[q.OR]),
  X = (e) => !!e[J.PATH],
  be = (e) => !s(e) && m(e) && !Y(e),
  Z = (e) => ({ [q.AND]: Object.keys(e).map((t) => ({ [t]: e[t] })) });
function Q(e, t, { auto: n = !0 } = {}) {
  let r = (e) => {
    let i = Object.keys(e),
      a = X(e);
    if (!a && i.length > 1 && !Y(e)) return r(Z(e));
    if (be(e)) {
      let r = a ? e[J.PATH] : i[0],
        o = a ? e[J.PATTERN] : e[r];
      if (!d(o)) throw Error(b(r));
      let s = { keyId: D(r), pattern: o };
      return (n && (s.searcher = K(o, t)), s);
    }
  ...
  return (Y(e) || (e = Z(e)), r(e));
}
function xe(e, { ignoreFieldNorm: t = O.ignoreFieldNorm }) {
  e.forEach((e) => {
    let n = 1;
...
function Se(e, t) {
  ...
  ((t.matches = []),
    g(n) &&
      n.forEach((e) => {
        if (!g(e.indices) || !e.indices.length) return;
...
function we(e, t, { includeMatches: n = O.includeMatches, includeScore: r = O.includeScore } = {}) {
  let i = [];
  return (
    n && i.push(Se),
    r && i.push(Ce),
...
var $ = class {
  constructor(e, t = {}, n) {
    ((this.options = { ...O, ...t }),
      ...
      (this._keyStore = new ee(this.options.keys)),
      this.setCollection(e, n));
  }
  setCollection(e, t) {
    if (((this._docs = e), t && !(t instanceof k))) throw Error(y);
    this._myIndex =
      t ||
  ...
  add(e) {
    g(e) && (this._docs.push(e), this._myIndex.add(e));
  }
  remove(e = () => !1) {
    let t = [];
  ...
  search(e, { limit: t = -1 } = {}) {
    ...
    return (
      xe(s, { ignoreFieldNorm: o }),
      i && s.sort(a),
      f(t) && t > -1 && (s = s.slice(0, t)),
      we(s, this._docs, { includeMatches: n, includeScore: r })
    );
  }
  _searchStringList(e) {
    ...
    return (
      n.forEach(({ v: e, i: n, n: i }) => {
        ...
        a && r.push({ item: e, idx: n, matches: [{ score: o, value: e, norm: i, indices: s }] });
      }),
      r
    );
  }
    ...
    return (
      r.forEach(({ $: e, i: r }) => {
        if (g(e)) {
          let o = n(t, e, r);
          o.length &&
            (i[r] || ((i[r] = { idx: r, item: e, matches: [] }), a.push(i[r])),
            o.forEach(({ matches: e }) => {
              i[r].matches.push(...e);
            }));
        }
  ...
  _searchObjectList(e) {
    ...
    return (
      r.forEach(({ $: e, i: r }) => {
        ...
        let a = [];
        (n.forEach((n, r) => {
          a.push(...this._findMatches({ key: n, value: e[r], searcher: t }));
        }),
...
(($.version = `7.1.0`),
  ...
  ye(ve));
export { o as n, $ as t };
//# sourceMappingURL=fuse-CeBckNvS.js.map

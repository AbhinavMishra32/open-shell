...
import { F as r, P as i, f as a, h as o, lt as s } from "./vscode-api-sUstfl-x.js";
import { c, o as l, r as u } from "./lib-MoKmYgcO.js";
import { t as d } from "./use-auth-DXLjX3T4.js";
import { p as f } from "./codex-api-DRlZt5zW.js";
import { t as p } from "./use-debounced-value-DkRRYvDv.js";
import { r as m } from "./toast-signal-By11REe1.js";
import { t as h } from "./tooltip-BhXPONlb.js";
import { t as g } from "./button-Xd4Hy1MO.js";
import { t as _ } from "./spinner-Dvc_A3Ae.js";
import { t as v } from "./copy-to-clipboard-q_KxH8lM.js";
...
import { t as D } from "./sites-color-BjPTBoYq.js";
import { t as O } from "./globe-DyuVFbAy.js";
import { t as k } from "./building-r_Q_yEQG.js";
import { t as A } from "./lock-DV6CP31m.js";
import { t as j } from "./arrow-up-right-lg-B6PWe6L5.js";
import { t as M } from "./link-CsT_QnTl.js";
import {
  d as ee,
  f as te,
  h as ne,
...
function ge(e) {
  let t = (0, P.c)(99),
    ...
    { email: h } = d(),
    { data: g } = f(),
    { data: v, isError: T, isLoading: E } = i(ae, a),
    D = i(se, a),
    [O, k] = (0, he.useState)(``),
    A;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((A = []), (t[0] = A)) : (A = t[0]);
  let [j, M] = (0, he.useState)(A),
    ie;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((ie = []), (t[1] = ie)) : (ie = t[1]);
  let [N, le] = (0, he.useState)(ie),
    [fe, pe] = (0, he.useState)(null),
    me;
  t[2] === O ? (me = t[3]) : ((me = O.trim()), (t[2] = O), (t[3] = me));
  let ge = me,
    Ee = p(ge, 200),
    { data: I } = ue(O),
    { data: L } = i(oe, Ee),
  ...
  if (
    ...
    ((H = Ae(L)),
      ...
      (V = z?.allowed_users ?? []),
      (B = z?.allowed_groups ?? []));
    let e = new Set(V.map(Se));
    W = de({
      currentAccountUserId: g?.account_user_id,
      existingAccountUserIds: e,
      selectedAccountUserIds: j.map(xe),
      workspaceUsers: I,
    });
    let n = new Set(B.map(be));
    G = new Set(U.map(ye));
    let r;
    t[20] !== n || t[21] !== N
    ...
    let i = H.filter(r),
      a;
    (t[23] === s ? (a = t[24]) : ((a = (e) => Me(e, s)), (t[23] = s), (t[24] = a)),
      (K = [...i.map(a), ...(W?.map(Ne) ?? [])]),
      (t[4] = L),
      (t[5] = R),
      (t[6] = g?.account_user_id),
  ...
  let Pe = K,
    Fe;
  if (t[25] !== s || t[26] !== N || t[27] !== j) {
    let e;
    (t[29] === s ? (e = t[30]) : ((e = (e) => Me(e, s)), (t[29] = s), (t[30] = e)),
      (Fe = [...N.map(e), ...j.map(Ne)]),
      (t[25] = s),
      (t[26] = N),
      (t[27] = j),
    ...
    : ((Le =
        v == null
          ...
          : (0, F.jsx)(l, {
              ...
              values: { siteTitle: v.title },
            })),
      (t[31] = v),
      (t[32] = Le));
  let Re = Le,
    q = fe ?? z?.access_mode ?? null,
  ...
  t[46] !== D
    ? ((He = function () {
        ...
        D.mutateAsync({
          access_mode: q,
          allowed_user_emails: ee([...V, ...j].map(ve)),
          ...te({
            accessGroups: H,
            knownAccessGroups: U,
            existingGroups: B,
  ...
  t[49] !== J || t[50] !== D
    ? ((Ke = function (e) {
        return D.mutateAsync(e).then(_e, (e) => {
          throw (J(), e);
        });
      }),
      (t[49] = J),
  ...
  t[52] !== z || t[53] !== H || t[54] !== U || t[55] !== qe
    ? ((Je = function (e) {
        ...
        switch (e.kind) {
          case `user`:
            return qe(ne(z, e.user.account_user_id));
          case `group`:
            return qe(
              re({ accessGroups: H, accessPolicy: z, group: e.group, knownAccessGroups: U }),
            );
        }
      }),
      (t[52] = z),
  ...
  let Ye = Je,
    Xe;
  t[57] !== v || t[58] !== Ye || t[59] !== u
    ? ((Xe = function (e) {
        v != null &&
          y(u, Ce, {
            label: e.kind === `group` ? e.group.name : De(e.user),
            onConfirm: () => Ye(e),
            siteTitle: v.title,
          });
      }),
  ...
  t[64] === Re
    ...
    : ((X = (0, F.jsxs)(`div`, {
        ...
        children: [
          (0, F.jsx)(x, { className: `sr-only`, children: Re }),
          (0, F.jsx)(S, { title: Re, titleClassName: `truncate pr-8` }),
        ],
      })),
      (t[64] = Re),
      (t[65] = X));
    ...
    ? ((Z = E
        ...
        : T || v == null || z == null
          ...
          : (0, F.jsxs)(F.Fragment, {
              children: [
                (0, F.jsx)(b, {
                  children: (0, F.jsx)(we, { liveUrl: v.current_live_url, title: v.title }),
                }),
                (0, F.jsx)(b, {
                  children: (0, F.jsx)(ce, {
                    ...
                    onRemoveOption: (e) => {
                      ...
                      bb143: switch (t.kind) {
                        case `group`:
                          le((e) => e.filter((e) => e.id !== t.group.id));
                          break bb143;
                        case `user`:
                          M((e) => e.filter((e) => e.account_user_id !== t.user.account_user_id));
                      }
                    },
                    onSelectOption: (e) => {
                      let { target: t } = e;
      ...
      (t[85] = Z))
    : (Z = t[85]);
  let $e = E || T || v == null || z == null ? void 0 : v.current_live_url,
    Q;
  t[86] !== Ue || t[87] !== ze || t[88] !== Be || t[89] !== $e || t[90] !== D.isPending
    ? ((Q = (0, F.jsx)(ke, {
  ...
  t[92] !== X || t[93] !== Z || t[94] !== Q
    ? (($ = (0, F.jsxs)(w, { className: `px-4 py-3`, children: [X, Z, Q] })),
      (t[92] = X),
      (t[93] = Z),
      (t[94] = Q),
      (t[95] = $))
...
function Ce(e) {
  ...
  let h;
  t[14] !== f || t[15] !== m
    ? ((h = (0, F.jsx)(S, { title: f, titleClassName: `truncate pr-8`, subtitle: m })),
      (t[14] = f),
      (t[15] = m),
      (t[16] = h))
    : (h = t[16]);
  ...
  let v;
  t[18] !== o || t[19] !== r
    ? ((v = (0, F.jsx)(g, { color: `secondary`, disabled: o, onClick: r, children: _ })),
      (t[18] = o),
      (t[19] = r),
      (t[20] = v))
    : (v = t[20]);
  ...
  t[22] === o
    ? (D = t[23])
    : ((D = (0, F.jsx)(g, { color: `danger`, loading: o, type: `submit`, children: y })),
      (t[22] = o),
      (t[23] = D));
  let O;
  t[24] !== D || t[25] !== v
    ? ((O = (0, F.jsx)(b, { children: (0, F.jsxs)(T, { children: [v, D] }) })),
      (t[24] = D),
      (t[25] = v),
      (t[26] = O))
    : (O = t[26]);
...
function we(e) {
  let t = (0, P.c)(12),
    { liveUrl: n, title: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = ie(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, F.jsx)(`span`, {
        className: `flex size-10 shrink-0 items-center justify-center`,
        children: (0, F.jsx)(D, { className: `icon-md` }),
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
  ...
  return (
    t[9] !== s || t[10] !== u
      ? ((d = (0, F.jsxs)(`div`, {
          ...
          children: [
            o,
            (0, F.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-0.5`, children: [s, u] }),
          ],
        })),
        (t[9] = s),
        (t[10] = u),
...
function Te(e) {
  ...
  if (
    ...
    let e = Ee({ activeAccessUsers: r, currentAccountUserId: u, currentUserEmail: s }),
    ...
    let a = `${i.revision}:${i.access_mode}`,
      c = o ?? i.access_mode;
    (t[16] !== i.access_mode || t[17] !== d || t[18] !== a || t[19] !== c
      ? ((S = (0, F.jsx)(
          B,
          { initialAccessMode: i.access_mode, selectedAccessMode: c, onAccessModeChange: d },
          a,
        )),
        (t[16] = i.access_mode),
        (t[17] = d),
    ...
    (t[21] === p
      ...
      (t[13] = x),
      (t[14] = S));
  } else ((h = t[8]), (g = t[9]), (_ = t[10]), (v = t[11]), (y = t[12]), (x = t[13]), (S = t[14]));
  let C;
  if (t[23] !== n || t[24] !== m || t[25] !== f || t[26] !== a) {
    let e;
    (t[28] !== m || t[29] !== f || t[30] !== a
      ? ((e = (e) =>
          (0, F.jsx)(
            fe,
            {
  ...
  t[32] !== g || t[33] !== _ || t[34] !== v || t[35] !== C
    ? ((w = (0, F.jsxs)(`div`, { className: g, children: [_, v, C] })),
      (t[32] = g),
      (t[33] = _),
      (t[34] = v),
      (t[35] = C),
  ...
  let T;
  return (
    t[37] !== h || t[38] !== y || t[39] !== x || t[40] !== S || t[41] !== w
      ? ((T = (0, F.jsxs)(h, { className: y, children: [x, S, w] })),
        (t[37] = h),
        (t[38] = y),
        (t[39] = x),
        (t[40] = S),
...
function Ee({ activeAccessUsers: e, currentAccountUserId: t, currentUserEmail: n }) {
...
function B(e) {
  ...
  if (t[0] !== n) {
    ...
    ((a = me), (o = e.map(H)), (t[0] = n), (t[1] = a), (t[2] = o));
  } else ((a = t[1]), (o = t[2]));
  let s;
  return (
    t[3] !== a || t[4] !== i || t[5] !== r || t[6] !== o
      ? ((s = (0, F.jsx)(a, { options: o, value: r, renderLabel: V, onChange: i })),
        (t[3] = a),
        (t[4] = i),
        (t[5] = r),
        (t[6] = o),
...
function ke(e) {
  let t = (0, P.c)(27),
    ...
    y;
  t[0] !== s || t[1] !== u
    ? ((y = G({ action: `copyLink`, isSaving: s, liveUrl: u })), (t[0] = s), (t[1] = u), (t[2] = y))
    : (y = t[2]);
  let x = y,
    S;
  t[3] !== s || t[4] !== u
    ? ((S = G({ action: `visit`, isSaving: s, liveUrl: u })), (t[3] = s), (t[4] = u), (t[5] = S))
    : (S = t[5]);
  let C = S,
    w;
  t[6] === f
    ? (w = t[7])
    : ((w = { invite: { onClick: f }, share: { onClick: f } }), (t[6] = f), (t[7] = w));
  let T;
  t[8] === d ? (T = t[9]) : ((T = { onClick: d }), (t[8] = d), (t[9] = T));
  let E;
  t[10] !== x || t[11] !== p || t[12] !== s || t[13] !== u || t[14] !== _ || t[15] !== C
    ? ((E =
        u === void 0
          ? null
          : (0, F.jsxs)(`div`, {
                ...
                (0, F.jsx)(h, {
                  ...
                  children: (0, F.jsx)(`span`, {
                    ...
                    children: (0, F.jsxs)(g, {
                      ...
                      size: `toolbar`,
                      onClick: () => {
                        u != null && a.dispatchMessage(`open-in-browser`, { url: u });
                      },
                      children: [
                        (0, F.jsx)(j, { className: `icon-xs` }),
                        (0, F.jsx)(l, {
...
export { ge as t };
//# sourceMappingURL=appgen-share-dialog-CLo_KH7g.js.map

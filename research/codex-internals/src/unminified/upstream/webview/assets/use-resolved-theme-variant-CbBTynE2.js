...
import { a as i } from "./setting-storage-Cel8Tr7E.js";
var a = r(),
  o = e(n(), 1);
function s() {
  return i(t.theme) ?? `system`;
}
function c(e) {
  let t = (0, a.c)(4),
    n;
  t[0] === e ? (n = t[1]) : ((n = e === `system` ? f : () => e), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] === e ? (r = t[3]) : ((r = e === `system` ? f : () => e), (t[2] = e), (t[3] = r)),
    (0, o.useSyncExternalStore)(e === `system` ? d : u, n, r)
  );
}
function l(e) {
...
export { s as n, c as r, l as t };
//# sourceMappingURL=use-resolved-theme-variant-CbBTynE2.js.map

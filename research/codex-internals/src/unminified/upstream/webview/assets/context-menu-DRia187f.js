...
import { lt as f } from "./vscode-api-sUstfl-x.js";
import { c as ne, o as re } from "./lib-MoKmYgcO.js";
import { n as ie } from "./window-zoom-context-CSPQZGcc.js";
import { t as ae } from "./tooltip-BhXPONlb.js";
import { t as oe } from "./check-md-CZTnvSiA.js";
...
function pe(e) {
  let t = (0, le.c)(83),
    ...
    v = ne(),
    y = ie(),
    b = !se && window.electronBridge?.showContextMenu != null,
    x;
  t[0] === n ? (x = t[1]) : ((x = n ?? []), (t[0] = n), (t[1] = x));
  let S;
  t[2] !== v.formatMessage || t[3] !== x
    ? ((S = h(x, v.formatMessage)), (t[2] = v.formatMessage), (t[3] = x), (t[4] = S))
    : (S = t[4]);
  let [C, w] = p.useState(S),
    T;
  t[5] === v.formatMessage
    ? (T = t[6])
    : ((T = (e) => {
  ...
  let A = k,
    j;
  t[15] !== f || t[16] !== n || t[17] !== g || t[18] !== E
    ? ((j = async () => (await g?.(), E(await (f ? f() : (n ?? []))))),
      (t[15] = f),
      (t[16] = n),
      (t[17] = g),
      (t[18] = E),
  ...
  let _e = P,
    F = me,
    I;
  t[30] !== _ || t[31] !== _e || t[32] !== A || t[33] !== ge || t[34] !== b
    ? ((I = async (e) => {
        if (!b) return;
        e.preventDefault();
        let t = _ ? await ge() : A(),
  ...
  if (b) {
    ...
    if (t[40] !== L || t[41] !== z) {
      let n;
      (t[43] === z ? (n = t[44]) : ((n = { onContextMenu: z }), (t[43] = z), (t[44] = n)),
  ...
  if (t[45] !== L || t[46] !== z) {
    let e;
    (t[48] === z ? (e = t[49]) : ((e = { onContextMenu: z }), (t[48] = z), (t[49] = e)),
  ...
  let V = B,
    ...
    Y,
    X;
  if (t[50] !== A || t[51] !== C || t[52] !== V || t[53] !== y) {
    let e = (t) =>
      t.map((t) =>
        t.type === `separator`
          ? (0, m.jsx)(l, { className: `mx-1 my-1 border-t border-token-border/60` }, t.id)
          : t.type === `checkbox`
            ? (0, m.jsx)(
                ae,
                {
                  tooltipContent: t.tooltipMessage
                    ? (0, m.jsx)(re, { ...t.tooltipMessage, values: t.tooltipMessageValues })
                    : null,
                  children: (0, m.jsx)(ee, {
                    checked: t.checked ?? !1,
                    className: r(
                  ...
                  d,
                  {
                    children: [
                      (0, m.jsx)(s, {
                        ...
                        disabled: t.enabled === !1,
                        children: (0, m.jsx)(he, { icon: t.icon, label: F(t), showChevron: !0 }),
                      }),
                      (0, m.jsx)(o, {
                        children: (0, m.jsx)(a, {
              ...
              : (0, m.jsx)(
                  ae,
                  {
                    ...
                    children: (0, m.jsx)(u, {
                      ...
                      children: (0, m.jsx)(he, { icon: t.icon, label: F(t) }),
                    }),
                  },
                  t.id,
                ),
    ...
    ((W = i),
      ...
      t[65] === V
        ? (X = t[66])
        : ((X = (0, m.jsx)(te, { asChild: !0, children: V })), (t[65] = V), (t[66] = X)),
      (U = o),
      (H = c),
  ...
  t[69] !== H || t[70] !== G || t[71] !== K || t[72] !== q || t[73] !== J
    ? ((Z = (0, m.jsx)(H, { className: G, collisionPadding: K, style: q, children: J })),
      (t[69] = H),
      (t[70] = G),
      (t[71] = K),
      (t[72] = q),
  ...
  let Q;
  t[75] !== U || t[76] !== Z
    ? ((Q = (0, m.jsx)(U, { children: Z })), (t[75] = U), (t[76] = Z), (t[77] = Q))
    : (Q = t[77]);
  let $;
  return (
...
function me(e) {
  return e.message ? (0, m.jsx)(re, { ...e.message, values: e.messageValues }) : e.id;
}
function he(e) {
  let t = (0, le.c)(15),
  ...
  t[0] !== n || t[1] !== a
    ? ((s = a
        ? (0, m.jsx)(`span`, {
            ...
            children: n ? (0, m.jsx)(oe, { "aria-hidden": !0, className: `icon-xs` }) : null,
          })
        : null),
      (t[0] = n),
      (t[1] = a),
  ...
  t[3] !== r || t[4] !== i
    ? ((c = r
        ? (0, m.jsx)(`img`, { alt: typeof i == `string` ? i : ``, src: r, className: `icon-sm` })
        : null),
      (t[3] = r),
      (t[4] = i),
      (t[5] = c))
  ...
  t[6] === i
    ? (l = t[7])
    : ((l = (0, m.jsx)(`span`, { className: `truncate`, children: i })), (t[6] = i), (t[7] = l));
  let u;
  t[8] === o
    ? (u = t[9])
    : ((u = o ? (0, m.jsx)(se, { className: `icon-xs ml-auto opacity-50` }) : null),
      (t[8] = o),
      (t[9] = u));
  let d;
  return (
...
export { pe as t };
//# sourceMappingURL=context-menu-DRia187f.js.map

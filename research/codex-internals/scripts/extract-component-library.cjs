...
function writeSystemWrappers() {
  ...
  writeFile(
    ...
    JSON.stringify(
      {
        name: "@codex-ui/component-library",
        private: true,
        type: "module",
        sideEffects: ["**/*.css"],
        exports: {
...
function writeComponentSystem(manifest) {
  ...
  const lines = [
    "# Codex UI Component System",
    "",
    "This is the working knowledge base for copying Codex UI into another Electron app with the same component code.",
    "",
    "Source of truth:",
      "- `original/assets` contains literal copied upstream renderer modules",
      "- `styles/index.js` loads Codex global renderer CSS and feature CSS",
    ...
    "- `@codex-ui/component-library/shell` for app shell and window chrome",
    "- `@codex-ui/component-library/styles` for global tokens and feature CSS",
    "- `@codex-ui/component-library/primitives` for shared controls",
    "- `@codex-ui/component-library/sidebar` for sidebar state/components",
    "- `@codex-ui/component-library/thread` for thread layout and conversation surfaces",
    "- `@codex-ui/component-library/composer` for prompt/editor/composer surfaces",
    "- `@codex-ui/component-library/markdown` for markdown rendering surfaces",
    "- `@codex-ui/component-library/settings` for settings pages",
    "- `@codex-ui/component-library/browser-sidebar` for retained browser/sidebar surfaces",
    "",
    "Copy strategy:",

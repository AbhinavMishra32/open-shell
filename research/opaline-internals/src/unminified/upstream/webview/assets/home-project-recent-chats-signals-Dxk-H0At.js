    ...
    ? [
        {
          ...
          message: z({
            id: `opaline.sidebarTaskRow.hideActiveStatus`,
    ...
    : [
        {
          id: `toggle-active-status`,
          message: z({
            id: `opaline.sidebarTaskRow.showActiveStatus`,
  ...
  r[49] !== a || r[50] !== D
    ? ((Ut = () => {
        d(`clean-background-terminals`, { conversationId: a }).catch(() => {
          D.get(se).danger(
            (0, Z.jsx)(B, {
              id: `opaline.localConversation.backgroundTerminals.cleanError`,
              ...
              stopBackgroundTerminalsAction: V
                ? {
                    ariaLabel: F.formatMessage({
                      id: `opaline.localConversation.backgroundTerminals.stop`,

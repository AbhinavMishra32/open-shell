...
import { F as g, I as _, P as v, f as y, h as b, lt as x, p as ee } from "./vscode-api-sUstfl-x.js";
import { n as te } from "./react-v2Nz4MGb.js";
import { c as ne, n as re, r as S } from "./lib-MoKmYgcO.js";
import { _ as C, l as w, p as ie, v as T } from "./persisted-signal-Cx1QgqJn.js";
import "./rpc-y95ESgjb.js";
import { o as ae } from "./statsig-Cajk3UKk.js";
import "./request-BXHjsnqU.js";
import { c as oe } from "./app-server-manager-hooks-BJ2CaNwA.js";
...
import { E as se } from "./opaline-api-DRlZt5zW.js";
import "./use-debounced-value-DkRRYvDv.js";
import "./toast-signal-By11REe1.js";
import "./window-zoom-context-CSPQZGcc.js";
import { t as E } from "./tooltip-BhXPONlb.js";
import { t as D } from "./persisted-atom-C-xVMviv.js";
import { t as O } from "./use-collaboration-mode-B_dtgury.js";
...
import { t as j } from "./proxy-DktXrBt_.js";
import { t as ce } from "./AnimatePresence-DwAfNqj_.js";
import { t as le } from "./use-reduced-motion-BsrTWbI1.js";
import { t as ue } from "./x-DypUcSQe.js";
import { t as M } from "./check-circle-filled-CC_XQe30.js";
import "./check-md-CZTnvSiA.js";
import { t as de } from "./chevron-right-BZtXyaBk.js";
import "./use-stable-callback-B56R_Ee2.js";
import { t as N } from "./context-menu-DRia187f.js";
import { t as fe } from "./read-service-tier-for-request-BJ8QN0Q7.js";
import { t as pe } from "./get-resize-observer-entry-size-CH0PchA7.js";
import { t as me } from "./clock-CDmkoq1h.js";
import { t as he } from "./chevron-D6hquBJC.js";
import { t as ge } from "./warning-y6tKEMlk.js";
import { t as P } from "./bullet-separator-CcZhs0Nn.js";
import { t as F } from "./is-subagent-conversation-DwbNoV13.js";
import { t as _e } from "./avatar-overlay-analytics-CE-OXRnw.js";
import { i as I } from "./opaline-avatar-9OkGRaoz.js";
import { t as L } from "./avatar-mascot-button-CnbIqNGL.js";
import { t as R } from "./use-avatar-options-B21XKZBs.js";
import { t as ve } from "./use-floating-window-pointer-interactivity-CLTZMlHp.js";
import { t as ye } from "./question-mark-circle-CEKHJHVG.js";
import { t as z } from "./permission-request-model-BpbcnUPl.js";
var B = x(),
  V = e(p(), 1),
  be = 1600,
  xe = 100,
...
function Se(e, t) {
  return e.hasMoved ? we(Ce([...e.samples, t])) : null;
}
function Ce(e) {
  let t = e.at(-1);
  return t == null ? e : e.filter((e) => t.timeMs - e.timeMs <= xe);
}
function we(e) {
  let t = e.at(-1);
...
function Te({ axis: e, debounce: t, initialSize: n = !0, onChange: r, target: i }) {
...
var W = S({
  ...
  additionalAccessTarget: {
    ...
    defaultMessage: `Opaline needs more {target} access`,
...
function Ee(e, t) {
  switch (e?.type) {
    case `userInput`:
      return e.isOnboardingDynamicInput === !0 ? null : ke(e, t);
    case `approval`:
      return e.item.type === `exec` ? Ae(e.item, t) : je(e.item, t);
...
function De(e, t) {
  switch (e.kind) {
    case `question`:
      return [e.prompt, ...e.options.map((e) => e.label)].filter(Boolean).join(` `);
    case `plan`:
      return e.summary;
    case `patch`:
      return [
        t.formatMessage(W.fileCount, { count: e.fileCount }),
...
function ke(e, t) {
  ...
  if (n == null) return null;
  let r = K(n.question) ?? K(n.header);
  return r == null || n.options.length === 0
    ? null
    : {
        kind: `question`,
        requestId: e.item.requestId,
        title: t.formatMessage(W.askQuestion),
        prompt: r,
        options: n.options.map((e) => ({
          label: K(e.label) ?? t.formatMessage(W.option),
...
function Ae(e, t) {
  ...
  let n = K(e.networkApprovalContext?.host ?? ``);
  return n == null
    ? {
        kind: `exec`,
        requestId: e.approvalRequestId,
        operation: t.formatMessage(W.runCommand),
        summary: K(e.cmd.join(` && `)) ?? t.formatMessage(W.command),
        title: t.formatMessage(W.reviewCommand),
        actions: [
          {
            commandDecision: `accept`,
            intent: `command-approval`,
            label: t.formatMessage(W.runOnce),
            tone: `primary`,
          },
          {
            commandDecision: `decline`,
            intent: `command-approval`,
            label: t.formatMessage(W.deny),
            tone: `danger`,
          },
        ],
      }
    : {
        kind: `network`,
        requestId: e.approvalRequestId,
        operation: t.formatMessage(W.allowNetwork),
        target: n,
        title: t.formatMessage(W.allowNetwork),
        actions: [
          {
            ariaLabel: t.formatMessage(W.allowOnce),
            commandDecision: `accept`,
            intent: `command-approval`,
            label: t.formatMessage(W.allow),
            tone: `primary`,
          },
          {
            commandDecision: `decline`,
...
function je(e, t) {
  ...
  return {
    kind: `patch`,
    requestId: e.approvalRequestId,
    operation: t.formatMessage(W.applyChanges),
    summary: n[0]?.[0] ?? t.formatMessage(W.oneFileChanged),
    title: t.formatMessage(W.applyChanges),
    files: n.map(([e]) => e),
    fileCount: n.length,
    ...
    actions: [
      {
        ...
        label: t.formatMessage(W.apply),
        tone: `primary`,
      },
      { intent: `open`, label: t.formatMessage(W.review), tone: `secondary` },
    ],
  };
}
function Me(e, t) {
  ...
  let i, a;
  if (r.kind === `network`) ((a = t.formatMessage(W.networkAccess)), (i = a));
  else {
    a = t.formatMessage(W.fileAccess);
    let e = r.paths[0] ?? a,
    ...
    actions: [
      {
        ...
        ariaLabel: t.formatMessage(W.allowOnce),
        label: t.formatMessage(W.allow),
        permissionResponse: { permissions: Fe(n), scope: `turn` },
        tone: `primary`,
      },
      {
        intent: `permission-response`,
...
function Ne(e, t) {
  ...
  return r == null
    ...
    : {
        kind: `plan`,
        operation: t.formatMessage(W.plan),
        planContent: n,
        summary: r,
        title: t.formatMessage(W.plan),
        turnId: e.turnId,
        actions: [
          { intent: `plan-start`, label: t.formatMessage(W.implementPlan), tone: `primary` },
        ],
      };
}
function Pe(e, t) {
  let { elicitation: n } = e,
    r = e.request.params,
    i = K(r.serverName),
    a = Ue(i) ?? i ?? t.formatMessage(W.toolServer),
    o,
    s = a,
    c = null,
    l = null;
  switch (n.kind) {
    case `formElicitation`:
      ((o = t.formatMessage(W.answerTarget, { target: a })), (c = K(n.message)), (l = []));
      break;
    case `mcpToolCall`: {
      let e = K(n.approval.connector_name) ?? Ue(n.approval.connector_id) ?? a,
        r = Ie(n.message);
      ((o =
        r == null
          ? t.formatMessage(W.allowTarget, { target: e })
          : t.formatMessage(W.allowTarget, { target: r })),
        (s = e),
        (c = K(n.subtitle) ?? Le(n.approval.tool_params) ?? K(n.message)));
      break;
    }
    case `toolSuggestion`: {
      let e = K(n.suggestion.tool_name) ?? Ue(n.suggestion.tool_id) ?? t.formatMessage(W.tool);
      ((o =
        n.suggestion.suggest_type === `enable`
          ? t.formatMessage(W.enableTool, { toolName: e })
          : t.formatMessage(W.installTool, { toolName: e })),
        (s =
          n.suggestion.tool_type === `connector`
            ? t.formatMessage(W.connector)
            : t.formatMessage(W.plugin)),
        (c = K(n.suggestion.suggest_reason)));
      break;
    }
    case `connectorAuth`: {
      let e = K(n.connector.connector_name) ?? Ue(n.connector.connector_id) ?? a,
        r = n.connector.auth_reason;
      ((o =
        r === `missing_link`
          ? t.formatMessage(W.connectTarget, { target: e })
          : r === `oauth_upgrade_required`
            ? t.formatMessage(W.additionalAccessTarget, { target: e })
            : t.formatMessage(W.reconnectTarget, { target: e })),
        (s = e),
        (c = K(n.subtitle) ?? K(n.message) ?? Re(n.url)),
        (l = [
          {
            intent: `open`,
            label:
              r === `missing_link`
                ? t.formatMessage(W.connect)
                : r === `oauth_upgrade_required`
                  ? t.formatMessage(W.updateAccess)
                  : t.formatMessage(W.reconnect),
            tone: `primary`,
          },
        ]));
      break;
    ...
    case `urlAction`:
      ((s = Ue(n.serverName) ?? K(n.serverName) ?? a),
        (o = t.formatMessage(W.openLink)),
        (c = K(n.subtitle) ?? Re(n.url) ?? K(n.message)),
        (l = [{ intent: `open`, label: t.formatMessage(W.openLink), tone: `primary` }]));
      break;
    case `generic`:
      ((o =
        ze({ message: n.message, metadata: n.metadata }) ??
        t.formatMessage(W.allowTarget, { target: a })),
        (c = K(n.subtitle) ?? Le(n.toolParams) ?? K(n.message)));
      break;
  }
  return {
    kind: `tool`,
    ...
    actions: l ?? [
      {
        ariaLabel: t.formatMessage(W.allowTarget, { target: s }),
        intent: `mcp-elicitation`,
        label: t.formatMessage(W.allowTarget, { target: s }),
...
function Ie(e) {
  ...
  if (t?.[1] != null) return K(t[1]);
  let n = /\baccess\s+(.+?)\?*$/i.exec(e);
  return n?.[1] == null ? null : K(n[1]);
}
function Le(e) {
  ...
  let [n, r] = t,
    i = G(r);
  return K(i == null ? n : `${n}: ${i}`);
}
function Re(e) {
  try {
    let t = new URL(e),
      n = t.pathname === `/` ? `` : t.pathname;
    return q(`${t.hostname}${n}`);
  } catch {
    return q(e);
  }
}
...
function ze({ message: e, metadata: t }) {
  let n = Ve(t),
    r = Be(e, n);
  return n != null && He(r) ? n : K(r);
}
function Be(e, t) {
  let n = e.trim();
  if (t == null) return n;
...
function Ve(e) {
  ...
  let t = e.reason;
  return typeof t == `string` ? K(t) : null;
}
function He(e) {
  let t = e.trim().toLowerCase();
  return t === `tool call needs your approval.` || t === `tool call needs your approval`;
}
function Ue(e) {
  let t = e
    ?.trim()
  ...
  return e
    .map((e) =>
      [
        ...
        e.action?.path ?? ``,
        e.waitingRequest == null ? `` : De(e.waitingRequest, t),
      ].join(``),
    )
    .join(`\0`);
}
var J = S({
  ...
  Je = { ...qe, mascotState: `waving` };
function Ye(e) {
  if (e == null) return qe;
  if (e.kind === `first-awake`) return Je;
  if (e.isLoading)
    return {
      badgeBackgroundColor: `var(--color-token-activity-bar-badge-background)`,
      badgeForegroundColor: `var(--color-token-activity-bar-badge-foreground)`,
...
function Xe({ includeCompactWaitingRequests: e, intl: t, localConversations: n, remoteTasks: r }) {
  let i = [],
    a = new Set();
  for (let r of n) {
    let n = Ze({ conversation: r, includeCompactWaitingRequests: e, intl: t });
...
function Ze({ conversation: e, includeCompactWaitingRequests: n, intl: r }) {
  if (F(e)) return null;
  let a = e.hostId ?? `local`,
    o = a === `local` ? `local` : `remote-host`,
    s = rt(e),
    c = n && s === `waiting` ? i(e) : null;
  return {
    ...
    status: s,
    subtitle: $e(e, r),
    title: t(e) ?? r.formatMessage(Y.newThread),
    turnKey: String(e.turns.length),
    updatedAtMs: e.updatedAt,
    waitingRequest: Ee(c, r),
  };
}
function Qe(e, t) {
...
function $e(e, t) {
  return et(e.turns.at(-1)?.items ?? [], t);
}
function et(e, t) {
...
function tt(e, t) {
  ...
  if (e.type === `commandExecution`) {
    ...
    if (n == null) return r ? t.formatMessage(Y.runningCommand) : t.formatMessage(Y.ranCommand);
    switch (n.type) {
      case `read`:
        return r
      ...
      case `listFiles`:
        return r ? t.formatMessage(Y.listingFiles) : t.formatMessage(Y.listedFiles);
      case `search`: {
        let e = nt(n.query ?? ``);
        return e == null
          ? r
      ...
      case `unknown`:
        return r ? t.formatMessage(Y.runningCommand) : t.formatMessage(Y.ranCommand);
    }
  }
  ...
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    n =
      e.resumeState === `needs_resume`
        ? t?.type === `active`
        : e.resumeState === `resuming` || e.turns.at(-1)?.status === `inProgress`,
    i =
      e.resumeState === `needs_resume`
...
var X = m(),
  Z = S({
    mascotLabel: {
      ...
      description: `Accessible label for the floating Opaline pet`,
    },
    openNotification: {
    ...
    resizeMascot: {
      ...
      description: `Accessible label for the handle that resizes the floating Opaline pet`,
    },
    notificationList: {
  ...
  lt = 512,
  ut = 1,
  dt = `group no-drag absolute left-1/2 z-10 flex h-5 cursor-interaction items-center justify-center gap-0.5 rounded-full border border-token-border bg-token-main-surface-primary px-2 text-[10px] leading-none font-medium text-token-text-secondary shadow-[0px_5px_10px_-7px_rgba(0,0,0,0.22)] backdrop-blur hover:text-token-foreground hover:shadow-[0px_7px_14px_-9px_rgba(0,0,0,0.26)] focus-visible:ring-1 focus-visible:ring-token-focus-border focus-visible:outline-none forced-colors:bg-[Canvas]`,
  ft = `!bg-token-main-surface-primary enabled:hover:!bg-[color-mix(in_srgb,var(--color-token-main-surface-primary)_94%,var(--color-token-foreground))]`;
function pt({
  avatar: e,
  avatarMenuItems: t,
  ...
  let S = ne(),
    ...
    ie = u.length > 0,
    T = ie && i,
    ae = a.placement.startsWith(`top`),
    oe = a.placement.endsWith(`end`),
    se = a.tray == null ? void 0 : Math.max(0, a.tray.height),
    E = `${ae ? `bottom` : `top`} ${oe ? `right` : `left`}`,
    D;
  return (
    T
      ? (D = {
          ariaLabel: S.formatMessage(Z.collapseNotificationTray),
          backgroundColor: `var(--color-token-bg-primary)`,
          content: (0, X.jsx)(he, { className: `icon-xs opacity-80` }),
      ...
      : ie &&
        (D = {
          ...
          backgroundColor: w.badgeBackgroundColor,
          content: u.length,
          foregroundColor: w.badgeForegroundColor,
          onClick: re,
        }),
    (0, X.jsx)(`main`, {
        ...
        children: [
          ie
            ? (0, X.jsx)(`div`, {
                ...
                children: (0, X.jsxs)(j.div, {
                  animate: { opacity: T ? 1 : 0, scale: T || C ? 1 : 0.97, y: T || C ? 0 : 8 },
                  className: `relative overflow-hidden [corner-shape:superellipse(1.5)]`,
                  "data-avatar-overlay-size": `notification-tray`,
                  initial: !1,
                  style: { maxHeight: se, transformOrigin: E },
                  transition: C
                    ? { duration: 0 }
          ...
          (0, X.jsx)(N, {
            ...
            children: (0, X.jsx)(`div`, {
              ...
              children: (0, X.jsx)(L, {
                ariaLabel: S.formatMessage(Z.mascotLabel, { petName: e.displayName }),
                assetRef: e.assetRef,
                spritesheetUrl: e.spritesheetUrl,
                notificationBadge: D,
                resizeHandle:
                  l == null ? void 0 : { ariaLabel: S.formatMessage(Z.resizeMascot), ...l },
                state: w.mascotState,
                style: s,
                transientState: c,
              }),
...
function mt(e) {
  let t = (0, B.c)(69),
    ...
    p = (0, V.useRef)(null),
    m;
  t[0] !== f || t[1] !== r ? ((m = Ke(r, f)), (t[0] = f), (t[1] = r), (t[2] = m)) : (m = t[2]);
  let g = m,
    _ = r.length > at,
    v = Math.max(0, r.length - at),
    y;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = {
      ...
      (t[3] = y))
    : (y = t[3]);
  let [b, x] = (0, V.useState)(y),
    [te, re] = (0, V.useState)(null),
    S = (0, V.useRef)(null),
    C;
  t[4] !== r || t[5] !== te
    ? ((C = r.some((e) => e.id === te) ? te : null), (t[4] = r), (t[5] = te), (t[6] = C))
    : (C = t[6]);
  let w = C,
    ie = w != null && n,
    T,
  ...
  (t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = () => {
      ...
      (t[12] = se))
    : ((oe = t[11]), (se = t[12])),
    ee(`avatar-overlay-keyboard-interaction-ready`, oe, se));
  let E = Math.min(b.hiddenOlderNotificationCount, v),
    D = b.hasScrollableContent,
    O = D && _ && b.hasLatestNotificationsAbove,
    k = D && _ && E > 0,
    A = D && _,
    le;
  ...
  let fe;
  (t[16] !== g || t[17] !== d
    ? ((fe = [g, d, ue]), (t[16] = g), (t[17] = d), (t[18] = fe))
    : (fe = t[18]),
    (0, V.useLayoutEffect)(N, fe));
  let pe;
  t[19] === u
    ? (pe = t[20])
    : ((pe = () => {
        let e = p.current;
        e != null && (e.scrollTo({ behavior: u ? `auto` : `smooth`, top: 0 }), x(Dt(e, 0)));
      }),
      (t[19] = u),
      (t[20] = pe));
  let me = pe,
  ...
  t[21] !== E || t[22] !== u
    ? ((he = () => {
        ...
        if (e == null) return;
        let t = _t(e, E);
        (e.scrollTo({ behavior: u ? `auto` : `smooth`, top: t }), x(Dt(e, t)));
      }),
      (t[21] = E),
      (t[22] = u),
      (t[23] = he))
  ...
  let ge = he,
    P;
  t[24] !== O || t[25] !== u || t[26] !== me
    ? ((P = O ? (0, X.jsx)(ht, { prefersReducedMotion: u, onClick: me }, `latest`) : null),
      (t[24] = O),
      (t[25] = u),
      (t[26] = me),
      (t[27] = P))
    : (P = t[27]);
  let F;
  t[28] === P ? (F = t[29]) : ((F = (0, X.jsx)(ce, { children: P })), (t[28] = P), (t[29] = F));
  let _e = n ? 1 : 0,
    I = n || u ? 0 : 3,
    L;
  t[30] !== _e || t[31] !== I
    ? ((L = { opacity: _e, y: I }), (t[30] = _e), (t[31] = I), (t[32] = L))
    : (L = t[32]);
  let R;
  t[33] === f ? (R = t[34]) : ((R = f.formatMessage(Z.notificationList)), (t[33] = f), (t[34] = R));
  let ve = A && `vertical-scroll-fade-mask snap-y snap-mandatory`,
    ye;
  t[35] === ve
    ? (ye = t[36])
    : ((ye = h(
      ...
      (t[36] = ye));
  let z;
  t[37] === d ? (z = t[38]) : ((z = { maxHeight: d }), (t[37] = d), (t[38] = z));
  let be;
  t[39] === u
    ? (be = t[40])
    : ((be = u ? { duration: 0 } : { duration: 0.16, ease: `easeOut` }), (t[39] = u), (t[40] = be));
  let xe;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = (e) => {
        let t = Dt(e.currentTarget);
        x((e) => (Ot(e, t) ? e : t));
      }),
      (t[41] = xe))
    : (xe = t[41]);
  ...
  t[49] !== u
    ...
    : (H = t[50]);
  let U;
  t[51] !== L || t[52] !== R || t[53] !== ye || t[54] !== z || t[55] !== be || t[56] !== H
    ? ((U = (0, X.jsx)(j.div, {
        ref: de,
        animate: L,
        "aria-label": R,
    ...
    : (U = t[57]);
  let Se;
  t[58] !== k || t[59] !== E || t[60] !== u || t[61] !== ge
    ? ((Se = k
        ? (0, X.jsx)(gt, { count: E, prefersReducedMotion: u, onClick: ge }, `older`)
        : null),
      (t[58] = k),
      (t[59] = E),
      (t[60] = u),
  ...
  t[63] === Se
    ? (Ce = t[64])
    : ((Ce = (0, X.jsx)(ce, { children: Se })), (t[63] = Se), (t[64] = Ce));
  let we;
  return (
    t[65] !== F || t[66] !== U || t[67] !== Ce
      ? ((we = (0, X.jsxs)(`div`, { className: `relative`, children: [F, U, Ce] })),
        (t[65] = F),
        (t[66] = U),
        (t[67] = Ce),
        (t[68] = we))
...
function ht(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = i.formatMessage(Z.showLatestNotifications)), (t[0] = i), (t[1] = a));
  let o;
  ...
  t[14] === i
    ? (g = t[15])
    : ((g = i.formatMessage(Z.latestNotifications)), (t[14] = i), (t[15] = g));
  let _;
  t[16] === g ? (_ = t[17]) : ((_ = (0, X.jsx)(`span`, { children: g })), (t[16] = g), (t[17] = _));
  let v;
...
function gt(e) {
  let t = (0, B.c)(36),
    ...
    o;
  t[0] !== n || t[1] !== a
    ? ((o = a.formatMessage(Z.showOlderNotifications, { count: n })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = h(dt, `bottom-1 min-w-9`)), (t[10] = p))
    : (p = t[10]);
  let m;
  t[11] === i ? (m = t[12]) : ((m = i ? void 0 : { scale: 1.03 }), (t[11] = i), (t[12] = m));
  let g;
  t[13] === i ? (g = t[14]) : ((g = i ? void 0 : { scale: 0.96 }), (t[13] = i), (t[14] = g));
  let _;
  t[15] !== n || t[16] !== a
    ? ((_ = a.formatMessage(Z.compactOlderNotificationCount, { count: n })),
      (t[15] = n),
      (t[16] = a),
      (t[17] = _))
    : (_ = t[17]);
  ...
  let y;
  t[20] !== n || t[21] !== a
    ? ((y = a.formatMessage(Z.olderNotificationCount, { count: n })),
      (t[20] = n),
      (t[21] = a),
      (t[22] = y))
    : (y = t[22]);
...
function _t(e, t) {
  if (t <= at) return e.scrollHeight;
  let n = Nt(e);
  return n[Ft(n, Pt(e, n)) + at]?.offsetTop ?? e.scrollHeight;
}
function vt({
  isReplying: e,
  notification: t,
  ...
  let f = ne(),
    ...
    m = v(o, p),
    g = m == null ? null : et(m.items, f),
    _ = Ye(t),
    y = f.formatMessage(_.labelMessage),
    b = g ?? t.body ?? f.formatMessage(_.fallbackBodyMessage),
    x = t.waitingRequest,
    ee = x == null ? b : De(x, f),
    te = ee.replace(/[.?!]+$/, ``),
    re = ee === y ? y : `${y}. ${te}`,
    S =
      t.action == null
        ? `${t.title}. ${re}`
        : `${t.title}. ${re}. ${f.formatMessage(Z.openNotification)}`,
    C = t.action != null,
    [w, ie] = (0, V.useState)(!1),
    [T, ae] = (0, V.useState)(!1),
    [oe, se] = (0, V.useState)(``),
    ...
    [N, fe] = (0, V.useState)(!1),
    pe = (0, V.useRef)(w),
    me = (0, V.useRef)(void 0),
    he = x == null ? st : ct,
    ge = (0, V.useCallback)((e) => {
      if ((me.current?.(), (me.current = void 0), e == null)) return;
      let t = () => {
      ...
      (t(), (me.current = Te({ axis: `both`, target: e, onChange: t })));
    }, []);
  (0, V.useLayoutEffect)(() => {
    pe.current = w;
  }, [w]);
  let P = le > he + ut || N,
    F = P && w && !e,
    _e = t.replyTarget != null && l != null,
    I = oe.trim(),
    L = u ? { duration: 0 } : { duration: A ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    R = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!_e || I.length === 0 || T))) {
        (ae(!0), O(null));
        try {
          (await l(t, I), se(``), i());
        } catch {
          O(f.formatMessage(Z.notificationReplyError));
        } finally {
          ae(!1);
        }
      }
    };
  return (0, X.jsx)(j.div, {
    ...
    transition: u
      ? { duration: 0 }
      : { delay: Math.min(n, 3) * ot, duration: 0.18, ease: `easeOut` },
    onBlurCapture: (e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.contains(t)) || ce(!1);
    },
    onFocusCapture: () => {
      ce(!0);
    },
      ...
      children: [
        (0, X.jsxs)(j.div, {
          ...
          children: [
            ...
            (0, X.jsx)(j.div, {
              ref: ge,
              animate: { maxHeight: F ? lt : he },
              className: h(
                `text-size-chat-sm mt-0.5 overflow-hidden leading-4 text-token-foreground`,
                F ? `whitespace-pre-wrap` : x == null ? `line-clamp-2` : void 0,
              ),
        ...
        (0, X.jsx)(`span`, {
          role: `img`,
          "aria-label": x?.kind === `question` ? f.formatMessage(Z.questionStatusIcon) : y,
          className: h(
            `pointer-events-none absolute top-1 right-1 z-0 flex size-6 items-center justify-center opacity-100`,
            P && A && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
          ),
          children: x?.kind === `question` ? (0, X.jsx)(ye, { className: _.iconClassName }) : It(_),
        }),
        P
          ? (0, X.jsx)(j.div, {
              animate: { opacity: A ? 1 : 0, x: A ? 0 : 6 },
              className: h(
              ...
              children: (0, X.jsx)(E, {
                ...
                tooltipContent: f.formatMessage(
                  w ? Z.collapseNotificationTooltip : Z.expandNotificationTooltip,
                ),
                children: (0, X.jsx)(k, {
                  className: h(`size-6`, ft),
                  color: `ghost`,
                  size: `icon`,
                  "aria-expanded": w,
                  "aria-label": f.formatMessage(w ? Z.collapseNotification : Z.expandNotification, {
                    title: t.title,
                  }),
                  onClick: () => {
                    ie((e) => !e);
                  },
                  children: (0, X.jsx)(j.span, {
                    animate: { rotate: w ? 90 : 0 },
                    transition: u ? { duration: 0 } : { duration: 0.12, ease: `easeOut` },
                    children: (0, X.jsx)(de, { className: `icon-xs` }),
                  }),
                }),
              }),
            })
          ...
          ? (0, X.jsx)(j.div, {
              ...
              children: (0, X.jsx)(`div`, {
                ...
                children: (0, X.jsx)(k, {
                  ...
                  color: `outline`,
                  size: `default`,
                  "aria-label": f.formatMessage(Z.replyNotification, { title: t.title }),
                  onClick: (e) => {
                    (e.stopPropagation(), O(null), se(``), a(), ce(!0));
                  },
                  onPointerDown: (e) => {
                    e.stopPropagation();
                  },
                  children: f.formatMessage(Z.replyNotificationButton),
                }),
              }),
            })
          : null,
                ...
                (0, X.jsxs)(`div`, {
                  ...
                  children: [
                    (0, X.jsx)(`input`, {
                      ...
                      "aria-label": f.formatMessage(Z.replyNotification, { title: t.title }),
                      autoFocus: !0,
                      placeholder: f.formatMessage(Z.notificationReplyPlaceholder),
                      value: oe,
                      onChange: (e) => {
                        (se(e.currentTarget.value), O(null));
                      },
                      onKeyDown: (e) => {
                        e.key !== `Escape` || T || (e.stopPropagation(), i(), O(null));
                      },
                    }),
                    (0, X.jsx)(k, {
                      ...
                      size: `default`,
                      type: `submit`,
                      "aria-label": f.formatMessage(Z.sendNotificationReply, { title: t.title }),
                      disabled: I.length === 0 || T,
                      loading: T,
                      children: f.formatMessage(Z.replyNotificationButton),
                    }),
                  ],
        ...
        r
          ? (0, X.jsx)(j.div, {
              ...
              children: (0, X.jsx)(E, {
                align: `start`,
                side: `top`,
                tooltipContent: f.formatMessage(Z.dismissNotificationTooltip),
                children: (0, X.jsx)(k, {
                  className: h(
                  ...
                  color: `outline`,
                  size: `icon`,
                  "aria-label": f.formatMessage(Z.dismissNotification, { title: t.title }),
                  onClick: () => {
                    r(t);
                  },
                  children: (0, X.jsx)(ue, { className: `icon-xs` }),
                }),
              }),
            })
          : null,
...
function yt(e) {
  ...
  switch (o.kind) {
    case `question`: {
      ...
      let s;
      t[4] !== o.prompt || t[5] !== r
        ? ((s = (0, X.jsx)(`div`, { className: r, children: o.prompt })),
          (t[4] = o.prompt),
          (t[5] = r),
          (t[6] = s))
        : (s = t[6]);
      let c;
      t[7] === o.options ? (c = t[8]) : ((c = o.options.map(bt)), (t[7] = o.options), (t[8] = c));
      let l;
      t[9] !== i || t[10] !== a
        ? ((l = (e) => {
      ...
      let u;
      t[12] !== c || t[13] !== l
        ? ((u = (0, X.jsx)($, { actions: c, onRunNotificationAction: l })),
          (t[12] = c),
          (t[13] = l),
          (t[14] = u))
        : (u = t[14]);
    ...
    case `patch`: {
      ...
      t[25] !== o.actions || t[26] !== c
        ? ((r = (0, X.jsx)($, { actions: o.actions, onRunNotificationAction: c })),
          (t[25] = o.actions),
          (t[26] = c),
          (t[27] = r))
        : (r = t[27]);
    ...
    case `exec`: {
      ...
      t[36] !== n || t[37] !== o.summary
        ? ((e = (0, X.jsx)(St, { isExpanded: n, text: o.summary })),
          (t[36] = n),
          (t[37] = o.summary),
          (t[38] = e))
        : (e = t[38]);
    ...
    case `network`: {
      ...
      t[45] !== n || t[46] !== o.target
        ? ((e = (0, X.jsx)(St, { isExpanded: n, text: o.target })),
          (t[45] = n),
          (t[46] = o.target),
          (t[47] = e))
        : (e = t[47]);
    ...
    case `tool`: {
      let e = o.summary ?? o.target,
        r;
      t[63] !== n || t[64] !== e
        ? ((r = (0, X.jsx)(St, { isExpanded: n, text: e })), (t[63] = n), (t[64] = e), (t[65] = r))
        : (r = t[65]);
      let i;
      t[66] !== o.actions || t[67] !== c
        ? ((i = (0, X.jsx)($, { actions: o.actions, onRunNotificationAction: c })),
          (t[66] = o.actions),
          (t[67] = c),
          (t[68] = i))
        : (i = t[68]);
...
function xt(e) {
  ...
  if (t[0] !== o || t[1] !== n || t[2] !== a.actions || t[3] !== a.kind || t[4] !== a.summary) {
    ...
    ((l = a.kind),
      t[9] !== n || t[10] !== a.summary
        ? ((u = (0, X.jsx)(St, { isExpanded: n, text: a.summary })),
          (t[9] = n),
          (t[10] = a.summary),
          (t[11] = u))
        : (u = t[11]),
  ...
  t[12] !== s || t[13] !== i || t[14] !== c
    ? ((d = (0, X.jsx)(s, { actions: c, onRunNotificationAction: i })),
      (t[12] = s),
      (t[13] = i),
      (t[14] = c),
      (t[15] = d))
...
function Ct(e) {
  let t = (0, B.c)(40),
    ...
    l;
  t[0] !== i || t[1] !== c
    ? ((l = c.formatMessage(Z.compactPatchFileCount, { count: i })),
      (t[0] = i),
      (t[1] = c),
      (t[2] = l))
    : (l = t[2]);
  let u = l,
    d;
  t[3] !== n || t[4] !== c
    ? ((d = n > 0 ? c.formatMessage(Z.compactPatchAdditions, { count: n }) : null),
      (t[3] = n),
      (t[4] = c),
      (t[5] = d))
    : (d = t[5]);
  let f = d,
    p;
  t[6] !== r || t[7] !== c
    ? ((p = r > 0 ? c.formatMessage(Z.compactPatchDeletions, { count: r }) : null),
      (t[6] = r),
      (t[7] = c),
      (t[8] = p))
    : (p = t[8]);
  ...
  if (!o) {
    let e;
    t[9] === u ? (e = t[10]) : ((e = (0, X.jsx)(`span`, { children: u })), (t[9] = u), (t[10] = e));
    let n;
    t[11] === f
      ? (n = t[12])
      : ((n =
          f == null
            ? null
            : (0, X.jsx)(`span`, { className: `ml-1.5 text-token-charts-green`, children: f })),
        (t[11] = f),
        (t[12] = n));
    let r;
    t[13] === m
      ...
      : ((r =
          m == null
            ? null
            : (0, X.jsx)(`span`, { className: `ml-1.5 text-token-error-foreground`, children: m })),
        (t[13] = m),
        (t[14] = r));
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, X.jsx)(P, { className: `mx-1.5 text-token-text-tertiary` })), (t[15] = i))
      : (i = t[15]);
    let a;
    t[16] === s
      ? (a = t[17])
      : ((a = (0, X.jsx)(`span`, { children: s })), (t[16] = s), (t[17] = a));
    let o;
    return (
  ...
  t[29] !== h || t[30] !== g || t[31] !== _
    ...
    : (v = t[32]);
  let y;
  t[33] === a ? (y = t[34]) : ((y = a.map(wt)), (t[33] = a), (t[34] = y));
  let b;
  t[35] === y
    ? (b = t[36])
    : ((b = (0, X.jsx)(`div`, {
...
function wt(e) {
  return (0, X.jsx)(`div`, { className: `leading-4 break-words`, children: e }, e);
}
function $(e) {
  let t = (0, B.c)(7),
      ...
      : ((e = (e) =>
          (0, X.jsx)(
            k,
            {
              ...
              onPointerDown: Tt,
              children: (0, X.jsx)(`span`, { className: `truncate`, children: e.label }),
            },
            e.ariaLabel ?? e.label,
          )),
        (t[3] = r),
...
function Dt(e, t = e.scrollTop) {
  ...
  return {
    hasScrollableContent: !0,
    hasLatestNotificationsAbove: t > Q,
...
function At(e) {
  return e.scrollHeight > e.clientHeight + Q;
}
function jt(e) {
  return [e, ...Array.from(e.querySelectorAll(`*`))].some(
    (e) => e.clientWidth > 0 && e.scrollWidth > e.clientWidth + ut,
  );
}
function Mt(e, t, n) {
  let r = n + e.clientHeight - Q;
  return t.filter((e) => e.offsetTop + e.offsetHeight > r).length;
}
function Nt(e) {
  return Array.from(e.children).filter((e) => e instanceof HTMLElement);
}
function Pt(e, t, n = e.scrollTop) {
  return n + (t[0]?.offsetTop ?? 0) + Q;
}
function Ft(e, t) {
  let n = 0;
...
function It(e) {
  switch (e.iconType) {
    case `check-circle`:
      return (0, X.jsx)(M, { className: e.iconClassName });
    case `clock`:
      return (0, X.jsx)(me, { className: e.iconClassName });
    case `spinner`:
      return (0, X.jsx)(A, { className: e.iconClassName });
    case `warning`:
      return (0, X.jsx)(ge, { className: e.iconClassName });
  }
}
var Lt = 192 / 208,
  Rt = `--opaline-avatar-width`,
  zt = 80,
  Bt = 224,
  Vt = D(`avatar-overlay-mascot-width-px`, null);
function Ht() {
  let e = (0, B.c)(7),
    [t, n] = te(Vt),
    r;
  e[0] === t ? (r = e[1]) : ((r = t == null ? null : Wt(t)), (e[0] = t), (e[1] = r));
  let i;
  e[2] === n
    ? (i = e[3])
    : ((i = (e) => {
...
function Ut(e) {
  if (e != null) return { [Rt]: `${Wt(e)}px` };
}
function Wt(e) {
  return Number.isFinite(e) ? Math.round(Math.min(Bt, Math.max(zt, e))) : 112;
}
var Gt = 180 * 1e3,
  Kt = 3600 * 1e3,
  qt = 1440 * 60 * 1e3,
...
function Xt({
  ...
  for (let t of r) {
    let r = Qt(t, n);
    r != null && e?.get(r.notification.id) !== r.notification.turnKey && i.push(r);
  }
  return {
    ...
    notifications: i.sort(nn).map((e) => e.notification),
  };
}
function Zt({ intl: e, petName: t, startedAtMs: n }) {
  return {
    action: null,
    body: e.formatMessage({
      id: `avatarOverlay.firstAwake.body`,
      defaultMessage: `I'm here to help keep your Opaline sessions moving`,
      description: `Body of the temporary greeting shown when the floating Opaline pet is first opened`,
    }),
    expiresAtMs: n + Yt,
    id: `first-awake`,
    isLoading: !1,
    ...
    title: e.formatMessage(
      {
        ...
        description: `Title of the temporary greeting shown when the floating Opaline pet is first opened`,
      },
      { petName: t },
    ),
    turnKey: null,
...
function Qt(e, t) {
  ...
  let n = en(e.status, e.updatedAtMs);
  return n != null && t >= n
    ? null
    : {
        expiresAtMs: n,
        ...
        notification: {
          ...
          replyTarget:
            e.localConversationId == null ? null : { conversationId: e.localConversationId },
          source: e.source,
          title: $t(e),
          turnKey: e.turnKey,
        ...
        notificationPriority: rn(e.status),
        updatedAtMs: e.updatedAtMs,
      };
}
function $t(e) {
...
var an = 15e3,
  on = `first-awake-pet-notification-avatar-ids`,
  sn = 4,
  cn = [`[data-avatar-overlay-hit-region]`, `[data-avatar-mascot='true']`],
  ln = `.opaline-avatar-root`,
  un = `[data-avatar-overlay-size='notification-tray']`,
  dn = `[data-avatar-overlay-size='notification-tray-header']`,
  fn = `[data-avatar-overlay-size='notification-tray-list']`,
  pn = `[data-avatar-overlay-measure='notification-tray-row']`,
  mn = `opaline-avatar-overlay-force-resize-cursor`,
  hn = [ln, un, dn, fn, pn],
  gn = {
...
function _n() {
  let e = (0, B.c)(9),
    { avatarOptions: t, isLoading: n, refetch: r } = R(),
    { selectedAvatar: i, selectedAvatarId: a } = I(t),
    o;
  e[0] !== i || e[1] !== a ? ((o = An(i, a)), (e[0] = i), (e[1] = a), (e[2] = o)) : (o = e[2]);
  let s;
  return (
...
function vn(e) {
  let t = (0, B.c)(148),
    { isLoading: r, refetch: i, selectedAvatar: a, selectedAvatarId: o } = e,
    p = g(b),
    m = ne(),
    h = ae(`451951815`),
    v = _(T),
    [x, te] = (0, V.useState)(gn),
    [S, E] = (0, V.useState)(null),
    [D, O] = (0, V.useState)(!0),
    [k, A] = (0, V.useState)(!1),
    [j, ce] = (0, V.useState)(!1),
    [le, ue] = (0, V.useState)(!1),
    [M, de] = (0, V.useState)(null),
    { mascotWidthPx: N, setMascotWidthPx: pe } = Ht(),
    [me, he] = (0, V.useState)(Dn),
    [ge, P] = (0, V.useState)(En),
    F;
  t[0] !== a || t[1] !== o
    ? ((F = () => kn(a, o)), (t[0] = a), (t[1] = o), (t[2] = F))
    : (F = t[2]);
  let [I] = (0, V.useState)(F),
    { data: L, refetch: R } = oe(),
    ye = L === void 0 ? [] : L,
    z;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = { taskFilter: `current`, limit: 20 }), (t[3] = z))
    : (z = t[3]);
  let { data: be, refetch: xe } = se(z),
    H = Xe({
      includeCompactWaitingRequests: h,
      intl: m,
      localConversations: ye,
      remoteTasks: be === void 0 ? [] : be,
    }),
    we = I == null ? null : Zt({ intl: m, petName: I.petName, startedAtMs: I.startedAtMs }),
    { nextNotificationExpiresAtMs: Te, notifications: W } = Xt({
      dismissedNotificationTurnKeys: me,
      extraNotifications: we == null ? [] : [we],
      nowMs: ge,
      sessions: H,
    }),
    Ee = Ke(W, m),
    ...
    Le = (0, V.useRef)(!1),
    Re;
  t[4] !== De || t[5] !== Oe || t[6] !== D || t[7] !== W.length || t[8] !== v || t[9] !== a
    ? ((Re = (e, t, n, r) => {
        let i = r === void 0 ? D : r;
        v.logProductEvent(
          d,
          _e({
            action: e,
            hasRunningCloudSession: Oe,
            hasRunningLocalSession: De,
  ...
  (t[11] === I
    ...
    : ((ze = () => {
        if (I == null) return;
        let e = w(on, []);
        e.includes(I.avatarId) || ie(on, [...e, I.avatarId]);
      }),
      (Be = [I]),
      (t[11] = I),
      (t[12] = ze),
    ...
    (0, V.useEffect)(ze, Be));
  let Ve, He;
  (t[14] !== r || t[15] !== i || t[16] !== a.id || t[17] !== o
    ? ((Ve = () => {
        !r && o?.startsWith(`custom:`) && a.id !== o && i();
      }),
      (He = [r, i, a.id, o]),
      (t[14] = r),
      (t[15] = i),
  ...
  (t[20] !== v || t[21] !== G
    ? ((Ue = () => {
        Le.current ||
          (v !== C &&
            ((Le.current = !0),
            G(f.OPALINE_AVATAR_OVERLAY_ACTION_OPENED, c.OPALINE_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
      }),
      (We = [v, G]),
      (t[20] = v),
      (t[21] = G),
  ...
  (t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ge = {
        interactiveRegionRef: Fe,
        isPaused: () => ke.current != null || Ae.current != null,
        onInteractiveChange: Cn,
        regionElementSelectors: cn,
      }),
      (t[24] = Ge))
    : (Ge = t[24]),
    ve(Ge));
  let K;
  t[25] !== D || t[26] !== W.length
    ? ((K = () => {
        if (Ae.current != null || Ne.current != null) return;
        let e = Nn(Fe.current);
        if (e == null) return;
        let t = { ...e, isTrayVisible: D && W.length > 0 };
        Ln(Ie.current, t) ||
          ((Ie.current = t),
          y.dispatchMessage(`avatar-overlay-element-size-changed`, {
  ...
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((J = () => {
        Pe.current != null && (window.clearTimeout(Pe.current), (Pe.current = null));
      }),
      (t[28] = J))
    : (J = t[28]);
  let qe = J,
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Je = () => {
        (je.current != null && (window.cancelAnimationFrame(je.current), (je.current = null)),
          (Me.current = null));
      }),
      (t[29] = Je))
    : (Je = t[29]);
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Y = (e) => {
        ((Me.current = e),
          (je.current ??= window.requestAnimationFrame(() => {
            je.current = null;
            let e = Me.current;
            ((Me.current = null),
              !(e == null || Ae.current == null) &&
                y.dispatchMessage(`avatar-overlay-mascot-resize-move`, { width: e }));
          })));
      }),
      (t[30] = Y))
    : (Y = t[30]);
    ...
    : ((Qe = (e) => {
        ((Ne.current = e),
          ...
          (Pe.current = window.setTimeout(() => {
            ((Pe.current = null), (Ne.current = null), de(null), q());
          }, 100)));
      }),
      (t[31] = q),
      (t[32] = Qe));
  ...
  t[33] === N
    ? (et = t[34])
    : ((et = () => Fn(Fe.current?.querySelector(ln) ?? null)?.width ?? N ?? 112),
      (t[33] = N),
      (t[34] = et));
  let tt = et,
    nt;
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((nt = (e, t) => {
        ...
        n == null ||
          n.pointerId !== e ||
          ((Ae.current = null), ce(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
      }),
      (t[35] = nt))
    : (nt = t[35]);
  let rt = nt,
  ...
  t[36] !== pe || t[37] !== $e
    ? ((it = (e, t) => {
        ...
        let r = t == null ? n.currentWidthPx : On(n, t);
        ((n.currentWidthPx = r),
          Ye(),
          de(r),
          pe(r),
          $e(r),
          y.dispatchMessage(`avatar-overlay-mascot-resize-end`, { width: r }));
      }),
      (t[36] = pe),
      (t[37] = $e),
      (t[38] = it))
  ...
  t[39] === G
    ...
    : ((at = (e, t) => {
        ...
        ((ke.current = null), A(!1), E(null));
        let a = n == null ? null : Se(i, n);
        (Fe.current?.hasPointerCapture?.(e) && Fe.current.releasePointerCapture?.(e),
          r &&
            i.startedOnMascot &&
            !i.hasMoved &&
            (G(f.OPALINE_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, c.OPALINE_AVATAR_OVERLAY_SOURCE_MASCOT),
            y.dispatchMessage(`open-current-main-window`, {})),
          y.dispatchMessage(`avatar-overlay-drag-end`, {}),
          i.hasMoved &&
            G(f.OPALINE_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, c.OPALINE_AVATAR_OVERLAY_SOURCE_MASCOT),
          a != null &&
            y.dispatchMessage(`avatar-overlay-drag-release`, { velocityX: a.x, velocityY: a.y }));
      }),
      (t[39] = G),
      (t[40] = at));
  let Q = at,
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ot = (e) => {
        e.button !== 0 ||
          ...
          y.dispatchMessage(`avatar-overlay-drag-start`, {
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ct = (e) => {
        ...
        let n = U(e);
        t.samples = Ce([...t.samples, n]);
        let r = n.screenX - t.screenX,
          i = n.screenY - t.screenY;
        (Math.abs(r) < sn && Math.abs(i) < sn) ||
          ((t.hasMoved = !0),
          (t.screenX = n.screenX),
          (t.screenY = n.screenY),
          E((e) => Mn({ currentDragState: e, deltaX: r })),
          y.dispatchMessage(`avatar-overlay-drag-move`, {}));
      }),
      (t[42] = ct))
    : (ct = t[42]);
  let lt = ct,
  ...
  t[43] === Q
    ? (ut = t[44])
    : ((ut = (e) => {
        Q(e.pointerId, { releaseSample: U(e), shouldOpenMainWindow: !0 });
      }),
      (t[43] = Q),
      (t[44] = ut));
  let dt = ut,
  ...
  t[45] === Q
    ? (ft = t[46])
    : ((ft = (e) => {
        Q(e.pointerId, { shouldOpenMainWindow: !1 });
      }),
      (t[45] = Q),
      (t[46] = ft));
  let mt = ft,
  ...
  t[49] === tt
    ...
    : ((_t = (e) => {
        ...
        (qe(),
          ...
          de(t),
          ce(!0),
          y.dispatchMessage(`avatar-overlay-mascot-resize-start`, { width: t }));
      }),
      (t[49] = tt),
      (t[50] = _t));
  let vt = _t,
  ...
  t[51] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((yt = (e) => {
        ...
        let n = On(t, e.screenX);
        ((t.currentWidthPx = n), de(n), Ze(n));
      }),
      (t[51] = yt))
    : (yt = t[51]);
  let bt = yt,
  ...
  t[52] === Z
    ? (xt = t[53])
    : ((xt = (e) => {
        (Z(e.pointerId, e.screenX), rt(e.pointerId, e.currentTarget));
      }),
      (t[52] = Z),
      (t[53] = xt));
  let St = xt,
  ...
  t[54] === Z
    ? (Ct = t[55])
    : ((Ct = (e) => {
        (e.stopPropagation(), Z(e.pointerId), rt(e.pointerId, e.currentTarget));
      }),
      (t[54] = Z),
      (t[55] = Ct));
  let wt = Ct,
  ...
  t[56] === Z
    ? ($ = t[57])
    : (($ = (e) => {
        (Z(e.pointerId), rt(e.pointerId));
      }),
      (t[56] = Z),
      (t[57] = $));
  let Tt = $,
    Et;
  t[58] !== R || t[59] !== p || t[60] !== G
    ? ((Et = (e, t) => {
            ...
            case `mcp-elicitation`:
              if (t.mcpElicitationAction != null && r?.kind === `tool`) {
                u(`reply-with-mcp-server-elicitation-response`, {
                  conversationId: i,
                  requestId: r.requestId,
                  response: s(t.mcpElicitationAction),
                }).then(() => {
                  R();
                });
                return;
        ...
        (t != null && t.intent !== `open`) ||
          (e.action != null &&
            (G(
              f.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_OPENED,
              c.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_ROW,
              e,
            ),
            y.dispatchMessage(`open-in-main-window`, { path: e.action.path })));
      }),
      (t[58] = R),
      (t[59] = p),
      (t[60] = G),
  ...
  t[64] === G
    ...
    : ((At = (e) => {
        (G(
          f.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_DISMISSED,
          c.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_ROW,
          e,
        ),
          he((t) => {
  ...
  t[66] !== p || t[67] !== G
    ? ((Mt = async (e, t) => {
        ...
        r.length !== 0 &&
          (G(
            f.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_SUBMITTED,
            c.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY,
            e,
          ),
          await u(`send-follow-up-message`, {
            conversationId: e.replyTarget.conversationId,
            prompt: r,
            serviceTier: await fe(p, p.get(n, e.replyTarget.conversationId) ?? `local`, null),
          }));
      }),
      (t[66] = p),
      (t[67] = G),
  ...
  (t[69] === q
    ...
    : ((Ft = (e) => {
        let { layout: t } = e;
        (te(t),
          Ne.current === t.mascot.width &&
            ((Ne.current = null), qe(), de(null), window.requestAnimationFrame(q)));
      }),
      (It = [qe, q]),
      (t[69] = q),
      (t[70] = Ft),
      (t[71] = It)),
    ee(`avatar-overlay-layout-changed`, Ft, It));
  let Rt, zt;
  (t[72] !== le || t[73] !== j
    ? ((Rt = () => {
        let e = le || j;
  ...
  (t[78] !== Z || t[79] !== Q
    ? ((Wt = () => {
        let e = (e) => {
            (Q(e.pointerId, { releaseSample: U(e), shouldOpenMainWindow: !0 }),
              Z(e.pointerId, e.screenX),
              rt(e.pointerId));
          },
          t = (e) => {
            (Q(e.pointerId, { shouldOpenMainWindow: !1 }), Z(e.pointerId), rt(e.pointerId));
          };
        return (
  ...
  t[82] === q
    ...
    : ((Kt = () => {
      ...
      (t[83] = Kt));
  let qt;
  (t[84] !== Ee || t[85] !== q || t[86] !== a.id
    ? ((qt = [q, a.id, Ee]), (t[84] = Ee), (t[85] = q), (t[86] = a.id), (t[87] = qt))
    : (qt = t[87]),
    (0, V.useLayoutEffect)(Kt, qt));
  let Jt;
  t[88] === q
    ? (Jt = t[89])
    : ((Jt = () => {
      ...
      (t[89] = Jt));
  let Yt;
  (t[90] !== D || t[91] !== N || t[92] !== Ee || t[93] !== q || t[94] !== a.id
    ? ((Yt = [D, q, a.id, Ee, N]),
      (t[90] = D),
      (t[91] = N),
      (t[92] = Ee),
      ...
      (t[95] = Yt))
    : (Yt = t[95]),
    (0, V.useLayoutEffect)(Jt, Yt));
  let Qt, $t;
  (t[96] === Te
    ? ((Qt = t[97]), ($t = t[98]))
    : ((Qt = () => {
        if (Te == null) return;
        let e = Math.max(0, Te - Date.now()),
          t = window.setTimeout(() => {
            P(bn);
          }, e);
        return () => {
    ...
    (0, V.useEffect)(Qt, $t));
  let en, tn;
  (t[99] !== De || t[100] !== Oe || t[101] !== R || t[102] !== xe
    ? ((en = () => {
        if (!De && !Oe) return;
  ...
  t[105] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((nn = re({
        ...
        description: `Context menu item that closes the floating Opaline pet`,
      })),
      (t[105] = nn))
    : (nn = t[105]);
  let rn;
    ...
    : ((rn = [
        {
          ...
          onSelect: () => {
            (G(
              f.OPALINE_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED,
              c.OPALINE_AVATAR_OVERLAY_SOURCE_CONTEXT_MENU,
            ),
      ...
      (t[107] = rn));
  let un;
  t[108] !== j || t[109] !== x.mascot || t[110] !== M
    ? ((un = j && M != null ? { ...x.mascot, height: Math.ceil(M / Lt), width: M } : x.mascot),
      (t[108] = j),
      (t[109] = x.mascot),
      (t[110] = M),
      (t[111] = un))
  ...
  t[112] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((dn = t[112]), (fn = t[113]));
  let pn;
  t[114] !== Tt || t[115] !== wt || t[116] !== vt || t[117] !== St
    ? ((pn = {
  ...
  let hn = M ?? N,
    _n;
  t[119] === hn ? (_n = t[120]) : ((_n = Ut(hn)), (t[119] = hn), (t[120] = _n));
  let vn;
  t[121] === G
    ? (vn = t[122])
    : ((vn = () => {
        (G(
          f.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_TRAY_CLOSED,
          c.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_BADGE,
          void 0,
          !1,
        ),
          O(!1));
  ...
  t[123] === G
    ...
    : ((An = (e) => {
        G(
          f.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_OPENED,
          c.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY,
          e,
        );
      }),
  ...
  t[125] === G
    ...
    : ((jn = () => {
        (G(
          f.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_TRAY_OPENED,
          c.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_BADGE,
          void 0,
          !0,
        ),
  ...
  return (
    ...
    t[146] !== jn
      ? ((In = (0, X.jsx)(pt, {
          ...
          mascotDragState: S,
          mascotLayout: un,
          mascotResizeHandle: pn,
          mascotStyle: _n,
          notifications: W,
          onCloseNotificationTray: vn,
          onLostPointerCapture: gt,
          onPointerCancel: mt,
          onPointerDown: st,
          onPointerMove: lt,
          onPointerUp: dt,
          onDismissNotification: jt,
          onNotificationReplyEditorActiveChange: Pt,
          onOpenNotificationReply: An,
          onRunNotificationAction: Dt,
          onSubmitQuestionOption: kt,
          onSubmitNotificationReply: Nt,
          onOpenNotificationTray: jn,
        })),
        (t[127] = jt),
        (t[128] = gt),
        (t[129] = mt),
...
function xn() {
  (document.documentElement.classList.remove(mn), document.body.classList.remove(mn));
}
function Sn(e) {
  y.dispatchMessage(`avatar-overlay-keyboard-interaction-changed`, { isInteractive: e });
}
function Cn(e) {
  y.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: e });
}
function wn(e) {
...
function On(e, t) {
  return Wt(e.startWidthPx + t - e.startScreenX);
}
function kn(e, t) {
  return jn(e, t) || w(on, []).includes(e.id)
    ? null
    : { avatarId: e.id, petName: e.displayName, startedAtMs: Date.now() };
}
function An(e, t) {
  return jn(e, t) ? `pending-custom-avatar` : `ready`;
}
function jn(e, t) {
  return t?.startsWith(`custom:`) === !0 && e.id !== t;
}
function Mn({ currentDragState: e, deltaX: t }) {
  return t >= sn ? `running-right` : t <= -sn ? `running-left` : e;
}
function Nn(e) {
  if (e == null) return null;
  let t = Fn(e.querySelector(ln)),
    n = In(e.querySelector(un));
  return t == null ? null : { mascot: t, tray: n };
}
function Pn(e) {
  return Array.from(e.querySelectorAll(hn.join(`, `)));
}
function Fn(e) {
  if (e == null || zn(e)) return null;
...
export { _n as AvatarOverlayPage };
//# sourceMappingURL=avatar-overlay-page-DIPmzcv9.js.map

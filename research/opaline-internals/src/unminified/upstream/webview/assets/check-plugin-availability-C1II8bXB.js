import { do as e, fo as t, uo as n } from "./app-server-manager-signals-BOGyjFm3.js";
import { lt as r } from "./vscode-api-sUstfl-x.js";
import { t as i } from "./useQueries-CqfBVjsA.js";
import { p as a, s as o } from "./apps-queries-CBUjthvi.js";
import { r as s } from "./plugin-detail-queries-nEDuNCez.js";
...
function m(e, t) {
  let n = (e.path == null ? void 0 : t.byPath.get(e.path)) ?? t.byName.get(e.name);
  if (n != null) return n;
...
function x(e) {
  let t = (0, g.c)(14),
    { hostId: n, pluginApps: r, marketplacePath: a, pluginName: c, remoteMarketplaceName: l } = e,
    u = r == null && (a != null || l != null) && c != null,
    d = a ?? null,
    f = c ?? null,
    p = l ?? null,
    m;
  t[0] !== n || t[1] !== u || t[2] !== d || t[3] !== f || t[4] !== p
    ? ((m = { hostId: n, marketplacePath: d, pluginName: f, remoteMarketplaceName: p, enabled: u }),
      (t[0] = n),
      (t[1] = u),
      (t[2] = d),
      (t[3] = f),
  ...
  t[6] !== n || t[7] !== x
    ...
    : (E = t[8]);
  let { data: D, isLoading: O, loadError: k } = o(E),
    A = D === void 0 ? [] : D,
    j = i({ queries: b.map(C) }),
    M = !0,
    N = 0,
  ...
  let F =
      b.length > 0 && N === b.length ? (M ? `disabled-by-admin` : `connector-unavailable`) : null,
    I;
  return (
...
//# sourceMappingURL=check-plugin-availability-C1II8bXB.js.map

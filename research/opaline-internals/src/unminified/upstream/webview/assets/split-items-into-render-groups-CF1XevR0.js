...
import { f as b, lt as x, v as S } from "./vscode-api-sUstfl-x.js";
...
import { t as E } from "./opaline-C1u5S_iM.js";
import {
  _ as D,
  a as O,
  c as te,
  ...
  t as A,
  v as oe,
} from "./app-server-dynamic-tools-DyLmetOo.js";
import { t as j } from "./thinking-shimmer-BqifOpst.js";
import { t as se } from "./chat-BEJ7qgOG.js";
import { t as ce } from "./globe-DyuVFbAy.js";
import { i as le, r as ue, t as de } from "./thread-resource-card-C7ERWGgK.js";
import { o as fe } from "./mcp-tool-item-content-utils-DTAnyTVK.js";
function M({ apps: e, functionName: t, serverName: n, toolName: r }) {
  let i = N(n),
    a = N(r),
    o = t
      .split(`__`)
  ...
  for (let t of e) {
    let e = pe(t);
    if (e.some((e) => P(e, i)) || e.some((e) => me(a, e)) || o.some((t) => e.some((e) => me(t, e))))
      return t;
  }
  return null;
}
function pe(e) {
  let t = [
    N(e.name),
    N(e.id),
    N(e.id.replace(/^connector[_-]/i, ``)),
    ...(e.pluginDisplayNames ?? []).map(N),
  ];
  return t.filter((e, n) => (e.length === 0 ? !1 : t.findIndex((t) => P(t, e)) === n));
}
function N(e) {
  return e
    .trim()
...
function F({ summary: e, cwd: t }) {
  return I({ summary: e, cwd: t })?.isSkillDefinitionFile === !0;
}
function he({ summary: e, cwd: t, intl: n, threadDetailLevel: r, formatSearchQuery: i }) {
  let a = I({ summary: e, cwd: t });
  if (!a) return null;
  switch (e.type) {
    case `read`:
      return a.isSkillDefinitionFile
        ? r === `STEPS_PROSE`
          ? ge({ skillName: a.skillName, isFinished: e.isFinished, intl: n })
          : n.formatMessage(
              {
                id: `localConversationTurn.exploration.skill.definition.read`,
                defaultMessage: `Read {skillName} skill`,
                description: `Exploration row for reading a Opaline skill definition`,
              },
        ...
        : n.formatMessage(
            {
              ...
              defaultMessage: `Read {skillName} skill`,
              description: `Exploration row for reading a file from a Opaline skill directory`,
            },
            { skillName: a.skillName },
          );
    case `list_files`:
      return n.formatMessage(
        {
          ...
          description: `Exploration row for listing files in a Opaline skill directory`,
        },
        { skillName: a.skillName },
      );
    case `search`:
        ...
        return n.formatMessage(
          {
            ...
            description: `Exploration row for searching for a query in a Opaline skill directory`,
          },
      ...
      return n.formatMessage(
        {
          ...
          description: `Exploration row for searching in a Opaline skill directory`,
        },
        { skillName: a.skillName },
      );
  }
}
function ge({ skillName: e, isFinished: t, intl: n }) {
  return t
    ? n.formatMessage(
        {
          id: `localConversationTurn.exploration.skill.definition.read.steps.complete`,
          defaultMessage: `Read {skillName} skill`,
          description: `Simplified exploration row after Opaline finishes reading a skill definition`,
        },
        { skillName: e },
      )
    : n.formatMessage(
        {
          ...
          description: `Simplified exploration row while Opaline is reading a skill definition`,
        },
        { skillName: e },
      );
}
function I({ summary: e, cwd: t }) {
  let n = _e({ summary: e, cwd: t });
  return n ? f(n) : null;
}
function _e({ summary: e, cwd: t }) {
  switch (e.type) {
    case `read`:
      return L({ path: e.path ?? e.name, cwd: t });
    case `list_files`:
      return e.path ? L({ path: e.path, cwd: t }) : null;
    case `search`:
      return e.path ? L({ path: e.path, cwd: t }) : null;
  }
}
function L({ path: e, cwd: t }) {
  if (!e) return null;
  let n = g(e);
  return n.length === 0 ? null : t == null ? n : g(h(t, n));
}
function R(e) {
  throw Error(`Unexpected value: ${String(e)}`);
}
function ve({ item: e, mcpServerStatuses: t }) {
...
function z({ item: e, mcpServerStatuses: t }) {
  return ve({ item: e, mcpServerStatuses: t }) !== `not-mcp-app`;
}
function ye(e) {
  return e.some(
    (e) =>
...
function be({ entries: e, mcpServerStatuses: t }) {
  return e.some(
    (e) =>
      e.kind === `item` &&
      e.item.type === `mcp-tool-call` &&
      z({ item: e.item, mcpServerStatuses: t }),
  );
}
var B = `browser-use`;
function V({ units: e, isActivitySliceClosed: t }) {
  let n = [],
    r = xe(e, t);
  for (let { startIndex: t, endIndex: i } of r) {
    ...
    for (; r < i; ) {
      ...
      n.push({ startIndex: a, endIndex: r, summary: we(o) });
    }
  }
  return n;
}
...
var Te = /(?:^|\s)(?:-X\s*|--request(?:=|\s+))(?:POST|PUT|PATCH|DELETE)\b/i,
  Ee = /(?:^|\s)(?:--data(?:-[^\s=]+)?|--json|--form|--upload-file)(?:=|\s|$)/,
  De = /(?:^|\s)-(?:d|F|T)(?:=|\s|$)/;
function Oe(
  e,
  {
  ...
  if (e.entry.kind === `exploration`) return Ne(e.entry);
  let o = e.entry.item;
  if (o.type === `assistant-message`) return { type: `assistant-message` };
  if (o.type === `patch`) return Pe(o, a);
  if (o.type === `exec`) {
    if (
      Ae(o, i) ||
      (o.parsedCmd.type === `read` &&
        !o.parsedCmd.isFinished &&
        F({ summary: o.parsedCmd, cwd: o.cwd }))
    )
      return { type: `other` };
  ...
  return o.type === `mcp-tool-call`
    ? r === !0 && z({ item: o, mcpServerStatuses: t })
      ? { type: `other` }
      : { type: `mcp-tool-call`, source: ke(o, n) }
...
function ke(e, t) {
  if (u(e)) return { logoUrl: null, logoUrlDark: null, name: B };
  let n = M({
    apps: t,
  ...
  if (n != null)
    return { logoUrl: n.logoUrl ?? null, logoUrlDark: n.logoUrlDark ?? null, name: n.name };
  let r = e.invocation.server.trim();
  return r.length === 0 ? null : { logoUrl: null, logoUrlDark: null, name: p(r) };
}
function Ae(e, t) {
  return !1;
}
function je(e) {
  if (!/^\s*curl(?:\s|$)/.test(e) || Te.test(e) || Ee.test(e) || De.test(e)) return !1;
  let t = e.match(/\bhttps?:\/\/[^\s'"<>]+/gi);
  return t == null ? !1 : t.some(Me);
}
function Me(e) {
  try {
  ...
  for (let s of e.items)
    if (s.type === `exec`) {
      ...
      if (s.parsedCmd.type === `read`) {
        let e = Fe(s.parsedCmd.path ?? s.parsedCmd.name, s.cwd);
...
function Pe(e, t) {
  ...
  for (let [u, d] of Object.entries(e.changes)) {
    if (d.type === `add`) {
      (n.push(u),
        e.success == null && t ? i.push(u) : (e.success ?? (r.push(u), (a += Ie(d.content)))));
      continue;
    }
    if (d.type === `delete`) {
...
function K(e) {
  ...
  t[0] === r
    ? (u = t[1])
    : ((u = y(`relative flex shrink-0 items-center justify-center`, r)), (t[0] = r), (t[1] = u));
  let d;
  t[2] !== c || t[3] !== o || t[4] !== a || t[5] !== n
    ? ((d =
        c === n || (a && o !== n)
          ? (0, G.jsx)(ce, { "aria-hidden": !0, className: `h-full w-full` })
          : null),
      (t[2] = c),
      (t[3] = o),
      (t[4] = a),
  ...
  return (
    t[11] !== u || t[12] !== d || t[13] !== f
      ? ((p = (0, G.jsxs)(`span`, { className: u, children: [d, f] })),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f),
        (t[14] = p))
...
function Le(e) {
  let t = (0, U.c)(31),
    ...
    a = !n.completed,
    o;
  t[0] === r ? (o = t[1]) : ((o = () => Re(r)), (t[0] = r), (t[1] = o));
  let s;
  t[2] !== n.callId || t[3] !== r
    ? ((s = [`chrome-tab-context-tool-call-metadata`, n.callId, r]),
      (t[2] = n.callId),
      (t[3] = r),
      (t[4] = s))
    : (s = t[4]);
  let c;
  t[5] !== a || t[6] !== o || t[7] !== s
    ? ((c = { enabled: a, queryFn: o, queryKey: s, staleTime: 1 / 0 }),
      (t[5] = a),
      (t[6] = o),
      (t[7] = s),
      (t[8] = c))
  ...
  let p = i === `summary-text` ? `inline` : `flex gap-2`,
    m = i === `row` && `my-1`,
    h =
      i === `row`
  ...
  t[14] !== p || t[15] !== m || t[16] !== h
    ? ((g = y(`text-size-chat min-w-0 items-center`, p, m, h)),
      (t[14] = p),
      (t[15] = m),
      (t[16] = h),
      (t[17] = g))
  ...
  let v = !n.completed,
    ...
    x;
  t[21] === b ? (x = t[22]) : ((x = y(b)), (t[21] = b), (t[22] = x));
  let C;
  t[23] !== f || t[24] !== v || t[25] !== x
    ? ((C = (0, G.jsx)(j, { active: v, className: x, children: f })),
      (t[23] = f),
      (t[24] = v),
      (t[25] = x),
      (t[26] = C))
  ...
  let T;
  return (
    t[27] !== C || t[28] !== g || t[29] !== _
      ? ((T = (0, G.jsxs)(`span`, { className: g, children: [_, C] })),
        (t[27] = C),
        (t[28] = g),
        (t[29] = _),
        (t[30] = T))
...
async function Re(e) {
  ...
  try {
    ...
    return { faviconUrl: Be(n, t), title: He(n) };
  } catch {
    return null;
  }
}
...
function Be(e, t) {
  ...
  let r = Ve(e);
  if (r != null && t.runtime?.getURL != null)
    try {
      let e = new URL(t.runtime.getURL(`/_favicon/`));
...
var q = o({ tabId: n().int().nonnegative() }),
  Ue = [{ getCompletedSummaryPartKey: Ge, namespace: d, render: We, tool: l }];
function We(e, t) {
  let n = q.safeParse(e.arguments);
  return n.success ? (0, G.jsx)(Le, { item: e, tabId: n.data.tabId, variant: t }) : null;
}
function Ge(e) {
  return q.safeParse(e.arguments).success ? e.callId : null;
}
var Ke = [
  { namespace: A, render: qe, tool: D },
  { namespace: A, render: Je, tool: oe },
];
function qe(e, t) {
  return Ye(e, e.completed ? `readCompleted` : `readActive`, t);
}
function Je(e, t) {
  return Ye(e, e.completed ? `writeCompleted` : `writeActive`, t);
}
function Ye(e, t, n) {
  return (0, G.jsxs)(`span`, {
    ...
    children: [
      n === `summary-text`
        ? null
        : (0, G.jsx)(ee, { className: `icon-xs shrink-0 text-token-text-secondary` }),
      (0, G.jsx)(j, {
        active: !e.completed,
        className: y(n !== `summary-text` && `min-w-0 truncate`),
        children: (0, G.jsx)(w, { ...Xe[t] }),
      }),
    ],
  });
}
...
function Ze(e) {
  let t = (0, U.c)(19),
    { result: n } = e,
    i = C(),
    a = `pendingWorktreeId` in n,
    o;
  t[0] !== i || t[1] !== a
    ? ((o = i.formatMessage(a ? J.openWorktreeSetup : J.openCreatedThread)),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
  let l = o,
    u;
  t[3] !== a || t[4] !== n.pendingWorktreeId || t[5] !== n.threadId
    ? ((u = () => {
        b.dispatchHostMessage({
          type: `navigate-to-route`,
          path: a ? c(n.pendingWorktreeId) : s(r(n.threadId)),
        });
      }),
      (t[3] = a),
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, G.jsx)(`span`, {
        ...
        children: (0, G.jsx)(se, { className: `icon-sm`, "aria-hidden": !0 }),
      })),
      (t[7] = f))
    : (f = t[7]);
  let p = a ? J.worktreeThreadQueued : J.threadCreated,
    m;
  t[8] === p ? (m = t[9]) : ((m = (0, G.jsx)(w, { ...p })), (t[8] = p), (t[9] = m));
  let h = a ? J.openSetup : J.openThread,
    g;
  t[10] === h
    ? (g = t[11])
    : ((g = (0, G.jsx)(ue, { label: (0, G.jsx)(w, { ...h }) })), (t[10] = h), (t[11] = g));
  let _;
  t[12] !== m || t[13] !== g
    ? ((_ = (0, G.jsx)(le, { icon: f, title: m, trailing: g })),
      (t[12] = m),
      (t[13] = g),
      (t[14] = _))
    : (_ = t[14]);
...
var J = T({
    threadCreated: {
      ...
      description: `Title for a card shown after a Opaline chat is created.`,
    },
    openCreatedThread: {
      id: `localConversation.appControlToolCall.openCreatedThread`,
      defaultMessage: `Open chat`,
      description: `Accessible label for opening a newly created Opaline chat.`,
    },
    openThread: {
      id: `localConversation.appControlToolCall.openThread`,
      defaultMessage: `Open chat`,
      description: `Button label for opening a newly created Opaline chat.`,
    },
    worktreeThreadQueued: {
      id: `localConversation.appControlToolCall.worktreeThreadQueued`,
      defaultMessage: `Worktree chat queued`,
      description: `Title for a card shown after a worktree-backed Opaline chat is queued.`,
    },
    openWorktreeSetup: {
      id: `localConversation.appControlToolCall.openWorktreeSetup`,
      defaultMessage: `Open worktree setup`,
      description: `Accessible label for opening setup for a queued worktree Opaline thread.`,
    },
    openSetup: {
      id: `localConversation.appControlToolCall.openSetup`,
      defaultMessage: `Open setup`,
      description: `Button label for opening setup for a queued worktree Opaline thread.`,
    },
  }),
  Qe = t({ target: t({ type: a(), environment: t({ type: a() }).optional() }) }),
  $e = i([t({ threadId: a().min(1) }), t({ pendingWorktreeId: a().min(1) })]),
  et = [
    { getCompletedSummaryPartKey: tt, namespace: A, render: Y, tool: ie },
    { continuesLiveActivityBetweenCalls: !0, namespace: A, render: Y, tool: ne },
    { continuesLiveActivityBetweenCalls: !0, namespace: A, render: Y, tool: O },
    { namespace: A, render: Y, tool: re },
    { namespace: A, render: Y, tool: te },
    { namespace: A, render: Y, tool: ae },
    { namespace: A, render: Y, tool: k },
  ];
function Y(e, t) {
  let n = tt(e);
  ...
  return r == null
    ? (0, G.jsxs)(`span`, {
        ...
        children: [
          t === `summary-text`
            ? null
            : (0, G.jsx)(E, { className: `icon-xs shrink-0 text-token-text-secondary` }),
          (0, G.jsx)(j, {
            active: !e.completed,
            className: y(t !== `summary-text` && `min-w-0 truncate`),
            children: (0, G.jsx)(w, { ...rt[n] }),
          }),
        ],
      })
    : (0, G.jsx)(Ze, { result: r });
...
function tt(e) {
  switch (e.tool) {
    case ie: {
      let t = Qe.safeParse(e.arguments);
      return t.success
...
var rt = T({
    ...
    threadsSendMessageActive: {
      ...
      description: `In-progress label for sending a message to a Opaline thread.`,
    },
    threadsSendMessageCompleted: {
      ...
      description: `Completed label for sending a message to a Opaline thread.`,
    },
    threadsSetArchivedActive: {
      ...
      description: `In-progress label for archiving or unarchiving a Opaline thread.`,
    },
    threadsSetArchivedCompleted: {
      ...
      description: `Completed label for archiving or unarchiving a Opaline thread.`,
    },
    threadsSetPinnedActive: {
      id: `localConversation.appControlToolCall.threadsSetPinned.active`,
      defaultMessage: `Updating thread pin`,
      description: `In-progress label for pinning or unpinning a Opaline thread.`,
    },
    threadsSetPinnedCompleted: {
      ...
      description: `Completed label for pinning or unpinning a Opaline thread.`,
    },
    threadsSetTitleActive: {
      id: `localConversation.appControlToolCall.threadsSetTitle.active`,
      defaultMessage: `Renaming thread`,
      description: `In-progress label for renaming a Opaline thread.`,
    },
    threadsSetTitleCompleted: {
      id: `localConversation.appControlToolCall.threadsSetTitle.completed`,
      defaultMessage: `Renamed thread`,
      description: `Completed label for renaming a Opaline thread.`,
    },
  }),
  it = [...Ue, ...et, ...Ke];
function X(e) {
  return it.find((t) => t.namespace === e.namespace && t.tool === e.tool);
}
function at(e) {
...
function st({ items: e, isActive: t }) {
  if (!t) return !1;
  if (e.some((e) => !e.completed)) return !0;
  let n = e.at(-1);
  return n != null && at(n);
}
function ct({ items: e, keepLatestLiveActivityInGroup: t }) {
  let n = e.at(-1);
  return e.length > 1 || (t && n != null && at(n));
}
function lt(e) {
  let t = [],
    n = [],
  ...
  for (let i of e) {
    ...
    if (
      (r(),
      i.kind === `item` && i.item.type === `multi-agent-action` && i.item.status !== `inProgress`)
    ) {
      let e = t[t.length - 1];
      if (
...
function ut(e) {
  for (let t = e.length - 1; t >= 0; --t) if (e[t]?.kind === `multi-agent-group`) return t;
  return -1;
}
function Z(e, t) {
...
function dt({
  ...
  for (let t = 0; t < e.length; ) {
    ...
    for (; c < e.length; ) {
      let t = Ct(e[c]);
      if (t == null || St(t, n, r)) break;
      let a = xt({ item: t, resolvedApps: i });
      if (s != null && a !== s) break;
      ((s = a), o.push(t), (c += 1));
    }
    if (o.length > 1) {
...
function ft({ units: e, keepLatestLiveActivityInGroup: t = !1 }) {
  let n = [];
  for (let r = 0; r < e.length; ) {
    ...
    if (ct({ items: i, keepLatestLiveActivityInGroup: t && a === e.length })) {
...
function vt({
  ...
  let c = e.map((e) =>
    ...
    l = [...V({ units: c, isActivitySliceClosed: t })];
  if (!t) {
    let e = Tt(c),
      t = [];
    ...
    for (let n of V({ units: t, isActivitySliceClosed: !0 }))
  ...
  for (let r = 0; r < e.length; ) {
    ...
    if (i && r === i.startIndex) {
      ...
      if (o != null) {
        let e = yt({ groupedUnits: a, isCurrentToolActivity: s, summary: i.summary });
        u.push({ kind: `collapsed-tool-activity`, key: Z(o, i.startIndex), units: a, summary: e });
      }
      ((r = i.endIndex), (d += 1));
      continue;
    }
...
function yt({ groupedUnits: e, isCurrentToolActivity: t, summary: n }) {
...
function xt({ item: e, resolvedApps: t }) {
  if (e.source === `browser-use`) return B;
  if (t != null) {
    let n = M({
      apps: t,
      functionName: e.functionName,
...
function St(e, t, n) {
  return e.source === `browser-use`
    ...
    : e.invocation.server === `computer-use` ||
      ...
      ? !0
      : n && z({ item: e, mcpServerStatuses: t });
}
function Ct(e) {
...
var Et = e(m(), 1);
function Dt({ agentItems: e, isTurnInProgress: t, isAnyNonAgentItemInProgress: n }) {
  let r = [],
    i = null,
    a = !1,
    o = !1,
...
function Ot(e) {
  return e.type !== `exec` ||
    (e.parsedCmd.type === `read` &&
      ...
      F({ summary: e.parsedCmd, cwd: e.cwd }))
    ? !1
...
function At(e, t) {
  ...
  let E = C[C.length - 1],
    D = t !== `in_progress` && !ee && It(E) ? E : null;
  D && C.pop();
...
var jt = (e) => e.type === `patch` && e.approvalRequestId != null && e.success == null,
  Mt = (e) => e.type === `exec` && e.approvalRequestId != null && e.output?.exitCode === void 0,
  Nt = (e) => e?.type === `assistant-message`,
  Pt = (e) => {
    let t = [];
    for (;;) {
      let n = e[e.length - 1];
...
//# sourceMappingURL=split-items-into-render-groups-CF1XevR0.js.map

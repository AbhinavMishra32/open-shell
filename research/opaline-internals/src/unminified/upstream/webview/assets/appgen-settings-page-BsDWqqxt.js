...
import { qt as t } from "./src-CYrn1fYL.js";
...
import { F as i, P as a, f as o, h as s, lt as c } from "./vscode-api-sUstfl-x.js";
import { c as l, o as u } from "./lib-MoKmYgcO.js";
import { a as d, g as f, m as p } from "./chunk-LFPYN7LY-DwFbyqR1.js";
...
import { t as g } from "./spinner-Dvc_A3Ae.js";
...
import { t as _ } from "./app-shell-D7yvB1FT.js";
...
import { r as y } from "./modal-controller-state-CEBUx8JQ.js";
import {
  a as b,
  d as x,
  i as S,
...
import { t as D } from "./trash-BX2WKfvO.js";
import "./chevron-D6hquBJC.js";
import { t as O } from "./plus-_AqggHDM.js";
import "./building-r_Q_yEQG.js";
import "./lock-DV6CP31m.js";
import { t as k } from "./arrow-top-right-D16Z5Bms.js";
import "./list-navigation-D9or854M.js";
import "./arrow-up-right-lg-B6PWe6L5.js";
import "./link-CsT_QnTl.js";
import { n as ee } from "./settings-row-DOKTjAF6.js";
import { n as A, t as j } from "./settings-group-BO3RZzLk.js";
import { n as M } from "./members-DLUwp6q7.js";
import { a as N, c as P, i as F, n as I, o as L, p as R } from "./appgen-url-BQfPV2YP.js";
import { i as z, t as B } from "./appgen-access-state-messages-BWrvnZzw.js";
import "./use-workspace-users-Do1vG9A7.js";
import { t as V } from "./appgen-share-dialog-CLo_KH7g.js";
import { t as H } from "./toolbar-breadcrumb-6vAQnE7b.js";
import { t as U } from "./settings-empty-state-AHLxAQVX.js";
var W = c(),
  te = e(n(), 1),
  G = e(t(), 1),
  K = `<REDACTED>`;
function q(e) {
  return {
    ...
    secrets: e.entries
      .filter((e) => e.is_secret)
      .map(({ key: e }) => ({ key: e, keyInputDisabledWhileValue: K, previousKey: e, value: K })),
  };
}
function ne(e, t) {
  ...
  let r = new Set([
    ...
    ...t.secrets.map((e) => (J(e) ? e.previousKey : e.key)),
  ]);
  return {
    remove: e.entries.filter(({ key: e }) => !r.has(e)).map(({ key: e }) => e),
    set_values: [
      ...t.environmentVariables.filter((t) => Y(e, t)).map((e) => X(e, !1)),
      ...t.secrets.filter((e) => !J(e)).map((e) => X(e, !0)),
    ],
  };
}
function J(e) {
  return e.previousKey != null && e.value === K;
}
function Y(e, t) {
...
function ie(e) {
  ...
  for (let n of e.split(/\r?\n/)) {
    ...
    let r = Z(e, `#`, (t) => e[t - 1]?.trim() === ``);
    if ((r !== -1 && (e = e.slice(0, r).trim()), e.length === 0)) continue;
    let i = Z(e, `=`);
    if (i === -1) continue;
    let a = e.slice(0, i).trim();
    a.length !== 0 && t.push({ key: a, value: Q(e.slice(i + 1).trim()) });
  }
  return t;
}
function Z(e, t, n = () => !0) {
...
function ae(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, $.jsx)(O, { className: `icon-xs` })), (t[3] = f))
    : (f = t[3]);
  let p;
  t[4] !== n || t[5] !== l || t[6] !== d
    ? ((p = (0, $.jsxs)(h, {
  ...
  let m;
  t[8] !== o || t[9] !== p || t[10] !== s
    ? ((m = (0, $.jsx)(j.Header, { actions: p, subtitle: o, title: s, titleGap: `none` })),
      (t[8] = o),
      (t[9] = p),
      (t[10] = s),
      (t[11] = m))
  ...
  return (
    t[17] !== m || t[18] !== g
      ? ((_ = (0, $.jsxs)(j, { className: `gap-2`, children: [m, g] })),
        (t[17] = m),
        (t[18] = g),
        (t[19] = _))
      : (_ = t[19]),
...
function oe(e) {
  ...
  t[4] !== r || t[5] !== i
    ...
    : (p = t[6]);
  let m;
  t[7] !== r.key || t[8] !== a || t[9] !== u || t[10] !== d || t[11] !== f || t[12] !== p
    ? ((m = (0, $.jsx)(se, {
        "aria-label": u,
        disabled: d,
        placeholder: f,
  ...
  t[18] !== r || t[19] !== i
    ...
    : (v = t[20]);
  let y;
  t[21] !== n || t[22] !== r.value || t[23] !== g || t[24] !== _ || t[25] !== v || t[26] !== s
    ? ((y = (0, $.jsx)(se, {
        "aria-label": g,
        disabled: n,
        placeholder: _,
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(D, { className: `icon-2xs` })), (t[30] = x))
    : (x = t[30]);
  let S;
...
function ce() {
  ...
  if (t == null) {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(d, { replace: !0, to: `/sites` })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  let n;
  return (
    e[1] === t ? (n = e[2]) : ((n = (0, $.jsx)(le, { projectId: t })), (e[1] = t), (e[2] = n)),
    n
  );
}
function le(e) {
  let t = (0, W.c)(22),
    { projectId: n } = e,
    { data: r, isError: i, isLoading: o } = a(L, n),
    { data: s, isError: c, isLoading: l } = a(N, n),
    u = r?.current_live_url,
    d;
  t[0] === u ? (d = t[1]) : ((d = I(u)), (t[0] = u), (t[1] = d));
  let f = d,
    p = r?.title,
    m;
  t[2] !== u || t[3] !== p
    ? ((m = (0, $.jsx)(ue, { liveUrl: u, siteTitle: p })), (t[2] = u), (t[3] = p), (t[4] = m))
    : (m = t[4]);
  let h = m,
    g;
  t[5] === h
    ? (g = t[6])
    : ((g = (0, $.jsx)(v, { extension: !0, children: h })), (t[5] = h), (t[6] = g));
  let y;
  t[7] === h
    ? (y = t[8])
    : ((y = (0, $.jsx)(v, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(_.Header, { children: h }),
      })),
      (t[7] = h),
      (t[8] = y));
  let b;
...
function ue(e) {
  ...
  let c;
  t[3] !== r || t[4] !== s
    ? ((c = (0, $.jsx)(H, { ancestors: s, current: r })), (t[3] = r), (t[4] = s), (t[5] = c))
    : (c = t[5]);
  let l;
  t[6] === n
    ? (l = t[7])
    : ((l =
        n == null
          ...
          : (0, $.jsxs)(h, {
              ...
              size: `toolbar`,
              onClick: () => {
                o.dispatchMessage(`open-in-browser`, { url: n });
              },
              children: [
  ...
  t[8] === l
    ? (d = t[9])
    : ((d = (0, $.jsx)(`div`, { className: `flex items-center justify-end`, children: l })),
      (t[8] = l),
      (t[9] = d));
  let f;
  return (
...
function de(e) {
  let t = (0, W.c)(61),
    { accessPolicy: n, environment: r, projectId: o, siteSlug: c, siteTitle: d } = e,
    f = i(s),
    p = a(P, o),
    g = l(),
    ...
    b;
  t[0] !== r || t[1] !== _?.draft
    ? ((b = _?.draft ?? q(r)), (t[0] = r), (t[1] = _?.draft), (t[2] = b))
    : (b = t[2]);
  let x = b,
    S;
  t[3] === _
    ? (S = t[4])
    : ((S = _ == null ? null : ne(_.baseEnvironment, _.draft)), (t[3] = _), (t[4] = S));
  let C = S,
    w;
  t[5] === r
    ? (w = t[6])
    : ((w = function (e) {
        v((t) => {
          let n = t?.baseEnvironment ?? r,
            i = q(n),
            a = e(t?.draft ?? i);
          return (0, G.default)(a, i) ? null : { baseEnvironment: n, draft: a };
        });
      }),
      (t[5] = r),
      (t[6] = w));
  let T = w,
    E;
  t[7] !== C || t[8] !== g || t[9] !== f || t[10] !== p
    ? ((E = (e) => {
        (e.preventDefault(),
          C != null &&
            p.mutateAsync(C).then(
              () => {
                v(null);
              },
              () => {
  ...
  let D;
  t[12] !== n || t[13] !== o
    ? ((D = n == null ? null : (0, $.jsx)(fe, { accessPolicy: n, projectId: o })),
      (t[12] = n),
      (t[13] = o),
      (t[14] = D))
    : (D = t[14]);
  ...
  t[18] === T
    ? (N = t[19])
    : ((N = (e) => {
        T((t) => ({ ...t, environmentVariables: e }));
      }),
      (t[18] = T),
      (t[19] = N));
  let F;
  t[20] !== x.environmentVariables || t[21] !== N || t[22] !== p.isPending
    ? ((F = (0, $.jsx)(ae, {
        addButtonLabel: O,
  ...
  t[27] === T
    ...
    : ((z = (e) => {
      ...
      (t[28] = z));
  let B;
  t[29] !== x.secrets || t[30] !== z || t[31] !== p.isPending
    ? ((B = (0, $.jsx)(ae, {
        addButtonLabel: I,
        disabled: p.isPending,
        entries: x.secrets,
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((H = t[34]), (U = t[35]));
  let K;
  t[36] !== o || t[37] !== f || t[38] !== c || t[39] !== d
    ? ((K = () => {
        y(f, pe, { projectId: o, siteSlug: c, siteTitle: d });
      }),
      (t[36] = o),
      (t[37] = f),
      (t[38] = c),
  ...
  let oe;
  return (
    t[54] !== F || t[55] !== B || t[56] !== Y || t[57] !== Q || t[58] !== E || t[59] !== D
      ? ((oe = (0, $.jsxs)(`form`, {
...
function fe(e) {
  ...
  t[0] === n
    ...
    : ((p = R(n)),
      ...
      (_ = (0, $.jsx)(z, { "aria-hidden": !0, accessPolicy: n, className: `icon-2xs shrink-0` })),
      (o = u),
      (m = B(p)),
      (t[0] = n),
      (t[1] = o),
      ...
      (t[11] = b));
  let x;
  t[14] !== o || t[15] !== p || t[16] !== m
    ? ((x = (0, $.jsx)(o, { ...m, values: p })), (t[14] = o), (t[15] = p), (t[16] = m), (t[17] = x))
    : (x = t[17]);
  let S;
  t[18] !== g || t[19] !== _ || t[20] !== x
    ? ((S = (0, $.jsxs)(`span`, { className: g, children: [_, x] })),
      (t[18] = g),
      (t[19] = _),
      (t[20] = x),
      (t[21] = S))
  ...
  let C;
  t[22] !== r || t[23] !== a
    ? ((C = () => y(a, V, { projectId: r })), (t[22] = r), (t[23] = a), (t[24] = C))
    : (C = t[24]);
  let w, T;
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(M, { "aria-hidden": !0, className: `icon-xs` })),
      (w = (0, $.jsx)(u, {
  ...
  t[27] === C
    ? (E = t[28])
    : ((E = (0, $.jsxs)(h, { color: `outline`, size: `toolbar`, onClick: C, children: [T, w] })),
      (t[27] = C),
      (t[28] = E));
  let D;
  t[29] !== c || t[30] !== E || t[31] !== v || t[32] !== S
    ? ((D = (0, $.jsx)(c, { label: v, description: S, control: E })),
      (t[29] = c),
      (t[30] = E),
      (t[31] = v),
      (t[32] = S),
  ...
  let O;
  t[34] !== l || t[35] !== D
    ? ((O = (0, $.jsx)(l, { children: D })), (t[34] = l), (t[35] = D), (t[36] = O))
    : (O = t[36]);
  let k;
  t[37] !== d || t[38] !== O
    ? ((k = (0, $.jsx)(d, { children: O })), (t[37] = d), (t[38] = O), (t[39] = k))
    : (k = t[39]);
  let N;
  return (
    t[40] !== f || t[41] !== k || t[42] !== b
      ? ((N = (0, $.jsxs)(f, { children: [b, k] })),
        (t[40] = f),
        (t[41] = k),
        (t[42] = b),
        (t[43] = N))
...
function pe(e) {
  let t = (0, W.c)(49),
    { onClose: n, projectId: r, siteSlug: o, siteTitle: c } = e,
    d = i(s),
    f = a(F, r),
    g = l(),
    _ = p(),
  ...
  t[2] !== f.isPending || t[3] !== n
    ...
    : (A = t[4]);
  let j;
  t[5] !== v || t[6] !== f || t[7] !== g || t[8] !== _ || t[9] !== n || t[10] !== d || t[11] !== o
    ? ((j = (e) => {
        (e.preventDefault(),
          !(v !== o || f.isPending) &&
            f.mutateAsync().then(
  ...
  t[13] === O
    ? (M = t[14])
    : ((M = (0, $.jsx)(x, { className: `contents`, children: O })), (t[13] = O), (t[14] = M));
  let N;
  t[15] === o
    ? (N = t[16])
    : ((N = (0, $.jsx)(E, {
  ...
  t[17] !== M || t[18] !== N
    ? ((P = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(S, { title: M, titleClassName: `truncate pr-8`, subtitle: N }),
      })),
      (t[17] = M),
      (t[18] = N),
      (t[19] = P))
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (L = t[22]);
  let R;
  t[23] !== v || t[24] !== f.isPending || t[25] !== o || t[26] !== I
    ? ((R = (0, $.jsx)(b, {
  ...
  let G;
  t[36] !== B || t[37] !== U
    ? ((G = (0, $.jsx)(b, { children: (0, $.jsxs)(T, { children: [B, U] }) })),
      (t[36] = B),
      (t[37] = U),
      (t[38] = G))
    : (G = t[38]);
  let K;
  t[39] !== R || t[40] !== G || t[41] !== j || t[42] !== P
    ? ((K = (0, $.jsxs)(w, {
        as: `form`,
  ...
  let q;
  return (
    t[44] !== f.isPending || t[45] !== K || t[46] !== ee || t[47] !== A
      ? ((q = (0, $.jsx)(C, {
          open: !0,
          size: `compact`,
          shouldIgnoreClickOutside: k,
          showDialogClose: ee,
          onOpenChange: A,
          children: K,
        })),
...
export { ce as AppgenSettingsPage };
//# sourceMappingURL=appgen-settings-page-BsDWqqxt.js.map

...
import { Vo as t } from "./app-server-manager-signals-BOGyjFm3.js";
...
function o(e) {
  let n = (0, a.c)(9),
    [r, i] = t(`diff_comments`),
    o;
  n[0] !== r || n[1] !== e ? ((o = s(r, e)), (n[0] = r), (n[1] = e), (n[2] = o)) : (o = n[2]);
  let c = o,
    l;
  n[3] !== e || n[4] !== i
    ? ((l = (t) => {
        e &&
          i((n) => {
            ...
            return a.length === 0 ? (delete r[e], r) : ((r[e] = a), r);
          });
      }),
      (n[3] = e),
      (n[4] = i),
  ...
  let u = l,
    d;
  return (
    n[6] !== c || n[7] !== u ? ((d = [c, u]), (n[6] = c), (n[7] = u), (n[8] = d)) : (d = n[8]),
    d
  );
}
function s(e, t) {
...
//# sourceMappingURL=arrow-rotate-ccw-BTd4TrbP.js.map

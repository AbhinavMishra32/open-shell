...
import { tr as t } from "./src-CYrn1fYL.js";
import { n, t as r } from "./jsx-runtime-CiQ1k8xo.js";
import { t as i } from "./clsx-BcPLHiun.js";
import { t as a } from "./react-dom-CvzHKZGB.js";
import { c as o } from "./lib-MoKmYgcO.js";
import { t as s } from "./x-DypUcSQe.js";
import { t as c } from "./download-TILfllSA.js";
import { d as ee, l as te } from "./dialog-layout-CCvvb1Vc.js";
import { t as l } from "./use-stable-callback-B56R_Ee2.js";
import { t as u } from "./arrow-left-2njf4k3d.js";
import { i as ne, n as re } from "./image-preview-shortcuts-CaXpgMPF.js";
import { t as ie } from "./minus-COQFKeWQ.js";
import { t as ae } from "./plus-_AqggHDM.js";
var d = e(n(), 1),
  oe = e(a(), 1),
  f = r(),
  se = 200,
...
function h({
  ...
  previewContent: h,
  triggerContent: _,
  toolbarLeadingAction: b,
  closeAriaLabel: ge,
  downloadSrc: x = e,
  imageDecoding: _e,
  imageDraggable: ve,
  imageFetchPriority: ye,
  imageLoading: be,
  imageReferrerPolicy: xe,
  onCloseAutoFocus: Se,
  onImageError: Ce,
  onNextImage: S,
  onPreviousImage: C,
  portalContainer: we,
  showZoomControls: Te = !0,
}) {
  let w = o(),
    [T, Ee] = (0, d.useState)(null),
    [De, E] = (0, d.useState)(null),
    [D, O] = (0, d.useState)(null),
    [k, Oe] = (0, d.useState)(null),
    A = (0, d.useRef)(null),
    j = (0, d.useRef)(null),
    M = (0, d.useRef)(null),
    ...
    L = k?.src === e ? k : null,
    R = le({ naturalSize: L, previewViewportSize: De }),
    z = (D?.src === e ? D.zoomPercent : null) ?? R,
    B = de(R),
    V = B[0] ?? z,
    H = B.at(-1) ?? z,
    Fe = z == null ? null : w.formatNumber(z / 100, { style: `percent`, maximumFractionDigits: 0 }),
    U = me(e, t),
    Ie = z != null && V != null && z > V,
    Le = z != null && H != null && z < H,
    W = n?.trim() || null,
    Re = C != null || S != null,
    G = () => {
    ...
    J = (0, d.useCallback)(
      (t) => {
        let n = ce(t);
        return n == null ? !1 : (T != null && q(T), Oe({ src: e, ...n }), !0);
      },
      [T, e, q],
    ),
    Ve = (0, d.useCallback)(
  ...
  if (z != null && L != null) {
    let e = z / 100;
    Y = { width: `${L.width * e}px`, height: `${L.height * e}px` };
  }
  let X = ({ clientX: t, clientY: n, zoomPercent: r }) => {
      ...
      let a = i.getBoundingClientRect(),
        o = a.width > 0 ? y((t - a.left) / a.width) : 0.5,
        s = a.height > 0 ? y((n - a.top) / a.height) : 0.5;
      if (
        ((0, oe.flushSync)(() => {
          O({ src: e, zoomPercent: r });
        }),
    ...
    Z = (e) => {
      z != null && Ue(ue({ currentZoomPercent: z, direction: e, zoomRamp: B }));
    },
    We = () => {
    ...
    Q = l((e) => {
      ...
      let t = g({
        maximumZoomPercent: H,
        minimumZoomPercent: V,
        zoomPercent: z * Math.exp(-fe(e) / se),
      });
      if (t == null || t === z) return;
      let n = pe({ event: e, fallbackPoint: M.current, previewViewportNode: T });
    ...
    Ke = (0, d.useCallback)(
      (e) => {
        let t = j.current;
        if (t !== e) {
          if ((t?.removeEventListener(`wheel`, Q), (j.current = e), Ee(e), e == null)) {
            E(null);
            return;
          }
    ...
    qe = (e) => {
      ...
      P.current = null;
      let t = v(N.current);
      F.current = t == null || z == null ? null : { distance: t.distance, zoomPercent: z };
    },
    Je = (e) => {
      if (
    ...
    $ = (e) => {
      ...
      let n = v(N.current);
      ((P.current = null),
        (F.current = n == null || z == null ? null : { distance: n.distance, zoomPercent: z }));
    };
  return (
    (0, d.useEffect)(() => {
      if (!r) return;
    ...
    (0, f.jsx)(te, {
      ...
      onOpenChange: K,
      unstyledContent: !0,
      contentClassName: `pointer-events-none fixed inset-0 !left-0 !top-0 h-[100dvh] w-screen max-w-none !translate-x-0 !translate-y-0 overflow-visible rounded-none bg-transparent p-0 shadow-none ring-0 backdrop-blur-none`,
      ...
      contentProps: {
        ...
        onKeyDown: (e) => {
          e.defaultPrevented ||
            (e.key === `ArrowLeft` && C != null && (e.preventDefault(), e.stopPropagation(), ze()),
            e.key === `ArrowRight` && S != null && (e.preventDefault(), e.stopPropagation(), Be()));
        },
        onCloseAutoFocus: Se,
      },
      children: (0, f.jsxs)(`div`, {
        className: i(
          ...
          Re ? `px-16 sm:px-20` : `px-4 sm:px-8`,
        ),
        onPointerDown: (e) => {
          e.target === e.currentTarget && K(!1);
        },
        children: [
          (0, f.jsxs)(`div`, {
            ...
            children: [
              b == null
                ...
                : (0, f.jsx)(`button`, {
                    type: `button`,
                    className: i(p, `relative`, b.active ? `h-9 min-w-0 p-1` : `h-9 min-w-10 px-3`),
                    ...
                    onClick: (e) => {
                      (e.stopPropagation(), b.onClick());
                    },
                    children: (0, f.jsx)(`span`, {
                      className: i(
                        `pointer-events-none rounded-full text-sm font-medium whitespace-nowrap`,
                        b.active && `bg-token-text-link-foreground px-3 py-1 text-white`,
                        !b.active && `p-1`,
                      ),
                      children: b.label,
                    }),
              ...
              (0, f.jsx)(`a`, {
                ...
                children: (0, f.jsx)(c, { className: `icon-xs` }),
              }),
              (0, f.jsx)(`button`, {
                type: `button`,
                className: m,
                ...
                children: (0, f.jsx)(s, { className: `icon-sm` }),
              }),
            ],
          }),
          C == null
            ...
            : (0, f.jsx)(`button`, {
                type: `button`,
                className: i(m, `absolute top-1/2 left-3 z-10 -translate-y-1/2 p-0`),
                "aria-label": Ne,
                onClick: (e) => {
          ...
          S == null
            ...
            : (0, f.jsx)(`button`, {
                type: `button`,
                className: i(m, `absolute top-1/2 right-3 z-10 -translate-y-1/2 p-0`),
                "aria-label": Pe,
                onClick: (e) => {
...
function le({ naturalSize: e, previewViewportSize: t }) {
...
function ue({ currentZoomPercent: e, direction: t, zoomRamp: n }) {
  if (t === `in`) {
...
function de(e) {
  let n = [...t];
  return (e != null && !n.includes(e) && (n.push(e), n.sort((e, t) => e - t)), n);
}
function g({ maximumZoomPercent: e, minimumZoomPercent: t, zoomPercent: n }) {
...
function pe({ event: e, fallbackPoint: t, previewViewportNode: n }) {
  let r = { clientX: e.clientX, clientY: e.clientY };
  if (n == null) return r;
  let i = n.getBoundingClientRect();
  return (r.clientX !== 0 || r.clientY !== 0) && _(r, i)
    ? r
    : t != null && _(t, i)
      ? t
...
export { h as t };
//# sourceMappingURL=image-preview-dialog-BBze7Upk.js.map

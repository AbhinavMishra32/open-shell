...
var s = class {
  ...
  arcTo(e, n, i, a, o) {
    ...
    if (this._x1 === null) this._append`M${(this._x1 = e)},${(this._y1 = n)}`;
      ...
      if (!(Math.abs(f * l - u * d) > r) || !o) this._append`L${(this._x1 = e)},${(this._y1 = n)}`;
      else {
        let m = i - s,
          h = a - c,
          g = l * l + u * u,
  ...
  arc(e, a, o, s, c, l) {
    if (((e = +e), (a = +a), (o = +o), (l = !!l), o < 0)) throw Error(`negative radius: ${o}`);
    let u = o * Math.cos(s),
      d = o * Math.sin(s),
      f = e + u,
      p = a + d,
    ...
    (this._x1 === null
      ? this._append`M${f},${p}`
      : (Math.abs(this._x1 - f) > r || Math.abs(this._y1 - p) > r) && this._append`L${f},${p}`,
      o &&
        (h < 0 && (h = (h % n) + n),
        h > i
          ? this
...
//# sourceMappingURL=path-8PN3RO0R.js.map

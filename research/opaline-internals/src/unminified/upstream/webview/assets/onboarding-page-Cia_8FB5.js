...
import { i as k, r as A } from "./react-v2Nz4MGb.js";
import { c as j, n as M, o as N } from "./lib-MoKmYgcO.js";
import { m as re } from "./chunk-LFPYN7LY-DwFbyqR1.js";
import { g as P, h as ie } from "./persisted-signal-Cx1QgqJn.js";
import "./rpc-y95ESgjb.js";
import { c as ae, d as oe, n as F } from "./statsig-Cajk3UKk.js";
...
import { t as se } from "./use-auth-DXLjX3T4.js";
...
import { t as I } from "./button-Xd4Hy1MO.js";
import { i as L } from "./setting-storage-Cel8Tr7E.js";
...
import { n as le, t as ue } from "./thread-detail-level-DlbE7gvF.js";
...
import {
  ...
  t as ge,
  u as _e,
} from "./onboarding-state-C29ET4Cr.js";
...
import { r as ve } from "./ambient-suggestions-connected-apps-consent-C2bHFt_J.js";
import "./check-circle-filled-CC_XQe30.js";
import "./terminal-CsU-mb2r.js";
import { t as ye } from "./info-BV-snsxq.js";
...
import { t as be } from "./check-md-CZTnvSiA.js";
import { t as xe } from "./select-project-Cy94qDrW.js";
...
import { i as Se, r as Ce, t as we } from "./external-agent-config-gates-DIGeW9JP.js";
import { n as Te, r as Ee } from "./external-agent-onboarding-import-status-Bc1RAAbf.js";
import "./clock-CDmkoq1h.js";
import "./search-mcwajolX.js";
import "./globe-DyuVFbAy.js";
import "./sortBy-EVRmvlY9.js";
import { t as De } from "./toggle-CHrq20xd.js";
import { t as Oe } from "./permissions-mode-visibility-DNx7wvRA.js";
import { t as ke } from "./arrow-up-right-lg-B6PWe6L5.js";
import "./folders-M-71dKsg.js";
import "./workspace-onboarding-experiment-07wt5Jg7.js";
import { r as Ae } from "./workspace-onboarding-controller-DJyxy8I4.js";
import { t as je } from "./app-preloader-DxFriehz.js";
import {
  a as Me,
  b as Ne,
  c as Pe,
...
import { t as V } from "./opaline-app-ga-logo-Ce-JNlBO.js";
import { a as Le } from "./onboarding-shell-B5Vl8B3_.js";
import { t as Re } from "./animated-icon-BEOZWoU_.js";
import "./tasks-DKnnCbd7.js";
import { i as H, n as ze, t as Be } from "./onboarding-roles-Ci9LuMkN.js";
var U = te(),
  Ve = [
    `animals`,
    `fitness`,
...
var Ue = [
  ...
  We = [`coding`, `non_coding`],
  Ge = [`claude-code`, `claude-cowork`],
  W = {
    Start: `start`,
  ...
  Ke = r(`step`, [
    t({ step: l(W.TeenWelcome) }),
    t({ step: l(W.TeenInterests), interests: c(a(Ve)) }),
    t({ step: l(W.TeenPrompts), prompt: u().optional() }),
    t({
      step: l(W.RoleSelection),
      roles: c(a(Ue)),
      personalizedSuggestionsEnabled: s(),
      workMode: a(We).nullable(),
    }),
    t({ step: l(W.AgentMigrationSourceSelection), providerIds: c(a(Ge)), skipped: s().optional() }),
    t({ step: l(W.AgentMigrationItemSelection), action: a([`imported`, `skipped`]) }),
  ]),
  G = w(`OnboardingScope`, { parent: D }),
  K = T(G, () => W.Start),
  q = T(G, () => null),
  J = T(G, () => null),
  Y = T(G, () => null),
...
function Ye() {
  ...
  return (
    ...
    e[11] !== v
      ? ((y = (e, y) => {
          let b = e.personalizedSuggestionsEnabled ?? !0,
            x = e.workMode !== `non_coding`,
            S = Qe(e.workMode);
          (r(e),
            ie(t, p, {
              selectedWorkspacesCount: 0,
              experimentArm: v,
              personalizedSuggestionsEnabled: b,
            }),
            L(t, d.conversationDetailMode, S.threadDetailLevel)
              .catch(Ze)
              .finally(() => {
                let e = c === `welcome`;
                (l(`auto`),
                  ...
                  a(`/?${ge}=1`, {
                    replace: !0,
                    state:
                      y?.focusComposer !== !0 && y?.prefillPrompt == null
                        ? void 0
                        : { focusComposerNonce: Date.now(), prefillPrompt: y.prefillPrompt },
                  }));
              }),
            S.fontSizes != null &&
              (L(t, n.sansFontSize, S.fontSizes.sans), L(t, n.codeFontSize, S.fontSizes.code)),
            t.set(Oe, { "guardian-approvals": x, "full-access": x }),
            b && t.set(ve, !0),
            (async () => {
              (await L(t, o.enabled, b),
                b &&
                  (await ne(`ambient-suggestions-refresh`, {
                    params: { hostId: m, projectRoot: i(`~`) },
                  }),
                  await Promise.all([
                    s.invalidateQueries({ queryKey: O(`ambient-suggestions`) }),
                    s.invalidateQueries({ queryKey: O(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(Xe));
        }),
        (e[0] = a),
...
function Xe(e) {
  E.error(`Failed to refresh ambient suggestions after onboarding`, {
    safe: {},
    sensitive: { error: e },
  });
}
function Ze(e) {
  E.error(`Failed to persist welcome v2 onboarding configuration`, {
    safe: {},
    sensitive: { error: e },
  });
}
function Qe(e) {
  return e === `non_coding`
    ? { threadDetailLevel: le, fontSizes: { sans: qe, code: Je } }
...
function $e(e) {
  ...
  let { isLoading: l, shouldUseTeenOnboarding: u } = Ae(c),
    d;
  t[2] === a ? (d = t[3]) : ((d = F(a, Se)), (t[2] = a), (t[3] = d));
  let f = d,
    p;
  t[4] === a ? (p = t[5]) : ((p = F(a, we)), (t[4] = a), (t[5] = p));
  let m = p,
    h = o || l || n,
    g;
  t[6] === a ? (g = t[7]) : ((g = F(a, Ce)), (t[6] = a), (t[7] = g));
  let _;
  t[8] !== m || t[9] !== f || t[10] !== i
    ? ((_ = async () => (f ? Pe({ isCoworkMigrationEnabled: m, queryClient: i }) : !1)),
      (t[8] = m),
      (t[9] = f),
      (t[10] = i),
      (t[11] = _))
...
var et = { roles: [`student`], personalizedSuggestionsEnabled: !1, workMode: `coding` },
  tt = {
    [W.Start]: null,
    [W.TeenWelcome]: `teen_welcome`,
    [W.TeenInterests]: `teen_interests`,
    [W.TeenPrompts]: `teen_prompts`,
    [W.RoleSelection]: `role_selection`,
    [W.AgentMigrationSourceSelection]: `agent_migration_source_selection`,
    [W.AgentMigrationItemSelection]: `agent_migration_item_selection`,
    [W.Complete]: null,
  };
async function nt(e, { completeOnboarding: t, logStepViewed: n, onboardingContext: r, result: i }) {
  let a = e.get(K);
  if (a === W.Complete) return;
  let o;
  (i != null && (o = Ke.parse(i)), o != null && ct(e, o));
  let s = await rt({ currentStep: a, onboardingContext: r, result: o });
  if (e.get(K) !== a || (s !== a && at(e, s, n), s !== W.Complete)) return;
  if (o?.step === W.TeenPrompts) {
    t(et, { focusComposer: !0, prefillPrompt: o.prompt });
    return;
  }
  let c = e.get(q);
  (o?.step === W.RoleSelection && (c = o), c != null && t(st(c)));
}
async function rt({ currentStep: e, onboardingContext: t, result: n }) {
  if (t.isLoading) return e;
  switch (e) {
    case W.Start:
      return t.shouldShowTeenOnboarding ? W.TeenWelcome : W.RoleSelection;
    case W.TeenWelcome:
      return W.TeenInterests;
    case W.TeenInterests:
      return W.TeenPrompts;
    case W.TeenPrompts:
      return W.Complete;
    case W.RoleSelection:
      return (await t.agentMigration.shouldShow()) ? W.AgentMigrationSourceSelection : W.Complete;
    case W.AgentMigrationSourceSelection:
    case W.AgentMigrationItemSelection:
      return it({ currentStep: e, result: n });
    case W.Complete:
      return W.Complete;
  }
}
function it({ currentStep: e, result: t }) {
  switch (e) {
    case W.AgentMigrationSourceSelection:
      return t?.step === W.AgentMigrationSourceSelection &&
        t.skipped !== !0 &&
        t.providerIds.length > 0
        ? W.AgentMigrationItemSelection
        : W.Complete;
    case W.AgentMigrationItemSelection:
      return W.Complete;
  }
...
function ct(e, t) {
  switch ((E.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case W.TeenWelcome:
      return;
    case W.TeenInterests:
      e.set(J, t);
...
function Q(e) {
  ...
  return (
    t[7] === c
      ? (l = t[8])
      : ((l = (0, Z.jsx)(Z.Fragment, { children: c })), (t[7] = c), (t[8] = l)),
    l
  );
}
function ut(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = { status: `idle` }), (t[0] = s))
    : (s = t[0]);
  let [c, l] = (0, X.useState)(s),
    u;
  t[1] !== n.isCoworkMigrationEnabled || t[2] !== n.isImportEnabled
    ? ((u = { enabled: n.isImportEnabled, isCoworkMigrationEnabled: n.isCoworkMigrationEnabled }),
  ...
  let d = B(u),
    f;
  t[4] !== d || t[5] !== r
    ? ((f = d.getSummaryForProviders(r)), (t[4] = d), (t[5] = r), (t[6] = f))
    : (f = t[6]);
  let p = f,
    m;
  t[7] !== a || t[8] !== o?.arm
    ? ((m = (e) => {
        P(a, {
          eventName: `opaline_onboarding_external_agent_import_event`,
  ...
  t[15] !== a
    ? ((g = (e) => {
        ...
        if (o === !0 || t == null) {
          i({ step: W.AgentMigrationItemSelection, action: `skipped` });
          return;
        }
        lt({
          ...
          importStatus: c,
          onComplete: () => {
            i({ step: W.AgentMigrationItemSelection, action: `imported` });
          },
          onImportStarted: dt,
          scope: a,
          setImportStatus: l,
...
function ft(e) {
  ...
  t[0] !== n.isCoworkMigrationEnabled || t[1] !== n.isImportEnabled
    ? ((i = { enabled: n.isImportEnabled, isCoworkMigrationEnabled: n.isCoworkMigrationEnabled }),
  ...
  return (
    t[3] !== a || t[4] !== r
      ? ((o = (0, Z.jsx)(pt, { agentMigration: a, onContinue: r, summary: a.summary })),
        (t[3] = a),
        (t[4] = r),
        (t[5] = o))
      : (o = t[5]),
...
function pt(e) {
  ...
  t[3] !== n.providerIds || t[4] !== l || t[5] !== i
    ? ((u = (e) => {
        l({ source: `first_time_onboarding`, action: e, ...Me(i, Fe(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = l),
      (t[5] = i),
  ...
  t[9] === p
    ...
    : ((m = () => {
      ...
      (t[10] = m));
  let h;
  (t[11] === i ? (h = t[12]) : ((h = [i]), (t[11] = i), (t[12] = h)), (0, X.useEffect)(m, h));
  let g;
  t[13] === r
    ? (g = t[14])
    : ((g = (e) => {
        ...
        return (0, Z.jsx)(Ne, {
          ...
          onContinue: (e) => {
            ...
            (r && d(`skipped`),
              t({
                result: {
                  step: W.AgentMigrationSourceSelection,
                  providerIds: e,
                  ...(r ? { skipped: !0 } : {}),
                },
                skipped: r,
          ...
          onSkip: () => {
            (d(`skipped`),
              t({
                result: { step: W.AgentMigrationSourceSelection, providerIds: [], skipped: !0 },
                skipped: !0,
              }));
          },
        });
...
function ht(e) {
  let t = (0, U.c)(23),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = { roles: [], personalizedSuggestionsEnabled: !0, workMode: null }), (t[0] = s))
    : (s = t[0]);
  let [c, l] = (0, X.useState)(s),
    u;
  t[1] !== a || t[2] !== o?.arm
    ? ((u = (e) => {
        ...
        P(a, {
          eventName: `opaline_onboarding_welcome_option_toggled`,
          metadata: {
            step: `role`,
            option: t,
            selected: n,
  ...
  t[4] !== a || t[5] !== o?.arm
    ? ((f = (e) => {
        P(a, {
          eventName: `opaline_onboarding_welcome_skip_clicked`,
          metadata: {
            step: `role`,
              ...
              children: [
                  ...
                  children: [
                    ...
                    (0, Z.jsx)(`p`, {
                      ...
                      children: (0, Z.jsx)(N, {
                        ...
                        defaultMessage: `Customize Opaline to fit the way you work`,
                ...
                (0, Z.jsx)(`div`, {
                  ...
                  children: ze.map((e) =>
                    (0, Z.jsx)(
                      gt,
                      { role: e, selected: c.roles.includes(e), onClick: () => h(e) },
                      e,
                    ),
                  ),
                }),
                (0, Z.jsx)(_t, { checked: c.personalizedSuggestionsEnabled, onChange: _ }),
                (0, Z.jsxs)(`div`, {
                  ...
                  children: [
                    (0, Z.jsx)(`button`, {
                      ...
                      onClick: () => {
                        t({
                          result: {
                            step: W.RoleSelection,
                            roles: c.roles,
                            personalizedSuggestionsEnabled: c.personalizedSuggestionsEnabled,
                            workMode: H(c.roles),
                          },
                        });
                      },
                    ...
                    (0, Z.jsx)(`button`, {
                      ...
                      onClick: () => {
                        let e = [mt],
                          n = { roles: e, personalizedSuggestionsEnabled: !1, workMode: H(e) };
                        (p(n),
                          t({
                            result: {
                              step: W.RoleSelection,
  ...
  return (
    t[20] !== S || t[21] !== C
      ? ((w = (0, Z.jsx)(Q, { name: `role_selection`, onComplete: S, children: C })),
        (t[20] = S),
        (t[21] = C),
        (t[22] = w))
      : (w = t[22]),
...
function _t(e) {
  ...
  let o;
  t[2] !== n || t[3] !== r || t[4] !== a
    ? ((o = (0, Z.jsx)(De, { checked: n, ariaLabel: a, onChange: r })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = a),
      (t[5] = o))
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Z.jsx)(`span`, {
        ...
        children: (0, Z.jsx)(N, {
          ...
          defaultMessage: `Opaline can suggest what to do next by searching project files and connected apps`,
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Z.jsx)(ye, { className: `size-4`, "aria-hidden": `true` })), (t[16] = f))
    : (f = t[16]);
  let p;
  t[17] === d
    ? (p = t[18])
  ...
  t[4] === i
    ...
    : ((l = (e) => {
        ...
        return (0, Z.jsx)(yt, {
          ...
          onToggleInterest: s,
          onNext: () => {
            t({ result: { step: W.TeenInterests, interests: i } });
          },
        });
      }),
      (t[4] = i),
      ...
      t[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((l = (0, Z.jsx)(`h1`, {
            ...
            children: (0, Z.jsx)(N, {
              ...
              defaultMessage: `See what Opaline can do`,
...
function Tt(e) {
  ...
  t[7] === n.titleMessage
    ...
    : ((s = (0, Z.jsx)(`h3`, {
        ...
        children: (0, Z.jsx)(N, { ...n.titleMessage }),
      })),
      (t[7] = n.titleMessage),
      (t[8] = s));
  let c;
  t[9] === n.descriptionMessage
    ...
    : ((c = (0, Z.jsx)(`p`, {
        ...
        children: (0, Z.jsx)(N, { ...n.descriptionMessage }),
      })),
      (t[9] = n.descriptionMessage),
      (t[10] = c));
  let l;
  ...
  t[2] === n
    ...
    : ((a = (e) => {
        ...
        return (0, Z.jsx)(Ct, {
          ...
          onContinue: (e) => {
            t({
              result: e == null ? { step: W.TeenPrompts } : { step: W.TeenPrompts, prompt: e },
              skipped: e == null,
            });
          },
        });
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Z.jsx)(`h1`, {
        ...
        children: (0, Z.jsx)(N, {
          ...
          defaultMessage: `Welcome to Opaline`,
    ...
    ? ((l = (0, Z.jsxs)(`button`, {
        ...
        children: [
          (0, Z.jsx)(N, {
            ...
            defaultMessage: `Learn more about what Opaline can do`,
            description: `Link label on the teen onboarding welcome page`,
          }),
          (0, Z.jsx)(ke, { className: `icon-sm` }),
        ],
      })),
      (t[7] = l))
    : (l = t[7]);
...
function Ot() {
  ee.dispatchMessage(`open-in-browser`, { url: `https://openai.com/opaline/` });
}
function kt() {
  let e = (0, U.c)(4),
    t;
...
function $(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = y(`absolute overflow-hidden rounded-2xl border border-token-border/50 shadow-2xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function Mt(e) {
  ...
  switch (n) {
    case W.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Z.jsx)(je, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    case W.TeenWelcome: {
      let e;
      return (
        t[1] === i ? (e = t[2]) : ((e = (0, Z.jsx)(At, { onContinue: i })), (t[1] = i), (t[2] = e)),
        e
      );
    }
    case W.TeenInterests: {
      let e;
      return (
        t[3] === i ? (e = t[4]) : ((e = (0, Z.jsx)(xt, { onContinue: i })), (t[3] = i), (t[4] = e)),
        e
      );
    }
    case W.TeenPrompts: {
      ...
      return (
        t[5] !== i || t[6] !== a.interests
          ? ((e = (0, Z.jsx)(Et, { selectedInterests: a.interests, onContinue: i })),
            (t[5] = i),
            (t[6] = a.interests),
            (t[7] = e))
          : (e = t[7]),
    ...
    case W.RoleSelection: {
      ...
      return (
        t[8] !== i || t[9] !== r.isLoading
          ? ((e = (0, Z.jsx)(ht, { isAdvancePending: r.isLoading, onContinue: i })),
            (t[8] = i),
            (t[9] = r.isLoading),
            (t[10] = e))
          : (e = t[10]),
    ...
    case W.AgentMigrationSourceSelection: {
      ...
      return (
        t[11] !== i || t[12] !== r.agentMigration
          ? ((e = (0, Z.jsx)(ft, { agentMigrationContext: r.agentMigration, onContinue: i })),
            (t[11] = i),
...
function Nt() {
  let e = (0, U.c)(21),
    ...
    [i, a] = (0, X.useState)(!1),
    o;
  e[0] === i ? (o = e[1]) : ((o = { isAdvancingOnboarding: i }), (e[0] = i), (e[1] = o));
  let s = $e(o),
    c;
  e[2] !== r || e[3] !== s || e[4] !== t
    ? ((c = (e) =>
  ...
  e[6] === l
    ...
    : ((u = () => {
      ...
      (e[6] = l),
      (e[7] = u));
  let d = (0, X.useEffectEvent)(u),
    p;
  e[8] !== d || e[9] !== n || e[10] !== s.isLoading
    ? ((p = () => {
        n !== W.Start || s.isLoading || d();
      }),
      (e[8] = d),
      (e[9] = n),
      (e[10] = s.isLoading),
  ...
  (e[12] !== n || e[13] !== s.isLoading
    ? ((m = [n, s.isLoading]), (e[12] = n), (e[13] = s.isLoading), (e[14] = m))
    : (m = e[14]),
    (0, X.useEffect)(p, m));
  let h;
  e[15] === l
  ...
  let g = h,
    _;
  return (
    e[17] !== n || e[18] !== g || e[19] !== s
      ? ((_ = (0, Z.jsx)(Mt, { currentStep: n, onboardingContext: s, onContinue: g })),
        (e[17] = n),
        (e[18] = g),
        (e[19] = s),
        (e[20] = _))
...
function Pt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(Le, {
          fullBleed: !0,
          children: (0, Z.jsx)(C, { scope: G, children: (0, Z.jsx)(Nt, {}) }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
...
export { Pt as OnboardingPage };
//# sourceMappingURL=onboarding-page-Cia_8FB5.js.map

...
import { o as re, r as E, t as ie } from "./opaline-mobile-setup-dialog-DzxoAWgH.js";
...
var G = 3e4,
  ...
  fe = l(g, ({ get: e }) => ({
    enabled: e(a, i),
    queryKey: [`opaline-mobile-setup-resume-client`],
    queryFn: () => oe(),
    staleTime: 0,
  }));
...
function J(e) {
  ...
  (t[9] !== O || t[10] !== c || t[11] !== s
    ? ((j = () => {
        ...
        f.current !== e &&
          ((f.current = e),
          ne(c, {
            eventName: `opaline_remote_control_onboarding_step_viewed`,
  ...
  (t[14] !== O || t[15] !== c
    ? ((N = () => {
        O === `connected` && o(c, r.OPALINE_MOBILE_SETUP_COMPLETED, !0);
      }),
      (P = [O, c]),
      (t[14] = O),
      (t[15] = c),
    ...
    : ((p =
        c === `allow-host` || c === `mfa-required` || c === `waiting`
          ? (0, q.jsx)(S.Header, {
              children: (0, q.jsx)(C, {
                start: (0, q.jsx)(b, {
                  id: `opalineMobile.setupPage.title`,
                  defaultMessage: `Set up Opaline Mobile`,
                  description: `Toolbar title shown during Opaline mobile setup`,
                }),
              }),
            })
          : null),
...
//# sourceMappingURL=opaline-mobile-setup-flow-BJuQbjBl.js.map

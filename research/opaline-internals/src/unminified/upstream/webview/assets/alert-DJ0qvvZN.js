...
import { c as r } from "./lib-MoKmYgcO.js";
import { t as i } from "./x-DypUcSQe.js";
var a = n(),
  o = e();
function s(e) {
  let n = (0, a.c)(22),
    s = r(),
    { className: c, level: l, fullWidth: u, children: d, icon: f, onRemove: p, testId: m } = e,
    h = l === void 0 ? `info` : l,
    g = h === `info`,
    _ = h === `success`,
    v = h === `warning`,
    y = h === `danger`,
    b;
  n[0] !== c || n[1] !== u || n[2] !== g || n[3] !== _ || n[4] !== v || n[5] !== y
    ? ((b = t(
        ...
        {
          flex: u,
          "border-token-border bg-token-dropdown-background": g,
          "border-token-border bg-token-input-validation-info-background": _,
  ...
  n[7] === f
    ...
    : ((S = f
        ? (0, o.jsx)(`div`, {
            ...
            children: (0, o.jsx)(f, { className: `icon-sm` }),
          })
        : null),
      (n[7] = f),
      (n[8] = S));
  ...
  n[9] === d
    ? (C = n[10])
    : ((C =
        typeof d == `string` ? (0, o.jsx)(`div`, { className: `font-medium`, children: d }) : d),
      (n[9] = d),
      (n[10] = C));
  let w;
  n[11] === C
    ? (w = n[12])
    : ((w = (0, o.jsx)(`div`, { className: `flex-1 justify-center gap-2`, children: C })),
      (n[11] = C),
      (n[12] = w));
  let T;
  n[13] !== s || n[14] !== p
    ? ((T = p
        ? (0, o.jsx)(`button`, {
            ...
            children: (0, o.jsx)(i, { className: `icon-xs` }),
          })
        : null),
      (n[13] = s),
      (n[14] = p),
  ...
  let E;
  return (
    n[16] !== x || n[17] !== S || n[18] !== w || n[19] !== T || n[20] !== m
      ? ((E = (0, o.jsxs)(`div`, {
          className: x,
          role: `alert`,
          "data-testid": m,
...
export { s as t };
//# sourceMappingURL=alert-DJ0qvvZN.js.map

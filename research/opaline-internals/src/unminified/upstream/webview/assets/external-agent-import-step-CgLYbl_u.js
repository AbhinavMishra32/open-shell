...
import { $r as t } from "./src-CYrn1fYL.js";
import { Ho as n, bc as r, fo as i, so as a } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { c as y, n as b, o as x } from "./lib-MoKmYgcO.js";
import { a as S, o as C, r as w } from "./config-queries-BDIsZFnB.js";
import { i as T, j as E, m as D, n as O } from "./sidebar-signals-B0JkGccK.js";
import { t as k } from "./tooltip-BhXPONlb.js";
import { t as A } from "./button-Xd4Hy1MO.js";
import { t as j } from "./spinner-Dvc_A3Ae.js";
import { t as M } from "./apps-DBd5dYzG.js";
import { t as N } from "./use-plugins-BKOuT9XR.js";
import { t as P } from "./check-circle-filled-CC_XQe30.js";
import { t as F } from "./terminal-CsU-mb2r.js";
import { t as I } from "./info-BV-snsxq.js";
import { n as L, t as R } from "./json-CuUDWIw2.js";
import { t as ee } from "./settings.cog-CJF3NOGk.js";
import { t as z } from "./skills-8SYgG-va.js";
import {
  a as te,
  d as B,
  i as ne,
...
import { t as V } from "./use-skills-DK2PGa-B.js";
import { t as se } from "./checkbox-Bz6PC7ig.js";
import { t as H } from "./sortBy-EVRmvlY9.js";
import { t as ce } from "./toggle-CHrq20xd.js";
import { s as U } from "./permissions-mode-visibility-DNx7wvRA.js";
import { t as le } from "./folders-M-71dKsg.js";
import { t as ue } from "./hooks-Bi5GvUJV.js";
import { t as de } from "./opaline-app-ga-logo-Ce-JNlBO.js";
import { n as fe, r as W } from "./onboarding-shell-B5Vl8B3_.js";
var pe = e(H(), 1);
function me(e, t) {
  switch (t.itemType) {
    case `AGENTS_MD`:
...
function G(e) {
  return (0, pe.default)(e, ({ itemType: e }) => {
    switch (e) {
      case `CONFIG`:
        return 0;
      case `AGENTS_MD`:
...
function be(e) {
  let t = (0, Y.c)(14),
    { sourceIconVariant: n, title: r, subtitle: i } = e,
    a;
  t[0] === n ? (a = t[1]) : ((a = (0, J.jsx)(xe, { variant: n })), (t[0] = n), (t[1] = a));
  let o, s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, J.jsx)(ve, { className: `h-12 w-10 text-token-foreground` })),
      (s = (0, J.jsx)(`img`, { alt: ``, className: `size-12`, src: de })),
      (t[2] = o),
      (t[3] = s))
    : ((o = t[2]), (s = t[3]));
  let c;
...
function xe(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = c(`flex size-12 shrink-0 items-center justify-center rounded-xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, J.jsx)(ye, { className: `size-6` })), (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === i
      ? (o = t[4])
      : ((o = (0, J.jsx)(`div`, { className: i, children: a })), (t[3] = i), (t[4] = o)),
    o
  );
}
var Se = [`claude-code`, `claude-cowork`],
  Ce = {
    "claude-code": {
      Icon: ge,
      label: b({
...
function we(e) {
  let t = (0, Y.c)(48),
    { providerIds: n, variant: r, onCustomize: i, onContinue: a, onSkip: o } = e,
    s = r === void 0 ? `onboarding` : r,
    c = y(),
    [l, u] = (0, q.useState)(n),
    d = s === `dialog`,
    f;
  ...
  t[14] !== d || t[15] !== p
    ? ((E = d
        ? (0, J.jsx)(te, {
            children: (0, J.jsx)(ne, {
              title: (0, J.jsx)(B, { className: `contents`, children: p }),
              subtitle: (0, J.jsx)(oe, { className: `sr-only`, children: h }),
            }),
          })
        : (0, J.jsx)(be, { sourceIconVariant: `neutral`, title: p, subtitle: h })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = E))
    : (E = t[16]);
  let D = d ? `mt-4 flex w-full flex-col` : `mt-8 flex w-full max-w-xs flex-col`,
    O;
  ...
  if (t[20] !== n || t[21] !== l) {
    let e;
    t[23] === n ? (e = t[24]) : ((e = (e) => n.includes(e)), (t[23] = n), (t[24] = e));
    let r;
    (t[25] === l
      ? (r = t[26])
      : ((r = (e) =>
          (0, J.jsx)(Te, { providerId: e, selected: l.includes(e), onToggle: () => C(e) }, e)),
        (t[25] = l),
        (t[26] = r)),
      (j = Se.filter(e).map(r)),
      (t[20] = n),
  ...
  let P;
  t[31] !== M || t[32] !== D
    ? ((P = (0, J.jsxs)(`div`, { className: D, children: [O, M, N] })),
      (t[31] = M),
      (t[32] = D),
      (t[33] = P))
    : (P = t[33]);
  let F;
  t[34] !== _ || t[35] !== b || t[36] !== d || t[37] !== i || t[38] !== o
    ? ((F = d
        ? (0, J.jsx)(`div`, {
            className: `mt-4`,
    ...
    : (F = t[39]);
  let I;
  t[40] !== P || t[41] !== F || t[42] !== E
    ? ((I = (0, J.jsxs)(J.Fragment, { children: [E, P, F] })),
      (t[40] = P),
      (t[41] = F),
      (t[42] = E),
      (t[43] = I))
  ...
  let L = I,
    R;
  return (
    t[44] !== L || t[45] !== T || t[46] !== d
      ? ((R = d
          ? (0, J.jsx)(ie, { as: `form`, className: `gap-0`, onSubmit: T, children: L })
          : (0, J.jsx)(`div`, {
...
function Te(e) {
  ...
  t[10] !== i || t[11] !== r || t[12] !== f
    ? ((p = (0, J.jsx)(ce, { checked: r, ariaLabel: f, onChange: i })),
      (t[10] = i),
      (t[11] = r),
      (t[12] = f),
      (t[13] = p))
...
function Oe(e) {
                ...
                (0, J.jsxs)(`label`, {
                  ...
                  children: [
                    (0, J.jsx)(`div`, {
                      ...
                      children: (0, J.jsx)(ke, { icon: e.icon }),
                    }),
                    (0, J.jsxs)(`div`, {
                ...
                e.tooltip == null
                  ...
                  : (0, J.jsx)(k, {
                      ...
                      children: (0, J.jsx)(`button`, {
                        ...
                        children: (0, J.jsx)(I, { className: `size-4`, "aria-hidden": `true` }),
                      }),
                    }),
                (0, J.jsx)(`div`, {
  ...
  t[11] === f
    ? (p = t[12])
    : ((p = (0, J.jsx)(`div`, { className: `flex flex-col gap-2`, children: f })),
      (t[11] = f),
      (t[12] = p));
  let m = l === 0,
    h;
  ...
  return (
    t[20] !== p || t[21] !== _
      ? ((v = (0, J.jsxs)(`div`, { className: `flex flex-col gap-4 p-4`, children: [u, d, p, _] })),
        (t[20] = p),
        (t[21] = _),
        (t[22] = v))
      : (v = t[22]),
...
function ke(e) {
  ...
  switch (n) {
    case `instructions`: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(L, { className: `icon-base` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    case `settings`: {
      ...
      return (
        t[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(R, { className: `icon-base` })), (t[1] = e))
          : (e = t[1]),
        e
      );
    }
    case `skills`: {
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(z, { className: `icon-base` })), (t[2] = e))
          : (e = t[2]),
        e
      );
    }
    case `plugins`: {
      ...
      return (
        t[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(M, { className: `icon-base` })), (t[3] = e))
          : (e = t[3]),
        e
      );
    }
    case `projects`: {
      ...
      return (
        t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(le, { className: `icon-base` })), (t[4] = e))
          : (e = t[4]),
        e
      );
    }
    case `chats`: {
      ...
      return (
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(Ee, { className: `icon-base` })), (t[5] = e))
          : (e = t[5]),
        e
      );
    }
    case `hooks`: {
      ...
      return (
        t[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(ue, { className: `icon-base` })), (t[6] = e))
          : (e = t[6]),
        e
      );
    }
    case `commands`: {
      ...
      return (
        t[7] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(F, { className: `icon-base` })), (t[7] = e))
          : (e = t[7]),
        e
      );
    }
    case `agents`: {
      ...
      return (
        t[8] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, J.jsx)(U, { className: `icon-base` })), (t[8] = e))
          : (e = t[8]),
        e
      );
    }
...
async function Ae({
  ...
  return (i != null && (await Fe(i)), { importedProjectRoots: a });
}
async function je({
  hostId: e,
  invalidateWorkspaceRootQueries: t,
  ...
  try {
    let i = await Me({ hostId: e, projectRoots: r });
    return i.length === 0 ? [] : (n?.(i), await Ne(i), await t?.(), i);
  } catch (t) {
    return (
      p.warning(`Failed to add imported project roots after import`, {
        safe: { hostId: e },
        sensitive: { error: t },
      }),
      []
...
async function Me({ hostId: e, projectRoots: t }) {
...
async function Ne(e) {
  ...
  t.length > 0 &&
    p.warning(`Failed to add some imported project roots after import`, {
      safe: { failedRootCount: t.length, totalRootCount: e.length },
      sensitive: { errors: t.map((e) => e.reason) },
    });
}
function Pe(e = n) {
  return r(`refresh-recent-conversations-for-host`, { hostId: e });
}
async function Fe(e) {
  try {
    await e();
  } catch (e) {
    p.warning(`Failed to refresh recent conversations after import`, {
      safe: {},
      sensitive: { error: e },
    });
  }
}
function Ie({ homeItems: e, projectItems: t }) {
...
function Le(e) {
  let n = t(e.sessionItems),
    r = t(e.projectItems),
    i = [...new Set([...n, ...r])].sort((e, t) => e.localeCompare(t));
  return [
    ...
    ...(e.projectItems.length > 0 || i.length > 0
      ? [{ key: `projects`, kind: `projects`, count: i.length, items: e.projectItems }]
      : []),
    ...(e.sessionItems.length > 0
      ? [{ key: `chats`, kind: `chats`, count: Ve(e.sessionItems), items: e.sessionItems }]
      : []),
  ];
}
function Re({ model: e, selection: t }) {
  let n = e.projectItems.some((e, n) => Object.prototype.hasOwnProperty.call(t, ze(e, n))),
    r = Le(e).filter((e) => t[e.key] ?? !1);
  return [
    ...r
      .filter((e) => e.kind !== `chats`)
      .flatMap((e) =>
        e.kind !== `projects` || !n ? e.items : e.items.filter((e, n) => t[ze(e, n)] ?? !1),
      ),
...
function He({ hostId: e, isCoworkMigrationEnabled: t, workspaceRoots: n }) {
  return [`external-agent-config`, `import-model`, `detected`, e, t, n];
}
async function Ue({
  hostId: e,
  includeHome: t,
  ...
  let a = i == null || i.length === 0 ? void 0 : i;
  return g(`external-agent-import-detect`, {
    params: {
      hostId: e,
      includeHome: t,
      providers: r ?? Ge(n),
      ...(a == null ? {} : { workspaceRoots: a }),
    },
  });
}
async function We({ hostId: e, items: t }) {
  return t.length === 0
    ? { projectRoots: [] }
    : g(`external-agent-import-import`, { params: { hostId: e, items: t } });
}
function Ge(e) {
  return e ? [`claude-code`, `claude-cowork`] : [`claude-code`];
}
async function Ke(e) {
  await Promise.all([
    e.invalidateQueries({ queryKey: N }),
    e.invalidateQueries({ queryKey: V }),
    e.invalidateQueries({ queryKey: S }),
    e.invalidateQueries({ queryKey: w }),
    e.invalidateQueries({ queryKey: C }),
    e.invalidateQueries({ queryKey: _(`local-custom-agents`) }),
    e.invalidateQueries({ queryKey: _(`external-agent-import-status`) }),
    e.invalidateQueries({ queryKey: _(`external-agent-imported-connectors`) }),
  ]);
}
function qe({ items: e, surface: t }) {
  p.info(`external_agent_import_user_flow_started`, { safe: { surface: t, ...Xe(e) } });
}
function Je({
  durationMs: e,
  error: t,
  ...
  let c = {
    ...
    projectRootsReturnedCount: i,
    remainingArtifactsCount: a,
    ...(n == null ? {} : { failedStage: n, failureKind: Ye(n) }),
    ...Xe(r),
  };
  if (o === `success`) {
    p.info(`external_agent_import_user_flow_finished`, { safe: c });
    return;
  }
  p.warning(`external_agent_import_user_flow_finished`, { safe: c, sensitive: { error: t } });
}
function Ye(e) {
  switch (e) {
    case `import`:
...
function $e(e) {
  let t = (0, Y.c)(42),
    { enabled: r, hostId: i, isCoworkMigrationEnabled: a, workspaceRoots: o } = e,
    s = i === void 0 ? n : i,
    c;
  t[0] !== s || t[1] !== a || t[2] !== o
    ? ((c = He({ hostId: s, isCoworkMigrationEnabled: a, workspaceRoots: o })),
      (t[0] = s),
      (t[1] = a),
      (t[2] = o),
      (t[3] = c))
  ...
  t[4] !== s || t[5] !== a || t[6] !== o
    ? ((l = () =>
        Ue({ hostId: s, includeHome: !0, isCoworkMigrationEnabled: a, workspaceRoots: o })),
      (t[4] = s),
      (t[5] = a),
      (t[6] = o),
      (t[7] = l))
  ...
  let u;
  t[8] !== r || t[9] !== c || t[10] !== l
    ? ((u = { queryKey: c, staleTime: 0, enabled: r, queryFn: l }),
      (t[8] = r),
      (t[9] = c),
      (t[10] = l),
      (t[11] = u))
  ...
  let d = v(u),
    p = d.data?.items ?? Ze,
    m = d.data?.unsupportedProjects ?? Qe,
    h;
  t[12] === p ? (h = t[13]) : ((h = p.filter(tt)), (t[12] = p), (t[13] = h));
  let g = h,
    _;
  t[14] === p ? (_ = t[15]) : ((_ = p.filter(et)), (t[14] = p), (t[15] = _));
  let y = _,
    b;
  t[16] !== g || t[17] !== y
    ? ((b = Ie({ homeItems: g, projectItems: y })), (t[16] = g), (t[17] = y), (t[18] = b))
    : (b = t[18]);
  let x = b,
    S;
  t[19] === x ? (S = t[20]) : ((S = x == null ? [] : Le(x)), (t[19] = x), (t[20] = S));
  let C = S,
    w = r && d.isLoading,
    T;
  t[21] === x
    ? (T = t[22])
    : ((T = (e) => (x == null ? [] : Re({ model: x, selection: e }))), (t[21] = x), (t[22] = T));
  let E = T,
    D;
  t[23] === s
    ? (D = t[24])
    : ((D = { mutationFn: (e) => We({ hostId: s, items: e }) }), (t[23] = s), (t[24] = D));
  let O = f(D),
    k = x != null || m.length > 0,
    A = x != null,
    j;
  t[25] !== E || t[26] !== O
    ? ((j = (e) => O.mutateAsync(E(e))), (t[25] = E), (t[26] = O), (t[27] = j))
    : (j = t[27]);
  let M;
  t[28] === d
    ? (M = t[29])
    : ((M = async () => (await d.refetch()).data?.items ?? Ze), (t[28] = d), (t[29] = M));
  let N;
  return (
    t[30] !== C ||
    t[31] !== p ||
    ...
    t[40] !== m
      ? ((N = {
          choices: C,
          detectedItems: p,
          unsupportedProjects: m,
          getSelectedItems: E,
          hasDetectedItems: k,
          hasImportableItems: A,
          importSelected: j,
          importItems: O.mutateAsync,
          isDetecting: w,
          isImporting: O.isPending,
          refetchDetectedItems: M,
        }),
        (t[30] = C),
        (t[31] = p),
        (t[32] = E),
...
var nt = [`claude-code`, `claude-cowork`],
  rt = 6;
function it(e) {
  let t = (0, Y.c)(33),
    { enabled: r, isCoworkMigrationEnabled: i } = e,
    a = u(m),
    o = y(),
    s = l(),
    c = d(O),
    f;
  t[0] !== r || t[1] !== i
    ? ((f = { enabled: r, isCoworkMigrationEnabled: i }), (t[0] = r), (t[1] = i), (t[2] = f))
    : (f = t[2]);
  let {
      detectedItems: p,
      getSelectedItems: h,
      hasImportableItems: g,
      importItems: v,
      importSelected: b,
      isDetecting: x,
      isImporting: S,
    ...
    C;
  t[3] !== p || t[4] !== i
    ? ((C = st({ detectedItems: p, isCoworkMigrationEnabled: i })),
      (t[3] = p),
      (t[4] = i),
      (t[5] = C))
    : (C = t[5]);
  ...
  bb0: {
    ...
    let e;
    (t[6] !== p || t[7] !== o || t[8] !== w
      ? ((e = X({ detectedItems: p, intl: o, providerIds: w })),
        (t[6] = p),
        (t[7] = o),
        (t[8] = w),
        (t[9] = e))
  ...
  let k = E,
    ...
    N;
  t[10] !== p || t[11] !== o
    ? ((N = (e) => X({ detectedItems: p, intl: o, providerIds: e })),
      (t[10] = p),
      (t[11] = o),
      (t[12] = N))
    : (N = t[12]);
  ...
  t[23] !== k
    ? ((P = async (e, t) => {
        if (!r || (t == null && !g)) return;
        let i = t == null ? k : X({ detectedItems: p, intl: o, providerIds: t }),
          l = t == null ? h(e) : ct({ detectedItems: p, providerIds: t, selection: e }),
          u = Date.now(),
          d = `import`,
          f = 0;
        qe({ items: l, surface: `first_time_onboarding` });
        let m = i?.chatChoiceKey != null && e[i.chatChoiceKey];
        try {
          d = `import`;
          let { projectRoots: r } = t == null ? await b(e) : await v(l);
          ((f = r.length),
            ...
            await Ae({
              ...
              onImportedProjectRootsReady: (e) => {
                D(a, T({ collapsedGroups: c, importedProjectRoots: e }));
              },
              projectRoots: r,
              invalidateWorkspaceRootQueries: async () => {
                await Promise.all([
                  s.invalidateQueries({ queryKey: _(`workspace-root-options`) }),
                  s.invalidateQueries({ queryKey: _(`active-workspace-roots`) }),
                ]);
              },
              refreshRecentConversations: m ? at : void 0,
            }),
            (d = `invalidate_queries`),
            await Promise.all([
              s.invalidateQueries({ queryKey: _(`opaline-agents-md`) }),
              s.invalidateQueries({ queryKey: V }),
            ]),
            Je({
              durationMs: Date.now() - u,
              items: l,
              projectRootsReturnedCount: f,
              remainingArtifactsCount: 0,
              status: `success`,
  ...
  return (
    ...
    t[31] !== P
      ? ((F = {
          ...
          isImporting: j,
          providerIds: w,
          shouldShowImportStep: M,
          summary: k,
          getSummaryForProviders: N,
          importSelection: P,
        }),
        (t[25] = w),
        (t[26] = k),
...
function at() {
  return r(`refresh-recent-conversations-for-host`, { hostId: n, sortKey: E });
}
async function ot({ isCoworkMigrationEnabled: e, queryClient: t }) {
  try {
    return (
      st({
        detectedItems: (
          await t.fetchQuery({
            queryKey: He({ hostId: n, isCoworkMigrationEnabled: e }),
            queryFn: () => Ue({ hostId: n, includeHome: !0, isCoworkMigrationEnabled: e }),
            staleTime: 0,
          })
        ).items,
        isCoworkMigrationEnabled: e,
      }).length > 0
    );
  } catch {
    return !1;
...
function st({ detectedItems: e, isCoworkMigrationEnabled: t }) {
  return nt.filter((n) => (n === `claude-cowork` && !t ? !1 : lt(e, [n]) != null));
}
function X({ detectedItems: e, intl: t, providerIds: n }) {
  let r = lt(e, n),
    i = r == null ? [] : Le(r);
  return i.length === 0 ? null : ut(t, i);
}
function ct({ detectedItems: e, providerIds: t, selection: n }) {
  let r = lt(e, t);
  return r == null ? [] : Re({ model: r, selection: n });
}
function lt(e, t) {
...
function ut(e, t) {
  let n = t.filter((e) => e.kind === `migrationItem`),
    ...
    a = St([...(r?.items ?? []), ...(i?.items ?? [])]),
    o = ft(i, r, n),
    s = i == null ? void 0 : yt(e, i),
    c = n.map((t) => Ct(e, t, `toolsAndSetup`));
  return (
    r != null &&
      r.count > 0 &&
      c.push({
        ...
        group: `projects`,
        icon: `projects`,
        ...(a.length === 0 ? {} : { tooltip: { text: kt(e, a) } }),
      }),
    i != null &&
      i.count > 0 &&
      c.push({
      ...
      }),
    {
      ...
      ...(a.length === 0 ? {} : { projectTooltip: { text: kt(e, a) } }),
      projectChoiceKey: r?.key ?? null,
      providerBreakdowns: o,
      ...(s == null ? {} : { recentChatTooltip: s }),
      toolsAndSetupCount: n.length,
      ...(n.length === 0 ? {} : { toolsAndSetupTooltip: _t(e, n) }),
...
function Z(e, t, n = gt(e)) {
  ...
  let o = Object.values(r).reduce((e, t) => e + t, 0),
    ...
    l = pt(e, t, c, s),
    u = mt(`claude-code`, e, t, c, s),
    d = mt(`claude-cowork`, e, t, c, s);
  return {
    ...r,
    chats_count: e.recentChatCount,
    chats_selected: s,
    claude_code_chats_count: u.chatsCount,
    claude_code_chats_selected: u.chatsSelected,
    claude_code_projects_count: u.projectsCount,
    claude_code_projects_selected: u.projectsSelected,
    claude_code_tools_and_setup_selected_count: u.toolsAndSetupSelectedCount,
    claude_code_tools_and_setup_total_count: u.toolsAndSetupTotalCount,
    claude_cowork_chats_count: d.chatsCount,
    claude_cowork_chats_selected: d.chatsSelected,
    claude_cowork_projects_count: d.projectsCount,
    claude_cowork_projects_selected: d.projectsSelected,
    claude_cowork_tools_and_setup_selected_count: d.toolsAndSetupSelectedCount,
    claude_cowork_tools_and_setup_total_count: d.toolsAndSetupTotalCount,
    detected_provider_count: n.length,
    detected_provider_ids: n.join(`,`),
    projects_count: e.projectCount,
    projects_selected: c,
    selected_provider_count: l.length,
    selected_provider_ids: l.join(`,`),
    selected_items_count: o,
    total_items_count: a,
  };
}
function dt(e) {
...
function ft(e, t, n) {
  let r = e?.items ?? [],
    i = [...(t?.items ?? []), ...r];
  return nt.flatMap((e) => {
    let t = St(i.filter((t) => t.providerId === e)).length,
      a = ht(r.filter((t) => t.providerId === e)),
...
function bt(e, t) {
  return [...new Set(t.map((e) => e.providerId))].map((t) => xt(e, t));
}
function xt(e, t) {
  switch (t) {
    case `claude-code`:
...
function wt(e, t) {
  ...
  let r = Dt(t);
  if (r.length > 0) return { tooltip: { text: kt(e, r) } };
  let i = Et(e, t);
    ...
    case `AGENTS_MD`:
      return {
        text: e.formatMessage({
          ...
          description: `Tooltip explaining how Claude instructions are imported into Opaline`,
        }),
      };
    case `CONFIG`:
      return t.providerId === `claude-cowork`
        ...
        : {
            text: e.formatMessage({
              ...
              description: `Tooltip explaining how Claude settings are imported into Opaline`,
            }),
          };
    case `COMMANDS`:
    case `HOOKS`:
...
function Et(e, t) {
  switch (t.itemType) {
    case `AGENTS_MD`:
      return `CLAUDE.md`;
    case `CONFIG`:
      return t.providerId === `claude-cowork` ? jt(t.description) : `settings.json`;
    case `SKILLS`:
      return e.formatMessage({
...
function Q({ count: e, fallback: t, formatCount: n }) {
  return e > 0 ? n(e) : t;
}
function Dt(e) {
  switch (e.itemType) {
...
function Mt(e) {
  return i(
    e
      .replace(
        /\/(?:private\/)?var\/folders\/\S+?\/T\/opaline-claude-import\/\.claude(?=\/|\s|$)/g,
        `~/.claude`,
      )
      .replace(
        /\/(?:private\/)?var\/folders\/\S+?\/T\/opaline-claude-import\/\.opaline(?=\/|\s|$)/g,
        `~/.opaline`,
      )
      .replace(
        /\/(?:private\/)?var\/folders\/\S+?\/T\/opaline-claude-import\/\.agents(?=\/|\s|$)/g,
        `~/.agents`,
      )
      .replace(/\/(?:private\/)?tmp\/opaline-claude-import\/\.claude(?=\/|\s|$)/g, `~/.claude`)
      .replace(/\/(?:private\/)?tmp\/opaline-claude-import\/\.opaline(?=\/|\s|$)/g, `~/.opaline`)
      .replace(/\/(?:private\/)?tmp\/opaline-claude-import\/\.agents(?=\/|\s|$)/g, `~/.agents`)
      .replace(/\/Users\/[^/\s]+\/\S+?\/\.stage\/home\/\.claude(?=\/|\s|$)/g, `~/.claude`)
      .replace(/\/Users\/[^/\s]+\/\S+?\/\.stage\/opaline-home(?=\/|\s|$)/g, `~/.opaline`)
      .replace(/\/Users\/[^/\s]+\/\S+?\/\.stage\/\.agents(?=\/|\s|$)/g, `~/.agents`)
      .replace(/\/Users\/[^/\s]+\/\.claude(?=\/|\s|$)/g, `~/.claude`)
      .replace(/\/Users\/[^/\s]+\/\.opaline(?=\/|\s|$)/g, `~/.opaline`)
      .replace(/\/Users\/[^/\s]+\/\.agents(?=\/|\s|$)/g, `~/.agents`)
      .replace(/\/Users\/[^/\s]+(?=\/|\s|$)/g, `~`)
      .replace(/[A-Za-z]:\\Users\\[^\\]+\\\.claude(?=\\|\s|$)/g, `~/.claude`)
      .replace(/[A-Za-z]:\\Users\\[^\\]+\\\.opaline(?=\\|\s|$)/g, `~/.opaline`)
...
function Lt({
  ...
  let _ = y(),
    [v, b] = (0, q.useState)(() => dt(f)),
    [S, C] = (0, q.useState)(!1),
    [w, T] = (0, q.useState)(() => new Set(f.customizeItems.map((e) => e.id))),
    E = l === `dialog`,
    D = i || r,
    O = i || r,
    k = Gt({ summary: f, selection: v }),
    j = Wt({ items: f.customizeItems, selection: v, group: `toolsAndSetup` }),
    M = Wt({ items: f.customizeItems, selection: v, group: `projects` }),
    N = f.chatChoiceKey != null && (v[f.chatChoiceKey] ?? !1),
    P = Bt({ isComplete: r, isSelected: j !== !1 }),
    F = Bt({ isComplete: r, isSelected: M !== !1 }),
    I = Bt({ isComplete: r, isSelected: N }),
    L = (e) => {
      h?.({ source: n, ...e });
    };
  (0, q.useEffect)(() => {
    a && L({ action: `shown`, ...Z(f, v, d) });
  }, []);
  let R = () => {
      (p?.(), C(!0));
    },
    z = () => {
      i || !k || (r || L({ action: `continue`, ...Z(f, v, d) }), m(v));
    },
    re = () => {
      D || (L({ action: `skipped`, ...Z(f, v, d) }), g());
    },
    V = i
      ? (0, J.jsx)(x, {
    ...
    se = s ?? (0, J.jsx)(Rt, {}),
    H = o === void 0 ? (0, J.jsx)(zt, {}) : o,
    ce = (e) => {
      (e.preventDefault(), !(i || !k) && z());
    },
    U = (0, J.jsxs)(J.Fragment, {
      children: [
        E
          ? (0, J.jsx)(te, {
              children: (0, J.jsx)(ne, {
                title: (0, J.jsx)(B, { className: `contents`, children: se }),
                subtitle: H == null ? null : (0, J.jsx)(oe, { children: H }),
              }),
            })
          : (0, J.jsx)(be, { sourceIconVariant: `orange`, title: se, subtitle: H }),
        (0, J.jsxs)(`div`, {
          className: c(`flex w-full flex-col`, E ? `mt-4` : `mt-8 max-w-sm`),
          children: [
            Ut(f)
              ? (0, J.jsxs)(fe, {
                  ...
                  children: [
                    f.toolsAndSetupCount > 0
                      ? (0, J.jsx)(W, {
                          ...
                          checked: j,
                          control: O ? (0, J.jsx)($, { status: P }) : void 0,
                          disabled: D,
                          leadingContent: (0, J.jsx)(ee, { className: `icon-base` }),
                          label: (0, J.jsx)(x, {
                    ...
                    f.projectCount > 0
                      ? (0, J.jsx)(W, {
                          ...
                          checked: M,
                          control: O ? (0, J.jsx)($, { status: F }) : void 0,
                          disabled: D,
                          leadingContent: (0, J.jsx)(le, { className: `icon-base` }),
                          label: (0, J.jsx)(x, {
                    ...
                    f.recentChatCount > 0
                      ? (0, J.jsx)(W, {
                          ...
                          checked: N,
                          control: O ? (0, J.jsx)($, { status: I }) : void 0,
                          disabled: D || f.chatChoiceKey == null,
                          leadingContent: (0, J.jsx)(Ee, { className: `icon-base` }),
                          label: (0, J.jsx)(x, {
        ...
        (0, J.jsx)(De, {
          ...
          onOpenChange: C,
          onConfirm: (e) => {
            let t = f.customizeItems.filter((t) => w.has(t.id) !== e.has(t.id)).length;
            T(e);
            let n = Kt({ current: v, items: f.customizeItems, selectedItemIds: e });
            (b(n), L({ action: `customized`, changed_items_count: t, ...Z(f, n, d) }));
          },
        }),
        (0, J.jsxs)(`div`, {
          className: c(
  ...
  return E
    ? (0, J.jsx)(ie, { as: `form`, className: `gap-0`, onSubmit: ce, children: U })
    : (0, J.jsx)(`div`, {
        className: `flex w-full max-w-lg flex-col items-center overflow-hidden rounded-2xl p-10`,
        children: U,
      });
...
function $(e) {
  ...
  if (n === `idle`) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, J.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5 shrink-0` })),
          (t[0] = e))
        : (e = t[0]),
      e
    );
  ...
  if (n === `complete`) {
    ...
    let n;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, J.jsx)(P, { className: `h-5 w-5 text-token-charts-green` })), (t[3] = n))
      : (n = t[3]);
    let i;
    return (
      t[4] === e
  ...
  let a;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, J.jsx)(j, { className: `h-5 w-5` })), (t[8] = a))
    : (a = t[8]);
  let o;
  return (
    t[9] === i
...
function Bt({ isComplete: e, isSelected: t }) {
...
function Vt(e) {
  let t = (0, Y.c)(6),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, J.jsx)(I, { className: `size-4`, "aria-hidden": `true` })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
...
function qt({ current: e, items: t, group: n, checked: r }) {
  let i = new Set(e);
  return (
    t
      .filter((e) => e.group === n)
...
function Jt({ current: e, items: t, group: n, checked: r }) {
  let i = { ...e };
  return (
    t
      .filter((e) => e.group === n)
...
//# sourceMappingURL=external-agent-import-step-CgLYbl_u.js.map

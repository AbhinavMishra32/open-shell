...
import { o as t } from "./lib-MoKmYgcO.js";
var n = e();
function r(e) {
  if (e == null) return 0;
  switch (e.phase) {
  ...
  switch (e?.phase) {
    ...
    case `error`:
      return (0, n.jsx)(t, {
        ...
        description: `Thread status shown while Opaline downloads required local runtime tools before starting a response`,
        values: { percent: r },
      });
    case `extracting`:
      return (0, n.jsx)(t, {
        ...
        description: `Thread status shown while Opaline extracts required local runtime tools before starting a response`,
      });
    case `verifying`:
    case `validating`:
    case `installed`:
    ...
    case `ready`:
      return (0, n.jsx)(t, {
        ...
        description: `Thread status shown while Opaline finalizes required local runtime tools before starting a response`,
      });
  }
}
export { i as n, r as t };
//# sourceMappingURL=primary-runtime-install-status-message-BdB-ENKl.js.map

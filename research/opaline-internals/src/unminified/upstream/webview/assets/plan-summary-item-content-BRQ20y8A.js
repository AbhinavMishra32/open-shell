...
import { F as i, I as a, f as o, h as s, lt as c } from "./vscode-api-sUstfl-x.js";
import { c as l, o as u, r as d } from "./lib-MoKmYgcO.js";
...
import { t as h } from "./proxy-DktXrBt_.js";
import { t as g } from "./download-TILfllSA.js";
import { t as _ } from "./with-window-DPMmD2K-.js";
import { t as ee } from "./copy-to-clipboard-q_KxH8lM.js";
import { r as te } from "./modal-controller-state-CEBUx8JQ.js";
import { t as ne } from "./thinking-shimmer-BqifOpst.js";
import { t as re } from "./animations-Du6t0V8Z.js";
import { t as ie } from "./chevron-D6hquBJC.js";
import { t as ae } from "./copy-button-5izllJyD.js";
import { t as oe } from "./arrow-top-right-D16Z5Bms.js";
import { n as se, t as ce } from "./markdown-surface-DsmgfpJy.js";
import { t as le } from "./feedback-form-dialog-CD7y99P3.js";
var ue = e(t()),
  v = n(),
  y = (e) =>
    (0, v.jsxs)(`svg`, {
  ...
  pe = {
    thumbs_down: [
      { id: `wrong_presentation_length`, label: x.wrongPresentationLength },
      { id: `poor_writing`, label: x.poorWriting },
      { id: `poor_style_format_or_visuals`, label: x.poorStyleFormatOrVisuals },
      { id: `wrong_topics_or_subtopics`, label: x.wrongTopicsOrSubtopics },
      { id: `didnt_follow_my_instructions`, label: x.didntFollowMyInstructions },
      { id: `didnt_follow_my_template`, label: x.didntFollowMyTemplate },
      { id: `incorrect_content`, label: x.incorrectContent },
    ],
    thumbs_up: [
      { id: `good_content`, label: x.goodContent },
      { id: `good_writing_quality`, label: x.goodWritingQuality },
      { id: `good_style_format_or_visuals`, label: x.goodStyleFormatOrVisuals },
      { id: `followed_my_instructions_well`, label: x.followedMyInstructionsWell },
      { id: `generated_quickly`, label: x.generatedQuickly },
    ],
  },
  S = {
    thumbs_down: [
      { id: `incorrect_or_incomplete`, label: x.incorrectOrIncomplete },
      { id: `didnt_follow_my_instructions`, label: x.didntFollowMyInstructions },
      { id: `off_track_or_wrong_scope`, label: x.offTrackOrWrongScope },
      { id: `lost_context`, label: x.lostContext },
      { id: `slow_or_buggy`, label: x.slowOrBuggy },
      { id: `other`, label: x.other },
    ],
    thumbs_up: [
      { id: `solved_my_task`, label: x.solvedMyTask },
      { id: `followed_my_instructions`, label: x.followedMyInstructions },
      { id: `good_code_or_output_quality`, label: x.goodCodeOrOutputQuality },
      { id: `fast_and_efficient`, label: x.fastAndEfficient },
      { id: `useful_autonomy`, label: x.usefulAutonomy },
      { id: `other`, label: x.other },
    ],
  };
function me(e) {
  let t = (0, de.c)(10),
    { hasArtifacts: n, threadId: r, turnId: o } = e,
    c = n === void 0 ? !1 : n,
    l = i(s),
    [d, p] = (0, ue.useState)(null),
    m = a(f),
    h;
  t[0] !== c || t[1] !== m || t[2] !== l || t[3] !== d || t[4] !== r || t[5] !== o
    ? ((h = (e) => {
        if (d === e) {
          p(null);
          return;
          ...
          te(l, le, {
            belowFreeformContent: (0, v.jsx)(`div`, {
              ...
              children: (0, v.jsx)(u, {
                ...
                defaultMessage: `Your feedback can be used to improve Opaline. <link>Learn more</link>.`,
            ...
            onSubmit: (e) => {
              let { details: t, selectedOptionId: n } = e;
              return m.submitOpalineAnalyticsEvent?.({
                action: `submit_turn_feedback`,
                eventKind: `action`,
                threadId: r,
                turnId: o,
                metadata: { details: t, has_artifacts: c, selected_option: n },
              });
            },
            options: c ? pe[e] : S[e],
          }));
  ...
  return (
    t[7] !== g || t[8] !== d
      ? ((_ = (0, v.jsxs)(v.Fragment, {
          children: [
            (0, v.jsx)(w, { rating: `thumbs_up`, selectedRating: d, onClick: g }),
            (0, v.jsx)(w, { rating: `thumbs_down`, selectedRating: d, onClick: g }),
          ],
        })),
        (t[7] = g),
        (t[8] = d),
...
function C(e) {
  (e.preventDefault(), o.dispatchMessage(`open-in-browser`, { url: fe }));
}
function w(e) {
  let t = (0, de.c)(17),
  ...
  t[3] !== i || t[4] !== n
    ? ((d = (e) => {
      ...
      (t[5] = d))
    : (d = t[5]);
  let f = n === `thumbs_down` ? `icon-xs rotate-180` : `icon-xs`,
    h;
  t[6] !== c || t[7] !== f
    ? ((h = (0, v.jsx)(c, { className: f })), (t[6] = c), (t[7] = f), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== s || t[10] !== u || t[11] !== d || t[12] !== h
    ? ((g = (0, v.jsx)(m, {
        color: `ghost`,
        size: `icon`,
        "aria-pressed": u,
  ...
  return (
    t[14] !== s || t[15] !== g
      ? ((_ = (0, v.jsx)(p, { tooltipContent: s, children: g })),
        (t[14] = s),
        (t[15] = g),
        (t[16] = _))
      : (_ = t[16]),
...
function ve(e) {
  ...
  t[0] !== n.completed || t[1] !== n.content
    ? ((be = n.completed && n.content.trim().length > 0),
      (t[0] = n.completed),
      (t[1] = n.content),
      (t[2] = be))
    : (be = t[2]);
  ...
  t[3] !== n.completed || t[4] !== n.content
    ? ((E = n.completed && n.content.trim().length > 0),
      (t[3] = n.completed),
      (t[4] = n.content),
      (t[5] = E))
    : (E = t[5]);
  let D = E,
    xe = T && !0,
    Se = D && !0,
    Ce = y != null && w.submitOpalineAnalyticsEvent != null,
    we = Ce && !1,
    Te = Ce && !0,
    O;
  t[6] === C
  ...
  t[11] !== i || t[12] !== n.content
    ? ((j = () => {
        o.dispatchMessage(`show-plan-summary`, { planContent: n.content, conversationId: i });
      }),
      (t[11] = i),
      (t[12] = n.content),
      (t[13] = j))
  ...
  t[14] === n.content
    ...
    : ((M = () => {
        ...
        ((r.href = t), (r.download = _e), r.click(), URL.revokeObjectURL(t));
      }),
      (t[14] = n.content),
      (t[15] = M));
  let N = M,
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = r(`text-token-foreground text-base font-semibold leading-tight`)), (t[21] = I))
    : (I = t[21]);
  let L;
  t[22] === n.completed
    ? (L = t[23])
  ...
  let R;
  t[24] !== Oe || t[25] !== L
    ? ((R = (0, v.jsx)(ne, { active: Oe, className: I, children: L })),
      (t[24] = Oe),
      (t[25] = L),
      (t[26] = R))
    : (R = t[26]);
                ...
                D
                  ? (0, v.jsx)(p, {
                      ...
                      children: (0, v.jsx)(m, {
                        ...
                        children: (0, v.jsx)(g, { className: `icon-2xs` }),
                      }),
                    })
                  : null,
                T ? (0, v.jsx)(ae, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: F }) : null,
                we ? (0, v.jsx)(me, { hasArtifacts: x, threadId: i, turnId: y }) : null,
                (0, v.jsx)(p, {
                  tooltipContent: (0, v.jsx)(u, {
  ...
  let V;
  t[43] !== F || t[44] !== xe
    ? ((V = xe ? (0, v.jsx)(ae, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: F }) : null),
      (t[43] = F),
      (t[44] = xe),
      (t[45] = V))
    : (V = t[45]);
  ...
  t[46] !== i || t[47] !== x || t[48] !== Te || t[49] !== y
    ? ((H = Te ? (0, v.jsx)(me, { hasArtifacts: x, threadId: i, turnId: y }) : null),
      (t[46] = i),
      (t[47] = x),
      (t[48] = Te),
      (t[49] = y),
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = () => {
      ...
      (t[53] = ke))
    : (ke = t[53]);
  let Ae = S ? `rotate-180` : `rotate-0`,
    W;
  t[54] === Ae
    ? (W = t[55])
    : ((W = r(`icon-2xs transition-transform`, Ae)), (t[54] = Ae), (t[55] = W));
  let G;
  t[56] === W ? (G = t[57]) : ((G = (0, v.jsx)(ie, { className: W })), (t[56] = W), (t[57] = G));
  let K;
  t[58] !== Ee || t[59] !== G
    ? ((K = (0, v.jsx)(m, {
        color: `ghost`,
  ...
  let q;
  t[61] !== U || t[62] !== K
    ? ((q = (0, v.jsx)(p, { tooltipContent: U, children: K })),
      (t[61] = U),
      (t[62] = K),
      (t[63] = q))
    : (q = t[63]);
  let J;
  t[64] !== z || t[65] !== B || t[66] !== V || t[67] !== H || t[68] !== q
    ? ((J = (0, v.jsxs)(`div`, {
        className: `flex items-center gap-1`,
        children: [z, B, V, H, q],
      })),
  ...
  t[70] !== R || t[71] !== J
    ? ((Y = (0, v.jsxs)(`div`, {
        className: `relative flex flex-wrap items-center justify-between gap-2 px-3 py-2`,
        children: [R, J],
      })),
      (t[70] = R),
      (t[71] = J),
  ...
  let je = S ? ge : `auto`,
    X;
  t[73] === je ? (X = t[74]) : ((X = { height: je }), (t[73] = je), (t[74] = X));
  let Me = !n.completed,
    Z;
  t[75] !== i || t[76] !== s || t[77] !== b || t[78] !== n.content || t[79] !== Me
    ? ((Z = (0, v.jsx)(se, {
        markdown: n.content,
        conversationId: i,
        hideCodeBlocks: b,
  ...
  return (
    t[87] !== Y || t[88] !== $
      ? ((Ne = (0, v.jsxs)(ce, { children: [Y, $] })), (t[87] = Y), (t[88] = $), (t[89] = Ne))
      : (Ne = t[89]),
    Ne
  );
}
...
export { me as n, ve as t };
//# sourceMappingURL=plan-summary-item-content-BRQ20y8A.js.map

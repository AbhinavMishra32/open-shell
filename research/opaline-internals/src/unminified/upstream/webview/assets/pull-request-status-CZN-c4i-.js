...
import { Aa as t, Da as n } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as r, t as i } from "./jsx-runtime-CiQ1k8xo.js";
import { t as a } from "./clsx-BcPLHiun.js";
import { lt as o } from "./vscode-api-sUstfl-x.js";
import { o as s } from "./lib-MoKmYgcO.js";
import { t as c } from "./tooltip-BhXPONlb.js";
import { t as l } from "./button-Xd4Hy1MO.js";
import { t as u } from "./check-circle-filled-CC_XQe30.js";
import { t as d } from "./clock-CDmkoq1h.js";
import { r as f } from "./dropdown-CHaZfyxI.js";
import { t as p } from "./unselected-circle-C_iqsj8O.js";
import { t as m } from "./pull-request-readonly-comment-BLgsn7KS.js";
import { t as h } from "./pull-request-open-BwjeCR7v.js";
var g = i(),
  _ = 5.75,
  v = 2 * Math.PI * _,
  y = 1.5;
function b({ className: e = `icon-sm shrink-0`, checks: t }) {
  let n = x(t),
    r = a(`text-token-description-foreground`, e);
  if (n.length === 0) return (0, g.jsx)(p, { className: r });
  let i = n.length > 1 ? y : 0,
    o = 0;
  return (0, g.jsx)(`svg`, {
    "aria-hidden": !0,
    className: r,
...
var S = (e) =>
  ...
  T = o(),
  E = `flex items-center gap-2 px-[var(--padding-row-x)] py-[var(--padding-row-y)]`,
  D = `min-w-0 truncate text-sm`;
function O(e) {
  let t = (0, T.c)(5),
    { className: n, label: r } = e,
    i;
  t[0] === n
    ? (i = t[1])
    : ((i = a(
        `inline-flex h-5 shrink-0 items-center rounded-[7px] bg-token-foreground/5 px-1.5 text-sm font-medium leading-[22px] tracking-[-0.12px] text-token-description-foreground`,
        n,
      )),
      (t[0] = n),
      (t[1] = i));
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((o = (0, g.jsx)(`span`, { className: i, children: r })),
        (t[2] = r),
        (t[3] = i),
        (t[4] = o))
      : (o = t[4]),
...
function ee(e) {
  let t = (0, T.c)(10),
    { icon: n, label: r, rightAdornment: i } = e,
    a = i === void 0 ? null : i,
    o;
  t[0] === n
    ? (o = t[1])
    : ((o = (0, g.jsx)(`span`, {
        className: `flex h-fit shrink-0 text-token-foreground`,
        children: n,
      })),
      (t[0] = n),
      (t[1] = o));
  ...
  t[4] === a
    ? (c = t[5])
    : ((c = a == null ? null : (0, g.jsx)(`span`, { className: `shrink-0`, children: a })),
      (t[4] = a),
      (t[5] = c));
  let l;
  return (
...
function te(e) {
  let t = (0, T.c)(13),
    { accessory: n, accessoryPlacement: r, icon: i, label: a } = e,
    o = n === void 0 ? null : n,
    s = r === void 0 ? `end` : r,
    c;
  t[0] === o
    ...
    : ((c =
        o?.kind === `icon`
          ? (0, g.jsx)(`span`, { className: `shrink-0 text-token-text-tertiary`, children: o.icon })
          : o?.kind === `pill`
            ? (0, g.jsx)(O, { label: o.label })
            : o?.kind === `text`
              ? (0, g.jsx)(`span`, {
  ...
  t[2] === i
    ? (u = t[3])
    : ((u = (0, g.jsx)(`span`, { className: `shrink-0`, children: i })), (t[2] = i), (t[3] = u));
  let d;
  t[4] === a
    ? (d = t[5])
    : ((d = (0, g.jsx)(`span`, {
  ...
  return (
    t[10] !== p || t[11] !== m
      ? ((h = (0, g.jsxs)(`div`, {
          className: `flex w-full min-w-0 items-center justify-between gap-3 text-token-text-tertiary`,
          children: [p, m],
        })),
        (t[10] = p),
        (t[11] = m),
...
function ne(e) {
  let t = (0, T.c)(10),
    { className: n, groups: r, title: i } = e,
    a = n === void 0 ? `max-w-[420px]` : n,
    o;
  t[0] === i
    ? (o = t[1])
    : ((o = (0, g.jsx)(f.SectionLabel, { children: i })), (t[0] = i), (t[1] = o));
  let s;
  t[2] === r
    ? (s = t[3])
    : ((s = (0, g.jsx)(`div`, {
        className: `flex max-h-[104px] flex-col overflow-y-auto`,
        children: (0, g.jsx)(re, { groups: r }),
      })),
      (t[2] = r),
      (t[3] = s));
  let c;
  t[4] !== o || t[5] !== s
    ? ((c = (0, g.jsxs)(`div`, { className: `flex flex-col`, children: [o, s] })),
      (t[4] = o),
      (t[5] = s),
      (t[6] = c))
    : (c = t[6]);
  ...
  return (
    t[7] !== a || t[8] !== c
      ? ((l = (0, g.jsx)(`div`, { className: a, children: c })), (t[7] = a), (t[8] = c), (t[9] = l))
      : (l = t[9]),
    l
  );
}
function re(e) {
  let t = (0, T.c)(4),
    { groups: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.flatMap(ae).map(ie)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, g.jsx)(g.Fragment, { children: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function ie(e, t) {
  return (0, g.jsx)(k, { item: e }, t);
}
function ae(e) {
  return e.items;
}
function k(e) {
  let t = (0, T.c)(26),
    { item: n } = e,
    r = n.onSelect != null && n.action == null,
    i;
  t[0] === n.icon
    ? (i = t[1])
    : ((i = (0, g.jsx)(`span`, {
        className: `flex shrink-0 items-center text-token-foreground`,
        children: n.icon,
      })),
      (t[0] = n.icon),
      (t[1] = i));
  let o = r && `group-hover:underline`,
    s;
  t[2] === o ? (s = t[3]) : ((s = a(D, `text-token-foreground`, o)), (t[2] = o), (t[3] = s));
  let c;
  t[4] !== n.label || t[5] !== s
    ? ((c = (0, g.jsx)(`span`, { className: s, children: n.label })),
      (t[4] = n.label),
      (t[5] = s),
      (t[6] = c))
    : (c = t[6]);
  ...
  t[7] === n.description
    ...
    : ((l =
        n.description == null
          ? null
          : (0, g.jsx)(`span`, {
              className: a(D, `text-token-description-foreground`),
  ...
  t[15] === n.action
    ...
    : ((f = n.action
        ? (0, g.jsx)(`button`, {
            className: `inline-flex h-5 shrink-0 cursor-interaction items-center rounded-[7px] bg-token-foreground/5 px-1.5 text-sm leading-[22px] font-medium tracking-[-0.12px] text-token-description-foreground enabled:hover:bg-token-foreground/10 disabled:cursor-not-allowed disabled:opacity-40`,
            disabled: n.action.disabled,
            onClick: (e) => {
              (e.preventDefault(), e.stopPropagation(), n.action?.onSelect?.());
            },
  ...
  if (!r) {
    ...
    return (
      t[20] === m
        ? (e = t[21])
        : ((e = (0, g.jsx)(`div`, { className: E, children: m })), (t[20] = m), (t[21] = e)),
      e
    );
  }
  let h;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = a(E, `group w-full cursor-interaction text-left`)), (t[22] = h))
    : (h = t[22]);
  let _;
  return (
    t[23] !== m || t[24] !== n.onSelect
      ? ((_ = (0, g.jsx)(`button`, {
          className: h,
          onClick: n.onSelect,
          type: `button`,
...
function A(e) {
  let t = (0, T.c)(16),
    { emptyMessage: n, groups: r, title: i } = e,
    a,
    o,
    s,
    c;
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    ...
    ((c = `max-w-[220px]`),
      ...
      t[7] === i
        ? (o = t[8])
        : ((o = (0, g.jsx)(f.SectionLabel, { children: i })), (t[7] = i), (t[8] = o)),
      (s =
        e.length === 0
          ? (0, g.jsx)(f.Message, { compact: !0, children: n })
          : (0, g.jsx)(`div`, {
              className: `flex max-h-[104px] flex-col overflow-y-auto`,
              children: e.map(j),
            })),
      ...
      (t[5] = s),
      (t[6] = c));
  } else ((a = t[3]), (o = t[4]), (s = t[5]), (c = t[6]));
  let l;
  t[9] !== a || t[10] !== o || t[11] !== s
    ? ((l = (0, g.jsxs)(`div`, { className: a, children: [o, s] })),
      (t[9] = a),
      (t[10] = o),
      (t[11] = s),
      (t[12] = l))
  ...
  return (
    t[13] !== c || t[14] !== l
      ? ((u = (0, g.jsx)(`div`, { className: c, children: l })),
        (t[13] = c),
        (t[14] = l),
        (t[15] = u))
      : (u = t[15]),
...
function j(e, t) {
  return (0, g.jsx)(
    c,
    {
      ...
      delayOpen: !0,
      side: `top`,
      tooltipContent: e.accessoryLabel,
      children: (0, g.jsxs)(`div`, {
        className: E,
        children: [
          (0, g.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: e.icon }),
          (0, g.jsx)(`span`, { className: a(D, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
...
function N(e) {
  let t = (0, T.c)(4),
    { groups: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.map(P)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, g.jsx)(`div`, {
          className: `max-h-[280px] w-[420px] overflow-y-auto`,
          children: (0, g.jsx)(`div`, { className: `flex flex-col gap-2`, children: r }),
        })),
        (t[2] = r),
        (t[3] = i)),
    i
...
function P(e, t) {
  return (0, g.jsxs)(
    `div`,
    {
      className: a(`flex flex-col gap-1`, t > 0 && `border-token-border/60 border-t pt-2`),
      children: [
        (0, g.jsx)(f.SectionLabel, { children: e.title }),
        (0, g.jsx)(`div`, {
...
function F(e, t) {
  ...
  return (0, g.jsx)(
    `div`,
    {
      ...
      children: (0, g.jsx)(m, {
        comment: r,
        metadataAccessory: I(n),
        metadataTooltipContent: r.position?.path == null ? null : (0, g.jsx)(L, { comment: r }),
        surface: `card`,
        url: r.url ?? null,
      }),
    },
...
function L(e) {
  let r = (0, T.c)(16),
    { comment: i } = e;
  if (i.position?.path == null) return null;
  let a;
  r[0] === i ? (a = r[1]) : ((a = t(i)), (r[0] = i), (r[1] = a));
  let { startLine: o, startSide: c, endLine: l, endSide: u } = a,
    d;
  r[2] !== i || r[3] !== l || r[4] !== u || r[5] !== o || r[6] !== c
    ? ((d =
        o === l && c === u
          ? (0, g.jsx)(s, {
  ...
  r[8] === i.position.path
    ...
    : ((p = (0, g.jsx)(`span`, {
        ...
        title: i.position.path,
        children: i.position.path,
      })),
      (r[8] = i.position.path),
      (r[9] = p));
  let m;
  r[10] !== i.position.line || r[11] !== f
    ? ((m =
        i.position.line == null
          ? null
          : (0, g.jsx)(`span`, {
              className: `text-xs leading-4 text-token-description-foreground`,
              children: f,
            })),
      (r[10] = i.position.line),
      (r[11] = f),
      (r[12] = m))
    : (m = r[12]);
  let h;
  return (
    r[13] !== p || r[14] !== m
      ? ((h = (0, g.jsxs)(`div`, {
          className: `flex max-w-xs flex-col gap-0.5`,
          children: [p, m],
        })),
        (r[13] = p),
        (r[14] = m),
...
function R({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  let a = z({ canFix: e, checks: t, intl: n, onFixCheck: r, onOpenCheck: i });
  if (a.length !== 0) return (0, g.jsx)(ne, { groups: a, title: W(t, n) });
}
function z({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  let a = [],
    o = [],
    s = [],
    c = [],
...
function B({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, g.jsx)(w, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, g.jsx)(d, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, g.jsx)(u, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
        return (0, g.jsx)(C, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    }
  return t === `none`
    ? (0, g.jsx)(d, { className: `icon-sm shrink-0` })
    : (0, g.jsx)(b, { checks: e });
}
function V(e) {
  switch (e) {
  ...
  switch (e) {
    case `failing`:
      return t.formatMessage({
        ...
        description: `Status text shown for an individual failing check in the checks flyout`,
      });
    case `pending`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.checks.status.pending`,
        defaultMessage: `Pending`,
        description: `Status text shown for an individual pending check in the checks flyout`,
      });
    case `skipped`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.checks.status.skipped`,
        defaultMessage: `Skipped`,
        description: `Status text shown for an individual skipped check in the checks flyout`,
      });
    case `successful`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.checks.status.passed`,
        defaultMessage: `Passed`,
        description: `Status text shown for an individual successful check in the checks flyout`,
      });
    case `unknown`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.checks.status.unknown`,
        defaultMessage: `Unknown`,
        description: `Status text shown for an individual check with unknown status in the checks flyout`,
      });
  }
}
function W(e, t) {
  ...
  return r.length === 0
    ...
    : (0, g.jsxs)(`span`, {
        ...
        children: [
          ...
          (0, g.jsx)(`span`, { className: `font-normal text-token-foreground/60`, children: r }),
        ],
      });
}
function oe(e, t) {
  return [
    G(e.filter((e) => e.status === `failing`).length, `failing`, t),
    G(e.filter((e) => e.status === `pending`).length, `pending`, t),
    G(e.filter((e) => e.status === `skipped`).length, `skipped`, t),
    G(e.filter((e) => e.status === `unknown`).length, `unknown`, t),
    G(e.filter((e) => e.status === `passing`).length, `successful`, t),
  ]
    .filter((e) => e != null)
    .join(`, `);
}
      ...
      return n.formatMessage(
        {
          ...
          defaultMessage: `{count, plural, one {# successful} other {# successful}}`,
          description: `Summary label for successful checks in the checks flyout`,
        },
        { count: e },
      );
    case `unknown`:
...
function K(e) {
  switch (e) {
    ...
    case `pending`:
      return (0, g.jsx)(C, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `skipped`:
      return (0, g.jsx)(S, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `successful`:
      return (0, g.jsx)(u, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `unknown`:
      return (0, g.jsx)(S, { className: `icon-sm shrink-0 text-token-description-foreground` });
...
function Z(e) {
  let t = (0, T.c)(8),
    { status: n, className: r, tone: i } = e,
    o = i === void 0 ? `status` : i,
    s,
    c;
  if (t[0] !== r || t[1] !== n || t[2] !== o) {
    let { Icon: e, iconClassName: i } = he({ status: n, tone: o });
    ((s = e), (c = a(r, i)), (t[0] = r), (t[1] = n), (t[2] = o), (t[3] = s), (t[4] = c));
  } else ((s = t[3]), (c = t[4]));
  let l;
  return (
    t[5] !== s || t[6] !== c
      ? ((l = (0, g.jsx)(s, { className: c })), (t[5] = s), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function le(e) {
  let t = (0, T.c)(8),
    { className: n, state: r, tone: i } = e,
    o = i === void 0 ? `status` : i,
    s,
    c;
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let { Icon: e, iconClassName: i } = ge({ state: r, tone: o });
    ((s = e), (c = a(n, i)), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = s), (t[4] = c));
  } else ((s = t[3]), (c = t[4]));
  let l;
  return (
    t[5] !== s || t[6] !== c
...
var de = { draft: J, open: h, merged: Y, closed: q },
  fe = {
  ...
  pe = { draft: J, failing: se, in_progress: ce, merged: Y, ready: X, successful: X },
  me = {
    draft: `text-token-description-foreground`,
...
function he({ status: e, tone: t }) {
  return {
    Icon: de[e],
    iconClassName: t === `currentColor` ? `text-current` : t === `neutral` ? $ : fe[e],
  };
}
function ge({ state: e, tone: t }) {
  return {
    Icon: pe[e],
    iconClassName:
      t === `currentColor` ? a(`text-current`, Q[e]) : t === `neutral` ? a($, Q[e]) : me[e],
  };
}
export {
  b as _,
...
//# sourceMappingURL=pull-request-status-CZN-c4i-.js.map

const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./angular-html-BJW1IG_l.js",
      "./angular-html-D0OelfoO.js",
      "./html-Date26Gw.js",
      "./css-DM5j2n-T.js",
      "./javascript-DEyk7zFy.js",
      "./angular-ts-DBXr3XRo.js",
      "./scss-BjEzxFPt.js",
      "./apl-Gpsr7ASY.js",
      "./json-BDI00V-j.js",
      "./xml-BR0GeArl.js",
      ...
      "./postcss-D_6TUwUO.js",
      "./tsx-PCrP-HQY.js",
      "./typescript-DmF0PpHj.js",
      "./blade-lpVLBxdB.js",
      "./html-derivative-DL--6lGP.js",
      "./sql-CI7thTb1.js",
      "./bsl-BDRpQZ-v.js",
      "./sdbl-DavTd9W1.js",
      "./c-Cgl9NOy1.js",
      ...
      "./fortran-fixed-form-DoY9RUzc.js",
      "./fortran-free-form-BRn4V2z5.js",
      "./fortran-free-form-Cy9V1dhz.js",
      "./fsharp-BiixXeew.js",
      "./gdresource-ECBE5gKa.js",
      "./gdscript-CPUnxGRx.js",
      "./gdshader-CJCPHnpD.js",
      "./gdscript-Bjd9kQ5Z.js",
      "./gdshader-bJQCawwE.js",
      "./git-commit-9y_AzOom.js",
      "./git-rebase-W8z1S5vo.js",
      "./glimmer-js-BRQJtHn9.js",
      "./glimmer-ts-BSzNXypd.js",
      "./glsl-Ce1vkC0W.js",
      "./go-oLYzpzyy.js",
      "./go-D1TrB75N.js",
      "./graphql-CoPuTGT-.js",
      "./hack-B2y7Pnx-.js",
      "./haml-ChUjaWlP.js",
      "./handlebars-CCDqg4C_.js",
      "./haxe-BNRcm70V.js",
      "./haxe-BG0sLpXW.js",
      "./hlsl-Cnsn84x3.js",
      "./hlsl-CPFlMWlq.js",
      "./html-BmwywfOM.js",
      "./html-derivative-CFdrR7Bk.js",
      "./http-Da7n24Hh.js",
      "./hurl-BPuq-Olo.js",
      "./hxml-BxzD8h1g.js",
      "./java-Dti2GZzj.js",
      "./javascript-tXs_xOzz.js",
      "./jinja-CNIxSlHU.js",
      "./jison-mmxCF1CJ.js",
      "./json-DDDAODHP.js",
      "./jsx-PdcVG1c_.js",
      ...
      "./scss-yloQ-14U.js",
      "./sdbl-Bynik832.js",
      "./shaderlab-CAHyMo3x.js",
      "./shellscript-oOdR2m8Z.js",
      "./shellsession-BYqD1fpu.js",
      "./soy-DjiKDI-Q.js",
      "./sparql-ORoNih1N.js",
      "./turtle-CKQuCZJs.js",
      "./sql-XL_NCIfZ.js",
      ...
      "./turtle-BvC33mf_.js",
      "./twig-_74eRPwV.js",
      "./typescript-Zgr1L7v7.js",
      "./vue-BrqqWTir.js",
      "./vue-DONqFwSY.js",
      "./vue-html-DxRvlH1N.js",
      "./vue-vine-DJ587nW1.js",
      "./xml-BQzzxnIi.js",
      "./xsl-BtbsBVRY.js",
      "./yaml-Bbz7tr1d.js",
    ]),
) => i.map((i) => d[i]);
import { r as e, s as t, t as n } from "./chunk-Bj-mKKzh.js";
import { D as r } from "./src-CYrn1fYL.js";
import { t as i } from "./preload-helper-I1wKxk_B.js";
import { n as a, t as o } from "./jsx-runtime-CiQ1k8xo.js";
import { t as s } from "./ccount-DzM6t3CN.js";
import { I as c, lt as l } from "./vscode-api-sUstfl-x.js";
import { a as u } from "./setting-storage-Cel8Tr7E.js";
import {
  C as d,
  D as f,
  S as p,
  ...
  x as ee,
  y as te,
} from "./diff-view-mode-DMAtdFuV.js";
import { n as ne, r as re } from "./use-resolved-theme-variant-CbBTynE2.js";
import { n as ie } from "./is-compact-window-context-C0RLy6_u.js";
...
function se(e, t) {
  return (
    e?.start === t?.start && e?.end === t?.end && e?.side === t?.side && e?.endSide === t?.endSide
  );
}
function ce(e) {
  return { type: `text`, value: e };
}
function b({ tagName: e, children: t = [], properties: n = {} }) {
  return { type: `element`, tagName: e, properties: n, children: t };
}
function le({ name: e, width: t = 16, height: n = 16, properties: r }) {
  return b({
    tagName: `svg`,
    properties: { width: t, height: n, viewBox: `0 0 16 16`, ...r },
    children: [b({ tagName: `use`, properties: { href: `#${e.replace(/^#/, ``)}` } })],
  });
}
function ue(e) {
  let t = e.children[0];
...
function de(e) {
  return b({ tagName: `div`, properties: { "data-gutter": `` }, children: e });
}
function fe(e, t, n, r = {}) {
  return b({
    tagName: `div`,
    properties: { "data-line-type": e, "data-column-number": t, "data-line-index": n, ...r },
    children:
      t == null
        ? void 0
        : [
...
function me() {
  return b({
    ...
    children: [le({ name: `diffs-icon-plus`, properties: { "data-icon": `` } })],
  });
}
function he(e, t) {
...
var Te = Object.keys(be),
  Ee = class extends x {
    constructor(e, t, n, r) {
      let i = -1;
      if ((super(e, t), De(this, `space`, r), typeof n == `number`))
        for (; ++i < Te.length; ) {
          let e = Te[i];
...
function Be(e, t) {
  ...
  if (n.length > 4 && n.slice(0, 4) === `data` && ze.test(t)) {
    if (t.charAt(4) === `-`) {
      let e = t.slice(5).replace(Re, He);
      r = `data` + e.charAt(0).toUpperCase() + e.slice(1);
    } else {
      let e = t.slice(4);
      if (!Re.test(e)) {
        let n = e.replace(Le, Ve);
...
var Ue = ve([ke, Me, Pe, Fe, Ie], `html`),
  We = ve([ke, Ne, Pe, Fe, Ie], `svg`),
  Ge = /["&'<>`]/g,
  Ke = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
  qe = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
  Je = /[|\\{}()[\]^$+*?.]/g,
  Ye = new WeakMap();
function Xe(e, t) {
  if (((e = e.replace(t.subset ? Ze(t.subset) : Ge, r)), t.subset || t.escapeOnly)) return e;
  return e.replace(Ke, n).replace(qe, r);
  function n(e, n, r) {
    return t.format(
...
function Ze(e) {
  let t = Ye.get(e);
  return (t || ((t = Qe(e)), Ye.set(e, t)), t);
}
function Qe(e) {
  let t = [],
    n = -1;
  for (; ++n < e.length; ) t.push(e[n].replace(Je, `\\$&`));
  return RegExp(`(?:` + t.join(`|`) + `)`, `g`);
}
var $e = /[\dA-Fa-f]/;
function et(e, t, n) {
  let r = `&#x` + e.toString(16).toUpperCase();
  return n && t && !$e.test(String.fromCharCode(t)) ? r : r + `;`;
}
var tt = /\d/;
function nt(e, t, n) {
  let r = `&#` + String(e);
  return n && t && !tt.test(String.fromCharCode(t)) ? r : r + `;`;
}
var rt =
  ...
  st = {},
  ct;
for (ct in it) ot.call(it, ct) && (st[it[ct]] = ct);
var lt = /[^\dA-Za-z]/;
function ut(e, t, n, r) {
  ...
  if (ot.call(st, i)) {
    ...
    return n &&
      rt.includes(e) &&
      !at.includes(e) &&
      (!r || (t && t !== 61 && lt.test(String.fromCharCode(t))))
      ? a
      : a + `;`;
  }
  return ``;
...
function gt(e, t, n, r) {
  return r.settings.bogusComments
    ? `<?` + ft(e.value, Object.assign({}, r.settings.characterReferences, { subset: mt })) + `>`
    : `<!--` + e.value.replace(pt, i) + `-->`;
  function i(e) {
    return ft(e, Object.assign({}, r.settings.characterReferences, { subset: ht }));
  }
}
function _t(e, t, n, r) {
  return (
...
function Tt(e) {
  return t;
  function t(t, n, r) {
    let i = t ? t.children : wt,
      a = (n || 0) + e,
      o = i[a];
    if (!r) for (; o && xt(o); ) ((a += e), (o = i[a]));
    return o;
  }
}
...
function Dt(e) {
  return t;
  function t(t, n, r) {
    return Et.call(e, t.tagName) && e[t.tagName](t, n, r);
  }
}
var Ot = Dt({
  body: jt,
...
var Wt = Dt({ body: qt, colgroup: Jt, head: Kt, html: Gt, tbody: Yt });
function Gt(e) {
  let t = D(e, -1);
...
function qt(e) {
  ...
  return (
    !t ||
    (t.type !== `comment` &&
      !(t.type === `text` && xt(t.value.charAt(0))) &&
      !(
        t.type === `element` &&
        (t.tagName === `meta` ||
          t.tagName === `link` ||
...
function Zt(e, t, n, r) {
  let i = r.schema,
    ...
    s = [],
    c;
  i.space === `html` && e.tagName === `svg` && (r.schema = We);
  let l = Qt(r, e.properties),
...
function $t(e, t, n) {
  ...
  let l = ft(
    r.attribute,
    Object.assign({}, e.settings.characterReferences, { subset: Xt.name[i][a] }),
  );
  return n === !0 ||
    ((n = Array.isArray(n)
      ? (r.commaSeparated ? vt : yt)(n, { padLeft: !e.settings.tightCommaSeparatedLists })
      : String(n)),
    ...
    : (e.settings.preferUnquoted &&
        (c = ft(
          ...
          Object.assign({}, e.settings.characterReferences, {
            attribute: !0,
            subset: Xt.unquoted[i][a],
          }),
        )),
      c !== n &&
        (e.settings.quoteSmart && s(n, o) > s(n, e.alternative) && (o = e.alternative),
        (c =
          o +
          ft(
            n,
            Object.assign({}, e.settings.characterReferences, {
              subset: (o === `'` ? Xt.single : Xt.double)[i][a],
              attribute: !0,
            }),
          ) +
          o)),
...
function tn(e, t, n, r) {
  return n && n.type === `element` && (n.tagName === `script` || n.tagName === `style`)
    ? e.value
    : ft(e.value, Object.assign({}, r.settings.characterReferences, { subset: en }));
}
function nn(e, t, n, r) {
  return r.settings.allowDangerousHtml ? e.value : tn(e, t, n, r);
}
function rn(e, t, n, r) {
  return r.all(e);
}
var an = oe(`type`, {
  invalid: on,
  unknown: sn,
  handlers: { comment: gt, doctype: _t, element: Zt, raw: nn, root: rn, text: tn },
});
function on(e) {
...
function dn(e, t) {
  ...
  return {
    ...
    settings: {
      ...
      voids: n.voids || ge,
      characterReferences: n.characterReferences || ln,
      closeSelfClosing: n.closeSelfClosing || !1,
      closeEmptyElements: n.closeEmptyElements || !1,
    },
    schema: n.space === `svg` ? We : Ue,
    quote: r,
    alternative: i,
  }.one(Array.isArray(e) ? { type: `root`, children: e } : e, void 0, void 0);
}
function fn(e, t, n) {
  return an(e, t, n, this);
}
function pn(e) {
  let t = [],
    n = (e && e.children) || un,
...
var mn = class {
  ...
  setup(e) {
    ...
    let { usesCustomGutterUtility: t = !1, enableGutterUtility: n = !1 } = this.options;
  ...
  setSelection(e) {
    let t = !(e === this.selectedRange || se(e ?? void 0, this.selectedRange ?? void 0));
    (!this.isSelectionDirty() && !t) ||
      ((this.selectedRange = e), this.renderSelection(), t && this.notifySelectionCommitted());
  }
  getSelection() {
  ...
  handlePointerClick = (e) => {
    ...
    (t == null && n == null && r == null && a == null && i == null) ||
      (this.options.onGutterUtilityClick != null && En(e.composedPath())) ||
      (O(this.options.__debugPointerEvents, `click`, `FileDiff.DEBUG.handlePointerClick:`, e),
  ...
  handlePointerMove = (e) => {
    ...
    (t === `disabled` && !o && n == null && r == null && i == null && a == null) ||
      (O(this.options.__debugPointerEvents, `move`, `FileDiff.DEBUG.handlePointerMove:`, e),
      this.handlePointerEvent({ eventType: `move`, event: e }));
  };
  handlePointerLeave = (e) => {
    let { __debugPointerEvents: t } = this.options;
    if (
      (O(t, `move`, `FileDiff.DEBUG.handlePointerLeave: no event`),
      this.hoveredLine == null && this.hoveredToken == null)
    ) {
      O(t, `move`, `FileDiff.DEBUG.handlePointerLeave: returned early, no hovered line or token`);
      return;
    }
    (this.gutterUtilityContainer?.remove(),
      this.hoveredToken != null &&
        (this.options.onTokenLeave?.(this.hoveredToken, e), this.clearHoveredToken()),
      this.hoveredLine != null &&
        (this.options.onLineLeave?.({ ...this.hoveredLine, event: e }), this.clearHoveredLine()));
  };
  handlePointerEvent({ eventType: e, event: t }) {
    let { __debugPointerEvents: n } = this.options,
      r = t.composedPath();
    O(n, e, `FileDiff.DEBUG.handlePointerEvent:`, { eventType: e, composedPath: r });
    let i = this.resolvePointerTarget(r);
    O(n, e, `FileDiff.DEBUG.handlePointerEvent: resolvePointerTarget result:`, i);
    let {
      onLineClick: a,
      onLineNumberClick: o,
      onLineEnter: s,
    ...
    switch (e) {
      case `move`: {
        let e = yn(i) && this.hoveredLine?.lineElement === i.lineElement;
        ((vn(i) && this.hoveredToken?.tokenElement === i.tokenElement) ||
          (this.hoveredToken != null && (d?.(this.hoveredToken, t), this.clearHoveredToken()),
          vn(i) &&
            (this.setHoveredToken(this.toTokenEventBaseProps(i)), u?.(this.hoveredToken, t))),
          e ||
            (this.hoveredLine != null &&
              (this.gutterUtilityContainer?.remove(),
            ...
            yn(i) &&
              ...
              this.gutterUtilityContainer != null &&
                i.numberElement.appendChild(this.gutterUtilityContainer),
      ...
      case `click`: {
        ...
        if (!yn(i)) break;
        vn(i) && l != null && l(this.toTokenEventBaseProps(i), t);
        let e = this.toEventBaseProps(i);
        o != null && i.numberColumn ? o({ ...e, event: t }) : a?.({ ...e, event: t });
        break;
      }
    }
  }
  syncPointerListeners(e) {
    ...
    g && !this.hasPointerListeners
      ? (e.addEventListener(`click`, this.handlePointerClick),
        ...
        O(t, `move`, `FileDiff.DEBUG.attachEventListeners: Attaching pointer move event`),
        O(t, `move`, `FileDiff.DEBUG.attachEventListeners: Attaching pointer leave event`))
      : !g &&
  ...
  updateInteractiveLineAttributes() {
    ...
    let { onLineClick: e, onLineNumberClick: t, enableLineSelection: n = !1 } = this.options,
      r = e != null,
      i = t != null || n;
  ...
  handlePointerDown = (e) => {
    ...
    En(t) && this.options.onGutterUtilityClick != null
      ? this.startGutterSelectionFromPointerDown(e, t)
      : this.startLineSelectionFromPointerDown(e, t);
  };
  startLineSelectionFromPointerDown(e, t) {
    let { enableLineSelection: n = !1 } = this.options;
    if (!n) return;
    let r = this.getSelectionPointerInfo(t, !0);
    if (r == null) return;
    let { pre: i } = this;
    if (i == null) return;
    e.preventDefault();
    let { lineNumber: a, eventSide: o, lineIndex: s } = r;
    if (e.shiftKey && this.selectedRange != null) {
      let t = this.getIndexesFromSelection(
        this.selectedRange,
        i.getAttribute(`data-diff-type`) === `split`,
      );
      if (t == null) return;
      let n = t.start <= t.end ? s >= t.start : s <= t.end;
      ((this.selectionAnchor = {
        lineNumber: n ? this.selectedRange.start : this.selectedRange.end,
        side: n ? this.selectedRange.side : (this.selectedRange.endSide ?? this.selectedRange.side),
      }),
        this.updateSelection(a, o, !1),
    ...
    if (this.selectedRange?.start === a && this.selectedRange?.end === a) {
      let t = { lineNumber: a, side: o };
    ...
    ((this.selectedRange = null),
      (this.selectionAnchor = { lineNumber: a, side: o }),
      this.updateSelection(a, o, !1),
      this.notifySelectionStart(this.selectedRange),
      (this.pointerSession = { mode: `selecting`, pointerId: e.pointerId }),
      this.attachDocumentPointerListeners());
  }
  startGutterSelectionFromPointerDown(e, t) {
    let { enableLineSelection: n = !1, onGutterUtilityClick: r } = this.options;
    if (r == null) return;
    let i = this.getSelectionPointFromPath(t);
    i != null &&
      (e.preventDefault(),
      e.stopPropagation(),
      (this.pointerSession = {
      ...
      n &&
        ((this.selectionAnchor = { lineNumber: i.lineNumber, side: i.side }),
  ...
  handleDocumentPointerMove = (e) => {
    ...
    switch (this.pointerSession.mode) {
      ...
      case `gutterSelecting`: {
        ...
        let n = this.getSelectionPointFromPath(e.composedPath());
        if (n == null) return;
        ((this.pointerSession.current = n), t === !0 && this.updateSelection(n.lineNumber, n.side));
        return;
      }
      case `selecting`: {
        if (e.pointerId !== this.pointerSession.pointerId) return;
        let t = this.getSelectionPointerInfo(e.composedPath(), !1);
      ...
      case `pendingSingleLineUnselect`: {
        ...
        if (he(this.pointerSession.pending, n)) return;
  ...
  handleDocumentPointerUp = (e) => {
    let { enableLineSelection: t = !1, onGutterUtilityClick: n } = this.options;
    switch (this.pointerSession.mode) {
      case `idle`:
        return;
      case `gutterSelecting`: {
        if (e.pointerId !== this.pointerSession.pointerId) return;
        let r = this.getSelectionPointFromPath(e.composedPath());
        (r != null &&
          ((this.pointerSession.current = r), t && this.updateSelection(r.lineNumber, r.side)),
          n?.(this.buildSelectedLineRange(this.pointerSession.anchor, this.pointerSession.current)),
          (this.selectionAnchor = void 0),
          t && (this.notifySelectionEnd(this.selectedRange), this.notifySelectionCommitted()),
          this.clearPointerSession(),
          this.detachDocumentPointerListeners());
        return;
      }
  ...
  setHoveredToken(e) {
    (this.hoveredToken != null && this.clearHoveredToken(), (this.hoveredToken = e));
  }
  ...
  getSelectionPointerInfo(e, t) {
    let n = this.resolvePointerTarget(e);
    if (_n(n) && !(t && !n.numberColumn) && n.splitLineIndex != null)
      return {
  ...
  getSelectionPointFromPath(e) {
    ...
    if (_n(t)) return { lineNumber: t.lineNumber, side: this.mode === `diff` ? t.side : void 0 };
  }
  getLineIndex(e, t) {
  ...
  getIndexesFromSelection(e, t) {
    ...
    return n != null && r != null ? { start: t ? n[1] : n[0], end: t ? r[1] : r[0] } : void 0;
  }
  renderSelection = () => {
    if (
      (this.queuedSelectionRender != null &&
    ...
    if (t.length > 2)
      throw (
        console.error(t),
        Error(`InteractionManager.renderSelection: Somehow there are more than 2 code elements...`)
      );
    ...
    for (let e of t) {
      ...
      for (let e = 0; e < s; e++) {
        ...
        let l = this.parseLineIndex(s, n);
        if ((l ?? 0) > o) break;
        if (l == null || l < a) continue;
        let u = i ? `single` : l === a ? `first` : l === o ? `last` : ``;
        (s.setAttribute(`data-selected-line`, u),
          c.setAttribute(`data-selected-line`, u),
          c.nextSibling instanceof HTMLElement &&
            s.nextSibling instanceof HTMLElement &&
            (s.nextSibling.hasAttribute(`data-line-annotation`) ||
              s.nextSibling.hasAttribute(`data-merge-conflict-actions`)) &&
            (i
              ? ((u = `last`), s.setAttribute(`data-selected-line`, `first`))
              : l === a
                ? (u = ``)
                : l === o && s.setAttribute(`data-selected-line`, ``),
            s.nextSibling.setAttribute(`data-selected-line`, u),
            c.nextSibling.setAttribute(`data-selected-line`, u)));
      }
    }
  };
  ...
  buildSelectedLineRange(e, t) {
    return this.buildSelectionRange(e.lineNumber, t.lineNumber, e.side, t.side);
  }
  ...
  resolvePointerTarget(e) {
    ...
    for (let f of e) {
      ...
      if (d == null && f.hasAttribute(`data-merge-conflict-action`)) {
        let e = f.getAttribute(`data-merge-conflict-action`) ?? void 0,
          t = f.getAttribute(`data-merge-conflict-conflict-index`) ?? void 0,
          n = t == null ? NaN : Number.parseInt(t, 10);
        Sn(e) &&
          Number.isFinite(n) &&
          (d = { kind: `merge-conflict-action`, resolution: e, conflictIndex: n });
      }
      if (s == null && f.hasAttribute(`data-char`)) {
        ...
        if (e != null) {
          ...
          if (!Number.isNaN(t)) {
            let e = f.textContent ?? ``,
              n = t + e.length;
            (e.trim() !== `` || this.options.enableTokenInteractionsOnWhitespace === !0) &&
              (c = { tokenElement: s, lineCharStart: t, lineCharEnd: n, tokenText: e });
            continue;
          }
        }
      }
      let e = o == null ? (f.getAttribute(`data-column-number`) ?? void 0) : void 0;
      if (e != null) {
        ((o = f),
      ...
      let p = i == null ? (f.getAttribute(`data-line`) ?? void 0) : void 0;
      if (p != null) {
        ((i = f),
      ...
      if (
        l == null &&
        (f.hasAttribute(`data-expand-button`) || f.hasAttribute(`data-unmodified-lines`))
      ) {
        l = {
          hunkIndex: void 0,
      ...
      let m = l == null ? void 0 : (f.getAttribute(`data-expand-index`) ?? void 0);
      if (l != null && m != null) {
    ...
    if (d != null) return d;
    if (l?.hunkIndex != null)
      return { type: `line-info`, hunkIndex: l.hunkIndex, direction: l.direction, all: l.all };
    if (
      ((i ??= a == null ? void 0 : Cn(r, `[data-line][data-line-index="${a}"]`)),
      (o ??= a == null ? void 0 : Cn(r, `[data-column-number][data-line-index="${a}"]`)),
      r == null || i == null || o == null || n == null || u == null || Number.isNaN(u))
    )
      return;
...
function hn(
  {
    ...
    __debugPointerEvents: m,
    enableLineSelection: h,
    onLineSelected: g,
    onLineSelectionStart: _,
    onLineSelectionChange: v,
    onLineSelectionEnd: y,
  },
  ee,
  te,
  ne,
  ...
  return {
    ...
    usesCustomGutterUtility: f != null || p != null,
    lineHoverHighlight: r,
    onGutterUtilityClick: i,
    onHunkExpand: ee,
    onMergeConflictActionClick: ne,
    onLineClick: a,
    onLineEnter: o,
    onLineLeave: s,
    onLineNumberClick: c,
...
function gn({
  ...
  enableHoverUtility: t,
  renderGutterUtility: n,
  renderHoverUtility: r,
  onGutterUtilityClick: i,
}) {
...
function En(e) {
  for (let t of e) if (t instanceof HTMLElement && t.hasAttribute(`data-utility-button`)) return !0;
  return !1;
}
function O(e = `none`, t, ...n) {
  switch (e) {
    case `none`:
      return;
    case `both`:
...
var Dn = class {
    ...
    setup(e, t) {
      ...
      let n = e.querySelectorAll(`code`),
        r = new Map(this.observedNodes);
      this.observedNodes.clear();
      for (let e of n) {
        let t = r.get(e);
        if (t != null && t.type !== `code`)
          throw Error(
        ...
        (n instanceof HTMLElement || (n = null),
          t == null
            ? ((t = {
              ...
              this.observedNodes.set(e, t),
              this.resizeObserver.observe(e),
              n != null && (this.observedNodes.set(n, t), this.resizeObserver.observe(n)))
            : (this.observedNodes.set(e, t),
              r.delete(e),
              t.numberElement === n
                ? t.numberElement != null &&
                  (r.delete(t.numberElement), this.observedNodes.set(t.numberElement, t))
                : (t.numberElement != null && this.resizeObserver.unobserve(t.numberElement),
                  n != null &&
                    (this.resizeObserver.observe(n), r.delete(n), this.observedNodes.set(n, t)),
                  (t.numberElement = n))));
      }
      if (n.length > 1 && !t) {
        ...
        for (let e of t) {
          ...
          let { lineAnnotation: t = `` } = e.dataset;
          if (!/^\d+,\d+$/.test(t)) {
        ...
        for (let [e, t] of n) {
          if (t.length !== 2) {
            console.error(`DiffFileRenderer.setupResizeObserver: Bad Pair`, e, t);
            continue;
          }
          let [n, i] = t,
          ...
          let s = r.get(a);
          if (s != null) {
            (this.observedNodes.set(a, s), this.observedNodes.set(o, s), r.delete(a), r.delete(o));
            continue;
          }
          s = {
            type: `annotations`,
            column1: { container: n, child: a, childHeight: a.getBoundingClientRect().height },
            column2: { container: i, child: o, childHeight: o.getBoundingClientRect().height },
            currentHeight: `auto`,
          };
          let c = Math.max(s.column1.childHeight, s.column2.childHeight);
          (this.applyNewHeight(s, c),
            this.observedNodes.set(a, s),
            this.observedNodes.set(o, s),
      ...
      for (let e of r.keys())
        (e.isConnected &&
          (e.style.removeProperty(`--diffs-column-content-width`),
          e.style.removeProperty(`--diffs-column-number-width`),
          e.style.removeProperty(`--diffs-column-width`),
          e.parentElement instanceof HTMLElement &&
            e.parentElement.style.removeProperty(`--diffs-annotation-min-height`)),
          this.resizeObserver.unobserve(e));
      r.clear();
    }
    handleResizeObserver = (e) => {
      for (let t of e) {
        let { target: e, borderBoxSize: n, contentBoxSize: r } = t;
        if (!(e instanceof HTMLElement)) {
          console.error(`FileDiff.handleResizeObserver: Invalid element for ResizeObserver`, t);
          continue;
        }
        let i = this.observedNodes.get(e);
        if (i == null) {
          console.error(`FileDiff.handleResizeObserver: Not a valid observed node`, t);
          continue;
        }
        if (i.type === `annotations`) {
          let t = (() => {
            if (e === i.column1.child) return i.column1;
            if (e === i.column2.child) return i.column2;
          })();
          if (t == null) {
          ...
          t.childHeight = n[0].blockSize;
          let r = Math.max(i.column1.childHeight, i.column2.childHeight);
          this.applyNewHeight(i, r);
        } else if (i.type === `code`) {
          let t = [e, r[0].inlineSize],
            n = this.queuedUpdates.get(i) ?? [];
          (n.push(t), this.queuedUpdates.set(i, n));
        }
      }
      this.handleColumnChange();
    };
    handleColumnChange = () => {
      for (let [e, t] of this.queuedUpdates)
        for (let [n, r] of t)
          if (n === e.codeElement) {
            let n = Math.max(Math.floor(r), 0);
            if (n !== e.codeWidth) {
              let t = Math.max(n - e.numberWidth, 0);
              ((e.codeWidth = n === 0 ? `auto` : n),
            ...
            e.numberElement != null &&
              ...
              e.numberWidth === 0 &&
              t.push([e.numberElement, e.numberElement.getBoundingClientRect().width]);
          } else if (n === e.numberElement) {
            let t = Math.max(Math.ceil(r), 0);
            if (
              t !== e.numberWidth &&
              ((e.numberWidth = t),
              e.codeElement.style.setProperty(
              ...
              let t = Math.max(e.codeWidth - e.numberWidth, 0);
              e.codeElement.style.setProperty(
                `--diffs-column-content-width`,
                `${t === 0 ? `auto` : `${t}px`}`,
              );
...
function Mn(e) {
  for (let t of Array.isArray(e) ? e : [e])
    if (!(t === `text` || t === `ansi`) && !jn.has(t)) return !1;
  return !0;
}
function Nn(e, t) {
  e = Array.isArray(e) ? e : [e];
  for (let n of e) {
    if (jn.has(n.name)) continue;
    let e = On.get(n.name);
    (e ?? ((e = n), On.set(n.name, e)), jn.add(e.name), t.loadLanguageSync(e.data));
  }
}
function Pn() {
...
function In(e) {
  return Array.isArray(e) ? Ln(e) : e instanceof RegExp ? e : typeof e == `object` ? Rn(e) : e;
}
function Ln(e) {
  let t = [];
  for (let n = 0, r = e.length; n < r; n++) t[n] = In(e[n]);
  return t;
}
function Rn(e) {
  let t = {};
...
function Bn(e) {
  ...
  return t === 0 ? e : ~t === e.length - 1 ? Bn(e.substring(0, e.length - 1)) : e.substr(~t + 1);
}
var Vn = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
  Hn = class {
    static hasCaptures(e) {
      return e === null ? !1 : ((Vn.lastIndex = 0), Vn.test(e));
    }
    static replaceCaptures(e, t, n) {
      return e.replace(Vn, (e, r, i, a) => {
...
var qn = class {
  ...
  Jn = class {
    ...
    static createFromRawTheme(e, t) {
      return this.createFromParsedTheme($n(e), t);
    }
    static createFromParsedTheme(e, t) {
      return tr(e, t);
    }
    _cachedMatchRoot = new qn((e) => this._root.match(e));
    getColorMap() {
    ...
    match(e) {
      ...
      let t = e.scopeName,
        n = this._cachedMatchRoot.get(t).find((t) => Xn(e.parent, t.parentScopes));
      return n ? new Qn(n.fontStyle, n.foreground, n.background) : null;
    }
  },
  Yn = class e {
    constructor(e, t) {
...
function tr(e, t) {
  e.sort((e, t) => {
    let n = Un(e.scope, t.scope);
    return n !== 0 || ((n = Wn(e.parentScopes, t.parentScopes)), n !== 0) ? n : e.index - t.index;
  });
  let n = 0,
    r = `#000000`,
    i = `#ffffff`;
  ...
  let a = new nr(t),
    o = new Qn(n, a.getId(r), a.getId(i)),
    s = new ar(new ir(0, null, -1, 0, 0), []);
  for (let t = 0, n = e.length; t < n; t++) {
    let n = e[t];
  ...
  ar = class e {
    ...
    match(t) {
      if (t !== ``) {
        let e = t.indexOf(`.`),
          ...
          r;
        if (
          (e === -1 ? ((n = t), (r = ``)) : ((n = t.substring(0, e)), (r = t.substring(e + 1))),
    ...
    insert(t, n, r, i, a, o) {
      ...
      (this._children.hasOwnProperty(c)
        ? (u = this._children[c])
        : ((u = new e(this._mainRule.clone(), ir.cloneArr(this._rulesWithParentScopes))),
          (this._children[c] = u)),
    ...
    _doInsertHere(e, t, n, r, i) {
      ...
      (n === -1 && (n = this._mainRule.fontStyle),
        ...
        this._rulesWithParentScopes.push(new ir(e, t, n, r, i)));
    }
  },
  or = class e {
    ...
    static print(t) {
      let n = e.getLanguageId(t),
        ...
        a = e.getForeground(t),
        o = e.getBackground(t);
      console.log({ languageId: n, tokenType: r, fontStyle: i, foreground: a, background: o });
    }
  ...
  gr = class {
    constructor(e, t) {
      ((this.repo = e),
        ...
        (this.Q = [new pr(this.initialScopeName)]));
    }
    ...
    processQueue() {
      ...
      this.Q = [];
      let t = new hr();
      for (let n of e) _r(n, this.initialScopeName, this.repo, t);
...
function _r(e, t, n, r) {
  ...
  let a = n.lookup(t);
  e instanceof pr
    ? yr({ baseGrammar: a, selfGrammar: i }, r)
    : vr(e.ruleName, { baseGrammar: a, selfGrammar: i, repository: i.repository }, r);
  let o = n.injections(e.scopeName);
  if (o) for (let e of o) r.add(new pr(e));
}
function vr(e, t, n) {
...
function yr(e, t) {
  (e.selfGrammar.patterns &&
    ...
    br(e.selfGrammar.patterns, { ...e, repository: e.selfGrammar.repository }, t),
...
function br(e, t, n) {
  for (let r of e) {
    ...
    n.visitedRule.add(r);
    let e = r.repository ? zn({}, t.repository, r.repository) : t.repository;
    Array.isArray(r.patterns) && br(r.patterns, { ...t, repository: e }, n);
    let i = r.include;
    if (!i) continue;
    let a = Er(i);
    switch (a.kind) {
      case 0:
        yr({ ...t, selfGrammar: t.baseGrammar }, n);
        break;
      case 1:
        yr(t, n);
        break;
      case 2:
        vr(a.ruleName, { ...t, repository: e }, n);
        break;
      case 3:
      case 4:
        let r =
        ...
        if (r) {
          ...
          a.kind === 4 ? vr(a.ruleName, i, n) : yr(i, n);
        } else a.kind === 4 ? n.add(new mr(a.scopeName, a.ruleName)) : n.add(new pr(a.scopeName));
        break;
    }
  }
}
...
function Er(e) {
  if (e === `$base`) return new xr();
  if (e === `$self`) return new Sr();
  let t = e.indexOf(`#`);
  return t === -1
    ? new wr(e)
    : t === 0
      ? new Cr(e.substring(1))
      : new Tr(e.substring(0, t), e.substring(t + 1));
}
var Dr = /\\(\d+)/,
  Or = /\\(\d+)/g,
  kr = -1,
...
var Nr = class {
    ...
    constructor(e, t, n, r) {
      ((this.$location = e),
        (this.id = t),
        (this._name = n || null),
        (this._nameIsCapturing = Hn.hasCaptures(this._name)),
        (this._contentName = r || null),
        (this._contentNameIsCapturing = Hn.hasCaptures(this._contentName)));
    }
    get debugName() {
      let e = this.$location ? `${Bn(this.$location.filename)}:${this.$location.line}` : `unknown`;
      return `${this.constructor.name}#${this.id} @ ${e}`;
    }
    getName(e, t) {
      return !this._nameIsCapturing || this._name === null || e === null || t === null
        ? this._name
        : Hn.replaceCaptures(this._name, e, t);
    }
    getContentName(e, t) {
      return !this._contentNameIsCapturing || this._contentName === null
        ? this._contentName
        : Hn.replaceCaptures(this._contentName, e, t);
    }
  },
  Pr = class extends Nr {
    ...
    _getCachedCompiledPatterns(e) {
      return (
        this._cachedCompiledPatterns ||
          ((this._cachedCompiledPatterns = new Vr()),
  ...
  Lr = class extends Nr {
    ...
    constructor(e, t, n, r, i, a, o, s, c, l) {
      (super(e, t, n, r),
        (this._begin = new Br(i, this.id)),
        (this.beginCaptures = a),
        (this._end = new Br(o || `￿`, -1)),
  ...
  Rr = class extends Nr {
    ...
    _getCachedCompiledWhilePatterns(e, t) {
      return (
        this._cachedCompiledWhilePatterns ||
          ((this._cachedCompiledWhilePatterns = new Vr()),
  ...
  zr = class e {
    static createCaptureRule(e, t, n, r, i) {
      return e.registerRule((e) => new Pr(t, e, n, r, i));
    }
      ...
      return (
        t.id ||
          n.registerRule((i) => {
            ...
            if (t.begin === void 0) {
              t.repository && (r = zn({}, r, t.repository));
              let i = t.patterns;
              return (
        ...
        for (let a = 0, o = t.length; a < o; a++) {
          ...
          if (s !== -1) {
            let e = n.getRule(s),
              t = !1;
            if (
              ((e instanceof Ir || e instanceof Lr || e instanceof Rr) &&
  ...
  Br = class e {
    ...
    resolveBackReferences(e, t) {
      ...
      return ((Or.lastIndex = 0), this.source.replace(Or, (e, t) => Kn(n[parseInt(t, 10)] || ``)));
    }
    _buildAnchorCache() {
      if (typeof this.source != `string`)
        throw Error(`This method should only be called if the source is a string`);
      ...
      for (i = 0, a = this.source.length; i < a; i++)
        ((o = this.source.charAt(i)),
          ...
          o === `\\` &&
            ...
            s === `A`
              ? ((e[i + 1] = `￿`), (t[i + 1] = `￿`), (n[i + 1] = `A`), (r[i + 1] = `A`))
              : s === `G`
                ? ((e[i + 1] = `￿`), (t[i + 1] = `G`), (n[i + 1] = `￿`), (r[i + 1] = `G`))
                : ((e[i + 1] = s), (t[i + 1] = s), (n[i + 1] = s), (r[i + 1] = s)),
            i++));
      return { A0_G0: e.join(``), A0_G1: t.join(``), A1_G0: n.join(``), A1_G1: r.join(``) };
    }
    resolveAnchors(e, t) {
...
`);
  ...
  Wr = class e {
    ...
    constructor(e, t) {
      ((this._defaultAttributes = new Ur(e, 8)),
        (this._embeddedLanguagesMatcher = new Gr(Object.entries(t || {}))));
    }
    ...
    static _NULL_SCOPE_METADATA = new Ur(0, 0);
    _getBasicScopeAttributes = new qn(
      (e) => new Ur(this._scopeToLanguage(e), this._toStandardTokenType(e)),
    );
    _scopeToLanguage(e) {
...
function Jr(e, t, n, r, i, a, o, s) {
  let c = t.content.length,
    ...
    u = -1;
  if (o) {
    let o = Yr(e, t, n, r, i, a);
    ((i = o.stack), (r = o.linePos), (n = o.isFirstLine), (u = o.anchorPosition));
  }
  let d = Date.now();
  for (; !l; ) {
    if (s !== 0 && Date.now() - d > s) return new qr(i, !0);
    f();
  }
  return new qr(i, !1);
  function f() {
    let o = Xr(e, t, n, r, i, u);
    if (!o) {
      (a.produce(i, c), (l = !0));
      return;
    }
    ...
    if (d === kr) {
      ...
      if (((i = i.push(d, r, u, s[0].end === c, null, h, h)), o instanceof Lr)) {
        let r = o;
        (ni(e, t, n, i, a, r.beginCaptures, s), a.produce(i, s[0].end), (u = s[0].end));
        let d = r.getContentName(t.content, s),
          m = h.pushAttributed(d, e);
        if (
          ((i = i.withContentNameScopesList(m)),
          r.endHasBackReferences &&
            (i = i.withEndRule(r.getEndWithResolvedBackReferences(t.content, s))),
          !f && p.hasSameRuleAs(i))
        ) {
        ...
        if (
          ...
          r.whileHasBackReferences &&
            (i = i.withEndRule(r.getWhileWithResolvedBackReferences(t.content, s))),
          !f && p.hasSameRuleAs(i))
        ) {
          ((i = i.pop()), a.produce(i, c), (l = !0));
          return;
        }
      } else if ((ni(e, t, n, i, a, o.captures, s), a.produce(i, s[0].end), (i = i.pop()), !f)) {
...
function Yr(e, t, n, r, i, a) {
  ...
  for (let t = i; t; t = t.pop()) {
    let n = t.getRule(e);
    n instanceof Rr && s.push({ rule: n, stack: t });
  }
  for (let c = s.pop(); c; c = s.pop()) {
    let { ruleScanner: s, findOptions: l } = ei(c.rule, e, c.stack.endRule, n, r === o),
    ...
    if (u) {
      ...
      u.captureIndices &&
        ...
        ni(e, t, n, c.stack, a, c.rule.whileCaptures, u.captureIndices),
        a.produce(c.stack, u.captureIndices[0].end),
        (o = u.captureIndices[0].end),
        u.captureIndices[0].end > r && ((r = u.captureIndices[0].end), (n = !1)));
    } else {
      i = c.stack.pop();
      break;
    }
...
function Xr(e, t, n, r, i, a) {
  let o = Zr(e, t, n, r, i, a),
    s = e.getInjections();
  if (s.length === 0) return o;
  let c = Qr(s, e, t, n, r, i, a);
  if (!c) return o;
  if (!o) return c;
...
function Zr(e, t, n, r, i, a) {
  let { ruleScanner: o, findOptions: s } = $r(i.getRule(e), e, i.endRule, n, r === a),
...
function Qr(e, t, n, r, i, a, o) {
  ...
  for (let a = 0, f = e.length; a < f; a++) {
    ...
    let { ruleScanner: p, findOptions: m } = $r(t.getRule(f.ruleId), t, null, r, i === o),
      h = p.findNextMatchSync(n, i, m);
    if (!h) continue;
    let g = h.captureIndices[0].start;
    if (!(g >= s) && ((s = g), (c = h.captureIndices), (l = h.ruleId), (u = f.priority), s === i))
      break;
  }
...
function $r(e, t, n, r, i) {
  return Kr
    ? { ruleScanner: e.compile(t, n), findOptions: ti(r, i) }
    : { ruleScanner: e.compileAG(t, n, r, i), findOptions: 0 };
}
function ei(e, t, n, r, i) {
  return Kr
    ? { ruleScanner: e.compileWhile(t, n), findOptions: ti(r, i) }
...
function ni(e, t, n, r, i, a, o) {
  ...
  for (let t = 0; t < c; t++) {
    ...
    if (
      (l.length > 0 ? i.produceFromScopes(l[l.length - 1].scopes, d.start) : i.produce(r, d.start),
      ...
      (Jr(e, p, n && d.start === 0, d.start, f, i, !1, 0), fr(p));
      continue;
    }
    let f = c.getName(s, o);
    if (f !== null) {
      let t = (l.length > 0 ? l[l.length - 1].scopes : r.contentNameScopesList).pushAttributed(
        f,
        e,
      );
      l.push(new ri(t, d.end));
    }
  }
  for (; l.length > 0; )
    (i.produceFromScopes(l[l.length - 1].scopes, l[l.length - 1].endPos), l.pop());
...
function ii(e, t, n, r, i, a, o, s) {
  return new ci(e, t, n, r, i, a, o, s);
}
function ai(e, t, n, r, i) {
  let a = lr(t, oi),
    o = zr.getCompiledRuleId(n, r, i.repository);
  for (let n of a)
    e.push({ debugSelector: t, matcher: n.matcher, ruleId: o, grammar: i, priority: n.priority });
}
function oi(e, t) {
  if (t.length < e.length) return !1;
  let n = 0;
  return e.every((e) => {
    for (let r = n; r < t.length; r++) if (si(t[r], e)) return ((n = r + 1), !0);
    return !1;
  });
}
function si(e, t) {
...
var ci = class {
  constructor(e, t, n, r, i, a, o, s) {
    if (
      ...
      (this._onigLib = s),
      (this._basicScopeAttributesProvider = new Wr(n, r)),
      (this._rootId = -1),
      (this._lastRuleId = 0),
      (this._ruleId2desc = [null]),
      (this._includedGrammars = {}),
      (this._grammarRepository = o),
      (this._grammar = li(t, null)),
      ...
      for (let e of Object.keys(i)) {
        let t = lr(e, oi);
        for (let n of t) this._tokenTypeMatchers.push({ matcher: n.matcher, type: i[e] });
      }
  }
  _rootId;
  _lastRuleId;
  ...
  _collectInjections() {
    ...
    if (r) {
      let e = r.injections;
      if (e) for (let n in e) ai(t, n, e[n], this, r);
  ...
  getExternalGrammar(e, t) {
    ...
    if (this._grammarRepository) {
      ...
      if (n) return ((this._includedGrammars[e] = li(n, t && t.$base)), this._includedGrammars[e]);
    }
  }
  ...
  _tokenize(e, t, n, r) {
    this._rootId === -1 &&
      ((this._rootId = zr.getCompiledRuleId(
    ...
    if (!t || t === di.NULL) {
      ...
      let e = this._basicScopeAttributesProvider.getDefaultAttributes(),
        ...
        r = or.set(0, e.languageId, e.tokenType, null, n.fontStyle, n.foregroundId, n.backgroundId),
        a = this.getRule(this._rootId).getName(null, null),
        o;
      ((o = a ? ui.createRootAndLookUpScopeName(a, r, this) : ui.createRoot(`unknown`, r)),
        (t = new di(null, this._rootId, -1, -1, !1, null, o, o)));
    } else ((i = !1), t.reset());
    e += `
`;
    let a = this.createOnigString(e),
      o = a.content.length,
      s = new pi(n, e, this._tokenTypeMatchers, this.balancedBracketSelectors),
      c = Jr(this, a, i, 0, t, s, !0, r);
    return (
      fr(a),
      { lineLength: o, lineTokens: s, ruleStack: c.stack, stoppedEarly: c.stoppedEarly }
    );
  }
};
function li(e, t) {
...
var ui = class e {
    ...
    static fromExtension(t, n) {
      let r = t,
        i = t?.scopePath ?? null;
      for (let t of n)
        ((i = Yn.push(i, t.scopeNames)), (r = new e(r, i, t.encodedTokenAttributes)));
      return r;
    }
    static createRoot(t, n) {
      return new e(null, new Yn(null, t), n);
    }
    ...
    static mergeAttributes(e, t, n) {
      let r = -1,
        ...
        a = 0;
      return (
        n !== null && ((r = n.fontStyle), (i = n.foregroundId), (a = n.backgroundId)),
        or.set(e, t.languageId, t.tokenType, null, r, i, a)
      );
    }
    pushAttributed(t, n) {
  ...
  di = class e {
    ...
    static _equals(e, t) {
      return e === t
        ...
        : this._structuralEquals(e, t)
          ? ui.equals(e.contentNameScopesList, t.contentNameScopesList)
          : !1;
    }
    ...
    static pushFrame(t, n) {
      let r = ui.fromExtension(t?.nameScopesList ?? null, n.nameScopesList);
      return new e(
        t,
        jr(n.ruleId),
        n.enterPos ?? -1,
        ...
        n.endRule,
        r,
        ui.fromExtension(r, n.contentNameScopesList),
      );
    }
  },
  fi = class {
    ...
    constructor(e, t) {
      ((this.balancedBracketScopes = e.flatMap((e) =>
        e === `*` ? ((this.allowAny = !0), []) : lr(e, oi).map((e) => e.matcher),
      )),
        (this.unbalancedBracketScopes = t.flatMap((e) => lr(e, oi).map((e) => e.matcher))));
    }
    get matchesAlways() {
      ...
      if (this._emitBinaryTokens) {
        ...
        if (
          ...
          for (let e of this._tokenTypeOverrides)
            e.matcher(t) && (n = or.set(n, 0, sr(e.type), null, -1, 0, 0));
          this.balancedBracketSelectors && (r = this.balancedBracketSelectors.match(t));
        }
        if (
          (r && (n = or.set(n, 0, 8, r, -1, 0, 0)),
  ...
  mi = class {
    ...
    grammarForScopeName(e, t, n, r, i) {
      if (!this._grammars.has(e)) {
        ...
        if (!a) return null;
        this._grammars.set(e, ii(e, a, t, n, r, i, this, this._onigLib));
      }
  ...
  hi = class {
    ...
    constructor(e) {
      ((this._options = e),
        (this._syncRegistry = new mi(Jn.createFromRawTheme(e.theme, e.colorMap), e.onigLib)),
    ...
    setTheme(e, t) {
      this._syncRegistry.setTheme(Jn.createFromRawTheme(e, t));
    }
    getColorMap() {
    ...
    loadGrammarWithConfiguration(e, t, n) {
      return this._loadGrammar(
        ...
        n.embeddedLanguages,
        n.tokenTypes,
        new fi(n.balancedBracketSelectors || [], n.unbalancedBracketSelectors || []),
      );
    }
    loadGrammar(e) {
    ...
    _loadGrammar(e, t, n, r, i) {
      let a = new gr(this._syncRegistry, e);
      for (; a.Q.length > 0; )
        (a.Q.map((e) => this._loadSingleGrammar(e.scopeName)), a.processQueue());
      ...
      for (let a of s) {
        ...
        if (n === 0 && r && Ai.includes(a))
          if (r === ki && o.length > 1) {
            ...
            ((c[a] = `light-dark(${o[e][a] || `inherit`}, ${o[r][a] || `inherit`})`),
...
function Pi(e) {
  let t = {};
  if (
    (e.color && (t.color = e.color), e.bgColor && (t[`background-color`] = e.bgColor), e.fontStyle)
  ) {
    (e.fontStyle & A.Italic && (t[`font-style`] = `italic`),
      e.fontStyle & A.Bold && (t[`font-weight`] = `bold`));
    let n = [];
    (e.fontStyle & A.Underline && n.push(`underline`),
      e.fontStyle & A.Strikethrough && n.push(`line-through`),
...
var zi = class e {
  ...
  static initial(t, n) {
    return new e(Object.fromEntries(yi(n).map((e) => [e, gi])), t);
  }
  constructor(...e) {
    if (e.length === 2) {
      let [t, n] = e;
...
function Vi(e, t) {
  if (!(e instanceof zi)) throw new k(`Invalid grammar state`);
...
function Hi() {
  ...
  function t(t) {
    if (!e.has(t.meta)) {
      let n = function (e) {
          if (typeof e == `number`) {
            if (e < 0 || e > t.source.length)
              throw new k(`Invalid decoration offset: ${e}. Code length: ${t.source.length}`);
      ...
      (Ui(i), e.set(t.meta, { decorations: i, converter: r, source: t.source }));
    }
    return e.get(t.meta);
  }
  return {
    ...
    code(e) {
      ...
      let n = t(this),
        r = Array.from(e.children).filter((e) => e.type === `element` && e.tagName === `span`);
      ...
      function i(e, t, n, i) {
        ...
        if (c === -1)
          throw new k(`Failed to find start index for decoration ${JSON.stringify(i.start)}`);
        if (l === -1)
          throw new k(`Failed to find end index for decoration ${JSON.stringify(i.end)}`);
        ...
        if (!i.alwaysWrap && u.length === a.children.length) o(a, i, `line`);
          ...
          let e = { type: `element`, tagName: `span`, properties: {}, children: u };
      ...
      function o(e, t, n) {
        ...
        return (
          ...
          t.properties?.class && Ti(e, t.properties.class),
          (e = i(e, n) || e),
          e
        );
      }
...
function Wi(e) {
  return e.type === `text` ? e.value : e.type === `element` ? e.children.map(Wi).join(``) : ``;
}
var Gi = [Hi()];
function Ki(e) {
  let t = qi(e.transformers || []);
  return [...t.pre, ...t.normal, ...t.post, ...Gi];
}
function qi(e) {
  let t = [],
    n = [],
...
function Zi(e) {
  ...
  if (t === `2`) {
    ...
    return t.length !== 3 || t.some((e) => Number.isNaN(e)) ? void 0 : { type: `rgb`, rgb: t };
  } else if (t === `5`) {
    let t = e.shift();
...
function Qi(e) {
  ...
  for (; e.length > 0; ) {
    ...
    if (!Number.isNaN(r))
      if (r === 0) t.push({ type: `resetAll` });
      else if (r <= 9) Yi[r] && t.push({ type: `setDecoration`, value: Yi[r] });
      else if (r <= 29) {
        let e = Yi[r - 20];
        e &&
        ...
        t.push({ type: `setForegroundColor`, value: { type: `named`, name: Ji[r - 30] } });
      else if (r === 38) {
        let n = Zi(e);
        n && t.push({ type: `setForegroundColor`, value: n });
      } else if (r === 39) t.push({ type: `resetForegroundColor` });
      else if (r <= 47)
        t.push({ type: `setBackgroundColor`, value: { type: `named`, name: Ji[r - 40] } });
      else if (r === 48) {
        let n = Zi(e);
            ...
            : r === 55
              ...
              : r >= 90 && r <= 97
                ? t.push({
                    ...
                    value: { type: `named`, name: Ji[r - 90 + 8] },
                  })
                : r >= 100 &&
                  r <= 107 &&
                  t.push({
                    type: `setBackgroundColor`,
                    value: { type: `named`, name: Ji[r - 100 + 8] },
                  });
  }
  return t;
}
...
function ta(e = ea) {
  ...
  function i() {
    if (r) return r;
    r = [];
    for (let e = 0; e < Ji.length; e++) r.push(t(Ji[e]));
    let e = [0, 95, 135, 175, 215, 255];
    for (let t = 0; t < 6; t++)
      for (let i = 0; i < 6; i++) for (let a = 0; a < 6; a++) r.push(n([e[t], e[i], e[a]]));
    let i = 8;
  ...
  return i.map((t) =>
    o.parse(t[0]).map((n) => {
      ...
      (n.decorations.has(`reverse`)
        ...
        (i = vi(i, r)),
        (o = vi(o, r)),
        n.decorations.has(`dim`) && (i = ia(i)));
      let s = A.None;
      return (
        n.decorations.has(`bold`) && (s |= A.Bold),
        n.decorations.has(`italic`) && (s |= A.Italic),
        n.decorations.has(`underline`) && (s |= A.Underline),
        n.decorations.has(`strikethrough`) && (s |= A.Strikethrough),
  ...
  if (t) {
    ...
    if (e.length === 8) {
      ...
      let t = e[0],
        ...
        r = e[2],
        i = e[3];
      return `#${t}${t}${n}${n}${r}${r}${Math.round(Number.parseInt(`${i}${i}`, 16) / 2)
        .toString(16)
        .padStart(2, `0`)}`;
    } else if (e.length === 3) {
      let t = e[0],
...
function aa(e, t, n = {}) {
  ...
  if (xi(i) || Ci(r)) return Ei(t).map((e) => [{ content: e[0], offset: e[1] }]);
  let { theme: a, colorMap: o } = e.setTheme(r);
  if (i === `ansi`) return ra(a, t, n);
...
function oa(...e) {
  if (e.length === 2) return Ri(e[1]);
  let [t, n, r = {}] = e,
    { lang: i = `text`, theme: a = t.getLoadedThemes()[0] } = r;
  if (xi(i) || Ci(a)) throw new k(`Plain language does not have grammar state`);
  if (i === `ansi`) throw new k(`ANSI language does not have grammar state`);
  let { theme: o, colorMap: s } = t.setTheme(a),
    c = t.getLanguage(i);
  return new zi(ca(n, c, o, s, r).stateStack, c.name, o.name);
}
function sa(e, t, n, r, i) {
  let a = ca(e, t, n, r, i),
    o = new zi(a.stateStack, t.name, n.name);
  return (Li(a.tokens, o), a.tokens);
}
function ca(e, t, n, r, i) {
  let a = _i(n, i),
    ...
    c = Ei(e),
    l = i.grammarState
      ? (Vi(i.grammarState, n.name) ?? gi)
      : i.grammarContextCode == null
        ? gi
        : ca(i.grammarContextCode, t, n, r, {
            ...i,
            grammarState: void 0,
  ...
  for (let e = 0, f = c.length; e < f; e++) {
    ...
    for (let e = 0; e < v; e++) {
      ...
      let s = _.tokens[2 * e + 1],
        c = vi(r[or.getForeground(s)], a),
        l = or.getFontStyle(s),
        d = { content: f.substring(t, o), offset: p + t, color: c, fontStyle: l };
      if (i.includeExplanation) {
        ...
        for (; t + r < o; ) {
          ...
          ((r += n.length),
            d.explanation.push({
              content: n,
              scopes: i.includeExplanation === `scopeName` ? la(t.scopes) : ua(e, t.scopes),
            }),
            (g += 1));
        }
      }
...
function ua(e, t) {
  ...
  for (let r = 0, i = t.length; r < i; r++) {
    let i = t[r];
    n[r] = { scopeName: i, themeMatches: pa(e, i, t.slice(0, r)) };
  }
  return n;
}
function da(e, t) {
...
function fa(e, t, n) {
  if (!da(e[e.length - 1], t)) return !1;
  let r = e.length - 2,
    i = n.length - 1;
  for (; r >= 0 && i >= 0; ) (da(e[r], n[i]) && --r, --i);
  return r === -1;
}
function pa(e, t, n) {
  let r = [];
...
function ga(e, t, n) {
  ...
  if (`themes` in n) {
    ...
    if (f.length === 0) throw new k("`themes` option must not be empty");
    let p = ma(e, t, n);
    if (((c = Ri(p)), l && ki !== l && !f.find((e) => e.color === l)))
      throw new k(`\`themes\` option must contain the defaultColor key \`${l}\``);
    let m = f.map((t) => e.getTheme(t.theme)),
      h = f.map((e) => e.color);
    ((a = p.map((e) => e.map((e) => Ni(e, h, u, l, d)))), c && Li(a, c));
    let g = f.map((e) => _i(e.theme, n));
    ((i = _a(f, m, g, u, l, `fg`, d)),
      (r = _a(f, m, g, u, l, `bg`, d)),
    ...
    ((r = vi(l.bg, s)), (i = vi(l.fg, s)), (o = l.name), (c = Ri(a)));
  } else throw new k("Invalid options, either `theme` or `themes` must be provided");
  return { tokens: a, fg: i, bg: r, themeName: o, rootStyle: s, grammarState: c };
}
function _a(e, t, n, r, i, a, o) {
  return e
    .map((s, c) => {
      let l = vi(t[c][a], n[c]) || `inherit`,
      ...
      if (c === 0 && i) {
        if (i === ki && e.length > 1) {
          ...
          return `light-dark(${vi(t[r][a], n[r]) || `inherit`}, ${vi(t[i][a], n[i]) || `inherit`});${u}`;
        }
        return l;
      }
...
function va(
  ...
  r = {
    meta: {},
    options: n,
    codeToHast: (t, n) => va(e, t, n),
    codeToTokens: (t, n) => ga(e, t, n),
  },
) {
  let i = t;
  for (let e of Ki(n)) i = e.preprocess?.call(r, i, n) || i;
  let { tokens: a, fg: o, bg: s, themeName: c, rootStyle: l, grammarState: u } = ga(e, i, n),
    { mergeWhitespaces: d = !0, mergeSameStyleTokens: f = !1 } = n;
  (d === !0 ? (a = ba(a)) : d === `never` && (a = xa(a)), f && (a = Sa(a)));
  let p = {
    ...r,
    get source() {
      return i;
  ...
  for (let e of Ki(n)) a = e.tokens?.call(p, a) || a;
  return ya(
    a,
    { ...n, fg: o, bg: s, themeName: c, rootStyle: n.rootStyle === !1 ? !1 : (n.rootStyle ?? l) },
    p,
    u,
  );
}
function ya(e, t, n, r = Ri(e)) {
  let i = Ki(t),
    a = [],
...
`,
      ...
      for (let a of e) {
        let e = {
          ...
          c = Fi(a.htmlStyle || Pi(a));
        c && (e.properties.style = c);
        for (let o of i) e = o?.span?.call(p, e, t + 1, r, n, a) || e;
        (s === `inline` ? o.children.push(e) : s === `classic` && n.children.push(e),
          (r += a.content.length));
      }
      if (s === `classic`) {
    ...
    for (let e = 0; e < n.children.length; e++) {
      e > 0 && o.children.push({ type: `element`, tagName: `br`, properties: {}, children: [] });
      let t = n.children[e];
...
function ba(e) {
  return e.map((e) => {
    ...
    return (
      e.forEach((i, a) => {
        let o = !(i.fontStyle && (i.fontStyle & A.Underline || i.fontStyle & A.Strikethrough));
...
function Sa(e) {
  return e.map((e) => {
    ...
    for (let n of e) {
      ...
      let e = t[t.length - 1],
        r = Fi(e.htmlStyle || Pi(e)),
        i = Fi(n.htmlStyle || Pi(n)),
        a = e.fontStyle && (e.fontStyle & A.Underline || e.fontStyle & A.Strikethrough),
        o = n.fontStyle && (n.fontStyle & A.Underline || n.fontStyle & A.Strikethrough);
...
function wa(e, t, n) {
  let r = {
    ...
    i = Ca(va(e, t, n, r));
  for (let e of Ki(n)) i = e.postprocess?.call(r, i, n) || i;
  return i;
}
var Ta = { light: `#333333`, dark: `#bbbbbb` },
  Ea = { light: `#fffffe`, dark: `#1e1e1e` },
  Da = `__shiki_resolved`;
function Oa(e) {
  if (e?.[Da]) return e;
  let t = { ...e };
  ...
  if (!n || !r) {
    ...
    (e?.settings?.foreground && (r = e.settings.foreground),
      ...
      (r ||= t.type === `light` ? Ta.light : Ta.dark),
      (n ||= t.type === `light` ? Ea.light : Ea.dark),
      (t.fg = r),
      (t.bg = n));
  }
  ...
  for (let e of Object.keys(t.colors || {}))
    if (
      (e === `editor.foreground` || e === `editor.background` || e.startsWith(`terminal.ansi`)) &&
      !t.colors[e]?.startsWith(`#`)
    ) {
      let n = o(t.colors[e]);
      ((t.colorReplacements[n] = t.colors[e]), (t.colors[e] = n));
    }
  return (Object.defineProperty(t, Da, { enumerable: !1, writable: !1, value: !0 }), t);
}
async function ka(e) {
  return Array.from(
    new Set(
      (
        await Promise.all(
          e
            .filter((e) => !Si(e))
            .map(async (e) => await bi(e).then((e) => (Array.isArray(e) ? e : [e]))),
        )
      ).flat(),
    ),
  );
...
async function Aa(e) {
  return (await Promise.all(e.map(async (e) => (wi(e) ? null : Oa(await bi(e)))))).filter(
    (e) => !!e,
  );
}
var ja = 3,
  Ma = !1;
function Na(e, t = 3) {
  if (ja && !(typeof ja == `number` && t > ja)) {
    if (Ma) throw Error(`[SHIKI DEPRECATE]: ${e}`);
...
function Fa(e, t) {
  ...
  if (t[e]) {
    ...
    for (; t[e]; ) {
      if (((e = t[e]), n.has(e)))
        throw new Pa(`Circular alias \`${Array.from(n).join(` -> `)} -> ${e}\``);
      n.add(e);
    }
  }
  return e;
...
var Ia = class extends hi {
    ...
    setTheme(e) {
      ...
      (t || ((t = Jn.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)),
        this._syncRegistry.setTheme(t));
    }
    getGrammar(e) {
      return ((e = Fa(e, this._alias)), this._resolvedGrammars.get(e));
    }
    loadLanguage(e) {
    ...
    loadLanguages(e) {
      ...
      if (n.length) {
        let e = t
          .filter(([e, t]) =>
            t
              ? (t.embeddedLanguages || t.embeddedLangs)?.some((e) => n.map(([e]) => e).includes(e))
              : !1,
          )
...
function za(e) {
  ((Ra += 1),
    e.warnings !== !1 &&
      ...
      Ra % 10 == 0 &&
      console.warn(
        `[Shiki] ${Ra} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`,
      ));
  let t = !1;
  if (!e.engine) throw new Pa("`engine` option is required for synchronous mode");
  let n = (e.langs || []).flat(1),
    r = (e.themes || []).flat(1).map(Oa),
    i = new Ia(new La(e.engine, n), r, n, e.langAlias),
    a;
  function o(t) {
    return Fa(t, e.langAlias);
  }
  function s(e) {
    g();
    let t = i.getGrammar(typeof e == `string` ? e : e.name);
    if (!t) throw new Pa(`Language \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function c(e) {
    if (e === `none`) return { bg: ``, fg: ``, name: `none`, settings: [], type: `dark` };
    g();
    let t = i.getTheme(e);
    if (!t) throw new Pa(`Theme \`${e}\` not found, you may need to load it first`);
    return t;
  }
  function l(e) {
    g();
    let t = c(e);
    return (a !== e && (i.setTheme(t), (a = e)), { theme: t, colorMap: i.getColorMap() });
  }
  function u() {
  ...
  async function h(...e) {
    return (g(), m(await Aa(e)));
  }
  function g() {
    if (t) throw new Pa(`Shiki instance has been disposed`);
  }
  function _() {
    t || ((t = !0), i.dispose(), --Ra);
  }
...
async function Ba(e) {
  ...
  let [t, n, r] = await Promise.all([Aa(e.themes || []), ka(e.langs || []), e.engine]);
  return za({ ...e, themes: t, langs: n, engine: r });
}
async function Va(e) {
  let t = await Ba(e);
  return {
    getLastGrammarState: (...e) => oa(t, ...e),
    codeToTokensBase: (e, n) => aa(t, e, n),
    codeToTokensWithThemes: (e, n) => ma(t, e, n),
    codeToTokens: (e, n) => ga(t, e, n),
    codeToHast: (e, n) => va(t, e, n),
    codeToHtml: (e, n) => wa(t, e, n),
    getBundledLanguages: () => ({}),
    getBundledThemes: () => ({}),
    ...t,
...
function Ha(e) {
  ...
  async function i(e) {
    function i(n) {
      if (typeof n == `string`) {
        if (((n = e.langAlias?.[n] || n), Si(n))) return [];
        let r = t[n];
        if (!r)
          throw new k(
    ...
    let o = (e.themes ?? []).map((e) => a(e)),
      s = (e.langs ?? []).map((e) => i(e)),
      c = await Va({ engine: e.engine ?? r(), ...e, themes: o, langs: s });
    return {
      ...c,
      loadLanguage(...e) {
...
function Ua(e) {
  ...
  async function n(n = {}) {
    if (t) {
      let e = await t;
      return (
        await Promise.all([e.loadTheme(...(n.themes || [])), e.loadLanguage(...(n.langs || []))]),
        e
      );
    } else {
      t = e({ ...n, themes: [], langs: [] });
      let r = await t;
      return (
        await Promise.all([r.loadTheme(...(n.themes || [])), r.loadLanguage(...(n.langs || []))]),
        r
      );
    }
  }
...
function Wa(e, t) {
  ...
  return {
    ...
    async getLastGrammarState(e, t) {
      return (await n({ langs: [t.lang], themes: [t.theme] })).getLastGrammarState(e, t);
    },
  };
}
var Ga = [
    {
      id: `abap`,
      name: `ABAP`,
      import: () => i(() => import(`./abap-D5_ylgtk.js`), [], import.meta.url),
    },
    {
      id: `actionscript-3`,
      name: `ActionScript`,
      import: () => i(() => import(`./actionscript-3-D3G7yyR7.js`), [], import.meta.url),
    },
    {
      id: `ada`,
      name: `Ada`,
      import: () => i(() => import(`./ada-BFYGSlGD.js`), [], import.meta.url),
    },
    {
      id: `angular-html`,
      name: `Angular HTML`,
      import: () =>
        i(
          () => import(`./angular-html-BJW1IG_l.js`),
    ...
    },
    {
      ...
      import: () =>
        i(
          () => import(`./angular-ts-DBXr3XRo.js`),
          __vite__mapDeps([5, 1, 2, 3, 4, 6]),
          import.meta.url,
        ),
    },
    {
      id: `apache`,
      name: `Apache Conf`,
      import: () => i(() => import(`./apache-CrAJ59fd.js`), [], import.meta.url),
    },
    {
      id: `apex`,
      name: `Apex`,
      import: () => i(() => import(`./apex-5bpClyQK.js`), [], import.meta.url),
    },
    {
      id: `apl`,
      name: `APL`,
      import: () =>
        i(
          () => import(`./apl-Gpsr7ASY.js`),
          __vite__mapDeps([7, 3, 2, 4, 8, 9, 10]),
          import.meta.url,
        ),
    },
    {
      id: `applescript`,
      name: `AppleScript`,
      import: () => i(() => import(`./applescript-CtfTzYaE.js`), [], import.meta.url),
    },
    {
      id: `ara`,
      name: `Ara`,
      import: () => i(() => import(`./ara-DLQkgsxJ.js`), [], import.meta.url),
    },
    {
      id: `asciidoc`,
      name: `AsciiDoc`,
      aliases: [`adoc`],
      import: () => i(() => import(`./asciidoc-BTOjk01X.js`), [], import.meta.url),
    },
    {
      id: `asm`,
      name: `Assembly`,
      import: () => i(() => import(`./asm-CWdkdBNj.js`), [], import.meta.url),
    },
    {
      id: `astro`,
      name: `Astro`,
      import: () =>
        i(
          () => import(`./astro-pSGtNPGF.js`),
          __vite__mapDeps([11, 3, 4, 8, 12, 13, 14]),
          import.meta.url,
        ),
    },
    {
      id: `awk`,
      name: `AWK`,
      import: () => i(() => import(`./awk-DCJvSafa.js`), [], import.meta.url),
    },
    {
      id: `ballerina`,
      name: `Ballerina`,
      import: () => i(() => import(`./ballerina-D2LUO7sC.js`), [], import.meta.url),
    },
    {
      id: `bat`,
      name: `Batch File`,
      aliases: [`batch`],
      import: () => i(() => import(`./bat-isYNTu3k.js`), [], import.meta.url),
    },
    {
      id: `beancount`,
      name: `Beancount`,
      import: () => i(() => import(`./beancount-GXdesrah.js`), [], import.meta.url),
    },
    {
      id: `berry`,
      name: `Berry`,
      aliases: [`be`],
      import: () => i(() => import(`./berry-DRdyRYkQ.js`), [], import.meta.url),
    },
    {
      id: `bibtex`,
      name: `BibTeX`,
      import: () => i(() => import(`./bibtex-78KU1hqv.js`), [], import.meta.url),
    },
    {
      id: `bicep`,
      name: `Bicep`,
      import: () => i(() => import(`./bicep-vNjhA8b6.js`), [], import.meta.url),
    },
    {
      id: `blade`,
      name: `Blade`,
      import: () =>
        i(
          () => import(`./blade-lpVLBxdB.js`),
          __vite__mapDeps([15, 3, 16, 2, 4, 8, 17, 9, 10]),
          import.meta.url,
        ),
    },
    {
      ...
      aliases: [`1c`],
      import: () =>
        i(() => import(`./bsl-BDRpQZ-v.js`), __vite__mapDeps([18, 19]), import.meta.url),
    },
    {
      id: `c`,
      name: `C`,
      import: () => i(() => import(`./c-Cgl9NOy1.js`), __vite__mapDeps([20, 21]), import.meta.url),
    },
    {
      id: `cadence`,
      name: `Cadence`,
      aliases: [`cdc`],
      import: () => i(() => import(`./cadence-D7foZ_Ga.js`), [], import.meta.url),
    },
    {
      id: `cairo`,
      name: `Cairo`,
      import: () =>
        i(() => import(`./cairo-Dt0Xx6dw.js`), __vite__mapDeps([22, 23]), import.meta.url),
    },
    {
      id: `clarity`,
      name: `Clarity`,
      import: () => i(() => import(`./clarity-CYxZJGxx.js`), [], import.meta.url),
    },
    {
      id: `clojure`,
      name: `Clojure`,
      aliases: [`clj`],
      import: () => i(() => import(`./clojure-DFZjnfFM.js`), [], import.meta.url),
    },
    {
      id: `cmake`,
      name: `CMake`,
      import: () =>
        i(() => import(`./cmake-B1o5nWxZ.js`), __vite__mapDeps([24, 25]), import.meta.url),
    },
    {
      id: `cobol`,
      name: `COBOL`,
      import: () =>
        i(() => import(`./cobol-CJi13L01.js`), __vite__mapDeps([26, 2, 3, 4, 10]), import.meta.url),
    },
    {
      id: `codeowners`,
      name: `CODEOWNERS`,
      import: () => i(() => import(`./codeowners-DztuVoSi.js`), [], import.meta.url),
    },
    {
      id: `codeql`,
      name: `CodeQL`,
      aliases: [`ql`],
      import: () => i(() => import(`./codeql-_GpsaOoe.js`), [], import.meta.url),
    },
    {
      id: `coffee`,
      name: `CoffeeScript`,
      ...
      import: () =>
        i(() => import(`./coffee-4316FaFJ.js`), __vite__mapDeps([27, 4]), import.meta.url),
    },
    {
      id: `common-lisp`,
      name: `Common Lisp`,
      aliases: [`lisp`],
      import: () => i(() => import(`./common-lisp-BCxcZb6M.js`), [], import.meta.url),
    },
    {
      id: `coq`,
      name: `Coq`,
      import: () => i(() => import(`./coq-a5kRJC8D.js`), [], import.meta.url),
    },
    {
      id: `cpp`,
      name: `C++`,
      ...
      import: () =>
        i(
          () => import(`./cpp-BHImCK0X.js`),
          __vite__mapDeps([28, 29, 30, 21, 31, 17]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./crystal-ypxk1Onj.js`),
          __vite__mapDeps([32, 21, 3, 2, 4, 33, 17]),
          import.meta.url,
        ),
    },
    {
      ...
      aliases: [`c#`, `cs`],
      import: () =>
        i(() => import(`./csharp-CWilEuiE.js`), __vite__mapDeps([34, 35]), import.meta.url),
    },
    {
      id: `css`,
      name: `CSS`,
      import: () => i(() => import(`./css-CqJS87cp.js`), __vite__mapDeps([36, 3]), import.meta.url),
    },
    {
      id: `csv`,
      name: `CSV`,
      import: () =>
        i(() => import(`./csv-CKgLTKZI.js`), __vite__mapDeps([37, 38]), import.meta.url),
    },
    {
      id: `cue`,
      name: `CUE`,
      import: () => i(() => import(`./cue-DnRuyPIw.js`), [], import.meta.url),
    },
    {
      id: `cypher`,
      name: `Cypher`,
      aliases: [`cql`],
      import: () => i(() => import(`./cypher-CuYtXypX.js`), [], import.meta.url),
    },
    { id: `d`, name: `D`, import: () => i(() => import(`./d-L376HX-T.js`), [], import.meta.url) },
    {
      id: `dart`,
      name: `Dart`,
      import: () => i(() => import(`./dart-BU5P9H8E.js`), [], import.meta.url),
    },
    {
      id: `dax`,
      name: `DAX`,
      import: () => i(() => import(`./dax-C9D1660i.js`), [], import.meta.url),
    },
    {
      id: `desktop`,
      name: `Desktop`,
      import: () => i(() => import(`./desktop-if3ABaVh.js`), [], import.meta.url),
    },
    {
      id: `diff`,
      name: `Diff`,
      import: () =>
        i(() => import(`./diff-CCaFb5HW.js`), __vite__mapDeps([39, 40]), import.meta.url),
    },
    {
      id: `docker`,
      name: `Dockerfile`,
      aliases: [`dockerfile`],
      import: () => i(() => import(`./docker-Cb6u5s2o.js`), [], import.meta.url),
    },
    {
      id: `dotenv`,
      name: `dotEnv`,
      import: () => i(() => import(`./dotenv-UgD3IKAc.js`), [], import.meta.url),
    },
    {
      id: `dream-maker`,
      name: `Dream Maker`,
      import: () => i(() => import(`./dream-maker-BI_BF6t3.js`), [], import.meta.url),
    },
    {
      id: `edge`,
      name: `Edge`,
      import: () =>
        i(
          () => import(`./edge-CiC63D1b.js`),
          __vite__mapDeps([41, 16, 2, 3, 4, 14]),
          import.meta.url,
        ),
    },
    {
      ...
      name: `Elixir`,
      import: () =>
        i(() => import(`./elixir-5ezRnAB3.js`), __vite__mapDeps([42, 2, 3, 4]), import.meta.url),
    },
    {
      id: `elm`,
      name: `Elm`,
      import: () =>
        i(() => import(`./elm-BcZaIxmt.js`), __vite__mapDeps([43, 30, 21]), import.meta.url),
    },
    {
      id: `emacs-lisp`,
      name: `Emacs Lisp`,
      aliases: [`elisp`],
      import: () => i(() => import(`./emacs-lisp-BHfkYRKs.js`), [], import.meta.url),
    },
    {
      id: `erb`,
      name: `ERB`,
      import: () =>
        i(
          () => import(`./erb-CIgUe-Bp.js`),
          __vite__mapDeps([
            44, 2, 3, 4, 45, 21, 29, 30, 31, 17, 46, 47, 13, 14, 48, 49, 33, 9, 10, 50,
          ]),
          import.meta.url,
        ),
    },
    {
      ...
      aliases: [`erl`],
      import: () =>
        i(() => import(`./erlang-BA7sfO2u.js`), __vite__mapDeps([51, 52]), import.meta.url),
    },
    {
      id: `fennel`,
      name: `Fennel`,
      import: () => i(() => import(`./fennel-CT0YUTHs.js`), [], import.meta.url),
    },
    {
      id: `fish`,
      name: `Fish`,
      import: () => i(() => import(`./fish-DHp6yl4_.js`), [], import.meta.url),
    },
    {
      id: `fluent`,
      name: `Fluent`,
      aliases: [`ftl`],
      import: () => i(() => import(`./fluent-CCikV1o2.js`), [], import.meta.url),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./fortran-fixed-form-DoY9RUzc.js`),
          __vite__mapDeps([53, 54]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./fortran-free-form-Cy9V1dhz.js`),
          __vite__mapDeps([55, 54]),
          import.meta.url,
        ),
    },
    {
      ...
      aliases: [`f#`, `fs`],
      import: () =>
        i(() => import(`./fsharp-BiixXeew.js`), __vite__mapDeps([56, 52]), import.meta.url),
    },
    {
      id: `gdresource`,
      name: `GDResource`,
      import: () =>
        i(() => import(`./gdresource-ECBE5gKa.js`), __vite__mapDeps([57, 58, 59]), import.meta.url),
    },
    {
      id: `gdscript`,
      name: `GDScript`,
      import: () =>
        i(() => import(`./gdscript-Bjd9kQ5Z.js`), __vite__mapDeps([60, 58]), import.meta.url),
    },
    {
      id: `gdshader`,
      name: `GDShader`,
      import: () =>
        i(() => import(`./gdshader-bJQCawwE.js`), __vite__mapDeps([61, 59]), import.meta.url),
    },
    {
      id: `genie`,
      name: `Genie`,
      import: () => i(() => import(`./genie-BFNn23LG.js`), [], import.meta.url),
    },
    {
      id: `gherkin`,
      name: `Gherkin`,
      import: () => i(() => import(`./gherkin-2F0Hux6H.js`), [], import.meta.url),
    },
    {
      id: `git-commit`,
      name: `Git Commit Message`,
      import: () =>
        i(() => import(`./git-commit-9y_AzOom.js`), __vite__mapDeps([62, 40]), import.meta.url),
    },
    {
      id: `git-rebase`,
      name: `Git Rebase Message`,
      import: () =>
        i(() => import(`./git-rebase-W8z1S5vo.js`), __vite__mapDeps([63, 33]), import.meta.url),
    },
    {
      id: `gleam`,
      name: `Gleam`,
      import: () => i(() => import(`./gleam-8BzUcftR.js`), [], import.meta.url),
    },
    {
      id: `glimmer-js`,
      name: `Glimmer JS`,
      ...
      import: () =>
        i(
          () => import(`./glimmer-js-BRQJtHn9.js`),
          __vite__mapDeps([64, 3, 2, 4, 14]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./glimmer-ts-BSzNXypd.js`),
          __vite__mapDeps([65, 3, 2, 4, 14]),
          import.meta.url,
        ),
    },
    {
      ...
      name: `GLSL`,
      import: () =>
        i(() => import(`./glsl-Ce1vkC0W.js`), __vite__mapDeps([66, 30, 21]), import.meta.url),
    },
    {
      id: `gnuplot`,
      name: `Gnuplot`,
      import: () => i(() => import(`./gnuplot-CD1ZEmek.js`), [], import.meta.url),
    },
    {
      id: `go`,
      name: `Go`,
      import: () => i(() => import(`./go-oLYzpzyy.js`), __vite__mapDeps([67, 68]), import.meta.url),
    },
    {
      id: `graphql`,
      name: `GraphQL`,
      ...
      import: () =>
        i(
          () => import(`./graphql-CoPuTGT-.js`),
          __vite__mapDeps([69, 46, 4, 47, 13, 14]),
          import.meta.url,
        ),
    },
    {
      id: `groovy`,
      name: `Groovy`,
      import: () => i(() => import(`./groovy-C4G7ngjZ.js`), [], import.meta.url),
    },
    {
      id: `hack`,
      name: `Hack`,
      import: () =>
        i(() => import(`./hack-B2y7Pnx-.js`), __vite__mapDeps([70, 2, 3, 4, 17]), import.meta.url),
    },
    {
      id: `haml`,
      name: `Ruby Haml`,
      import: () =>
        i(() => import(`./haml-ChUjaWlP.js`), __vite__mapDeps([71, 48, 3, 4]), import.meta.url),
    },
    {
      id: `handlebars`,
      name: `Handlebars`,
      ...
      import: () =>
        i(
          () => import(`./handlebars-CCDqg4C_.js`),
          __vite__mapDeps([72, 3, 2, 4, 50]),
          import.meta.url,
        ),
    },
    {
      ...
      name: `Haskell`,
      aliases: [`hs`],
      import: () => i(() => import(`./haskell-B_S3iP8v.js`), [], import.meta.url),
    },
    {
      id: `haxe`,
      name: `Haxe`,
      import: () =>
        i(() => import(`./haxe-BNRcm70V.js`), __vite__mapDeps([73, 74]), import.meta.url),
    },
    {
      id: `hcl`,
      name: `HashiCorp HCL`,
      import: () => i(() => import(`./hcl-CMYU1vnV.js`), [], import.meta.url),
    },
    {
      id: `hjson`,
      name: `Hjson`,
      import: () => i(() => import(`./hjson-CODMlcFg.js`), [], import.meta.url),
    },
    {
      id: `hlsl`,
      name: `HLSL`,
      import: () =>
        i(() => import(`./hlsl-Cnsn84x3.js`), __vite__mapDeps([75, 76]), import.meta.url),
    },
    {
      id: `html`,
      name: `HTML`,
      import: () =>
        i(() => import(`./html-BmwywfOM.js`), __vite__mapDeps([77, 2, 3, 4]), import.meta.url),
    },
    {
      id: `html-derivative`,
      ...
      import: () =>
        i(
          () => import(`./html-derivative-CFdrR7Bk.js`),
          __vite__mapDeps([78, 16, 2, 3, 4]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./http-Da7n24Hh.js`),
          __vite__mapDeps([79, 46, 4, 47, 13, 14, 8, 33, 9, 10]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./hurl-BPuq-Olo.js`),
          __vite__mapDeps([80, 38, 46, 4, 47, 13, 14, 9, 10]),
          import.meta.url,
        ),
    },
    {
      ...
      name: `HXML`,
      import: () =>
        i(() => import(`./hxml-BxzD8h1g.js`), __vite__mapDeps([81, 74]), import.meta.url),
    },
    {
      id: `hy`,
      name: `Hy`,
      import: () => i(() => import(`./hy-DnRpxtSp.js`), [], import.meta.url),
    },
    {
      id: `imba`,
      name: `Imba`,
      import: () => i(() => import(`./imba-sCInZGzW.js`), [], import.meta.url),
    },
    {
      id: `ini`,
      name: `INI`,
      aliases: [`properties`],
      import: () => i(() => import(`./ini-DqXb22fh.js`), [], import.meta.url),
    },
    {
      id: `java`,
      name: `Java`,
      import: () =>
        i(() => import(`./java-Dti2GZzj.js`), __vite__mapDeps([82, 10]), import.meta.url),
    },
    {
      id: `javascript`,
      name: `JavaScript`,
      aliases: [`js`, `cjs`, `mjs`],
      import: () =>
        i(() => import(`./javascript-tXs_xOzz.js`), __vite__mapDeps([83, 4]), import.meta.url),
    },
    {
      id: `jinja`,
      name: `Jinja`,
      import: () =>
        i(() => import(`./jinja-CNIxSlHU.js`), __vite__mapDeps([84, 2, 3, 4]), import.meta.url),
    },
    {
      id: `jison`,
      name: `Jison`,
      import: () =>
        i(() => import(`./jison-mmxCF1CJ.js`), __vite__mapDeps([85, 4]), import.meta.url),
    },
    {
      id: `json`,
      name: `JSON`,
      import: () =>
        i(() => import(`./json-DDDAODHP.js`), __vite__mapDeps([86, 8]), import.meta.url),
    },
    {
      id: `json5`,
      name: `JSON5`,
      import: () => i(() => import(`./json5-CXVyrZMa.js`), [], import.meta.url),
    },
    {
      id: `jsonc`,
      name: `JSON with Comments`,
      import: () => i(() => import(`./jsonc-QtsdGr-L.js`), [], import.meta.url),
    },
    {
      id: `jsonl`,
      name: `JSON Lines`,
      import: () => i(() => import(`./jsonl-gdbevu_X.js`), [], import.meta.url),
    },
    {
      id: `jsonnet`,
      name: `Jsonnet`,
      import: () => i(() => import(`./jsonnet-B7Kai4eK.js`), [], import.meta.url),
    },
    {
      id: `jssm`,
      name: `JSSM`,
      aliases: [`fsl`],
      import: () => i(() => import(`./jssm-dvTZHFqu.js`), [], import.meta.url),
    },
    {
      id: `jsx`,
      name: `JSX`,
      import: () =>
        i(() => import(`./jsx-PdcVG1c_.js`), __vite__mapDeps([87, 47]), import.meta.url),
    },
    {
      id: `julia`,
      name: `Julia`,
      ...
      import: () =>
        i(
          () => import(`./julia-DNMj7TB2.js`),
          __vite__mapDeps([88, 29, 30, 21, 31, 17, 4, 23, 89]),
          import.meta.url,
        ),
    },
    {
      id: `kdl`,
      name: `KDL`,
      import: () => i(() => import(`./kdl-U8bGmIQo.js`), [], import.meta.url),
    },
    {
      id: `kotlin`,
      name: `Kotlin`,
      aliases: [`kt`, `kts`],
      import: () => i(() => import(`./kotlin-Cf62Q-nj.js`), [], import.meta.url),
    },
    {
      id: `kusto`,
      name: `Kusto`,
      aliases: [`kql`],
      import: () => i(() => import(`./kusto-C7xmnq6w.js`), [], import.meta.url),
    },
    {
      id: `latex`,
      name: `LaTeX`,
      import: () =>
        i(() => import(`./latex-Ckq-HaQQ.js`), __vite__mapDeps([90, 91, 89]), import.meta.url),
    },
    {
      id: `lean`,
      name: `Lean 4`,
      aliases: [`lean4`],
      import: () => i(() => import(`./lean-c_rYkb5g.js`), [], import.meta.url),
    },
    {
      id: `less`,
      name: `Less`,
      import: () =>
        i(() => import(`./less-CtOMNVlL.js`), __vite__mapDeps([92, 93]), import.meta.url),
    },
    {
      id: `liquid`,
      name: `Liquid`,
      import: () =>
        i(() => import(`./liquid-bUr19Y0W.js`), __vite__mapDeps([94, 3, 2, 4, 8]), import.meta.url),
    },
    {
      id: `llvm`,
      name: `LLVM IR`,
      import: () => i(() => import(`./llvm-BTQpWdrO.js`), [], import.meta.url),
    },
    {
      id: `log`,
      name: `Log file`,
      import: () => i(() => import(`./log-CRP_XN2H.js`), [], import.meta.url),
    },
    {
      id: `logo`,
      name: `Logo`,
      import: () => i(() => import(`./logo-BbWxJgTG.js`), [], import.meta.url),
    },
    {
      id: `lua`,
      name: `Lua`,
      import: () =>
        i(() => import(`./lua-BrHxl5HQ.js`), __vite__mapDeps([95, 49, 21]), import.meta.url),
    },
    {
      id: `luau`,
      name: `Luau`,
      import: () => i(() => import(`./luau-D7pH3f7l.js`), [], import.meta.url),
    },
    {
      id: `make`,
      name: `Makefile`,
      aliases: [`makefile`],
      import: () => i(() => import(`./make-DDeV_SoZ.js`), [], import.meta.url),
    },
    {
      id: `markdown`,
      name: `Markdown`,
      aliases: [`md`],
      import: () =>
        i(() => import(`./markdown-fw3eJobG.js`), __vite__mapDeps([96, 52]), import.meta.url),
    },
    {
      id: `marko`,
      name: `Marko`,
      import: () =>
        i(
          () => import(`./marko-sRILKQqU.js`),
          __vite__mapDeps([97, 3, 93, 6, 14]),
          import.meta.url,
        ),
    },
    {
      id: `matlab`,
      name: `MATLAB`,
      import: () => i(() => import(`./matlab-CbfijV2T.js`), [], import.meta.url),
    },
    {
      id: `mdc`,
      name: `MDC`,
      import: () =>
        i(
          () => import(`./mdc-8iq1w9E4.js`),
          __vite__mapDeps([98, 16, 2, 3, 4, 52, 50]),
          import.meta.url,
        ),
    },
    {
      id: `mdx`,
      name: `MDX`,
      import: () => i(() => import(`./mdx-C3v_fSFZ.js`), [], import.meta.url),
    },
    {
      id: `mermaid`,
      name: `Mermaid`,
      aliases: [`mmd`],
      import: () => i(() => import(`./mermaid-Uws3MkPK.js`), [], import.meta.url),
    },
    {
      id: `mipsasm`,
      name: `MIPS Assembly`,
      aliases: [`mips`],
      import: () => i(() => import(`./mipsasm-BIXc153k.js`), [], import.meta.url),
    },
    {
      id: `mojo`,
      name: `Mojo`,
      import: () => i(() => import(`./mojo-BMmSv2i9.js`), [], import.meta.url),
    },
    {
      id: `move`,
      name: `Move`,
      import: () => i(() => import(`./move-D2RNUi7j.js`), [], import.meta.url),
    },
    {
      id: `narrat`,
      name: `Narrat Language`,
      aliases: [`nar`],
      import: () => i(() => import(`./narrat-VDlT6b86.js`), [], import.meta.url),
    },
    {
      id: `nextflow`,
      name: `Nextflow`,
      aliases: [`nf`],
      import: () => i(() => import(`./nextflow-BkvkAaGN.js`), [], import.meta.url),
    },
    {
      id: `nginx`,
      name: `Nginx`,
      import: () =>
        i(() => import(`./nginx-T_gKTJ2v.js`), __vite__mapDeps([99, 49, 21]), import.meta.url),
    },
    {
      id: `nim`,
      name: `Nim`,
      import: () =>
        i(
          () => import(`./nim-vpc6lnAq.js`),
          __vite__mapDeps([100, 21, 3, 30, 2, 4, 52, 9, 10]),
          import.meta.url,
        ),
    },
    {
      id: `nix`,
      name: `Nix`,
      import: () => i(() => import(`./nix-iw9gVkGV.js`), [], import.meta.url),
    },
    {
      id: `nushell`,
      name: `nushell`,
      aliases: [`nu`],
      import: () => i(() => import(`./nushell-DUzJGZcC.js`), [], import.meta.url),
    },
    {
      id: `objective-c`,
      name: `Objective-C`,
      aliases: [`objc`],
      import: () => i(() => import(`./objective-c-DO3eayTL.js`), [], import.meta.url),
    },
    {
      id: `objective-cpp`,
      name: `Objective-C++`,
      import: () => i(() => import(`./objective-cpp-zU98dLPe.js`), [], import.meta.url),
    },
    {
      id: `ocaml`,
      name: `OCaml`,
      import: () => i(() => import(`./ocaml-E9x-Vkqf.js`), [], import.meta.url),
    },
    {
      id: `openscad`,
      name: `OpenSCAD`,
      aliases: [`scad`],
      import: () => i(() => import(`./openscad-btUu7bIB.js`), [], import.meta.url),
    },
    {
      id: `pascal`,
      name: `Pascal`,
      import: () => i(() => import(`./pascal-DjcbiXBF.js`), [], import.meta.url),
    },
    {
      id: `perl`,
      name: `Perl`,
      import: () =>
        i(
          () => import(`./perl-BJI_PDjg.js`),
          __vite__mapDeps([101, 3, 2, 4, 17, 9, 10]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./php-DRRGm-MU.js`),
          __vite__mapDeps([102, 103, 3, 2, 4, 8, 17, 9, 10]),
          import.meta.url,
        ),
    },
    {
      id: `pkl`,
      name: `Pkl`,
      import: () => i(() => import(`./pkl-CAW5cXET.js`), [], import.meta.url),
    },
    {
      id: `plsql`,
      name: `PL/SQL`,
      import: () => i(() => import(`./plsql-DHzRVmQU.js`), [], import.meta.url),
    },
    {
      id: `po`,
      name: `Gettext PO`,
      aliases: [`pot`, `potx`],
      import: () => i(() => import(`./po-qCMAirBk.js`), [], import.meta.url),
    },
    {
      id: `polar`,
      name: `Polar`,
      import: () => i(() => import(`./polar-D27Kopbe.js`), [], import.meta.url),
    },
    {
      id: `postcss`,
      name: `PostCSS`,
      import: () =>
        i(() => import(`./postcss-d5cs3rtT.js`), __vite__mapDeps([104, 12]), import.meta.url),
    },
    {
      id: `powerquery`,
      name: `PowerQuery`,
      import: () => i(() => import(`./powerquery-9zxXUggH.js`), [], import.meta.url),
    },
    {
      id: `powershell`,
      name: `PowerShell`,
      aliases: [`ps`, `ps1`],
      import: () => i(() => import(`./powershell-Co_Ee-sL.js`), [], import.meta.url),
    },
    {
      id: `prisma`,
      name: `Prisma`,
      import: () => i(() => import(`./prisma-CTQ5_NH8.js`), [], import.meta.url),
    },
    {
      id: `prolog`,
      name: `Prolog`,
      import: () => i(() => import(`./prolog-BbDy_Zv0.js`), [], import.meta.url),
    },
    {
      id: `proto`,
      name: `Protocol Buffer 3`,
      aliases: [`protobuf`],
      import: () => i(() => import(`./proto-B2nqQ7-y.js`), [], import.meta.url),
    },
    {
      id: `pug`,
      name: `Pug`,
      aliases: [`jade`],
      import: () =>
        i(() => import(`./pug-C7Y6vh_L.js`), __vite__mapDeps([105, 3, 2, 4]), import.meta.url),
    },
    {
      id: `puppet`,
      name: `Puppet`,
      import: () => i(() => import(`./puppet-BKCkUeZK.js`), [], import.meta.url),
    },
    {
      id: `purescript`,
      name: `PureScript`,
      import: () => i(() => import(`./purescript-36h3TWIy.js`), [], import.meta.url),
    },
    {
      id: `python`,
      name: `Python`,
      aliases: [`py`],
      import: () =>
        i(() => import(`./python-2B2k9LSp.js`), __vite__mapDeps([106, 23]), import.meta.url),
    },
    {
      id: `qml`,
      name: `QML`,
      import: () =>
        i(() => import(`./qml-CdEt_o2t.js`), __vite__mapDeps([107, 4]), import.meta.url),
    },
    {
      id: `qmldir`,
      name: `QML Directory`,
      import: () => i(() => import(`./qmldir-B4CLaYxm.js`), [], import.meta.url),
    },
    {
      id: `qss`,
      name: `Qt Style Sheets`,
      import: () => i(() => import(`./qss-BaZUUpss.js`), [], import.meta.url),
    },
    {
      id: `r`,
      name: `R`,
      import: () => i(() => import(`./r-DNd7IQE6.js`), __vite__mapDeps([108, 89]), import.meta.url),
    },
    {
      id: `racket`,
      name: `Racket`,
      import: () => i(() => import(`./racket-BAYWSQH2.js`), [], import.meta.url),
    },
    {
      id: `raku`,
      name: `Raku`,
      aliases: [`perl6`],
      import: () => i(() => import(`./raku-CWVuChLv.js`), [], import.meta.url),
    },
    {
      id: `razor`,
      name: `ASP.NET Razor`,
      import: () =>
        i(
          () => import(`./razor-CHWVyl9W.js`),
          __vite__mapDeps([109, 35, 2, 3, 4]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () => i(() => import(`./reg-DWAvrJ5l.js`), [], import.meta.url),
    },
    {
      id: `regexp`,
      name: `RegExp`,
      aliases: [`regex`],
      import: () =>
        i(() => import(`./regexp-BDWyvyyV.js`), __vite__mapDeps([110, 31]), import.meta.url),
    },
    {
      id: `rel`,
      name: `Rel`,
      import: () => i(() => import(`./rel-JqGFIQgu.js`), [], import.meta.url),
    },
    {
      id: `riscv`,
      name: `RISC-V`,
      import: () => i(() => import(`./riscv-CdWrh1JD.js`), [], import.meta.url),
    },
    {
      id: `rosmsg`,
      name: `ROS Interface`,
      import: () => i(() => import(`./rosmsg-CE7dz9Oh.js`), [], import.meta.url),
    },
    {
      id: `rst`,
      ...
      import: () =>
        i(
          () => import(`./rst-DGbqoxTD.js`),
          __vite__mapDeps([
            111, 25, 29, 30, 21, 31, 17, 16, 2, 3, 4, 23, 45, 46, 47, 13, 14, 48, 49, 33, 9, 10, 50,
          ]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./ruby-D1AFyzOg.js`),
          __vite__mapDeps([
            112, 45, 21, 29, 30, 31, 17, 3, 46, 4, 47, 13, 14, 48, 2, 49, 33, 9, 10, 50,
          ]),
          import.meta.url,
        ),
    },
    {
      ...
      name: `Rust`,
      aliases: [`rs`],
      import: () => i(() => import(`./rust-yKvqhHwM.js`), [], import.meta.url),
    },
    {
      id: `sas`,
      name: `SAS`,
      import: () =>
        i(() => import(`./sas-D8TiETVp.js`), __vite__mapDeps([113, 17]), import.meta.url),
    },
    {
      id: `sass`,
      name: `Sass`,
      import: () => i(() => import(`./sass-CJZGvZ7F.js`), [], import.meta.url),
    },
    {
      id: `scala`,
      name: `Scala`,
      import: () => i(() => import(`./scala-DrQrnVTE.js`), [], import.meta.url),
    },
    {
      id: `scheme`,
      name: `Scheme`,
      import: () => i(() => import(`./scheme-De7cAKlR.js`), [], import.meta.url),
    },
    {
      id: `scss`,
      name: `SCSS`,
      import: () =>
        i(() => import(`./scss-yloQ-14U.js`), __vite__mapDeps([114, 6, 3]), import.meta.url),
    },
    {
      id: `sdbl`,
      name: `1C (Query)`,
      aliases: [`1c-query`],
      import: () =>
        i(() => import(`./sdbl-Bynik832.js`), __vite__mapDeps([115, 19]), import.meta.url),
    },
    {
      id: `shaderlab`,
      name: `ShaderLab`,
      aliases: [`shader`],
      import: () =>
        i(() => import(`./shaderlab-CAHyMo3x.js`), __vite__mapDeps([116, 76]), import.meta.url),
    },
    {
      id: `shellscript`,
      name: `Shell`,
      ...
      import: () =>
        i(() => import(`./shellscript-oOdR2m8Z.js`), __vite__mapDeps([117, 33]), import.meta.url),
    },
    {
      id: `shellsession`,
      name: `Shell Session`,
      aliases: [`console`],
      import: () =>
        i(() => import(`./shellsession-BYqD1fpu.js`), __vite__mapDeps([118, 33]), import.meta.url),
    },
    {
      id: `smalltalk`,
      name: `Smalltalk`,
      import: () => i(() => import(`./smalltalk-CPZE8B_0.js`), [], import.meta.url),
    },
    {
      id: `solidity`,
      name: `Solidity`,
      import: () => i(() => import(`./solidity-BZolVd3Q.js`), [], import.meta.url),
    },
    {
      id: `soy`,
      ...
      import: () =>
        i(() => import(`./soy-DjiKDI-Q.js`), __vite__mapDeps([119, 2, 3, 4]), import.meta.url),
    },
    {
      id: `sparql`,
      name: `SPARQL`,
      import: () =>
        i(() => import(`./sparql-ORoNih1N.js`), __vite__mapDeps([120, 121]), import.meta.url),
    },
    {
      id: `splunk`,
      name: `Splunk Query Language`,
      aliases: [`spl`],
      import: () => i(() => import(`./splunk-BmDmUJwZ.js`), [], import.meta.url),
    },
    {
      id: `sql`,
      name: `SQL`,
      import: () =>
        i(() => import(`./sql-XL_NCIfZ.js`), __vite__mapDeps([122, 17]), import.meta.url),
    },
    {
      id: `ssh-config`,
      name: `SSH Config`,
      import: () => i(() => import(`./ssh-config-Cal4sx8P.js`), [], import.meta.url),
    },
    {
      id: `stata`,
      name: `Stata`,
      import: () =>
        i(() => import(`./stata-cgn1xotO.js`), __vite__mapDeps([123, 17]), import.meta.url),
    },
    {
      id: `stylus`,
      name: `Stylus`,
      aliases: [`styl`],
      import: () =>
        i(() => import(`./stylus-H3xxBRpp.js`), __vite__mapDeps([124, 125]), import.meta.url),
    },
    {
      id: `svelte`,
      name: `Svelte`,
      import: () =>
        i(
          () => import(`./svelte-BppvB1tF.js`),
          __vite__mapDeps([126, 3, 4, 12, 14]),
          import.meta.url,
        ),
    },
    {
      id: `swift`,
      name: `Swift`,
      import: () => i(() => import(`./swift-B14QxTfU.js`), [], import.meta.url),
    },
    {
      id: `system-verilog`,
      name: `SystemVerilog`,
      import: () => i(() => import(`./system-verilog-lJNLv9wX.js`), [], import.meta.url),
    },
    {
      id: `systemd`,
      name: `Systemd Units`,
      import: () => i(() => import(`./systemd-DsksDBhn.js`), [], import.meta.url),
    },
    {
      id: `talonscript`,
      name: `TalonScript`,
      aliases: [`talon`],
      import: () => i(() => import(`./talonscript-CB5vRWwk.js`), [], import.meta.url),
    },
    {
      id: `tasl`,
      name: `Tasl`,
      import: () => i(() => import(`./tasl-sHjFylzg.js`), [], import.meta.url),
    },
    {
      id: `tcl`,
      name: `Tcl`,
      import: () => i(() => import(`./tcl-Cihev_yw.js`), [], import.meta.url),
    },
    {
      id: `templ`,
      name: `Templ`,
      import: () =>
        i(() => import(`./templ-B-lcn0gd.js`), __vite__mapDeps([127, 3, 68, 4]), import.meta.url),
    },
    {
      id: `terraform`,
      name: `Terraform`,
      aliases: [`tf`, `tfvars`],
      import: () => i(() => import(`./terraform-CXsxpb4z.js`), [], import.meta.url),
    },
    {
      id: `tex`,
      name: `TeX`,
      import: () =>
        i(() => import(`./tex-D6cks7T_.js`), __vite__mapDeps([128, 91, 89]), import.meta.url),
    },
    {
      id: `toml`,
      name: `TOML`,
      import: () => i(() => import(`./toml-C4CPMfGx.js`), [], import.meta.url),
    },
    {
      id: `ts-tags`,
      ...
      import: () =>
        i(
          () => import(`./ts-tags-CKn4OSxR.js`),
          __vite__mapDeps([129, 3, 30, 21, 2, 4, 17, 14, 9, 10]),
          import.meta.url,
        ),
    },
    {
      id: `tsv`,
      name: `TSV`,
      import: () => i(() => import(`./tsv-D4aufiDD.js`), [], import.meta.url),
    },
    {
      id: `tsx`,
      name: `TSX`,
      import: () =>
        i(() => import(`./tsx-0JX2-cXr.js`), __vite__mapDeps([130, 13]), import.meta.url),
    },
    {
      id: `turtle`,
      name: `Turtle`,
      import: () =>
        i(() => import(`./turtle-BvC33mf_.js`), __vite__mapDeps([131, 121]), import.meta.url),
    },
    {
      id: `twig`,
      name: `Twig`,
      import: () =>
        i(
          () => import(`./twig-_74eRPwV.js`),
          __vite__mapDeps([
            132, 3, 4, 103, 2, 8, 17, 9, 10, 23, 45, 21, 29, 30, 31, 46, 47, 13, 14, 48, 49, 33, 50,
            6,
          ]),
          import.meta.url,
        ),
    },
    {
      ...
      aliases: [`ts`, `cts`, `mts`],
      import: () =>
        i(() => import(`./typescript-Zgr1L7v7.js`), __vite__mapDeps([133, 14]), import.meta.url),
    },
    {
      id: `typespec`,
      name: `TypeSpec`,
      aliases: [`tsp`],
      import: () => i(() => import(`./typespec-DQrRgkCg.js`), [], import.meta.url),
    },
    {
      id: `typst`,
      name: `Typst`,
      aliases: [`typ`],
      import: () => i(() => import(`./typst-DZMp9ziY.js`), [], import.meta.url),
    },
    { id: `v`, name: `V`, import: () => i(() => import(`./v-kVKTPcYn.js`), [], import.meta.url) },
    {
      id: `vala`,
      name: `Vala`,
      import: () => i(() => import(`./vala-Cm1rcUgC.js`), [], import.meta.url),
    },
    {
      id: `vb`,
      name: `Visual Basic`,
      aliases: [`cmd`],
      import: () => i(() => import(`./vb-C2QSjIcr.js`), [], import.meta.url),
    },
    {
      id: `verilog`,
      name: `Verilog`,
      import: () => i(() => import(`./verilog-zSIzBIPX.js`), [], import.meta.url),
    },
    {
      id: `vhdl`,
      name: `VHDL`,
      import: () => i(() => import(`./vhdl-B3Omo881.js`), [], import.meta.url),
    },
    {
      id: `viml`,
      name: `Vim Script`,
      aliases: [`vim`, `vimscript`],
      import: () => i(() => import(`./viml-D2set7e5.js`), [], import.meta.url),
    },
    {
      id: `vue`,
      name: `Vue`,
      import: () =>
        i(
          () => import(`./vue-BrqqWTir.js`),
          __vite__mapDeps([134, 135, 3, 16, 2, 4, 8, 14]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./vue-html-DxRvlH1N.js`),
          __vite__mapDeps([136, 4, 135, 3, 16, 2, 8, 14]),
          import.meta.url,
        ),
    },
    {
      ...
      import: () =>
        i(
          () => import(`./vue-vine-DJ587nW1.js`),
          __vite__mapDeps([137, 3, 4, 93, 135, 16, 2, 8, 14, 12, 6, 125]),
          import.meta.url,
        ),
    },
    {
      ...
      name: `Vyper`,
      aliases: [`vy`],
      import: () => i(() => import(`./vyper-UXk-oIIa.js`), [], import.meta.url),
    },
    {
      id: `wasm`,
      name: `WebAssembly`,
      import: () => i(() => import(`./wasm-CjYS5Ika.js`), [], import.meta.url),
    },
    {
      id: `wenyan`,
      name: `Wenyan`,
      aliases: [`文言`],
      import: () => i(() => import(`./wenyan-DxeVNnOt.js`), [], import.meta.url),
    },
    {
      id: `wgsl`,
      name: `WGSL`,
      import: () => i(() => import(`./wgsl-u_aMrJdS.js`), [], import.meta.url),
    },
    {
      id: `wikitext`,
      name: `Wikitext`,
      aliases: [`mediawiki`, `wiki`],
      import: () => i(() => import(`./wikitext-BCV_qnAA.js`), [], import.meta.url),
    },
    {
      id: `wit`,
      name: `WebAssembly Interface Types`,
      import: () => i(() => import(`./wit-B9eLmQFs.js`), [], import.meta.url),
    },
    {
      id: `wolfram`,
      name: `Wolfram`,
      aliases: [`wl`],
      import: () => i(() => import(`./wolfram-CVpgTmBC.js`), [], import.meta.url),
    },
    {
      id: `xml`,
      name: `XML`,
      import: () =>
        i(() => import(`./xml-BQzzxnIi.js`), __vite__mapDeps([138, 9, 10]), import.meta.url),
    },
    {
      id: `xsl`,
      name: `XSL`,
      import: () =>
        i(() => import(`./xsl-BtbsBVRY.js`), __vite__mapDeps([139, 9, 10]), import.meta.url),
    },
    {
      id: `yaml`,
      name: `YAML`,
      aliases: [`yml`],
      import: () =>
        i(() => import(`./yaml-Bbz7tr1d.js`), __vite__mapDeps([140, 50]), import.meta.url),
    },
    {
      id: `zenscript`,
      name: `ZenScript`,
      import: () => i(() => import(`./zenscript-ClWqegPg.js`), [], import.meta.url),
    },
    {
      id: `zig`,
      name: `Zig`,
      import: () => i(() => import(`./zig-B9u1oIfl.js`), [], import.meta.url),
    },
  ],
  Ka = Object.fromEntries(Ga.map((e) => [e.id, e.import])),
  qa = Object.fromEntries(Ga.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])),
  Ja = { ...Ka, ...qa },
    ...
    [
      {
        ...
        type: `dark`,
        import: () => i(() => import(`./andromeeda-BPZrskSC.js`), [], import.meta.url),
      },
      {
        id: `aurora-x`,
        displayName: `Aurora X`,
        type: `dark`,
        import: () => i(() => import(`./aurora-x-FcR6oJ22.js`), [], import.meta.url),
      },
      {
        id: `ayu-dark`,
        displayName: `Ayu Dark`,
        type: `dark`,
        import: () => i(() => import(`./ayu-dark-DVHz1Xcs.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-frappe`,
        displayName: `Catppuccin Frappé`,
        type: `dark`,
        import: () => i(() => import(`./catppuccin-frappe-DLeXvR-K.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-latte`,
        displayName: `Catppuccin Latte`,
        type: `light`,
        import: () => i(() => import(`./catppuccin-latte-BmnCWDsy.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-macchiato`,
        displayName: `Catppuccin Macchiato`,
        type: `dark`,
        import: () => i(() => import(`./catppuccin-macchiato-DFDPoOFt.js`), [], import.meta.url),
      },
      {
        id: `catppuccin-mocha`,
        displayName: `Catppuccin Mocha`,
        type: `dark`,
        import: () => i(() => import(`./catppuccin-mocha-BsJ4O4gF.js`), [], import.meta.url),
      },
      {
        id: `dark-plus`,
        displayName: `Dark Plus`,
        type: `dark`,
        import: () => i(() => import(`./dark-plus-DZAlW5b6.js`), [], import.meta.url),
      },
      {
        id: `dracula`,
        displayName: `Dracula Theme`,
        type: `dark`,
        import: () => i(() => import(`./dracula-Br9gQIcm.js`), [], import.meta.url),
      },
      {
        id: `dracula-soft`,
        displayName: `Dracula Theme Soft`,
        type: `dark`,
        import: () => i(() => import(`./dracula-soft-C1DW0-Iq.js`), [], import.meta.url),
      },
      {
        id: `everforest-dark`,
        displayName: `Everforest Dark`,
        type: `dark`,
        import: () => i(() => import(`./everforest-dark-DkLZmW6Z.js`), [], import.meta.url),
      },
      {
        id: `everforest-light`,
        displayName: `Everforest Light`,
        type: `light`,
        import: () => i(() => import(`./everforest-light-IjsJxGUT.js`), [], import.meta.url),
      },
      {
        id: `github-dark`,
        displayName: `GitHub Dark`,
        type: `dark`,
        import: () => i(() => import(`./github-dark-DXAnu09K.js`), [], import.meta.url),
      },
      {
        id: `github-dark-default`,
        displayName: `GitHub Dark Default`,
        type: `dark`,
        import: () => i(() => import(`./github-dark-default-DfuY614_.js`), [], import.meta.url),
      },
      {
        id: `github-dark-dimmed`,
        displayName: `GitHub Dark Dimmed`,
        type: `dark`,
        import: () => i(() => import(`./github-dark-dimmed-BTU76fj3.js`), [], import.meta.url),
      },
      {
        ...
        type: `dark`,
        import: () =>
          i(() => import(`./github-dark-high-contrast-DDUIvYA2.js`), [], import.meta.url),
      },
      {
        id: `github-light`,
        displayName: `GitHub Light`,
        type: `light`,
        import: () => i(() => import(`./github-light-BDWWsZop.js`), [], import.meta.url),
      },
      {
        id: `github-light-default`,
        displayName: `GitHub Light Default`,
        type: `light`,
        import: () => i(() => import(`./github-light-default-0twG4T8P.js`), [], import.meta.url),
      },
      {
        ...
        type: `light`,
        import: () =>
          i(() => import(`./github-light-high-contrast-C_styKVr.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-dark-hard`,
        displayName: `Gruvbox Dark Hard`,
        type: `dark`,
        import: () => i(() => import(`./gruvbox-dark-hard-DFefn52B.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-dark-medium`,
        displayName: `Gruvbox Dark Medium`,
        type: `dark`,
        import: () => i(() => import(`./gruvbox-dark-medium-CBDOVFxJ.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-dark-soft`,
        displayName: `Gruvbox Dark Soft`,
        type: `dark`,
        import: () => i(() => import(`./gruvbox-dark-soft-D0zKncEV.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-light-hard`,
        displayName: `Gruvbox Light Hard`,
        type: `light`,
        import: () => i(() => import(`./gruvbox-light-hard-DnoiGCQ5.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-light-medium`,
        displayName: `Gruvbox Light Medium`,
        type: `light`,
        import: () => i(() => import(`./gruvbox-light-medium-Fl8po7pB.js`), [], import.meta.url),
      },
      {
        id: `gruvbox-light-soft`,
        displayName: `Gruvbox Light Soft`,
        type: `light`,
        import: () => i(() => import(`./gruvbox-light-soft-CpMdWmZV.js`), [], import.meta.url),
      },
      {
        id: `houston`,
        displayName: `Houston`,
        type: `dark`,
        import: () => i(() => import(`./houston-BqqEJP4-.js`), [], import.meta.url),
      },
      {
        id: `kanagawa-dragon`,
        displayName: `Kanagawa Dragon`,
        type: `dark`,
        import: () => i(() => import(`./kanagawa-dragon-DGRuUQzA.js`), [], import.meta.url),
      },
      {
        id: `kanagawa-lotus`,
        displayName: `Kanagawa Lotus`,
        type: `light`,
        import: () => i(() => import(`./kanagawa-lotus-CXQWuRlX.js`), [], import.meta.url),
      },
      {
        id: `kanagawa-wave`,
        displayName: `Kanagawa Wave`,
        type: `dark`,
        import: () => i(() => import(`./kanagawa-wave-B-KK-IJM.js`), [], import.meta.url),
      },
      {
        id: `laserwave`,
        displayName: `LaserWave`,
        type: `dark`,
        import: () => i(() => import(`./laserwave-C8RfFclF.js`), [], import.meta.url),
      },
      {
        id: `light-plus`,
        displayName: `Light Plus`,
        type: `light`,
        import: () => i(() => import(`./light-plus-Bdw9N-_7.js`), [], import.meta.url),
      },
      {
        id: `material-theme`,
        displayName: `Material Theme`,
        type: `dark`,
        import: () => i(() => import(`./material-theme-BFp9Zt0G.js`), [], import.meta.url),
      },
      {
        id: `material-theme-darker`,
        displayName: `Material Theme Darker`,
        type: `dark`,
        import: () => i(() => import(`./material-theme-darker-CL931DZa.js`), [], import.meta.url),
      },
      {
        id: `material-theme-lighter`,
        displayName: `Material Theme Lighter`,
        type: `light`,
        import: () => i(() => import(`./material-theme-lighter-5I2GC1m8.js`), [], import.meta.url),
      },
      {
        id: `material-theme-ocean`,
        displayName: `Material Theme Ocean`,
        type: `dark`,
        import: () => i(() => import(`./material-theme-ocean-Cjj034ZD.js`), [], import.meta.url),
      },
      {
        ...
        type: `dark`,
        import: () =>
          i(() => import(`./material-theme-palenight-DMBMxN2s.js`), [], import.meta.url),
      },
      {
        id: `min-dark`,
        displayName: `Min Dark`,
        type: `dark`,
        import: () => i(() => import(`./min-dark-BqJ57ykJ.js`), [], import.meta.url),
      },
      {
        id: `min-light`,
        displayName: `Min Light`,
        type: `light`,
        import: () => i(() => import(`./min-light-BG3U3CgU.js`), [], import.meta.url),
      },
      {
        id: `monokai`,
        displayName: `Monokai`,
        type: `dark`,
        import: () => i(() => import(`./monokai-DtrdTKx6.js`), [], import.meta.url),
      },
      {
        id: `night-owl`,
        displayName: `Night Owl`,
        type: `dark`,
        import: () => i(() => import(`./night-owl-B5ncHMUm.js`), [], import.meta.url),
      },
      {
        id: `nord`,
        displayName: `Nord`,
        type: `dark`,
        import: () => i(() => import(`./nord-BYGmyRxE.js`), [], import.meta.url),
      },
      {
        id: `one-dark-pro`,
        displayName: `One Dark Pro`,
        type: `dark`,
        import: () => i(() => import(`./one-dark-pro-BrPdfKrk.js`), [], import.meta.url),
      },
      {
        id: `one-light`,
        displayName: `One Light`,
        type: `light`,
        import: () => i(() => import(`./one-light-BRrvQ6VQ.js`), [], import.meta.url),
      },
      {
        id: `plastic`,
        displayName: `Plastic`,
        type: `dark`,
        import: () => i(() => import(`./plastic-C24saCQT.js`), [], import.meta.url),
      },
      {
        id: `poimandres`,
        displayName: `Poimandres`,
        type: `dark`,
        import: () => i(() => import(`./poimandres-Y97LOEHG.js`), [], import.meta.url),
      },
      {
        id: `red`,
        displayName: `Red`,
        type: `dark`,
        import: () => i(() => import(`./red-gmV84oOQ.js`), [], import.meta.url),
      },
      {
        id: `rose-pine`,
        displayName: `Rosé Pine`,
        type: `dark`,
        import: () => i(() => import(`./rose-pine-DKYkPgyU.js`), [], import.meta.url),
      },
      {
        id: `rose-pine-dawn`,
        displayName: `Rosé Pine Dawn`,
        type: `light`,
        import: () => i(() => import(`./rose-pine-dawn-n8VEGoYx.js`), [], import.meta.url),
      },
      {
        id: `rose-pine-moon`,
        displayName: `Rosé Pine Moon`,
        type: `dark`,
        import: () => i(() => import(`./rose-pine-moon-4O6yPJnN.js`), [], import.meta.url),
      },
      {
        id: `slack-dark`,
        displayName: `Slack Dark`,
        type: `dark`,
        import: () => i(() => import(`./slack-dark-ChFugr_W.js`), [], import.meta.url),
      },
      {
        id: `slack-ochin`,
        displayName: `Slack Ochin`,
        type: `light`,
        import: () => i(() => import(`./slack-ochin-DdWURv3K.js`), [], import.meta.url),
      },
      {
        id: `snazzy-light`,
        displayName: `Snazzy Light`,
        type: `light`,
        import: () => i(() => import(`./snazzy-light-0IuPXq4N.js`), [], import.meta.url),
      },
      {
        id: `solarized-dark`,
        displayName: `Solarized Dark`,
        type: `dark`,
        import: () => i(() => import(`./solarized-dark-BjxChDhb.js`), [], import.meta.url),
      },
      {
        id: `solarized-light`,
        displayName: `Solarized Light`,
        type: `light`,
        import: () => i(() => import(`./solarized-light-9fcylU2j.js`), [], import.meta.url),
      },
      {
        id: `synthwave-84`,
        displayName: `Synthwave '84`,
        type: `dark`,
        import: () => i(() => import(`./synthwave-84-CGyjaJP9.js`), [], import.meta.url),
      },
      {
        id: `tokyo-night`,
        displayName: `Tokyo Night`,
        type: `dark`,
        import: () => i(() => import(`./tokyo-night-CiTH_Xlm.js`), [], import.meta.url),
      },
      {
        id: `vesper`,
        displayName: `Vesper`,
        type: `dark`,
        import: () => i(() => import(`./vesper-YFlxVIca.js`), [], import.meta.url),
      },
      {
        id: `vitesse-black`,
        displayName: `Vitesse Black`,
        type: `dark`,
        import: () => i(() => import(`./vitesse-black-DnH4hxwg.js`), [], import.meta.url),
      },
      {
        id: `vitesse-dark`,
        displayName: `Vitesse Dark`,
        type: `dark`,
        import: () => i(() => import(`./vitesse-dark-CrP4NRPb.js`), [], import.meta.url),
      },
      {
        id: `vitesse-light`,
        displayName: `Vitesse Light`,
        type: `light`,
        import: () => i(() => import(`./vitesse-light-Dbf18TJc.js`), [], import.meta.url),
      },
    ].map((e) => [e.id, e.import]),
  ),
...
async function eo(e) {
  ...
  function s(e) {
    ...
    for (let r = 1; r <= 4; r *= 2) {
      let i = t * (1 + 0.2 / r);
      if (((i = Math.min(i, e + 100663296)), o(Math.min(n, $a(Math.max(e, i), 65536))))) return !0;
    }
    return !1;
  }
...
var to = Object.defineProperty,
  no = (e, t, n) =>
    t in e ? to(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n),
  j = (e, t, n) => no(e, typeof t == `symbol` ? t : t + ``, n),
  M = null;
function ro(e) {
  throw new Xa(e.UTF8ToString(e.getLastOnigError()));
}
var io = class e {
    constructor(t) {
      (j(this, `utf16Length`),
        ...
        j(this, `utf16Value`),
        j(this, `utf8Value`),
        j(this, `utf16OffsetToUtf8`),
        j(this, `utf8OffsetToUtf16`));
      let n = t.length,
          ...
          l <= 127
            ...
            : l <= 2047
              ...
              : l <= 65535
                ...
                : ((o[c + 0] = e), (o[c + 1] = e), (o[c + 2] = e), (o[c + 3] = e))),
          l <= 127
            ? (s[c++] = l)
            : l <= 2047
              ? ((s[c++] = 192 | ((l & 1984) >>> 6)), (s[c++] = 128 | ((l & 63) >>> 0)))
              : l <= 65535
                ? ((s[c++] = 224 | ((l & 61440) >>> 12)),
                  (s[c++] = 128 | ((l & 4032) >>> 6)),
                  (s[c++] = 128 | ((l & 63) >>> 0)))
  ...
  ao = class e {
    constructor(t) {
      if (
        ...
        throw new Xa(`Must invoke loadWasm first.`);
      ((this._onigBinding = M), (this.content = t));
      let n = new io(t);
      ((this.utf16Length = n.utf16Length),
        ...
        this.utf8Length < 1e4 && !e._sharedPtrInUse
          ? ((e._sharedPtr ||= M.omalloc(1e4)),
            (e._sharedPtrInUse = !0),
            M.HEAPU8.set(n.utf8Value, e._sharedPtr),
            (this.ptr = e._sharedPtr))
          : (this.ptr = n.createString(M)));
    }
...
(j(ao, `LAST_ID`, 0), j(ao, `_sharedPtr`, 0), j(ao, `_sharedPtrInUse`, !1));
var oo = ao,
  so = class {
    constructor(e) {
      if ((j(this, `_onigBinding`), j(this, `_ptr`), !M))
        throw new Xa(`Must invoke loadWasm first.`);
      let t = [],
        n = [];
      for (let r = 0, i = e.length; r < i; r++) {
        let i = new io(e[r]);
        ((t[r] = i.createString(M)), (n[r] = i.utf8Length));
      }
      let r = M.omalloc(4 * e.length);
      M.HEAPU32.set(t, r / 4);
      let i = M.omalloc(4 * e.length);
      M.HEAPU32.set(n, i / 4);
      let a = M.createOnigScanner(r, i, e.length);
      for (let n = 0, r = e.length; n < r; n++) M.ofree(t[n]);
      (M.ofree(i), M.ofree(r), a === 0 && ro(M), (this._onigBinding = M), (this._ptr = a));
    }
    dispose() {
              ...
              fo(n)
                ? (n =
                    typeof WebAssembly.instantiateStreaming == `function`
                      ? await _o(n)(t)
                      : await vo(n)(t))
                : po(n) || n instanceof WebAssembly.Module
                  ? (n = await go(n)(t))
                  : `default` in n &&
                    n.default instanceof WebAssembly.Module &&
                    (n = await go(n.default)(t))),
...
async function yo(e) {
  return (
    ...
    {
      createScanner(e) {
        return new so(e.map((e) => (typeof e == `string` ? e : e.source)));
      },
      createString(e) {
        return new oo(e);
      },
...
var bo = Ha({
    langs: Ja,
    themes: Ya,
    engine: () => yo(i(() => import(`./wasm-Cpuss_7d.js`), [], import.meta.url)),
  }),
  {
    codeToHtml: xo,
    codeToHast: So,
    codeToTokens: Co,
    codeToTokensBase: wo,
    codeToTokensWithThemes: To,
    getSingletonHighlighter: Eo,
    getLastGrammarState: Do,
  } = Wa(bo, { guessEmbeddedLanguages: Oi });
function Oo(e) {
...
var Mo = N`\[\^?`,
  No = `c.? | C(?:-.?)?|${N`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${N`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${N`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${N`o\{[^\}]*\}?`}|${N`\d{1,3}`}`,
  Po = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
  Fo = new RegExp(
    N`
  \\ (?:
...
function Lo(e, t = {}) {
  let n = { flags: ``, ...t, rules: { captureGroup: !1, singleline: !1, ...t.rules } };
  ...
  let r = fs(n.flags),
    ...
    o = [],
    s;
  for (Fo.lastIndex = 0; (s = Fo.exec(e)); ) {
    let t = Ro(a, e, s[0], Fo.lastIndex);
    (t.tokens ? o.push(...t.tokens) : t.token && o.push(t.token),
      t.lastIndex !== void 0 && (Fo.lastIndex = t.lastIndex));
  }
  let c = [],
    l = 0;
  (o
  ...
  let u = l || c.length;
  return { tokens: o.map((e) => (e.type === `EscapedNumber` ? ms(e, u) : e)).flat(), flags: r };
}
function Ro(e, t, n, r) {
  let [i, a] = n;
  if (n === `[` || n === `[^`) {
  ...
  if (i === `\\`) {
    if (`AbBGyYzZ`.includes(a)) return { token: Uo(n, n) };
    if (/^\\g[<']/.test(n)) {
    ...
    if (a === `K`) return { token: Xo(`keep`, n) };
    if (a === `N` || a === `R`) return { token: Yo(`newline`, n, { negate: a === `N` }) };
    if (a === `O`) return { token: Yo(`any`, n) };
    if (a === `X`) return { token: Yo(`text_segment`, n) };
    let e = Vo(n, { inCharClass: !1 });
    return Array.isArray(e) ? { tokens: e } : { token: e };
  }
  if (i === `(`) {
    if (a === `*`) return { token: ss(n) };
    if (n === `(?{`) throw Error(`Unsupported callout "${n}"`);
    if (n.startsWith(`(?#`)) {
      if (t[r] !== `)`) throw Error(`Unclosed comment group "(?#"`);
      return { lastIndex: r + 1 };
    }
    if (/^\(\?[-imx]+[:)]$/.test(n)) return { token: os(n, e) };
    if (
      (e.pushModX(e.getCurrentModX()),
      e.numOpenGroups++,
      (n === `(` && !e.captureGroup) || n === `(?:`)
    )
      return { token: $o(`group`, n) };
    if (n === `(?>`) return { token: $o(`atomic`, n) };
    if (n === `(?=` || n === `(?!` || n === `(?<=` || n === `(?<!`)
      return {
        token: $o(n[2] === `<` ? `lookbehind` : `lookahead`, n, { negate: n.endsWith(`!`) }),
      };
    if (
      (n === `(` && e.captureGroup) ||
      ...
      return { token: $o(`capturing`, n, { ...(n !== `(` && { name: n.slice(3, -1) }) }) };
    if (n.startsWith(`(?~`)) {
      if (n === `(?~|`) throw Error(`Unsupported absence function kind "${n}"`);
      return { token: $o(`absence_repeater`, n) };
    }
    throw n === `(?(`
...
`,
  ...
  return n === `.`
    ? { token: Yo(`dot`, n) }
    : n === `^` || n === `$`
      ? { token: Uo(e.singleline ? { "^": N`\A`, $: N`\Z` }[n] : n, n) }
      : n === `|`
        ? { token: Ho(n) }
        : Po.test(n)
          ? { tokens: hs(n) }
...
function zo(e, t, n) {
  let r = [Jo(t[1] === `^`, t)],
    i = 1,
    a;
  for (Io.lastIndex = n; (a = Io.exec(e)); ) {
    let e = a[0];
    if (e[0] === `[` && e[1] !== `:`) (i++, r.push(Jo(e[1] === `^`, e)));
    else if (e === `]`) {
      if (r.at(-1).type === `CharacterClassOpen`) r.push(P(93, e));
      else if ((i--, r.push(Go(e)), !i)) break;
    } else {
      let t = Bo(e);
      Array.isArray(t) ? r.push(...t) : r.push(t);
    }
  }
  return { tokens: r, lastIndex: Io.lastIndex || e.length };
}
function Bo(e) {
  if (e[0] === `\\`) return Vo(e, { inCharClass: !0 });
  if (e[0] === `[`) {
    let t = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(e);
    if (!t || !Ao.has(t.groups.name)) throw Error(`Invalid POSIX class "${e}"`);
    return Yo(`posix`, e, { value: t.groups.name, negate: !!t.groups.negate });
  }
  return e === `-` ? Ko(e) : e === `&&` ? qo(e) : P(Oo(e), e);
}
function Vo(e, { inCharClass: t }) {
  let n = e[1];
  if (n === `c` || n === `C`) return as(e);
  if (`dDhHsSwW`.includes(n)) return ls(e);
  if (e.startsWith(N`\o{`))
  ...
  if (/^\\x[89A-Fa-f]\p{AHex}/u.test(e))
    try {
      let t = e
          ...
          .slice(1)
          .map((e) => parseInt(e, 16)),
        n = new TextDecoder(`utf-8`, { ignoreBOM: !0, fatal: !0 }).decode(new Uint8Array(t)),
        r = new TextEncoder();
      return [...n].map((e) => {
  ...
  if (n === `u` || n === `x`) return P(ps(e), e);
  if (is.has(n)) return P(is.get(n), e);
  if (/\d/.test(n)) return Zo(t, e);
...
function Xo(e, t, n = {}) {
  return e === `keep`
    ...
    : { type: `Directive`, kind: e, flags: jo(n.flags), raw: t };
}
function Zo(e, t) {
...
var rs = new Set([`COUNT`, `CMP`, `ERROR`, `FAIL`, `MAX`, `MISMATCH`, `SKIP`, `TOTAL_COUNT`]),
  is = new Map([
    [`a`, 7],
    [`b`, 8],
    [`e`, 27],
...
function as(e) {
  ...
  return P(Oo(t.toUpperCase()) - 64, e);
}
function os(e, t) {
  ...
  if ((a && (s.enable = a), o && (s.disable = o), e.endsWith(`)`)))
    return (t.replaceCurrentModX(i), Xo(`flags`, e, { flags: s }));
  if (e.endsWith(`:`))
    return (t.pushModX(i), t.numOpenGroups++, $o(`group`, e, { ...((a || o) && { flags: s }) }));
...
function ss(e) {
  ...
  let a = i
      ...
      : [],
    [o, s, c] = a,
    l = rs.has(n) ? n.toLowerCase() : `custom`;
  switch (l) {
    case `fail`:
    case `mismatch`:
    case `skip`:
    ...
    case `max`:
      ...
      if (typeof o == `string` && !/^[A-Za-z_]\w*$/.test(o))
        throw Error(`Named callout argument one must be a tag or number "${o}"`);
      if (a.length === 2 && (typeof s == `number` || !/^[<>X]$/.test(s)))
        throw Error(`Named callout optional argument two must be '<', '>', or 'X' "${s}"`);
      break;
    case `count`:
    case `total_count`:
      if (a.length > 1) throw Error(`Named callout allows only one argument "${a}"`);
      if (a.length === 1 && (typeof o == `number` || !/^[<>X]$/.test(o)))
        throw Error(`Named callout optional argument must be '<', '>', or 'X' "${o}"`);
      break;
    case `cmp`:
      ...
      if (typeof c == `string` && !/^[A-Za-z_]\w*$/.test(c))
        throw Error(`Named callout argument three must be a tag or number "${c}"`);
      break;
    case `custom`:
  ...
  return es(l, r ?? null, i?.split(`,`) ?? null, e);
}
function cs(e) {
  let t = null,
    n,
    r;
  if (e[0] === `{`) {
    let { minStr: i, maxStr: a } = /^\{(?<minStr>\d*)(?:,(?<maxStr>\d*))?/.exec(e).groups,
      o = 1e5;
...
function ls(e) {
  ...
  return Yo({ d: `digit`, h: `hex`, s: `space`, w: `word` }[t], e, { negate: e[1] !== t });
}
function us(e) {
  let { p: t, neg: n, value: r } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(e).groups;
  return Yo(`property`, e, { value: r, negate: (t === `P` && !n) || (t === `p` && !!n) });
}
function ds(e) {
  let t = {};
  return (
...
function ms(e, t) {
  let { raw: n, inCharClass: r } = e,
    i = n.slice(1);
  if (!r && ((i !== `0` && i.length === 1) || (i[0] !== `0` && +i <= t))) return [Wo(n)];
  let a = [],
    o = i.match(/^[0-7]+|\d/g);
  for (let e = 0; e < o.length; e++) {
    ...
    if (e === 0 && t !== `8` && t !== `9`) {
      if (((r = parseInt(t, 8)), r > 127))
        throw Error(N`Octal encoded byte above 177 unsupported "${n}"`);
    } else r = Oo(t);
    a.push(P(r, (e === 0 ? `\\` : ``) + t));
  }
  return a;
  ...
  for (; (r = n.exec(e)); ) {
    ...
    if (e[0] === `{`) {
      ...
      if (r) {
        ...
        if (+i > +a && e.endsWith(`?`)) {
          (n.lastIndex--, t.push(cs(e.slice(0, -1))));
          continue;
        }
      }
    }
    ...
    i = (e, t) => {
      ...
      switch (((a.parent = e), a.nextIndex++, n.type)) {
        ...
        case `Backreference`:
          return xs(n, a);
        case `Character`:
          return Ns(n.value, { useLastValid: !!t.isCheckingRangeEnd });
        ...
        case `CharacterSet`:
          return ws(n, a);
        case `Directive`:
          return Ls(n.kind, { flags: n.flags });
        case `GroupOpen`:
          return Ts(n, a, t);
        case `NamedCallout`:
          return Bs(n.kind, n.tag, n.arguments);
        case `Quantifier`:
          return Es(n, a);
        case `Subroutine`:
          return Ds(n, a);
...
function xs({ raw: e }, t) {
  let n = /^\\k[<']/.test(e),
    ...
    i = (n, r = !1) => {
      ...
      return ((t.hasNumberedRef = !0), js(r ? i + 1 - n : n, { orphan: a }));
    };
  if (n) {
...
function Ss(e, t, n) {
  ...
  if (
    ...
    if (o.type === `Character` && e.type === `Character`) return (a.body.pop(), Fs(o, e));
    throw Error(`Invalid character class range`);
  }
  return Ns(Oo(`-`));
}
function Cs({ negate: e }, t, n) {
  let { tokens: r, walk: i } = t,
    a = r[t.nextIndex],
    o = [Ps()],
    s = ec(a);
  for (; s.type !== `CharacterClassClose`; ) {
    if (s.type === `CharacterClassIntersector`) (o.push(Ps()), t.nextIndex++);
    else {
      let e = o.at(-1);
      e.body.push(i(e, n));
    }
    s = ec(r[t.nextIndex], a);
  }
  let c = Ps({ negate: e });
  return (
    o.length === 1
      ? (c.body = o[0].body)
      : ((c.kind = `intersection`), (c.body = o.map((e) => (e.body.length === 1 ? e.body[0] : e)))),
    t.nextIndex++,
    c
  );
}
function ws({ kind: e, negate: t, value: n }, r) {
  let {
  ...
  if (e === `property`) {
    let r = $s(n);
    if (Ao.has(r) && !o?.has(r)) ((e = `posix`), (n = r));
    else
      return Gs(n, {
        negate: t,
        normalizeUnknownPropertyNames: i,
  ...
  return e === `posix` ? Vs(n, { negate: t }) : Is(e, { negate: t });
}
function Ts(e, t, n) {
  let {
      tokens: r,
    ...
    d = u && c.negate;
  if (
    (c.type === `CapturingGroup` && (i.push(c), c.name && ko(a, c.name, []).push(c)),
    l && n.isInAbsenceFunction)
  )
    throw Error(`Nested absence function not supported by Oniguruma`);
  let f = tc(r[t.nextIndex]);
  for (; f.type !== `GroupClose`; ) {
    if (f.type === `Alternator`) (c.body.push(ks()), t.nextIndex++);
    else {
      let e = c.body.at(-1),
        t = s(e, {
          ...n,
      ...
      if ((e.body.push(t), (u || n.isInLookbehind) && !o)) {
        ...
        if (d || n.isInNegLookbehind) {
          if (Ys(t) || t.type === `CapturingGroup`) throw Error(e);
        } else if (Ys(t) || (Xs(t) && t.negate)) throw Error(e);
      }
    }
    f = tc(r[t.nextIndex]);
  }
...
function Es({ kind: e, min: t, max: n }, r) {
  let i = r.parent,
    a = i.body.at(-1);
  if (!a || !_s(a)) throw Error(`Quantifier requires a repeatable token`);
  let o = Hs(e, t, n, a);
  return (i.body.pop(), o);
}
function Ds({ raw: e }, t) {
  ...
  if (a) {
    let e = +a.groups.num,
      r = n.length;
    if (
      ((t.hasNumberedRef = !0), (i = { "": e, "+": r + e, "-": r + 1 - e }[a.groups.sign]), i < 1)
    )
...
function Os(e, t) {
  ...
  return { type: `AbsenceFunction`, kind: e, body: qs(t?.body) };
}
function ks(e) {
  return { type: `Alternative`, body: Js(e?.body) };
}
function As(e, t) {
...
function Ms(e, t) {
  ...
  if (n.name !== void 0 && !Zs(n.name)) throw Error(`Group name "${n.name}" invalid in Oniguruma`);
  return {
    type: `CapturingGroup`,
    number: e,
    ...(n.name && { name: n.name }),
...
function Ps(e) {
  ...
  return { type: `CharacterClass`, kind: t.kind, negate: t.negate, body: Js(e?.body) };
}
function Fs(e, t) {
...
function Is(e, t) {
  ...
  return (
    (e === `digit` || e === `hex` || e === `newline` || e === `space` || e === `word`) &&
      (r.negate = n),
    (e === `text_segment` || (e === `newline` && !n)) && (r.variableLength = !0),
    r
  );
}
function Ls(e, t = {}) {
  if (e === `keep`) return { type: `Directive`, kind: e };
  if (e === `flags`) return { type: `Directive`, kind: e, flags: jo(t.flags) };
...
function F(e) {
  ...
  return { type: `Group`, ...(t && { atomic: t }), ...(n && { flags: n }), body: qs(e?.body) };
}
function zs(e) {
...
function Vs(e, t) {
  let n = !!t?.negate;
  if (!Ao.has(e)) throw Error(`Invalid POSIX class "${e}"`);
...
function Us(e, t) {
  return { type: `Regex`, body: qs(t?.body), flags: e };
}
function Ws(e) {
...
function Gs(e, t) {
  let n = {
    ...
    r = n.unicodePropertyMap?.get($s(e));
  if (!r) {
    if (n.normalizeUnknownPropertyNames) r = Qs(e);
    else if (n.unicodePropertyMap && !n.skipPropertyNameValidation)
      throw Error(N`Invalid Unicode property "\p{${e}}"`);
  }
  return { type: `CharacterSet`, kind: `property`, value: r ?? e, negate: n.negate };
}
function Ks({ flags: e, kind: t, name: n, negate: r, number: i }) {
  switch (t) {
    ...
    case `lookahead`:
    case `lookbehind`:
      return zs({ behind: t === `lookbehind`, negate: r });
    default:
...
function qs(e) {
  if (e === void 0) e = [ks()];
  else if (!Array.isArray(e) || !e.length || !e.every((e) => e.type === `Alternative`))
  ...
  function i(a, o = null, s = null, c = null) {
    let l = 0,
      ...
      d = {
        ...
        root: e,
        remove() {
          (rc(c).splice(Math.max(0, ic(s) + l), 1), l--, (u = !0));
        },
        removeAllNextSiblings() {
          return rc(c).splice(ic(s) + 1);
        },
        removeAllPrevSiblings() {
          let e = ic(s) + l;
          return ((l -= e), rc(c).splice(0, Math.max(0, e)));
        },
        replaceWith(e, t = {}) {
          let n = !!t.traverse;
          (c ? (c[Math.max(0, ic(s) + l)] = e) : (jo(o, `Can't replace root node`)[s] = e),
            n && i(e, o, s, c),
            (u = !0));
        },
        replaceWithMultiple(e, t = {}) {
          let n = !!t.traverse;
          if ((rc(c).splice(Math.max(0, ic(s) + l), 1, ...e), (l += e.length - 1), n)) {
            let t = 0;
            for (let n = 0; n < e.length; n++) t += i(e[n], o, ic(s) + n + t, c);
          }
          u = !0;
        },
        skip() {
...
var ac = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function oc(e, t) {
  ...
  for (let t of e.matchAll(i)) {
    ...
    if (!i && (!r || (r === I.DEFAULT) == !o)) {
      n instanceof Function
        ? (s += n(t, { context: o ? I.CHAR_CLASS : I.DEFAULT, negated: a[a.length - 1] }))
        : (s += n);
      continue;
    }
...
var pc = new RegExp(
  String.raw`(?<noncapturingStart>${ac})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
  `gsu`,
);
function mc(e, t) {
  ...
  do {
    ...
    let t = 0,
      ...
      d = !1,
      f;
    for (pc.lastIndex = Number.isNaN(c) ? 0 : c + 7; (f = pc.exec(e)); ) {
      let {
        0: p,
        index: m,
...
function _c(e) {
  if (!RegExp(`${hc}\\+`).test(e)) return { pattern: e };
  let t = [],
    n = null,
    r = null,
    i = ``,
    a = 0,
    o;
  for (gc.lastIndex = 0; (o = gc.exec(e)); ) {
    let {
      0: s,
      index: c,
    ...
    if (s === `[`) (a || (r = c), a++);
      ...
      if (u === `+` && i && !i.startsWith(`(`)) {
        ...
        let t = -1;
        if (/^\{\d+\}$/.test(l)) e = sc(e, c + l.length, u, ``);
        else {
          if (i === `)` || i === `]`) {
            let t = i === `)` ? n : r;
...
var L = String.raw,
  vc = L`\(\?R=(?<rDepth>[^\)]+)\)|${L`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`}`,
  yc = L`\(\?<(?![=!])(?<captureName>[^>]+)>`,
  bc = L`${yc}|(?<unnamed>\()(?!\?)`,
  xc = new RegExp(L`${yc}|${vc}|\(\?|\\?.`, `gsu`),
  Sc = `Cannot use multiple overlapping recursions`;
function Cc(e, t) {
  let { hiddenCaptures: n, mode: r } = { hiddenCaptures: [], mode: `plugin`, ...t },
    i = t?.captureTransfers ?? new Map();
  if (!new RegExp(vc, `su`).test(e)) return { pattern: e, captureTransfers: i, hiddenCaptures: n };
  if (r === `plugin` && dc(e, L`\(\?\(DEFINE\)`, I.DEFAULT))
    throw Error(`DEFINE groups cannot be used with recursion`);
  let a = [],
    o = dc(e, L`\\[1-9]`, I.DEFAULT),
    s = new Map(),
    c = [],
    l = !1,
    u = 0,
    d = 0,
    f;
  for (xc.lastIndex = 0; (f = xc.exec(e)); ) {
    let {
      0: t,
    ...
    if (t === `[`) u++;
      ...
      if ((wc(m), l)) throw Error(Sc);
      if (o)
        throw Error(
          `${r === `external` ? `Backrefs` : `Numbered backrefs`} cannot be used with global recursion`,
        );
      let t = e.slice(0, f.index),
        s = e.slice(xc.lastIndex);
      if (dc(s, vc, I.DEFAULT)) throw Error(Sc);
      let c = m - 1;
      ((e = Tc(t, s, c, !1, n, a, d)), (i = Oc(i, t, c, a.length, 0, d)));
      break;
    } else if (h) {
      wc(g);
      let u = !1;
      for (let e of c)
        if (e.name === h || e.num === +h) {
          if (((u = !0), e.hasRecursedWithin)) throw Error(Sc);
          break;
        }
      if (!u)
        throw Error(
      ...
      let _ = e.slice(p, f.index),
        ...
        y = a.length,
        ee = g - 1,
        te = Tc(_, v, ee, !0, n, a, d);
      ((i = Oc(i, _, ee, a.length - y, y, d)),
        (e = `${e.slice(0, p)}${te}${e.slice(p + m.length)}`),
        (xc.lastIndex += te.length - t.length - _.length - v.length),
        c.forEach((e) => (e.hasRecursedWithin = !0)),
        (l = !0));
    } else if (p)
      (d++, s.set(String(d), xc.lastIndex), s.set(p, xc.lastIndex), c.push({ num: d, name: p }));
    else if (t[0] === `(`) {
      let e = t === `(`;
      (e && (d++, s.set(String(d), xc.lastIndex)), c.push(e ? { num: d } : {}));
    } else t === `)` && c.pop();
  }
...
function Tc(e, t, n, r, i, a, o) {
  ...
  return `${e}${Ec(`(?:${e}`, `forward`, ...c)}(?:)${Ec(`${t})`, `backward`, ...c)}${t}`;
}
  ...
  for (let t = 0; t < n; t++) {
    ...
    c += cc(
      ...
      ({ 0: e, groups: { captureName: t, unnamed: s, backref: c } }) => {
        ...
        if (s || t) {
          let n = o + a.length + 1;
          return (a.push(n), Dc(i, n), s ? e : `(?<${t}${l}>`);
        }
        return L`\k<${c}${l}>`;
      },
      I.DEFAULT,
...
var R = String.fromCodePoint,
  z = String.raw,
  B = { flagGroups: !0, unicodeSets: !0 };
((B.bugFlagVLiteralHyphenIsRange = B.unicodeSets
  ? (() => {
      try {
        new RegExp(z`[\d\-a]`, `v`);
      } catch {
  ...
  : !1),
  (B.bugNestedClassIgnoresNegation = B.unicodeSets && RegExp(`[[^a]]`, `v`).test(`a`)));
function kc(e, { enable: t, disable: n }) {
  return {
...
var Nc = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
  Pc = { auto: `auto`, ES2025: `ES2025`, ES2024: `ES2024`, ES2018: `ES2018` };
function Fc(e = {}) {
  if ({}.toString.call(e) !== `[object Object]`) throw Error(`Unexpected options`);
  if (e.target !== void 0 && !Pc[e.target]) throw Error(`Unexpected target "${e.target}"`);
  let t = {
    accuracy: `default`,
    avoidSubclass: !1,
    flags: ``,
  ...
  return (
    t.target === `auto` &&
      (t.target = B.flagGroups ? `ES2025` : B.unicodeSets ? `ES2024` : `ES2018`),
    t
  );
}
var Ic = `[	-\r ]`,
  Lc = new Set([R(304), R(305)]),
  V = z`[\p{L}\p{M}\p{N}\p{Pc}]`;
function Rc(e) {
  if (Lc.has(e)) return [e];
  let t = new Set(),
    n = e.toLowerCase(),
    r = n.toUpperCase(),
    i = Hc.get(n),
...
XID_Start XIDS`
  ...
  Uc = new Map([
    [`alnum`, z`[\p{Alpha}\p{Nd}]`],
    [`alpha`, z`\p{Alpha}`],
    [`ascii`, z`\p{ASCII}`],
    [`blank`, z`[\p{Zs}\t]`],
    [`cntrl`, z`\p{Cc}`],
    [`digit`, z`\p{Nd}`],
    [`graph`, z`[\P{space}&&\P{Cc}&&\P{Cn}&&\P{Cs}]`],
    [`lower`, z`\p{Lower}`],
    [`print`, z`[[\P{space}&&\P{Cc}&&\P{Cn}&&\P{Cs}]\p{Zs}]`],
    [`punct`, z`[\p{P}\p{S}]`],
    [`space`, z`\p{space}`],
    [`upper`, z`\p{Upper}`],
    [`word`, z`[\p{Alpha}\p{M}\p{Nd}\p{Pc}]`],
    [`xdigit`, z`\p{AHex}`],
  ]);
function Wc(e, t) {
  let n = [];
...
function qc(e, t) {
  ...
  let r = {
    ...
    minTargetEs2024: jc(n.bestEffortTarget, `ES2024`),
    passedLookbehind: !1,
    strategy: null,
...
var Jc = {
    AbsenceFunction({ node: e, parent: t, replaceWith: n }) {
      ...
      if (i === `repeater`) {
        let e = F();
        e.body[0].body.push(zs({ negate: !0, body: r }), Gs(`Any`));
        let i = F();
        (i.body[0].body.push(Hs(`greedy`, 0, 1 / 0, e)), n(G(i, t), { traverse: !0 }));
    ...
    Alternative: {
      ...
      exit({ node: e }, { flagDirectivesByAlt: t }) {
        if (t.get(e)?.length) {
          ...
          if (n) {
            let t = F({ flags: n });
            ((t.body[0].body = e.body), (e.body = [G(t, e)]));
          }
        }
      },
    },
    Assertion({ node: e, parent: t, key: n, container: r, root: i, remove: a, replaceWith: o }, s) {
      let { kind: c, negate: l } = e,
        { asciiWordBoundaries: u, avoidSubclass: d, supportedGNodes: f, wordIsAscii: p } = s;
      if (c === `text_segment_boundary`)
        throw Error(`Unsupported text segment boundary "\\${l ? `Y` : `y`}"`);
      if (c === `line_end`)
        o(G(zs({ body: [ks({ body: [As(`string_end`)] }), ks({ body: [Ns(10)] })] }), t));
        ...
        if (f.has(e)) ((i.flags.sticky = !0), a());
          ...
          let e = r[n - 1];
          if (e && ul(e)) o(G(zs({ negate: !0 }), t));
          else if (d) throw Error(z`Uses "\G" in a way that requires a subclass`);
          else (o(W(As(`string_start`), t)), (s.strategy = `clip_search`));
        }
      else if (!(c === `string_end` || c === `string_start`))
        if (c === `string_end_newline`) o(G(U(z`(?=\n?\z)`), t));
    ...
    Backreference({ node: e }, { jsGroupNameMap: t }) {
      let { ref: n } = e;
      typeof n == `string` && !fl(n) && ((n = rl(n, t)), (e.ref = n));
    },
    CapturingGroup({ node: e }, { jsGroupNameMap: t, subroutineRefMap: n }) {
      let { name: r } = e;
      (r && !fl(r) && ((r = rl(r, t)), (e.name = r)), n.set(e.number, e), r && n.set(r, e));
    },
    CharacterClassRange({ node: e, parent: t, replaceWith: n }) {
      t.kind === `intersection` && n(G(Ps({ body: [e] }), t), { traverse: !0 });
    },
    CharacterSet(
      { node: e, parent: t, replaceWith: n },
      { accuracy: r, minTargetEs2024: i, digitIsAscii: a, spaceIsAscii: o, wordIsAscii: s },
    ) {
      let { kind: c, negate: l, value: u } = e;
      if (a && (c === `digit` || u === `digit`)) {
        n(W(Is(`digit`, { negate: l }), t));
        return;
      }
      ...
      if (s && (c === `word` || u === `word`)) {
        n(W(Is(`word`, { negate: l }), t));
        return;
      }
      if (c === `any`) n(W(Gs(`Any`), t));
      else if (c === `digit`) n(W(Gs(`Nd`, { negate: l }), t));
      else if (c !== `dot`)
        if (c === `text_segment`) {
          if (r === `strict`) throw Error(z`Use of "\X" requires non-strict accuracy`);
          let e = `\\p{Emoji}(?:\\p{EMod}|\\uFE0F\\u20E3?|[\\x{E0020}-\\x{E007E}]+\\x{E007F})?`,
            a = z`\p{RI}{2}|${e}(?:\u200D${e})*`;
          n(
            G(
              U(z`(?>\r\n|${i ? z`\p{RGI_Emoji}` : a}|\P{M}\p{M}*)`, {
                skipPropertyNameValidation: !0,
              }),
              t,
            ),
          );
        } else if (c === `hex`) n(W(Gs(`AHex`, { negate: l }), t));
        else if (c === `newline`)
          n(
            G(
              U(
...
\v\f\u2028\u2029])`,
          ...
          if (!i && (u === `graph` || u === `print`)) {
            if (r === `strict`)
              throw Error(`POSIX class "${u}" requires min target ES2024 or non-strict accuracy`);
            let e = { graph: `!-~`, print: ` -~` }[u];
            (l && (e = `\0-${R(e.codePointAt(0) - 1)}${R(e.codePointAt(2) + 1)}-\u{10FFFF}`),
              n(G(U(`[${e}]`), t)));
          } else n(G(pl(U(Uc.get(u)), l), t));
        else if (c === `property`) zc.has($s(u)) || (e.key = `sc`);
        else if (c === `space`) n(W(Gs(`space`, { negate: l }), t));
        else if (c === `word`) n(G(pl(U(V), l), t));
    ...
    Directive({
      ...
      if (s === `flags`)
        if (!c.enable && !c.disable) r();
          ...
          let e = F({ flags: c });
          ((e.body[0].body = o()), i(G(e, t), { traverse: !0 }));
        }
      else if (s === `keep`) {
        let e = n.body[0],
          r =
            n.body.length === 1 && gs(e, { type: `Group` }) && e.body[0].body.length === 1
              ? e.body[0]
              : n;
        if (t.parent !== r || r.body.length > 1)
          throw Error(z`Uses "\K" in a way that's unsupported`);
        let o = zs({ behind: !0 });
        ((o.body[0].body = a()), i(G(o, t)));
    ...
    Regex: {
      enter({ node: e }, { supportedGNodes: t }) {
        let n = [],
          ...
          i = !1;
        for (let t of e.body)
          if (t.body.length === 1 && t.body[0].kind === `search_start`) t.body.pop();
          else {
            let e = sl(t.body);
      ...
      exit(e, { accuracy: t, passedLookbehind: n, strategy: r }) {
        if (t === `strict` && n && r)
          throw Error(z`Uses "\G" in a way that requires non-strict accuracy`);
      },
    },
  ...
  Yc = {
    ...
    CapturingGroup: {
      enter(
        ...
        let l = i.get(e);
        if (l && s.has(e.number)) {
          let r = W(tl(e.number), t);
          (c.set(r, s.get(e.number)), n(r));
          return;
        }
        (s.set(e.number, e), o.set(e.number, []), e.name && Ac(o, e.name, []));
    ...
    Group: {
      enter({ node: e }, t) {
        ((t.prevFlags = t.currentFlags), e.flags && (t.currentFlags = kc(t.currentFlags, e.flags)));
      },
      exit(e, t) {
    ...
    Subroutine({ node: e, parent: t, replaceWith: n }, r) {
      ...
      if (i) {
        ...
        for (
          ;
          (n = n.parent) && !(n.type === `CapturingGroup` && (n.name === a || n.number === a));
        );
      ...
      let o = r.subroutineRefMap.get(a),
        s = a === 0,
        c = s ? tl(0) : el(o, r.groupOriginByCopy, null),
        l = c;
      if (!s) {
        let e = il(nl(o, (e) => e.type === `Group` && !!e.flags)),
          t = e ? kc(r.globalFlags, e) : r.globalFlags;
        Qc(t, r.currentFlags) || ((l = F({ flags: al(t) })), l.body[0].body.push(c));
      }
      n(G(l, t), { traverse: !s });
    },
  },
  Xc = {
    Backreference({ node: e, parent: t, replaceWith: n }, r) {
      ...
      let i = r.reffedNodesByReferencer.get(e).filter((t) => $c(t, e));
      i.length
        ? i.length > 1
          ? n(G(F({ atomic: !0, body: i.reverse().map((e) => ks({ body: [js(e.number)] })) }), t))
          : (e.ref = i[0].number)
        : n(G(zs({ negate: !0 }), t));
    },
...
function el(e, t, n, r) {
  ...
  for (let [a, o] of Object.entries(e))
    a === `parent`
      ...
      : o && typeof o == `object`
        ? (i[a] = el(o, t, i, n))
        : (a === `type` && o === `CapturingGroup` && t.set(i, t.get(e) ?? e), (i[a] = o));
  return i;
}
function tl(e) {
  let t = Ws(e);
...
function al({ dotAll: e, ignoreCase: t }) {
  let n = {};
  return (
    (e || t) && ((n.enable = {}), e && (n.enable.dotAll = !0), t && (n.enable.ignoreCase = !0)),
    (!e || !t) &&
      ((n.disable = {}), !e && (n.disable.dotAll = !0), !t && (n.disable.ignoreCase = !0)),
    n
  );
}
function ol(e) {
...
function sl(e) {
  let t = e.find((e) => e.kind === `search_start` || dl(e, { negate: !1 }) || !ll(e));
  if (!t) return null;
...
function cl(e, t) {
  let n = ol(e) ?? [];
  for (let e of n) if (e === t || cl(e, t)) return !0;
  return !1;
}
function ll({ type: e }) {
...
function dl(e, t) {
  ...
  return (
    ...
    e.body.length === 1 &&
    gs(e.body[0], { type: `Assertion`, kind: `search_start` })
  );
}
function fl(e) {
...
function U(e, t) {
  let n = ys(e, { ...t, unicodePropertyMap: zc }).body;
...
function G(e, t) {
  return (Zc(e), (e.parent = t), e);
}
function ml(e, t) {
  let n = Fc(t),
    r = jc(n.target, `ES2024`),
    i = jc(n.target, `ES2025`),
  ...
  let c = { dotAll: e.flags.dotAll, ignoreCase: !!((e.flags.ignoreCase || o) && !s) },
    l = e,
    u = {
      accuracy: n.accuracy,
  ...
  function d(e) {
    return ((u.lastNode = l), (l = e), Mc(gl[e.type], `Unexpected node type "${e.type}"`)(e, u, d));
  }
  let f = { pattern: e.body.map(d).join(`|`), flags: d(e.flags), options: { ...e.options } };
  return (
    r ||
    ...
    u.captureMap.forEach((e, t) => {
      (e.hidden && f._hiddenCaptures.push(t),
        e.transferTo && Ac(f._captureTransfers, e.transferTo, []).push(t));
    }),
    f
  );
}
var hl = {
    "*": {
      enter({ node: e }, t) {
        if (Ol(e)) {
          ...
          t.pushModI(e.flags ? kc({ ignoreCase: n }, e.flags).ignoreCase : n);
        }
      },
      exit({ node: e }, t) {
        Ol(e) && t.popModI();
    ...
    Character({ node: e }, t) {
      Sl(R(e.value)) && t.setHasCasedChar();
    },
    CharacterClassRange({ node: e, skip: t }, n) {
      (t(), Cl(e, { firstOnly: !0 }).length && n.setHasCasedChar());
    },
    CharacterSet({ node: e }, t) {
      e.kind === `property` && Kc.has(e.value) && t.setHasCasedChar();
    },
  },
  gl = {
    ...
    Assertion({ kind: e, negate: t }) {
      ...
      if (e === `word_boundary`) return t ? z`\B` : z`\b`;
    ...
    Character({ value: e }, t) {
      ...
      if (r !== n) return r;
      if (t.useAppliedIgnoreCase && t.currentFlags.ignoreCase && Sl(n)) {
        let e = Rc(n);
    ...
    CharacterClass(e, t, n) {
      ...
      B.bugFlagVLiteralHyphenIsRange &&
        t.useFlagV &&
        o.some(Al) &&
        (o = [Ns(45), ...o.filter((e) => !Al(e))]);
      let s = () => `[${i ? `^` : ``}${o.map(n).join(r === `intersection` ? `&&` : ``)}]`;
      if (!t.inCharClass) {
        if ((!t.useFlagV || B.bugNestedClassIgnoresNegation) && !i) {
      ...
      if (
        ...
        (((!t.useFlagV || !t.verbose) &&
          a.kind === `union` &&
          !(B.bugFlagVLiteralHyphenIsRange && t.useFlagV)) ||
          (!t.verbose &&
            a.kind === `intersection` &&
            o.length === 1 &&
    ...
    CharacterClassRange(e, t) {
      ...
      return (
        t.useAppliedIgnoreCase &&
          t.currentFlags.ignoreCase &&
          Tl(Cl(e)).forEach((e) => {
            s.add(Array.isArray(e) ? `${wl(e[0], i)}-${wl(e[1], i)}` : wl(e, i));
          }),
        `${a}-${o}${[...s].join(``)}`
      );
    },
      ...
      if (e === `dot`)
        return i.currentFlags.dotAll
          ? i.appliedGlobalFlags.dotAll || i.useFlagMods
            ...
            : `[^]`
          : z`[^\n]`;
      if (e === `digit`) return t ? z`\D` : z`\d`;
      if (e === `property`) {
        if (i.useAppliedIgnoreCase && i.currentFlags.ignoreCase && Kc.has(n))
          throw Error(
            `Unicode property "${n}" can't be case-insensitive when other chars have specific case`,
          );
        return `${t ? z`\P` : z`\p`}{${r ? `${r}=` : ``}${n}}`;
      }
      if (e === `word`) return t ? z`\W` : z`\w`;
    ...
    Group({ atomic: e, body: t, flags: n, parent: r }, i, a) {
      ...
      n && (i.currentFlags = kc(o, n));
      let s = t.map(a).join(`|`),
        c =
          !i.verbose && t.length === 1 && r.type !== `Quantifier` && !e && (!i.useFlagMods || !n)
            ? s
            : `(?${El(e, n, i.useFlagMods)}${s})`;
...
function wl(e, { escDigit: t, inCharClass: n, useFlagV: r }) {
  if (bl.has(e)) return bl.get(e);
  if (e < 32 || (e > 126 && e < 160) || e > 262143 || (t && kl(e)))
    return e > 255
...
function Dl({ kind: e, max: t, min: n }) {
  let r;
  return (
    (r =
      !n && t === 1
...
function Al({ type: e, value: t }) {
  return e === `Character` && t === 45;
}
var jl = class e extends RegExp {
  #e = new Map();
  #t = null;
  #n;
  #r = null;
  ...
  constructor(t, n, r) {
    ...
    if (t instanceof RegExp) {
      ...
      (super(i, n),
        (this.#n = i.source),
        i instanceof e &&
          ((this.#e = i.#e), (this.#r = i.#r), (this.#i = i.#i), (this.rawOptions = i.rawOptions)));
    } else {
      let e = { hiddenCaptures: [], strategy: null, transfers: [], ...r };
      (super(i ? `` : t, n),
        (this.#n = t),
        (this.#e = Nl(e.hiddenCaptures, e.transfers)),
        (this.#i = e.strategy),
        (this.rawOptions = r ?? {}));
    }
    i || (this.#t = this);
  ...
  exec(t) {
    ...
    if (this.#i === `clip_search` && n && r) {
      ...
      return (e && (Ml(e, r, t, this.hasIndices), (this.lastIndex += r)), e);
    }
    return this.#a(t);
  }
  #a(e) {
...
function Nl(e, t) {
  ...
  for (let [e, r] of t) for (let t of r) Ac(n, t, {}).transferTo = e;
  return n;
}
function Pl(e) {
...
function Fl(e, t) {
  let n = Il(e, t);
  return n.options ? new jl(n.pattern, n.flags, n.options) : new RegExp(n.pattern, n.flags);
}
function Il(e, t) {
  let n = Fc(t),
    r = qc(
  ...
  if (n.avoidSubclass) {
    if (n.lazyCompileLength !== 1 / 0) throw Error(`Lazy compilation requires subclass`);
  } else {
...
function Bl(e = {}) {
  ...
  return (
    (t.regexConstructor ||= (e) => zl(e, { target: t.target })),
    {
      createScanner(e) {
        return new Rl(e, t);
      },
...
async function Vl(e) {
  ...
  try {
    let t = An.get(e);
    if ((t == null && Object.prototype.hasOwnProperty.call(Ja, e) && (t = Ja[e]), t == null))
      throw Error(`resolveLanguage: "${e}" not found in bundled or custom languages`);
    let n = t().then(({ default: t }) => {
      let n = { name: e, data: t };
      return (On.has(e) || On.set(e, n), n);
    });
    return (kn.set(e, n), await n);
  } finally {
    kn.delete(e);
  }
}
function Hl(e) {
  return On.get(e) ?? Vl(e);
}
var K = new Map(),
  Ul = new Map(),
  Wl = new Map(),
...
function Kl(e, t) {
  ...
  for (let n of e) {
    ...
    } else ((e = n), (n = n.name), K.has(n) || K.set(n, e));
    Gl.has(n) || (Gl.add(n), t.loadThemeSync(e));
  }
}
async function ql(e) {
  if (Pn())
  ...
  try {
    let t = Wl.get(e) ?? Ya[e];
    if (t == null) throw Error(`resolveTheme: No valid loader for ${e}`);
    let n = t().then((t) => Jl(e, `default` in t ? t.default : t));
    Ul.set(e, n);
    let r = await n;
    if (r.name !== e)
      throw Error(`resolvedTheme: themeName: ${e} does not match theme.name: ${r.name}`);
    return (K.set(r.name, r), r);
  } finally {
    Ul.delete(e);
  }
}
function Jl(e, t) {
  return K.get(e) ?? ((t = Oa(t)), K.set(e, t), t);
}
function Yl(e) {
  return K.get(e) ?? ql(e);
}
...
var q;
async function Zl({ themes: e, langs: t, preferredHighlighter: n = `shiki-js` }) {
  q ??= bo({
    themes: [],
    langs: [`text`],
    engine:
      n === `shiki-wasm` ? yo(i(() => import(`./wasm-Cpuss_7d.js`), [], import.meta.url)) : Bl(),
  });
  let r = $l(q) ? await q : q;
  q = r;
  let a = [];
  for (let e of t) {
    ...
    let t = Hl(e);
    `then` in t ? a.push(t) : Nn(t, r);
  }
  let o = [];
  for (let t of e) {
    let e = Yl(t);
    `then` in e ? o.push(e) : Kl(e, q);
  }
  return (
...
(Xl(`pierre-dark`, async () => {
  let { default: e } = await i(
    async () => {
      let { default: e } = await import(`./pierre-dark-C6upavPg.js`);
      return { default: e };
    },
    [],
    import.meta.url,
  );
  return { ...e, name: `pierre-dark` };
}),
  Xl(`pierre-light`, async () => {
    let { default: e } = await i(
      async () => {
        let { default: e } = await import(`./pierre-light-BiHtkl9W.js`);
        return { default: e };
      },
      [],
      import.meta.url,
    );
    return { ...e, name: `pierre-light` };
  }));
function eu(e = v) {
  let t = [];
  return (typeof e == `string` ? t.push(e) : (t.push(e.dark), t.push(e.light)), t);
}
function tu(e) {
  for (let t of eu(e)) if (!Gl.has(t)) return !1;
  return !0;
}
function nu(e) {
  for (let t of e) if (!K.has(t)) return !1;
  return !0;
}
function ru(e, t) {
...
function au(e) {
  return b({
    ...
    children: [
      b({
        tagName: `div`,
        children: e.annotations?.map((e) => b({ tagName: `slot`, properties: { name: e } })),
...
function su({ fileOrDiff: e, mode: t }) {
  let n = `type` in e ? e : void 0,
    r = { "data-diffs-header": t, "data-change-type": n?.type };
  return b({
    tagName: `div`,
    children: [
      t === `custom`
        ? b({ tagName: `slot`, properties: { name: _ } })
        : cu({
            name: e.name,
            prevName: `prevName` in e ? e.prevName : void 0,
            iconType: n?.type ?? `file`,
          }),
      ...(t === `custom` ? [] : [lu(n)]),
    ],
    properties: r,
...
function cu({ name: e, prevName: t, iconType: n }) {
  let r = [
    b({ tagName: `slot`, properties: { name: h } }),
    le({ name: ou(n), properties: { "data-change-icon": n } }),
  ];
  return (
    t != null &&
      (r.push(
        b({
          tagName: `div`,
          children: [b({ tagName: `bdi`, children: [ce(t)] })],
          properties: { "data-prev-name": `` },
        }),
      ),
      r.push(le({ name: `diffs-icon-arrow-right-short`, properties: { "data-rename-icon": `` } }))),
    r.push(
      b({
        tagName: `div`,
        children: [b({ tagName: `bdi`, children: [ce(e)] })],
        properties: { "data-title": `` },
      }),
    ),
    b({ tagName: `div`, children: r, properties: { "data-header-content": `` } })
  );
}
function lu(e) {
  let t = [];
  if (e != null) {
    ...
    ((r > 0 || n === 0) &&
      t.push(
        b({ tagName: `span`, children: [ce(`-${r}`)], properties: { "data-deletions-count": `` } }),
      ),
      (n > 0 || r === 0) &&
        t.push(
          b({
  ...
  return (
    t.push(b({ tagName: `slot`, properties: { name: te } })),
    b({ tagName: `div`, children: t, properties: { "data-metadata": `` } })
  );
}
function uu(e) {
  return b({ tagName: `pre`, properties: du(e) });
}
function du({
  diffIndicators: e,
  disableBackground: t,
...
function J(e) {
  if (fu.has(e)) return fu.get(e) ?? `text`;
  if (mu[e] != null) return mu[e];
  let t = e.match(/\.([^/\\]+\.[^/\\]+)$/);
  if (t != null) {
    if (fu.has(t[1])) return fu.get(t[1]) ?? `text`;
    if (mu[t[1]] != null) return mu[t[1]] ?? `text`;
  }
  let n = e.match(/\.([^.]+)$/)?.[1] ?? ``;
  return fu.has(n) ? (fu.get(n) ?? `text`) : (mu[n] ?? `text`);
}
function hu() {
  return pu;
}
function gu() {
  return Object.fromEntries(fu);
}
function _u(e, { theme: t, preferredHighlighter: n = `shiki-js` }) {
  return { langs: [e ?? `text`], themes: eu(t), preferredHighlighter: n };
}
function vu(e) {
...
var bu = Symbol(`no-token`),
  xu = Symbol(`multiple-tokens`);
function Su(e) {
  let t = Cu(e);
  if (t != null) return t;
  let n = bu,
    ...
    o = () => {
      ...
      if (i.length === 1) {
        ...
        if (e?.type === `element`) {
          Tu(e, a);
          for (let t of e.children) wu(t);
        } else wu(e);
        (r.push(e), (i = []), (a = void 0));
        return;
      }
      for (let e of i) wu(e);
      (r.push(b({ tagName: `span`, properties: { "data-char": a }, children: i })),
        (i = []),
        (a = void 0));
    },
    s = (e) => {
...
function Eu(e = {}) {
  let { classPrefix: t = `__shiki_`, classSuffix: n = ``, classReplacer: r = (e) => e } = e,
    i = new Map();
  function a(e) {
  ...
  function o(e) {
    let o = t + Du(typeof e == `string` ? e : a(e)) + n;
    ...
    tokens(e) {
      for (let t of e)
        for (let e of t) {
          ...
          ((e.htmlStyle = {}),
            (e.htmlAttrs ||= {}),
            e.htmlAttrs.class ? (e.htmlAttrs.class += ` ${t}`) : (e.htmlAttrs.class = t));
        }
    },
    getClassRegistry() {
      return i;
...
function Du(e, t = 0) {
  ...
  for (let t = 0, i; t < e.length; t++)
    ((i = e.charCodeAt(t)), (n = Math.imul(n ^ i, 2654435761)), (r = Math.imul(r ^ i, 1597334677)));
  return (
...
function Ou(e = !1, t = !1) {
        ...
        pre(t) {
          ...
          if (r != null) {
            ...
            for (let a of r.children)
              a.type === `element` && (e && Su(a), i.push(yu(a, t, n)), t++);
            r.children = i;
          }
          return t;
        },
  ...
  return (t && r.push(Au, ku), { state: n, transformers: r, toClass: ku });
}
var ku = Eu({ classPrefix: `hl-` }),
  Au = {
...
function ju({ theme: e = v, highlighter: t, prefix: n }) {
  let r = ``;
  if (typeof e == `string`) {
    let i = t.getTheme(e);
    ((r += `color:${i.fg};`),
      (r += `background-color:${i.bg};`),
      (r += `${Y(`global`)}fg:${i.fg};`),
      (r += `${Y(`global`)}bg:${i.bg};`),
      (r += Mu(i, n)));
  } else {
    let n = t.getTheme(e.dark);
    ((r += `${Y(`global`)}dark:${n.fg};`),
      (r += `${Y(`global`)}dark-bg:${n.bg};`),
      (r += Mu(n, `dark`)),
      (n = t.getTheme(e.light)),
      (r += `${Y(`global`)}light:${n.fg};`),
      (r += `${Y(`global`)}light-bg:${n.bg};`),
      (r += Mu(n, `light`)));
  }
  return r;
}
function Mu(e, t) {
  t = t == null ? `` : `${t}-`;
  let n = ``,
    r = e.colors?.[`gitDecoration.addedResourceForeground`] ?? e.colors?.[`terminal.ansiGreen`];
  r != null && (n += `${Y(`global`)}${t}addition-color:${r};`);
  let i = e.colors?.[`gitDecoration.deletedResourceForeground`] ?? e.colors?.[`terminal.ansiRed`];
  i != null && (n += `${Y(`global`)}${t}deletion-color:${i};`);
  let a = e.colors?.[`gitDecoration.modifiedResourceForeground`] ?? e.colors?.[`terminal.ansiBlue`];
  return (a != null && (n += `${Y(`global`)}${t}modified-color:${a};`), n);
}
function Nu(e) {
  let t = e.children[0];
  for (; t != null; ) {
...
function Pu({ lines: e, startingLine: t = 0, totalLines: n = 1 / 0, callback: r }) {
  let i = Math.min(t + n, e.length),
    a = (() => {
      let t = e.at(-1);
      return t === `` ||
        t ===
...
` ||
        t === `\r`
        ? Math.max(0, e.length - 2)
        : e.length - 1;
    })();
  for (let n = t; n < i; n++) {
    let t = n === a;
    if (r({ lineIndex: n, lineNumber: n + 1, content: e[n], isLastLine: t }) === !0 || t) break;
  }
}
function Fu(e) {
  return e === `` ? [] : e.split(ee);
}
var Iu = { forcePlainText: !1 };
function Lu(
  e,
  t,
  { theme: n = v, tokenizeMaxLineLength: r, useTokenTransformer: i },
  { forcePlainText: a, startingLine: o, totalLines: s, lines: c } = Iu,
) {
  a ? ((o ??= 0), (s ??= 1 / 0)) : ((o = 0), (s = 1 / 0));
  let l = o > 0 || s < 1 / 0,
    { state: u, transformers: d } = Ou(i),
    f = a ? `text` : (e.lang ?? J(e.name)),
    p = typeof n == `string` ? t.getTheme(n).type : void 0,
    m = ju({ theme: n, highlighter: t });
  u.lineInfo = (e) => ({ type: `context`, lineIndex: e - 1 + o, lineNumber: e + o });
  let h =
      typeof n == `string`
        ? {
            lang: f,
    ...
    _ = Nu(t.codeToHast(l ? Ru(c ?? Fu(e.contents), o, s) : g(e.contents), h)),
    y = l ? Array(o) : _;
  return (l && y.push(..._), { code: y, themeStyles: m, baseThemeType: p });
}
function Ru(e, t, n) {
  let r = ``;
  return (
...
var Hu = `<svg data-icon-sprite aria-hidden="true" width="0" height="0">
...
function Wu(e, t) {
  return e == null || t == null
    ? e === t
    : Ku(e.customProperties, t.customProperties) &&
        e.type === t.type &&
...
function qu(e) {
  ...
  return ((t.dataset.annotationSlot = ``), (t.slot = e), (t.style.whiteSpace = `normal`), t);
}
function Ju() {
  let e = document.createElement(`div`);
  return (
...
function Yu() {
  ...
  return (e.setAttribute(d, ``), e);
}
var Xu = `@layer base, theme, rendered, unsafe;
...
`,
  Zu = `@layer base, theme, rendered, unsafe;`;
function Qu(e) {
  return `${Zu}
@layer unsafe {
  ${e}
...
function ed({ code: e, pre: t, columnType: n, rowSpan: r, containerSize: i = !1 } = {}) {
  return (
    e ??
      ...
      t?.appendChild(e)),
    r == null ? e.style.removeProperty(`grid-row`) : e.style.setProperty(`grid-row`, `span ${r}`),
    i ? e.setAttribute(`data-container-size`, ``) : e.removeAttribute(`data-container-size`),
    e
  );
}
function td(e, t) {
...
function nd(
  ...
  return (
    ...
    r ? e.removeAttribute(`data-background`) : e.setAttribute(`data-background`, ``),
    t === `diff`
      ? e.setAttribute(`data-diff-type`, o ? `split` : `single`)
      : e.removeAttribute(`data-diff-type`),
    e.setAttribute(`data-overflow`, a),
    (e.tabIndex = 0),
    e.style.setProperty(`--diffs-min-number-column-width-default`, `${`${s}`.length}ch`),
    e
  );
}
function rd({ shadowRoot: e, currentNode: t, themeCSS: n }) {
  if (n.trim() === ``) {
    t?.remove();
    return;
  }
  return ((t ??= id()), (t.textContent = n), t.parentNode !== e && e.appendChild(t), t);
}
function id() {
  let e = document.createElement(`style`);
  return (e.setAttribute(p, ``), e);
}
if (typeof HTMLElement < `u` && customElements.get(`diffs-container`) == null) {
  let e;
  class t extends HTMLElement {
    constructor() {
      if ((super(), this.shadowRoot != null)) return;
      let t = this.attachShadow({ mode: `open` });
      (e ?? ((e = new CSSStyleSheet()), e.replaceSync(Xu)), (t.adoptedStyleSheets = [e]));
    }
  }
...
var vd = `a-zA-Z0-9_\\u{AD}\\u{C0}-\\u{D6}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}`,
  yd = RegExp(`[${vd}]+|\\s+|[^${vd}]`, `ug`);
new (class extends X {
  equals(e, t, n) {
    ...
    return (
      e.forEach((e) => {
        e.added
          ...
          : e.removed
            ? (i = e)
            : ((r || i) && bd(n, i, r, e), (n = e), (r = null), (i = null));
      }),
      (r || i) && bd(n, i, r, null),
      e
    );
...
function bd(e, t, n, r) {
  if (t && n) {
    ...
    if (e) {
      let r = cd(i, o);
      ((e.value = dd(e.value, o, r)), (t.value = fd(t.value, r)), (n.value = fd(n.value, r)));
    }
    if (r) {
      let e = ld(a, s);
      ((r.value = ud(r.value, s, e)), (t.value = pd(t.value, e)), (n.value = pd(n.value, e)));
    }
  } else if (n) {
    if (e) {
      let e = _d(n.value);
    ...
    let n = _d(r.value),
      ...
      a = gd(t.value),
      o = cd(n, i);
    t.value = fd(t.value, o);
    let s = ld(fd(n, o), a);
    ((t.value = pd(t.value, s)),
      (r.value = ud(r.value, n, s)),
      (e.value = dd(e.value, n, n.slice(0, n.length - s.length))));
  } else if (r) {
    let e = _d(r.value),
      n = md(gd(t.value), e);
    t.value = pd(t.value, n);
  } else if (e) {
    let n = md(gd(e.value), _d(t.value));
    t.value = fd(t.value, n);
  }
}
var xd = new (class extends X {
  tokenize(e) {
    let t = RegExp(`(\\r?\\n)|[${vd}]+|[^\\S\\n\\r]+|[^${vd}]`, `ug`);
    return e.match(t) || [];
  }
...
function Sd(e, t, n) {
  return xd.diff(e, t, n);
}
var Cd = new (class extends X {
  constructor() {
    (super(...arguments), (this.tokenize = Td));
  }
  equals(e, t, n) {
    return (
      n.ignoreWhitespace
...
(new (class extends X {
  ...
  new (class extends X {
    ...
    castInput(e, t) {
      ...
      return typeof e == `string` ? e : JSON.stringify(Dd(e, null, null, r), null, `  `);
    }
    equals(e, t, n) {
...
function Dd(e, t, n, r, i) {
  ...
  if ((e && e.toJSON && (e = e.toJSON()), typeof e == `object` && e)) {
    ...
    for (i.sort(), a = 0; a < i.length; a += 1) ((s = i[a]), (o[s] = Dd(e[s], t, n, r, s)));
    (t.pop(), n.pop());
  } else o = e;
  return o;
}
...
var Od = { includeIndex: !0, includeUnderline: !0, includeFileHeaders: !0 };
function kd(e, t, n, r, i, a, o) {
  ...
  function l(n) {
    ...
    for (let e = 0; e < n.length; e++) {
      let t = n[e],
        i = t.lines || Md(t.value);
      if (((t.lines = i), t.added || t.removed)) {
        if (!s) {
          let t = n[e - 1];
          ((s = d),
            (l = f),
            t && ((u = c > 0 ? r(t.lines.slice(-c)) : []), (s -= u.length), (l -= u.length)));
        }
...
`)
    ...
    return { oldFileName: e, newFileName: t, oldHeader: i, newHeader: a, hunks: o };
  }
}
function Ad(e, t) {
  if (((t ||= Od), Array.isArray(e))) {
    if (e.length > 1 && !t.includeFileHeaders)
      throw Error(
...
`);
  ...
  let n = [];
  (t.includeIndex && e.oldFileName == e.newFileName && n.push(`Index: ` + e.oldFileName),
    t.includeUnderline &&
      n.push(`===================================================================`),
    t.includeFileHeaders &&
      (n.push(`--- ` + e.oldFileName + (e.oldHeader === void 0 ? `` : `	` + e.oldHeader)),
      n.push(`+++ ` + e.newFileName + (e.newHeader === void 0 ? `` : `	` + e.newHeader))));
  for (let t = 0; t < e.hunks.length; t++) {
    let r = e.hunks[t];
    (r.oldLines === 0 && --r.oldStart,
      r.newLines === 0 && --r.newStart,
      n.push(
  ...
  if ((typeof o == `function` && (o = { callback: o }), o?.callback)) {
    ...
    kd(
      ...
      Object.assign(Object.assign({}, o), {
        callback: (e) => {
          s(e ? Ad(e, o.headerOptions) : void 0);
        },
      }),
    );
  } else {
    let s = kd(e, t, n, r, i, a, o);
    return s ? Ad(s, o?.headerOptions) : void 0;
  }
}
function Md(e) {
  let t = e.endsWith(`
...
function Nd({ line: e, spanStart: t, spanLength: n }) {
  return {
...
function Pd({ item: e, arr: t, enableJoin: n, isNeutral: r = !1, isLastItem: i = !1 }) {
  let a = t[t.length - 1];
  if (a == null || i || !n) {
...
function Fd({
  ...
  let s = {
    ...
    unifiedCount: 0,
    shouldBreak() {
      if (!s.isWindowedHighlight) return !1;
      let e = s.unifiedCount >= n + r,
        i = s.splitCount >= n + r;
      return t === `unified` ? e : (t === `split` || e) && i;
    },
    shouldSkip(e, r) {
      if (!s.isWindowedHighlight) return !1;
      let i = s.unifiedCount + e < n,
        a = s.splitCount + r < n;
      return t === `unified` ? i : (t === `split` || i) && a;
    },
    incrementCounts(e, n) {
      ((t === `unified` || t === `both`) && (s.unifiedCount += e),
        (t === `split` || t === `both`) && (s.splitCount += n));
    },
    isInWindow(e, n) {
      if (!s.isWindowedHighlight) return !0;
      let r = s.isInUnifiedWindow(e),
        i = s.isInSplitWindow(n);
      return t === `unified` ? r : t === `split` ? i : r || i;
    },
    isInUnifiedWindow(e) {
      return !s.isWindowedHighlight || (s.unifiedCount >= n - e && s.unifiedCount < n + r);
    },
    isInSplitWindow(e) {
      return !s.isWindowedHighlight || (s.splitCount >= n - e && s.splitCount < n + r);
    },
    emit(e, n = !1) {
      return (
        n ||
          (t === `unified`
            ? s.incrementCounts(1, 0)
            : t === `split`
              ? s.incrementCounts(0, 1)
              : s.incrementCounts(1, 1)),
        o(e) ?? !1
      );
    },
  };
  hunkIterator: for (let [n, r] of e.hunks.entries()) {
    if (s.shouldBreak()) break;
    let o = Id(e.isPartial, r.collapsedBefore, i, n, a),
      c = (() => {
        if (r !== s.finalHunk || !Ld(e)) return;
        let t = e.additionLines.length - (r.additionLineIndex + r.additionCount),
          n = e.deletionLines.length - (r.deletionLineIndex + r.deletionCount);
        if (t !== n)
          throw Error(
            `iterateOverDiff: trailing context mismatch (additions=${t}, deletions=${n}) for ${e.name}`,
          );
        let o = Math.min(t, n);
        return Id(e.isPartial, o, i, e.hunks.length, a);
      })(),
      l = o.fromStart + o.fromEnd;
    function u(e, n) {
      return c == null || c.collapsedLines <= 0 || c.fromStart + c.fromEnd > 0
        ? 0
        : t === `unified`
    ...
    function d() {
      if (o.collapsedLines === 0) return 0;
      let e = o.collapsedLines;
      return ((o.collapsedLines = 0), e);
    }
    if (s.shouldSkip(l, l)) (s.incrementCounts(l, l), d());
    else {
      let e = r.unifiedLineStart - o.rangeSize,
        t = r.splitLineStart - o.rangeSize,
        i = r.deletionLineIndex - o.rangeSize,
        a = r.additionLineIndex - o.rangeSize,
        c = r.deletionStart - o.rangeSize,
        l = r.additionStart - o.rangeSize,
        u = 0;
      for (; u < o.fromStart; ) {
        if (s.isInWindow(0, 0)) {
          if (
            ...
            break hunkIterator;
        } else s.incrementCounts(1, 1);
        u++;
      }
      for (
        e = r.unifiedLineStart - o.fromEnd,
          t = r.splitLineStart - o.fromEnd,
          i = r.deletionLineIndex - o.fromEnd,
          a = r.additionLineIndex - o.fromEnd,
          c = r.deletionStart - o.fromEnd,
          l = r.additionStart - o.fromEnd,
          u = 0;
        u < o.fromEnd;
      ) {
        if (s.isInWindow(0, 0)) {
    ...
    let f = r.unifiedLineStart,
      p = r.splitLineStart,
      m = r.deletionLineIndex,
      h = r.additionLineIndex,
      g = r.deletionStart,
      _ = r.additionStart,
      v = r.hunkContent.at(-1);
    for (let e of r.hunkContent) {
      if (s.shouldBreak()) break hunkIterator;
      let i = e === v;
      if (e.type === `context`) {
        if (s.shouldSkip(e.lines, e.lines)) (s.incrementCounts(e.lines, e.lines), d());
        else {
          let t = 0;
          for (; t < e.lines; ) {
            if (s.isInWindow(0, 0)) {
        ...
        if (!s.shouldSkip(o, a)) {
          ...
          for (let [l, v] of c)
            for (let c = l; c < v; c++) {
              let l = u(
                f + c,
                t === `unified` ? p + (c < e.deletions ? c : c - e.deletions) : p + c,
              );
              if (
                s.emit(
                  zd({
                    ...
                    additionLineIndex: h,
                    deletionLineIndex: m,
                    additionLineNumber: _,
                    deletionLineNumber: g,
                    content: e,
                    isLastContent: i,
                    unifiedCount: o,
                    splitCount: a,
    ...
    if (c != null) {
      let { collapsedLines: t, fromStart: n, fromEnd: r } = c,
        i = n + r,
        a = 0;
      for (; a < i; ) {
        if (s.shouldBreak()) break hunkIterator;
        if (s.isInWindow(0, 0)) {
          ...
          if (
            s.emit({
              ...
              hunk: void 0,
              collapsedBefore: 0,
              collapsedAfter: n ? t : 0,
              type: `context-expanded`,
              deletionLine: {
                lineNumber: g + a,
                lineIndex: m + a,
                noEOFCR: !1,
                unifiedLineIndex: f + a,
                splitLineIndex: p + a,
              },
              additionLine: {
                unifiedLineIndex: f + a,
...
function Id(e, t, n, r, i) {
  if (((t = Math.max(t, 0)), t === 0 || e))
    return { fromStart: 0, fromEnd: 0, rangeSize: t, collapsedLines: Math.max(t, 0) };
  if (n === !0 || t <= i) return { fromStart: t, fromEnd: 0, rangeSize: t, collapsedLines: 0 };
  let a = n?.get(r),
    o = Math.min(Math.max(a?.fromStart ?? 0, 0), t),
    s = Math.min(Math.max(a?.fromEnd ?? 0, 0), t),
    c = o + s,
    l = c >= t;
  return {
    fromStart: l ? t : o,
    fromEnd: l ? 0 : s,
    rangeSize: t,
    collapsedLines: Math.max(t - c, 0),
  };
}
function Ld(e) {
  let t = e.hunks.at(-1);
  return t == null || e.isPartial || e.additionLines.length === 0 || e.deletionLines.length === 0
    ? !1
...
function Rd(e, t, n) {
  if (!e.isWindowedHighlight)
    return [[0, n === `unified` ? t.deletions + t.additions : Math.max(t.deletions, t.additions)]];
  let r = n !== `split`,
    i = n !== `unified`,
  ...
  if (
    ...
    i &&
      (l(s(e.splitCount, t.deletions), `deletions`), l(s(e.splitCount, t.additions), `additions`)),
    o.length === 0)
  )
    return o;
  o.sort((e, t) => e[0] - t[0]);
...
function zd({
  ...
  let g = a < f.deletions ? o + a : void 0,
    ...
    ae =
      y != null && ee != null && g != null
        ? { lineNumber: ee, lineIndex: y, noEOFCR: re, unifiedLineIndex: g, splitLineIndex: v }
        : void 0,
    oe =
      te != null && ne != null && _ != null
        ? { unifiedLineIndex: _, splitLineIndex: v, lineIndex: te, lineNumber: ne, noEOFCR: ie }
        : void 0;
  if (ae == null && oe != null)
    return {
      type: `change`,
  ...
  if (ae == null || oe == null) throw Error(`iterateOverDiff: missing change line data`);
  return {
    type: `change`,
    hunkIndex: e,
    hunk: t,
...
function Vd(
  ...
  let c = i > 0 || a < 1 / 0,
    ...
    u = ju({ theme: n.theme, highlighter: t }),
    d = r && !c && (e.unifiedLineCount > 1e3 || e.splitLineCount > 1e3) ? `none` : n.lineDiffType,
  ...
  function v(e, t, n, r) {
    if (c) {
      ...
      ((e == null || e.targetIndex + e.count !== t) &&
        ((e = { targetIndex: t, originalOffset: r.length, count: 0 }), n.push(e)),
        e.count++);
    }
    r.push(e);
  }
  Fd({
    ...
    callback: ({ hunkIndex: t, additionLine: n, deletionLine: r, type: i }) => {
      ...
      (i === `change` &&
        ...
        r != null &&
          (v(e.deletionLines[r.lineIndex], r.lineIndex, a.deletionSegments, a.deletionContent),
          a.deletionInfo.push({
        ...
        n != null &&
          (v(e.additionLines[n.lineIndex], n.lineIndex, a.additionSegments, a.additionContent),
          a.additionInfo.push({
  ...
  for (let i of g.values()) {
    ...
    let a = { name: e.prevName ?? e.name, contents: i.deletionContent.value },
      ...
      { deletionLines: s, additionLines: c } = Wd({
        deletionFile: a,
...
function Hd({
  ...
  if (
    ...
    t == null ||
    o === `none` ||
    ((e = g(e)), (t = g(t)), e.length > s || t.length > s)
  )
    return;
  let c = o === `char` ? sd(e, t) : Sd(e, t),
    l = [],
    u = [],
    d = o === `word-alt`,
    f = c.at(-1);
  for (let e of c) {
    let t = e === f;
    !e.added && !e.removed
      ? (Pd({ item: e, arr: l, enableJoin: d, isNeutral: !0, isLastItem: t }),
        Pd({ item: e, arr: u, enableJoin: d, isNeutral: !0, isLastItem: t }))
      : e.removed
        ? Pd({ item: e, arr: l, enableJoin: d, isLastItem: t })
        : Pd({ item: e, arr: u, enableJoin: d, isLastItem: t });
  }
  let p = 0;
  for (let e of l)
    (e[0] === 1 && i.push(Nd({ line: n, spanStart: p, spanLength: e[1].length })),
      (p += e[1].length));
  p = 0;
  for (let e of u)
    (e[0] === 1 && a.push(Nd({ line: r, spanStart: p, spanLength: e[1].length })),
      (p += e[1].length));
}
function Ud() {
  return {
...
function Wd({
  ...
  let u = s ?? J(e.name),
    d = s ?? J(t.name),
    { state: f, transformers: p } = Ou(l.useTokenTransformer),
    m =
      typeof c == `string`
        ? {
            ...l,
  ...
  return {
    deletionLines:
      e.contents === ``
        ? []
        : ((m.lang = u), (f.lineInfo = n), (m.decorations = a), Nu(i.codeToHast(g(e.contents), m))),
    additionLines:
      t.contents === ``
        ? []
        : ((m.lang = d), (m.decorations = o), (f.lineInfo = r), Nu(i.codeToHast(g(t.contents), m))),
  };
}
function Gd(e) {
  let t = e.lang ?? J(e.name),
    n = e.lang ?? (e.prevName == null ? `text` : J(e.prevName));
...
function Z(e) {
  ...
  (qd.add(e), (Jd ??= requestAnimationFrame(Xd)));
}
function Xd(e) {
  Yd = !0;
  for (let t of qd)
  ...
  (qd.clear(),
    Kd.size > 0 ? ((qd = new Set(Kd)), Kd.clear(), (Jd = requestAnimationFrame(Xd))) : (Jd = null),
    (Yd = !1));
}
function Zd(e, t) {
  return e == null || t == null ? e === t : e.top === t.top && e.bottom === t.bottom;
}
function Qd({
  scrollTop: e,
  scrollHeight: t,
  ...
  let o = n + a * 2,
    s = i ? n : o;
  if (((t = Math.max(t, s)), o >= t || i)) {
    let n = Math.max(e - r, 0),
      i = Math.min(e + s, t) - r;
    return { top: n, bottom: Math.max(i, n) };
  }
  let c = e + n / 2 - o / 2,
    l = c + o;
  return (
    c < 0 && (c = 0),
    l > t && (l = t),
    (c = Math.floor(Math.max(c - r, 0))),
    { top: c, bottom: Math.ceil(Math.max(Math.min(l, t) - r, c)) }
  );
}
var $d = 1e3,
  ef = $d * 4,
  tf = [0, 1e-6, 0.99999, 1],
  nf = { overscrollSize: $d, intersectionObserverMargin: ef, resizeDebugging: !1 },
  rf = 0,
  af = -1,
  of = class e {
    static __STOP = !1;
          ...
          (window.__TOGGLE = () => {
            e.__STOP
              ? ((e.__STOP = !1),
                ...
                Z(this.computeRenderRangeAndEmit))
              : ((e.__lastScrollPosition = this.getScrollTop()), (e.__STOP = !0));
          }));
        for (let [e, t] of this.connectQueue.entries()) this.connect(e, t);
        (this.connectQueue.clear(), this.markDOMDirty(), Z(this.computeRenderRangeAndEmit));
      }
    }
    instanceChanged(e) {
      (this.instancesChanged.add(e), this.markDOMDirty(), Z(this.computeRenderRangeAndEmit));
    }
    getWindowSpecs() {
      return (
    ...
    handleContainerResize = (e) => {
      ...
      t && Z(this.computeRenderRangeAndEmit);
    };
    setupWindow() {
      ...
      (window.addEventListener(`scroll`, this.handleWindowScroll, { passive: !0 }),
        window.addEventListener(`resize`, this.handleWindowResize, { passive: !0 }),
        this.resizeObserver?.observe(this.root.documentElement));
    }
    setupElement(e) {
      if (this.root == null || this.root instanceof Document)
        throw Error(`Virtualizer.setupElement: Invalid setup method`);
      (this.root.addEventListener(`scroll`, this.handleElementScroll, { passive: !0 }),
        this.resizeObserver?.observe(this.root),
        (e ??= this.root.firstElementChild ?? void 0),
        e instanceof HTMLElement && ((this.contentContainer = e), this.resizeObserver?.observe(e)));
    }
    cleanUp() {
    ...
    getOffsetInScrollContainer(e) {
      return this.getScrollTop() + sf(e, this.getScrollContainerElement());
    }
    connect(e, t) {
    ...
    disconnect(e) {
      ...
      (this.connectQueue.delete(e),
        t != null &&
          ...
          this.visibleInstances.delete(e) && (this.visibleInstancesDirty = !0),
          this.markDOMDirty(),
          Z(this.computeRenderRangeAndEmit)));
    }
    handleWindowResize = () => {
      e.__STOP ||
        ...
        ((this.heightDirty = !0), Z(this.computeRenderRangeAndEmit));
    };
    handleWindowScroll = () => {
      e.__STOP ||
        this.root == null ||
        !(this.root instanceof Document) ||
        ((this.scrollDirty = !0), Z(this.computeRenderRangeAndEmit));
    };
    handleElementScroll = () => {
      e.__STOP ||
        this.root == null ||
    ...
    computeRenderRangeAndEmit = () => {
      ...
      ((this.visibleInstancesDirty = !1), (this.renderedObservers = this.observers.size));
      let n = this.getScrollAnchor(this.height),
        r = new Set();
      for (let e of t ? this.observers.values() : this.visibleInstances.values())
        e.onRender(t) && r.add(e);
      for (let e of this.instancesChanged) r.has(e) || (e.onRender(t) && r.add(e));
      (this.scrollFix(n), this.instancesChanged.size > 0 && this.markDOMDirty());
      for (let e of r) e.reconcileHeights();
      ((this.instancesChanged.size > 0 || t) && Z(this.computeRenderRangeAndEmit),
        r.clear(),
        this.instancesChanged.clear());
    };
    scrollFix(e) {
      ...
      let t = this.getScrollContainerElement(),
        { lineIndex: n, lineOffset: r, fileElement: i, fileOffset: a, fileTypeOffset: o } = e;
      if (n != null && r != null) {
        let e = i.shadowRoot?.querySelector(`[data-line][data-line-index="${n}"]`);
        if (e instanceof HTMLElement) {
          let n = sf(e, t);
          if (n !== r) {
            let e = n - r;
    ...
    getScrollAnchor(e) {
      ...
      for (let [r] of this.visibleInstances.entries()) {
        ...
        let c, l;
        if (a > 0 && i < e)
          for (let e of r.shadowRoot?.querySelectorAll(`[data-line][data-line-index]`) ?? []) {
            if (!(e instanceof HTMLElement)) continue;
    ...
    handleIntersectionChange = (e) => {
      ...
      for (let { target: t, isIntersecting: n } of e) {
        if (!(t instanceof HTMLElement))
          throw Error(`Virtualizer.handleIntersectionChange: target not an HTMLElement`);
        let e = this.observers.get(t);
        if (e == null) throw Error(`Virtualizer.handleIntersectionChange: no instance for target`);
      ...
      this.visibleInstancesDirty && Z(this.computeRenderRangeAndEmit);
    };
    getScrollTop() {
      ...
      let e =
        this.root == null
          ...
          : this.root instanceof Document
            ...
            : this.root.scrollTop;
      return (
        (e = Math.max(0, Math.min(e, this.getScrollHeight() - this.getHeight()))),
        (this.scrollTop = e),
        e
      );
    }
    ...
    markDOMDirty() {
      ((this.scrollDirty = !0), (this.scrollHeightDirty = !0), (this.heightDirty = !0));
    }
...
function lf(e) {
  for (let t of Array.isArray(e) ? e : [e]) if (!On.has(t)) return !1;
  return !0;
}
async function uf(e) {
  let t = [],
  ...
  return (
    n.length > 0 &&
      (await Promise.all(n).then((e) => {
        for (let n of e) {
          if (n == null) throw Error(`resolvedLanguages: unable to resolve language`);
          t.push(n);
        }
      })),
    t
...
function df(e) {
  ...
  for (let n of e) {
    ...
    if (e == null)
      throw Error(
        `getAllResolvedThemes: ${n} is unresolved, you must resolve all necessary themes before calling this function`,
      );
    t.push(e);
  }
  return t;
...
function pf(e, t, n) {
  ...
  for (let n of i) if ((a.delete(n), !r.has(n) && (!(n in t) || e[n] !== t[n]))) return !1;
...
function mf(e, t) {
  let n = e?.theme ?? v,
    ...
    i = hf(e),
    a = hf(t);
  return iu(n, r) && pf(e, t, [`theme`, `parseDiffOptions`]) && pf(i, a);
}
function hf(e) {
  if (e != null && `parseDiffOptions` in e) return e.parseDiffOptions;
}
var gf = { position: `absolute`, top: 0, bottom: 0, textAlign: `center` },
  _f = { display: `contents` };
function vf() {
  return null;
}
...
var $ = t(a(), 1),
  bf = (0, $.createContext)(void 0);
function xf() {
  return (0, $.useContext)(bf);
}
var Sf = t(
    n((e, t) => {
      (function (n, r) {
        ...
        class r {
          ...
          _markEntryAsUsed(e) {
            e !== this.newest &&
              (e[t] && (e === this.oldest && (this.oldest = e[t]), (e[t][n] = e[n])),
              e[n] && (e[n][t] = e[t]),
              (e[t] = void 0),
              (e[n] = this.newest),
          ...
          set(e, r) {
            ...
            return a
              ...
              : (this._keymap.set(e, (a = new i(e, r))),
                this.newest ? ((this.newest[t] = a), (a[n] = this.newest)) : (this.oldest = a),
                (this.newest = a),
                ++this.size,
          ...
          toString() {
            for (var e = ``, n = this.oldest; n; )
              ((e += String(n.key) + `:` + n.value), (n = n[t]), n && (e += ` < `));
            return e;
          }
        }
        e.LRUMap = r;
  ...
  Tf = class {
    ...
    constructor(
      ...
      ((this.options = e),
        ...
        (this.fileCache = new Sf.default.LRUMap(e.totalASTLRUCacheSize ?? 100)),
        (this.diffCache = new Sf.default.LRUMap(e.totalASTLRUCacheSize ?? 100)),
    ...
    async setRenderOptions({
      theme: e = v,
      useTokenTransformer: t = !1,
      lineDiffType: n = `word-alt`,
      maxLineDiffLength: r = 1e3,
      tokenizeMaxLineLength: i = 1e3,
    }) {
      ...
      try {
        ...
        if (
          ...
          !this.isCurrentLifecycle(a) || ad(o, this.renderOptions))
        )
          return;
        let s = eu(e),
          c = [];
        if (
          (iu(o.theme, this.renderOptions.theme) || (c = nu(s) ? df(s) : await ff(s)),
          !this.isCurrentLifecycle(a))
        )
          return;
        if (this.highlighter != null)
          (Kl(c, this.highlighter), await this.setRenderOptionsOnWorkers(o, c));
        else {
          let [e] = await Promise.all([
            Zl({ themes: s, langs: [`text`], preferredHighlighter: this.preferredHighlighter }),
            this.setRenderOptionsOnWorkers(o, c),
          ]);
          if (!this.isCurrentLifecycle(a)) return;
          this.highlighter = e;
        }
        if (!this.isCurrentLifecycle(a)) return;
        ((this.renderOptions = o), this.diffCache.clear(), this.fileCache.clear());
        for (let e of this.themeSubscribers) e.rerender();
      } catch (e) {
        if (e instanceof wf || !this.isCurrentLifecycle(a)) return;
        throw e;
      }
    }
    getFileRenderOptions() {
      let { tokenizeMaxLineLength: e, theme: t, useTokenTransformer: n } = this.renderOptions;
      ...
      for (let r of this.workers) {
        if (!r.initialized)
          throw (
            ...
            Error(`setRenderOptionsOnWorkers: Somehow we have an uninitialized worker`)
          );
        n.push(
          new Promise((n, i) => {
            let a = this.generateRequestId(),
              o = {
                ...
                id: a,
                request: { type: `set-render-options`, id: a, renderOptions: e, resolvedThemes: t },
                resolve: n,
                reject: i,
                requestStart: Date.now(),
              };
            (this.pendingTasks.set(a, o), r.worker.postMessage(o.request));
          }),
        );
      }
      await Promise.all(n);
    ...
    subscribeToThemeChanges(e) {
      return (
        ...
        this.queueBroadcastStateChanges(),
        () => {
          (this.unsubscribeToThemeChanges(e), this.queueBroadcastStateChanges());
        }
      );
    }
    ...
    _broadcastStateChanges = () => {
      this._queuedBroadcast != null &&
        (cancelAnimationFrame(this._queuedBroadcast), (this._queuedBroadcast = void 0));
      let e = this.getStats();
      for (let t of this.statSubscribers) t(e);
    };
    cleanUpPendingTasks(e) {
      this.taskQueue.delete(e);
      let t = this.instanceRequestMap.get(e);
      (t != null && (this.pendingTasks.delete(t), this.instanceRequestMap.delete(e)),
        this.queueBroadcastStateChanges());
    }
    isInitialized() {
      ...
      if (this.initialized !== !0)
        if (this.initialized === !1) {
          ...
          ((this.initialized = new Promise((n, r) => {
            (async () => {
              try {
                let r = eu(this.renderOptions.theme),
                  i = [];
                if (((i = nu(r) ? df(r) : await ff(r)), !this.isCurrentLifecycle(t))) {
                  n();
                  return;
                }
                let a = [];
                if (((a = lf(e) ? cf(e) : await uf(e)), !this.isCurrentLifecycle(t))) {
                  n();
                  return;
                }
                ...
                if (e instanceof wf || !this.isCurrentLifecycle(t)) {
                  n();
                  return;
                }
                ((this.initialized = !1),
                  (this.workersFailed = !0),
                  this.queueBroadcastStateChanges(),
                  r(e));
              }
            })();
    ...
    async initializeWorkers(e, t) {
      ...
      for (let a = 0; a < (this.options.poolSize ?? 8); a++) {
        ...
        (a.addEventListener(`message`, (e) => {
          ...
          a.addEventListener(`error`, (e) => console.error(`Worker error:`, e, o)),
          this.workers.push(o),
          n.push(
            new Promise((n, a) => {
              ...
              (this.pendingTasks.set(s, c), this.executeTask(o, c));
            }),
          ));
      }
      await Promise.all(n);
    ...
    drainQueue = () => {
      if (((this._queuedDrain = void 0), !(this.initialized !== !0 || this.taskQueue.size === 0))) {
        for (let [e, t] of this.taskQueue) {
          if (this.instanceRequestMap.has(e)) continue;
          let n = Df(t),
            r = this.getAvailableWorker(n);
          if (r == null) break;
          (this.assignWorkerToTask(t, r), this.resolveLanguagesAndExecuteTask(r, t, n));
        }
        this.queueBroadcastStateChanges();
      }
    };
    highlightFileAST(e, t) {
      if (!Bu(t)) {
        for (let n of [this.taskQueue, this.pendingTasks.values()])
          for (let r of n)
            if (
              `instance` in r &&
              r.instance === e &&
    ...
    getPlainFileAST(e, t, n, r) {
      ...
      return Lu(e, this.highlighter, this.renderOptions, {
        forcePlainText: !0,
        startingLine: t,
        totalLines: n,
        lines: r,
    ...
    getPlainDiffAST(e, t, n, r, i) {
      return this.highlighter == null
        ? void 0
        : Vd(e, this.highlighter, this.renderOptions, {
            forcePlainText: !0,
            startingLine: t,
            totalLines: n,
            expandedHunks: r,
    ...
    cancelPendingAsyncWorkerTasks() {
      let e = new wf();
      for (let t of this.pendingTasks.values()) `reject` in t && t.reject(e);
    }
    terminateWorkers() {
    ...
    getStats() {
      return {
        ...
        busyWorkers: this.workers.filter((e) => e.request_id != null).length,
    ...
    submitTask(e, t) {
      ...
      (this.taskQueue.set(e, i), this.queueDrain());
    }
    async resolveLanguagesAndExecuteTask(e, t, n) {
      try {
        ...
        (r.length > 0 &&
          (lf(r)
            ? (t.request.resolvedLanguages = cf(r))
            : (t.request.resolvedLanguages = await uf(r))),
    ...
    handleWorkerMessage(e, t) {
      let n = this.pendingTasks.get(t.id);
      try {
        if (n == null) throw Cf;
        if (t.type === `error`) {
          let e = Error(t.error);
          throw (
            ...
            `reject` in n ? n.reject(e) : n.instance.onHighlightError(e),
            e
          );
        } else {
          if (`instance` in n && this.instanceRequestMap.get(n.instance) !== t.id) throw Cf;
          switch (t.requestType) {
            case `initialize`:
              if (n.type !== `initialize`)
                throw Error(`handleWorkerMessage: task/response dont match`);
            ...
            case `set-render-options`:
              ...
              break;
            case `file`: {
              if (n.type !== `file`) throw Error(`handleWorkerMessage: task/response dont match`);
              let { result: r, options: i } = t,
                { instance: a, request: o } = n;
              (this.syncCustomExtensionVersion(e, o),
                o.file.cacheKey != null &&
                  this.fileCache.set(o.file.cacheKey, { result: r, options: i }),
                a.onHighlightSuccess(o.file, r, i));
              break;
            }
            case `diff`: {
              if (n.type !== `diff`) throw Error(`handleWorkerMessage: task/response dont match`);
              let { result: r, options: i } = t,
                { instance: a, request: o } = n;
              (this.syncCustomExtensionVersion(e, o),
                o.diff.cacheKey != null &&
                  this.diffCache.set(o.diff.cacheKey, { result: r, options: i }),
                a.onHighlightSuccess(o.diff, r, i));
              break;
            }
          }
        }
      } catch (e) {
        e !== Cf && console.error(e, n, t);
      }
      (this.cleanWorkerAndTask(e, n),
        this.queueBroadcastStateChanges(),
        this.taskQueue.size > 0 && this.queueDrain());
    }
    _queuedDrain;
    queueDrain() {
      this._queuedDrain ??
    ...
    assignWorkerToTask(e, t) {
      ((t.request_id = e.id),
        `instance` in e &&
          (this.taskQueue.delete(e.instance), this.instanceRequestMap.set(e.instance, e.id)),
        this.pendingTasks.set(e.id, e));
    }
    cleanWorkerAndTask(e, t) {
      ((e.request_id = void 0),
        t != null &&
          (`instance` in t && this.instanceRequestMap.delete(t.instance),
          this.pendingTasks.delete(t.id)));
    }
    executeTask(e, t) {
      (Ef(t.request) && this.maybeAttachCustomExtensions(e, t.request),
        this.assignWorkerToTask(t, e));
      for (let n of Df(t)) e.langs.add(n);
      try {
        e.worker.postMessage(t.request);
      } catch (n) {
        (this.cleanWorkerAndTask(e, t),
          console.error(`Failed to post message to worker:`, n),
          `instance` in t ? t.instance.onHighlightError(n) : `reject` in t && t.reject(n));
      }
      this.queueBroadcastStateChanges();
    }
    maybeAttachCustomExtensions(e, t) {
      ...
      e.customExtensionsVersion >= n ||
        ((t.customExtensionsVersion = n), (t.customExtensionMap = gu()));
    }
    syncCustomExtensionVersion(e, t) {
      t.customExtensionsVersion != null && (e.customExtensionsVersion = t.customExtensionsVersion);
    }
    getAvailableWorker(e) {
      let t;
      for (let n of this.workers) {
        if (n.request_id != null || !n.initialized) continue;
...
function Df(e) {
  ...
  switch (e.type) {
    case `file`:
      t.add(e.request.file.lang ?? J(e.request.file.name));
      break;
    case `diff`:
      (t.add(e.request.diff.lang ?? J(e.request.diff.name)),
        t.add(e.request.diff.lang ?? J(e.request.diff.prevName ?? `-`)));
      break;
  }
  return (t.delete(`text`), Array.from(t));
}
var Of;
function kf({ poolOptions: e, highlighterOptions: t }) {
  return ((Of ??= new Tf(e, t)), Of);
}
function Af() {
  Of != null && (Of.terminate(), (Of = void 0));
}
var jf = (0, $.createContext)(void 0),
  Mf = 0;
function Nf({ children: e, poolOptions: t, highlighterOptions: n }) {
  let [r] = (0, $.useState)(() => {
    if (!(typeof window > `u`)) return kf({ poolOptions: t, highlighterOptions: n });
  });
  return (
    ...
    (0, Q.jsx)(jf.Provider, { value: r, children: e })
  );
}
function Pf() {
  return (0, $.useContext)(jf);
}
function Ff(e) {
  let t = (0, $.useRef)(e);
  return (
    (0, $.useInsertionEffect)(() => void (t.current = e)),
    (0, $.useCallback)((...e) => t.current(...e), [])
  );
}
var If = `var(--color-token-main-surface-primary)`,
  Lf = `var(--color-token-diff-surface)`,
  Rf = `
  --opaline-diffs-surface: ${If};
  --opaline-diffs-context-surface: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 94%,
  var(--color-token-main-surface-primary)
);
  --opaline-diffs-separator-surface: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 94%,
  var(--color-token-text-link-foreground)
);
  --opaline-diffs-hover-surface: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 92%,
  var(--color-token-main-surface-primary)
);
  --opaline-diffs-header-surface: var(--opaline-diffs-surface);
  --opaline-diffs-context-number: color-mix(
  in lab,
  var(--opaline-diffs-surface) 98.5%,
  var(--diffs-mixer)
);
  --opaline-diffs-addition-number: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 91%,
  var(--diffs-addition-color-override)
);
  --opaline-diffs-deletion-number: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 91%,
  var(--diffs-deletion-color-override)
);
  --diffs-bg-context-override: var(--opaline-diffs-context-surface);
  --diffs-bg-separator-override: var(--opaline-diffs-separator-surface);
  --diffs-bg-hover-override: var(--opaline-diffs-hover-surface);
  --diffs-bg-addition-override: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 88%,
  var(--diffs-addition-color-override)
);
  --diffs-bg-addition-number-override: var(--opaline-diffs-addition-number);
  --diffs-bg-deletion-override: color-mix(
  in srgb,
  var(--opaline-diffs-surface) 88%,
  var(--diffs-deletion-color-override)
);
  --diffs-bg-deletion-number-override: var(--opaline-diffs-deletion-number);
`;
function zf({ includeDiffHeader: e, includeSimpleLineSeparators: t, rootSelector: n, surface: r }) {
  return `
  ${
    e
      ? `[data-diffs-header],
  ...
  mark.opaline-thread-find-match {
  ...
  mark.opaline-thread-find-active {
...
function Bf(e, t) {
  return e ? (t === `diff` ? Lf : If) : `var(--color-token-side-bar-background)`;
}
var Vf = `` + new URL(`worker-BF8EmMYz.js`, import.meta.url).href;
function Hf() {
  return new Worker(Vf, { type: `module` });
}
var Uf = l(),
  Wf = 4,
  Gf = 100,
  Kf = [`typescript`, `javascript`, `css`, `html`, `python`];
function qf(e) {
  let t = (0, Uf.c)(13),
    { children: n } = e,
    i = re(ne()),
    a = u(r.lightCodeThemeId),
    o = u(r.darkCodeThemeId),
    s = c(y),
    l;
  t[0] !== i || t[1] !== o || t[2] !== a
    ? ((l = i === `light` ? f(a, `light`) : f(o, `dark`)),
      (t[0] = i),
      (t[1] = o),
      (t[2] = a),
      (t[3] = l))
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = { workerFactory: Hf, poolSize: Wf, totalASTLRUCacheSize: Gf }), (t[4] = m))
    : (m = t[4]);
  let h, g;
  t[5] !== p || t[6] !== d
    ? ((h = { theme: d, lineDiffType: p, langs: Kf }),
      (g = (0, Q.jsx)(Jf, { lineDiffType: p, theme: d })),
      (t[5] = p),
      (t[6] = d),
      (t[7] = h),
      (t[8] = g))
  ...
  return (
    t[9] !== n || t[10] !== h || t[11] !== g
      ? ((_ = (0, Q.jsxs)(Nf, { poolOptions: m, highlighterOptions: h, children: [g, n] })),
        (t[9] = n),
        (t[10] = h),
        (t[11] = g),
        (t[12] = _))
...
function Xf(e) {
  ...
  let r;
  return (
    t[0] === n ? (r = t[1]) : ((r = (0, Q.jsx)(qf, { children: n })), (t[0] = n), (t[1] = r)),
    r
  );
}
export {
...
//# sourceMappingURL=shiki-highlight-provider-gate-BIr7ajST.js.map

...
function* m() {
  ...
  do
    for (t = n.reverse(), n = []; (e = t.pop()); )
      if ((yield e, (r = e.children))) for (i = 0, a = r.length; i < a; ++i) n.push(r[i]);
  while (n.length);
}
function h(e, t) {
  e instanceof Map ? ((e = [void 0, e]), t === void 0 && (t = v)) : t === void 0 && (t = _);
  for (var n = new x(e), r, i = [n], a, o, s, c; (r = i.pop()); )
    if ((o = t(r.data)) && (c = (o = Array.from(o)).length))
      for (r.children = o, s = c - 1; s >= 0; --s)
        (i.push((a = o[s] = new x(o[s]))), (a.parent = r), (a.depth = r.depth + 1));
...
function E(e, t, n, r, i) {
  for (var a = e.children, o, s = -1, c = a.length, l = e.value && (r - t) / e.value; ++s < c; )
    ((o = a[s]), (o.y0 = n), (o.y1 = i), (o.x0 = t), (o.x1 = t += o.value * l));
}
function D(e, t, n, r, i) {
  for (var a = e.children, o, s = -1, c = a.length, l = e.value && (i - n) / e.value; ++s < c; )
...
function k(e, t, n, r, i, a) {
  for (
    ...
    while (!g && d < f);
    for (
      _ = v = g, x = Math.max(m / p, p / m) / (h * e), S = g * g * x, b = Math.max(v / S, S / _);
      d < f;
      ++d
    ) {
      if (
    ...
    (o.push((c = { value: g, dice: p < m, children: s.slice(u, d) })),
      c.dice
        ? E(c, n, r, i, h ? (r += (m * g) / h) : a)
        : D(c, n, r, h ? (n += (p * g) / h) : i, a),
      (h -= g),
      (u = d));
  }
  return o;
...
function j() {
  ...
  return (
    ...
    (u.paddingTop = function (e) {
      return arguments.length ? ((o = typeof e == `function` ? e : w(+e)), u) : o;
    }),
    (u.paddingRight = function (e) {
      return arguments.length ? ((s = typeof e == `function` ? e : w(+e)), u) : s;
    }),
    (u.paddingBottom = function (e) {
      return arguments.length ? ((c = typeof e == `function` ? e : w(+e)), u) : c;
    }),
    (u.paddingLeft = function (e) {
      return arguments.length ? ((l = typeof e == `function` ? e : w(+e)), u) : l;
    }),
    u
  );
}
export { h as a, T as i, A as n, E as r, j as t };
//# sourceMappingURL=treemap-BYFuMAdb.js.map

import { A as e, _ as t, l as n, lt as r, u as i, v as a } from "./vscode-api-sUstfl-x.js";
import { u as o } from "./statsig-Cajk3UKk.js";
import { a as s, t as c } from "./request-BXHjsnqU.js";
...
function b({ accountStructure: e, plan: t, workspaceName: n }) {
  let r = H(n);
...
function ee({ dailyUsage: e, todayIso: t, view: n }) {
  let r = F(e, t);
  switch (n) {
    case `cumulative`:
      return ne(r);
...
function T({ dailyUsage: e, todayIso: t }) {
  let n = O(t),
    ...
    a = new Map(Array.from({ length: r }, (e, t) => [B(n, t * 7), t]));
  for (let n of e) {
    if (n.date > t) continue;
    let e = a.get(I(n.date));
    e != null && (i[e] += Math.max(0, n.credits));
  }
  return i;
}
function te({ dailyUsage: e, todayIso: t }) {
  return N(T({ dailyUsage: e, todayIso: t }));
}
function E(e = new Date()) {
  return e.toISOString().slice(0, 10);
}
function D(e) {
  let t = new Date(`${I(e)}T00:00:00.000Z`).getTime(),
    n = new Date(`${d}T00:00:00.000Z`).getTime(),
    r = Math.floor((t - n) / (10080 * 60 * 1e3));
  return Math.min(u, Math.max(1, r + 1));
}
function O(e) {
  return B(I(e), -(D(e) - 1) * 7);
}
function k(e, t) {
  return B(O(t), e);
}
...
function F(e, t) {
  let n = z(e),
    r = O(t);
  return Array.from({ length: D(t) * 7 }, (e, t) => n.get(B(r, t)) ?? 0);
}
function I(e) {
...
var U = r(),
  W = `3503973010`,
  G = `profile_usage_query_stale_time_ms`,
  K = `profile_usage_warm_fetch_enabled`,
  q = class extends Error {
    constructor(e) {
      (super(`Profile photo upload failed`), (this.uploadError = e));
    }
  };
function J({ accountId: e, userId: t }) {
  return [`profile`, `usage`, t ?? null, e ?? null];
}
function Y(e) {
  let t = (0, U.c)(9),
    { accountId: n, enabled: r, userId: s } = e,
    c = o(W),
    l;
  t[0] === c ? (l = t[1]) : ((l = c.get(G, i.SIX_HOURS)), (t[0] = c), (t[1] = l));
  let u = l,
    d;
  t[2] !== n || t[3] !== s
    ? ((d = J({ accountId: n, userId: s })), (t[2] = n), (t[3] = s), (t[4] = d))
    : (d = t[4]);
  let f = r && !0,
    p;
  return (
    t[5] !== u || t[6] !== d || t[7] !== f
      ? ((p = { queryKey: d, enabled: f, queryFn: oe, staleTime: u }),
        (t[5] = u),
        (t[6] = d),
        (t[7] = f),
        (t[8] = p))
...
function X() {
  let e = (0, U.c)(2),
    t = o(W),
    n;
  return (e[0] === t ? (n = e[1]) : ((n = t.get(K, !0)), (e[0] = t), (e[1] = n)), n);
}
function re(n) {
  let r = (0, U.c)(6),
    { accountId: i, userId: a } = n,
    o = e(),
    s;
  r[0] !== i || r[1] !== a
    ? ((s = J({ accountId: i, userId: a })), (r[0] = i), (r[1] = a), (r[2] = s))
    : (s = r[2]);
  let c = s,
    l;
  return (
    ...
    r[3] !== o || r[4] !== c
      ? ((l = {
          ...
          onSuccess: (e, t) => {
            ...
            n != null && o.setQueryData(c, { ...n, username: x(t) || null });
          },
        }),
        (r[3] = o),
        (r[4] = c),
...
async function oe() {
  let e = await c.safeGet(`/wham/profiles/me`);
  return {
    dailyUsage:
...
async function Z(e) {
  ...
  return (
    await n
      .getInstance()
      .post(`/wham/profiles/me/photo`, s(await de(e, t)), {
...
async function le(e) {
  let t = C(e);
  if (!t.ok) throw new l(t.reason);
  await Q({ username: t.username });
}
async function Q(e) {
  return c.safePatch(`/wham/profiles/me`, { requestBody: e });
}
function ue(e, t, n) {
...
function fe() {
  return typeof crypto < `u` && `randomUUID` in crypto
    ? `----opaline-profile-photo-${crypto.randomUUID()}`
    : `----opaline-profile-photo-${Math.random().toString(36).slice(2)}`;
}
function pe(e) {
  let t = 0;
...
//# sourceMappingURL=profile-queries-CdFCWyeF.js.map

...
import { t as o } from "./chevron-right-BZtXyaBk.js";
var s = r(),
  c = e(t(), 1),
  l = n();
function u(e) {
  ...
  t[0] === a
    ...
    : ((c = a.formatMessage({
      ...
      (t[1] = c));
  let u;
  t[2] === n ? (u = t[3]) : ((u = n.map(d)), (t[2] = n), (t[3] = u));
  let f;
  t[4] !== n.length || t[5] !== r
    ? ((f =
        r == null
          ...
          : (0, l.jsxs)(l.Fragment, {
              children: [
                n.length > 0
                  ? (0, l.jsx)(o, { "aria-hidden": !0, className: `icon-xs shrink-0` })
                  : null,
                (0, l.jsx)(`span`, {
                  "aria-current": `page`,
...
function d(e, t) {
  return (0, l.jsxs)(
    ...
    {
      children: [
        t > 0 ? (0, l.jsx)(o, { "aria-hidden": !0, className: `icon-xs shrink-0` }) : null,
        (0, l.jsx)(a, {
          className: `min-w-0`,
          color: `ghost`,
          size: `toolbar`,
          onClick: e.onClick,
          children: (0, l.jsx)(`span`, { className: `min-w-0 truncate`, children: e.label }),
        }),
      ],
    },
    e.id,
...
export { u as t };
//# sourceMappingURL=toolbar-breadcrumb-6vAQnE7b.js.map

          ...
          children:
            n === `binary`
              ...
              : n === `rename-without-changes`
                ? (0, R.jsx)(C, {
                    id: `opaline.diff.fileRenamedWithoutChanges`,
...
function et(e) {
  ...
  t[80] !== Be || t[81] !== Ve
    ...
    : (rn = t[82]);
  let an = `var(--opaline-diffs-surface-override, ${rn})`,
    on = Be ? `var(--opaline-diffs-surface)` : void 0,
    sn;
  t[83] !== an || t[84] !== on
    ? ((sn = { "--opaline-diffs-surface": an, backgroundColor: on }),
      (t[83] = an),
      (t[84] = on),
      (t[85] = sn))
    : (sn = t[85]);
...
function rt(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = { backgroundColor: `var(--opaline-diffs-surface)` }), (t[15] = se))
    : (se = t[15]);
  ...
  t[16] === x
    ...
    : ((D = x
        ...
        : { backgroundColor: `var(--opaline-diffs-header-surface)` }),
      (t[16] = x),
      (t[17] = D));
  let le = x
      ? `rounded-[6px] py-0.5 px-0.5 hover:bg-[var(--opaline-diffs-separator-surface)]`
      : `px-[var(--opaline-diffs-header-padding-x,1rem)] py-[var(--opaline-diffs-header-padding-y,0.25rem)] hover:bg-token-list-hover-background/30`,
    O;
  t[18] === le
    ? (O = t[19])
    : ((O = h(
...
function it(e) {
  ...
  t[0] !== n?.ariaLabel || t[1] !== i
    ? ((a =
        n?.ariaLabel ??
        i.formatMessage({
          id: `opaline.diff.fileHeader.openInIcon`,
  ...
  t[3] !== n?.tooltip || t[4] !== i
    ? ((s =
        n?.tooltip ??
        i.formatMessage({
          id: `opaline.diff.fileHeader.openIn.tooltip`,
...
function lt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, R.jsx)(`span`, {
        ...
        children: (0, R.jsx)(C, {
          id: `opaline.diff.openInEditorPrompt.singleLine`,
  ...
  t[1] !== n || t[2] !== r
    ? ((a = n
        ? (0, R.jsx)(T, {
            ...
            onClick: r,
            children: (0, R.jsx)(C, {
              id: `opaline.diff.openInEditorPrompt.openButton`,
              defaultMessage: `Open in editor`,
...
function ut(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, R.jsx)(`span`, {
        className: `sr-only`,
        children: (0, R.jsx)(C, {
          id: `opaline.review.diff.loading`,
...
function ft(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, R.jsx)(`span`, {
        ...
        children: (0, R.jsx)(C, {
          id: `opaline.review.diff.loadFailedAfterRetrying`,
...
function pt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, R.jsx)(`span`, {
        className: `text-token-text-secondary`,
        children: (0, R.jsx)(C, {
          id: `opaline.review.diff.fullContentLoadFailed`,

import { Ho as e, bc as t } from "./app-server-manager-signals-BOGyjFm3.js";
...
async function s({ hostId: n = e, signal: r, useStreamlinedLogin: i }) {
  let a = l(r);
  return n === `local`
    ? t(`login-with-chatgpt`, { abortController: a, useStreamlinedLogin: i })
    : t(`login-with-chatgpt-for-host`, { abortController: a, hostId: n, useStreamlinedLogin: i });
}
function c({ signal: e } = {}) {
  return t(`login-with-chatgpt-device-code`, { abortController: l(e) });
}
function l(e) {
  ...
  if (r) {
    ...
    t[1] === _
      ...
      : ((r = _.formatMessage({
        ...
        (t[2] = r));
    let i;
    t[3] === p ? (i = t[4]) : ((i = (e) => p(e.target.value)), (t[3] = p), (t[4] = i));
    let c;
    t[5] !== n || t[6] !== r || t[7] !== i
      ? ((c = (0, d.jsxs)(`label`, {
    ...
    let m;
    t[12] !== n || t[13] !== s
      ? ((m = n.trim().length === 0 || s), (t[12] = n), (t[13] = s), (t[14] = m))
      : (m = t[14]);
    let h;
    ...
    let y;
    t[20] !== u || t[21] !== v
      ? ((y = (0, d.jsxs)(`div`, { className: `flex items-center gap-2`, children: [u, v] })),
        (t[20] = u),
        (t[21] = v),
        (t[22] = y))
      : (y = t[22]);
    ...
    return (
      t[23] !== c || t[24] !== y
        ? ((b = (0, d.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [c, y] })),
          (t[23] = c),
          (t[24] = y),
          (t[25] = b))
        : (b = t[25]),
...
export { c as n, s as r, f as t };
//# sourceMappingURL=onboarding-login-content-DhtcviP9.js.map

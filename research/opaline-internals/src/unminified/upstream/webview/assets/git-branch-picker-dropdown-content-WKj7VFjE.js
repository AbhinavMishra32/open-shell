...
import { Gn as t, Ht as n, S as r } from "./src-CYrn1fYL.js";
import {
  C as i,
  Hn as a,
  Ma as o,
...
import { c as ie, o as I, r as ae } from "./lib-MoKmYgcO.js";
import { m as oe } from "./chunk-LFPYN7LY-DwFbyqR1.js";
import { t as se } from "./branch-CGmrzqEi.js";
import { g as ce, t as le, v as ue } from "./persisted-signal-Cx1QgqJn.js";
import { a as de } from "./thread-context-inputs-BUuWvrJW.js";
import { t as fe } from "./use-debounced-value-DkRRYvDv.js";
import { r as L } from "./toast-signal-By11REe1.js";
import { r as pe, t as R } from "./tooltip-BhXPONlb.js";
import { t as z } from "./route-scope-BCJTBhwV.js";
import { c as me } from "./prompt-text-CsQ_-ZN9.js";
import { a as he } from "./use-model-settings-ctdtUCGA.js";
import { t as B } from "./button-Xd4Hy1MO.js";
import { a as ge, t as _e } from "./setting-storage-Cel8Tr7E.js";
import { t as ve } from "./spinner-Dvc_A3Ae.js";
import { t as ye } from "./proxy-DktXrBt_.js";
import { t as be } from "./x-DypUcSQe.js";
import { t as xe } from "./sumBy-DhBnMLcX.js";
import { i as Se, n as Ce } from "./git-current-branch-query-VkU7ix9i.js";
import { t as V } from "./app-intl-signal-DF17N7z2.js";
import { t as we } from "./with-window-DPMmD2K-.js";
import { n as Te } from "./check-git-index-for-changes-6WWLEsel.js";
import { t as Ee } from "./copy-to-clipboard-q_KxH8lM.js";
import { d as De, l as Oe, n as H } from "./dialog-layout-CCvvb1Vc.js";
import { t as ke } from "./check-md-CZTnvSiA.js";
import { n as Ae } from "./electron-menu-shortcuts-CGQ9azZA.js";
import { t as je } from "./checkbox-Bz6PC7ig.js";
import { r as U, t as Me } from "./dropdown-CHaZfyxI.js";
import { t as Ne } from "./chevron-D6hquBJC.js";
import { t as Pe } from "./copy-Bnv7rlOa.js";
import { t as Fe } from "./plus-_AqggHDM.js";
import { n as Ie, t as Le } from "./gh-cli-status-query-BaEZIynd.js";
import { n as Re } from "./dist-fk-6hqz4.js";
import { n as ze } from "./use-git-default-branch-CGx2UfAz.js";
import { n as Be } from "./diff-stats-RCuB___W.js";
import { t as Ve } from "./send-to-cloud-DV9amx77.js";
import { t as He } from "./opaline-analytics-attribution-BanxoePb.js";
import { i as Ue, r as We, t as Ge } from "./gh-pull-request-status-query-Bvqblflw.js";
function Ke(e) {
  ...
  return Number.isFinite(i)
    ? { percent: i, usedTokens: r, contextWindow: t, remainingTokens: Math.max(t - r, 0) }
    : { percent: null, usedTokens: null, contextWindow: null, remainingTokens: null };
}
var W = te();
function qe(e) {
  let n = (0, W.c)(31),
    ...
    u = ie(),
    d;
  n[0] === i ? (d = n[1]) : ((d = _(i)), (n[0] = i), (n[1] = d));
  let f = d,
    p = r ?? ``,
    h;
  n[2] !== f || n[3] !== p
    ? ((h = [`git`, `init-repo`, f, p]), (n[2] = f), (n[3] = p), (n[4] = h))
    : (h = n[4]);
  let g;
  n[5] !== r || n[6] !== i
    ? ((g = async () => {
        ...
        await m(`git`).request({
          ...
          params: { cwd: t(r), hostConfig: i, operationSource: `review_model` },
        });
      }),
      (n[5] = r),
      (n[6] = i),
    ...
    : (g = n[7]);
  let v;
  n[8] !== r || n[9] !== f || n[10] !== u || n[11] !== l || n[12] !== c
    ? ((v = async () => {
        c.get(L).success(
          u.formatMessage({
            id: `opaline.review.noDiff.gitInit.success`,
            defaultMessage: `Git repository created`,
            description: `Toast shown after creating a git repository from the diff empty state`,
          }),
        );
        let e = [l.invalidateQueries({ queryKey: ne(`git-origins`) })];
        (r != null && e.push(l.invalidateQueries({ queryKey: [`git`, `metadata`, f, r] })),
          await Promise.all(e));
      }),
      (n[8] = r),
      (n[9] = f),
  ...
  n[14] !== u || n[15] !== a || n[16] !== c || n[17] !== s
    ...
    : (y = n[18]);
  let b;
  n[19] !== h || n[20] !== g || n[21] !== v || n[22] !== y
    ? ((b = { mutationKey: h, mutationFn: g, onSuccess: v, onError: y }),
      (n[19] = h),
      (n[20] = g),
      (n[21] = v),
      (n[22] = y),
  ...
  let w = S,
    ...
    E;
  return (
    n[27] !== w || n[28] !== x.isPending || n[29] !== T
      ? ((E = {
          canCreateGitRepository: T,
          createGitRepository: w,
...
var Je = Se({
    ...
    getOptions: () => ({ select: (e) => e.exists, staleTime: re.FIVE_SECONDS }),
  }).fromCwd$,
  Ye = { type: `loading` },
  Xe = { type: `error` },
  Ze = Se({
  ...
  K = O(
    ...
    (e, { get: t }) => {
      let n = { ...e, enabled: !0 },
        r = t(h, { ...n, watchForGitInit: !1 }),
        i = t(Ze.fromCwd$, n),
        a = t(G.fromCwd$, n),
        o = t(Qe.fromCwd$, n);
      if (r.isError || i.isError || a.isError || o.isError) return Xe;
      if (!r.isSuccess || !i.isSuccess || !a.isSuccess || !o.isSuccess) return Ye;
      let s = r.data,
        c = i.data,
        l = a.data;
...
function $e(e, t) {
  let n = { ...t, enabled: !0 };
  return Promise.all([e.get(Ze.fromCwd$, n).refetch(), e.get(G.fromCwd$, n).refetch()]);
}
function et(e) {
  ...
  switch (n.kind) {
    case `commit`: {
      ...
      return (
        t[0] === n.reason
          ? (e = t[1])
          : ((e = (0, q.jsx)(rt, { reason: n.reason })), (t[0] = n.reason), (t[1] = e)),
        e
      );
    }
    case `push`: {
      ...
      return (
        t[2] === n.reason
          ? (e = t[3])
          : ((e = (0, q.jsx)(it, { reason: n.reason })), (t[2] = n.reason), (t[3] = e)),
        e
      );
    }
    case `create-pr`: {
      ...
      return (
        t[4] === n.reason
          ? (e = t[5])
          : ((e = (0, q.jsx)(at, { reason: n.reason })), (t[4] = n.reason), (t[5] = e)),
        e
      );
    }
  }
...
function lt({ hasSomeUncommittedChanges: e, isChangesLoading: t, isChangesUnavailable: n }) {
  switch (!0) {
    case t:
...
function mt(e, t) {
  let n = ht(e),
    r = t.flatMap((e) =>
      e?.type === `success`
        ? e.files.filter((e) => [e.path, e.previousPath].some((e) => e != null && ht(e) === n))
        : [],
    );
  return r.length === 0
    ? null
...
var gt = A(z, (e) =>
  ...
  bt = O(z, (e, { get: t }) => {
    ...
    return r == null
      ? v(n)
      : t(_t, { commonDir: r.commonDir, cwd: e.cwd, hostConfig: e.hostConfig, root: r.root });
  }),
  xt = O(z, (e, { get: t }) => {
  ...
  wt = O(z, (e, { get: t }) => {
    let n = t(K, Et(e));
    return ut({ pushStatus: n.type === `success` ? n.data : void 0, ignoreNothingToPush: !0 });
  }),
  Tt = O(z, (e, { get: t }) => {
    let n = t(K, Et(e)),
      ...
      u = t(Ge, s),
      d = dt({ ghCliAvailability: l, hasOpenPr: u, isLoadingPRStatus: c.isLoading, pushStatus: r }),
      f = dt({
      ...
      m = ct({ ...p, createsBranch: e.createsBranch, includeLocalChanges: e.includeLocalChanges });
    return {
      blockedStep: Ot({
        ...p,
        commitBlockedReason: i,
...
var kt = new Map(),
  Y = w(P, (e) => null),
  X = w(P, (e) => ``),
  At = le(`git-action-include-unstaged-changes`, !0),
  jt = w(P, (e) => ``),
  Mt = w(P, (e) => ``),
  Nt = w(P, (e) => !0);
function Pt(e, t) {
  (e.set(jt, t, ``), e.set(Mt, t, ``), e.set(Nt, t, !0));
}
function Ft(e) {
  let t = new AbortController();
  return (kt.set(Rt(e), t), t.signal);
}
function It(e) {
  kt.get(Rt(e))?.abort();
}
function Lt(e, t) {
  kt.get(Rt(e))?.signal === t && kt.delete(Rt(e));
}
function Rt(e) {
  return JSON.stringify([e.hostId, e.cwd]);
}
function zt({ currentBranch: e, storedThreadBranch: t }) {
  let n = e?.trim() ?? ``,
    r = t?.trim() ?? ``;
  return {
    currentBranchName: n,
...
var Z = k(`LocalGitActionsScope`, {
  ...
  Wt = O(z, (e, { get: t }) => {
    ...
    return zt({
      currentBranch: n.data ?? (r.type === `success` ? (r.data.branch ?? null) : null),
      storedThreadBranch: t(i, e.conversationId),
    }).currentBranchName;
  }),
  Gt = O(z, (e, { get: t }) => t(Ue, un(e, t(Wt, e)))),
  Kt = O(z, (e, { get: t }) => t(Ge, un(e, t(Wt, e)))),
  qt = O(
    z,
    (e, { get: t }) =>
      zt({ currentBranch: t(Wt, e), storedThreadBranch: t(i, e.conversationId) })
  ...
  Yt = E(Z, ({ get: e, scope: t }) => ({
    opalineWorktree: t.value.opalineWorktree,
    conversationId: t.value.conversationId,
    cwd: t.value.cwd,
    hostConfig: e(de, t.value.hostId),
  })),
  Xt = E(Z, ({ get: e, scope: t }) => e(Y, { cwd: t.value.cwd, hostId: t.value.hostId })),
  Zt = E(Z, ({ get: e }) => e(St, { ...e(Yt), includeUnstaged: !0 })),
  Qt = O(z, (e, { get: t }) => {
    let n = t(Ht, e);
    ...
    if (i) {
      ...
      if (t(St, { ...e, includeUnstaged: !0 }) != null && (r?.commitsAhead ?? 0) === 0)
        return `hidden`;
    } else {
      let n = t(Ut, e).data;
    ...
    return t(Tt, {
      ...
      hostConfig: e.hostConfig,
      createsBranch: i,
      includeLocalChanges: t(Nt, { cwd: e.cwd, hostId: e.hostConfig.id }),
    }).blockedStep == null
      ? `enabled`
      : `disabled`;
  }),
  $t = E(Z, ({ get: e }) => e(Qt, e(Yt))),
  en = E(Z, ({ get: e }) => {
    let t = e(Yt),
      n = e(K, {
        cwd: t.cwd,
    ...
    return t.opalineWorktree && r != null && (!a || a === r.defaultBranch);
  }),
  tn = E(Z, ({ get: e }) => e(en) && !e(Jt, e(Yt))),
  nn = E(Z, ({ get: e }) => {
    let t = e(Yt),
      n = e(Zt),
      r = e(Ct, t),
      i = e(wt, t);
    return r == null || (n == null && i == null) || (e(en) && n == null) ? null : r;
  }),
  rn = E(Z, ({ get: e }) => {
    let t = e(Yt);
    return e(Tt, {
      cwd: t.cwd,
      hostConfig: t.hostConfig,
      createsBranch: e(en) || e(Jt, t),
      includeLocalChanges: e(Nt, { cwd: t.cwd, hostId: t.hostConfig.id }),
    }).blockedStep;
  }),
  an = E(Z, ({ get: e }) => {
    let t = e(Yt);
    return t.opalineWorktree && e(Ht, t).isLoading;
  });
function on(e) {
  if (e.get(en)) {
    (e.set(Vt, `commit`), e.set(Bt, `worktree-branch-setup`));
    return;
  }
  e.set(Bt, `commit`);
}
function sn(e) {
  if (e.get(tn)) {
    (e.set(Vt, `create-pr`), e.set(Bt, `worktree-branch-setup`));
    return;
  }
  e.set(Bt, `create-pr`);
}
function cn(e) {
  (e.set(Vt, null), e.set(Bt, `worktree-branch-setup`));
}
function ln(e) {
  let t = e.get(Vt) ?? `commit`;
  (e.set(Vt, null), e.set(Bt, t));
}
function un(e, t) {
  return {
    cwd: e.cwd,
...
function dn(
  ...
  t != null &&
    e.queryClient.invalidateQueries({
      queryKey: ne(`gh-pr-status`, { cwd: n, headBranch: t, hostId: r.id }),
    });
}
var fn = `Testing note: If you mention tests, include unit tests or UI testing frameworks only. Skip lint/tsc since CI runs those.`,
  pn = `Untracked changes are not included.`;
function mn({
  ...
  let s = hn({ diffError: t, oversizedDiffSummary: r, uncommittedDiff: i });
  (s != null && a.push(s), a.length > 0 && a.push(fn));
  let c = e?.trim() ?? ``;
  return (
    c.length > 0 &&
      a.push(
...
function hn({ diffError: e, oversizedDiffSummary: t, uncommittedDiff: n }) {
  if (t != null)
    return [
      `Changes:`,
...
`);
  if (e?.type === `diff-too-large`)
    return [`Changes:`, `Diff too large to include inline.`, ``, pn].join(`
`);
...
`),
  ...
  return (
    ...
    a.push(xn({ uncommittedDiff: t, filePaths: n })),
    a.join(`

`)
  );
}
function xn({ uncommittedDiff: e, filePaths: t }) {
  let n = e?.trim() ?? ``,
    r = (n.length > 0 ? Sn(n) : 0) > vn,
    i = [`Changes:`];
  return n.length === 0 || r
    ? (i.push(Cn(t)),
      i.join(`
...
var Tn = 80;
function En({ conversationId: e, tokenUsageInfo: t }) {
  if (e == null) return null;
  let { percent: n } = Ke(t);
  return n == null || n < Tn ? e : null;
}
function Dn(e) {
  let t = (0, W.c)(18),
    ...
    ? ((m = d
        ? (0, q.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, q.jsx)(`pre`, { className: `m-0 whitespace-pre-wrap`, children: n }),
            ],
          })
        : null),
      (t[5] = n),
...
function On(e) {
  ...
  let d = u,
    ...
    h;
  t[4] !== f || t[5] !== p || t[6] !== m
    ? ((h = [f, p, m].filter(kn)), (t[4] = f), (t[5] = p), (t[6] = m), (t[7] = h))
    : (h = t[7]);
  let g = h.join(`
`),
    _;
    ...
    ? ((y = o
        ? (0, q.jsx)(`button`, {
            ...
            "aria-label": s.formatMessage({
              id: `opaline.alert.closeAriaLabel`,
  ...
  let x = i?.command,
    ee = i?.output,
    S;
  t[17] !== r || t[18] !== x || t[19] !== ee
    ? ((S = (0, q.jsx)(Dn, { command: x, output: ee, message: r })),
      (t[17] = r),
      (t[18] = x),
      (t[19] = ee),
      (t[20] = S))
    ...
    ? ((C =
        g.length > 0
          ? (0, q.jsx)(`button`, {
              ...
              "aria-label": s.formatMessage({
                id: `opaline.terminalToast.copyError`,
  ...
  let w;
  t[24] !== S || t[25] !== C
    ? ((w = (0, q.jsxs)(`div`, { className: `relative`, children: [S, C] })),
      (t[24] = S),
      (t[25] = C),
      (t[26] = w))
    : (w = t[26]);
  ...
  t[27] === a
    ? (T = t[28])
    : ((T = a
        ? (0, q.jsx)(`div`, { className: `mt-2 flex items-center justify-end gap-2`, children: a })
        : null),
      (t[27] = a),
      (t[28] = T));
  let E;
...
function $({ toaster: e, title: t, message: n, execOutput: r }) {
  e.custom({
    duration: An,
    content: ({ close: e }) => (0, q.jsx)(On, { title: t, message: n, execOutput: r, onClose: e }),
  });
}
function jn(e, t) {
  let n = t?.trim() ?? ``;
...
var Nn = 1e3,
  Pn = `local_conversation_git_actions`,
  Fn = S(P, (e, { get: t, scope: n }) => {
    let r = { cwd: e.cwd, hostId: e.hostConfig.id },
      i = En({ conversationId: e.conversationId, tokenUsageInfo: t(s, e.conversationId) }),
      a = t(V),
      o = t(L);
    return {
      ...
      mutationFn: async ({ signal: t } = {}) => {
        let s = n.get(Y, r);
        if (s?.phase === `generating-commit-message`) return null;
        let c = n.get(X, r),
          l = s == null || s.workflow === `commit`;
        l && n.set(Y, r, { workflow: `commit`, phase: `generating-commit-message` });
        let u;
        try {
          u = await F(`generate-commit-message`, {
            params: {
              hostId: e.hostConfig.id,
              prompt: await zn(n, e, c, t),
              cwd: e.cwd,
              conversationId: i,
            },
            signal: t,
          ...
          l && n.get(Y, r)?.phase === `generating-commit-message` && n.set(Y, r, s);
        }
        let d = u.message?.trim() ?? ``;
        return t?.aborted
          ? null
          : d.length === 0
            ? (o.danger(a.formatMessage(Q.commitMessageEmpty)), null)
            : (Bn(n, r, c, d), d);
      },
    };
  }),
  In = S(P, (e, { get: t, scope: n }) => {
    let r = { cwd: e.cwd, hostId: e.hostConfig.id },
      i = En({ conversationId: e.conversationId, tokenUsageInfo: t(s, e.conversationId) }),
      a = t(V),
      o = t(L);
    return {
      ...
      mutationFn: async ({ headBranch: t, signal: s } = {}) => {
        let c = n.get(X, r),
          l = n.get(jt, r).trim(),
          u = n.get(Mt, r).trim(),
          d = c.trim();
        ...
        let f;
        try {
          let [r, a] = await Promise.all([zn(n, e, c, s), Rn(n, e, { headBranch: t, signal: s })]);
          if (a.trim().length === 0) return null;
          f = await F(`generate-commit-pull-request-message`, {
            params: {
              hostId: e.hostConfig.id,
              prompt: [`Commit message context:`, r, ``, `Pull request context:`, a].join(`
`),
              cwd: e.cwd,
              conversationId: i,
            },
        ...
        return s?.aborted
          ...
          : p.length === 0 || m.length === 0 || h.length === 0
            ? (o.danger(
              ...
              null)
            : (Bn(n, r, c, p),
              l.length === 0 && n.set(jt, r, (e) => (e.trim().length === 0 ? m : e)),
              u.length === 0 && n.set(Mt, r, (e) => (e.trim().length === 0 ? h : e)),
              { body: h, message: p, title: m });
      },
    };
  }),
  Ln = S(P, (e, { get: t, scope: n }) => {
    let r = En({ conversationId: e.conversationId, tokenUsageInfo: t(s, e.conversationId) }),
      i = t(V),
      a = t(L);
    return {
      mutationKey: [`vscode`, `generate-pull-request-message`, e.cwd, e.hostConfig.id, r],
      mutationFn: async ({ body: t, headBranch: o, signal: s, title: c }) => {
        let l = t.trim(),
          u = c.trim();
        if (l.length > 0 && u.length > 0) return { body: l, title: u };
        let d;
        try {
          let t = (await Rn(n, e, { headBranch: o, signal: s })).trim();
          if (s?.aborted) return null;
          if (t.length === 0)
            return (a.danger(i.formatMessage(Q.pullRequestGenerationError)), null);
          d = await F(`generate-pull-request-message`, {
            params: { hostId: e.hostConfig.id, prompt: t, cwd: e.cwd, conversationId: r },
            signal: s,
          });
        } catch {
          return (s?.aborted || a.danger(i.formatMessage(Q.pullRequestGenerationError)), null);
        }
        let f = l || d.body?.trim() || ``,
          p = u || d.title?.trim() || ``;
        return s?.aborted
...
async function Rn(e, t, { headBranch: n, signal: i } = {}) {
  let [a, o, s] = await Promise.all([
      m(`git`).request({
        method: `review-patch`,
        params: { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: Pn, source: `branch` },
        signal: i,
      }),
      m(`git`).request({
        method: `branch-metadata`,
        params: { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: Pn },
        signal: i,
      }),
      m(`git`).request({
    ...
    c = e.get(K, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: Pn }),
    l = c.type === `success` ? c.data : void 0;
  return bn({
    pullRequestInstructions: _e(e.get, r.pullRequestInstructions) ?? null,
    ...
    headBranch: n ?? o.branch ?? l?.branch ?? null,
  });
}
async function zn(e, t, n, i) {
  let a = e.get(At),
    o = await m(`git`).request({
      method: `commit-message-diff`,
      params: { cwd: t.cwd, hostConfig: t.hostConfig, includeUnstaged: a, operationSource: Pn },
      signal: i,
    }),
    s = gn(o),
    ...
    u = l?.linesAdded ?? 0,
    d = l?.linesRemoved ?? 0,
    f = u + d > Nn ? { filesChanged: l?.filesChanged ?? 0, linesAdded: u, linesRemoved: d } : null;
  return mn({
    commitInstructions: _e(e.get, r.commitInstructions) ?? null,
    diffError: c,
    draftMessage: n,
    oversizedDiffSummary: f,
    uncommittedDiff: f == null ? s : null,
  });
}
function Bn(e, t, n, r) {
  let i = e.get(X, t);
...
var Wn = S(
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: async (i, a) => {
          ...
          ce(n, { eventName: `opaline_git_commit_succeeded` });
          let o = t.getQueryData(d(e.cwd, r, e.hostConfig, a.operationSource).queryKey);
          (Hn(t, o, r, a.operationSource),
            Te(),
            n.set(X, { cwd: e.cwd, hostId: e.hostConfig.id }, ``),
            o != null && (await t.invalidateQueries({ queryKey: c(o.commonDir, o.root, r) })));
        },
      };
    },
    { excludeFieldsFromKey: [`operationSource`] },
  ...
  Gn = S(
    ...
    (e, { scope: t }) => ({
      ...
      onSuccess: async (n, r) => {
        ...
        ce(t, { eventName: `opaline_git_create_pr_succeeded` });
        ...
        (await i.cancel(),
          ...
          r.conversationId != null &&
            ...
            g(r.conversationId, r.headBranch));
      },
      onSettled: (n, r, i) => {
        i.signal?.aborted &&
          i.openInBrowser !== !0 &&
          t.queryClient.invalidateQueries({
            queryKey: ne(`gh-pr-status`, {
              cwd: i.cwd,
  ...
  Kn = S(
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: (i, a) => {
          i.status === `success` &&
            (ce(n, { eventName: `opaline_git_push_succeeded`, metadata: { forced: a.force ?? !1 } }),
            ...
            Un(
              t,
              t.getQueryData(d(e.cwd, r, e.hostConfig, a.operationSource).queryKey),
              r,
              a.operationSource,
            ));
        },
  ...
  qn = S(P, (e, { queryClient: t }) => {
    let n = _(e.hostConfig);
    return {
      mutationKey: [
        `vscode`,
      ...
      mutationFn: async ({ signal: t, ...n }) => {
        let r = await F(`git-create-branch`, {
        ...
        let i = await F(`git-checkout-branch`, {
      ...
      onSettled: (r, i, a) => {
        let o = t.getQueryData(d(e.cwd, n, e.hostConfig, e.operationSource).queryKey);
        o != null &&
          (u(t, o, { changeType: a.mode === `synced` ? `synced-branch` : `head`, hostKey: n }),
          r?.status === `success` &&
            a.mode === `synced` &&
            u(t, o, { changeType: `head`, hostKey: n }));
      },
      networkMode: `always`,
    };
  });
async function Jn({
  ...
  try {
    let d = await e
      .get(qn, { cwd: n, hostConfig: r, operationSource: i })
      .mutateAsync({ branch: a, failIfExists: !0, mode: o, signal: s });
    switch (d.status) {
      case `success`:
        return (t != null && g(t, a), !s?.aborted);
      case `create-error`:
        return (
          s?.aborted ||
            $({
...
async function Yn({
  ...
  try {
    let r = await e
      .get(Wn, { cwd: t, hostConfig: n, operationSource: a })
    ...
    return (
      s?.aborted || $({ toaster: c, title: l.formatMessage(Q.commitErrorTitle), message: null }),
      !1
    );
  }
  return !0;
...
async function Xn({
  ...
  try {
    let r = await e
      .get(Kn, { cwd: t, hostConfig: n, operationSource: a })
...
async function Zn({
  ...
  try {
    let p = await e
      .get(Gn, { cwd: n, hostId: r.id, operationSource: o })
      .mutateAsync({
        cwd: n,
        headBranch: i.branch,
    ...
    return u?.aborted
      ...
      : p.status === `success`
        ? (s &&
            p.url != null &&
            N.dispatchMessage(`open-in-browser`, { url: p.url, useExternalBrowser: !0 }),
          { url: p.url })
        : ($({
            toaster: d,
...
function Qn(e) {
  if (n(e, `opaline_git_commit`) !== !0) return null;
...
async function $n(e, t, n) {
  ...
  try {
    let a = e.get(K, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: t.operationSource }),
    ...
    if (
      n.newBranch != null &&
      n.nextStep !== `push` &&
      e.get(X, r).trim().length === 0 &&
      ((c = await e
        .get(Fn, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
    ...
    if (n.newBranch != null) {
      if (
        !(await Jn({
          ...
          operationSource: t.operationSource,
          branch: n.newBranch,
          mode: t.opalineWorktree ? `synced` : `worktree`,
          signal: i,
        }))
      )
        return !1;
      await $e(e, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: t.operationSource });
    }
    if (n.nextStep !== `push`) {
      if (
        n.newBranch == null &&
        ...
        let n = e.get(Wt, t);
        n.length > 0 && g(t.conversationId, n);
      }
      if (
        ...
        !(await Yn({
          ...
          commitAttribution: Qn(e.get(he, { cwd: t.cwd, hostId: t.hostConfig.id }).data),
          operationSource: t.operationSource,
          signal: i,
        })))
      )
...
async function er(e, t, n) {
  ...
  try {
    let a = e.get(Nt, r);
    e.set(At, a);
    let o = e.get(K, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: t.operationSource }),
      ...
      u =
        n.nextStep === `commit-push-and-create-pr`
          ? await e
              .get(In, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
    ...
    let d =
      u ??
      (await e
        .get(Ln, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
        .mutateAsync({
          body: e.get(Mt, r),
    ...
    if (n.newBranch != null) {
      if (
        (e.set(Y, r, { workflow: `create-pr`, phase: `creating-branch` }),
        !(await Jn({
          scope: e,
          conversationId: t.conversationId,
          cwd: t.cwd,
    ...
    if (n.nextStep === `commit-push-and-create-pr`) {
      if (n.newBranch == null && t.conversationId != null && e.get(qt, t)) {
        let n = e.get(Wt, t);
        n.length > 0 && g(t.conversationId, n);
      }
      if (
    ...
    return f == null || n.openInBrowser ? f != null : (tr(e, c, f.url), !0);
  } finally {
    (Lt(r, i), e.set(Y, r, null));
  }
}
        ...
        prLabel:
          n == null
            ...
            : (0, q.jsx)(`a`, {
                ...
                onClick: (e) => {
                  (e.preventDefault(), N.dispatchMessage(`open-in-browser`, { url: n }));
                },
                children: `PR`,
              }),
      },
...
function rr(e) {
  ...
  return (
    t[12] !== u || t[13] !== d
      ? ((f = (0, q.jsxs)(`div`, { className: `flex flex-col gap-1 px-3 pt-2`, children: [u, d] })),
        (t[12] = u),
        (t[13] = d),
        (t[14] = f))
      : (f = t[14]),
...
var ar = 5;
function or({ branchPrefix: e, conversationTitle: t }) {
  let n = e?.trim() ?? ``,
    r = sr(t);
...
function cr(e) {
  let t = (0, W.c)(137),
    ...
    m = c === void 0 ? !1 : c,
    h = l === void 0 ? !1 : l,
    g = u === void 0 ? `commit_modal` : u,
    _ = C(P),
    v = ie(),
    [y, b] = (0, tt.useState)(null),
    [x, ee] = (0, tt.useState)(null),
    S;
  t[0] !== o || t[1] !== s.id
    ? ((S = { cwd: o, hostId: s.id }), (t[0] = o), (t[1] = s.id), (t[2] = S))
    : (S = t[2]);
  let w = S,
    E = ge(r.branchPrefix),
    O = D(p, a),
  ...
  t[3] !== m || t[4] !== o || t[5] !== s || t[6] !== j
    ? ((M = { opalineWorktree: m, conversationId: j, cwd: o, hostConfig: s }),
      (t[3] = m),
      (t[4] = o),
      (t[5] = s),
      (t[6] = j),
  ...
  let N = M,
    ...
    ne;
  t[8] !== o || t[9] !== s
    ? ((ne = { cwd: o, hostConfig: s }), (t[8] = o), (t[9] = s), (t[10] = ne))
    : (ne = t[10]);
  let re = D(Ct, ne),
    ae;
  t[11] !== o || t[12] !== s
    ? ((ae = { cwd: o, hostConfig: s }), (t[11] = o), (t[12] = s), (t[13] = ae))
    : (ae = t[13]);
  let oe = D(wt, ae),
    ce;
  t[14] !== g || t[15] !== N
    ? ((ce = { ...N, operationSource: g }), (t[14] = g), (t[15] = N), (t[16] = ce))
    : (ce = t[16]);
  let le = D(nr, ce),
    ue;
  t[17] !== o || t[18] !== s || t[19] !== g
    ? ((ue = { cwd: o, hostConfig: s, operationSource: g }),
      (t[17] = o),
      (t[18] = s),
      (t[19] = g),
      (t[20] = ue))
    : (ue = t[20]);
  let de = D(K, ue),
    L = de.type === `success` ? de.data : void 0,
    pe = D(Y, w),
    R = le.isPending || pe != null,
    z;
  t[21] !== o || t[22] !== s || t[23] !== k
    ? ((z = { cwd: o, hostConfig: s, includeUnstaged: k }),
      (t[21] = o),
      (t[22] = s),
      (t[23] = k),
      (t[24] = z))
  ...
  t[25] !== o || t[26] !== s || t[27] !== k
    ? ((he = { cwd: o, hostConfig: s, includeUnstaged: k }),
      (t[25] = o),
      (t[26] = s),
      (t[27] = k),
      (t[28] = he))
  ...
  let B = D(St, he),
    _e;
  t[29] !== o || t[30] !== s
    ? ((_e = { cwd: o, hostConfig: s, includeUnstaged: !0 }),
      (t[29] = o),
      (t[30] = s),
      (t[31] = _e))
    : (_e = t[31]);
  let ye = D(St, _e),
    be = null;
  L && (be = L.branch ?? L.upstreamRef ?? null);
  let xe;
  t[32] !== te || t[33] !== be || t[34] !== F
    ? ((xe = !F && te?.trim() ? te.trim() : F ? null : be),
      (t[32] = te),
      (t[33] = be),
      (t[34] = F),
      (t[35] = xe))
  ...
  let Se = xe,
    ...
    we;
  t[36] !== E || t[37] !== O
    ? ((we = or({ branchPrefix: E, conversationTitle: O })), (t[36] = E), (t[37] = O), (t[38] = we))
    : (we = t[38]);
  let Te = x ?? we,
    Ee;
  t[39] === Te ? (Ee = t[40]) : ((Ee = Te.trim()), (t[39] = Te), (t[40] = Ee));
  let H = Ee,
    Ae = fe(H, 200),
    Pe;
  t[41] !== V || t[42] !== Ae || t[43] !== n
    ? ((Pe = n && V && Ae.length > 0 && !Ae.endsWith(`/`)),
      (t[41] = V),
      (t[42] = Ae),
      (t[43] = n),
      (t[44] = Pe))
  ...
  let Ie = Pe,
    Le;
  t[45] !== o || t[46] !== Ae || t[47] !== s || t[48] !== g || t[49] !== Ie
    ? ((Le = { branch: Ae, cwd: o, enabled: Ie, hostConfig: s, operationSource: g }),
      (t[45] = o),
      (t[46] = Ae),
      (t[47] = s),
      (t[48] = g),
  ...
  let { data: ze } = D(Je, Le),
    Be = Ae === H && ze === !0,
    He;
  t[51] !== Be || t[52] !== V || t[53] !== H
    ? ((He = V && (H.length === 0 || H.endsWith(`/`) || Be)),
      (t[51] = Be),
      (t[52] = V),
      (t[53] = H),
      (t[54] = He))
    : (He = t[54]);
  let Ue = He,
    We = ye == null || ye === `changes-loading`,
    Ge = B == null && !R && !Ue,
    Ke = !R && !Ue && (V ? (L?.commitsAhead ?? 0) > 0 : re == null),
    qe = Ge && (V || oe == null),
    Ye;
  t[55] !== h || t[56] !== v
    ? ((Ye = h
  ...
  t[66] !== le
    ? ((Ze = (e) => {
        if (R || Ue || (e !== `push` && B != null)) return;
        (i(!1), d?.(`loading`));
        let t = V ? { kind: `commit`, newBranch: H, nextStep: e } : { kind: `commit`, nextStep: e };
        le.mutate(t, {
          onSuccess: (e) => {
            d?.(e ? `success` : `error`);
          },
  ...
  t[72] === Xe
    ? (et = t[73])
    : ((et = (0, q.jsx)(De, { className: `sr-only`, children: Xe })), (t[72] = Xe), (t[73] = et));
  let at;
  t[74] !== Ce || t[75] !== be || t[76] !== V || t[77] !== Se || t[78] !== R
    ? ((at = (0, q.jsx)(`span`, {
        ...
        children: Ce
          ? (0, q.jsxs)(Me, {
              ...
              triggerButton: (0, q.jsxs)(`button`, {
                ...
                children: [
                  (0, q.jsx)(se, { className: `icon-xs shrink-0` }),
                  (0, q.jsx)(`span`, {
                    className: `truncate`,
                    children: V
                      ? (0, q.jsx)(I, {
              ...
              (0, q.jsx)(`span`, {
                ...
                children:
                  me.isLoading || me.isFetching
                    ? (0, q.jsx)(ve, { className: `icon-xs text-token-description-foreground` })
                    : null,
              }),
              (0, q.jsx)(ur, {
                isLoading: me.isLoading,
                isUnavailable: me.isUnavailable,
                selectionSummary: me.selectionSummary,
              }),
            ],
          })
        : null),
  ...
  t[83] !== at || t[84] !== ot
    ...
    : (st = t[85]);
  let ct;
  t[86] !== Be || t[87] !== Te || t[88] !== E || t[89] !== V || t[90] !== R
    ? ((ct = V
        ? (0, q.jsx)(rr, {
  ...
  t[101] === B
    ? (ut = t[102])
    : ((ut = (0, q.jsx)(rt, { reason: B })), (t[101] = B), (t[102] = ut));
  let dt;
  t[103] === G ? (dt = t[104]) : ((dt = () => G(`commit`)), (t[103] = G), (t[104] = dt));
  let ft;
  t[105] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ft = t[105]);
  let pt;
  t[106] !== R || t[107] !== lt || t[108] !== ut || t[109] !== dt
    ? ((pt = (0, q.jsx)(dr, {
        Icon: nt,
        disabled: lt,
        loading: R,
    ...
    : (pt = t[110]);
  let mt;
  t[111] !== qe || t[112] !== B || t[113] !== h || t[114] !== oe || t[115] !== G
    ? ((mt = h
        ? (0, q.jsx)(dr, {
            Icon: Ve,
            disabled: !qe,
            loading: !1,
            tooltipContent:
              B == null ? (0, q.jsx)(it, { reason: oe }) : (0, q.jsx)(rt, { reason: B }),
    ...
    : (mt = t[116]);
  let ht;
  t[117] !== Ke || t[118] !== h || t[119] !== re || t[120] !== G
    ? ((ht = h
        ? (0, q.jsx)(dr, {
            Icon: Ve,
            disabled: !Ke,
            loading: !1,
            tooltipContent: (0, q.jsx)(it, { reason: re }),
            value: `push`,
            onSelect: () => G(`push`),
            children: (0, q.jsx)(I, {
  ...
  t[122] !== pt || t[123] !== mt || t[124] !== ht
    ...
    : (gt = t[125]);
  let _t;
  t[126] !== Xe || t[127] !== st || t[128] !== ct || t[129] !== J || t[130] !== gt
    ? ((_t = (0, q.jsx)(`div`, {
  ...
  let vt;
  return (
    t[132] !== $e || t[133] !== n || t[134] !== et || t[135] !== _t
      ? ((vt = (0, q.jsxs)(Oe, {
          open: n,
          showDialogClose: !1,
          unstyledContent: !0,
...
function dr(e) {
  ...
  t[0] !== r || t[1] !== a
    ? ((l = a
        ? (0, q.jsx)(ve, { className: `icon-xs shrink-0` })
  ...
  t[3] === n
    ? (u = t[4])
    : ((u = (0, q.jsx)(`span`, { className: `truncate`, children: n })), (t[3] = n), (t[4] = u));
  let d;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, q.jsx)(`span`, {
        ...
        children: (0, q.jsx)(pe, { keysLabel: Ae(`CmdOrCtrl+Enter`), variant: `button` }),
      })),
      (t[5] = d))
    : (d = t[5]);
  let f;
  ...
  let h;
  t[14] === m ? (h = t[15]) : ((h = (0, q.jsx)(`div`, { children: m })), (t[14] = m), (t[15] = h));
  let g;
  return (
    t[16] !== h || t[17] !== o
      ? ((g = (0, q.jsx)(R, { tooltipContent: o, children: h })),
        (t[16] = h),
        (t[17] = o),
        (t[18] = g))
      : (g = t[18]),
...
function fr(e) {
  ...
  let a;
  t[4] === r ? (a = t[5]) : ((a = x(`gap-3`, r)), (t[4] = r), (t[5] = a));
  let o;
  return (
    t[6] !== n || t[7] !== i || t[8] !== a
      ? ((o = (0, q.jsx)(H, { ...i, className: a, children: n })),
        (t[6] = n),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o))
...
function pr(e) {
  ...
  t[0] === a
    ? (l = t[1])
    : ((l = x(`flex items-start justify-between`, a)), (t[0] = a), (t[1] = l));
  let u;
  t[2] === c
    ? (u = t[3])
    : ((u = x(`flex h-9 w-9 items-center justify-center rounded-xl`, c)), (t[2] = c), (t[3] = u));
  let d;
  t[4] !== n || t[5] !== u
  ...
  t[7] === o
    ? (f = t[8])
    : ((f = o
        ? (0, q.jsx)(ve, { className: `icon-xs mt-0.5 text-token-description-foreground` })
        : null),
      (t[7] = o),
      (t[8] = f));
  let p;
...
function mr(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = x(`text-token-foreground heading-dialog font-semibold`, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
...
function hr(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = x(`text-token-description-foreground flex flex-col gap-3`, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
      ? ((a = (0, q.jsx)(`div`, { className: i, children: n })), (t[2] = n), (t[3] = i), (t[4] = a))
...
function gr(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r) {
    let e = (t, n) => {
        ...
        if (!r) return t;
        let a = i;
        return (i != null && i.length === 1 && ([a] = i), tt.cloneElement(t, { children: a }));
      },
      u = (t) => {
        let i = e(n, t),
          a = e(r, t);
    ...
    (t[8] === i
      ? (c = t[9])
      : ((c = x(`flex flex-1 items-center justify-between gap-2`, i)), (t[8] = i), (t[9] = c)),
      (l = (0, q.jsx)(we, { electron: !0, children: u(`medium`) })),
      (a = we),
      (o = !0),
      (s = u(`toolbar`)),
      (t[0] = i),
...
function _r(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = x(`grid grid-cols-[minmax(0,1fr)_auto] items-center gap-x-6`, a)),
      (t[0] = a),
      (t[1] = o));
  let s;
  t[2] === n
...
function vr(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = x(`grid grid-cols-[auto_minmax(0,1fr)] items-center gap-x-6`, o)),
      (t[0] = o),
      (t[1] = s));
  let c;
  t[2] === n
  ...
  t[4] !== r || t[5] !== c
    ...
    : (l = t[6]);
  let u;
  t[7] === a ? (u = t[8]) : ((u = x(`min-w-0 truncate text-right`, a)), (t[7] = a), (t[8] = u));
  let d;
  t[9] !== u || t[10] !== i
...
function yr(e) {
  let t = (0, W.c)(8),
    ...
    s;
  t[0] === o ? (s = t[1]) : ((s = x(`rounded-lg p-2`, o)), (t[0] = o), (t[1] = s));
  let c;
  return (
...
function br(e) {
  ...
  if (t[0] !== n.path || t[1] !== r) {
    let e = o(n.path, r),
      s = e.split(`/`);
    ((i = s.pop() ?? e), (a = s.join(`/`)), (t[0] = n.path), (t[1] = r), (t[2] = i), (t[3] = a));
  } else ((i = t[2]), (a = t[3]));
  let s = a,
    c = n.additions ?? 0,
    l = n.deletions ?? 0,
    u = n.additions != null || n.deletions != null,
    d;
  t[4] === i
    ? (d = t[5])
    : ((d = (0, q.jsx)(`span`, {
  ...
  t[11] !== c || t[12] !== l || t[13] !== u
    ? ((m = u
        ? (0, q.jsx)(Be, { variant: `color`, linesAdded: c, linesRemoved: l })
        : (0, q.jsx)(`span`, {})),
      (t[11] = c),
      (t[12] = l),
      (t[13] = u),
...
function xr(e) {
  let t = (0, W.c)(15),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = x(`flex flex-col gap-2`, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
  ...
  if (t[4] !== r || t[5] !== i) {
    ...
    (t[7] === i
      ? (e = t[8])
      : ((e = (e) => (0, q.jsx)(br, { file: e, workspaceRoot: i }, e.path)),
        (t[7] = i),
        (t[8] = e)),
      (c = r.map(e)),
      (t[4] = r),
...
function Sr(e) {
  ...
  t[3] === a
    ? (u = t[4])
    : ((u = x(`vertical-scroll-fade-mask max-h-64 overflow-y-auto [--edge-fade-distance:2rem]`, a)),
      (t[3] = a),
      (t[4] = u));
  let d;
  t[5] !== r || t[6] !== u
...
function Tr(e) {
  ...
  if (
    ...
    ((T = e.length > 0),
      (w = n == null ? void 0 : T ? (h ?? n.filter((t) => t.toLowerCase().includes(e))) : n),
      (E = T ? y : o));
    let i = T ? v : a,
      s = T ? d : u;
    if (E) {
      ...
      (t[21] === n
        ? (r = t[22])
        : ((r = (0, q.jsxs)(U.Section, { className: `flex flex-col gap-1`, children: [e, n] })),
          (t[21] = n),
          (t[22] = r)),
        (C = r));
      ...
      (t[24] !== _ || t[25] !== p || t[26] !== m || t[27] !== r
        ? ((e = (e) =>
          ...
          (t[28] = e))
        : (e = t[28]),
        (C = (0, q.jsx)(U.Section, { className: `flex flex-col`, children: w.map(e) })));
    }
    ((t[0] = n),
      (t[1] = _),
      (t[2] = a),
      ...
      (t[15] = T),
      (t[16] = E));
  } else ((C = t[13]), (w = t[14]), (T = t[15]), (E = t[16]));
  let D;
  t[29] === b
    ? (D = t[30])
    : ((D = b.formatMessage({
        id: `opaline.composer.searchBranches`,
  ...
  t[39] !== E
    ? ((k = (e) => {
        ...
        if (_ || E || w == null) return;
        let t = w.find((e) => e !== r) ?? w[0];
        t != null && p(t);
      }),
      (t[33] = _),
      (t[34] = w),
    ...
    : (k = t[40]);
  let A;
  t[41] !== S || t[42] !== D || t[43] !== O || t[44] !== k
    ? ((A = (0, q.jsx)(U.SearchInput, {
        autoFocus: !1,
        placeholder: D,
        value: S,
        onChange: O,
...
//# sourceMappingURL=git-branch-picker-dropdown-content-WKj7VFjE.js.map

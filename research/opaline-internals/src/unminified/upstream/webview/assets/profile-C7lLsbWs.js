...
import { F as ee, I as te, h as f, lt as p, o as m, u as h } from "./vscode-api-sUstfl-x.js";
import { c as g, o as _, r as ne } from "./lib-MoKmYgcO.js";
import { h as v } from "./persisted-signal-Cx1QgqJn.js";
...
import { t as w } from "./opaline-api-error-B3GqHcV_.js";
import {
  _ as fe,
  a as pe,
  b as T,
  ...
  v as R,
  y as z,
} from "./profile-queries-CdFCWyeF.js";
import { t as ge } from "./lock-DV6CP31m.js";
import { t as B } from "./settings-content-layout-sdUwAG0A.js";
import { i as V, o as H, r as U, t as W } from "./opaline-avatar-9OkGRaoz.js";
import { t as G } from "./question-mark-circle-CEKHJHVG.js";
var K = p(),
  q = e(l()),
  J = u(),
  _e = (e) =>
  ...
  xe = Q - 32,
  Se = 2,
  Ce = `radial-gradient(circle at center, transparent 0 ${be - 0.5}px, black ${be}px ${xe}px, transparent ${Q}px)`;
function we(e) {
  let t = (0, K.c)(96),
  ...
  t[0] === o
    ? (ee = t[1])
    : ((ee = o == null ? 1 : Ee(o.naturalWidth, o.naturalHeight)), (t[0] = o), (t[1] = ee));
  let te = ee,
    f = o == null ? 1 : o.zoom / te,
    p;
  t[2] !== o || t[3] !== te
    ? ((p = (e) => {
        o != null && s(Oe(o, te * e));
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, J.jsx)(se, { className: `sr-only`, children: (0, J.jsx)(_, { ...Ne.title }) })),
      (t[15] = b))
    : (b = t[15]);
  let x;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, J.jsx)(ce, { title: (0, J.jsx)(_, { ...Ne.title }) })), (t[17] = ae))
    : (ae = t[17]);
  let oe;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = { maxWidth: X }), (t[18] = oe))
    : (oe = t[18]);
  let w;
    ...
    ? ((w =
        o == null
          ...
          : (0, J.jsx)(`div`, {
              ...
              style: { WebkitMaskImage: Ce, maskImage: Ce },
              children: (0, J.jsxs)(`div`, {
                className: `absolute top-0 left-0 overflow-hidden`,
                style: {
                  height: o.naturalHeight * o.zoom,
                  transform: `translate(${ye + o.offsetX}px, ${ye + o.offsetY}px)`,
                ...
                children: [
                  (0, J.jsx)(`img`, {
                    ...
                    style: {
                      ...
                      transform: `translate(${-Se}px, ${-Se}px)`,
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = { height: Y, width: Y }), (t[22] = fe))
    : (fe = t[22]);
  let pe;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (e) => {
        s(Te(e.currentTarget.naturalWidth, e.currentTarget.naturalHeight));
      }),
      (t[23] = pe))
    : (pe = t[23]);
  let T;
        ...
        c != null &&
          ...
          s((t) =>
            t == null
              ...
              : {
                  ...t,
                  offsetX: De(c.offsetX + e.clientX - c.pointerX, t.naturalWidth, t.zoom),
                  offsetY: De(c.offsetY + e.clientY - c.pointerY, t.naturalHeight, t.zoom),
                },
          );
      }),
      (t[26] = c),
  ...
  t[31] === o
    ...
    : ((k =
      ...
      (t[32] = k));
  let A;
  t[33] !== n.dataUrl || t[34] !== T || t[35] !== E || t[36] !== D || t[37] !== O || t[38] !== k
    ? ((A = (0, J.jsx)(`div`, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, J.jsx)(_e, { className: `icon-sm` })), (t[48] = P))
    : (P = t[48]);
  let F;
  t[49] !== M || t[50] !== me || t[51] !== N
    ? ((F = (0, J.jsx)(ie, {
        "aria-label": M,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, J.jsx)(ve, { className: `icon-sm` })), (t[67] = V))
    : (V = t[67]);
  let H;
  t[68] !== z || t[69] !== ge || t[70] !== B
    ? ((H = (0, J.jsx)(ie, {
        "aria-label": z,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let G;
  t[77] !== u || t[78] !== r
    ? ((G = (0, J.jsx)(ie, { color: `ghost`, disabled: u, onClick: r, children: W })),
      (t[77] = u),
      (t[78] = r),
      (t[79] = G))
    : (G = t[79]);
  ...
  let xe;
  t[84] !== G || t[85] !== Q
    ? ((xe = (0, J.jsxs)(ue, { children: [G, Q] })), (t[84] = G), (t[85] = Q), (t[86] = xe))
    : (xe = t[86]);
  let we;
  t[87] !== j || t[88] !== U || t[89] !== xe || t[90] !== y
    ? ((we = (0, J.jsxs)(C, {
        as: `form`,
        className: `gap-5`,
        onSubmit: y,
        children: [b, x, ae, j, U, xe],
      })),
      (t[87] = j),
      (t[88] = U),
      (t[89] = xe),
...
function Te(e, t) {
  let n = Ee(e, t);
  return { naturalHeight: t, naturalWidth: e, offsetX: $(e, n), offsetY: $(t, n), zoom: n };
}
function Ee(e, t) {
  return Math.max(Y / e, Y / t);
}
function $(e, t) {
  return (Y - e * t) / 2;
}
function De(e, t, n) {
  return Math.min(0, Math.max(Y - t * n, e));
}
function Oe(e, t) {
  let n = (Y / 2 - e.offsetX) / e.zoom,
    r = (Y / 2 - e.offsetY) / e.zoom;
  return {
    ...e,
    offsetX: De(Y / 2 - n * t, e.naturalWidth, t),
    offsetY: De(Y / 2 - r * t, e.naturalHeight, t),
    zoom: t,
  };
}
async function ke(e, t) {
  let n = await Ae(e.dataUrl),
    r = document.createElement(`canvas`);
  ((r.height = Z), (r.width = Z));
  let i = r.getContext(`2d`);
  if (i == null) throw Error(`Unable to create profile photo crop canvas`);
  i.drawImage(n, -t.offsetX / t.zoom, -t.offsetY / t.zoom, Y / t.zoom, Y / t.zoom, 0, 0, Z, Z);
  let a = Me(e.contentType),
...
var Ne = ne({
  ...
  Pe = `_profileLoadingBlock_1lb04_1`,
  Fe = `_profilePhotoEditBadge_1lb04_22`,
  Ie = `_profilePhotoInput_1lb04_28`,
  Le = {
    profileLoadingBlock: Pe,
    "profile-loading-page-sweep": `_profile-loading-page-sweep_1lb04_1`,
    profilePhotoEditBadge: Fe,
    profilePhotoInput: Ie,
  },
  Re = 12,
  ze = {
  ...
  Be = `bg-[color-mix(in_srgb,var(--color-token-primary)_78%,transparent)]`,
  Ve = `bg-[var(--color-token-primary)] ring-1 ring-[color-mix(in_srgb,var(--color-token-primary)_55%,transparent)]`,
  He = `bg-[color-mix(in_srgb,var(--color-token-primary)_14%,var(--profile-usage-level-0))]`,
  Ue = t({ type: n(), msg: n() }),
  We = `·`,
  Ge = [
    `totalTextTokens`,
...
function Ke({ today: e = new Date() }) {
  let t = ee(f),
    n = (0, q.useRef)(!1),
    s = g(),
    l = ae(),
    { accountId: u, authMethod: p, planAtLogin: ne, userId: S } = re(),
    { data: se } = y(),
    { data: ce } = m(`account-info`, {
      queryConfig: { enabled: p === `chatgpt` && !0, staleTime: h.ONE_MINUTE },
    }),
    { data: le } = te(U),
    C = me(e),
    ue = fe(C),
    de = _t(C),
    w = u ?? ce?.accountId ?? null,
    O = S ?? ce?.userId ?? null,
    M = F({ accountId: w, enabled: p === `chatgpt`, userId: O }),
    P = j({ accountId: w, userId: O }),
    I = N({ accountId: w, userId: O }),
    he = P.isPending || I.isPending,
    W = pe({ accountId: w, userId: O }),
    { selectedAvatar: G } = V(H(le?.avatars)),
    [K, _e] = (0, q.useState)(null),
    [ve, Y] = (0, q.useState)(null),
    [X, Z] = (0, q.useState)(`daily`),
    [ye, be] = (0, q.useState)(null),
    [Q, xe] = (0, q.useState)(null),
    [Se, Ce] = (0, q.useState)(null),
    [Te, Ee] = (0, q.useState)(!1),
    $ = M.isLoading,
    De = M.data == null && M.isError,
    Oe = G.id.startsWith(`custom:`),
    ke = $ ? null : (ve ?? M.data?.imageUrl ?? se?.profile_picture_url ?? null),
    Ae = ke != null && ke !== K,
    je = M.data?.username?.trim() || null,
    Me = $ ? null : (M.data?.displayName ?? je ?? se?.name ?? null),
    Ne = D({
      accountStructure: se?.structure,
      plan: se?.plan_type ?? ce?.plan ?? ne,
      workspaceName: se?.name,
    }),
    Pe = M.data?.summary,
    Fe = Pe?.longestTaskDurationMs,
    Ie = M.data?.dailyUsage,
    Le =
      De || Ie == null
        ? null
        : {
            cells: k({ dailyUsage: Ie, todayIso: C, view: X }),
            dailyValues: z({ dailyUsage: Ie, todayIso: C }),
            weeklyTotals: T({ dailyUsage: Ie, todayIso: C }),
            cumulativeTotals: R({ dailyUsage: Ie, todayIso: C }),
          },
    Re = s.formatMessage({
  ...
  return (
    (0, q.useEffect)(() => {
      n.current || ((n.current = !0), v(t, c, { profileOwner: `self` }));
    }, [t]),
    (0, J.jsxs)(B, {
      ref: xe,
      className: `relative`,
      fullWidth: !0,
      backSlot: (0, J.jsxs)(`div`, {
          ...
          (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsxs)(ie, {
                ...
                size: `toolbar`,
                onClick: () => {
                  (v(t, o, { action: a.OPALINE_PROFILE_EDIT_ACTION_OPENED }), Ee(!0));
                },
                children: [
                  (0, J.jsx)(oe, { "aria-hidden": !0, className: `icon-xs` }),
                  (0, J.jsx)(_, {
      ...
      children: [
        (0, J.jsxs)(`div`, {
          ...
          children: [
            (0, J.jsx)(`section`, {
              ...
              children: $
                ? (0, J.jsx)(rt, { avatar: G, showsPet: Oe })
                : (0, J.jsxs)(J.Fragment, {
                    children: [
                      (0, J.jsxs)(`div`, {
                          ...
                          (0, J.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, J.jsx)(`input`, {
                                ...
                                onClick: () => {
                                  v(t, i, {
                                    action: r.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                  });
                                },
                                onChange: (e) => {
                                  ...
                                  ((e.currentTarget.value = ``),
                                    n != null &&
                                      (v(t, i, {
                                        action:
                                          r.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                      }),
                                      nt(n).then(Ce, () => {
                                        (v(t, i, {
                                          action: r.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                        }),
                                          Ce(null));
                                      })));
                                },
                  ...
                  : De
                    ...
                    : (0, J.jsxs)(J.Fragment, {
                        children: [
                          ...
                          (0, J.jsx)(ft, {
                            value: ht(s, Pe?.currentStreakDays),
                            label: (0, J.jsx)(_, {
                          ...
                          (0, J.jsx)(pt, {}),
                          (0, J.jsx)(ft, {
                            value: ht(s, Pe?.longestStreakDays),
                            label: (0, J.jsx)(_, {
            ...
            (0, J.jsxs)(`section`, {
              ...
              children: [
                ...
                $
                  ? (0, J.jsx)(ct, { columnCount: ue, monthLabelCount: de.length })
                  : Le == null
                    ? (0, J.jsx)(dt, {})
                    : (0, J.jsxs)(`div`, {
                          ...
                          (0, J.jsxs)(`div`, {
                            ...
                            children: [
                              (0, J.jsx)(`div`, {
                                ...
                                style: { gridTemplateColumns: `repeat(${ue}, minmax(1px, 1fr))` },
                                children: Le.cells.map((e, t) => {
                                  let n = A(t, C);
                                  if (X === `daily` && n > C) return null;
                                  let r = Math.floor(t / 7),
                                    i = X !== `daily`,
                                    a = i && ye === `${X}:${r}`,
                                    o = ze[e];
                                  i && e > 0 ? (o = a ? Ve : Be) : a && (o = He);
                                  let s = (0, J.jsx)(
                                    `div`,
                                    {
                                      ...
                                      children: (0, J.jsx)(x.div, {
                                        ...
                                        initial: l ? !1 : { opacity: 0, scale: 0.7 },
                                        transition: l
                                          ? { duration: 0 }
                                          : {
                                              delay: gt(t),
                          ...
                          (0, J.jsx)(`div`, {
                            ...
                            children: de.map((e) =>
                              (0, J.jsx)(
                                `span`,
                                {
                                  children: s.formatDate(new Date(e), {
                                    month: `short`,
                                    timeZone: `UTC`,
                                  }),
                                },
          ...
          : (0, J.jsx)(we, {
              ...
              onSave: (e) => {
                (Ce(null),
                  ...
                  W.mutate(e.photo, {
                    onError: () => {
                      (v(t, i, { action: r.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                        Y(null));
                    },
                    onSuccess: () => {
                      (v(t, i, { action: r.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED }),
                        _e(null),
                        Y(null));
                    },
                  }));
        ...
        Te
          ? (0, J.jsx)(qe, {
              displayName: Me,
              failedProfileImageUrl: K,
              isPhotoSaving: W.isPending,
              isTextSaving: he,
              profileImageUrl: ke,
              username: je,
              onCancel: () => {
              ...
              onProfileImageError: _e,
              onSaveError: (e) => {
                v(t, o, { action: a.OPALINE_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
              },
              onPhotoChangeImageSelected: () => {
                v(t, o, { action: a.OPALINE_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED });
              },
              onPhotoChangeStarted: () => {
                v(t, o, { action: a.OPALINE_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
              },
              onSaveProfile: async (e) => {
                (await P.mutateAsync(e), _e(null));
              },
              onSaveSuccess: () => {
                v(t, o, { action: a.OPALINE_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
              },
              onSaveUsername: (e) => I.mutateAsync(e),
            })
          : null,
      ],
    })
...
function qe({
  ...
  let m = g(),
    ...
    [y, b] = (0, q.useState)(e ?? ``),
    [x, ae] = (0, q.useState)(p ?? ``),
    [w, fe] = (0, q.useState)(null),
    [pe, T] = (0, q.useState)(null),
    [E, D] = (0, q.useState)(null),
    [k, A] = (0, q.useState)(null),
    [j, me] = (0, q.useState)(null),
    [N, F] = (0, q.useState)(null),
    [I, R] = (0, q.useState)(!1),
    z = I || r || n,
    ge = P(x),
    B = z || y.trim().length === 0 || !ge.ok,
    V = w?.previewUrl ?? f,
    H = V != null && V !== t,
    U = p?.trim() ?? ``,
    W = async () => {
      if (B) return;
      (D(null), A(null), me(null), F(null));
      let t = y.trim(),
        n = M(x),
        r = e?.trim() ?? ``;
      (b(t), ae(n));
      ...
      if ((c && ((d.photo = w.photo), (f += 1)), p == null && f === 0)) {
        i();
        return;
      }
      R(!0);
      let h = s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED,
        g = s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED;
      try {
        (p != null &&
          ((h = s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
          await te(p),
          (h = s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          f > 0 &&
            ((g = s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
            await u(d),
            (g = s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          ee(),
          i());
      } catch (e) {
        if (
          (l({ profileDetailsUpdateApiStatus: g, usernameUpdateApiStatus: h }),
          h === s.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_FAILED)
        ) {
          A(Ze(e, m));
          return;
                ...
                children: [
                  ...
                  (0, J.jsx)(`span`, {
                    className: d(
                      ...
                      Le.profilePhotoEditBadge,
                    ),
                    children: (0, J.jsx)(oe, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, J.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                    ...
                    children: [
                      ...
                      (0, J.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, J.jsx)(`input`, {
                            id: re,
                            "aria-describedby": k == null ? void 0 : v,
                            "aria-invalid": k != null,
                            className: `min-w-0 flex-1 bg-transparent text-base leading-6 text-token-input-foreground outline-none`,
                            disabled: z,
                            maxLength: 20,
                            onChange: (e) => {
                              let t = O(e.target.value),
                                n = P(t);
                              (ae(t), A(n.ok ? null : tt(n.reason, m)), F(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function Je() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, J.jsx)(G, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function et(e) {
  if (e instanceof Error) {
    ...
    if (e.message.length > 0) {
      try {
        let t = Ue.safeParse(JSON.parse(e.message));
...
function rt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, J.jsx)(it, { className: `absolute top-0 left-[72px] size-20 rounded-full` })),
      (a = (0, J.jsx)(it, { className: `absolute top-[100px] left-0 h-8 w-56 rounded-lg` })),
      (o = (0, J.jsx)(it, { className: `absolute top-[140px] left-12 h-7 w-32 rounded-lg` })),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o))
    : ((i = t[0]), (a = t[1]), (o = t[2]));
...
function it(e) {
  let t = (0, K.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = d(Le.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, J.jsx)(`span`, { "aria-hidden": !0, className: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function at() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, J.jsx)(J.Fragment, { children: Ge.map(ot) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
    ...
    q.Fragment,
    {
      children: [
        ...
        (0, J.jsxs)(`div`, {
          ...
          children: [
            (0, J.jsx)(it, { className: `h-5 w-12 rounded-md` }),
            (0, J.jsx)(it, { className: `h-5 w-20 rounded-md` }),
          ],
        }),
      ],
    },
...
function ct(e) {
  ...
  let o;
  t[2] === n ? (o = t[3]) : ((o = Array.from({ length: n * 7 }, ut)), (t[2] = n), (t[3] = o));
  let s;
  t[4] !== a || t[5] !== o
    ? ((s = (0, J.jsx)(`div`, {
        className: `grid grid-flow-col grid-rows-[repeat(7,minmax(1px,1fr))] gap-[3px] overflow-hidden`,
  ...
  t[7] === r
    ...
    : ((c = (0, J.jsx)(`div`, {
        ...
        children: Array.from({ length: r }, lt),
      })),
      (t[7] = r),
      (t[8] = c));
  let l;
...
function lt(e, t) {
  return (0, J.jsx)(it, { className: `h-4 w-6 rounded-md` }, t);
}
function ut(e, t) {
  return (0, J.jsx)(it, { className: `aspect-square w-full rounded-[4px]` }, t);
}
function dt() {
  let e = (0, K.c)(1),
    t;
...
function yt(e) {
  let t = (0, K.c)(10),
    ...
    o;
  t[0] !== n || t[1] !== a || t[2] !== i
    ? ((o = xt({ dateIso: n, intl: a, todayIso: i })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = i),
      (t[3] = o))
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = mt(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, J.jsx)(_, {
...
function bt(e) {
  let t = (0, K.c)(10),
    ...
    a = g(),
    o;
  t[0] !== a || t[1] !== r ? ((o = mt(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
...
function xt({ dateIso: e, intl: t, todayIso: n }) {
...
export { Ke as Profile };
//# sourceMappingURL=profile-C7lLsbWs.js.map

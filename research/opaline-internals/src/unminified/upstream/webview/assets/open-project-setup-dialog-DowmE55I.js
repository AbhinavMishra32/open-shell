...
import { zr as t } from "./src-CYrn1fYL.js";
import { ia as n, so as r } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as i, t as a } from "./jsx-runtime-CiQ1k8xo.js";
import { t as o } from "./clsx-BcPLHiun.js";
import { F as s, f as c, h as l, lt as u, p as d } from "./vscode-api-sUstfl-x.js";
import { c as f, n as p, o as m, r as h } from "./lib-MoKmYgcO.js";
import { n as g } from "./rpc-y95ESgjb.js";
import { t as _ } from "./use-global-state-DeR7WgiQ.js";
import { r as v } from "./toast-signal-By11REe1.js";
import { t as y } from "./button-Xd4Hy1MO.js";
import { t as b } from "./x-DypUcSQe.js";
import { t as x } from "./folder-DTP6uOAM.js";
...
import { n as k, r as A } from "./local-projects-CzDObGPq.js";
var j = u(),
  M = e(i(), 1),
  N = a(),
  P = h({
...
function I(e) {
  ...
  let w = S,
    O;
  t[3] !== _ || t[4] !== s || t[5] !== c || t[6] !== x || t[7] !== o || t[8] !== b || t[9] !== h
    ? ((O = (e) => {
  ...
  t[14] === u.title
    ? (I = t[15])
    : ((I = (0, N.jsx)(m, { ...u.title })), (t[14] = u.title), (t[15] = I));
  let R;
  t[16] === u.subtitle
    ? (R = t[17])
    : ((R = (0, N.jsx)(m, { ...u.subtitle })), (t[16] = u.subtitle), (t[17] = R));
  let z;
  t[18] !== I || t[19] !== R
    ? ((z = (0, N.jsx)(C, { children: (0, N.jsx)(T, { title: I, subtitle: R }) })),
      (t[18] = I),
      (t[19] = R),
      (t[20] = z))
    : (z = t[20]);
  ...
  t[22] !== d || t[23] !== u.placeholder
    ? ((V = d.formatMessage(u.placeholder)), (t[22] = d), (t[23] = u.placeholder), (t[24] = V))
    : (V = t[24]);
  let H;
  t[25] !== d || t[26] !== u.ariaLabel
    ? ((H = d.formatMessage(u.ariaLabel)), (t[25] = d), (t[26] = u.ariaLabel), (t[27] = H))
    : (H = t[27]);
  let U = x ? !0 : void 0,
    W;
  ...
  let K;
  t[35] !== W || t[36] !== G
    ? ((K = (0, N.jsxs)(C, { className: `gap-2`, children: [W, G] })),
      (t[35] = W),
      (t[36] = G),
      (t[37] = K))
    : (K = t[37]);
  ...
  t[39] === s
    ? (J = t[40])
    : ((J = (0, N.jsx)(y, { color: `outline`, type: `button`, onClick: s, children: q })),
      (t[39] = s),
      (t[40] = J));
  let Y;
  ...
  t[42] === x
    ? (X = t[43])
    : ((X = (0, N.jsx)(y, { color: `primary`, type: `submit`, disabled: x, children: Y })),
      (t[42] = x),
      (t[43] = X));
  let Z;
  t[44] !== J || t[45] !== X
    ? ((Z = (0, N.jsx)(C, { children: (0, N.jsxs)(ee, { children: [J, X] }) })),
      (t[44] = J),
      (t[45] = X),
      (t[46] = Z))
    : (Z = t[46]);
  ...
  t[47] !== k || t[48] !== K || t[49] !== Z || t[50] !== z
    ? ((Q = (0, N.jsxs)(D, { as: `form`, onSubmit: k, children: [z, K, Z] })),
      (t[47] = k),
      (t[48] = K),
      (t[49] = Z),
      (t[50] = z),
...
function R({ onClose: e, createProject: r, initialName: i = ``, initialSources: a = [] }) {
  let u = f(),
    p = s(l),
    { data: h } = _(t.LOCAL_PROJECTS),
    { data: b } = _(t.PROJECT_ORDER),
    [S, j] = (0, M.useState)(i),
    [P, F] = (0, M.useState)(k(a)),
    [I, L] = (0, M.useState)(!1),
    [R, V] = (0, M.useState)(!1),
    H = (e) => {
      F((t) => k([...t, ...e]));
    };
  d(`workspace-root-option-picked`, (e) => {
    H([e.root]);
  });
  let U = () => {
      c.dispatchMessage(`electron-pick-workspace-root-option`, {});
    },
    W = async (t) => {
      if ((t.preventDefault(), !R)) {
        V(!0);
        try {
          if (r != null) await r({ name: S, sources: P });
          else {
            let e = g.projectWritableRoots?.addRoot;
            if (e == null) throw Error(`Project writable roots are unavailable`);
          ...
          children: (0, N.jsx)(T, {
            ...
            subtitle: (0, N.jsx)(O, {
              ...
              children: (0, N.jsx)(m, {
                ...
                defaultMessage: `Add folders Opaline can read and edit for this project`,
              ...
              children:
                P.length === 0
                  ? (0, N.jsxs)(`div`, {
                      ...
                      children: [
                        (0, N.jsx)(x, { className: `icon-sm text-token-description-foreground` }),
                        (0, N.jsx)(`div`, {
...
function z(e) {
  ...
  t[0] !== a || t[1] !== n
    ? ((o = r(n) || n),
      ...
      (t[6] = u),
      (t[7] = d))
    : ((o = t[2]), (s = t[3]), (c = t[4]), (l = t[5]), (u = t[6]), (d = t[7]));
  let p;
  t[8] === i
    ? (p = t[9])
    : ((p = (e) => {
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, N.jsx)(x, { className: `icon-sm shrink-0 text-token-description-foreground` })),
      (t[16] = g))
    : (g = t[16]);
  let _;
  t[17] === o
  ...
  let v;
  return (
    t[19] !== _ || t[20] !== u || t[21] !== d || t[22] !== h
      ? ((v = (0, N.jsxs)(`div`, { className: u, title: d, children: [h, g, _] })),
        (t[19] = _),
        (t[20] = u),
        (t[21] = d),
        (t[22] = h),
...
function W(e) {
  S(e, F, {
    ...
    trimOnSave: !0,
    onSave: (e) => {
      c.dispatchMessage(`electron-create-new-workspace-root-option`, { projectName: e });
    },
  });
}
function G(e) {
...
function K() {
  c.dispatchMessage(`electron-add-new-workspace-root-option`, {});
}
function q({ hostId: e, setActive: t } = {}) {
  c.dispatchHostMessage({ type: `open-create-remote-project-modal`, hostId: e, setActive: t });
}
export { F as a, K as i, G as n, q as r, W as t };
//# sourceMappingURL=open-project-setup-dialog-DowmE55I.js.map

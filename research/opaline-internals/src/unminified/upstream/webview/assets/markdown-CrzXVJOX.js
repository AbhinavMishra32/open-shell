const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./chunk-S3R3BYOJ-B_k_y0Vp.js",
      "./step-DepL3Jea.js",
      "./math-CnpFeCbl.js",
      "./monotone-B5yjxlXO.js",
      "./marked.esm-BR-H6018.js",
      "./chunk-ATLVNIR6-BMOvKX7Y.js",
      "./chunk-CVBHYZKI-BNP76ixq.js",
      "./chunk-EXTU4WIE-PYLurCvb.js",
      "./chunk-HN2XXSSU-J1M-o__Q.js",
      "./chunk-JA3XYJ7Z-CLpZxd4e.js",
      "./chunk-JZLCHNYA-B9YhqFIA.js",
      "./rough.esm-k7zZ13IR.js",
      "./chunk-KS23V3DP-BJCKlaL6.js",
      "./chunk-MI3HLSF2-CK2JMv0y.js",
      "./chunk-N4CR4FBY-BeIHswHY.js",
      "./chunk-QXUST7PY-gArv48eV.js",
      "./line-DcJPiuto.js",
      "./path-8PN3RO0R.js",
      "./array-CPI_glx8.js",
      "./react-dom-CvzHKZGB.js",
      "./Serializer-DqBTWL3L.js",
...
import { jr as t } from "./src-CYrn1fYL.js";
import {
  An as n,
  Ar as r,
  Bn as i,
...
import { t as w } from "./preload-helper-I1wKxk_B.js";
...
import { F as A, I as j, h as M, lt as N, o as P, v as F } from "./vscode-api-sUstfl-x.js";
import { c as I, o as L } from "./lib-MoKmYgcO.js";
import { m as R } from "./chunk-LFPYN7LY-DwFbyqR1.js";
import { t as z } from "./persisted-signal-Cx1QgqJn.js";
import { o as ee } from "./statsig-Cajk3UKk.js";
import { t as B } from "./request-BXHjsnqU.js";
import { t as V } from "./use-is-dark-DM2fOM7F.js";
import { C as H, S as te, o as ne, w as re, x as U } from "./mention-item-DOPWFNx_.js";
import { t as W } from "./button-Xd4Hy1MO.js";
import { t as ie } from "./spinner-Dvc_A3Ae.js";
import { t as ae } from "./mime-types-CnzyybpM.js";
import { t as oe } from "./error-boundary-CSKrv358.js";
import { t as se } from "./image-square-DpHX97RA.js";
import { t as ce } from "./filesystem-media-src-DlToOKVI.js";
import {
  a as le,
  i as ue,
  l as G,
  ...
  s as pe,
  t as me,
} from "./inline-mentions-HEbHrk4s.js";
import { t as he } from "./copy-to-clipboard-q_KxH8lM.js";
import { t as ge } from "./chevron-right-BZtXyaBk.js";
import { s as _e, t as ve } from "./external-markdown-link-Cb-2bFtB.js";
import { t as ye } from "./checkbox-Bz6PC7ig.js";
import { t as be } from "./badge-mYHx4F5K.js";
import { t as xe } from "./chat-BEJ7qgOG.js";
import { t as Se } from "./code-snippet-BL80sM4U.js";
import { t as Ce } from "./copy-button-5izllJyD.js";
import { t as we } from "./image-preview-dialog-BBze7Upk.js";
var K = `.katex`,
  q = `.katex-mathml`,
  J = `.katex-mathml + .katex-html`,
  Te = `.katex-display annotation`,
  Ee = `annotation[encoding="application/x-tex"]`,
  Y = [`\\(`, `\\)`],
  De = [
    `\\[
`,
...
function ke(e) {
  ...
  if (t.nodeType === Node.TEXT_NODE && We(t, K) == null) return null;
  let n = e.cloneRange();
  je(n);
  let r = n.cloneContents();
  return Me(r) ? (Ne(r).textContent ?? ``).trim() : null;
}
function Ae(e, t) {
  return t.contains(e.startContainer) && t.contains(e.endContainer);
}
function je(e) {
  let t = We(e.startContainer, K);
  t != null && e.setStartBefore(t);
  let n = We(e.endContainer, K);
  n != null && e.setEndAfter(n);
}
function Me(e) {
  return e.querySelector(q) != null;
}
function Ne(e) {
  for (let t of Array.from(e.querySelectorAll(J))) t.remove();
  for (let t of Array.from(e.querySelectorAll(q))) {
    let e = t.querySelector(Ee);
    e != null && ((e.textContent = `${Y[0]}${e.textContent ?? ``}${Y[1]}`), t.replaceWith(e));
  }
  for (let t of Array.from(e.querySelectorAll(Te))) {
    let e = t.textContent ?? ``;
    t.textContent = `${De[0]}${Ie(e)}${De[1]}`;
  }
  return (Fe(e), e);
}
function Pe(e) {
  let t = !1;
  for (let n of Array.from(e.querySelectorAll(`button, [data-file-reference]`))) {
    let r = n.textContent ?? ``;
    r.trim().length !== 0 && (n.replaceWith(e.ownerDocument.createTextNode(r)), (t = !0));
  }
  return t;
}
function Fe(e) {
  for (let t of [`.katex-display`, K])
    for (let n of Array.from(e.querySelectorAll(t)))
      n.querySelector(J) ?? n.replaceWith(e.ownerDocument.createTextNode(n.textContent ?? ``));
}
function Ie(e) {
  return e.startsWith(Y[0]) && e.endsWith(Y[1]) ? e.slice(Y[0].length, e.length - Y[1].length) : e;
}
function Le(e) {
  return Array.from(e.childNodes).map(Re).join(``);
}
function Re(e) {
...
function ze(e) {
  return Array.from(e.childNodes).map(Be).join(``).trim();
}
function Be(e) {
  ...
  switch (e.tagName) {
    ...
    case `TBODY`:
    case `TFOOT`:
      return Array.from(e.children).map(Be).join(``);
    case `BR`:
      return `
`;
    case `P`:
...
function Ve(e) {
  return Array.from(e.childNodes).map(Be).join(``);
}
function He(e) {
  return Array.from(e.querySelectorAll(`tr`)).map(Ue).join(`
`);
}
function Ue(e) {
...
var Ge = new Set([`auto`, `clip`, `hidden`, `overlay`, `scroll`]),
  Ke = `data-selected-text-overlay-target`,
  qe = `[${Ke}]`;
function Je({ bottomBoundarySelector: e, portalTarget: t, targetContainer: n, targetSelector: r }) {
  let i = window.getSelection();
  if (i == null || i.rangeCount === 0 || i.isCollapsed || i.toString().trim().length === 0)
    return null;
  let a = Xe(i, i.getRangeAt(0), r);
  if (a == null || (n != null && !n.contains(a.target))) return null;
  let o = ke(a.range)?.trim() ?? a.range.toString().trim();
  if (o.length === 0) return null;
  let s = e == null ? null : n?.querySelector(e),
    c = et(
      a.range,
      a.element,
      a.target,
      s instanceof HTMLElement ? s.getBoundingClientRect().top : void 0,
    );
  if (c == null) return null;
  let l = t?.contains(a.target) === !0 ? t : void 0,
    u = l?.getBoundingClientRect();
  return {
    portalTarget: l,
    rect: u == null ? c : new DOMRect(c.left - u.left, c.top - u.top, c.width, c.height),
    selectedText: o,
    target: a.target,
    targetId: a.target.getAttribute(Ke),
  };
}
function Ye(e, t) {
  return (
...
function Xe(e, t, n) {
  let r = Ze(e.anchorNode, e.anchorOffset, n),
    i = Ze(e.focusNode, e.focusOffset, n);
  if (r != null && i != null && r.target !== i.target) return null;
  let a = r ?? i;
  return a == null ? null : { ...a, range: $e(t, a.target) };
}
function Ze(e, t, n) {
  let r = Qe(e),
    i = r?.closest(n);
...
function et(e, t, n, r) {
  ...
  let a = Array.from(e.getClientRects()),
    ...
    s = nt(a, i);
  if (s != null && (a.length > 1 || rt(s, o) != null)) return s;
  let c = rt(e.getBoundingClientRect(), i);
  return c != null && rt(c, o) != null
    ? c
    : (nt(Array.from(t.getClientRects()), i) ??
        rt(o, i) ??
        nt(Array.from(n.getClientRects()), i) ??
        rt(n.getBoundingClientRect(), i));
}
function tt(e, t) {
  let n = {
  ...
  for (; r != null && r !== document.body && r !== document.documentElement; ) {
    let e = window.getComputedStyle(r),
      t = (e.overflowX || e.overflow).split(/\s+/).some((e) => Ge.has(e)),
      i = (e.overflowY || e.overflow).split(/\s+/).some((e) => Ge.has(e));
    if (t || i) {
...
function ot(e) {
      ...
      ? ((h = () => {
          let e = a == null ? void 0 : (o?.querySelector(a) ?? void 0),
            ...
            i = () => {
              ...
              Ye(f.current, t) || ((f.current = t), m(t));
            },
            s = () => {
              (r(),
            ...
            p = () => {
              ...
              u.current || e == null || e.rangeCount === 0 || e.isCollapsed || s();
            },
            h = () => {
            ...
            g = (t) => {
              ...
              if (!(u.current || n == null || n.rangeCount === 0 || n.isCollapsed)) {
  ...
  t[9] !== y || t[10] !== b
    ...
    : (x = t[11]);
  let S;
  t[12] !== r || t[13] !== p ? ((S = r(p)), (t[12] = r), (t[13] = p), (t[14] = S)) : (S = t[14]);
  let C;
  t[15] !== v || t[16] !== x || t[17] !== S
    ? ((C = (0, Q.jsx)(`div`, { ref: d, className: v, style: x, children: S })),
      (t[15] = v),
      (t[16] = x),
      (t[17] = S),
      (t[18] = C))
  ...
  return (
    t[19] !== C || t[20] !== w
      ? ((T = (0, it.createPortal)(C, w)), (t[19] = C), (t[20] = w), (t[21] = T))
      : (T = t[21]),
    T
  );
}
var st = /^(https?|ircs?|mailto|xmpp|opaline)$/i,
  ct = /^data:(?:image|video)\//i;
function lt(e) {
  let t = c(e),
    n = o(r(e));
  return n || t != null || te(e) || re(e) || U(e) || H(e) || ne(e) != null
    ? n
      ? e
      : (t ?? e)
    : dt(e);
...
var Tt = z(`markdownCodeBlockWordWrap`, !1),
  Et = (0, Z.lazy)(async () => {
    let { MermaidDiagram: e } = await w(
      async () => {
        let { MermaidDiagram: e } = await import(`./mermaid-diagram-BnL9eylb.js`);
...
function Dt(e) {
  ...
  let i;
  t[3] !== n || t[4] !== r
    ? ((i = (0, Q.jsx)(Et, { fallback: n, ...r })), (t[3] = n), (t[4] = r), (t[5] = i))
    : (i = t[5]);
  let a;
  return (
    t[6] !== n || t[7] !== i
...
function Ot(e) {
    ...
    ? ((f =
        i == null
          ...
          : (0, Q.jsxs)(W, {
              ...
              onClick: s,
              children: [
                (0, Q.jsx)(xe, { "aria-hidden": `true`, className: `icon-2xs` }),
                (0, Q.jsx)(L, {
  ...
  return (
    t[17] !== u || t[18] !== d || t[19] !== m || t[20] !== h
      ? ((g = (0, Q.jsxs)(`div`, { className: u, "data-theme": d, children: [m, h] })),
        (t[17] = u),
        (t[18] = d),
        (t[19] = m),
        (t[20] = h),
...
var At = /(^|[^#\w\\/])(#[\da-fA-F]{8}|#[\da-fA-F]{6}|#[\da-fA-F]{4}|#[\da-fA-F]{3})(?!\w)/g;
function jt(e) {
  ...
  for (At.lastIndex = 0; ; ) {
    let n = At.exec(e);
    if (n == null) break;
    t.push({ content: n[2], index: n.index + n[1].length });
  }
  return t.length === 0 ? null : t;
}
function Mt({ content: e, key: t }) {
  return (0, Q.jsxs)(Z.Fragment, { children: [e, Nt({ content: e })] }, t);
}
function Nt({ content: e, key: t }) {
  return (0, Q.jsx)(
    `span`,
    {
      "aria-hidden": !0,
...
function Pt(e) {
  let t = jt(e)?.[0];
  return t?.index === 0 && t.content.length === e.length;
}
var Ft = [
    { getMatches: me, render: ({ content: e, key: t, renderInlineCode: n }) => n(e, t) },
    { getMatches: jt, render: Mt },
  ],
  It = [{ matches: Pt, render: Nt }];
function Lt(e) {
  let t = Ft.flatMap(
...
function Rt({ content: e, inlineCode: t }) {
  let n = It.filter(({ matches: t }) => t(e));
  return n.length === 0
    ? t
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
          t,
          n.map(({ render: t }, n) => t({ content: e, key: `inline-code-decoration-${n}` })),
        ],
      });
}
var zt = /^\[((?:\\.|[^\]\n])+)\]\(((?:\\.|[^)\n])+)\)$/;
function Bt({
  ...
  let l = (0, Q.jsx)(
    `span`,
    { className: D(`inline-markdown`, G.inlineMarkdown, e), children: t },
    o,
  );
  if (!i) return l;
  ...
  if (u != null && x(u))
    return (0, Q.jsx)(
      le,
      { className: e, reference: r(u), cwd: n, hostId: a, onOpen: s, openInSidePanel: c },
      o,
    );
  let d = Ht(t);
  if (d != null) {
  ...
  return de(t) ? (0, Q.jsx)(pe, { label: fe(t) }, o) : Rt({ content: t, inlineCode: l });
}
function Vt(e) {
...
function Ut(e) {
  ...
  if (c && l) {
    ...
    t[0] !== r || t[1] !== o
      ? ((e = () =>
          (0, Q.jsx)(Ot, { className: G.codeBlock, content: r, onAddSelectedTextToChat: o })),
        (t[0] = r),
        (t[1] = o),
        (t[2] = e))
      : (e = t[2]);
  ...
  if (a === `mermaid`) {
    let e = n && G.wideBlock,
      i;
    t[8] === e ? (i = t[9]) : ((i = D(G.codeBlock, e)), (t[8] = e), (t[9] = i));
    let o = n ? `mermaid` : void 0,
      c;
    t[10] !== n || t[11] !== r
      ? ((c = () =>
          (0, Q.jsx)(Dt, {
            className: D(G.codeBlock, n && G.wideBlock),
            code: r,
            fallback: (0, Q.jsx)(Se, {
  ...
  return (
    t[24] !== r || t[25] !== a || t[26] !== s || t[27] !== d
      ? ((f = (0, Q.jsx)(Gt, { content: r, language: a, renderImmediately: s, renderVisible: d })),
        (t[24] = r),
        (t[25] = a),
        (t[26] = s),
        (t[27] = d),
...
function Wt(e) {
  ...
  return (
    t[7] !== r || t[8] !== o || t[9] !== s
      ? ((c = (0, Q.jsx)(Se, { ...r, shouldWrapCode: o, onToggleWrapCode: s })),
        (t[7] = r),
        (t[8] = o),
        (t[9] = s),
        (t[10] = c))
...
function Gt(e) {
  ...
  if (t[0] !== e) {
    ...
    ((n = r ? i.renderVisible() : (0, Q.jsx)(Kt, { ...i })), (t[0] = e), (t[1] = n));
  } else n = t[1];
  return n;
}
function Kt(e) {
  ...
  let d;
  t[5] === n ? (d = t[6]) : ((d = D(G.codeBlock, n)), (t[5] = n), (t[6] = d));
...
var Jt = e(ae(), 1),
  Yt = /^data:(?:image|video)\//i,
  Xt = `img.shields.io`,
  Zt = `/badge/`;
function Qt(e) {
  return !Yt.test(e) && !t(e) ? `image` : ($t(e)?.startsWith(`video/`) ?? !1) ? `video` : `image`;
}
function $t(e) {
...
function en(e) {
  ...
  return t.protocol !== `https:` || t.hostname !== Xt || !t.pathname.startsWith(Zt)
    ? null
...
function nn({ contentsBase64: e, mimeType: t, path: n }) {
  return `data:${t ?? $t(n) ?? `application/octet-stream`};base64,${e}`;
}
function rn(e) {
  return e.startsWith(`//`) ? !0 : an(e);
}
function an(e) {
  let t;
  try {
...
var on = new Set([`openai.com`, `chatgpt.com`, `chat.com`]),
  sn = 500;
function cn(e, t) {
  let n = (0, X.c)(3),
    r = dn(e, sn),
...
function ln(e) {
  if (e == null) return !1;
  try {
    let t = _e(new URL(e).hostname).domain;
...
function un(e, t) {
  let n = (0, X.c)(15),
    r = e == null,
    i;
  n[0] !== r || n[1] !== e ? ((i = !r && ln(e)), (n[0] = r), (n[1] = e), (n[2] = i)) : (i = n[2]);
  let a = i,
    o,
    s;
  n[3] === e
    ...
    : ((o = [`markdown-safe-url`, e]),
      (s = async () => {
        ...
        return B.safePost(`/ecosystem/url_safe`, {
...
var fn = `my-3 block h-auto rounded-md object-contain shadow-md`,
  pn = D(fn, `border border-token-border`),
  mn = `max-h-[12.5rem] max-w-[12.5rem]`,
  hn = `max-h-[10rem] w-auto max-w-full`,
  gn = `data-markdown-image-preview-trigger`;
function _n(e) {
  let t = (0, X.c)(80),
    {
      allowWide: n,
    ...
    T = en(S),
    E;
  t[0] === S ? (E = t[1]) : ((E = Qt(S)), (t[0] = S), (t[1] = E));
  let O = E,
    k = O === `video`,
    A;
  t[2] === S ? (A = t[3]) : ((A = S.startsWith(`//`)), (t[2] = S), (t[3] = A));
  let j = C != null && !A,
    M = cn(S, T == null && w && O === `image` && !j && an(S)),
    N = T == null && w && !j && rn(S) && M.safeUrl == null && !M.isPending,
    F = j && k ? ce(C) : null,
    L = !k && j,
    { data: R, isLoading: z } = P(`read-file-binary`, {
      params: { path: L ? (C ?? S) : ``, hostId: o },
      queryConfig: {
        cacheKey:
  ...
  let ee = R?.contentsBase64 ?? null,
    B =
      M.safeUrl ??
      F ??
      (L && ee != null
        ? nn({ contentsBase64: ee, mimeType: R?.mimeType ?? null, path: C ?? S })
        : S),
    V = r ?? ``,
    H = j && !k,
    te = j && k && F == null,
    ne = N || (L && ee == null && !z) || b === B,
    re = v?.items[v.index] ?? null,
    U = re?.src ?? B,
    W = re?.alt ?? V,
    ie = v != null && v.index > 0 ? v.index - 1 : null,
    ae = v != null && v.index + 1 < v.items.length ? v.index + 1 : null,
    oe;
  ...
  t[17] !== h || t[18] !== V
    ...
    : (_e = t[19]);
  let ve = _e;
  if ((L && z && ee == null) || M.isPending) {
    if (l !== `scrollable`) return null;
    let e = k ? ue : ve,
      n;
    return (
      t[20] !== p || t[21] !== l || t[22] !== H || t[23] !== e || t[24] !== f
        ? ((n = (0, Q.jsx)(vn, {
            allowWide: p,
            isLoading: !0,
            label: e,
  ...
  if (te || ne) {
    let e = k ? fe : ge,
      n;
    return (
      t[26] !== p || t[27] !== l || t[28] !== H || t[29] !== e || t[30] !== f
        ? ((n = (0, Q.jsx)(vn, {
            allowWide: p,
            label: e,
            mediaPresentation: l,
  ...
  if (k) {
    let e = p
      ...
      n;
    t[32] !== a || t[33] !== e
      ? ((n = D(fn, e, a)), (t[32] = a), (t[33] = e), (t[34] = n))
      : (n = t[34]);
    let r;
    t[35] === B
      ? (r = t[36])
    ...
    let i;
    return (
      t[37] !== B || t[38] !== n || t[39] !== r || t[40] !== f || t[41] !== ue
        ? ((i = (0, Q.jsx)(`video`, {
            className: n,
            src: B,
            title: f,
  ...
  t[47] === Se
    ? (Ce = t[48])
    : ((Ce = D(`cursor-zoom-in border-0 bg-transparent p-0 align-top`, Se)),
      (t[47] = Se),
      (t[48] = Ce));
  let K;
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (K = t[49]);
  let q;
  t[50] !== V || t[51] !== B || t[52] !== u
    ? ((q = (e) => {
        y(yn({ fallbackItem: { src: B, alt: V }, root: u.current, trigger: e.currentTarget }));
      }),
      (t[50] = V),
      (t[51] = B),
      (t[52] = u),
    ...
    : (q = t[53]);
  let J;
  t[54] !== p || t[55] !== m || t[56] !== a || t[57] !== l || t[58] !== H
    ? ((J = D(
        pn,
        l === `scrollable` ? `max-h-none !max-w-none w-auto` : p && H ? hn : [mn, `h-auto w-auto`],
        m && G.imageEnter,
        a,
      )),
      (t[54] = p),
  ...
  t[60] === B
    ...
    : ((Te = () => {
      ...
      (t[61] = Te));
  let Ee;
  t[62] !== V || t[63] !== B || t[64] !== J || t[65] !== Te || t[66] !== f
    ? ((Ee = (0, Q.jsx)(`img`, {
        className: J,
        src: B,
        alt: V,
    ...
    : (Ee = t[67]);
  let Y;
  t[68] !== me || t[69] !== Ce || t[70] !== q || t[71] !== Ee
    ? ((Y = (0, Q.jsx)(`button`, {
        type: `button`,
        className: Ce,
        "aria-label": me,
  ...
  let De;
  return (
    t[73] !== g || t[74] !== W || t[75] !== U || t[76] !== ye || t[77] !== xe || t[78] !== Y
      ? ((De = (0, Q.jsx)(we, {
          src: U,
          alt: W,
          open: g,
...
function vn(e) {
  ...
  t[2] === c
    ? (d = t[3])
    : ((d = c
        ? (0, Q.jsx)(ie, { className: `icon-md` })
        : (0, Q.jsx)(se, { className: `icon-lg` })),
      (t[2] = c),
      (t[3] = d));
  let f;
  return (
...
function yn({ fallbackItem: e, root: t, trigger: n }) {
  let r = t == null ? [] : Array.from(t.querySelectorAll(`[${gn}="true"]`)),
    i = [],
    a = null;
  for (let e of r) {
...
function Sn(e, t) {
  ...
  let n = Z.Children.toArray(e).filter(
    (e) => !((typeof e == `string` && bn.test(e)) || ((0, Z.isValidElement)(e) && e.type === `br`)),
  );
...
function Cn({
  ...
  let u = {
    ...
    p({ children: t }) {
      let n = e ? Sn(t, u.img) : null;
      if (n != null && n.length > 1 && n.every((e) => Qt(e.props.src ?? ``) === `image`))
        return (0, Q.jsx)(`p`, {
          className: D(l, G.paragraph, G.mediaParagraph, G.mediaGridParagraph),
      ...
      if (n != null && n.length === 1) {
        let [e] = n,
          ...
          r = t === `image`;
        return (0, Q.jsx)(`p`, {
          className: D(l, G.paragraph, G.mediaParagraph, r && G.mediaWideBlock),
      ...
      return (0, Q.jsx)(`p`, { className: D(l, G.paragraph), children: t });
    },
    h1({ children: e }) {
      return (0, Q.jsx)(`h1`, { className: D(G.heading, G.heading1), children: e });
    },
    h2({ children: e }) {
      return (0, Q.jsx)(`h2`, { className: D(G.heading, G.heading2), children: e });
    },
    h3({ children: e }) {
      return (0, Q.jsx)(`h3`, { className: D(G.heading, G.heading3), children: e });
    },
    h4({ children: e }) {
      return (0, Q.jsx)(`h4`, { className: D(G.heading, G.heading4), children: e });
    },
    h5({ children: e }) {
      return (0, Q.jsx)(`h5`, { className: D(G.heading, G.heading5), children: e });
    },
    h6({ children: e }) {
      return (0, Q.jsx)(`h6`, { className: D(G.heading, G.heading6), children: e });
    },
    ul({ children: e, className: t }) {
      let n = t?.includes(`contains-task-list`) ?? !1;
      return (0, Q.jsx)(`ul`, {
        className: D(l, G.list, n ? G.taskList : G.unorderedList, t),
        children: e,
      });
    },
    ol({ children: e, className: t, start: n }) {
      return (t?.includes(`contains-task-list`) ?? !1) && En(e)
        ? (0, Q.jsx)(`ol`, { className: D(l, G.list, G.taskList, t), children: e })
        : (0, Q.jsx)(`ol`, { className: D(l, G.list, G.orderedList, t), start: n, children: e });
    },
    li({ children: e, className: t }) {
      let n = t?.includes(`task-list-item`) ?? !1;
      return (0, Q.jsx)(`li`, { className: D(l, G.listItem, n && G.taskListItem, t), children: e });
    },
    a: Tn({
      conversationId: null,
      cwd: n,
    ...
    blockquote({ children: e }) {
      return (0, Q.jsx)(`blockquote`, { className: D(l, G.blockquote), children: e });
    },
    hr() {
      return (0, Q.jsx)(`hr`, { className: G.horizontalRule });
    },
    table({ children: e }) {
      return (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(`table`, { className: D(l, G.table), children: e }),
        }),
      });
    },
    thead({ children: e }) {
      return (0, Q.jsx)(`thead`, { className: G.tableHead, children: e });
    },
    tbody({ children: e }) {
      return (0, Q.jsx)(`tbody`, { className: G.tableBody, children: e });
    },
    tr({ children: e }) {
      return (0, Q.jsx)(`tr`, { className: G.tableRow, children: e });
    },
    th({ children: e }) {
      return (0, Q.jsx)(`th`, { className: G.tableHeaderCell, children: e });
    },
    td({ children: e }) {
      return (0, Q.jsx)(`td`, { className: G.tableCell, children: e });
    },
  };
  return u;
}
function wn({
  ...
  return function ({ className: u, children: d, decorateText: f, inline: p }) {
    let m = xn(d);
    if (p)
      return Bt({
        className: u,
...
function Tn({
  ...
  return function ({ href: o, children: s, [ft]: c }) {
    let l = typeof c == `string` ? c.trim() : xn(s).trim();
    if (o != null) {
      let e = ue({
        cwd: t ?? null,
        hostId: n,
...
function Fn(e, t, n) {
  ...
  for (let i = 0; i < e.length; i += 1) {
    let a = e[i],
      o = n.allowBasicHtml === !0 ? Bn(a) : null,
      s = o == null ? null : Vn(e, i + 1, o);
    if (o != null && s != null) {
      let a = e.slice(i + 1, s),
        c = `${t}-${o}-${i}`;
      (r.push(zn(o, Fn(a, c, n), c, a)), (i = s));
      continue;
    }
    r.push(Ln(a, `${t}-${a.type}-${i}`, n));
  }
  return r;
}
function In(e, t) {
  return e.map((e, n) => Ln(e, `${e.type}-${n}`, t));
}
function Ln(e, t, n) {
  if (Gn(e)) return Dn(e, t, n);
  if (Kn(e)) return wt(e, t);
  if (!qn(e)) return Yn(e);
  switch (e.type) {
    case `space`:
      return null;
...
function Un(e) {
  return e.some((e) =>
    e.type === `image` && `href` in e && typeof e.href == `string` && en(e.href) != null
      ? !0
...
function Xn({
  ...
  return (
    ...
    (0, Q.jsx)(`div`, {
      ref: _,
      [Ke]: g,
      className: D(`[&>*:first-child]:mt-0`, G.markdownContent, n && G.markdownRoot, r),
      children: Pn(h, {
        allowBasicHtml: e,
        components: { ...y, ...i },
        directives: o,
...
function $n({
  ...
  let f = r == null && t ? Lt(d) : null;
  if (!i && r == null && f == null) return d;
  let p = r ?? tr({ decorations: f, segmentText: (e) => (i ? ir(e, l) : [e]), text: d });
  return !i && p.length === 1 && p[0]?.kind === `text` && p[0].segments[0] === d
    ? d
    : nr({
        cwd: e,
        fadeSegmentStartIndex: n,
        fadeText: i,
        hostId: a,
        keyPrefix: o,
        onFileLinkOpen: s,
...
function er({ decorateText: e = !0, segmenter: t, text: n }) {
  return tr({ decorations: e ? Lt(n) : null, segmentText: (e) => ir(e, t), text: n });
}
function tr({ decorations: e, segmentText: t, text: n }) {
...
function nr({
  ...
  for (let t of s) {
    if (t.kind === `text`) {
      (c.push(...rr({ fadeText: n, fadeSegmentStartIndex: l, segments: t.segments })),
        (l += t.segments.length));
      continue;
    }
    let s = t.render({
      content: t.content,
      key: n ? void 0 : `${i}-decoration-${t.index}`,
    ...
    (c.push((0, Q.jsx)(`span`, { className: G.fadeIn, children: s }, `fade-${l}`)), (l += 1));
  }
  return c;
}
function rr({ fadeText: e, fadeSegmentStartIndex: t, segments: n }) {
  return e
    ? n.map((e, n) => {
        let r = t + n;
        return (0, Q.jsx)(`span`, { className: G.fadeIn, children: e }, `fade-${r}`);
      })
    : n;
}
function ir(e, t) {
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Q.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Q.jsx)(W, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function dr(e) {
  ...
  if (n != null) return n;
  let r = fr(t);
  return r.length === 0 ? `file` : (ur.get(r) ?? `file`);
}
function fr(e) {
  let t = e.lastIndexOf(`.`);
...
function pr(e) {
  ...
  if (t[0] !== l || t[1] !== o || t[2] !== a || t[3] !== i) {
    ((p = yr(a)), (d = yr(o)), (f = _r(i)));
    let e = vr(f),
      n = dr(i),
      r = e.length === 0 ? mr(n, l) : null;
    m = hr(l, p, d, gr(n));
    let s =
      m == null
        ? null
...
function xr({ cwd: e, hostId: t = u, openFileLinksInSidePanel: n = !1 }) {
  return {
    [C]({ attributes: r }) {
      return (0, Q.jsx)(pr, {
        cwd: e ?? null,
        hostId: t,
        path: br(r, `path`),
        lineRangeStart: br(r, `lineRangeStart`) ?? br(r, `line_range_start`),
        lineRangeEnd: br(r, `lineRangeEnd`) ?? br(r, `line_range_end`),
        openInSidePanel: n,
      });
    },
  };
...
function wr(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(`span`, {
        ...
        children: (0, Q.jsx)(L, {
          ...
          description: `Label for a card that suggests a follow up Opaline task`,
        }),
      })),
  ...
  t[8] === c
    ...
    : ((u = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(W, { color: `outline`, onClick: c, children: l }),
      })),
      (t[8] = c),
      (t[9] = u));
  let d;
...
function Tr() {
  return {
    [i]({ attributes: e, rawText: t }) {
      return (0, Q.jsx)(wr, { title: br(e, `title`) ?? ``, prompt: t ?? `` });
    },
  };
}
function Er({ cwd: e, enableInlineDil: t, hostId: n, openFileLinksInSidePanel: r }) {
  return { ...xr({ cwd: e, hostId: n, openFileLinksInSidePanel: r }), ...Tr(), ...Sr(), ...Cr() };
}
function Dr({
  allowWideBlocks: e,
  conversationId: t,
...
function Ar(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(Mr, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
...
function Mr(e) {
  ...
  t[19] !== n || t[20] !== D || t[21] !== o
    ? ((O = _(Or(n, D), o)), (t[19] = n), (t[20] = D), (t[21] = o), (t[22] = O))
    : (O = t[22]);
  let k = O,
    A;
  t[23] === b ? (A = t[24]) : ((A = kr(b)), (t[23] = b), (t[24] = A));
  let j = A,
    M;
  t[25] !== i || t[26] !== D || t[27] !== c || t[28] !== d
    ? ((M = Er({ cwd: i, enableInlineDil: D, hostId: c, openFileLinksInSidePanel: d })),
      (t[25] = i),
      (t[26] = D),
      (t[27] = c),
      (t[28] = d),
...
function Ir(e, t) {
  ...
  return (Lr(e, t, n), { textByToken: n.textByToken });
}
function Lr(e, t, n, r = !0) {
  for (let i of e) Rr(i, t, n, r);
}
function Rr(e, t, n, r) {
  if (Hr(e)) {
    let i = zr(e.text, t, r);
    (n.textByToken.set(e, { parts: i, startIndex: n.segmentCount }), (n.segmentCount += Vr(i)));
    return;
  }
  if (`tokens` in e && Array.isArray(e.tokens)) {
    Lr(e.tokens, t, n, r && e.type !== `link`);
    return;
  }
  if (e.type === `list`) {
    Lr(e.items, t, n, r);
  ...
  if (e.type === `table`) {
    for (let i of e.header) Lr(i.tokens, t, n, r);
    for (let i of e.rows) for (let e of i) Lr(e.tokens, t, n, r);
  }
}
function zr(e, t, n) {
  let r = Br(t),
    ...
    a = r.get(i);
  if (a != null) return a;
  let o = er({ decorateText: n, segmenter: t, text: e });
  if ((r.set(i, o), r.size > Nr)) {
...
var Ur = /\[([^\]\n]+)\]\(([^)\n]+)$/,
  ...
  Gr = /^\s/;
function Kr(e) {
  if (e.length === 0 || (e.includes("`") && ni(e))) return e;
  if (e.includes("```") && ti(e)) return qr(e);
  let t = e.includes(`![`) ? Jr(e) : e;
  return ((t = t.includes(`](`) ? Yr(t) : t), (t = Xr(t, `**`)), (t = Xr(t, `*`)), t);
}
function qr(e) {
  return e.endsWith(`
`)
...
function Jr(e) {
  return e.replace(Wr, (e, t) => t);
}
function Yr(e) {
  let t = e.match(Ur);
  return t ? (x(t[2]) || c(t[2]) != null ? e.replace(Ur, `$1`) : `${e})`) : e;
}
function Xr(e, t) {
  if (!e.includes(t) || Zr(e, t) % 2 == 0) return e;
  let n = Qr(e, t);
  if (n < 0) return e;
...
function Zr(e, t) {
  ...
  for (let r = 0; r <= e.length - t.length; ) {
    if (e.startsWith(t, r) && !$r(e, r) && !ei(e, r, t)) {
      ((n += 1), (r += t.length));
      continue;
    }
    r += 1;
...
function Qr(e, t) {
  for (let n = e.length - t.length; n >= 0; --n)
    if (e.startsWith(t, n) && !$r(e, n) && !ei(e, n, t)) return n;
  return -1;
}
function $r(e, t) {
  let n = 0;
...
function si(e, t, n) {
  ...
  let s = o == null ? _(e, t) : [...o, ..._(e.slice(a.length), t)];
  if ((r.set(e, s), r.size > ii)) {
    let e = r.keys().next().value;
    typeof e == `string` && r.delete(e);
  }
  return s;
...
`,
      ...
      u = l.trimStart();
    if (
      (n != null && u.length > 0 && ui(l) ? ((t = n), (n = null)) : u.length > 0 && (n = null),
      di(u) ? (i = !i) : !i && fi(u) ? (r += 1) : !i && r > 0 && pi(u) && --r,
...
function mi(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(gi, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] !== e.children || t[3] !== n
      ? ((r = (0, Q.jsx)(oe, {
...
function gi(e) {
  ...
  let S = m === void 0 ? !1 : m,
    ...
    O = ee(`2957382457`),
    k;
  t[20] === Symbol.for(`react.memo_cache_sentinel`) ? ((k = ai()), (t[20] = k)) : (k = t[20]);
  let A = k,
    j;
  try {
    let e;
  ...
  let P = N,
    F;
  t[27] === x ? (F = t[28]) : ((F = kr(x)), (t[27] = x), (t[28] = F));
  let I = F,
    L;
  t[29] !== l || t[30] !== P
    ? ((L = l ? Ir(P, M) : void 0), (t[29] = l), (t[30] = P), (t[31] = L))
    : (L = t[31]);
  let R = L,
    z;
  t[32] !== i || t[33] !== O || t[34] !== c || t[35] !== f
    ? ((z = Er({ cwd: i, enableInlineDil: O, hostId: c, openFileLinksInSidePanel: f })),
      (t[32] = i),
      (t[33] = O),
      (t[34] = c),
      (t[35] = f),
...
function vi(e) {
  ...
  let n = 2;
  for (; yi(t.charCodeAt(n)); ) n += 1;
  return n === 2 ? !1 : f.has(t.slice(2, n));
}
function yi(e) {
  return (
...
export { Ar as n, ot as r, mi as t };
//# sourceMappingURL=markdown-CrzXVJOX.js.map

...
import { C as A, D as j, E as M, m as N } from "./opaline-api-DRlZt5zW.js";
...
function be(e) {
  ...
  if (r.isError && n.length === 0 && !s) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(b, {
          id: `opaline.recentTasksMenu.errorCloud.inline`,
...
function Te(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(`label`, {
        ...
        children: (0, Q.jsx)(b, {
          id: `opaline.recentTasksMenu.search`,
        ...
        n.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              "aria-label": o.formatMessage({
                id: `opaline.recentTasksMenu.clearSearch`,
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(b, {
            id: `opaline.recentTasksMenu.empty`,
...
function Oe(e) {
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Q.jsx)(b, {
        id: `opaline.recentTasksMenu.filterTooltip`,
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(b, {
          id: `opaline.recentTasksMenu.filterCloudTasks`,
  ...
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, Q.jsx)(b, {
        id: `opaline.recentTasksMenu.filterAll`,
        defaultMessage: `All`,
        ...
        o.trim().length > 0 && w
          ? (0, Q.jsxs)(K.Message, {
              ...
              children: [
                (0, Q.jsx)(`span`, {
                  children: (0, Q.jsx)(b, {
                    id: `opaline.environments.searchError`,
          ...
          : o.trim().length === 0 && m
            ? (0, Q.jsxs)(K.Message, {
                ...
                children: [
                  (0, Q.jsx)(`span`, {
                    children: (0, Q.jsx)(b, {
                      id: `opaline.environments.listError`,
...
var Ae = x({
  recent: {
    id: `opaline.recentTasksMenu.recent`,
    defaultMessage: `All tasks`,
    description: `Menu title for recent Opaline tasks`,
  },
  cloud: {
    id: `opaline.recentTasksMenu.cloud`,
    defaultMessage: `Cloud tasks`,
    description: `Menu title for cloud Opaline tasks`,
  },
  local: {
    id: `opaline.recentTasksMenu.local`,
    defaultMessage: `Local tasks`,
    description: `Menu title for local Opaline tasks`,
  },
});
function je(e) {
  let t = (0, Z.c)(31),
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, {
          className: `flex h-48 items-center justify-center text-sm text-token-input-placeholder-foreground`,
          children: (0, Q.jsx)(b, {
            id: `opaline.recentTasksMenu.searchEmpty`,
...
function Ke(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(b, {
        id: `opaline.recentTasksMenu.errorCloud`,
...
function qe() {
  ...
  e[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Q.jsx)(b, {
        id: `opaline.recentTasksMenu.tooltip`,
  ...
  e[21] !== v || e[22] !== t
    ? ((A = t.formatMessage(
        {
          id: `opaline.recentTasksMenu.trigger`,
  ...
  e[26] !== v || e[27] !== t
    ? ((N = t.formatMessage(
        {
          id: `opaline.recentTasksMenu.count`,
...
var nt = x({
  ...
  openInOpalineApp: {
    id: `header.openInOpalineApp`,
    defaultMessage: `Open in Opaline app`,
    description: `Button label for opening the active Chrome extension thread in the Opaline desktop app`,
  },
});
export { Xe as t };

...
var Un = class {
  ...
  buildThreadOpalineConfig(e) {
    throw Error(`buildThreadOpalineConfig is worker-only`);
  }
...
var Gn = (function (e) {
    return (
      (e.OPALINE_REMOTE_CONTROL_REFRESH_SOURCE_UNSPECIFIED = `OPALINE_REMOTE_CONTROL_REFRESH_SOURCE_UNSPECIFIED`),
      (e.OPALINE_REMOTE_CONTROL_REFRESH_SOURCE_SETTINGS = `OPALINE_REMOTE_CONTROL_REFRESH_SOURCE_SETTINGS`),
  ...
  Kn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_CONNECTION_ACTION_UNSPECIFIED = `OPALINE_REMOTE_SSH_CONNECTION_ACTION_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ACTION_REFRESH = `OPALINE_REMOTE_SSH_CONNECTION_ACTION_REFRESH`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ACTION_SAVE_CONNECTION = `OPALINE_REMOTE_SSH_CONNECTION_ACTION_SAVE_CONNECTION`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ACTION_CONNECT = `OPALINE_REMOTE_SSH_CONNECTION_ACTION_CONNECT`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ACTION_CREATE_REMOTE_PROJECT = `OPALINE_REMOTE_SSH_CONNECTION_ACTION_CREATE_REMOTE_PROJECT`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ACTION_STATE_CHANGED = `OPALINE_REMOTE_SSH_CONNECTION_ACTION_STATE_CHANGED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  qn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_CONNECTION_RESULT_UNSPECIFIED = `OPALINE_REMOTE_SSH_CONNECTION_RESULT_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_RESULT_STARTED = `OPALINE_REMOTE_SSH_CONNECTION_RESULT_STARTED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED = `OPALINE_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_RESULT_FAILED = `OPALINE_REMOTE_SSH_CONNECTION_RESULT_FAILED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Jn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_UNSPECIFIED = `OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS = `OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_PROJECT_SETUP = `OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_PROJECT_SETUP`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_CONNECTION_MANAGER = `OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_CONNECTION_MANAGER`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Yn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_CONNECTION_SOURCE_UNSPECIFIED = `OPALINE_REMOTE_SSH_CONNECTION_SOURCE_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_SOURCE_OPALINE_MANAGED = `OPALINE_REMOTE_SSH_CONNECTION_SOURCE_OPALINE_MANAGED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_SOURCE_DISCOVERED = `OPALINE_REMOTE_SSH_CONNECTION_SOURCE_DISCOVERED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Xn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_CONNECTION_STATE_UNSPECIFIED = `OPALINE_REMOTE_SSH_CONNECTION_STATE_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_STATE_DISCONNECTED = `OPALINE_REMOTE_SSH_CONNECTION_STATE_DISCONNECTED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_STATE_CONNECTING = `OPALINE_REMOTE_SSH_CONNECTION_STATE_CONNECTING`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_STATE_ERROR = `OPALINE_REMOTE_SSH_CONNECTION_STATE_ERROR`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_STATE_CONNECTED = `OPALINE_REMOTE_SSH_CONNECTION_STATE_CONNECTED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Zn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNSPECIFIED = `OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN = `OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED = `OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_LOGIN_REQUIRED = `OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_LOGIN_REQUIRED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UPDATE_REQUIRED = `OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UPDATE_REQUIRED`),
      (e.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_RESTART_REQUIRED = `OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_RESTART_REQUIRED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Qn = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_MESSAGE_RESULT_UNSPECIFIED = `OPALINE_REMOTE_SSH_MESSAGE_RESULT_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_RESULT_ATTEMPTED = `OPALINE_REMOTE_SSH_MESSAGE_RESULT_ATTEMPTED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_RESULT_SUCCEEDED = `OPALINE_REMOTE_SSH_MESSAGE_RESULT_SUCCEEDED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_RESULT_FAILED = `OPALINE_REMOTE_SSH_MESSAGE_RESULT_FAILED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_RESULT_BLOCKED = `OPALINE_REMOTE_SSH_MESSAGE_RESULT_BLOCKED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_RESULT_QUEUED = `OPALINE_REMOTE_SSH_MESSAGE_RESULT_QUEUED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  $n = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_UNSPECIFIED = `OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_STEER = `OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_STEER`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_QUEUE = `OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_QUEUE`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_STOP = `OPALINE_REMOTE_SSH_MESSAGE_SUBMIT_ACTION_STOP`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  er = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_UNSPECIFIED = `OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_DISCONNECTED = `OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_DISCONNECTED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_LOGIN_REQUIRED = `OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_LOGIN_REQUIRED`),
      (e.OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_MISSING_REMOTE_PROJECT_PATH = `OPALINE_REMOTE_SSH_MESSAGE_BLOCKED_REASON_MISSING_REMOTE_PROJECT_PATH`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  tr = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_THREAD_ACTION_UNSPECIFIED = `OPALINE_REMOTE_SSH_THREAD_ACTION_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_THREAD_ACTION_START = `OPALINE_REMOTE_SSH_THREAD_ACTION_START`),
      (e.OPALINE_REMOTE_SSH_THREAD_ACTION_FORK = `OPALINE_REMOTE_SSH_THREAD_ACTION_FORK`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  nr = (function (e) {
    return (
      (e.OPALINE_REMOTE_SSH_THREAD_RESULT_UNSPECIFIED = `OPALINE_REMOTE_SSH_THREAD_RESULT_UNSPECIFIED`),
      (e.OPALINE_REMOTE_SSH_THREAD_RESULT_SUCCEEDED = `OPALINE_REMOTE_SSH_THREAD_RESULT_SUCCEEDED`),
      (e.OPALINE_REMOTE_SSH_THREAD_RESULT_FAILED = `OPALINE_REMOTE_SSH_THREAD_RESULT_FAILED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  rr = (function (e) {
    return (
      (e.OPALINE_APP_TURN_STATUS_UNSPECIFIED = `OPALINE_APP_TURN_STATUS_UNSPECIFIED`),
      (e.OPALINE_APP_TURN_STATUS_COMPLETED = `OPALINE_APP_TURN_STATUS_COMPLETED`),
      (e.OPALINE_APP_TURN_STATUS_INTERRUPTED = `OPALINE_APP_TURN_STATUS_INTERRUPTED`),
      (e.OPALINE_APP_TURN_STATUS_FAILED = `OPALINE_APP_TURN_STATUS_FAILED`),
      (e.OPALINE_APP_TURN_STATUS_IN_PROGRESS = `OPALINE_APP_TURN_STATUS_IN_PROGRESS`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  ir = (function (e) {
    return (
      (e.OPALINE_APP_TURN_TRANSPORT_UNSPECIFIED = `OPALINE_APP_TURN_TRANSPORT_UNSPECIFIED`),
      (e.OPALINE_APP_TURN_TRANSPORT_LOCAL = `OPALINE_APP_TURN_TRANSPORT_LOCAL`),
      (e.OPALINE_APP_TURN_TRANSPORT_SSH = `OPALINE_APP_TURN_TRANSPORT_SSH`),
      (e.OPALINE_APP_TURN_TRANSPORT_REMOTE_CONTROL = `OPALINE_APP_TURN_TRANSPORT_REMOTE_CONTROL`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  ar = (function (e) {
    return (
      (e.OPALINE_SLASH_COMMAND_SELECTION_SOURCE_UNSPECIFIED = `OPALINE_SLASH_COMMAND_SELECTION_SOURCE_UNSPECIFIED`),
      (e.OPALINE_SLASH_COMMAND_SELECTION_SOURCE_AUTOCOMPLETE = `OPALINE_SLASH_COMMAND_SELECTION_SOURCE_AUTOCOMPLETE`),
      (e.OPALINE_SLASH_COMMAND_SELECTION_SOURCE_DIALOG = `OPALINE_SLASH_COMMAND_SELECTION_SOURCE_DIALOG`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  or = (function (e) {
    return (
      (e.OPALINE_AVATAR_OVERLAY_ACTION_UNSPECIFIED = `OPALINE_AVATAR_OVERLAY_ACTION_UNSPECIFIED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_OPEN_REQUESTED = `OPALINE_AVATAR_OVERLAY_ACTION_OPEN_REQUESTED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED = `OPALINE_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_OPENED = `OPALINE_AVATAR_OVERLAY_ACTION_OPENED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_PET_SELECTED = `OPALINE_AVATAR_OVERLAY_ACTION_PET_SELECTED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED = `OPALINE_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED = `OPALINE_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_TRAY_OPENED = `OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_TRAY_OPENED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_TRAY_CLOSED = `OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_TRAY_CLOSED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_OPENED = `OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_OPENED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_DISMISSED = `OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_DISMISSED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_OPENED = `OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_OPENED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_SUBMITTED = `OPALINE_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_SUBMITTED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_CLOSED = `OPALINE_AVATAR_OVERLAY_ACTION_CLOSED`),
      (e.OPALINE_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED = `OPALINE_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  sr = (function (e) {
    return (
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_UNSPECIFIED = `OPALINE_AVATAR_OVERLAY_SOURCE_UNSPECIFIED`),
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_SETTINGS = `OPALINE_AVATAR_OVERLAY_SOURCE_SETTINGS`),
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_CONTEXT_MENU = `OPALINE_AVATAR_OVERLAY_SOURCE_CONTEXT_MENU`),
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_MASCOT = `OPALINE_AVATAR_OVERLAY_SOURCE_MASCOT`),
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_BADGE = `OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_BADGE`),
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_ROW = `OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_ROW`),
      (e.OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY = `OPALINE_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  cr = (function (e) {
    return (
      (e.OPALINE_AVATAR_OVERLAY_PET_KIND_UNSPECIFIED = `OPALINE_AVATAR_OVERLAY_PET_KIND_UNSPECIFIED`),
      (e.OPALINE_AVATAR_OVERLAY_PET_KIND_BUILT_IN = `OPALINE_AVATAR_OVERLAY_PET_KIND_BUILT_IN`),
      (e.OPALINE_AVATAR_OVERLAY_PET_KIND_CUSTOM = `OPALINE_AVATAR_OVERLAY_PET_KIND_CUSTOM`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  lr = (function (e) {
    return (
      (e.OPALINE_AVATAR_OVERLAY_NOTIFICATION_SOURCE_UNSPECIFIED = `OPALINE_AVATAR_OVERLAY_NOTIFICATION_SOURCE_UNSPECIFIED`),
      (e.OPALINE_AVATAR_OVERLAY_NOTIFICATION_SOURCE_LOCAL = `OPALINE_AVATAR_OVERLAY_NOTIFICATION_SOURCE_LOCAL`),
      (e.OPALINE_AVATAR_OVERLAY_NOTIFICATION_SOURCE_CLOUD = `OPALINE_AVATAR_OVERLAY_NOTIFICATION_SOURCE_CLOUD`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  ur = (function (e) {
    return (
      (e.OPALINE_THREAD_SWITCH_KIND_UNSPECIFIED = `OPALINE_THREAD_SWITCH_KIND_UNSPECIFIED`),
      (e.OPALINE_THREAD_SWITCH_KIND_HOT = `OPALINE_THREAD_SWITCH_KIND_HOT`),
      (e.OPALINE_THREAD_SWITCH_KIND_COLD = `OPALINE_THREAD_SWITCH_KIND_COLD`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  dr = (function (e) {
    return (
      (e.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_UNSPECIFIED = `OPALINE_PROFILE_EDIT_SAVE_API_STATUS_UNSPECIFIED`),
      (e.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED = `OPALINE_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED`),
      (e.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED = `OPALINE_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED`),
      (e.OPALINE_PROFILE_EDIT_SAVE_API_STATUS_FAILED = `OPALINE_PROFILE_EDIT_SAVE_API_STATUS_FAILED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  fr = (function (e) {
    return (
      (e.OPALINE_PROFILE_EDIT_ACTION_UNSPECIFIED = `OPALINE_PROFILE_EDIT_ACTION_UNSPECIFIED`),
      (e.OPALINE_PROFILE_EDIT_ACTION_OPENED = `OPALINE_PROFILE_EDIT_ACTION_OPENED`),
      (e.OPALINE_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED = `OPALINE_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED`),
      (e.OPALINE_PROFILE_EDIT_ACTION_SAVE_FAILED = `OPALINE_PROFILE_EDIT_ACTION_SAVE_FAILED`),
      (e.OPALINE_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED = `OPALINE_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED`),
      (e.OPALINE_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED = `OPALINE_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  pr = (function (e) {
    return (
      (e.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_UNSPECIFIED = `OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_UNSPECIFIED`),
      (e.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED = `OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED`),
      (e.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED = `OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED`),
      (e.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED = `OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED`),
      (e.OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED = `OPALINE_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  mr = (function (e) {
    return (
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_UNSPECIFIED = `OPALINE_ONBOARDING_WIZARD_PHASE_UNSPECIFIED`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_LAUNCH = `OPALINE_ONBOARDING_WIZARD_PHASE_LAUNCH`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_ROLE_PICKER = `OPALINE_ONBOARDING_WIZARD_PHASE_ROLE_PICKER`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_TASK_PICKER = `OPALINE_ONBOARDING_WIZARD_PHASE_TASK_PICKER`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_CONTEXT_PICKER = `OPALINE_ONBOARDING_WIZARD_PHASE_CONTEXT_PICKER`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_PLUGIN_INSTALL = `OPALINE_ONBOARDING_WIZARD_PHASE_PLUGIN_INSTALL`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_FIRST_ARTIFACT = `OPALINE_ONBOARDING_WIZARD_PHASE_FIRST_ARTIFACT`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_PLUGIN_PICKER = `OPALINE_ONBOARDING_WIZARD_PHASE_PLUGIN_PICKER`),
      (e.OPALINE_ONBOARDING_WIZARD_PHASE_COMPLETION = `OPALINE_ONBOARDING_WIZARD_PHASE_COMPLETION`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  hr = (function (e) {
    return (
      (e.OPALINE_ONBOARDING_WIZARD_ACTION_UNSPECIFIED = `OPALINE_ONBOARDING_WIZARD_ACTION_UNSPECIFIED`),
      (e.OPALINE_ONBOARDING_WIZARD_ACTION_COMPLETED = `OPALINE_ONBOARDING_WIZARD_ACTION_COMPLETED`),
      (e.OPALINE_ONBOARDING_WIZARD_ACTION_SKIPPED = `OPALINE_ONBOARDING_WIZARD_ACTION_SKIPPED`),
      (e.OPALINE_ONBOARDING_WIZARD_ACTION_DISMISSED = `OPALINE_ONBOARDING_WIZARD_ACTION_DISMISSED`),
      (e.OPALINE_ONBOARDING_WIZARD_ACTION_FAILED = `OPALINE_ONBOARDING_WIZARD_ACTION_FAILED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  gr = (function (e) {
    return (
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_UNSPECIFIED = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_UNSPECIFIED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_SHOWN = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_SHOWN`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_SEND_SUCCEEDED = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_SEND_SUCCEEDED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_BACKEND_ERROR = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_BACKEND_ERROR`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ACTION_DONE_CLICKED = `OPALINE_REFERRAL_INVITE_MODAL_ACTION_DONE_CLICKED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  _r = (function (e) {
    return (
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNSPECIFIED = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNSPECIFIED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_BACKEND_ISSUE = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_BACKEND_ISSUE`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_RATE_LIMITED = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_RATE_LIMITED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_AUTHENTICATION_REQUIRED = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_AUTHENTICATION_REQUIRED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_PERMISSION_DENIED = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_PERMISSION_DENIED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR = `OPALINE_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  vr = (function (e) {
    return (
      (e.OPALINE_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_UNSPECIFIED = `OPALINE_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_UNSPECIFIED`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_USER = `OPALINE_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_USER`),
      (e.OPALINE_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_SYSTEM = `OPALINE_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_SYSTEM`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  yr = (function (e) {
    return (
      (e.OPALINE_PREVIOUS_TURN_EXPANDED_TARGET_UNSPECIFIED = `OPALINE_PREVIOUS_TURN_EXPANDED_TARGET_UNSPECIFIED`),
      (e.OPALINE_PREVIOUS_TURN_EXPANDED_TARGET_TURN = `OPALINE_PREVIOUS_TURN_EXPANDED_TARGET_TURN`),
      (e.OPALINE_PREVIOUS_TURN_EXPANDED_TARGET_TOOL_CALL = `OPALINE_PREVIOUS_TURN_EXPANDED_TARGET_TOOL_CALL`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  br = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_ACTION_UNSPECIFIED = `OPALINE_AUTOMATION_ACTION_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_ACTION_CREATED = `OPALINE_AUTOMATION_ACTION_CREATED`),
      (e.OPALINE_AUTOMATION_ACTION_UPDATED = `OPALINE_AUTOMATION_ACTION_UPDATED`),
      (e.OPALINE_AUTOMATION_ACTION_DELETED = `OPALINE_AUTOMATION_ACTION_DELETED`),
      (e.OPALINE_AUTOMATION_ACTION_RUN_NOW = `OPALINE_AUTOMATION_ACTION_RUN_NOW`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  xr = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_SOURCE_UNSPECIFIED = `OPALINE_AUTOMATION_SOURCE_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_SOURCE_MANUAL_PAGE = `OPALINE_AUTOMATION_SOURCE_MANUAL_PAGE`),
      (e.OPALINE_AUTOMATION_SOURCE_SUGGESTED_CARD = `OPALINE_AUTOMATION_SOURCE_SUGGESTED_CARD`),
      (e.OPALINE_AUTOMATION_SOURCE_PENDING_WORKTREE = `OPALINE_AUTOMATION_SOURCE_PENDING_WORKTREE`),
      (e.OPALINE_AUTOMATION_SOURCE_PR_MERGE_HELPER = `OPALINE_AUTOMATION_SOURCE_PR_MERGE_HELPER`),
      (e.OPALINE_AUTOMATION_SOURCE_AGENT_TOOL = `OPALINE_AUTOMATION_SOURCE_AGENT_TOOL`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Sr = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_FAILURE_REASON_UNSPECIFIED = `OPALINE_AUTOMATION_FAILURE_REASON_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_FAILURE_REASON_HOST_ERROR = `OPALINE_AUTOMATION_FAILURE_REASON_HOST_ERROR`),
      (e.OPALINE_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION = `OPALINE_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION`),
      (e.OPALINE_AUTOMATION_FAILURE_REASON_INVALID_ID = `OPALINE_AUTOMATION_FAILURE_REASON_INVALID_ID`),
      (e.OPALINE_AUTOMATION_FAILURE_REASON_STORAGE_UNAVAILABLE = `OPALINE_AUTOMATION_FAILURE_REASON_STORAGE_UNAVAILABLE`),
      (e.OPALINE_AUTOMATION_FAILURE_REASON_STATE_CLEANUP_FAILED = `OPALINE_AUTOMATION_FAILURE_REASON_STATE_CLEANUP_FAILED`),
      (e.OPALINE_AUTOMATION_FAILURE_REASON_REMOVE_FAILED = `OPALINE_AUTOMATION_FAILURE_REASON_REMOVE_FAILED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Cr = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_DELETE_STATUS_UNSPECIFIED = `OPALINE_AUTOMATION_DELETE_STATUS_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_DELETE_STATUS_DELETED = `OPALINE_AUTOMATION_DELETE_STATUS_DELETED`),
      (e.OPALINE_AUTOMATION_DELETE_STATUS_NOT_FOUND = `OPALINE_AUTOMATION_DELETE_STATUS_NOT_FOUND`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  wr = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_UNSPECIFIED = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_DAILY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_DAILY`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY`),
      (e.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY = `OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Tr = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_KIND_UNSPECIFIED = `OPALINE_AUTOMATION_KIND_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_KIND_CRON = `OPALINE_AUTOMATION_KIND_CRON`),
      (e.OPALINE_AUTOMATION_KIND_HEARTBEAT = `OPALINE_AUTOMATION_KIND_HEARTBEAT`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Er = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_STATUS_UNSPECIFIED = `OPALINE_AUTOMATION_STATUS_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_STATUS_ACTIVE = `OPALINE_AUTOMATION_STATUS_ACTIVE`),
      (e.OPALINE_AUTOMATION_STATUS_PAUSED = `OPALINE_AUTOMATION_STATUS_PAUSED`),
      (e.OPALINE_AUTOMATION_STATUS_DELETED = `OPALINE_AUTOMATION_STATUS_DELETED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Dr = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_UNSPECIFIED = `OPALINE_AUTOMATION_REASONING_EFFORT_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_NONE = `OPALINE_AUTOMATION_REASONING_EFFORT_NONE`),
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_MINIMAL = `OPALINE_AUTOMATION_REASONING_EFFORT_MINIMAL`),
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_LOW = `OPALINE_AUTOMATION_REASONING_EFFORT_LOW`),
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_MEDIUM = `OPALINE_AUTOMATION_REASONING_EFFORT_MEDIUM`),
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_HIGH = `OPALINE_AUTOMATION_REASONING_EFFORT_HIGH`),
      (e.OPALINE_AUTOMATION_REASONING_EFFORT_XHIGH = `OPALINE_AUTOMATION_REASONING_EFFORT_XHIGH`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Or = (function (e) {
    return (
      (e.OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_UNSPECIFIED = `OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_UNSPECIFIED`),
      (e.OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE = `OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE`),
      (e.OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL = `OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  kr = (function (e) {
    return (
      (e.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_UNSPECIFIED = `OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_UNSPECIFIED`),
      (e.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_DIRECT_CREATE = `OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_DIRECT_CREATE`),
      (e.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_EDIT = `OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_EDIT`),
      (e.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_LOCAL_ROUNDTRIP_EDIT = `OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_LOCAL_ROUNDTRIP_EDIT`),
      (e.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_UNKNOWN = `OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_UNKNOWN`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  Ar = (function (e) {
    return (
      (e.OPALINE_APPGEN_NUX_ACTION_UNSPECIFIED = `OPALINE_APPGEN_NUX_ACTION_UNSPECIFIED`),
      (e.OPALINE_APPGEN_NUX_ACTION_VIEWED = `OPALINE_APPGEN_NUX_ACTION_VIEWED`),
      (e.OPALINE_APPGEN_NUX_ACTION_DISMISSED = `OPALINE_APPGEN_NUX_ACTION_DISMISSED`),
      (e.OPALINE_APPGEN_NUX_ACTION_TRY_SITES_CLICKED = `OPALINE_APPGEN_NUX_ACTION_TRY_SITES_CLICKED`),
      (e.UNRECOGNIZED = `UNRECOGNIZED`),
      e
    );
  })({}),
  jr = { $type: `protobuf_analytics_events.v1.OpalineRemoteSshConnectionEvent` },
  Mr = { $type: `protobuf_analytics_events.v1.OpalineRemoteControlConnectionsRefreshed` },
  Nr = { $type: `protobuf_analytics_events.v1.OpalineRemoteSshMessageEvent` },
  Pr = { $type: `protobuf_analytics_events.v1.OpalineRemoteSshThreadEvent` },
  Fr = { $type: `protobuf_analytics_events.v1.OpalineAppTurnEvent` },
  Ir = { $type: `protobuf_analytics_events.v1.OpalineSettingsWorkModeSelected` },
  Lr = { $type: `protobuf_analytics_events.v1.OpalineI18nLocaleResolved` },
  Rr = { $type: `protobuf_analytics_events.v1.OpalineI18nLanguageSelected` },
  zr = { $type: `protobuf_analytics_events.v1.OpalineSlashCommandSelected` },
  Br = { $type: `protobuf_analytics_events.v1.OpalineAvatarOverlayEvent` },
  Vr = { $type: `protobuf_analytics_events.v1.OpalineThreadSwitchCompleted` },
  Hr = { $type: `protobuf_analytics_events.v1.OpalineSidebarUsageAlertViewed` },
  Ur = { $type: `protobuf_analytics_events.v1.OpalineSidebarUsageAlertDismissed` },
  Wr = { $type: `protobuf_analytics_events.v1.OpalineSidebarUsageAlertCtaClicked` },
  Gr = { $type: `protobuf_analytics_events.v1.OpalineRateLimitResetCreditRedeemed` },
  Kr = { $type: `protobuf_analytics_events.v1.OpalineOnboardingStepViewed` },
  qr = { $type: `protobuf_analytics_events.v1.OpalineLoginPageViewed` },
  Jr = { $type: `protobuf_analytics_events.v1.OpalineProfilePageEntrypointClicked` },
  Yr = { $type: `protobuf_analytics_events.v1.OpalineProfilePageViewed` },
  Xr = { $type: `protobuf_analytics_events.v1.OpalineProfileEditEvent` },
  Zr = { $type: `protobuf_analytics_events.v1.OpalineProfileInlinePhotoChangeEvent` },
  Qr = { $type: `protobuf_analytics_events.v1.OpalineLoginMethodSelected` },
  $r = { $type: `protobuf_analytics_events.v1.OpalineLoginSuccess` },
  ei = { $type: `protobuf_analytics_events.v1.OpalineLoginFailure` },
  ti = { $type: `protobuf_analytics_events.v1.OpalineOnboardingCompleted` },
  ni = { $type: `protobuf_analytics_events.v1.OpalineOnboardingWizardStep` },
  ri = { $type: `protobuf_analytics_events.v1.OpalineReferralInviteModalEvent` },
  ii = { $type: `protobuf_analytics_events.v1.OpalineUpgradePlanModalShown` },
  ai = { $type: `protobuf_analytics_events.v1.OpalineUpgradePlanModalCtaClicked` },
  oi = { $type: `protobuf_analytics_events.v1.OpalineCreditReloadModalShown` },
  si = { $type: `protobuf_analytics_events.v1.OpalineCreditReloadPurchaseCtaClicked` },
  ci = { $type: `protobuf_analytics_events.v1.OpalineCreditReloadAutoReloadSettingsChanged` },
  li = { $type: `protobuf_analytics_events.v1.OpalinePreviousTurnExpanded` },
  ui = { $type: `protobuf_analytics_events.v1.OpalineAutomationEvent` },
  di = { $type: `protobuf_analytics_events.v1.OpalineFileProduced` },
  fi = { $type: `protobuf_analytics_events.v1.OpalineFileOpened` },
  pi = { $type: `protobuf_analytics_events.v1.OpalineFileUploaded` },
  mi = { $type: `protobuf_analytics_events.v1.OpalineGoogleWorkspaceArtifactTurn` },
  hi = { $type: `protobuf_analytics_events.v1.OpalineAppgenNuxEvent` },
  gi = e(Ne(), 1),
...
function xi(e) {
  return {
    action: Kn.OPALINE_REMOTE_SSH_CONNECTION_ACTION_REFRESH,
    result: qn.OPALINE_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED,
    source: Jn.OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
    connectionCount: e.length,
    opalineManagedConnectionCount: ee(e, `opaline-managed`).length,
...
function Ci(e) {
  switch (e) {
    case `opaline-managed`:
      return Yn.OPALINE_REMOTE_SSH_CONNECTION_SOURCE_OPALINE_MANAGED;
    case `discovered`:
      return Yn.OPALINE_REMOTE_SSH_CONNECTION_SOURCE_DISCOVERED;
  }
}
function wi(e) {
  switch (e) {
    case `disconnected`:
      return Xn.OPALINE_REMOTE_SSH_CONNECTION_STATE_DISCONNECTED;
    case `connecting`:
    case `restarting`:
      return Xn.OPALINE_REMOTE_SSH_CONNECTION_STATE_CONNECTING;
    case `error`:
      return Xn.OPALINE_REMOTE_SSH_CONNECTION_STATE_ERROR;
    case `connected`:
      return Xn.OPALINE_REMOTE_SSH_CONNECTION_STATE_CONNECTED;
    case null:
      return Xn.OPALINE_REMOTE_SSH_CONNECTION_STATE_UNSPECIFIED;
  }
}
function Ti(e) {
  if (e == null) return Zn.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN;
  switch (e.code) {
    case `connection-failed`:
    case `remote-opaline-not-found`:
      return Zn.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED;
    case `login-required`:
      return Zn.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_LOGIN_REQUIRED;
    case `update-required`:
      return Zn.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UPDATE_REQUIRED;
    case `restart-required`:
      return Zn.OPALINE_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_RESTART_REQUIRED;
  }
}
...
function Oi(e, { error: t, hostId: n, previousError: r, previousState: i, state: a }) {
  ...
  o != null &&
    Di(e.get(vt), {
      action: Kn.OPALINE_REMOTE_SSH_CONNECTION_ACTION_STATE_CHANGED,
      source: Jn.OPALINE_REMOTE_SSH_CONNECTION_EVENT_SOURCE_CONNECTION_MANAGER,
      connection: o,
      connectionState: a,
...
function Ho(e, t) {
  t.addTurnCompletedListener((t) => {
    ...
    (n == null
      ? r == null
        ? t.hostId === `local` && (i = ir.OPALINE_APP_TURN_TRANSPORT_LOCAL)
        : (i = ir.OPALINE_APP_TURN_TRANSPORT_REMOTE_CONTROL)
      : (i = ir.OPALINE_APP_TURN_TRANSPORT_SSH),
...
function Uo(e) {
  switch (e) {
    case `completed`:
      return rr.OPALINE_APP_TURN_STATUS_COMPLETED;
    case `interrupted`:
      return rr.OPALINE_APP_TURN_STATUS_INTERRUPTED;
    case `failed`:
      return rr.OPALINE_APP_TURN_STATUS_FAILED;
    case `inProgress`:
      return rr.OPALINE_APP_TURN_STATUS_IN_PROGRESS;
  }
}
var Wo = t((e, t) => {
    var n = ge(),
...
var Hs = `features.onboarding_interactive_tools`,
  ...
  Gs = `setup_opaline_step`,
  Ks = `setup_opaline_context_picker`,
...
var tc = {
    name: Gs,
    description: `Advance the native Setup Opaline flow through role, task, context, plugin, and completion steps.`,
    inputSchema: {
      type: `object`,
  ...
  nc = [
    {
      name: Us,
      description: `Ask the user to pick one or more options in the Opaline onboarding flow.`,
      inputSchema: {
        type: `object`,
        properties: {
    ...
    {
      name: Ws,
      description: `Ask one to three structured onboarding questions using the native-looking Opaline input panel. Use this for choosing a first task or asking concise onboarding follow-up questions.`,
      inputSchema: {
        type: `object`,
        properties: {
          questions: {
    ...
    {
      name: Ks,
      description: `Show the Opaline onboarding context-source picker so the user can connect apps or choose a local folder.`,
...
var Fc = x([`session`, `always`]),
  ...
  Bc = {
    opaline_approval_kind: M(`tool_suggestion`),
  ...
  Vc = f(`opaline_approval_kind`, [
    f(`tool_type`, [
      n({ ...Bc, tool_type: M(`connector`), install_url: P() }).passthrough(),
      n({ ...Bc, tool_type: M(`plugin`), install_url: P().optional() }).passthrough(),
    ]),
    n({
      opaline_approval_kind: M(`mcp_tool_call`),
      opaline_request_type: M(`approval_request`).optional(),
      connector_id: P(),
...
function Uc(e) {
  ...
  if (e.mode === `url`) {
    ...
    return e.serverName === `opaline_apps`
      ? !r.success || !Zc(t.hostname)
        ...
        : {
            ...
            message: e.message,
            url: t.toString(),
            connector: r.data._opaline_apps.connector_auth_failure,
          }
      : {
          ...n,
          kind: `urlAction`,
  ...
  if (r.success)
    switch (r.data.opaline_approval_kind) {
...
function Gc(e, t, r) {
  return n({ opaline_approval_kind: M(`mcp_tool_call`) }).safeParse(r).success
    ? !0
...
function Gl(e) {
  let t = e.trim();
  if (!t.startsWith(`<opaline_delegation>`) || !t.endsWith(`</opaline_delegation>`)) return null;
...
var vu = `## Code review guidelines:`,
  ...
  Su = `## Prior conversation with Opaline:`,
  Cu = `# Diff comments:`,
  wu = `# Browser comments:`,
  Tu = `# Selected text:`,
  Eu = `# MCP app context:`,
  ...
  Vu = `Style provenance:`,
  Hu = `Apply each annotation to the source code or design tokens that own the current UI. Treat the visible viewport as context, not a hard rule. Do not assume the annotation should apply globally or only at this viewport size; fit it into the existing responsive styling patterns, and call out any non-obvious breakpoint, container, or token decisions. Do not copy temporary Opaline preview attributes into source.`,
  Uu = `Attached images: `,
...
`),
  ...
  let d = l.trim(),
    ...
    S = y.includes(Ou),
    C = y.includes(xu),
    w = !b && !x && l.includes(`## Prior conversation with Opaline:`),
    ...
    h.length > 0 && (te = nl(te)),
    {
      ...
      item: {
        ...
        ...(f
          ...
          : {}),
        ...(p ? { opalineDelegation: { sourceThreadId: p.sourceThreadId } } : {}),
...
async function Kf(e, t, n, r) {
  ...
  if (o)
    try {
      let { opalineHome: t } = await e.fetchFromHost(`opaline-home`, { params: { hostId: e.hostId } });
      o = te(n, t);
    } catch {}
  let s = null;
  if (o)
...
var Rp =
  /^(.*(?:^|[\\/])Documents[\\/]+Opaline)[\\/]+(?:\d{4}-\d{2}-\d{2}-[a-z0-9][a-z0-9-]*|\d{4}-\d{2}-\d{2}[\\/]+[a-z0-9][a-z0-9-]*)[\\/]*$/;
function zp(e) {
...
var ug = `feature_overrides`,
  ...
  gg = [
    ...
    { gateName: `2307253562`, featureKey: `opaline_git_commit` },
  ...
  Ag = class {
    ...
    async buildNewConversationParams(e, t, n, r, i, a, o, s) {
      let c = await C(
        ...
        n,
        r,
        () => this.buildThreadOpalineConfig(n),
        o,
        i,
    ...
    async buildThreadOpalineConfig(e) {
      return (await this.params.fetchFromHost(`mcp-opaline-config`, { params: { cwd: e } })).config;
    }
    async startThread({
      model: e,
      serviceTier: t,
...
function m_(e) {
  ...
  for (let n = e.turns.length - 1; n >= 0; --n) {
    ...
    if (i.turnId != null) {
      ...
      let s = e?.latestSetupOpalineStepRequest;
      if (s != null) return { type: `setupOpalineStep`, ...s };
      let c = w_(i);
      ...
      : f_(m_(e)?.type)
        ...
        : e.requests.some(
            (e) =>
              ...
              e.method === `item/tool/requestSetupOpalineContextPicker` ||
              (e.method === `item/tool/call` &&
                (e.params.tool === `request_onboarding_input` ||
                  e.params.tool === `request_option_picker` ||
                  e.params.tool === `setup_opaline_context_picker` ||
                  (e.params.tool === `setup_opaline_step` && x_(e.params.arguments)))) ||
              (e.method === `mcpServer/elicitation/request` && Uc(e.params) != null),
          );
}
function __(e) {
...
function y_(e) {
  ...
  for (let i = e.length - 1; i >= 0; --i) {
    ...
    switch (a.method) {
      ...
      case `item/tool/requestSetupOpalineContextPicker`: {
        let e = b_(r, a.params.turnId);
        e.latestSetupOpalineStepRequest ??= { requestId: j(a.id), request: a, step: `context` };
        continue;
      }
      case `item/tool/call`:
        ...
        if (a.params.tool === `setup_opaline_step`) {
          let e = Zs.safeParse(a.params.arguments);
          if (!e.success || e.data.step === `complete`) continue;
          let t = b_(r, a.params.turnId);
          t.latestSetupOpalineStepRequest ??= { requestId: j(a.id), request: a, step: e.data.step };
          continue;
        }
        continue;
...
function b_(e, t) {
  ...
  let r = {
    ...
    latestSetupOpalineStepRequest: null,
  };
  return (e.set(t, r), r);
}
function x_(e) {
...
function uv(e, t) {
  mt(e, { eventName: `opaline_onboarding_step_continue_clicked`, metadata: { step: t } });
}
function dv(e, t) {
  mt(e, { eventName: `opaline_onboarding_step_skipped`, metadata: { step: t } });
}
function fv(e, t, n) {
  ht(e, ni, { phase: t, action: n });
}
var pv = {
    role_picker: mr.OPALINE_ONBOARDING_WIZARD_PHASE_ROLE_PICKER,
    task_picker: mr.OPALINE_ONBOARDING_WIZARD_PHASE_TASK_PICKER,
    context_picker: mr.OPALINE_ONBOARDING_WIZARD_PHASE_CONTEXT_PICKER,
  },
  mv = {
    completed: hr.OPALINE_ONBOARDING_WIZARD_ACTION_COMPLETED,
    skip: hr.OPALINE_ONBOARDING_WIZARD_ACTION_SKIPPED,
    dismiss: hr.OPALINE_ONBOARDING_WIZARD_ACTION_DISMISSED,
  };
function hv(e, t, n, r) {
  ...
  if (
    ...
    i.params.tool !== `setup_opaline_step` ||
    !a?.success ||
    a.data.step !== r.step
  )
    return;
...
async function Av(
  ...
  let f = await e.buildThreadOpalineConfig(r ?? d?.cwd ?? null),
    ...
    throw (
      e.updateConversationState(t, (e) => {
        ...
        ((t.items ||= []),
          ...
          (t.status = `failed`),
          (t.error = { message: n, opalineErrorInfo: null, additionalDetails: null }),
...
var My = 250,
  Ny = class {
    ...
    async getAttachmentsRoot() {
      let { opalineHome: e } = await this.fetchFromHost(`opaline-home`, {
      ...
      if (n) {
        ...
        if (t.length > 0)
          for (let n of t) {
            ...
            if (n.method === `item/tool/requestSetupOpalineContextPicker`) {
              this.replyWithSetupOpalineContextPickerResponse(e, t, {
                action: `dismiss`,
                selectedSources: [],
              });
              continue;
...
`) === a,
          ...
          case `error`: {
            let { error: e, willRetry: t, threadId: r, turnId: i } = n.params,
              { message: a, opalineErrorInfo: o, additionalDetails: s } = e,
              c = N(r);
      ...
      if (
        ...
        switch (
          ...
          case `item/tool/requestSetupOpalineContextPicker`: {
            let n = `threadId` in r && typeof r.threadId == `string` ? r.threadId : null;
            if (!n) {
              B.error(`Missing threadId for setup Opaline context picker`, {
                safe: {},
                sensitive: { id: t, params: r },
              });
              return;
          ...
          case `item/tool/call`:
            ...
            if (
              ...
              r.tool === `setup_opaline_context_picker`
            ) {
...
`,
    ...
    getSetupOpalineStepActionContext() {
      return {
        hostId: this.hostId,
        scope: this.scope,
        dispatchMessageFromView: this.dispatchMessageFromView,
    ...
    replyWithSetupOpalineStepResponse(e, t, n) {
      hv(this.getSetupOpalineStepActionContext(), e, t, n);
    }
    ...
    replyWithSetupOpalineContextPickerResponse(e, t, n) {
      let r = this.getConversation(e)?.requests.find((e) => e.id === t);
      if (r?.method !== `item/tool/requestSetupOpalineContextPicker`) {
        if (r?.method !== `item/tool/call` || r.params.tool !== `setup_opaline_context_picker`)
          return;
        (this.dispatchMessageFromView(`mcp-response`, {
          hostId: this.hostId,
          response: { id: t, result: ec(n) },
    ...
    async buildThreadOpalineConfig(e) {
      return this.threadCreation.buildThreadOpalineConfig(e);
    }
...
var mx = n({ "opaline/browserUse": M(!0) });
...
function bw({
  ...
  return e && n && r.successfulReadToolCallCount > 0 && r.successfulWriteToolCallCount > 0
    ? kr.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_LOCAL_ROUNDTRIP_EDIT
    : e && r.successfulWriteToolCallCount > 0
      ? kr.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_EDIT
      : !e && t && !n && r.successfulWriteToolCallCount > 0
        ? kr.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_DIRECT_CREATE
        : kr.OPALINE_GOOGLE_WORKSPACE_ARTIFACT_FLOW_UNKNOWN;
}
function xw(e) {
...
var lT = `__opaline_directive_escaped_double_quote__`,
  uT = `__opaline_directive_escaped_single_quote__`,
  dT = `__opaline_directive_quoted_backslash__`,
  fT = `__opaline_directive_quoted_closing_bracket__`,
  pT = `__opaline_directive_quoted_closing_brace__`,
  mT = `__opaline_directive_`,
  hT = [`:::`, `::`],
...
function mO(e, t) {
  t.addNotificationCallback(`error`, (t) => {
    t.params.error.opalineErrorInfo === `usageLimitExceeded` && e.query.fetch(pO).catch(() => void 0);
  });
}
var hO = t((e, t) => {
    var n = Il();
...
function yk(e, t) {
  ...
  (t.addNotificationCallback(`turn/started`, (r) => {
    if (!St(e, vk)) return;
    let i = Sk(e);
    if (e.get(vt).submitOpalineAnalyticsEvent == null || i == null) return;
...
function Wk(e) {
  ...
  switch (e.method) {
    case `error`:
      return e.params.error.opalineErrorInfo === `cyberPolicy`
...
var vA = { cwd: null, diff: null, turnId: null },
  ...
  bA = ft(V, (e, { signal: t }) => {
    let n = t(`disconnected`),
      r = t(null);
    return { appServerVersion$: t(null), error$: r, installedOpalineVersion$: t(null), state$: n };
  }),
  xA = R(V, (e, { get: t }) => t(t(bA, e).state$)),
  SA = R(V, (e, { get: t }) => t(t(bA, e).error$)),
  CA = R(V, (e, { get: t }) => t(t(bA, e).appServerVersion$)),
  wA = R(V, (e, { get: t }) => t(t(bA, e).installedOpalineVersion$)),
  TA = $e(V, ({ get: e }) => {
    let t = e(DA, Fo);
...
function Bj(e, { appServerVersion: t, hostId: n, installedOpalineVersion: r }) {
  let i = e.get(bA, n);
  (i.appServerVersion$.set(t), r !== void 0 && i.installedOpalineVersion$.set(r));
}
var Vj = L(V, (e) => null, {
    onMount: (e, t) => {
      let { key: n } = t;

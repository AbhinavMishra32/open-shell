...
import { c as a, d as o, i as s, n as c, o as l, s as u, t as d, u as f } from "./dist-B8SKCozm.js";
import { a as p, i as m, n as h, o as g, r as _, s as v, t as y } from "./Combination-9DfZp13g.js";
import { lt as b } from "./vscode-api-sUstfl-x.js";
import { n as x } from "./window-zoom-context-CSPQZGcc.js";
import { n as S } from "./tooltip-dismiss-1FVw8OQP.js";
import { t as C } from "./button-Xd4Hy1MO.js";
import { t as w } from "./x-DypUcSQe.js";
import { t as T } from "./with-window-DPMmD2K-.js";
var E = e({
    Close: () => be,
    Content: () => _e,
    Description: () => ye,
  ...
  N = (e) => {
    let {
      ...
      s = D.useRef(null),
      c = D.useRef(null),
      [l, u] = d({ prop: r, defaultProp: i ?? !1, onChange: a, caller: k });
    return (0, O.jsx)(j, {
      scope: t,
      triggerRef: s,
      contentRef: c,
  ...
  z = (e) => {
    ...
    return (0, O.jsx)(L, {
      ...
      children: D.Children.map(r, (e) =>
        (0, O.jsx)(c, {
          present: n || a.open,
          children: (0, O.jsx)(_, { asChild: !0, container: i, children: e }),
        }),
      ),
    });
  };
...
var B = `DialogOverlay`,
  V = D.forwardRef((e, t) => {
    let n = R(B, e.__scopeDialog),
      { forceMount: r = n.forceMount, ...i } = e,
      a = M(B, e.__scopeDialog);
    return a.modal
      ? (0, O.jsx)(c, { present: r || a.open, children: (0, O.jsx)(U, { ...i, ref: t }) })
      : null;
  });
V.displayName = B;
var H = l(`DialogOverlay.RemoveScroll`),
  U = D.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = M(B, n);
    return (0, O.jsx)(y, {
  ...
  G = D.forwardRef((e, t) => {
    let n = R(W, e.__scopeDialog),
      { forceMount: r = n.forceMount, ...i } = e,
      a = M(W, e.__scopeDialog);
    return (0, O.jsx)(c, {
      present: r || a.open,
      children: a.modal ? (0, O.jsx)(K, { ...i, ref: t }) : (0, O.jsx)(q, { ...i, ref: t }),
    });
  });
G.displayName = W;
var K = D.forwardRef((e, t) => {
    let n = M(W, e.__scopeDialog),
      r = D.useRef(null),
    ...
    return (
      ...
      (0, O.jsxs)(O.Fragment, {
        children: [
          ...
          (0, O.jsxs)(O.Fragment, {
            children: [
              (0, O.jsx)(ue, { titleId: s.titleId }),
              (0, O.jsx)(fe, { contentRef: c, descriptionId: s.descriptionId }),
            ],
          }),
        ],
      })
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
  ...
  fe = ({ contentRef: e, descriptionId: t }) => {
    let n = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${le(de).contentName}}.`;
    return (
      D.useEffect(() => {
  ...
  Ce = {
    content: xe,
    "opaline-dialog-enter": `_opaline-dialog-enter_pk7td_1`,
    overlay: Se,
    "opaline-dialog-overlay": `_opaline-dialog-overlay_pk7td_1`,
  },
  X = b(),
  we = i(
    `extension:bg-token-editor-background/80 electron:bg-[#00000022] opaline-dialog-overlay fixed inset-0 z-50`,
    Ce.overlay,
  );
function Te(e) {
  return e === `narrow`
...
function Ee(e) {
  ...
  let E;
  return (
    t[32] !== C || t[33] !== c || t[34] !== w || t[35] !== T
      ? ((E = (0, O.jsxs)(pe, { ...c, onOpenChange: C, children: [w, T] })),
        (t[32] = C),
        (t[33] = c),
        (t[34] = w),
        (t[35] = T),
...
function De(e) {
  let t = (0, X.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = (0, O.jsx)(ve, { ...e })), (t[0] = e), (t[1] = n)), n);
}
function Oe(e) {
  let t = (0, X.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = (0, O.jsx)(ye, { ...e })), (t[0] = e), (t[1] = n)), n);
}
function ke(e) {
  let t = (0, X.c)(8),
    n,
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (i = t[3]))
    : (({ asChild: r, triggerRef: i, ...n } = e), (t[0] = e), (t[1] = n), (t[2] = r), (t[3] = i));
  let a = r === void 0 ? !0 : r,
    o;
  return (
    t[4] !== a || t[5] !== n || t[6] !== i
      ? ((o = (0, O.jsx)(me, { ref: i, asChild: a, ...n })),
        (t[4] = a),
        (t[5] = n),
        (t[6] = i),
        (t[7] = o))
...
function Ae(e) {
  let t = (0, X.c)(35),
    ...
    m = l === void 0 ? !1 : l,
    h = u === void 0 ? !1 : u,
    { className: g, onPointerDown: _, onPointerDownOutside: v, style: y, ...b } = f,
    S = x(),
    C = i(
      `opaline-dialog left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 outline-none`,
      Ce.content,
  ...
  (t[0] === j
    ...
    : ((M = () => {
      ...
      (t[1] = M),
      (t[2] = N)),
    (0, D.useLayoutEffect)(M, N));
  let P = E,
    F = s ?? void 0,
    I;
  t[3] === o ? (I = t[4]) : ((I = i(we, o)), (t[3] = o), (t[4] = I));
  let L;
  t[5] === I ? (L = t[6]) : ((L = (0, O.jsx)(ge, { className: I })), (t[5] = I), (t[6] = L));
  let R = E,
    z = i(
      C,
      !h &&
    ...
    B = s == null && S !== 1 ? S : void 0,
    V;
  t[7] !== y || t[8] !== B
    ? ((V = { zoom: B, ...y }), (t[7] = y), (t[8] = B), (t[9] = V))
    : (V = t[9]);
  let H;
  t[10] !== v || t[11] !== m
    ? ((H = (e) => {
  ...
  let W;
  t[15] !== n || t[16] !== j
    ? ((W = j ? (0, O.jsx)(`div`, { ref: A, children: n }) : n),
      (t[15] = n),
      (t[16] = j),
      (t[17] = W))
    : (W = t[17]);
  ...
  let q;
  return (
    t[30] !== K || t[31] !== P.Portal || t[32] !== F || t[33] !== L
      ? ((q = (0, O.jsxs)(P.Portal, { container: F, children: [L, K] })),
        (t[30] = K),
        (t[31] = P.Portal),
        (t[32] = F),
        (t[33] = L),
...
var Me = `opaline.debug.dialogLayout`,
  Ne = `w-auto gap-2`,
...
function $(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, O.jsx)(`span`, { className: Pe, children: n })), (t[0] = n), (t[1] = r)),
    r
  );
}
function Ie(e) {
  ...
  t[0] !== o || t[1] !== m || t[2] !== p
    ? ((h = Q()),
      ...
      (_ = i(`flex flex-col items-start gap-3`, h && Z, o)),
      (t[0] = o),
      (t[1] = m),
      (t[2] = p),
      (t[3] = h),
  ...
  t[7] === h
    ? (y = t[8])
    : ((y = h ? (0, O.jsx)($, { name: `DialogHeader` }) : null), (t[7] = h), (t[8] = y));
  let b;
  t[9] !== n || t[10] !== c || t[11] !== s
    ? ((b = n
        ? (0, O.jsx)(`span`, {
    ...
    : (b = t[12]);
  let x;
  t[13] !== r || t[14] !== u || t[15] !== v
    ? ((x = r
        ? (0, O.jsx)(`div`, { className: i(v, `min-w-0 font-semibold`, u), children: r })
        : null),
      (t[13] = r),
      (t[14] = u),
      (t[15] = v),
  ...
  t[17] !== a || t[18] !== f || t[19] !== g
    ? ((S = a
        ? (0, O.jsx)(`div`, {
            className: i(`text-token-description-foreground`, g, f),
            children: a,
          })
        : null),
      (t[17] = a),
  ...
  return (
    t[24] !== _ || t[25] !== y || t[26] !== b || t[27] !== C
      ? ((w = (0, O.jsxs)(`div`, { className: _, children: [y, b, C] })),
        (t[24] = _),
        (t[25] = y),
        (t[26] = b),
        (t[27] = C),
...
function Le(e) {
  ...
  if (e.as === `form`) {
    ...
    t[6] === o
      ? (i = t[7])
      : ((i = o ? (0, O.jsx)($, { name: `DialogBody` }) : null), (t[6] = o), (t[7] = i));
    let a;
    return (
  ...
  t[15] === o
    ? (u = t[16])
    : ((u = o ? (0, O.jsx)($, { name: `DialogBody` }) : null), (t[15] = o), (t[16] = u));
  let d;
  return (
...
function Re(e) {
    ...
    let e = Q(),
      ...
      m = (e) =>
        f.map((t) => {
          ...
          let n = p === 1 ? `w-full justify-center` : void 0;
          return D.cloneElement(t, { size: t.props.size ?? e, className: i(t.props.className, n) });
        });
    ((c = i(`flex w-full items-center justify-end gap-3`, e && Z, r)),
      t[9] === e
        ? (l = t[10])
        : ((l = e ? (0, O.jsx)($, { name: `DialogFooter` }) : null), (t[9] = e), (t[10] = l)),
      (u = (0, O.jsx)(T, { browser: !0, children: m(`medium`) })),
      (d = (0, O.jsx)(T, { electron: !0, children: m(`medium`) })),
      (a = T),
      (o = !0),
      (s = m(`toolbar`)),
      (t[0] = n),
      ...
      (t[7] = u),
      (t[8] = d));
  } else ((a = t[2]), (o = t[3]), (s = t[4]), (c = t[5]), (l = t[6]), (u = t[7]), (d = t[8]));
  let f;
  t[11] !== a || t[12] !== o || t[13] !== s
    ? ((f = (0, O.jsx)(a, { extension: o, children: s })),
      (t[11] = a),
      (t[12] = o),
      (t[13] = s),
      (t[14] = f))
  ...
  let p;
  return (
    t[15] !== c || t[16] !== l || t[17] !== u || t[18] !== d || t[19] !== f
      ? ((p = (0, O.jsxs)(`div`, { className: c, children: [l, u, d, f] })),
        (t[15] = c),
        (t[16] = l),
        (t[17] = u),
        (t[18] = d),
...
function Be(e) {
  ...
  t[0] === r
    ? ((a = t[1]), (o = t[2]))
    : ((a = Q()),
      (o = i(`flex w-full flex-col pt-3 first:pt-0`, a && Z, r)),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o));
  let s;
  t[3] === a
    ? (s = t[4])
    : ((s = a ? (0, O.jsx)($, { name: `DialogSection` }) : null), (t[3] = a), (t[4] = s));
  let c;
  return (
    t[5] !== n || t[6] !== o || t[7] !== s
      ? ((c = (0, O.jsxs)(`div`, { className: o, children: [s, n] })),
        (t[5] = n),
        (t[6] = o),
        (t[7] = s),
        (t[8] = c))
...
function Ve(e) {
  ...
  t[0] === r
    ? ((a = t[1]), (o = t[2]))
    : ((a = Q()),
      (o = i(`relative flex items-center gap-2`, a && Z, r)),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o));
  let s;
  t[3] === a
    ? (s = t[4])
    : ((s = a ? (0, O.jsx)($, { name: `FormRow` }) : null), (t[3] = a), (t[4] = s));
  let c;
  return (
    t[5] !== n || t[6] !== o || t[7] !== s
      ? ((c = (0, O.jsxs)(`div`, { className: o, children: [s, n] })),
...
function He(e) {
  ...
  t[0] === r
    ? ((a = t[1]), (o = t[2]))
    : ((a = Q()), (o = i(`flex flex-col gap-2`, a && Z, r)), (t[0] = r), (t[1] = a), (t[2] = o));
  let s;
  t[3] === a
    ? (s = t[4])
    : ((s = a ? (0, O.jsx)($, { name: `FieldStack` }) : null), (t[3] = a), (t[4] = s));
  let c;
  return (
    t[5] !== n || t[6] !== o || t[7] !== s
      ? ((c = (0, O.jsxs)(`div`, { className: o, children: [s, n] })),
...
//# sourceMappingURL=dialog-layout-CCvvb1Vc.js.map

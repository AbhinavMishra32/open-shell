...
import { n as r } from "./dist-fk-6hqz4.js";
var i = {
...
function s(e) {
  ...
  return (
    n[9] !== s || n[10] !== m
      ? ((h = (0, o.jsx)(`div`, { ...s, className: m })), (n[9] = s), (n[10] = m), (n[11] = h))
      : (h = n[11]),
    h
  );
}
function c(e) {
  ...
  n[0] !== s || n[1] !== h || n[2] !== g || n[3] !== _
    ? ((v = t(h, g, _, s)), (n[0] = s), (n[1] = h), (n[2] = g), (n[3] = _), (n[4] = v))
    : (v = n[4]);
  let y;
  return (
    n[5] !== r || n[6] !== c || n[7] !== v
...
function l(e) {
  ...
  let d = u === void 0 ? !1 : u,
    ...
    p;
  n[5] !== s || n[6] !== f ? ((p = t(f, s)), (n[5] = s), (n[6] = f), (n[7] = p)) : (p = n[7]);
  let m = d && i.expandedTopTrayShell,
    h;
  n[8] !== c || n[9] !== m ? ((h = t(m, c)), (n[8] = c), (n[9] = m), (n[10] = h)) : (h = n[10]);
  let g;
  return (
    n[11] !== l || n[12] !== p || n[13] !== h
      ? ((g = (0, o.jsx)(r.Dialog, { ...l, className: p, contentClassName: h })),
        (n[11] = l),
        (n[12] = p),
        (n[13] = h),
        (n[14] = g))
...
//# sourceMappingURL=composer-top-menu-chrome-4snk27KP.js.map

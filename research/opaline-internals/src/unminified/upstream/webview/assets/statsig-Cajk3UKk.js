...
import { G as i, P as a, W as o, h as s, lt as c } from "./vscode-api-sUstfl-x.js";
var l = t((e) => {
        ...
        return t(this, void 0, void 0, function* () {
          ...
          try {
            ...
            ((t = `event_sender_pre_logs_flushed_emitter_exception`),
              ...
              (t = n ? `event_sender_unexpected_exception` : `event_sender_post_exception`));
            let i = n ? this._sendEventsViaBeacon(e, r) : yield this._sendEventsViaPost(e, r);
            return i.success
              ...
              Object.assign(
                Object.assign(
                  Object.assign(
                    ...
                    r.errorMessage ? { failureErrorMessage: r.errorMessage } : {},
                  ),
                  r.diagnosticBucket ? { failureDiagnosticBucket: r.diagnosticBucket } : {},
                ),
                r.diagnosticMetadata ? { failureDiagnosticMetadata: r.diagnosticMetadata } : {},
              )
            );
          }
        });
          ...
          return r === -1
            ? Object.assign(
                Object.assign(
                  ...
                  n.diagnosticBucket ? { failureDiagnosticBucket: n.diagnosticBucket } : {},
                ),
                n.diagnosticMetadata ? { failureDiagnosticMetadata: n.diagnosticMetadata } : {},
              )
      ...
      _sendEventsViaBeacon(e, t) {
        ...
        return Object.assign(
          Object.assign(
            ...
            !n && t.diagnosticBucket ? { failureDiagnosticBucket: t.diagnosticBucket } : {},
          ),
          !n && t.diagnosticMetadata ? { failureDiagnosticMetadata: t.diagnosticMetadata } : {},
        );
      }
      _getRequestData(e) {
        return {
    ...
    e.NetworkFallbackResolver = class {
      ...
      tryFetchUpdatedFallbackInfo(e, n, r, i) {
        return t(this, void 0, void 0, function* () {
          ...
          try {
            ...
            return (
              (t = this._errorBoundary) == null || t.logError(`tryFetchUpdatedFallbackInfo`, e),
              !1
            );
          }
        });
      ...
      _tryFetchFallbackUrlsFromNetwork(e) {
        return t(this, void 0, void 0, function* () {
          ...
          let r = [],
            i = yield (0, n._fetchTxtRecords)(this._networkOverrideFunc ?? fetch),
            a = p(e.defaultUrl);
          for (let t of i) {
            ...
            if (n.length > 1) {
              let e = n[1];
              (e.endsWith(`/`) && (e = e.slice(0, -1)), r.push(`https://${e}${a}`));
            }
          }
          return r;
        });
  ...
  k = t((e) => {
    ...
    ((0, a._subscribeToVisiblityChanged)((e) => {
      e === `background` && Object.values(u).forEach((e) => g(e));
    }),
    ...
    function d(e, t) {
      let n = Date.now();
      return (f(e) ? g(e) : t && ((e.data.lastUpdate = n), v(e)), e);
    }
    function f(e) {
      var t;
      let n = e.data,
    ...
    function g(e) {
      try {
        ((0, r._setObjectInStorage)(e.storageKey, e.data), (e.lastPersistedAt = Date.now()));
      } catch {
    ...
    function x() {
      return { sessionID: (0, i.getUUID)(), startTime: Date.now(), lastUpdate: Date.now() };
    }
  }),
  A = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
    ...
    e.StableID = {
      ...
      get: (e) => {
        ...
        return (
          (t = p(e)),
          t == null
            ? ((t = f(e)), (t ??= (0, a.getUUID)()), d(t, e), m(t, e), (o[e] = t), t)
            : ((o[e] = t), d(t, e), t)
        );
      },
      setOverride: (e, t) => {
  ...
  M = t((e) => {
      ...
      (e.NetworkCore = class {
        constructor(e, t) {
          ((this._emitter = t),
            ...
            (this._fallbackResolver = new o.NetworkFallbackResolver(this._options)),
        ...
        beacon(e, t) {
          if (!N(e)) return (t && (t.path = `beacon_invalid_sdk_key`), !1);
        ...
        _sendRequest(n, r) {
          return t(this, void 0, void 0, function* () {
            var t, a;
            if (!N(n)) return (r && (r.path = `network_invalid_sdk_key`), null);
            if (this._netConfig.preventAllNetworkTraffic)
              return (r && (r.path = `network_prevent_all_network_traffic`), null);
            ...
            try {
              ...
              t && ((t.lastRequestTime = Date.now()), (this._leakyBucket[u] = t));
              ...
              if (
                ((g = yield Promise.race([
                  ...
                  new Promise((e, t) => {
                    i = setTimeout(() => {
                      ((f = !0), t(Error(`Timeout of ${this._timeout}ms expired.`)));
                    }, this._timeout);
                  }),
                ])),
                !g.ok)
              ...
              if (
                ...
                if (
                  (i.Log.error(e, l, s),
                  (a = this._errorBoundary) == null || a.attachErrorIfNoneExists(e),
                ...
                if (g == null && r) {
                  ((r.path = u
                    ...
                    l && (r.errorMessage = l));
                  try {
                    let e = L(n, p, u, Date.now() - m);
                    ((r.diagnosticBucket = e.bucket), (r.diagnosticMetadata = e.metadata));
                  } catch {}
                }
                return null;
              }
              return (
                yield U(d),
                this._sendRequest(
                  Object.assign(Object.assign({}, n), { retries: c, attempt: d + 1 }),
                  r,
                )
              );
            }
        ...
        _getLogEventCompressionMode(e) {
          ...
          return (
            !t && e?.disableCompression === !0 && (t = _.LogEventCompressionMode.Disabled),
          ...
          let n = Object.assign(
              {
                ...
                [a.NetworkParam.SessionID]: p.SessionID.get(e.sdkKey),
              },
              e.params,
            ),
            r = Object.keys(n)
        ...
        _tryEncodeBody(e) {
          ...
          if (
            ...
            try {
              ...
              i.Log.warn(`Request encoding failed for ${e.urlConfig.getUrl()}`, t);
            }
        }
        _tryToCompressBody(e) {
          return t(this, void 0, void 0, function* () {
            let t = e.body;
            if (!(typeof t != `string` || !P(e, this._options)))
              try {
                ...
                i.Log.warn(`Request compression failed for ${e.urlConfig.getUrl()}`, t);
              }
          });
        }
        _getInternalRequestArgs(e, t) {
          ...
          return (`data` in t && re(r, t.data), r);
        }
      }));
    var N = (e) => (e.sdkKey ? !0 : (i.Log.warn(`Unable to make request without an SDK key`), !1)),
      re = (e, t) => {
        ...
        e.body = JSON.stringify(
          Object.assign(Object.assign({}, t), {
            statsigMetadata: Object.assign(Object.assign({}, g.StatsigMetadataProvider.get()), {
              stableID: i,
              sessionID: a,
              sdkType: o,
              fallbackUrl: r,
    ...
    function L(e, t, n, r) {
      let i = (0, f._getWindowSafe)(),
        a = i?.document,
        o = typeof navigator < `u` ? navigator : null,
        s = (0, C._isUnloading)(),
        c = o && typeof o.onLine == `boolean` ? String(o.onLine) : `unknown`,
        l = a?.visibilityState ?? `unknown`,
        u = Object.keys(e.headers ?? {}).length > 0,
        d = R(t, i?.location?.origin),
        p = e.urlConfig.customUrl != null,
        m = e.fallbackUrl != null,
        h = B(r, [250, 1e3, 5e3, 1e4]),
        g = B(z(e.body), [16384, 65536, 262144, 1048576]),
    ...
    function R(e, t) {
      return t ? !e.startsWith(`${t}/`) && !e.startsWith(`${t}?`) && e !== t : !0;
    }
    function z(e) {
      return e == null
        ? 0
    ...
    function U(e) {
      return t(this, void 0, void 0, function* () {
        yield new Promise((t) => setTimeout(t, Math.min(e * e * T, E)));
      });
    }
  }),
  N = t((e) => {
    ...
    e.FlushCoordinator = class {
      ...
      processManualFlush() {
        return t(this, void 0, void 0, function* () {
          return (
            ...
            (this._currentFlushPromise = this._executeFlush(a.FlushType.Manual).finally(() => {
      ...
      processShutdown() {
        return t(this, void 0, void 0, function* () {
          return (
            ...
            this._clearAllTimers(),
            this._currentFlushPromise && (yield this._currentFlushPromise),
            (this._currentFlushPromise = this._executeFlush(a.FlushType.Shutdown)
              .catch((e) => {
      ...
      checkQuickFlush() {
        this._hasRunQuickFlush ||
          Date.now() - this._creationTime > n.EventRetryConstants.QUICK_FLUSH_WINDOW_MS ||
      ...
      _attemptScheduledFlush() {
        ...
        let n;
        ((n = e ? a.FlushType.ScheduledFullBatch : a.FlushType.ScheduledMaxTime),
      ...
      _scheduleNextFlush() {
        ...
        this._cooldownTimer = setTimeout(() => {
          ((this._cooldownTimer = null),
            d.StatsigSession.checkForIdleSession(this._sdkKey),
      ...
      _processOneBatch(e, n) {
        return t(this, void 0, void 0, function* () {
          if (this._loggingEnabled !== f.LoggingEnabledOption.always && (0, u._isServerEnv)())
      ...
      _isRetryableBatch(e, t) {
        return !!(c.RETRYABLE_CODES.has(e) || (e === -1 && t && h.has(t)));
      }
      _handleFailure(e, t, r, i, o, c, l) {
        ...
        u > 0 &&
          (s.Log.warn(`Failed to requeue batch : dropped ${u} events due to full queue`),
          this._errorBoundary.logDroppedEvents(u, `Batch queue limit reached during requeue`, {
            loggingInterval: this._flushInterval.getCurrentIntervalMs(),
            batchSize: this._batchQueue.batchSize(),
            maxPendingBatches: n.EventRetryConstants.MAX_PENDING_BATCHES,
            flushType: t,
      ...
      loadAndRetryShutdownFailedEvents() {
        return t(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (t.length === 0) return;
            (s.Log.debug(`Loading ${t.length} failed shutdown event(s) from storage for retry`),
              m.Storage.removeItem(e),
              t.forEach((e) => {
                this.addEvent(e);
              }),
  ...
  I = t((e) => {
    ...
    e.EventLogger = class e {
      ...
      constructor(e, t, n, r, i) {
        ((this._sdkKey = e),
          ...
          (this._loggingEnabled =
            r?.loggingEnabled ??
            (r?.disableLogging === !0
              ? h.LoggingEnabledOption.disabled
              : h.LoggingEnabledOption.browserOnly)),
          r?.loggingEnabled &&
        ...
        this._logEventUrlConfig = new b.UrlConfiguration(
          c.Endpoint._rgstr,
          a?.logEventUrl,
          a?.api,
      ...
      _shouldLogEvent(e) {
        if (this._options?.loggingEnabled !== `always` && (0, d._isServerEnv)()) return !1;
        if (!(0, f._isExposureEvent)(e)) return !0;
        ...
        return o && s - o < T
          ? !1
          : (Object.keys(this._lastExposureTimeMap).length > w && (this._lastExposureTimeMap = {}),
      ...
      _initFlushCoordinator() {
        ...
        let e = this._options?.loggingBufferMaxSize ?? i.EventRetryConstants.DEFAULT_BATCH_SIZE;
        return (
          (this._pendingEvents = new u.PendingEvents(e)),
      ...
      _getEventsFromStorage(e) {
        try {
          let t = (0, y._getObjectFromStorage)(e);
          return Array.isArray(t) ? t : [];
        } catch {
          return [];
        }
      ...
      _loadStoredEvents() {
        ...
        return (t.length > 0 && y.Storage.removeItem(e), t);
      }
      _normalizeEvent(e) {
    ...
    e.DataAdapterCore = class {
      ...
      getDataSync(e) {
        ...
        return a && this._getIsCacheValueValid(a)
          ? (this._inMemoryCache.add(n, a, this._cacheLimit), this._inMemoryCache.get(n, t))
          : null;
      }
      setData(e, t) {
      ...
      _getIsCacheValueValid(e) {
        return e.stableID == null || e.stableID === r.StableID.get(this._getSdkKey());
      }
      ...
      _fetchAndPrepFromNetwork(e, i, a) {
        return t(this, void 0, void 0, function* () {
          ...
          if (!c) return (n.Log.debug(`No response returned for latest value`), null);
          let l = (0, o._typedJsonParse)(c, `has_updates`, `Response`),
            d = this._getSdkKey(),
            f = r.StableID.get(d),
            p = null;
          if (l?.has_updates === !0) p = u(`Network`, c, f, i);
          else if (t && l?.has_updates === !1) p = u(`NetworkNotModified`, t, f, i);
          else return null;
    ...
    e.ErrorBoundary = class {
      ...
      logEventRequestFailure(e, t, n, r, i, a, o, s, c) {
        ...
        (a && (l.failurePath = a),
          ...
          typeof s == `string` && s.length > 0 && (l.failureDiagnosticBucket = s),
          c &&
      ...
      _onError(c, l, d = !1, f) {
        try {
          (n.Log.warn(`Caught error in ${c}`, { error: l }),
            t(this, void 0, void 0, function* () {
              var t, n;
              let p = l || Error(a),
                m = p instanceof Error,
                h = m ? p.name : `No Name`;
              if (((this._lastSeenError = o(p)), !d && this._seen.has(h))) return;
              if ((this._seen.add(h), this._options?.networkConfig?.preventAllNetworkTraffic)) {
                (t = this._emitter) == null || t.call(this, { name: `error`, error: l, tag: c });
                return;
              }
              let g = r.SDKType._get(this._sdkKey),
                _ = i.StatsigMetadataProvider.get(),
                v = m ? p.stack : s(p),
                y = Object.assign(
                  Object.assign(
                    { tag: c, exception: h, info: v, statsigOptions: u(this._options) },
                    Object.assign(Object.assign({}, _), { sdkType: g }),
                  ),
                  f ?? {},
                ),
                b = this._options?.networkConfig;
              (yield (b?.networkOverrideFunc ?? fetch)(b?.sdkExceptionUrl ?? e.EXCEPTION_ENDPOINT, {
                method: `POST`,
                headers: {
                ...
                (n = this._emitter) == null || n.call(this, { name: `error`, error: l, tag: c }));
            })
              .then(() => {})
              .catch(() => {}));
        } catch {}
  ...
  le = t((e) => {
    ...
    (Object.defineProperty(e, `__esModule`, { value: !0 }), (e.StatsigClientBase = void 0), u());
    var n = u(),
      r = H(),
      i = I(),
      a = l(),
    ...
    e.StatsigClientBase = class {
      constructor(e, t, n, o) {
        ...
        ((this.loadingStatus = `Uninitialized`),
          ...
          (this._listeners = {}));
        let u = this.$emt.bind(this);
        (o?.logLevel != null && (a.Log.level = o.logLevel),
          o != null && o.disableStorage && p.Storage._setDisabled(!0),
          o != null &&
            o.initialSessionID &&
            c.StatsigSession.overrideInitialSessionID(o.initialSessionID, e),
          o != null && o.storageProvider && p.Storage._setProvider(o.storageProvider),
          o != null && o.enableCookies && d.StableID._setCookiesEnabled(e, o.enableCookies),
          o != null && o.disableStableID && d.StableID._setDisabled(e, !0),
          (this._sdkKey = e),
          (this._options = o ?? {}),
          (this._memoCache = {}),
          (this.overrideAdapter = o?.overrideAdapter ?? null),
          (this._errorBoundary = new r.ErrorBoundary(e, o, u)),
          (this._logger = new i.EventLogger(e, u, n, o, this._errorBoundary)),
          this._errorBoundary.wrap(this),
          ...
          (this.storageProvider = p.Storage),
          (l = (s = this.overrideAdapter)?.loadFromStorage?.call(s)) == null ||
            l.catch((e) => this._errorBoundary.logError(`OA::loadFromStorage`, e)),
      ...
      updateRuntimeOptions(e) {
        (e.loggingEnabled
          ...
          e.disableStorage != null &&
            ...
            p.Storage._setDisabled(e.disableStorage)),
          ...
          e.logEventCompressionMode
            ...
            : e.disableCompression &&
              this._logger.setLogEventCompressionMode(f.LogEventCompressionMode.Disabled));
      }
      flush() {
        ...
        return (n, r) => {
          ...
          return i
            ? (i in this._memoCache ||
                (Object.keys(this._memoCache).length >= m && (this._memoCache = {}),
  ...
  fe = t((e) => {
    ...
    e._makeLayer = s;
    function c(e, t, n, r) {
      return Object.assign(Object.assign(Object.assign({}, e), t), { get: u(e.name, n, r) });
    }
    e._mergeOverride = c;
    function u(e, r, i) {
      return (a, o) => {
  ...
  G = t((e) => {
    ...
    (Object.defineProperty(e, `Storage`, {
      ...
      n(me(), e),
      n(te(), e),
      Object.assign((0, r._getStatsigGlobal)(), { Log: o.Log, SDK_VERSION: s.SDK_VERSION }));
  }),
  K = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
  ...
  q = t((e) => {
    ...
    e.default = (0, t.createContext)({
      renderVersion: 0,
      client: r.NoopEvaluationsClient,
      isLoading: !0,
    });
  }),
  he = t((e) => {
  ...
  Ce = t((e) => {
    ...
    var t = n(),
      r = G();
    function i(e, n) {
      let i = (0, t.useMemo)(() => (0, r._getInstance)(n.sdkKey) ?? e(n), []),
    ...
    e.useStatsigInternalClientFactoryAsync = i;
  }),
  we = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }), (e.useClientAsyncInit = void 0));
    var t = J(),
      n = Ce();
  ...
  Te = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }), (e.StatsigProvider = void 0));
    var t = r(),
      i = n(),
      a = G(),
      o = q(),
    ...
    function c(e) {
      return `client` in e
        ? ((`sdkKey` in e || `user` in e) &&
          ...
          (0, t.jsx)(u, Object.assign({}, e)))
        : (0, t.jsx)(l, Object.assign({}, e));
    }
    e.StatsigProvider = c;
    function l(e) {
      let [n, r] = (0, i.useState)(0),
        a = (0, s.useClientAsyncInit)(e.sdkKey, e.user, e.options).client,
        [c, l] = (0, i.useState)(!f(a));
      d(a, r, l);
      let u = (0, i.useMemo)(() => ({ renderVersion: n, client: a, isLoading: c }), [n, a, c]);
      return (0, t.jsx)(o.default.Provider, {
        value: u,
        children: e.loadingComponent == null || !u.isLoading ? e.children : e.loadingComponent,
      });
    }
    function u(e) {
      let [n, r] = (0, i.useState)(0),
        a = e.client,
        [s, c] = (0, i.useState)(!f(a));
      d(a, r, c);
      let l = (0, i.useMemo)(() => ({ renderVersion: n, client: a, isLoading: s }), [n, a, s]);
      return (0, t.jsx)(o.default.Provider, {
        value: l,
        children: e.loadingComponent == null || !l.isLoading ? e.children : e.loadingComponent,
      });
    }
    function d(e, t, n) {
      (0, i.useEffect)(() => {
        ...
        return (
          a.SDKType._setBindingType(`react`),
          e.$on(`values_updated`, r),
          () => {
            (e.flush().catch((e) => a.Log.error(`An error occurred during flush`, e)),
              e.off(`values_updated`, r));
          }
        );
      }, [e, t]);
    }
  ...
  Ee = t((e) => {
    ...
    var t = n(),
      r = G();
    function i(e, n) {
      let i = (0, t.useRef)((0, r._getInstance)(n.sdkKey));
      return (0, t.useMemo)(() => {
        ...
        return (
          (i.current = t),
          n.useLegacyFormat
            ? t.dataAdapter.setDataLegacy(n.initialValues, n.initialUser)
            : t.dataAdapter.setData(n.initialValues),
          t.initializeSync(),
          t
        );
      }, []);
    }
    e.useStatsigInternalClientFactoryBootstrap = i;
  }),
  De = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }), (e.useClientBootstrapInit = void 0));
    var t = J(),
      n = Ee();
    function r(e, r, i, a = null, o) {
      return (0, n.useStatsigInternalClientFactoryBootstrap)(
        (e) => new t.StatsigClient(e.sdkKey, e.initialUser, e.statsigOptions),
        { sdkKey: e, initialUser: r, initialValues: i, statsigOptions: a, useLegacyFormat: o },
      );
    }
        ...
        () =>
          (0, i.isNoopClient)(o)
            ? (r.Log.warn(
              ...
              i.NoopEvaluationsClient.getDynamicConfig(e, n))
            : o.getDynamicConfig(e, n),
        ...
        () =>
          (0, i.isNoopClient)(o)
            ? (r.Log.warn(
              ...
              i.NoopEvaluationsClient.getExperiment(e, n))
            : o.getExperiment(e, n),
        [e, o, s, ...(n ? Object.values(n) : [])],
      );
    }
  ...
  Me = t((e) => {
    ...
    function o(e, n) {
      ...
      return (0, t.useMemo)(
        () =>
          (0, i.isNoopClient)(o)
            ? (r.Log.warn(`useLayer hook failed to find a valid Statsig client for layer '${e}'.`),
              i.NoopEvaluationsClient.getLayer(e, n))
            : o.getLayer(e, n),
        [e, o, s, ...(n ? Object.values(n) : [])],
      );
    }
        ...
        () =>
          (0, i.isNoopClient)(o)
            ? (r.Log.warn(
              ...
              i.NoopEvaluationsClient.getParameterStore(e, n))
            : o.getParameterStore(e, n),
        [e, o, s, ...(n ? Object.values(n) : [])],
      );
    }
    e.default = o;
  ...
  Pe = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }), (e.useStatsigClient = void 0));
    var t = n(),
      r = G(),
      i = K(),
      a = q();
    function o() {
      let { client: e, renderVersion: n, isLoading: o } = (0, t.useContext)(a.default),
        s = (0, t.useMemo)(
          () =>
            (0, i.isNoopClient)(e)
              ? (r.Log.warn(`Attempting to retrieve a StatsigClient but none was set.`),
        ...
        h = (0, t.useCallback)(
          (e, t, n) => (typeof e == `string` ? s.logEvent(e, t, n) : s.logEvent(e)),
          c,
        );
      return (0, t.useMemo)(
        () => ({
    ...
    e.useStatsigClient = o;
  }),
  Fe = t((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }), (e.useStatsigUser = void 0));
    var t = n(),
      r = q(),
      i = Pe();
    function a(e) {
    ...
    function o() {
      let { client: e } = (0, i.useStatsigClient)(),
        { renderVersion: n } = (0, t.useContext)(r.default);
      return {
        user: (0, t.useMemo)(() => a(e), [e, n]),
        updateUserSync: (0, t.useCallback)(
          (t) => (typeof t == `function` && (t = t(a(e))), e.updateUserSync(t)),
          [e],
        ),
        updateUserAsync: (0, t.useCallback)(
          (t) => (typeof t == `function` && (t = t(a(e))), e.updateUserAsync(t)),
          [e],
        ),
      };
    }
  ...
  Z = i(s, (e) => !1, {
    onMount: (e, t) => {
      ...
      return (
        ...
        t.set(X, (e) => (e.includes(n) ? e : [...e, n])),
        () => {
          t.set(X, (e) => e.filter((e) => e !== n));
        }
      );
    },
  });
...
function $() {
  return (nt(), (0, ze.useStatsigClient)());
}
function We() {
  return $().client;
}
function Ge(e, t) {
  ...
  return (
    n[0] !== r || n[1] !== e || n[2] !== t
      ? ((i = Ke(r, e, t)), (n[0] = r), (n[1] = e), (n[2] = t), (n[3] = i))
      : (i = n[3]),
    i
  );
}
...
function Ze(e) {
  ...
  return (
    Object.entries(e).forEach(([e, n]) => {
      (typeof n == `number` || typeof n == `string` || typeof n == `boolean`) && (t[e] = String(n));
    }),
    t
  );
}
function Qe(e) {
  ...
  return { origin: `opaline_vscode`, ...(t ? { app_version: t } : {}) };
}
function $e(e, t, { value: n, metadata: r } = {}) {
  let i = Ze({ ...Qe(e), ...r });
  e.logEvent(t, n, i);
}
function et(e, t, n) {
...
function tt() {
  let e = (0, Q.c)(7),
    { client: t } = $(),
    n;
  e[0] === t ? (n = e[1]) : ((n = (e, n) => et(t, e, n)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === t ? (i = e[3]) : ((i = (e, n) => $e(t, e, n)), (e[2] = t), (e[3] = i));
  let a = i,
    o;
  return (
    e[4] !== r || e[5] !== a
...
//# sourceMappingURL=statsig-Cajk3UKk.js.map

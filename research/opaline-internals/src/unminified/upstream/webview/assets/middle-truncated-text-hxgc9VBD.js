...
import { t as r } from "./tooltip-BhXPONlb.js";
import { n as i } from "./use-measured-text-collapse-CmQL8SIA.js";
var a =
...
function ae(e, t, n, r) {
  ...
  for (let u of e) {
    ...
    (a !== null && i.push({ text: I(o), isWordLike: c, kind: a, start: s }),
      (a = e),
      (o = [u]),
      (s = n + l),
      (c = d),
  ...
  return (a !== null && i.push({ text: I(o), isWordLike: c, kind: a, start: s }), i);
}
function L(e) {
...
function se(e, t) {
  ...
  return n.startsWith(`www.`)
    ? !0
    : oe.test(n) && t + 1 < e.len && e.kinds[t + 1] === `text` && e.texts[t + 1] === `//`;
}
function ce(e) {
...
function ue(e) {
  ...
  for (let a = 0; a < e.len; a++) {
    let o = e.texts[a];
    if ((t.push(o), n.push(e.isWordLike[a]), r.push(e.kinds[a]), i.push(e.starts[a]), !ce(o)))
      continue;
    let s = a + 1;
    if (s >= e.len || L(e.kinds[s])) continue;
    let c = [],
      l = e.starts[s],
      u = s;
    for (; u < e.len && !L(e.kinds[u]); ) (c.push(e.texts[u]), u++);
    c.length > 0 && (t.push(I(c)), n.push(!0), r.push(`text`), i.push(l), (a = u - 1));
  }
...
function V(e) {
  if (e.length === 0) return !1;
  for (let t of e) if (!(b.test(t) || de.has(t))) return !1;
  return !0;
}
function fe(e) {
  let t = [],
  ...
  for (let a = 0; a < e.len; a++) {
    ...
    if (s === `text` && V(o) && B(o)) {
      let s = [o],
        c = a + 1;
      for (; c < e.len && e.kinds[c] === `text` && V(e.texts[c]); ) (s.push(e.texts[c]), c++);
      (t.push(I(s)), n.push(!0), r.push(`text`), i.push(e.starts[a]), (a = c - 1));
      continue;
    }
...
function pe(e) {
  ...
  for (let a = 0; a < e.len; a++) {
    let o = e.texts[a],
      s = e.kinds[a],
      c = e.isWordLike[a];
    if (s === `text` && c && R.test(o)) {
      let s = [o],
        c = z.test(o),
        l = a + 1;
      for (; c && l < e.len && e.kinds[l] === `text` && e.isWordLike[l] && R.test(e.texts[l]); ) {
        let t = e.texts[l];
        (s.push(t), (c = z.test(t)), l++);
      }
      (t.push(I(s)), n.push(!0), r.push(`text`), i.push(e.starts[a]), (a = l - 1));
      continue;
    }
  ...
  for (; a < e.len; ) {
    ...
    if (c === `glue`) {
      ...
      if (a < e.len && e.kinds[a] === `text`)
        ((o[0] = f), o.push(e.texts[a]), (s = e.isWordLike[a]), (c = `text`), (l = d), a++);
      else {
    ...
    (t.push(I(o)), n.push(s), r.push(c), i.push(l));
  }
  return { len: t.length, texts: t, isWordLike: n, kinds: r, starts: i };
}
function ge(e) {
  ...
  for (let e = 0; e < t.length - 1; e++) {
    ...
    let n = P(t[e]);
    n !== null &&
      ((t[e] = n.head), (t[e + 1] = n.tail + t[e + 1]), (i[e + 1] = i[e] + n.head.length));
  }
  return { len: t.length, texts: t, isWordLike: n, kinds: r, starts: i };
}
function _e(e, t, n) {
  ...
  for (let l of r.segment(e))
    for (let e of ae(l.segment, l.isWordLike ?? !1, l.index, n)) {
      let n = e.kind === `text`;
      (t.carryCJKAfterClosingQuote &&
        ...
        S(a[i - 1]) &&
        F(a[i - 1])) ||
      (n && i > 0 && s[i - 1] === `text` && j(e.text) && S(a[i - 1])) ||
      (n && i > 0 && s[i - 1] === `text` && ne(a[i - 1]))
        ? ((a[i - 1] += e.text), (o[i - 1] = o[i - 1] || e.isWordLike))
        : n && i > 0 && s[i - 1] === `text` && e.isWordLike && x(e.text) && te(a[i - 1])
          ...
          : (n &&
              ...
              (n &&
                ...
                i > 0 &&
                s[i - 1] === `text` &&
                (A(e.text) || (e.text === `-` && o[i - 1])))
            ? (a[i - 1] += e.text)
            : ((a[i] = e.text), (o[i] = e.isWordLike), (s[i] = e.kind), (c[i] = e.start), i++);
    }
  for (let e = 1; e < i; e++)
    s[e] === `text` &&
      !o[e] &&
  ...
  let u = ge(pe(me(fe(ue(le(he({ len: l, texts: a, isWordLike: o, kinds: s, starts: c })))))));
  for (let e = 0; e < u.len - 1; e++) {
    ...
    t !== null &&
      ((u.kinds[e] !== `space` && u.kinds[e] !== `preserved-space`) ||
        ...
        ((u.texts[e] = t.space),
        (u.isWordLike[e] = !1),
        (u.kinds[e] = u.kinds[e] === `preserved-space` ? `preserved-space` : `space`),
...
function ve(e, t) {
  ...
  if (!t.preserveHardBreaks)
    return [{ startSegmentIndex: 0, endSegmentIndex: e.len, consumedEndSegmentIndex: e.len }];
  let n = [],
    r = 0;
  for (let t = 0; t < e.len; t++)
    e.kinds[t] === `hard-break` &&
      (n.push({ startSegmentIndex: r, endSegmentIndex: t, consumedEndSegmentIndex: t + 1 }),
      (r = t + 1));
  return (
    r < e.len &&
      n.push({ startSegmentIndex: r, endSegmentIndex: e.len, consumedEndSegmentIndex: e.len }),
    n
  );
}
function ye(e, t, n = `normal`) {
  let r = f(n),
    i = r.mode === `pre-wrap` ? m(e) : p(e);
  if (i.length === 0)
    return { normalized: i, chunks: [], len: 0, texts: [], isWordLike: [], kinds: [], starts: [] };
  let a = _e(i, t, r);
  return { normalized: i, chunks: ve(a, r), ...a };
}
var H = null,
  U = new Map(),
  W = null,
  be = /\p{Emoji_Presentation}/u,
  xe = /[\p{Emoji_Presentation}\p{Extended_Pictographic}\p{Regional_Indicator}\uFE0F\u20E3]/u,
  G = null,
  K = new Map();
function q() {
  if (H !== null) return H;
  if (typeof OffscreenCanvas < `u`) return ((H = new OffscreenCanvas(1, 1).getContext(`2d`)), H);
  if (typeof document < `u`) return ((H = document.createElement(`canvas`).getContext(`2d`)), H);
...
function J(e, t) {
  let n = t.get(e);
  return (
    n === void 0 && ((n = { width: q().measureText(e).width, containsCJK: S(e) }), t.set(e, n)),
    n
  );
}
function Y() {
...
function X() {
  return (G === null && (G = new Intl.Segmenter(void 0, { granularity: `grapheme` })), G);
}
function we(e) {
  return be.test(e) || e.includes(`️`);
}
function Te(e) {
  return xe.test(e);
}
...
function De(e) {
  let t = 0,
    n = X();
  for (let r of n.segment(e)) we(r.segment) && t++;
  return t;
}
function Oe(e, t) {
  return (t.emojiCount === void 0 && (t.emojiCount = De(e)), t.emojiCount);
}
function Z(e, t, n) {
  return n === 0 ? t.width : t.width - Oe(e, t) * n;
}
function ke(e, t, n, r) {
...
function je(e, t) {
  ...
  let r = Se(e),
    i = Ce(e);
  return { cache: r, fontSize: i, emojiCorrection: t ? Ee(e, i) : 0 };
}
function Q(e) {
  return (
    e === `space` ||
...
function Ie(e, t) {
  return e.simpleLineWalkFastPath ? Le(e, t) : ze(e, t);
}
function Le(e, t) {
  return Re(e, t);
}
function Re(e, t, n) {
  ...
  function T(e, n) {
    ...
    for (let a = n; a < r.length; a++) {
      let n = Pe(r, i, a, s.preferPrefixWidthsForBreakableRuns);
      if (!d) {
        x(e, a, n);
        continue;
      }
  ...
  let E = 0;
  for (; E < r.length && !(!d && ((E = Me(e, E)), E >= r.length)); ) {
    let e = r[E],
      n = i[E];
    if (!d) {
...
function ze(e, t, n) {
  if (e.simpleLineWalkFastPath) return Re(e, t, n);
  let {
    widths: r,
  ...
  function M(e, n) {
    let r = s[e],
      i = c[e] ?? null;
    for (let a = n; a < r.length; a++) {
      let n = Pe(r, i, a, f.preferPrefixWidthsForBreakableRuns);
      if (!g) {
        O(e, a, n);
        continue;
      }
  ...
  function N(e) {
    ...
    let r = f.preferPrefixWidthsForBreakableRuns ? (c[e] ?? n) : n,
      { fitCount: i, fittedWidth: a } = Fe(r, h, t, p, l, r !== n);
    return i === 0
      ? !1
      : ((h = a),
        (y = e),
        (b = i),
        T(),
        i === n.length ? ((y = e + 1), (b = 0), !0) : (E(e, i, a + l), M(e, i), !0));
  }
  function P(e) {
    (m++,
      n?.({
...
var $ = null;
function Be() {
  return ($ === null && ($ = new Intl.Segmenter(void 0, { granularity: `grapheme` })), $);
}
function Ve(e) {
  return e
    ? {
...
function He(e, t, n) {
  let r = Be(),
    i = Y(),
    { cache: a, emojiCorrection: o } = je(t, Te(e.normalized)),
    s = Z(`-`, J(`-`, a), o),
    c = Z(` `, J(` `, a), o) * 8;
  ...
  for (let t = 0; t < e.len; t++) {
    ...
    if (l === `text` && f.containsCJK) {
      ...
      for (let t of r.segment(n)) {
        ...
        if (w.has(e) || C.has(n) || E.has(n) || (i.carryCJKAfterClosingQuote && S(n) && F(e))) {
          e += n;
          continue;
        }
        let r = J(e, a),
    ...
    let p = Z(n, f, o),
      m = l === `space` || l === `preserved-space` || l === `zero-width-break` ? 0 : p,
    ...
    (c && n.length > 1
      ? x(
          ...
          d,
          ke(n, f, a, o),
          i.preferPrefixWidthsForBreakableRuns ? Ae(n, f, a, o) : null,
        )
      : x(n, p, m, h, l, d, null, null),
      (b[t] = u.length));
  }
  let T = Ue(e.chunks, y, b),
    D = h === null ? null : l(e.normalized, h);
  return v === null
    ? {
        widths: u,
...
function Ue(e, t, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    let a = e[i],
      o = a.startSegmentIndex < t.length ? t[a.startSegmentIndex] : (n[n.length - 1] ?? 0),
      s = a.endSegmentIndex < t.length ? t[a.endSegmentIndex] : (n[n.length - 1] ?? 0),
      c =
        a.consumedEndSegmentIndex < t.length
          ? t[a.consumedEndSegmentIndex]
          : (n[n.length - 1] ?? 0);
    r.push({ startSegmentIndex: o, endSegmentIndex: s, consumedEndSegmentIndex: c });
  }
  return r;
}
function We(e, t, n, r) {
  return He(ye(e, Y(), r?.whiteSpace), t, n);
}
function Ge(e, t, n) {
  return We(e, t, !1, n);
}
...
function Qe(e) {
  let n = (0, Je.c)(15),
    { text: a, className: o } = e,
    s;
  n[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = { fallbackFontSizePx: 12 }), (n[0] = s))
    : (s = n[0]);
  let { setTextMeasurementRef: c, textMeasurement: l } = i(s),
    u;
  bb0: {
    if (l == null) {
      u = a;
    ...
    let e;
    (n[1] !== a || n[2] !== l.font || n[3] !== l.maxWidthPx
      ? ((e = $e(a, l.font, l.maxWidthPx)),
        (n[1] = a),
        (n[2] = l.font),
        (n[3] = l.maxWidthPx),
        (n[4] = e))
  ...
  n[5] === o
    ? (p = n[6])
    : ((p = t(`block min-w-0 overflow-hidden whitespace-nowrap`, o)), (n[5] = o), (n[6] = p));
  let m;
  n[7] !== d || n[8] !== c || n[9] !== p
    ? ((m = (0, Ye.jsx)(`span`, { ref: c, className: p, children: d })),
      (n[7] = d),
      (n[8] = c),
      (n[9] = p),
      (n[10] = m))
  ...
  let h;
  return (
    n[11] !== f || n[12] !== m || n[13] !== a
      ? ((h = (0, Ye.jsx)(r, { tooltipContent: a, disabled: f, children: m })),
        (n[11] = f),
        (n[12] = m),
        (n[13] = a),
        (n[14] = h))
...
function $e(e, t, n) {
  if (e.length === 0 || n <= 0 || et(e, t, n)) return e;
  let r = Array.from(e),
    i = 0,
    a = r.length - 1,
    o = Xe;
  for (; i <= a; ) {
    let e = Math.floor((i + a) / 2),
      s = Math.ceil(e / 2),
      c = Math.floor(e / 2),
      l = `${r.slice(0, s).join(``)}${Xe}${r.slice(r.length - c).join(``)}`;
    et(l, t, n) ? ((o = l), (i = e + 1)) : (a = e - 1);
  }
  return o;
}
function et(e, t, n) {
  return qe(Ge(e, t, { whiteSpace: `pre-wrap` }), n, Ze).lineCount <= 1;
}
export { Qe as t };
//# sourceMappingURL=middle-truncated-text-hxgc9VBD.js.map

...
import { b as t } from "./src-CYrn1fYL.js";
import { n, t as r } from "./jsx-runtime-CiQ1k8xo.js";
import { t as i } from "./clsx-BcPLHiun.js";
import { F as a, H as o, h as s, lt as c, u as l } from "./vscode-api-sUstfl-x.js";
import { n as u } from "./rpc-y95ESgjb.js";
import { a as d, i as f } from "./setting-storage-Cel8Tr7E.js";
import { t as p } from "./use-reduced-motion-BsrTWbI1.js";
var m = [
  {
    assetRef: `opaline`,
    description: `The original Opaline companion.`,
    displayName: `Opaline`,
    id: `opaline`,
  },
  {
...
function y(e) {
  let n = (0, g.c)(9),
    r = a(s),
    i = d(t.selectedAvatarId),
    o;
  n[0] !== e || n[1] !== i ? ((o = v(i, e)), (n[0] = e), (n[1] = i), (n[2] = o)) : (o = n[2]);
  let c;
  n[3] === r
    ? (c = n[4])
    : ((c = (e) => {
        f(r, t.selectedAvatarId, e);
      }),
      (n[3] = r),
      (n[4] = c));
  let l;
  return (
    n[5] !== i || n[6] !== o || n[7] !== c
      ? ((l = { selectedAvatar: o, selectedAvatarId: i, setSelectedAvatarId: c }),
        (n[5] = i),
        (n[6] = o),
        (n[7] = c),
        (n[8] = l))
...
var b = [`custom-avatars`],
  x = o(s, () => ({
    queryKey: b,
    queryFn: () => u.customAvatars.load(),
    enabled: !0,
    refetchOnMount: !1,
    refetchOnWindowFocus: !1,
    staleTime: l.INFINITE,
  })),
  S = `` + new URL(`bsod-spritesheet-v4-BRrRVy1T.webp`, import.meta.url).href,
  C = `` + new URL(`opaline-spritesheet-v4-Bl6P89d_.webp`, import.meta.url).href,
  w = `` + new URL(`dewey-spritesheet-v4-gAYk_M9g.webp`, import.meta.url).href,
  T = `` + new URL(`fireball-spritesheet-v4-BtU8R9Qp.webp`, import.meta.url).href,
  E = `` + new URL(`hoots-spritesheet-v4-BYSNdvho.webp`, import.meta.url).href,
  D = `` + new URL(`null-signal-spritesheet-v4-CCoTR-8t.webp`, import.meta.url).href,
  O = `` + new URL(`rocky-spritesheet-v4-3RlTi26B.webp`, import.meta.url).href,
  k = `` + new URL(`seedy-spritesheet-v4-CdlE_fn9.webp`, import.meta.url).href,
  A = `` + new URL(`stacky-spritesheet-v4-CaUJd4fY.webp`, import.meta.url).href,
  j = e(n(), 1),
  M = 8,
  N = 9,
  P = 6,
...
function R(e) {
  let t = (0, g.c)(6),
    { avatarRef: n, isAnimationEnabled: r, prefersReducedMotion: i, state: a } = e,
    o = r === void 0 ? !0 : r,
    s = a === void 0 ? `idle` : a,
    c,
    l;
          ...
          c = window.setTimeout(() => {
            ...
            if (n >= r.length) {
              if (t.loopStartIndex != null) {
                ((a = t.loopStartIndex), (e.style.backgroundPosition = V(r[a])), l());
                return;
              }
              c = null;
              return;
...
function W(e) {
  ...
  (t[2] !== l || t[3] !== s
    ...
    R(f));
  let m;
  t[5] === r ? (m = t[6]) : ((m = i(`opaline-avatar-root`, r)), (t[5] = r), (t[6] = m));
  let h = `url(${a ?? U[d]})`,
    _;
  t[7] === h ? (_ = t[8]) : ((_ = { backgroundImage: h }), (t[7] = h), (t[8] = _));
  let v;
  return (

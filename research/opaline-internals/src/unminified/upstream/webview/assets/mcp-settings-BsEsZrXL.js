...
import { P as n, bc as r, wn as i } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as a, t as o } from "./jsx-runtime-CiQ1k8xo.js";
import { t as s } from "./clsx-BcPLHiun.js";
import "./marked.esm-BR-H6018.js";
import { A as c, I as l, P as u, f as d, g as f, lt as p, p as m } from "./vscode-api-sUstfl-x.js";
import { c as h, o as g } from "./lib-MoKmYgcO.js";
...
import { S as _, o as v, p as y, x as b, y as x } from "./config-queries-BDIsZFnB.js";
import "./_baseEach-BGrGeeUo.js";
import "./_baseOrderBy-MeGLt7Sq.js";
import { t as S } from "./button-Xd4Hy1MO.js";
import "./setting-storage-Cel8Tr7E.js";
import "./reduced-motion-preference-BEImGcUg.js";
import "./spinner-Dvc_A3Ae.js";
import { t as C } from "./link-external-oqLWmWWX.js";
import "./x-DypUcSQe.js";
import { t as w } from "./settings.cog-CJF3NOGk.js";
import { r as T } from "./settings-sections-BUO2MNq2.js";
import "./_defineProperty-b-BZyUPb.js";
import "./homepage-logo-C4Z1mn1w.js";
import { t as E } from "./loading-page-Cq0CTe5D.js";
import { t as D } from "./arrow-left-2njf4k3d.js";
import { h as O } from "./links-DlYWpuc5.js";
import { t as k } from "./trash-BX2WKfvO.js";
import "./chevron-D6hquBJC.js";
import { t as A } from "./plus-_AqggHDM.js";
import { t as j } from "./sortBy-EVRmvlY9.js";
import "./use-connected-remote-connections-fvh51TCi.js";
import { t as M } from "./toggle-CHrq20xd.js";
import { t as ee } from "./regenerate-Co1G5oL3.js";
import { i as te, r as ne } from "./settings-shared-BibDzP9i.js";
import { t as re } from "./settings-host-context-MFy9perG.js";
import { t as N } from "./settings-content-layout-sdUwAG0A.js";
import { n as ie } from "./settings-row-DOKTjAF6.js";
import { n as P, t as F } from "./settings-group-BO3RZzLk.js";
import { t as I } from "./tabs-ji6s-l3m.js";
import { t as L } from "./control-group-CgFVnD7x.js";
import { n as ae, r as oe } from "./mcp-settings.search-BopWZeCE.js";
var se = e(j(), 1),
  ce = e(i(), 1),
  R = e(a(), 1),
  z = e(t(), 1),
...
function H(e) {
  let t = (0, B.c)(52),
    n = e.inputType === T.String,
    r = e.inputType === T.Array,
    i = e.inputType === T.Record,
    a = h(),
    o;
  t[0] === a
    ? (o = t[1])
  ...
  let f = d,
    p,
    m;
  if (t[6] !== c || t[7] !== e.inputType || t[8] !== e.placeHolderValue || t[9] !== u) {
    if (((p = c), (m = u), e.inputType === T.Record)) {
      let [t] = e.placeHolderValue;
      ((p = t?.key ?? c), (m = t?.value ?? u));
    }
    ((t[6] = c),
      (t[7] = e.inputType),
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, V.jsx)(S, {
                    ...
                    children: (0, V.jsx)(k, { className: `icon-2xs` }),
                  }),
                ],
              },
              `list-${n}`,
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, V.jsx)(S, {
                    ...
                    size: `icon`,
                    disabled:
                      y.length <= 1 && t.key.trim().length === 0 && t.value.trim().length === 0,
                    "aria-label": f,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
  ...
  t[37] === x
    ? (C = t[38])
    : ((C = (0, V.jsx)(`div`, { className: `flex flex-col gap-2`, children: x })),
      (t[37] = x),
      (t[38] = C));
  let w;
...
function U(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, V.jsx)(`input`, { className: i, ...r })), (t[5] = r), (t[6] = i), (t[7] = a))
      : (a = t[7]),
    a
  );
}
...
function le({ config: e, initialKey: t, onSave: n, onCancel: r, onUninstall: i }) {
  let a = (0, R.useMemo)(() => K(e, t), [e, t]),
    [o, s] = (0, R.useState)(a),
    [c, l] = (0, R.useState)(!1),
  ...
  return (0, V.jsx)(N, {
    ...
    children: (0, V.jsxs)(`div`, {
      className: `relative`,
      children: [
        c ? (0, V.jsx)(E, { overlay: !0 }) : null,
        (0, V.jsx)(F, {
          children: (0, V.jsxs)(F.Content, {
            children: [
              y
                ? (0, V.jsx)(`p`, {
...
function K(e, t) {
  ...
  return {
    ...
    stdio: {
      ...
      env: `command` in e && e.env ? J(e.env) : [],
    ...
    http: {
      ...
      httpHeaders: `url` in e && e.http_headers ? J(e.http_headers) : [],
      envHttpHeaders: `url` in e && e.env_http_headers ? J(e.env_http_headers) : [],
    },
  };
}
function q(e) {
  ...
  if (e.transportType === `streamable_http`) {
    let n = Y(e.http.httpHeaders),
      r = Y(e.http.envHttpHeaders);
    return {
      ...t,
      url: e.http.url,
...
var ue = `mcp-settings`,
  de = { command: ``, args: [], env_vars: [], enabled: !0 };
function X() {
  let { selectedHostId: e } = re(),
    { data: t } = x(null, { hostId: e }),
    { data: i, isFetching: a } = u(y, e),
    o = _({ hostId: e }),
    s = b({ hostId: e }),
    p = c(),
    C = h(),
    ...
    G = new Set(Object.entries(z).flatMap(([e, t]) => [e, t.name ?? e])),
    K = D.includes(e),
    q = K ? (k[e] ?? []) : [],
    J = (0, se.default)(
      (t == null ? [] : (i?.data ?? [])).filter((e) => !G.has(e.name) && !q.includes(e.name)),
      (e) => e.name,
    ),
    Y = U.length > 0,
    X = J.length > 0,
  ...
  let Q = () => {
    ...
    _e = async (e, t) => {
      let n = j ?? fe(t, U, null);
      try {
        (await o.mutateAsync({ filePath: he(), key: n, value: e }), Q(), $());
      } catch (e) {
        throw (
          f.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    ve = async (t) => {
      let n = j ?? fe(t, U, null);
      try {
        (await o.mutateAsync({ filePath: he(), key: n, value: null }),
          A((r) => ({ ...r, [e]: (0, ce.default)([...(r[e] ?? []), n, t, z[n]?.name ?? n]) })),
          Q(),
          $());
      } catch (e) {
        throw (
          f.error(`Failed to uninstall MCP server`, {
            safe: { targetKey: n },
            sensitive: { error: e },
          }),
          e
    ...
    ye = async (t) => {
      ...
      let n = T[t];
      if (n) {
        d.dispatchMessage(`open-in-browser`, { url: n });
        return;
      }
      E((e) => ({ ...e, [t]: null }));
      try {
        let { authorizationUrl: n } = await r(`login-mcp-server`, { hostId: e, name: t });
        n && (E((e) => ({ ...e, [t]: n })), d.dispatchMessage(`open-in-browser`, { url: n }));
      } catch (e) {
        (f.error(`Failed to start login for MCP server`, {
          safe: { serverName: t },
          sensitive: { error: e },
        }),
          E((e) => {
    ...
    be = (0, R.useEffectEvent)((e, t) => {
      (E((n) => {
        ...
        t && (Q(), p.invalidateQueries({ queryKey: v })));
    }),
    xe = (0, R.useRef)(!0);
  if (
    ((0, R.useEffect)(() => {
      ...
      w?.hostId === e && be(w.name, w.success);
    }, [w, e]),
    m(
      `opaline-app-server-initialized`,
      (e) => {
        (O((t) => t.filter((t) => t !== e.hostId)),
          ...
          p.invalidateQueries({ queryKey: [...v, e.hostId] }));
      },
      [p],
    ),
    I)
    ...
    return (0, V.jsx)(le, {
      ...
      onCancel: $,
      onSave: _e,
      onUninstall: j ? ve : void 0,
    });
  let Se = (0, V.jsx)(te, { slug: ue }),
    Ce = (0, V.jsx)(ne, { slug: ue }),
    we = K
      ? (0, V.jsxs)(S, {
          color: `ghost`,
          size: `toolbar`,
          onClick: () => {
            d.dispatchMessage(`opaline-app-server-restart`, { hostId: e });
          },
          children: [
            ...
            (0, V.jsx)(g, {
              ...
              description: `Button label to restart the opaline electron app after MCP settings change`,
            }),
          ],
        })
      : null,
    Te = () => {
      (M(null), L({ ...de, name: void 0 }));
    };
  return (0, V.jsxs)(N, {
    title: Se,
    subtitle: Ce,
    ...
    children: [
      (0, V.jsxs)(F, {
        ...
        children: [
          (0, V.jsx)(F.Header, {
            title: (0, V.jsx)(g, { ...oe.servers }),
            actions: (Y || X) && (0, V.jsx)(me, { onClick: Te }),
          }),
          Y || !X
            ? (0, V.jsx)(F.Content, {
                children: (0, V.jsx)(P, {
                    ...
                    ? W.map((e) =>
                        (0, V.jsx)(
                          pe,
                          {
                            ...
                            authStatus: Z[e],
                            onAuthenticateClicked: () => ye(e),
                            onEnableClicked: z[e] ? (t) => ge(e, t) : void 0,
                  ...
                  children: J.map((e) =>
                    (0, V.jsx)(
                      pe,
                      {
                        ...
                        onAuthenticateClicked: () => ye(e.name),
                      },
                      `status-${e.name}`,
                    ),
                  ),
...
function pe(e) {
            ...
            children: [
              ...
              c
                ? (0, V.jsx)(S, {
                    ...
                    children: (0, V.jsx)(w, { className: `icon-xs` }),
                  })
                : null,
              o
                ? (0, V.jsx)(M, {
  ...
  return (
    t[12] !== p || t[13] !== m
      ? ((_ = (0, V.jsx)(ie, { label: p, description: null, control: m })),
        (t[12] = p),
        (t[13] = m),
        (t[14] = _))
      : (_ = t[14]),
...
export { X as McpSettings };
//# sourceMappingURL=mcp-settings-BsEsZrXL.js.map

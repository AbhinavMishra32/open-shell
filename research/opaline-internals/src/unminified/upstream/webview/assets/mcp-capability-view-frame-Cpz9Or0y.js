...
import { bc as C, vc as w } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { c as ne, o as R, r as z } from "./lib-MoKmYgcO.js";
import { m as B } from "./chunk-LFPYN7LY-DwFbyqR1.js";
import { l as V } from "./persisted-signal-Cx1QgqJn.js";
import { o as H } from "./statsig-Cajk3UKk.js";
import "./config-queries-BDIsZFnB.js";
import { t as re } from "./connector-logo-uEk_Q1Qc.js";
import { t as ie } from "./tooltip-BhXPONlb.js";
import { t as U } from "./route-scope-BCJTBhwV.js";
import { O as ae } from "./composer-view-state-MMPs5p5E.js";
import { t as oe } from "./button-Xd4Hy1MO.js";
import {
  c as se,
  d as ce,
  f as le,
  ...
  m as de,
  u as fe,
} from "./mcp-capability-signals-3iWufNgx.js";
import "./permissions-mode-defaults-8II8GGSz.js";
import { st as pe } from "./app-shell-state-B5MFb4Nm.js";
import { t as me } from "./app-shell-D7yvB1FT.js";
import { t as W } from "./apps-DBd5dYzG.js";
import { n as he } from "./projectless-thread-SfYhUYuZ.js";
import { l as G, n as ge } from "./app-shell-tab-controller-B0DXekEJ.js";
import { i as _e, n as ve } from "./thread-panel-state-CYOPuORF.js";
import { d as ye, i as be, l as xe, n as Se, r as Ce, u as we } from "./dialog-layout-CCvvb1Vc.js";
import { t as Te } from "./check-md-CZTnvSiA.js";
import { t as Ee } from "./use-stable-callback-B56R_Ee2.js";
import { t as De } from "./build-worktree-label-from-input-CQX6umYy.js";
import { t as Oe } from "./read-service-tier-for-request-BJ8QN0Q7.js";
import { r as ke } from "./pending-worktree-store-CGUvLIzH.js";
import { u as Ae } from "./sidebar-project-group-signals-h0Ffvrar.js";
import { t as je } from "./arrow-left-2njf4k3d.js";
import { t as Me } from "./checkbox-Bz6PC7ig.js";
import { r as Ne, t as Pe } from "./dropdown-CHaZfyxI.js";
import { t as Fe } from "./chevron-D6hquBJC.js";
import { t as Ie } from "./macbook-CQYmUEtL.js";
import { t as Le } from "./worktree-BtgJtB2d.js";
import { n as Re, t as ze } from "./mcp-capability-client-C9eWeicf.js";
import { n as Be, t as Ve } from "./project-dropdown-options-D9XLN3KO.js";
import { t as He } from "./alert-DJ0qvvZN.js";
import {
  a as Ue,
  c as We,
  i as Ge,
  ...
  r as qe,
  s as Je,
} from "./mcp-tool-item-content-utils-DTAnyTVK.js";
function Ye(e, t) {
  return _e(e, `right`, t);
}
function Xe(e) {
...
function et(e, t) {
  ...
  e.get(ge.tabs$).some((e) => e.tabId === n) &&
    (ge.closeTab(e, n), e.get(ge.tabs$).length === 0 && Xe(e));
}
function tt(e) {
  return `${G.MCP_APP}:${e}`;
}
var nt = e(y(), 1),
  rt = { intrinsicHeight: null, isFullScreen: !1, isInlineExpanded: !1, sandboxError: null },
  Y = N(U, () => new Map()),
  it = N(U, () => new Map()),
  at = N(U, () => new Set()),
  ot = k(U, ({ get: e }) => {
  ...
  st = j(U, (e, { get: t }) => t(Y).get(e) ?? null),
  ct = j(U, (e, { get: t }) => t(it).get(e) ?? rt),
  lt = j(U, (e, { get: t }) => t(at).has(e));
function ut(e) {
  return e;
}
function dt(e, t, n) {
...
function mt(e, t) {
  ...
  (e.set(Y, (r) => {
    let i = e.get(it),
      ...
      c = r;
    (a == null || !(0, nt.default)(a, s)) && ((c = new Map(r)), c.set(t.mcpAppId, s));
    let l = yt({
...
function ht(e, t, n) {
  ...
  for (let r of n.values())
    if (
      ...
      xt(r.sidePanelFrameContent ?? r.inlineFrameContent, t)
    )
      return r.mcpAppId;
  return t.mcpAppId;
}
function gt(e, t, n) {
  (n.isFullScreen === !0 && vt(e, t),
    e.set(it, (e) => {
      let r = e.get(t) ?? rt,
        i = { ...r, ...n };
      if (
...
function yt({ activeSidePanelTabId: e, frameStates: t, registration: n, registrations: r }) {
  for (let i of r.values())
    if (
      e === tt(i.mcpAppId) &&
      t.get(i.mcpAppId)?.isFullScreen === !0 &&
      xt(i.sidePanelFrameContent ?? i.inlineFrameContent, n)
    )
      return i;
  return null;
}
function bt({ hostedInThreadScrollLayout: e, inlineFrameContainer: t, mcpAppId: n, ...r }) {
  return r;
}
function xt(e, t) {
  return (
    ...
    e.server === t.server &&
    (0, nt.default)(e.mcpAppScope, t.mcpAppScope) &&
    St(e.sandboxOriginScope, t.sandboxOriginScope)
  );
}
function St(e, t) {
...
async function Ft({
  ...
  let o = crypto.randomUUID(),
    { ports: s, replyPort: c } = await new Promise((e, s) => {
      ...
      let f = h({ initId: o, sourceUrl: i });
      a.getAttribute(`src`) !== f && a.setAttribute(`src`, f);
    }),
    l = Bt(e);
  return (c.postMessage(l, Object.values(l)), c.start(), zt(s, r));
}
function It(e, t) {
  let n = {};
  for (let r of Pt) {
...
function Rt(e) {
  return Lt(e) ? typeof e.postMessage == `function` && typeof e.start == `function` : !1;
}
function zt(e, t) {
  return {
    ...
    runWidgetCode: Gt(e.runWidgetCode, t),
...
function X(e) {
  ...
  return (
    (t.onmessage = async (t) => {
      ...
      if (!(n !== Ot || i == null))
        try {
          i.postMessage([jt, await e(...r)]);
        } catch (e) {
          i.postMessage([At, Vt(e)]);
        } finally {
          i.close();
        }
    }),
...
function Vt(e) {
  return e instanceof Error
    ? { ...Ht(e), message: e.message || `MCP sandbox host call failed.`, name: e.name }
    : typeof e == `object` &&
        e &&
        `message` in e &&
        typeof e.message == `string` &&
        e.message.length > 0
      ? { ...Ht(e), message: e.message }
...
function Z(e, t = {}) {
  return (
    ...
    (n) =>
      new Promise((r, i) => {
        let a = t.signal,
          o = t.timeoutMs === void 0 ? Nt : t.timeoutMs;
        if (a?.aborted) {
          i(Ut());
          return;
        }
  ...
  return (
    ...
    async function* (n) {
      let { port1: r, port2: i } = new MessageChannel(),
        ...
        p = Z(s),
        m = Z(l);
      e.postMessage([kt, { asyncDispose: i, next: o, return: c, throw: u }, n], [i, o, c, u]);
      try {
...
var Kt = e(O(), 1),
  ...
  Jt = i(),
  Yt = _(g(), v()),
  Xt = t({ text: g(), type: p(`text`) }).strip(),
  Zt = t({ data: g(), mimeType: g(), type: p(`image`) }).strip(),
  Qt = t({ type: a([`audio`, `image`, `resource`, `resource_link`, `text`]) }).passthrough(),
  $t = t({ status: p(2), type: p(`environment_status`) }).passthrough(),
  en = g(),
  tn = t({ mode: a([`inline`, `fullscreen`]) }),
  nn = t({ canGoBack: u(), canGoForward: u() }).passthrough(),
  rn = t({ prompt: g().trim().min(1) }).strip(),
  an = t({ method: g(), params: _(g(), v()).optional() }).strip(),
  on = t({ blob: c(Blob), name: g().trim().min(1) }).strip(),
  sn = f({ [ce]: de.optional(), progressToken: fe.optional() }),
  cn = t({
    name: g().min(1),
    arguments: _(g(), Jt).optional(),
    _meta: sn.optional(),
  }).passthrough(),
  ln = t({ "openai/fileParams": v().optional() }).passthrough(),
  un = t({ uri: g().min(1) }).passthrough(),
  dn = t({ code: s().optional(), message: g().min(1) }).passthrough(),
  fn = s().finite().positive(),
  pn = t({ href: g().refine(mr) }),
  mn = _(g(), Jt),
  hn = t({ content: d(v()).optional() }).passthrough(),
  gn = t({ content: d(Qt), structuredContent: Yt.optional() }).strict(),
  _n = { insets: { bottom: 0, left: 0, right: 0, top: 0 } },
  vn = { insets: { ..._n.insets, top: 48 } },
  yn = 240,
  bn = 200,
  xn = 720,
  Sn = { canGoBack: !1, canGoForward: !1 },
  Cn = [],
  wn = [],
  Tn = z({
    workLocally: {
      id: `opaline.mcpTool.confirmFollowUp.workLocally`,
    ...
    newWorktree: {
      id: `opaline.mcpTool.confirmFollowUp.newWorktree`,
    ...
    newWorktreeRequiresGitProject: {
      id: `opaline.mcpTool.confirmFollowUp.newWorktreeRequiresGitProject`,
    ...
    newWorktreeDesktopOnly: {
      id: `opaline.mcpTool.confirmFollowUp.newWorktreeDesktopOnly`,
      defaultMessage: `New worktree is only available in the Opaline desktop app`,
      description: `Tooltip for a disabled MCP app follow-up worktree option outside the Opaline desktop app`,
    },
  });
function En(e) {
  let t = (0, K.c)(5),
...
function On(e) {
  ...
  t[0] !== f.intrinsicHeight || t[1] !== i
    ? ((_ = pr(f.intrinsicHeight, i)), (t[0] = f.intrinsicHeight), (t[1] = i), (t[2] = _))
    : (_ = t[2]);
  let v = _,
    y = n ?? f.sandboxError,
    b,
      ...
      t[9] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, q.jsx)(He, {
            ...
            children: (0, q.jsx)(`div`, {
              ...
              children: (0, q.jsx)(R, {
                id: `opaline.mcpTool.mcpAppTooLarge`,
  ...
  if (o) {
    ...
    t[10] === u
      ? (e = t[11])
      : ((e = u.formatMessage({
          id: `opaline.mcpTool.mcpAppLoading`,
      ...
      t[20] === y.message
        ...
        : ((e = (0, q.jsx)(He, {
            ...
            children: (0, q.jsx)(`div`, {
              className: `text-size-chat max-h-48 overflow-auto whitespace-pre-wrap`,
              children: (0, q.jsx)(R, {
                id: `opaline.mcpTool.mcpAppLoadFailed`,
    ...
    return (
      t[22] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, q.jsx)(`p`, {
            ...
            children: (0, q.jsx)(R, {
              id: `opaline.mcpTool.mcpAppNoContent`,
...
function kn(e) {
  ...
  return (
    t[7] === o
      ? (s = t[8])
      : ((s = (0, q.jsx)(q.Fragment, { children: o.map(An) })), (t[7] = o), (t[8] = s)),
    s
  );
}
function An(e) {
  return (0, q.jsx)(jn, { mcpAppId: e }, e);
}
function jn(e) {
  let t = (0, K.c)(5),
    { mcpAppId: n } = e,
...
function Mn({
  ...
  let w = ee(U),
    ...
    ze = (0, J.useEffectEvent)((e) => {
      let t = en.safeParse(e);
      t.success && fe(t.data);
    }),
    Be = (0, J.useEffectEvent)(() => {
      gt(w, s, { sandboxError: Error(`The MCP app sandbox failed to load.`) });
    }),
    Ve = (0, J.useEffectEvent)((e) => {
      let t = fn.safeParse(e);
      t.success && gt(w, s, { intrinsicHeight: t.data });
    }),
    ...
    K = (e) => {
      let t = Gn(e.content);
      O({ id: s, imageAttachments: Kn(e.content), text: t, title: _ });
    },
    Ze = (0, J.useEffectEvent)((e, t) => {
      let n = mn.safeParse(t);
    ...
    rt = (0, J.useEffectEvent)(async (t) => {
      let n = rn.safeParse(t);
      if (!n.success) throw $(`Invalid follow-up message`, -32602);
      if (we != null) throw $(`A follow-up message is already awaiting confirmation`, qt);
      let { prompt: r } = n.data,
      ...
      switch (a.type) {
        ...
        case `new-thread`:
          if (a.executionMode === `worktree`) {
            await E(
              `/worktree-init-v2/${await Hn({ createPendingWorktree: k, hostId: i, prompt: a.prompt, projectRoot: a.projectRoot, scope: w })}`,
            );
            return;
          }
          await E(
            b(await Vn({ hostId: i, prompt: a.prompt, projectRoot: a.projectRoot, scope: w })),
          );
          return;
      }
    }),
    Y = async (e, t) => (f == null ? t() : f(e)),
    it = (t) =>
      Y({ method: `tools/call`, params: t }, () =>
        Xn({
          conversationId: e,
          hostId: i,
          mcpAppScope: c,
    ...
    at = (0, J.useEffectEvent)(async (e, t) => {
      let n = cn.safeParse({ arguments: t, name: e });
      if (!n.success) throw $(`Invalid MCP tool call params`, -32602);
      return it(n.data);
    }),
    ot = (0, J.useEffectEvent)(async (t) => {
      ...
      switch (r) {
        ...
        case `resources/read`: {
          ...
          return Y({ method: r, params: t.data }, async () => {
            ...
            try {
              ...
              throw or(e, `MCP resource read failed`);
            }
          });
        }
        case `tools/list`:
          return Y(n.data, async () => {
            let e = await Yn({
              hostId: i,
              mcpServerStatuses: m === `opaline_apps` ? u : void 0,
              server: m,
            });
            return {
              tools: er({
                connectorId: Qn({ mcpAppScope: c, server: m, serverStatus: e }),
                server: m,
        ...
        case `resources/list`:
          return Y(n.data, async () =>
            m === `opaline_apps`
              ? { resources: [] }
              : { resources: (await Yn({ hostId: i, server: m })).resources },
          );
        case `resources/templates/list`:
          return Y(n.data, async () =>
            m === `opaline_apps`
              ? { resourceTemplates: [] }
              : { resourceTemplates: (await Yn({ hostId: i, server: m })).resourceTemplates },
          );
        case `prompts/list`:
          return Y(n.data, async () => ({ prompts: [] }));
        default:
          return Y(n.data, async () => {
  ...
  ((0, J.useLayoutEffect)(() => {
    ...
    return (
      ...
      re(t),
      () => {
        (e.remove(), V((t) => (t === e ? null : t)), re((e) => (e === t ? null : e)), ce(!1));
      }
    );
  }, [s, Me, Ne]),
    (0, J.useLayoutEffect)(() => {
      z == null ||
        ...
        ((z.className = D(
          ...
          !N && (r ? `border-t border-token-border-light` : `rounded-lg border shadow-sm`),
          !N && !r && (d ? `border-token-border` : `border-token-border-light`),
        )),
        (H.className = D(
        ...
        (H.style.backgroundColor = de ?? ``),
        (H.title = _));
    }, [de, r, z, N, d, H, _]),
    (0, J.useLayoutEffect)(() => {
      if (z == null || H == null) return;
      let e = N ? Fe : Ie;
      if (e == null || Re == null) {
        z.style.display = `none`;
        return;
      }
      (H.parentElement !== z && z.appendChild(H),
        z.parentElement !== Re && Re.appendChild(z),
        (z.style.display = ``),
        se || ce(!0));
      let t = () => {
        Un({ frameElement: z, isFullScreen: N, targetFrameContainer: e, threadFrameContainer: Re });
      };
  ...
  let st = (0, J.useEffectEvent)((e) => {
      $e(w, {
        activate: !w.get(ge.tabs$).some((e) => e.tabId === tt(s)),
        connectorIcon: h,
        mcpAppId: s,
        onExitFullScreen: e,
    ...
    ct = (0, J.useEffectEvent)(() => {
      I.current || (pt(w, s), gt(w, s, { isFullScreen: !1 }));
    });
  ((0, J.useLayoutEffect)(() => {
    if (N) {
      st(ct);
    ...
    (0, J.useLayoutEffect)(() => {
      if (H == null || z == null || !se) return;
      (gt(w, s, { sandboxError: null }), xe(!1), _e(Sn), (L.current = null));
      let e = Pe();
      if (e == null) {
      ...
      return (
        Ft({
          hostApiHandlers: {
            ...
            sendFollowUpMessage: rt,
            sendInstrument: () => {},
            updateWidgetState: Ze,
          },
          ...
          .then(async (s) => {
            ...
            let l = Ye(),
              ...
              p = sr({
                ...
                displayMode: l,
                locale: e.locale,
                safeAreaInsets: _n.insets,
                styleVariables: w.get(Tt),
                theme: u,
                userAgent: f,
              }),
              m = s.runWidgetCode({
    ...
    (0, J.useEffect)(() => {
      ...
      let e = {
        ...
        toolOutput: De,
        toolResponseMetadata: Ae,
        toolResult: { content: y.content, structuredContent: y.structuredContent ?? void 0 },
      };
      if ((0, nt.default)(L.current, e)) return;
      L.current = e;
      let t = Xe();
      (Q(
        W.setWidgetData({
        ...
        Q(
          W.notifyMcpAppsToolResult({
            content: y.content,
            ...(y.structuredContent == null ? {} : { structuredContent: y.structuredContent }),
            ...(Ae == null ? {} : { _meta: Ae }),
          }),
        ));
    }, [be, W, Ee, De, Ae, y, ve]),
    (0, J.useEffect)(() => {
      ...
      let e = null,
        ...
        n = () => {
          let e = lr(z),
            n = cr({ displayMode: t, hasNavigationHistory: G.canGoBack || G.canGoForward });
          (Q(
  ...
  let lt = (e) => {
    ...
    ut = () => {
      let e = we;
      e != null && (Te(null), e.reject($(`Follow-up message was not confirmed`, qt)));
    },
    dt = H?.tagName === `WEBVIEW`,
    ft = z != null && W != null && dt && hr(),
    mt = G.canGoBack || G.canGoForward,
    ht = W != null && mt,
    _t = ht && !N,
    vt = ht && N && A?.tabId === tt(s);
  return (0, q.jsxs)(q.Fragment, {
    children: [
      (0, q.jsx)(Fn, { confirmation: we, onCancel: ut, onConfirm: lt }),
      vt
        ...
        ? (0, Kt.createPortal)(
            (0, q.jsx)(ie, {
              ...
              tooltipContent: (0, q.jsx)(R, {
                id: `opaline.mcpTool.mcpAppSandboxDevtoolsTooltip`,
              ...
              children: (0, q.jsx)(`div`, {
                ...
                children: (0, q.jsx)(oe, {
                  ...
                  "aria-label": T.formatMessage({
                    id: `opaline.mcpTool.mcpAppSandboxDevtoolsAriaLabel`,
                    defaultMessage: `Open app DevTools`,
                  ...
                  children: (0, q.jsx)(R, {
                    id: `opaline.mcpTool.mcpAppSandboxDevtoolsButton`,
...
function Nn(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = s.formatMessage({
        id: `opaline.mcpTool.mcpAppNavigationBack`,
        defaultMessage: `Back`,
  ...
  t[2] === s
    ? (u = t[3])
    : ((u = s.formatMessage({
        id: `opaline.mcpTool.mcpAppNavigationForward`,
        defaultMessage: `Next`,
...
function Fn(e) {
  ...
  let s;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((s = n == null ? null : (0, q.jsx)(In, { confirmation: n, onCancel: r, onConfirm: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = s))
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, q.jsx)(xe, { open: a, onOpenChange: o, size: `wide`, children: s })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
...
function In(e) {
  let t = (0, K.c)(57),
    { confirmation: n, onCancel: i, onConfirm: a } = e,
    o = ne(),
    s = (0, J.useId)(),
    c = te(Ae),
  ...
  if (t[2] !== p || t[3] !== h || t[4] !== c) {
    let e = r(`~`);
    ((b = Ve({ workspaceGroups: c, roots: [], formatRootLabel: zn })),
      (x = Ve({ workspaceGroups: c?.filter(Rn), roots: [], formatRootLabel: Ln })));
    let n = h === e ? e : (b.find((e) => e.value === h)?.value ?? e),
      i = x.find((e) => e.value === h)?.value ?? x[0]?.value ?? null;
    ((y = p === `local` ? r(n) : i == null ? null : r(i)),
      (t[2] = p),
      (t[3] = h),
      (t[4] = c),
      (t[5] = y),
  ...
  let S = y,
    ...
    T;
  t[8] !== C || t[9] !== d || t[10] !== p || t[11] !== a || t[12] !== S || t[13] !== v
    ? ((T = (e) => {
        if ((e.preventDefault(), v.length !== 0)) {
          if (d) {
            if (S == null || (p === `worktree` && !C)) return;
            a({ executionMode: p, prompt: v, type: `new-thread`, projectRoot: S });
            return;
          }
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, q.jsx)(ye, {
        children: (0, q.jsx)(R, {
          id: `opaline.mcpTool.confirmFollowUp.title`,
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, q.jsx)(be, {
        ...
        subtitle: (0, q.jsx)(we, {
          children: (0, q.jsx)(R, {
            id: `opaline.mcpTool.confirmFollowUp.description`,
  ...
  t[17] === o
    ? (O = t[18])
    : ((O = o.formatMessage({
        id: `opaline.mcpTool.confirmFollowUp.promptAriaLabel`,
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, q.jsx)(R, {
        id: `opaline.mcpTool.confirmFollowUp.createNewThread`,
  ...
  t[38] !== x
    ? ((P = d
        ? (0, q.jsxs)(`div`, {
            ...
            children: [
              (0, q.jsx)(Bn, { mode: p, canCreateWorktree: C, onChange: m }),
              (0, q.jsx)(`span`, {
                className: `text-sm text-token-description-foreground`,
                children: (0, q.jsx)(R, {
                  id: `opaline.mcpTool.confirmFollowUp.runsIn`,
                  defaultMessage: `in`,
              ...
              (0, q.jsx)(Be, {
                selectedRoots: S == null ? Cn : [S],
                options: p === `worktree` ? x : b,
                placeholder: o.formatMessage({
                  id: `opaline.mcpTool.confirmFollowUp.projectPlaceholder`,
                ...
                localOnlyTooltip: o.formatMessage({
                  id: `opaline.mcpTool.confirmFollowUp.localProjectsOnlyTooltip`,
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, q.jsx)(R, {
        id: `opaline.mcpTool.confirmFollowUp.cancel`,
  ...
  t[44] === i
    ? (L = t[45])
    : ((L = (0, q.jsx)(oe, { color: `secondary`, className: `ml-auto`, onClick: i, children: I })),
      (t[44] = i),
      (t[45] = L));
  let z = !w,
    B;
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, q.jsx)(R, {
        id: `opaline.mcpTool.confirmFollowUp.confirm`,
        defaultMessage: `Send`,
  ...
  t[47] === z
    ? (V = t[48])
    : ((V = (0, q.jsx)(oe, { type: `submit`, disabled: z, children: B })),
      (t[47] = z),
      (t[48] = V));
  let H;
  t[49] !== F || t[50] !== L || t[51] !== V
    ? ((H = (0, q.jsxs)(Ce, { className: `justify-start gap-2`, children: [F, L, V] })),
      (t[49] = F),
      (t[50] = L),
      (t[51] = V),
      (t[52] = H))
...
function Bn(e) {
  ...
  t[0] === a
    ? (s = t[1])
    : ((s = a.formatMessage(Tn.newWorktreeRequiresGitProject)), (t[0] = a), (t[1] = s));
  let c = s,
    l;
  t[2] === o
    ? (l = t[3])
    : ((l = (0, q.jsx)(o, { className: `icon-2xs shrink-0` })), (t[2] = o), (t[3] = l));
  let u = n === `worktree` ? Tn.newWorktree : Tn.workLocally,
    d;
  t[4] === u
    ? (d = t[5])
    : ((d = (0, q.jsx)(`span`, {
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(R, { ...Tn.workLocally })), (t[12] = g))
    : (g = t[12]);
  let _;
  t[13] !== m || t[14] !== h
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, q.jsx)(R, { ...Tn.newWorktree })), (t[18] = S))
    : (S = t[18]);
  let C;
...
async function Vn({ hostId: e, prompt: t, projectRoot: n, scope: r }) {
  let i = n === `~`,
    a = i
      ? await he([`~`], { prompt: t })
      : { cwd: n, projectlessOutputDirectory: null, workspaceRoots: [n] };
  if (a.cwd == null) throw $(`Missing project root`, qt);
  if (i && a.projectlessOutputDirectory == null)
    throw $(`Missing projectless thread output directory`, qt);
  let { config: s } = await C(`read-config-for-host`, { hostId: e, includeLayers: !1, cwd: a.cwd }),
    c = o(V(`agent-mode-by-host-id`, {})[e] ?? `auto`, a.workspaceRoots, s);
...
async function Hn({ createPendingWorktree: e, hostId: t, prompt: n, projectRoot: r, scope: i }) {
  if (r === `~`) throw $(`Missing project root`, qt);
  let { config: a } = await C(`read-config-for-host`, { hostId: t, includeLayers: !1, cwd: r }),
    ...
    s = {
      ...
      fileAttachments: wn,
      addedFiles: wn,
      agentMode: V(`agent-mode-by-host-id`, {})[t] ?? `auto`,
      model: null,
...
function Jn(e) {
  let t = Yt.safeParse(e.structuredContent);
...
async function Yn({ hostId: e, mcpServerStatuses: t, server: n }) {
  ...
  if (i == null) throw $(`MCP server not found: ${n}`, qt);
  return i;
}
async function Xn({
  conversationId: e,
  ...
  let o = await Zn({ hostId: t, mcpServerStatuses: r, server: i, toolName: a.name });
  if (
    ($n({
      connectorId: Qn({ mcpAppScope: n, server: i, serverStatus: o.serverStatus }),
      server: i,
      tool: o.tool,
      toolName: o.name,
    }),
    ...
    throw $(`MCP app widgets cannot call tools that accept file parameters: ${o.name}`, -32603);
  let s = ir(i, a._meta),
    c = {
      hostId: t,
      threadId: e,
  ...
  try {
    ...
    throw or(e, `MCP tool call failed`);
  }
}
async function Zn({ hostId: e, mcpServerStatuses: t, server: n, toolName: r }) {
  let i = t?.data.find(({ name: e }) => e === n) ?? (await Yn({ hostId: e, server: n }));
  if (n !== `opaline_apps`) {
    let e = i.tools[r] ?? Object.values(i.tools).find((e) => e?.name === r) ?? null;
...
function Qn({ mcpAppScope: e, server: t, serverStatus: n }) {
  if (t !== `opaline_apps`) return null;
  let r = Je(
    n?.tools[e.originTool] ??
      Object.values(n?.tools ?? {}).find((t) => t?.name === e.originTool) ??
      null,
  );
  if (r == null) throw $(`MCP app requests require a trusted connector scope`, -32603);
  return r;
}
function $n({ connectorId: e, server: t, tool: n, toolName: r }) {
  if (t !== `opaline_apps`) return;
  let i = Je(n);
  if (i == null || i !== e)
    throw $(`MCP app cannot call tool outside its connector scope: ${r}`, -32603);
}
function er({ connectorId: e, server: t, tools: n }) {
  if (t !== `opaline_apps`) return tr(n);
  if (e == null) throw $(`MCP app tool listing requires a trusted connector scope`, -32603);
  return tr(n.filter((t) => Je(t) === e));
}
function tr(e) {
  return e.filter((e) => !nr(e));
}
function nr(e) {
  let t = ln.safeParse(e?._meta);
  return t.success && Object.hasOwn(t.data, `openai/fileParams`);
}
function rr({ mcpAppScope: e, server: t, uri: n }) {
  if (t === `opaline_apps` && (e.originResourceUri == null || n !== e.originResourceUri))
    throw $(`MCP app cannot read resource outside its widget scope: ${n}`, -32603);
}
function ir(e, t) {
  if (e !== `opaline_apps` || !ar(t)) return t;
  let n = { ...t };
  return (
...
function or(e, t) {
  let n = dn.safeParse(e);
  return n.success
    ? $(n.data.message, n.data.code ?? qt, e)
...
function cr({ displayMode: e, hasNavigationHistory: t }) {
  return e === `inline` && t ? vn : _n;
}
function lr(e) {
...
function dr() {
  return {
    ...
    device: { os: fr(), platform: `native`, type: `desktop` },
  };
}
function fr() {
...
function pr(e, t) {
  let n = e == null ? (t ?? yn) : Math.max(e, t ?? 0);
  return Math.min(Math.max(n, bn), xn);
}
function mr(e) {
  try {
...
var gr = i(),
  ...
  br = M(
    ...
    (e, { scope: t }) => ({
      ...
      queryFn: () => Re(t, e.hostId, e.server, e.resourceUri),
      staleTime: 0,
    }),
    { key: Sr },
  ),
  xr = M(
    ...
    ({ toolArguments: e, view: t }, { scope: n }) => ({
      ...
      queryFn: async () => ze(n, t.hostId, t.server, t.tool.name, e),
      staleTime: 0,
    }),
    { key: Cr },
  );
...
function Cr({ toolArguments: e, view: t }) {
...
function Tr(e) {
  let t = (0, K.c)(68),
    ...
    c = ee(I),
    l = ee(U),
    { data: u, error: d, isLoading: f } = A(br, o),
    p;
  t[0] !== s || t[1] !== o
    ? ((p = { toolArguments: s, view: o }), (t[0] = s), (t[1] = o), (t[2] = p))
    : (p = t[2]);
  let { data: h, error: g, isLoading: _ } = A(xr, p),
    v = qe(u);
  H(`2957382457`);
  let y = Ke({
      isDilEnabled: !1,
    ...
    x;
  t[3] !== i || t[4] !== c || t[5] !== o.hostId || t[6] !== o.server || t[7] !== o.serverTools
    ? ((x = async (e) => {
        let t = ue.parse(e);
        switch (t.method) {
          case `tools/call`: {
            let e = vr.parse(t.params);
            return ze(c, o.hostId, o.server, e.name, _r.parse(e.arguments ?? {}));
          }
          case `resources/read`: {
            let e = yr.parse(t.params),
              n = await i?.(e);
            return n == null
              ? Re(c, o.hostId, o.server, e.uri)
  ...
  if (
    t[9] !== r ||
    t[10] !== l.value.conversationId ||
    t[11] !== l.value.routeKind ||
    t[12] !== o.hostId ||
    t[13] !== o.server ||
    t[14] !== o.tool.name
  ) {
    let e;
    t[17] === r ? (e = t[18]) : ((e = r == null ? [] : [r]), (t[17] = r), (t[18] = e));
    let n;
    (t[19] !== e || t[20] !== o.hostId || t[21] !== o.server || t[22] !== o.tool.name
      ...
      : (n = t[23]),
      (C = ut(n.join(`:`))),
      (w = l.value.routeKind === `local-thread` ? l.value.conversationId : m(C)),
      (t[9] = r),
      (t[10] = l.value.conversationId),
      (t[11] = l.value.routeKind),
      (t[12] = o.hostId),
  ...
  let T = w,
    E;
  t[24] === n ? (E = t[25]) : ((E = D(`h-full min-h-0`, n)), (t[24] = n), (t[25] = E));
  let O;
  t[26] === C
    ? (O = t[27])
    : ((O = (0, q.jsx)(En, { isInlineExpanded: !0, mcpAppId: C })), (t[26] = C), (t[27] = O));
  let te = b?.csp ?? null,
    k = d ?? g,
    j = b?.html ?? null,
    M = f || _,
    N;
  t[28] !== o.resourceUri || t[29] !== o.tool.name
    ? ((N = { originResourceUri: o.resourceUri, originTool: o.tool.name }),
      (t[28] = o.resourceUri),
      (t[29] = o.tool.name),
      (t[30] = N))
    : (N = t[30]);
  let P = b?.prefersBorder ?? !1,
    F;
  t[31] === o.server
    ? (F = t[32])
    : ((F = { kind: `mcp_server`, server: o.server }), (t[31] = o.server), (t[32] = F));
  let L = h ?? null,
    ne = b?.widgetDomain ?? null,
    R;
  t[33] !== T ||
  t[34] !== C ||
  t[35] !== S ||
  ...
  t[48] !== o.title
    ? ((R = (0, q.jsx)(Dn, {
        ...
        prefersBorder: P,
        overrideMcpRequest: S,
        sandboxOriginScope: F,
        server: o.server,
  ...
  t[58] !== d
    ...
    : (z = t[59]);
  let B;
  t[60] === C ? (B = t[61]) : ((B = (0, q.jsx)(kn, { mcpAppId: C })), (t[60] = C), (t[61] = B));
  let V;
  return (
    t[62] !== R || t[63] !== z || t[64] !== B || t[65] !== E || t[66] !== O
      ? ((V = (0, q.jsxs)(`div`, {
...
//# sourceMappingURL=mcp-capability-view-frame-Cpz9Or0y.js.map

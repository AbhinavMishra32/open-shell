...
import { Ho as t, Vo as n } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as r } from "./jsx-runtime-CiQ1k8xo.js";
import { t as i } from "./v4-JB8aTMDB.js";
import { f as a, lt as o } from "./vscode-api-sUstfl-x.js";
var s = e(r(), 1),
  c = new Set(),
  l = new Map(),
  u = [];
function d() {
  return (0, s.useSyncExternalStore)(m, h);
}
function f() {
  return {
    addPendingWorktreeConversationStart: p,
    beginPendingWorktreeConversationStart: (e) =>
      l.get(e)?.state === `waiting` ? (l.set(e, { state: `starting` }), g(), !0) : !1,
    failPendingWorktreeConversationStart: (e) => {
      l.has(e) && (l.set(e, { state: `failed` }), g());
    },
    succeedPendingWorktreeConversationStart: (e, t) => {
      l.has(e) && (l.set(e, { state: `succeeded`, conversationId: t }), g());
    },
    retryPendingWorktreeConversationStart: (e) => {
      l.has(e) && (l.set(e, { state: `waiting` }), g());
    },
...
function g() {
  ((u = Array.from(l, ([e, t]) => ({ pendingWorktreeId: e, ...t }))),
    c.forEach((e) => {
      e();
    }));
}
...
function b(e) {
  let n = e.lastIndexOf(`:`);
  return n <= 0 || n === e.length - 1 ? t : e.slice(0, n);
}
function x() {
  let [e] = n(`pending_worktrees`);
  return e ?? v;
}
function S(e) {
  let t = (0, _.c)(3),
    [r] = n(`pending_worktrees`);
  if (!e) return null;
  if (r === void 0) return;
  let i;
  return (
    t[0] !== e || t[1] !== r
      ? ((i = r.find((t) => t.id === e) ?? null), (t[0] = e), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
function C() {
  let e = (0, _.c)(33),
    [, t] = n(`pending_worktrees`),
    { removePendingWorktreeConversationStart: r, retryPendingWorktreeConversationStart: i } = f(),
    o;
  e[0] === t
    ? (o = e[1])
    : ((o = (e) => {
        ...
        return window.electronBridge == null
          ? (r.launchMode !== `create-stable-worktree` && p(n),
            t((e) => [...(e === void 0 ? [] : e), r]),
            n)
          : E(n, e);
      }),
    ...
    : ((c = (e, n) => {
        if (n.length !== 0) {
          if (window.electronBridge == null) {
            t((t) => (t === void 0 ? [] : t).map((t) => (t.id === e ? O(t, n) : t)));
            return;
          }
          n.forEach((t) => {
  ...
  e[12] !== i || e[13] !== t
    ? ((C = (e) => {
        ...
        a.dispatchMessage(`pending-worktree-retry`, { hostId: b(e), id: e });
      }),
      (e[12] = i),
      (e[13] = t),
      (e[14] = C))
  ...
  e[15] === t
    ? (D = e[16])
    : ((D = (e) => {
        if ((p(e), window.electronBridge == null)) {
          t((t) =>
            (t === void 0 ? [] : t).map((t) =>
              t.id === e &&
              t.phase === `failed` &&
        ...
        a.dispatchMessage(`pending-worktree-continue`, { hostId: b(e), id: e });
      }),
      (e[15] = t),
      (e[16] = D));
  let k = D,
  ...
  e[17] !== r || e[18] !== t
    ? ((A = (e) => {
        if ((r(e), window.electronBridge == null)) {
          t((t) => (t === void 0 ? [] : t).filter((t) => t.id !== e));
          return;
        }
        a.dispatchMessage(`pending-worktree-cancel`, { hostId: b(e), id: e });
      }),
      (e[17] = r),
      (e[18] = t),
      (e[19] = A))
  ...
  e[20] !== r || e[21] !== t
    ? ((M = (e) => {
        ...
        a.dispatchMessage(`pending-worktree-dismiss`, { hostId: b(e), id: e });
      }),
      (e[20] = r),
      (e[21] = t),
      (e[22] = M))
  ...
  return (
    ...
    e[31] !== v
      ? ((P = {
          ...
          setPendingWorktreePinned: h,
          setPendingWorktreePinnedBeforeThreadId: v,
          clearPendingWorktreeAttention: S,
          retryPendingWorktree: w,
          continuePendingWorktree: k,
          cancelPendingWorktree: j,
          dismissPendingWorktree: N,
        }),
        (e[23] = j),
        (e[24] = S),
        (e[25] = k),
  ...
  switch (t.launchMode) {
    ...
    case `start-conversation`:
      return {
        ...
        threadGoalObjective: t.threadGoalObjective,
        sourceConversationId: null,
        sourceCollaborationMode: null,
      };
  }
...
function E(e, t) {
  if (window.electronBridge == null)
    throw Error(`Worktree app actions require the Opaline desktop app`);
  return (
    T(e, t).launchMode !== `create-stable-worktree` && p(e),
    a.dispatchMessage(`pending-worktree-create`, { hostId: t.hostId, request: D(e, t) }),
    e
  );
}
function D(e, t) {
...
export { f as a, x as i, S as n, d as o, C as r, w as t };
//# sourceMappingURL=pending-worktree-store-CGUvLIzH.js.map

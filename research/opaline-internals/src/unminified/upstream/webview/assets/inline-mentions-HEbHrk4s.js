...
var _e = e(p(), 1),
  ...
  Q = m(),
  rt = C({
    controlDesktopAppsFromOpaline: {
      id: `markdown.pluginMention.controlDesktopAppsFromOpaline`,
      defaultMessage: `Control desktop apps from Opaline`,
...
function lt({
  ...
  let s = e?.description ?? r.formatMessage(rt.controlDesktopAppsFromOpaline),
    c = e == null ? null : j(e, a);
  return (0, Q.jsx)($, {

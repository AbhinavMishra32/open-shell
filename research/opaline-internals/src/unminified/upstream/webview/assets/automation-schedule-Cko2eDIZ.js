...
import { o as a, r as o, t as s } from "./tslib.es6-BbTQ3PDY.js";
var c = [`MO`, `TU`, `WE`, `TH`, `FR`, `SA`, `SU`],
  l = (function () {
    function e(e, t) {
...
function _(e, t, n) {
  ...
  return (
    ...
    r.length > t
      ? String(r)
      : ((t -= r.length), t > n.length && (n += h(n, t / n.length)), n.slice(0, t) + String(r))
  );
}
var v = function (e, t, n) {
  ...
  b = function (e, t) {
    return { div: Math.floor(e / t), mod: y(e, t) };
  },
  x = function (e) {
  ...
  ie = function (e) {
    return new Date(ee.getTime() + e * E);
  },
  ae = function (e) {
    var t = e.getUTCMonth();
    return t === 1 && O(e.getUTCFullYear()) ? 29 : T[t];
  },
  A = function (e) {
  ...
  le = function (e) {
    for (var t = [], n = 0; n < e.length; n++) t.push(ce(e[n]));
    return t;
  },
  j = function (e) {
    e.sort(function (e, t) {
  ...
  ue = function (e, t) {
    ...
    var n = new Date(e);
    return [
      _(n.getUTCFullYear().toString(), 4, `0`),
      _(n.getUTCMonth() + 1, 2, `0`),
      _(n.getUTCDate(), 2, `0`),
      `T`,
      _(n.getUTCHours(), 2, `0`),
      _(n.getUTCMinutes(), 2, `0`),
      _(n.getUTCSeconds(), 2, `0`),
      t ? `Z` : ``,
    ].join(``);
  },
  de = function (e) {
  ...
  pe = function (e, t) {
    var n = Intl.DateTimeFormat().resolvedOptions().timeZone,
      r = new Date(fe(e, n)),
      i = new Date(fe(e, t ?? `UTC`)).getTime() - r.getTime();
  ...
  P = (function () {
    function e(e, t, n, r) {
      ...
      if (u(this.origOptions.byweekday)) {
        var o = p(this.origOptions.byweekday)
    ...
    return (
      (e.isFullyConvertible = function (t) {
        ...
        for (var r in t.origOptions) {
          if (he([`dtstart`, `tzid`, `wkst`, `freq`], r)) return !0;
          if (!he(e.IMPLEMENTED[t.options.freq], r)) return !1;
        }
        return n;
      }),
      ...
      (e.prototype.toString = function () {
        ...
        if (
          ((this.text = [t(`every`)]), this[G.FREQUENCIES[this.options.freq]](), this.options.until)
        ) {
          this.add(t(`until`));
      ...
      (e.prototype.list = function (e, t, n, r) {
        ...
        var a = function (e, t, n) {
          for (var r = ``, i = 0; i < e.length; i++)
            (i !== 0 && (i === e.length - 1 ? (r += ` ` + n + ` `) : (r += t + ` `)), (r += e[i]));
          return r;
        };
        t ||= function (e) {
          return e.toString();
...
function ye(e, t) {
  ...
  function i() {
    ...
    switch (r.symbol) {
      case `day(s)`:
        ((n.freq = G.DAILY), r.nextSymbol() && (o(), d()));
        break;
      case `weekday(s)`:
        ((n.freq = G.WEEKLY),
          (n.byweekday = [G.MO, G.TU, G.WE, G.TH, G.FR]),
          r.nextSymbol(),
          o(),
          d());
        break;
      case `week(s)`:
        ((n.freq = G.WEEKLY), r.nextSymbol() && (a(), o(), d()));
        break;
      case `hour(s)`:
        ((n.freq = G.HOURLY), r.nextSymbol() && (a(), d()));
        break;
      case `minute(s)`:
        ((n.freq = G.MINUTELY), r.nextSymbol() && (a(), d()));
        break;
      case `month(s)`:
        ((n.freq = G.MONTHLY), r.nextSymbol() && (a(), d()));
        break;
      case `year(s)`:
        ((n.freq = G.YEARLY), r.nextSymbol() && (a(), d()));
        break;
      case `monday`:
      case `tuesday`:
      case `wednesday`:
      ...
      case `sunday`:
        if (
          ((n.freq = G.WEEKLY),
          (n.byweekday = [G[r.symbol.substr(0, 2).toUpperCase()]]),
          !r.nextSymbol())
        )
          return;
        for (; r.accept(`comma`); ) {
          ...
          (n.byweekday.push(G[t]), r.nextSymbol());
        }
        (o(), u(), d());
        break;
      case `january`:
      ...
      case `november`:
      case `december`:
        if (((n.freq = G.YEARLY), (n.bymonth = [s()]), !r.nextSymbol())) return;
        for (; r.accept(`comma`); ) {
          if (r.isDone()) throw Error(`Unexpected end`);
          var i = s();
  ...
  function a() {
    ...
    if (e || t)
      do {
        ...
        if (i)
          a
            ? (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(G[a].nth(i)))
            : ((n.bymonthday ||= []), n.bymonthday.push(i), r.accept(`day(s)`));
        else if (a) (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(G[a]));
        else if (r.symbol === `weekday(s)`)
          (r.nextSymbol(), (n.byweekday ||= [G.MO, G.TU, G.WE, G.TH, G.FR]));
...
var xe = function (e, t) {
    return (t === void 0 && (t = N), new G(ye(e, t) || void 0));
  },
  I = [`count`, `until`, `interval`, `byweekday`, `bymonthday`, `bymonth`];
((P.IMPLEMENTED = []),
  (P.IMPLEMENTED[F.HOURLY] = I),
  (P.IMPLEMENTED[F.MINUTELY] = I),
  (P.IMPLEMENTED[F.DAILY] = [`byhour`].concat(I)),
  (P.IMPLEMENTED[F.WEEKLY] = I),
  (P.IMPLEMENTED[F.MONTHLY] = I),
  (P.IMPLEMENTED[F.YEARLY] = [`byweekno`, `byyearday`].concat(I)));
var Se = function (e, t, n, r) {
    return new P(e, t, n, r).toString();
  },
  Ce = P.isFullyConvertible,
  we = (function () {
    function e(e, t, n, r) {
    ...
    return (
      ...
      (t.prototype.addHours = function (e, t, n) {
        for (t && (this.hour += Math.floor((23 - this.hour) / e) * e); ; ) {
          this.hour += e;
          var r = b(this.hour, 24),
            i = r.div,
            a = r.mod;
          if ((i && ((this.hour = a), this.addDaily(i)), x(n) || C(n, this.hour))) break;
        }
      }),
      (t.prototype.addMinutes = function (e, t, n, r) {
        for (
          t && (this.minute += Math.floor((1439 - (this.hour * 60 + this.minute)) / e) * e);
          ;
        ) {
          this.minute += e;
          var i = b(this.minute, 60),
            a = i.div,
            o = i.mod;
          if (
            (a && ((this.minute = o), this.addHours(a, !1, n)),
            (x(n) || C(n, this.hour)) && (x(r) || C(r, this.minute)))
          )
            break;
        }
      }),
      (t.prototype.addSeconds = function (e, t, n, r, i) {
        for (
          ...
          this.second += e;
          var a = b(this.second, 60),
            o = a.div,
            s = a.mod;
          if (
            (o && ((this.second = s), this.addMinutes(o, !1, n, r)),
            (x(n) || C(n, this.hour)) && (x(r) || C(r, this.minute)) && (x(i) || C(i, this.second)))
          )
            break;
        }
      }),
      (t.prototype.fixDay = function () {
        if (!(this.day <= 28)) {
          var e = oe(this.year, this.month - 1)[1];
          if (!(this.day <= e))
            for (; this.day > e; ) {
              if (
                ((this.day -= e),
                ++this.month,
                this.month === 13 && ((this.month = 1), ++this.year, this.year > 9999))
              )
                return;
              e = oe(this.year, this.month - 1)[1];
            }
        }
      }),
...
function Ee(e) {
  for (var t = [], n = Object.keys(e), r = 0, i = n; r < i.length; r++) {
    var a = i[r];
    (C(ut, a) || t.push(a), te(e[a]) && !k(e[a]) && t.push(a));
  }
...
function De(e) {
  var t = s(s({}, lt), Ee(e));
  if ((u(t.byeaster) && (t.freq = G.YEARLY), !(u(t.freq) && G.FREQUENCIES[t.freq])))
    throw Error(`Invalid frequency: ${t.freq} ${e.freq}`);
  if (
    ((t.dtstart ||= new Date(new Date().setMilliseconds(0))),
    u(t.wkst) ? d(t.wkst) || (t.wkst = t.wkst.weekday) : (t.wkst = G.MO.weekday),
    u(t.bysetpos))
  ) {
  ...
  if (
    (u(t.bymonth) && !p(t.bymonth) && (t.bymonth = [t.bymonth]),
    u(t.byyearday) && !p(t.byyearday) && d(t.byyearday) && (t.byyearday = [t.byyearday]),
    !u(t.bymonthday))
  )
    ((t.bymonthday = []), (t.bynmonthday = []));
  else if (p(t.bymonthday)) {
    ...
    t.bymonthday < 0
      ...
      : ((t.bynmonthday = []), (t.bymonthday = [t.bymonthday]));
  if ((u(t.byweekno) && !p(t.byweekno) && (t.byweekno = [t.byweekno]), !u(t.byweekday)))
    t.bynweekday = null;
  else if (d(t.byweekday)) ((t.byweekday = [t.byweekday]), (t.bynweekday = null));
  else if (f(t.byweekday))
    ((t.byweekday = [l.fromStr(t.byweekday).weekday]), (t.bynweekday = null));
  else if (t.byweekday instanceof l)
    !t.byweekday.n || t.freq > G.MONTHLY
      ? ((t.byweekday = [t.byweekday.weekday]), (t.bynweekday = null))
      : ((t.bynweekday = [[t.byweekday.weekday, t.byweekday.n]]), (t.byweekday = null));
  else {
    for (var o = [], c = [], n = 0; n < t.byweekday.length; n++) {
      var m = t.byweekday[n];
      if (d(m)) {
        o.push(m);
        continue;
      } else if (f(m)) {
        o.push(l.fromStr(m).weekday);
        continue;
      }
      !m.n || t.freq > G.MONTHLY ? o.push(m.weekday) : c.push([m.weekday, m.n]);
    }
    ((t.byweekday = S(o) ? o : null), (t.bynweekday = S(c) ? c : null));
  }
  return (
    u(t.byhour)
      ? d(t.byhour) && (t.byhour = [t.byhour])
      : (t.byhour = t.freq < G.HOURLY ? [t.dtstart.getUTCHours()] : null),
    u(t.byminute)
      ? d(t.byminute) && (t.byminute = [t.byminute])
      : (t.byminute = t.freq < G.MINUTELY ? [t.dtstart.getUTCMinutes()] : null),
    u(t.bysecond)
      ? d(t.bysecond) && (t.bysecond = [t.bysecond])
      : (t.bysecond = t.freq < G.SECONDLY ? [t.dtstart.getUTCSeconds()] : null),
    { parsedOptions: t }
  );
}
function Oe(e) {
...
function L(e) {
  ...
  var r = n[1],
    i = n[2];
  return (r && (t.tzid = r), (t.dtstart = de(i)), t);
}
function Ae(e) {
    ...
    e
      ...
      .forEach(function (n) {
        ...
        switch (i.toUpperCase()) {
          case `FREQ`:
            t.freq = F[a.toUpperCase()];
            break;
          case `WKST`:
            t.wkst = W[a.toUpperCase()];
            break;
          case `COUNT`:
          case `INTERVAL`:
          case `BYSETPOS`:
...
function Me(e) {
  return e.indexOf(`,`) === -1 ? Ne(e) : e.split(`,`).map(Ne);
}
function Ne(e) {
...
var R = (function () {
  ...
  return (
    ...
    (e.prototype.toString = function () {
      var e = ue(this.date.getTime(), this.isUTC);
    ...
    (e.prototype.rezonedDate = function () {
      return this.isUTC ? this.date : pe(this.date, this.tzid);
    }),
    e
  );
})();
function Fe(e) {
  for (var t = [], n = ``, r = Object.keys(e), i = Object.keys(lt), a = 0; a < r.length; a++)
    if (r[a] !== `tzid` && C(i, r[a])) {
      ...
      if (!(!u(s) || (p(s) && !s.length))) {
        switch (o) {
          case `FREQ`:
            c = G.FREQUENCIES[e.freq];
            break;
          case `WKST`:
            c = d(s) ? new l(s).toString() : s.toString();
            break;
          case `BYWEEKDAY`:
            ((o = `BYDAY`),
              (c = g(s)
                .map(function (e) {
                  return e instanceof l ? e : p(e) ? new l(e[0], e[1]) : new l(e);
                })
                .toString()));
            break;
          case `DTSTART`:
          ...
          default:
            if (p(s)) {
              for (var f = [], m = 0; m < s.length; m++) f[m] = String(s[m]);
              c = f.toString();
            } else c = String(s);
        }
        c && t.push([o, c]);
...
function Ie(e, t) {
  return e ? `DTSTART` + new R(new Date(e), t).toString() : ``;
}
function Le(e, t) {
...
var Re = (function () {
    ...
    return (
      ...
      (e.prototype._cacheGet = function (e, t) {
        ...
        return p(n) ? le(n) : n instanceof Date ? ce(n) : n;
      }),
      e
    );
  })(),
          ...
          a(
            a(
              a(
                a(
                  a(
                    a(a(a(a([], h(1, 31), !0), h(2, 28), !0), h(3, 31), !0), h(4, 30), !0),
                    h(5, 31),
                    !0,
                  ),
                  h(6, 30),
          ...
          a(
            a(
              a(
                a(
                  a(
                    a(a(a(a([], h(1, 31), !0), h(2, 29), !0), h(3, 31), !0), h(4, 30), !0),
                    h(5, 31),
                    !0,
                  ),
                  h(6, 30),
  ...
  Ue = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], B, !0), He, !0), B, !0), z, !0), B, !0), z, !0), B, !0), B, !0),
            z,
            !0,
          ),
          B,
  ...
  We = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], B, !0), Ve, !0), B, !0), z, !0), B, !0), z, !0), B, !0), B, !0),
            z,
            !0,
          ),
          B,
  ...
  qe = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], H, !0), Ke, !0), H, !0), V, !0), H, !0), V, !0), H, !0), H, !0),
            V,
            !0,
          ),
          H,
  ...
  Je = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], H, !0), Ge, !0), H, !0), V, !0), H, !0), V, !0), H, !0), H, !0),
            V,
            !0,
          ),
          H,
  ...
  Ye = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366],
  Xe = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365],
  Ze = (function () {
    for (var e = [], t = 0; t < 55; t++) e = e.concat(m(7));
    return e;
  })();
function Qe(e, t) {
  var n = w(e, 1, 1),
    ...
    a = re(n),
    o = A(n),
    c = s(s({ yearlen: r, nextyearlen: i, yearordinal: a, yearweekday: o }, $e(e)), {
      wnomask: null,
    });
  if (x(t.byweekno)) return c;
  c.wnomask = h(0, r + 7);
  var l,
    u,
    d = (l = y(7 - o + t.wkst, 7));
  d >= 4 ? ((d = 0), (u = c.yearlen + y(o - t.wkst, 7))) : (u = r - d);
  for (
    var f = Math.floor(u / 7), p = y(u, 7), m = Math.floor(f + p / 4), g = 0;
    g < t.byweekno.length;
    g++
  ) {
    var _ = t.byweekno[g];
    if ((_ < 0 && (_ += m + 1), _ > 0 && _ <= m)) {
      var v = void 0;
      _ > 1 ? ((v = d + (_ - 1) * 7), d !== l && (v -= 7 - l)) : (v = d);
      for (var b = 0; b < 7 && ((c.wnomask[v] = 1), v++, c.wdaymask[v] !== t.wkst); b++);
    }
  }
  if (C(t.byweekno, 1)) {
    var v = d + m * 7;
    if ((d !== l && (v -= 7 - l), v < r))
      for (var g = 0; g < 7 && ((c.wnomask[v] = 1), (v += 1), c.wdaymask[v] !== t.wkst); g++);
  }
  if (d) {
    var S = void 0;
    if (C(t.byweekno, -1)) S = -1;
    else {
      var T = A(w(e - 1, 1, 1)),
        E = y(7 - T.valueOf() + t.wkst, 7),
        ee = O(e - 1) ? 366 : 365,
        D = void 0;
      (E >= 4 ? ((E = 0), (D = ee + y(T - t.wkst, 7))) : (D = r - d),
        (S = Math.floor(52 + y(D, 7) / 4)));
    }
    if (C(t.byweekno, S)) for (var v = 0; v < d; v++) c.wnomask[v] = 1;
  }
  return c;
}
function $e(e) {
  var t = O(e) ? 366 : 365,
    n = A(w(e, 1, 1));
  return t === 365
    ? { mmask: ze, mdaymask: We, nmdaymask: Je, wdaymask: Ze.slice(n), mrange: Xe }
    : { mmask: Be, mdaymask: Ue, nmdaymask: qe, wdaymask: Ze.slice(n), mrange: Ye };
}
function et(e, t, n, r, i, a) {
  var o = { lastyear: e, lastmonth: t, nwdaymask: [] },
    s = [];
  if (a.freq === G.YEARLY)
    if (x(a.bymonth)) s = [[0, n]];
    else
      for (var c = 0; c < a.bymonth.length; c++)
        ((t = a.bymonth[c]), s.push(r.slice(t - 1, t + 1)));
  else a.freq === G.MONTHLY && (s = [r.slice(t - 1, t + 1)]);
  if (x(s)) return o;
  o.nwdaymask = h(0, n);
  for (var c = 0; c < s.length; c++)
    for (var l = s[c], u = l[0], d = l[1] - 1, f = 0; f < a.bynweekday.length; f++) {
      var p = void 0,
        m = a.bynweekday[f],
        g = m[0],
        _ = m[1];
      (_ < 0
        ? ((p = d + (_ + 1) * 7), (p -= y(i[p] - g, 7)))
        : ((p = u + (_ - 1) * 7), (p += y(7 - i[p] + g, 7))),
...
function tt(e, t) {
  ...
  var n = e % 19,
    ...
    _ = Date.UTC(e, 0, 1);
  return [Math.ceil((g - _) / (1e3 * 60 * 60 * 24))];
}
var nt = (function () {
  function e(e) {
    this.options = e;
  ...
  return (
    (e.prototype.rebuild = function (e, t) {
      var n = this.options;
      if (
        (e !== this.lastyear && (this.yearinfo = Qe(e, n)),
        S(n.bynweekday) && (t !== this.lastmonth || e !== this.lastyear))
      ) {
        var r = this.yearinfo,
          i = r.yearlen,
          a = r.mrange,
          o = r.wdaymask;
        this.monthinfo = et(e, t, i, a, o, n);
      }
      u(n.byeaster) && (this.eastermask = tt(e, n.byeaster));
    }),
    ...
    (e.prototype.ydayset = function () {
      return [m(this.yearlen), 0, this.yearlen];
    }),
    (e.prototype.mdayset = function (e, t) {
      for (
        var n = this.mrange[t - 1], r = this.mrange[t], i = h(null, this.yearlen), a = n;
        a < r;
        a++
      )
        i[a] = a;
    ...
    (e.prototype.wdayset = function (e, t, n) {
      for (
        var r = h(null, this.yearlen + 7), i = re(w(e, t, n)) - this.yearordinal, a = i, o = 0;
...
function rt(e, t, n, r, i, a) {
  for (var o = [], s = 0; s < e.length; s++) {
    var c = void 0,
      ...
      d = e[s];
    d < 0
      ? ((c = Math.floor(d / t.length)), (l = y(d, t.length)))
      : ((c = Math.floor((d - 1) / t.length)), (l = y(d - 1, t.length)));
    for (var f = [], p = n; p < r; p++) {
      var m = a[p];
      u(m) && f.push(m);
    }
    var h = void 0;
    h = c < 0 ? f.slice(c)[0] : f[c];
    var g = t[l],
      _ = se(ie(i.yearordinal + h), g);
    C(o, _) || o.push(_);
  }
  return (j(o), o);
}
function it(e, t) {
  var n = t.dtstart,
    ...
    o = t.bysetpos,
    s = t.count;
  if (s === 0 || i === 0) return U(e);
  var c = Te.fromDate(n),
    l = new nt(t);
  l.rebuild(c.year, c.month);
  for (var d = ct(l, c, t); ; ) {
    var f = l.getdayset(r)(c.year, c.month, c.day),
      p = f[0],
      m = f[1],
      h = f[2],
      g = st(p, m, h, l, t);
    if (S(o))
      for (var _ = rt(o, d, m, h, l, p), v = 0; v < _.length; v++) {
        var y = _[v];
        if (a && y > a) return U(e);
        if (y >= n) {
          var b = ot(y, t);
          if (!e.accept(b) || (s && (--s, !s))) return U(e);
        }
      }
    else
      for (var v = m; v < h; v++) {
        var x = p[v];
        if (u(x))
          for (var C = ie(l.yearordinal + x), w = 0; w < d.length; w++) {
            var T = d[w],
              y = se(C, T);
            if (a && y > a) return U(e);
            if (y >= n) {
    ...
    if (t.interval === 0 || (c.add(t, g), c.year > 9999)) return U(e);
    (be(r) || (d = l.gettimeset(r)(c.hour, c.minute, c.second, 0)), l.rebuild(c.year, c.month));
  }
}
function at(e, t, n) {
  var r = n.bymonth,
  ...
  return (
    (S(r) && !C(r, e.mmask[t])) ||
    (S(i) && !e.wnomask[t]) ||
    (S(a) && !C(a, e.wdaymask[t])) ||
    (S(e.nwdaymask) && !e.nwdaymask[t]) ||
    (o !== null && !C(e.eastermask, t)) ||
    ((S(s) || S(c)) && !C(s, e.mdaymask[t]) && !C(c, e.nmdaymask[t])) ||
    (S(l) &&
      ((t < e.yearlen && !C(l, t + 1) && !C(l, -e.yearlen + t)) ||
        (t >= e.yearlen && !C(l, t + 1 - e.yearlen) && !C(l, -e.nextyearlen + t - e.yearlen))))
  );
}
function ot(e, t) {
  return new R(e, t.tzid).rezonedDate();
}
function U(e) {
  return e.getValue();
}
...
function ct(e, t, n) {
  ...
  return be(r)
    ? Oe(n)
    : (r >= G.HOURLY && S(i) && !C(i, t.hour)) ||
        (r >= G.MINUTELY && S(a) && !C(a, t.minute)) ||
        (r >= G.SECONDLY && S(o) && !C(o, t.second))
      ? []
...
var W = {
  ...
  G = (function () {
    function e(e, t) {
      (e === void 0 && (e = {}),
        t === void 0 && (t = !1),
        (this._cache = t ? null : new Re()),
        (this.origOptions = Ee(e)),
        (this.options = De(e).parsedOptions));
    }
    return (
      ...
      (e.prototype.before = function (e, t) {
        ...
        return (
          r === !1 && ((r = this._iter(new M(`before`, n))), this._cacheAdd(`before`, r, n)),
          r
        );
      }),
      (e.prototype.after = function (e, t) {
        if ((t === void 0 && (t = !1), !k(e))) throw Error(`Invalid date passed in to RRule.after`);
        var n = { dt: e, inc: t },
          r = this._cacheGet(`after`, n);
        return (
          r === !1 && ((r = this._iter(new M(`after`, n))), this._cacheAdd(`after`, r, n)),
          r
        );
      }),
...
var ft = { dtstart: null, cache: !1, unfold: !1, forceset: !1, compatible: !1, tzid: null };
function pt(e, t) {
  var n = [],
    r = [],
    i = [],
    ...
    c = o.tzid;
  return (
    bt(e, t.unfold).forEach(function (e) {
      if (e) {
        var t = yt(e),
          o = t.name,
          s = t.parms,
    ...
    { dtstart: s, tzid: c, rrulevals: n, rdatevals: r, exrulevals: i, exdatevals: a }
  );
}
function mt(e, t) {
  var n = pt(e, t),
  ...
  if (
    ...
    return (
      ...
      r.forEach(function (e) {
        u.rrule(new G(gt(e, s, c), l));
      }),
      i.forEach(function (e) {
        u.rdate(e);
      }),
      a.forEach(function (e) {
        u.exrule(new G(gt(e, s, c), l));
      }),
  ...
  var d = r[0] || {};
  return new G(gt(d, d.dtstart || t.dtstart || s, d.tzid || t.tzid || c), l);
}
function ht(e, t) {
  return (t === void 0 && (t = {}), mt(e, _t(t)));
}
function gt(e, t, n) {
...
var wt = (function (e) {
  ...
  function t(t) {
    ...
    return (
      (n.dtstart = Ct.apply(n, [`dtstart`])),
      (n.tzid = Ct.apply(n, [`tzid`])),
      (n._rrule = []),
      (n._rdate = []),
      (n._exrule = []),
      (n._exdate = []),
  ...
  return (
    (t.prototype._iter = function (e) {
      return dt(e, this._rrule, this._exrule, this._rdate, this._exdate, this.tzid());
    }),
    ...
    (t.prototype.valueOf = function () {
      var e = [];
      return (
        !this._rrule.length && this._dtstart && (e = e.concat(Fe({ dtstart: this._dtstart }))),
...
`,
        ...
        this._rdate.length && e.push(Dt(`RDATE`, this._rdate, this.tzid())),
        this._exdate.length && e.push(Dt(`EXDATE`, this._exdate, this.tzid())),
        e
      );
    }),
...
function Tt(e, t) {
  if (!(e instanceof G)) throw TypeError(String(e) + ` is not RRule instance`);
  C(t.map(String), String(e)) || t.push(e);
}
function Et(e, t) {
  if (!(e instanceof Date)) throw TypeError(String(e) + ` is not Date instance`);
  C(t.map(Number), Number(e)) || (t.push(e), j(t));
}
function Dt(e, t, n) {
  var r = !n || n.toUpperCase() === `UTC`;
  return `${r ? `${e}:` : `${e};TZID=${n}:`}${t
    .map(function (e) {
      return ue(e.valueOf(), r);
    })
    .join(`,`)}`;
}
var K = [`SU`, `MO`, `TU`, `WE`, `TH`, `FR`, `SA`];
function q(e) {
  let t = new Map(K.map((e, t) => [e, t]));
...
function Ot(e, t) {
  ...
  return !Number.isFinite(i) || !Number.isFinite(a)
    ? null
    : t.formatTime(new Date(2024, 0, 1, i, a), { hour: `numeric`, minute: `2-digit` });
}
function kt(e, t) {
  switch (e) {
    case `SU`:
...
function At(e, t, n, r, i) {
  ...
  if (i === `long` && e.length === 1) {
    let n = e[0];
    return n ? kt(n, t) : null;
  }
  return e.length > 2 && Lt(e) ? It(e, t) : jt(e, t, e.length > 2 ? `short` : i);
}
function J(e, t) {
  return e.length === t.length ? t.every((t) => e.includes(t)) : !1;
}
function jt(e, t, n) {
  let r = e.map((e) => (n === `short` ? Ft(e, t) : Mt(e, t, `long`)));
...
function Ft(e, t) {
  let n = Mt(e, t, `short`),
    r = Mt(e, t, `long`);
  return n.length >= r.length ? t.formatDate(Nt(e), { weekday: `narrow` }) : n;
}
function It(e, t) {
  let n = q(e),
    r = n[0],
...
var Y = Array.from(K),
  ...
  zt = `09:00`,
  Bt = `MO`,
  Vt = { MO: G.MO, TU: G.TU, WE: G.WE, TH: G.TH, FR: G.FR, SA: G.SA, SU: G.SU };
function Ht() {
  return {
    mode: `daily`,
    intervalHours: 24,
...
function Gt(e) {
  ...
  return { ...t, intervalHours: Math.max(1, Math.round(r / 60)), intervalMinutes: r };
}
function Kt(e) {
  let t = $(e);
  if (t == null) return {};
...
function qt(e) {
  let t = {
    kind: on(e.kind),
    ...(`status` in e ? { status: sn(e.status) } : {}),
    ...Kt(e.rrule),
    hasModel: e.model != null,
    ...(e.reasoningEffort == null ? {} : { reasoningEffort: cn(e.reasoningEffort) }),
  };
  if (e.kind !== `cron`) return t;
  let n = { ...t, cwdCount: e.cwds.length, executionEnvironment: ln(e.executionEnvironment) };
  return (
    e.localEnvironmentConfigPath !== void 0 &&
      (n.hasLocalEnvironmentConfig = e.localEnvironmentConfigPath != null),
    n
  );
}
function Jt(e) {
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null ? en(e.intervalHours) : tn(e.intervalMinutes);
    case `daily`:
      return rn({ time: e.time, weekdays: Y });
    case `weekdays`:
      return rn({ time: e.time, weekdays: Array.from(X) });
    case `weekly`:
      return rn({ time: e.time, weekdays: [bn(e.weekdays)] });
    case `custom`:
...
function Yt(e) {
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null ? Z(e.intervalHours) != null : Q(e.intervalMinutes) != null;
    case `daily`:
    case `weekdays`:
    case `weekly`:
      return xn(e.time) != null;
    case `custom`:
      return Sn(e.customRrule.trim());
  }
}
function Xt(e, t) {
  return t === `custom`
    ? {
        ...e,
        mode: `custom`,
        customRrule: e.mode === `custom` && e.customRrule.trim() ? e.customRrule : Jt(e),
      }
    : t === `hourly`
      ? {
          ...e,
          mode: `hourly`,
          intervalHours: e.mode === `hourly` ? (Z(e.intervalHours) ?? 1) : 1,
          intervalMinutes: e.intervalMinutes == null ? null : (Q(e.intervalMinutes) ?? 30),
        }
      : t === `daily`
        ? { ...e, mode: `daily`, weekdays: Y }
        : t === `weekdays`
          ? { ...e, mode: `weekdays`, weekdays: Array.from(X) }
          : { ...e, mode: `weekly`, weekdays: [bn(e.weekdays)] };
}
function Zt(e) {
  return e.length > 0 ? q(e) : Y;
}
function Qt(e, t) {
  return dn($(Jt(e)), t) ?? null;
}
function $t({ rrule: e, intl: t, fallbackMessage: n }) {
  return e ? (dn($(e), t) ?? n) : null;
}
function en(e) {
  let t = Z(e) ?? 1;
  return new G({
    ...
    interval: t,
    byminute: 0,
    byweekday: Y.map((e) => Vt[e]),
  }).toString();
}
function tn(e) {
  let t = Q(e) ?? 30;
  return new G({ freq: G.MINUTELY, interval: t }).toString();
}
function Z(e) {
...
function $(e) {
  if (!e) return null;
  try {
    let t = ht(e, { forceset: !0, tzid: wn() ?? void 0 }).rrules()[0];
    if (!t) return null;
    let n = t.options,
      r = vn(n.byweekday) ?? yn(e) ?? Y,
      i = _n(n.byminute);
    return {
      freq: n.freq,
      hasMultipleTimeValues:
        (Array.isArray(n.byhour) && n.byhour.length > 1) ||
        (Array.isArray(n.byminute) && n.byminute.length > 1),
      interval: Math.max(1, Math.round(n.interval ?? 1)),
      minute: i,
      rruleText: e,
      time: gn(n.byhour, n.byminute, n),
      weekdays: r,
    };
  } catch {
    return null;
...
function an(e) {
  ...
  if (e.freq === G.HOURLY && e.interval === 1 && e.minute === 0 && J(e.weekdays, Y))
    return `hourly`;
  if (e.interval === 1 && (e.freq === G.DAILY || e.freq === G.WEEKLY)) {
    if (J(e.weekdays, Y)) return `daily`;
    if (J(e.weekdays, X)) return `weekdays`;
...
function on(t) {
  switch (t) {
    case `cron`:
      return e.OPALINE_AUTOMATION_KIND_CRON;
    case `heartbeat`:
      return e.OPALINE_AUTOMATION_KIND_HEARTBEAT;
  }
}
function sn(e) {
  switch (e) {
    case `ACTIVE`:
      return t.OPALINE_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return t.OPALINE_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return t.OPALINE_AUTOMATION_STATUS_DELETED;
  }
}
function cn(e) {
  switch (e) {
    case `none`:
      return n.OPALINE_AUTOMATION_REASONING_EFFORT_NONE;
    case `minimal`:
      return n.OPALINE_AUTOMATION_REASONING_EFFORT_MINIMAL;
    case `low`:
      return n.OPALINE_AUTOMATION_REASONING_EFFORT_LOW;
    case `medium`:
      return n.OPALINE_AUTOMATION_REASONING_EFFORT_MEDIUM;
    case `high`:
      return n.OPALINE_AUTOMATION_REASONING_EFFORT_HIGH;
    case `xhigh`:
      return n.OPALINE_AUTOMATION_REASONING_EFFORT_XHIGH;
  }
}
function ln(e) {
  switch (e) {
    case `worktree`:
      return r.OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return r.OPALINE_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function un(e) {
  switch (e) {
    case G.SECONDLY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY;
    case G.MINUTELY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY;
    case G.HOURLY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY;
    case G.DAILY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_DAILY;
    case G.WEEKLY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY;
    case G.MONTHLY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY;
    case G.YEARLY:
      return i.OPALINE_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY;
  }
}
function dn(e, t) {
  ...
  let n = Zt(e.weekdays),
    r = n.length === K.length;
  if (e.freq === G.MINUTELY)
    return pn({ intervalMinutes: e.interval, intl: t, isEveryDay: r, weekdays: n });
  if (e.freq === G.HOURLY)
    return fn({ intervalHours: e.interval, intl: t, isEveryDay: r, weekdays: n });
  if (e.freq !== G.DAILY && e.freq !== G.WEEKLY) return null;
  let i = Ot(e.time, t);
  return i ? hn({ intl: t, isEveryDay: r, timeLabel: i, weekdays: n }) : null;
}
function fn({ intervalHours: e, intl: t, isEveryDay: n, weekdays: r }) {
  let i =
    e === 1
      ? t.formatMessage({
  ...
  let a = t.formatMessage(
    {
      ...
      description: `Day count label for interval schedules with selected weekdays`,
    },
    { count: r.length },
  );
  return t.formatMessage(
...
function pn({ intervalMinutes: e, intl: t, isEveryDay: n, weekdays: r }) {
  let i = mn({ intervalMinutes: e, intl: t });
  if (n) return i;
  let a = t.formatMessage(
    {
      id: `settings.automations.scheduleSummary.intervalDayCount`,
...
function mn({ intervalMinutes: e, intl: t }) {
  return e === 1
    ? t.formatMessage({
...
function hn({ intl: e, isEveryDay: t, timeLabel: n, weekdays: r }) {
  let i = J(r, X),
    a = J(r, Rt);
  if (t)
...
function gn(e, t, n) {
  ...
  return r != null && i != null
    ? Cn(r, i)
    : n.dtstart
      ? Cn(n.dtstart.getHours(), n.dtstart.getMinutes())
      : zt;
}
function _n(e) {
  return Array.isArray(e)
...
function vn(e) {
  if (!e) return null;
  let t = new Map(K.map((e) => [Vt[e].weekday, e])),
    n = (Array.isArray(e) ? e : [e])
      .map((e) => {
        if (typeof e == `string`) {
          let t = e.toUpperCase();
          return K.includes(t) ? t : null;
        }
        return typeof e == `number`
          ? (t.get(e) ?? null)
...
function xn(e) {
  let [t, n] = e.split(`:`),
    r = Number(t),
    i = Number(n);
  return !Number.isFinite(r) || !Number.isFinite(i) ? null : { hour: r, minute: i };
}
function Sn(e) {
  return e ? $(e) != null : !1;
}
...
//# sourceMappingURL=automation-schedule-Cko2eDIZ.js.map

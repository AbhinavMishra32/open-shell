...
import { Nr as t, so as n } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as r, t as i } from "./jsx-runtime-CiQ1k8xo.js";
import { t as a } from "./clsx-BcPLHiun.js";
import { g as o, lt as s, s as c } from "./vscode-api-sUstfl-x.js";
import { o as l } from "./lib-MoKmYgcO.js";
import { t as u } from "./use-is-dark-DM2fOM7F.js";
import { t as ee } from "./tooltip-BhXPONlb.js";
import { t as d } from "./open-workspace-file-DNjRVDw7.js";
import { t as f } from "./proxy-DktXrBt_.js";
import { t as p } from "./parse-diff--8ZK8ESR.js";
import { t as m } from "./file-diff-DyKTlUkx.js";
import { t as h } from "./chevron-right-BZtXyaBk.js";
import { n as g } from "./use-resize-observer-CbHbkQNx.js";
import { t as _ } from "./thinking-shimmer-BqifOpst.js";
import { t as v } from "./animations-Du6t0V8Z.js";
import { t as y } from "./code-snippet-BL80sM4U.js";
import { t as b } from "./copy-button-5izllJyD.js";
import { n as te } from "./diff-stats-RCuB___W.js";
function x(e) {
  let t = e.toLowerCase();
...
function w() {
  ...
  return (
    e[4] !== t || e[5] !== c
      ? ((l = { elementHeightPx: t, elementRef: c }), (e[4] = t), (e[5] = c), (e[6] = l))
      : (l = e[6]),
    l
  );
}
...
function k(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    ...
    bb0: {
      ...
      if (o === `offset`) {
        c = (0, O.jsx)(`div`, { className: a(e, `relative overflow-visible py-0`), children: n });
        break bb0;
      }
      s = a(e, `py-0`);
    }
  ...
  return (
    t[5] !== n || t[6] !== s
      ? ((l = (0, O.jsx)(`div`, { className: s, children: n })), (t[5] = n), (t[6] = s), (t[7] = l))
      : (l = t[7]),
    l
  );
}
...
function re(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((o = (0, O.jsx)(`div`, { className: i, ...r })), (t[5] = r), (t[6] = i), (t[7] = o))
      : (o = t[7]),
    o
  );
}
function ie(e) {
  let r = (0, S.c)(90),
    ...
    A = c(`open-file`),
    j;
  r[0] !== o || r[1] !== i ? ((j = t(i, o)), (r[0] = o), (r[1] = i), (r[2] = j)) : (j = r[2]);
  let M = j,
    N;
  ...
  bb0: {
    if (o.type === `add`) {
      if (y) {
        ...
        (r[8] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, O.jsx)(l, {
              id: `opaline.patch.change.stoppedCreating`,
      ...
      if (x) {
        ...
        (r[9] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, O.jsx)(l, {
              id: `opaline.patch.change.rejected-add`,
    ...
    if (o.type === `delete`) {
      if (y) {
        ...
        (r[12] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, O.jsx)(l, {
              id: `opaline.patch.change.stoppedDeleting`,
      ...
      if (x) {
        ...
        (r[13] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, O.jsx)(l, {
              id: `opaline.patch.change.rejected-delete`,
              defaultMessage: `Rejected`,
    ...
    if (y) {
      ...
      (r[16] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, O.jsx)(l, {
            id: `opaline.patch.change.stoppedEditing`,
    ...
    if (x) {
      ...
      (r[17] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, O.jsx)(l, {
            id: `opaline.patch.change.rejected-edit`,
            defaultMessage: `Rejected`,
  ...
  bb1: {
    ...
    if (o.type === `add`) {
      ...
      (r[30] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, O.jsx)(l, {
            id: `opaline.patch.change.created-file`,
    ...
    if (o.type === `delete`) {
      ...
      (r[31] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, O.jsx)(l, {
            id: `opaline.patch.change.deleted-file`,
    ...
    (r[32] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, O.jsx)(l, {
          id: `opaline.patch.change.edited-file`,
  ...
  r[40] !== M
    ? ((H = M
        ? (0, O.jsx)(oe, {
            ...
            onOpenFile: L,
            children: (0, O.jsx)(se, { path: i, change: o, unifiedDiff: M, isShortView: b }),
          })
        : (0, O.jsx)(re, {
            children:
              o.type === `delete`
                ? (0, O.jsx)(l, {
                    id: `opaline.patch.change.contentsDeleted`,
                    defaultMessage: `Contents deleted`,
                    description: `Label indicating a file has been deleted in the patch summary`,
                  })
                : (0, O.jsx)(l, {
                    id: `opaline.patch.change.noChanges`,
  ...
  let _e;
  r[42] !== H || r[43] !== ge
    ? ((_e = (0, O.jsx)(`div`, { ref: ge, children: H })), (r[42] = H), (r[43] = ge), (r[44] = _e))
    : (_e = r[44]);
  let ve = _e,
  ...
  r[47] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((be = r[47]), (xe = r[48]));
  let W;
  r[49] !== F || r[50] !== z || r[51] !== T || r[52] !== b || r[53] !== y || r[54] !== g
    ? ((W = g
        ? (0, O.jsx)(_, {
            active: !0,
  ...
  r[56] !== z || r[57] !== L || r[58] !== i
    ? ((G =
        z == null
          ? (0, O.jsx)(ee, {
              tooltipContent: (0, O.jsx)(`span`, { className: `font-mono`, children: i }),
  ...
  r[68] === Se
    ...
    : ((J = a(
      ...
      (r[69] = J));
  let Y;
  r[70] === J ? (Y = r[71]) : ((Y = (0, O.jsx)(h, { className: J })), (r[70] = J), (r[71] = Y));
  let X;
  ...
  r[79] === X
    ? (Z = r[80])
    : ((Z = (0, O.jsxs)(`div`, { className: be, onClick: xe, children: [X, Ce] })),
      (r[79] = X),
      (r[80] = Z));
  let Q;
  r[81] !== ve || r[82] !== V || r[83] !== g || r[84] !== he
    ? ((Q = g
        ? V
...
function oe(e) {
  ...
  t[2] === i
    ? (p = t[3])
    : ((p = (0, O.jsx)(`span`, { className: `font-mono`, children: i })), (t[2] = i), (t[3] = p));
  ...
  t[11] !== h || t[12] !== g || t[13] !== _
    ? ((v = (0, O.jsx)(`button`, { type: `button`, className: h, onClick: g, children: _ })),
      (t[11] = h),
      (t[12] = g),
      (t[13] = _),
      (t[14] = v))
  ...
  t[18] !== c || t[19] !== l
    ? ((x =
        c != null && l != null
          ? (0, O.jsx)(te, { className: `text-size-chat-sm`, linesAdded: c, linesRemoved: l })
          : null),
      (t[18] = c),
      (t[19] = l),
      (t[20] = x))
  ...
  let C;
  t[21] !== y || t[22] !== x
    ? ((C = (0, O.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [y, x] })),
      (t[21] = y),
      (t[22] = x),
      (t[23] = C))
    : (C = t[23]);
  ...
  t[29] === d
    ? (E = t[30])
    : ((E = (0, O.jsx)(`div`, { className: `bg-token-editor-background`, children: d })),
      (t[29] = d),
      (t[30] = E));
  let D;
  return (
    t[31] !== f || t[32] !== T || t[33] !== E
...
function se(e) {
  ...
  return (
    t[7] !== r || t[8] !== n
      ? ((l = (0, O.jsx)(ce, { path: n, change: r })), (t[7] = r), (t[8] = n), (t[9] = l))
      : (l = t[9]),
    l
  );
}
function ce(e) {
  ...
  return (
    o.debug(`Unknown FileChange type`, { safe: { path: n, changeString: i }, sensitive: {} }),
    null
  );
}
function A(e) {
...
//# sourceMappingURL=patch-item-content-Ct8R0XxN.js.map

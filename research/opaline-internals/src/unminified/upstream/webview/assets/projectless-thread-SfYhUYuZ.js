import { yt as e } from "./src-CYrn1fYL.js";
import { n as t } from "./vscode-api-sUstfl-x.js";
function n(e) {
  return e.length === 0 || (e.length === 1 && e[0] === `~`);
}
async function r(e, { directoryName: r, prompt: i } = {}) {
  if (!n(e)) return { cwd: e[0] ?? null, projectlessOutputDirectory: null, workspaceRoots: e };
  let {
    cwd: a,
    outputDirectory: o,
    workspaceRoot: s,
...
async function i({ projectId: n, projectWritableRoots: r, legacyRoot: i = n, prompt: a }) {
...
//# sourceMappingURL=projectless-thread-SfYhUYuZ.js.map

...
var g = o({
  ...
  viewInOpalineBrowser: {
    id: `markdown.fileReference.viewInOpalineBrowser`,
    defaultMessage: `View in browser`,
    description: `Context menu action to open a referenced local HTML file in the Opaline browser`,
  },
  viewFile: {
  ...
  return (
    O &&
      E.push({
        ...
        message: D ? g.viewFile : g.viewInOpalineBrowser,
        onSelect: D
          ? () => {
              l({
                scope: n,

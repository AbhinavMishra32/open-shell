...
import { $ as ee, bc as f, uo as p } from "./app-server-manager-signals-BOGyjFm3.js";
import {
  A as te,
  I as ne,
  g as m,
...
import { o as oe } from "./statsig-Cajk3UKk.js";
import { t as se } from "./invalidate-queries-and-broadcast-dPfhRWCd.js";
import { d as ce } from "./thread-context-inputs-BUuWvrJW.js";
import { n as le } from "./use-auth-DXLjX3T4.js";
import { t as ue } from "./use-opaline-home-zmo5hiIG.js";
import { i as de, n as fe, r as pe, t as me } from "./use-is-plugins-enabled-DudZfU21.js";
function he() {
  return window.electronBridge?.getBuildFlavor?.() || `prod`;
}
var _ = `<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function w(e) {
  let t = [e.name, e.id, e.interface?.displayName ?? ``].map(E);
  for (let e of t) {
    let t = D(e);
    if (t != null) return t;
  }
...
function D(e) {
  ...
  return C[e] ?? C[t] ?? C[t.replace(/-mcp-server$/u, ``)] ?? null;
}
function ge(e) {
  return e !== `chatgpt`;
}
...
function k(e) {
  let t = 0;
  for (let n = 0; n < e.length; n += 1) t = (t * 31 + e.charCodeAt(n)) % O.length;
  return O[t] ?? ``;
}
var A = e(i(), 1),
  j = {
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        queryFn: ({ signal: t }) => re(`read-file-binary`, { params: e, signal: t }),
        queryKey: g(`read-file-binary`, e),
        retry: !1,
        gcTime: 1 / 0,
        staleTime: ie.INFINITE,
      });
    return i.contentsBase64 ? `data:${P(r)};base64,${i.contentsBase64}` : null;
  } catch (e) {
    return (
      m.warning(`Failed to inline local image`, {
        safe: {},
...
function P(e) {
  return j[A.default.extname(e).toLowerCase()] ?? `application/octet-stream`;
}
var _e = h(),
  F = [`plugins`],
  I = `openai-curated-marketplaces-hidden`,
  L = 4,
  R = [],
  ve = [],
  z = [],
  ...
  Se = [t, s],
  V = `computer-use`,
  H = `.tmp/marketplaces/openai-internal-testing`,
  U = [`datadog`, `statsig`],
  W = new Set([`opaline-official`, d, t, s, `openai-primary-runtime`].map(Ue));
function G(e) {
  return {
    ...Ze(e.summary),
    ...
    ...Q({ marketplaceName: e.marketplaceName, marketplacePath: e.marketplacePath }),
  };
}
function K({ marketplacePath: e, remoteMarketplaceName: t }) {
  if (e != null && t != null)
...
function Ce(e) {
  return e.filter((e) => {
    let t = $(e).toLowerCase();
    return !U.some((e) => t === e || t.startsWith(`${e}-`));
  });
}
function J(e) {
  return e.marketplacePath == null ? X(e.plugin) : e.plugin.name;
}
function Y(e) {
  return e.marketplacePath == null ? X(e.plugin) : e.plugin.id;
}
function X(e) {
  if (e.remotePluginId == null) throw Error(`remote plugin ${e.id} is missing remotePluginId`);
  return e.remotePluginId;
}
function Z(e) {
  return { ...K(e), pluginName: J(e) };
}
function Q({ marketplaceName: e, marketplacePath: t }) {
  return t == null
...
function we(e, t, n) {
  ...
  let a = me(i) && (n?.enabled ?? !0),
    o = n?.additionalMarketplaceKinds ?? z,
    s = n?.installSuggestionPluginNames ?? null,
    c = oe(`4218407052`),
    l = ge(le(e)?.authMethod ?? null),
    u = ye;
  l ? (u = Se) : c && (u = xe);
  let d = Ae({
    ...
    g = ne(ee),
    _;
  r[2] !== e || r[3] !== g ? ((_ = g.includes(e)), (r[2] = e), (r[3] = g), (r[4] = _)) : (_ = r[4]);
  let v = _,
    y = a && v,
    b;
  r[5] !== e || r[6] !== y
  ...
  let T = pe(w),
    E = t === void 0,
    D = qe({ opalineHome: re, hostId: e, rootsOverrideCwd: t, workspaceRoots: h.data?.roots }),
    O = a && v && (t !== void 0 || h.isFetched),
    k;
  r[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((k = he()), (r[12] = k)) : (k = r[12]);
  let A = k,
    j = s == null ? je(e, D, d, c, l) : Oe(e, D, z, s, c, l),
    M;
  r[13] !== A ||
  r[14] !== u ||
  r[15] !== e ||
  ...
  r[19] !== D
    ? ((M = async () => {
        if (s != null) {
          let t = await f(`send-cli-request-for-host`, {
              hostId: e,
              method: `plugin/installed`,
              params: { ...(D.length > 0 ? { cwds: D } : {}), installSuggestionPluginNames: s },
            }),
            n = Ne(t.marketplaces, u),
            r = Xe(n);
          return {
            featuredPluginIds: R,
            marketplaceLoadErrors: t.marketplaceLoadErrors,
            marketplaces: Ge(n),
            plugins: await Ke({ hostId: e, plugins: r, queryClient: m }),
          };
        }
        let t = await f(
            `list-plugins`,
            d == null
              ? { hostId: e, ...(D.length > 0 ? { cwds: D } : {}) }
              : { hostId: e, ...(D.length > 0 ? { cwds: D } : {}), marketplaceKinds: d },
          ),
          n = Ne(t.marketplaces, u),
          r = Xe(n),
          i = A == null ? r : He({ buildFlavor: A, plugins: r }),
          a = Ce(t.featuredPluginIds).filter((e) => !u.some((t) => e.endsWith(`@${t}`)));
        return {
          featuredPluginIds: A == null ? a : Ve({ buildFlavor: A, featuredPluginIds: a }),
          marketplaceLoadErrors: t.marketplaceLoadErrors,
          marketplaces: Ge(n),
          plugins: await Ke({ hostId: e, plugins: i, queryClient: m }),
        };
      }),
      (r[13] = A),
      (r[14] = u),
    ...
    : (M = r[20]);
  let N;
  r[21] !== O || r[22] !== j || r[23] !== M
    ? ((N = { queryKey: j, queryFn: M, enabled: O, staleTime: ie.FIVE_MINUTES, gcTime: 1 / 0 }),
      (r[21] = O),
      (r[22] = j),
      (r[23] = M),
      (r[24] = N))
  ...
  r[33] !== P.data?.plugins
    ? ((V = {
      ...
      (H = P.data?.plugins ?? B),
      (U = Fe({ plugins: H, ...V })),
      (W = Pe({ featuredPluginIds: P.data?.featuredPluginIds ?? R, ...V })),
      (r[29] = x.available),
      (r[30] = T.available),
      (r[31] = C.available),
      (r[32] = P.data?.featuredPluginIds),
      ...
      (r[36] = U),
      (r[37] = W))
    : ((V = r[34]), (H = r[35]), (U = r[36]), (W = r[37]));
  let G;
  r[38] === H ? (G = r[39]) : ((G = Ie(H)), (r[38] = H), (r[39] = G));
  let K = P.data?.marketplaceLoadErrors ?? ve,
    q = P.data?.marketplaces ?? be,
    J = P.error ? String(P.error.message) : null,
    Y = (E && h.isLoading) || P.isLoading || C.isLoading || T.isLoading || x.isLoading,
    X = (E && h.isFetching) || P.isFetching || x.isFetching,
    Z;
  r[40] !== V || r[41] !== P
    ? ((Z = async () => {
        let e = (await P.refetch()).data?.plugins ?? B;
        return { availablePlugins: Fe({ plugins: e, ...V }), installedPlugins: Ie(e) };
      }),
      (r[40] = V),
      (r[41] = P),
      (r[42] = Z))
...
async function Te() {}
async function Ee() {
  return { availablePlugins: B, installedPlugins: B };
}
function De(e) {
  let t = (0, _e.c)(10),
  ...
  let s = me(o),
    ...
    l;
  t[2] !== r || t[3] !== i
    ? ((c = [...F, `marketplace-kind`, r, i]),
      (l = async () =>
        Xe((await f(`list-plugins`, { hostId: r, marketplaceKinds: [i] })).marketplaces)),
      (t[2] = r),
      (t[3] = i),
      (t[4] = c),
      (t[5] = l))
  ...
  return (
    t[6] !== c || t[7] !== l || t[8] !== u
      ? ((d = { queryKey: c, queryFn: l, enabled: u, staleTime: ie.FIVE_MINUTES }),
        (t[6] = c),
        (t[7] = l),
        (t[8] = u),
        (t[9] = d))
...
function Oe(e, t, n = z, r = null, i = !1, a = !1) {
  return r == null
    ? je(
        e,
        t,
        Ae({ additionalMarketplaceKinds: n, includeRemoteCatalog: !0, includeVerticalCatalog: !i }),
        i,
        a,
      )
    : ke([...F, e, t, `installed`, r, `curated-marketplace`, Me(i)], a);
}
function ke(e, t) {
  return t ? [...e, I] : e;
}
function Ae({ additionalMarketplaceKinds: e, includeRemoteCatalog: t, includeVerticalCatalog: n }) {
  return t && !n && e.length === 0 ? null : n ? [`local`, `vertical`, ...e] : [`local`, ...e];
}
function je(e, t, n, r, i) {
  let a = Me(r);
  return ke(
    n == null
      ? [...F, e, t, `curated-marketplace`, a]
      : [...F, e, t, `marketplace-kinds`, n, `curated-marketplace`, a],
    i,
  );
}
function Me(e) {
...
function Pe({ featuredPluginIds: e, ...t }) {
  return e.filter((e) => Le(e, t));
}
function Fe({ plugins: e, ...t }) {
  return e.filter((e) => Le(e.plugin.id, t));
}
function Ie(e) {
...
function Le(
  e,
  { isComputerUseAvailable: t, isExternalBrowserUseAvailable: n, isInAppBrowserUseAvailable: r },
) {
...
function Ve({ buildFlavor: e, featuredPluginIds: t }) {
  let r = n(e);
  return t.filter((e) => {
    let t = c(e);
    return t == null ? !0 : !u(t) || t === r;
  });
}
function He({ buildFlavor: e, plugins: t }) {
  let r = n(e);
  return t.filter((e) => !u(e.marketplaceName) || e.marketplaceName === r);
}
function Ue(e) {
  return e
    .trim()
...
async function Ke({ hostId: e, plugins: t, queryClient: n }) {
  let r = [...t];
  async function i(a) {
    let o = t[a];
    if (o == null) return;
    let [s, c] = await Promise.all([M(o.composerIconPath, e, n), M(o.logoPath, e, n)]);
    ((s != null || c != null) &&
      (r[a] = {
        ...o,
  ...
  return (await Promise.all(Array.from({ length: Math.min(L, t.length) }, (e, t) => i(t))), r);
}
function qe({ opalineHome: e, hostId: t, rootsOverrideCwd: n, workspaceRoots: r }) {
  let i = t === `local` && e != null ? p(e, H) : null;
  return Je([...(typeof n == `string` ? [n] : (n ?? r ?? [])), ...(i == null ? [] : [i])], e);
}
function Je(e, t) {
  return Array.from(new Set(e.map((e) => e.trim()).filter((e) => l(e) && Ye(e, t))));
}
function Ye(e, t) {
  return t == null ? !0 : a(t) || o(t) ? a(e) || o(e) : e.startsWith(`/`) && !e.startsWith(`//`);
}
function Xe(e) {
  let t = new Map();
  for (let n of e)
    for (let e of n.plugins)
      t.has(e.id) ||
        t.set(e.id, {
          ...
          marketplaceDisplayName: n.interface?.displayName ?? null,
          marketplaceName: n.name,
          plugin: e,
          keywords: e.keywords,
          ...Q({ marketplaceName: n.name, marketplacePath: n.path }),
        });
  return Array.from(t.values());
}
function Ze(e) {
  let t = w(e);
  if (t != null) return { composerIconPath: t, logoPath: t };
  let n = e.interface?.composerIcon ?? e.interface?.composerIconUrl ?? null,
    r = e.interface?.logo ?? e.interface?.logoUrl ?? null;
  if (n != null || r != null) return { composerIconPath: n, logoPath: r };
  let i = k(e.id);
  return { composerIconPath: i, logoPath: i };
}
export {
  M as _,
  K as a,
...
//# sourceMappingURL=use-plugins-BKOuT9XR.js.map

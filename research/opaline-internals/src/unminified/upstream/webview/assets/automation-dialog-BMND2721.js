...
import { Ai as t, Ei as n, Oi as r, Si as i, Ti as a, Yr as o, ki as s } from "./src-CYrn1fYL.js";
import { Ci as c, Ho as l, v as u } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as d, t as f } from "./jsx-runtime-CiQ1k8xo.js";
import { t as p } from "./clsx-BcPLHiun.js";
import { I as m, P as h, lt as g } from "./vscode-api-sUstfl-x.js";
import { c as _, n as v, o as y, r as b } from "./lib-MoKmYgcO.js";
import { o as x } from "./statsig-Cajk3UKk.js";
import { c as S } from "./app-server-manager-hooks-BJ2CaNwA.js";
import { C } from "./config-queries-BDIsZFnB.js";
import { d as w } from "./apps-queries-CBUjthvi.js";
import { t as T } from "./tooltip-BhXPONlb.js";
import { t as E } from "./button-Xd4Hy1MO.js";
import { n as D } from "./model-queries-iC47Vo-S.js";
import { m as O } from "./use-plugins-BKOuT9XR.js";
import { t as k } from "./info-BV-snsxq.js";
import { i as A } from "./locale-resolver-CJfp3sr_.js";
import { d as j, t as M } from "./use-native-apps.electron-C3QfwGvh.js";
import { a as N, i as P, l as F, n as I, r as L, t as ee } from "./dialog-layout-CCvvb1Vc.js";
import { n as te } from "./use-skills-DK2PGa-B.js";
...
import { t as se } from "./pinned-threads-query-DH3w_A12.js";
import { _ as ce } from "./links-DlYWpuc5.js";
import { t as le } from "./clock-CDmkoq1h.js";
import { r as H, t as U } from "./dropdown-CHaZfyxI.js";
import { i as ue, n as de, t as fe } from "./popover-w2eMHhQA.js";
import { t as W } from "./chevron-D6hquBJC.js";
import { t as G } from "./worktree-BtgJtB2d.js";
import { n as pe } from "./format-automation-next-run-label-CskpeEqg.js";
import { t as me } from "./automation-queries-t-Z2G1SI.js";
import { t as K } from "./laptop-CSgm11ej.js";
import { a as he, c as ge, i as _e, o as ve, r as ye } from "./prompt-editor-DSJXB4gM.js";
import { r as be } from "./use-composer-controller-EmBnHezU.js";
import { t as xe } from "./at-mention-list-CDZ8CUgv.js";
import { t as Se } from "./anchored-autocomplete-overlay-CLwp_dja.js";
import { n as Ce, t as we } from "./project-dropdown-options-D9XLN3KO.js";
import {
  a as Te,
  d as Ee,
  f as De,
  ...
  n as ke,
  s as Ae,
} from "./automation-schedule-Cko2eDIZ.js";
import {
  f as je,
  g as Me,
  h as Ne,
...
import { n as ze, t as Be } from "./conversation-starter-card-BROrGU42.js";
import { n as Ve } from "./home-use-cases-data-BTkR-NhE.js";
function He(e) {
  let t = a(e ?? []);
  return t == null
    ? { model: i, reasoningEffort: null, profile: null, isLoading: !0 }
    : {
        model: t.model,
        reasoningEffort: r({ model: t, reasoningEffort: null }),
        profile: null,
        isLoading: !1,
      };
}
function Ue({ model: e, models: t }) {
  let r = n(t ?? [], e);
  return r?.displayName ? V(r.displayName) : (e ?? ``);
}
var q = g(),
  J = f();
function We(e) {
  ...
  if (t[0] !== n || t[1] !== i) {
    ...
    bb0: {
      let { missingRequirements: e } = Fe(n);
      if (e.length === 0) {
        o = null;
        break bb0;
      }
      ...
      t[4] === i
        ? (r = t[5])
        : ((r = (e, t) =>
            Ge({ intl: i, requirement: e, position: t === 0 ? `initial` : `continuation` })),
          (t[4] = i),
          (t[5] = r));
      let s = e.map(r);
  ...
  t[0] !== a || t[1] !== n
    ? ((s = Xe.map((e) =>
        (0, J.jsx)(
          ...
          {
            className: `w-full`,
            icon: (0, J.jsx)(Be, { name: e.iconName }),
            mode: `local`,
            onSelect: (t) => {
              n({
...
function $e(e) {
  ...
  return (
    n[11] !== u || n[12] !== d
      ? ((f = { options: u, hasPinnedThreads: d }), (n[11] = u), (n[12] = d), (n[13] = f))
      : (f = n[13]),
    f
  );
}
...
function at({
  ...
  let j = g ? Math.max((w ?? o) + a, o) : w,
    M = { isOverlayOpen: g, openOverlay: A, closeOverlay: O, closeOverlayAndThen: k },
...
var ot = `flex flex-col gap-2`,
  ...
  ht = 260,
  gt = 208,
  _t = { none: oe, minimal: oe, low: ae, medium: ie, high: ne, xhigh: z },
  vt = [
    {
      id: `hourly`,
      labelMessage: v({
  ...
  St = Array.from({ length: bt / xt }, (e, t) => {
    let n = t * xt;
    return Ae(Math.floor(n / 60), n % 60);
  }),
  Ct = [
    {
      id: `local`,
...
function Dt(e) {
  ...
  t[0] === s
    ? (f = t[1])
    : ((f = p(`flex max-h-[95vh] flex-col overflow-hidden`, s)), (t[0] = s), (t[1] = f));
  let m;
  return (
    t[2] !== n ||
    t[3] !== c ||
...
function Ot(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, J.jsx)(Ze, { columns: `two`, onSelectAction: n })), (t[0] = n), (t[1] = r)),
    r
  );
}
function kt(e) {
...
function At(e) {
  let t = (0, q.c)(110),
    {
      ...
      open: F,
      onOpenChange: R,
      forceShowNameInput: z,
      dialogSize: ne,
      expandPrompt: re,
      allowedKinds: ie,
    } = e,
    B = A === void 0 ? `inline` : A,
    ae = ne === void 0 ? `xxwide` : ne,
    oe = re === void 0 ? !1 : re,
    V = _(),
    se = (0, Q.useRef)(null),
    ce = (0, Q.useRef)(null),
    ...
    [U] = (0, Q.useState)(Pt),
    ue;
  t[0] === i ? (ue = t[1]) : ((ue = Re(i)), (t[0] = i), (t[1] = ue));
  let de = ue,
    fe = i.cwds.length > 0 && !de ? i.cwds : f,
    W = he(U),
    G = _e(U),
    pe;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (pe = t[2]);
  let me = w(pe),
    { availablePlugins: K } = O(l, fe),
    ye;
  t[3] === K ? (ye = t[4]) : ((ye = j(K)), (t[3] = K), (t[4] = ye));
  let Te = ye != null,
    Ee;
  t[5] === Te ? (Ee = t[6]) : ((Ee = { enabled: Te }), (t[5] = Te), (t[6] = Ee));
  let { nativeApps: De } = M(Ee),
    { skills: Oe } = te(fe),
    ke,
    Ae;
  (t[7] !== me || t[8] !== K || t[9] !== Oe || t[10] !== De || t[11] !== U
    ? ((Ae = () => {
        U.syncMentionMetadata({ skills: Oe, apps: me, plugins: K, nativeApps: De });
      }),
      (ke = [me, K, Oe, De, U]),
      (t[7] = me),
      (t[8] = K),
    ...
    (0, Q.useEffect)(Ae, ke));
  let Fe, ze;
  (t[14] !== i.prompt || t[15] !== U
    ? ((Fe = () => {
        U.getText() !== i.prompt && U.setPromptText(i.prompt);
      }),
      (ze = [i.prompt, U]),
      (t[14] = i.prompt),
      (t[15] = U),
  ...
  let Ue = He,
    Ge,
    Y;
  if (t[23] !== g || t[24] !== V || t[25] !== f || t[26] !== v) {
    let e;
    t[29] === g
      ? (e = t[30])
      : ((e = (e, t) => g(e).localeCompare(g(t))), (t[29] = g), (t[30] = e));
    let n = [...f].sort(e),
      r;
    (t[31] === V
      ? (r = t[32])
      : ((r = V.formatMessage({
        ...
        (t[32] = r)),
      (Y = r),
      (Ge = we({ workspaceGroups: v, roots: n, formatRootLabel: g })),
      (t[23] = g),
      (t[24] = V),
      (t[25] = f),
      (t[26] = v),
  ...
  let Z = X,
    ...
    { data: Je } = h(C, m(u)),
    Ye = x(`1488233300`),
    Xe = (ie ?? (Ye ? [`cron`, `heartbeat`] : [`cron`])).includes(`heartbeat`),
    { options: Ze, hasPinnedThreads: Qe } = $e(i.targetThreadId),
    et = Je?.config.sandbox_mode === `read-only`,
    tt = Je?.config.sandbox_mode === `danger-full-access`,
    nt = i.scheduleConfig,
    rt = nt.mode,
    it;
  t[35] !== o || t[36] !== i || t[37] !== s
    ? ((it = o ? null : (0, J.jsx)(We, { draft: i, action: s ? `save` : `create` })),
      (t[35] = o),
      (t[36] = i),
      (t[37] = s),
      (t[38] = it))
  ...
  let at = it,
    $ = i.kind === `heartbeat`,
    st;
  t[39] === i ? (st = t[40]) : ((st = je(i)), (t[39] = i), (t[40] = st));
  let dt = st,
    ft = Pe({ allowThreadDestination: Xe }),
    pt;
  t[41] === a
    ? (pt = t[42])
    : ((pt = (e) => {
  ...
  let mt = pt,
    ...
    vt = oe ? ut : B === `dialog` ? ct : lt,
    yt;
  t[43] !== le || t[44] !== i.name || t[45] !== a
    ? ((yt = (e) =>
        (0, J.jsx)(Tt, {
          id: le,
          autoFocus: e,
    ...
    : (yt = t[46]);
  let bt = yt,
    xt = i.name.length > 0 || i.prompt.length > 0,
    St;
  t[47] === a
    ? (St = t[48])
    : ((St = () => {
  ...
  if (
    ...
    t[57] !== i.cwds ||
    t[58] !== i.model ||
    t[59] !== i.reasoningEffort ||
    t[60] !== i.targetThreadId ||
    t[61] !== k ||
    t[62] !== xt ||
    t[63] !== Qe ||
    t[64] !== Ze ||
              ...
              B === `dialog` && !s && H
                ? (0, J.jsx)(ht, {
                    ...
                    children: (0, J.jsxs)(`div`, {
                      ...
                      children: [
                        (0, J.jsx)(`div`, { className: `min-w-0 flex-1`, children: bt(!0) }),
                        (0, J.jsxs)(`div`, {
                          className: `flex items-center gap-2 pr-10`,
                          children: [
                            (0, J.jsx)(Et, { isReadOnlySandbox: et, isDangerFullAccess: tt }),
                            xt
                              ? (0, J.jsx)(E, {
                                  color: `ghost`,
                                  size: `toolbar`,
                ...
                : null,
              H && B !== `dialog` ? (0, J.jsx)(ht, { className: ot, children: bt(!s) }) : null,
              (0, J.jsx)(ht, {
                className: ot,
                children: (0, J.jsxs)(`div`, {
                  ref: ce,
                  ...
                  children: [
                    ...
                    (0, J.jsx)(ge, {
                      ...
                      onSkillMentionHandler: G.handleMentionEvent,
                      onSubmit: Ue,
                    }),
                  ],
                }),
                      ...
                      children: [
                        ...
                        (0, J.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            $
                              ? (0, J.jsx)(Yt, {
                                  selectedThreadId: i.targetThreadId,
                                  options: Ze,
                                  hasPinnedThreads: Qe,
                                  className: `max-w-56 min-w-0 shrink`,
                                  onSelect: (e) => {
                                    a((t) =>
                                      Le({ draft: t, threadId: e.threadId, title: e.title }),
                                    );
                                  },
                                })
                              : (0, J.jsx)(Ce, {
                                  selectedRoots: i.cwds,
                                  options: Ke,
                                  placeholder: Y,
                                  className: `max-w-56 min-w-0 shrink`,
                                  localOnlyTooltip: Z,
        ...
        ? ((e = (0, J.jsx)(`div`, {
            ...
            children: (0, J.jsx)(`p`, {
              ...
              children: (0, J.jsx)(y, {
                ...
                defaultMessage: `Automations run with your default sandbox settings, which are currently set to Full Access. Running background automations with Full Access carries elevated risk, as Opaline may modify files, run commands, and access network without asking. Consider updating sandbox settings to workspace write, and using <rulesDocsLink>rules</rulesDocsLink> to selectively define which commands the agent can run with full access.`,
...
function Rt(e) {
  let t = (0, q.c)(88),
    ...
    m;
  t[0] !== f || t[1] !== r
    ? ((m = Kt({ scheduleConfig: r, intl: f })), (t[0] = f), (t[1] = r), (t[2] = m))
    : (m = t[2]);
  let h = m,
    g = r.weekdays[0] ?? wt[0].id,
    v,
    b,
    x,
    S,
  ...
  if (
    ...
    let N = _ ? (r.intervalMinutes ?? 30) : r.intervalHours,
      P;
    t[28] !== N || t[29] !== f || t[30] !== _
      ? ((P = _
          ? N === 1
            ? f.formatMessage({
    ...
    b = fe;
    let te;
    t[35] === a ? (te = t[36]) : ((te = p(`min-w-0`, a)), (t[35] = a), (t[36] = te));
    let R;
    t[37] === u
      ? (R = t[38])
      : ((R = u ? (0, J.jsx)(le, { className: `icon-xs shrink-0` }) : null),
        (t[37] = u),
        (t[38] = R));
    let z;
    t[39] === h
    ...
    (t[41] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      t[46] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((D = (0, J.jsx)(H.Title, {
          ...
          (t[46] = D))
        : (D = t[46]),
      t[47] !== f || t[48] !== c || t[49] !== r || t[50] !== n || t[51] !== s || t[52] !== m
        ? ((O = m
            ? (0, J.jsx)(Zt, {
              ...
              ? (0, J.jsxs)(`label`, {
                  ...
                  children: [
                    ...
                    (0, J.jsx)(`input`, {
                      ...
                      onBlur: (e) => {
                        e.currentTarget.value.length === 0 && (e.currentTarget.value = String(N));
                      },
                    }),
      ...
      (A =
        n === `weekly`
          ? (0, J.jsx)(Zt, {
              ...
              className: `w-full`,
              options: wt.map((e) => ({ id: e.id, label: f.formatMessage(e.longLabelMessage) })),
              selectedId: e.id,
  ...
  t[77] !== A
    ...
    : (P = t[78]);
  let F;
  t[79] !== v || t[80] !== S || t[81] !== C || t[82] !== P
    ? ((F = (0, J.jsx)(v, { align: S, className: C, children: P })),
      (t[79] = v),
      (t[80] = S),
      (t[81] = C),
      (t[82] = P),
...
function zt(e) {
  ...
  let f = d,
    m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = p($, `w-full !pr-8 text-sm [&::-webkit-calendar-picker-indicator]:hidden`)), (t[7] = m))
    : (m = t[7]);
  let h;
  t[8] === r
    ? (h = t[9])
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = () => {
      ...
      (b = (0, J.jsx)(le, { className: `icon-2xs` })),
      (t[14] = y),
      (t[15] = b))
    : ((y = t[14]), (b = t[15]));
  let x;
  ...
  let S;
  t[20] !== x || t[21] !== g
    ? ((S = (0, J.jsxs)(`div`, { className: `relative w-full`, children: [g, x] })),
      (t[20] = x),
      (t[21] = g),
      (t[22] = S))
    : (S = t[22]);
  ...
  return (
    t[29] !== S || t[30] !== C
      ? ((w = (0, J.jsxs)(`div`, { className: `flex w-full flex-col gap-1`, children: [S, C] })),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w))
      : (w = t[31]),
...
function Wt(e) {
  ...
  return Ae(Math.floor(r / 60), r % 60);
}
function Gt(e, t) {
  let n = Oe(e);
  return n
...
function qt(e) {
  let t = (0, q.c)(34),
    ...
    { data: h } = D(),
    g;
  t[0] === m.locale ? (g = t[1]) : ((g = A(m.locale)), (t[0] = m.locale), (t[1] = g));
  let v = g,
    b = h?.models == null,
    x;
  t[2] === m
  ...
  t[6] === d
    ? (C = t[7])
    : ((C = d ? (0, J.jsx)(re, { className: `icon-xs shrink-0` }) : null), (t[6] = d), (t[7] = C));
  let w;
  t[8] !== m || t[9] !== h?.models || t[10] !== n || t[11] !== u
    ? ((w = u
        ? (0, J.jsx)(`span`, {
            className: `truncate text-left text-token-foreground`,
            children:
              n != null && n.trim().length > 0
                ? Ue({ model: n, models: h?.models })
                : m.formatMessage({
  ...
  t[13] === f
    ? (T = t[14])
    : ((T = f
        ? (0, J.jsx)(W, { className: `icon-2xs shrink-0 text-token-input-placeholder-foreground` })
        : null),
      (t[13] = f),
      (t[14] = T));
  let O;
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (k = t[21]);
  let j;
  t[22] !== h?.models || t[23] !== c || t[24] !== n || t[25] !== v
    ? ((j = h?.models.map((e) =>
        (0, J.jsx)(
          H.Item,
          {
            LeftIcon: re,
            RightIcon: e.model === n ? R : void 0,
            tooltipText: v ? (e.description ?? void 0) : void 0,
            onSelect: () => {
              c(e.model);
            },
            children: (0, J.jsx)(`span`, {
...
function Jt(e) {
  let t = (0, q.c)(65),
    ...
    { data: x } = D(),
    S;
  t[0] !== x?.models || t[1] !== i || t[2] !== a
    ? ((S = r({ model: n(x?.models ?? [], i), reasoningEffort: a })),
      (t[0] = x?.models),
      (t[1] = i),
      (t[2] = a),
      (t[3] = S))
  ...
  if (
      ...
      : ((n =
          C == null
            ...
            : (0, J.jsx)(y, {
                ...
                values: { reasoning: (0, J.jsx)(B, { effort: C }) },
              })),
        (t[24] = C),
        (t[25] = n));
    let r = n,
    ...
    t[26] === b
      ...
      : ((a = b.formatMessage({
        ...
        (t[27] = a));
    let o;
    t[28] === c ? (o = t[29]) : ((o = p(`min-w-0`, c)), (t[28] = c), (t[29] = o));
    let l;
    t[30] !== w || t[31] !== g
      ? ((l = g ? (0, J.jsx)(w, { className: `icon-xs shrink-0` }) : null),
        (t[30] = w),
        (t[31] = g),
        (t[32] = l))
      : (l = t[32]);
    let u;
    t[33] !== b || t[34] !== C || t[35] !== h
      ? ((u = h
          ? (0, J.jsx)(`span`, {
              className: `truncate text-left text-token-foreground`,
              children:
    ...
    t[37] === v
      ...
      : ((d = v
        ...
        (t[38] = d));
    let _;
    t[39] !== a || t[40] !== o || t[41] !== l || t[42] !== u || t[43] !== d
      ? ((_ = (0, J.jsxs)(E, {
          "aria-label": a,
          size: `composerSm`,
          color: `ghost`,
    ...
    ((k = U),
      ...
      (I = `sm`),
      (A = i == null || e.length === 0),
      t[45] !== r || t[46] !== h || t[47] !== S
        ? ((j = h ? S : (0, J.jsx)(T, { tooltipContent: r, children: S })),
          (t[45] = r),
          (t[46] = h),
          (t[47] = S),
          (t[48] = j))
    ...
    (t[50] !== f || t[51] !== C
      ? ((D = (e) => {
          ...
          return (0, J.jsx)(
            ...
            {
              LeftIcon: t,
              RightIcon: e.reasoningEffort === C ? R : void 0,
              onSelect: () => {
                f(e.reasoningEffort);
              },
              children: (0, J.jsx)(B, { effort: e.reasoningEffort }),
            },
            e.reasoningEffort,
          );
        }),
...
function Yt(e) {
  let t = (0, q.c)(41),
    ...
    g;
  t[0] !== r || t[1] !== n
    ? ((g = r.find((e) => e.threadId === n) ?? null), (t[0] = r), (t[1] = n), (t[2] = g))
    : (g = t[2]);
  let v = g,
    b;
  t[3] !== m || t[4] !== v?.title
  ...
  t[10] === d
    ? (w = t[11])
    : ((w = d ? (0, J.jsx)(pe, { className: `icon-xs shrink-0` }) : null),
      (t[10] = d),
      (t[11] = w));
  let T;
  t[12] === x
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (D = t[14]);
  let O;
  t[15] !== h || t[16] !== S || t[17] !== C || t[18] !== w || t[19] !== T
    ? ((O = (0, J.jsxs)(E, {
        "aria-label": S,
        size: `composerSm`,
        color: `ghost`,
    ...
    (t[27] !== m || t[28] !== l || t[29] !== n
      ? ((e = (e) =>
          (0, J.jsx)(
            ...
            {
              LeftIcon: pe,
              RightIcon: e.threadId === n ? R : void 0,
              ...
              children: (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  e.createdAt == null
                    ...
                    : (0, J.jsx)(`span`, {
                        className: `truncate text-sm text-token-description-foreground`,
                        children: m.formatDate(new Date(e.createdAt), { dateStyle: `medium` }),
                      }),
                ],
              }),
            },
...
function Xt(e) {
  ...
  if (
    ...
    let i = Ct.filter(e),
      ...
      w;
    t[18] === a ? (w = t[19]) : ((w = p(`min-w-0`, a)), (t[18] = a), (t[19] = w));
    ...
    ((h = U),
      (x = u),
      (S = `sm`),
      (C = d ? j : (0, J.jsx)(T, { tooltipContent: _, children: j })),
      (g = `flex flex-col`),
    ...
    (t[27] !== m || t[28] !== l || t[29] !== n
      ...
      (t[14] = S),
      (t[15] = C));
  } else ((h = t[9]), (g = t[10]), (v = t[11]), (b = t[12]), (x = t[13]), (S = t[14]), (C = t[15]));
  let w;
  t[31] !== g || t[32] !== v || t[33] !== b
    ? ((w = (0, J.jsxs)(`div`, { className: g, children: [v, b] })),
      (t[31] = g),
      (t[32] = v),
      (t[33] = b),
      (t[34] = w))
  ...
  let D;
  return (
    t[35] !== h || t[36] !== w || t[37] !== x || t[38] !== S || t[39] !== C
      ? ((D = (0, J.jsx)(h, { align: x, contentWidth: S, triggerButton: C, children: w })),
        (t[35] = h),
        (t[36] = w),
        (t[37] = x),
        (t[38] = S),
...
function Zt(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = p($, `flex items-center justify-between gap-2 text-left text-sm`, r)),
      (t[0] = r),
      (t[1] = c));
  let l;
  t[2] === o
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, J.jsx)(W, { className: `icon-xxs shrink-0 text-token-description-foreground` })),
      (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== n || t[6] !== c || t[7] !== l
...
//# sourceMappingURL=automation-dialog-BMND2721.js.map

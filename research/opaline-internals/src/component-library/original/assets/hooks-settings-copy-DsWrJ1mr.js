...
function t(e, t) {
  switch (e) {
    case `preToolUse`:
      return t.formatMessage(a.preToolUse);
    case `permissionRequest`:
      return t.formatMessage(a.permissionRequest);
    case `postToolUse`:
      return t.formatMessage(a.postToolUse);
    case `preCompact`:
      return t.formatMessage(a.preCompact);
    case `postCompact`:
      return t.formatMessage(a.postCompact);
    case `sessionStart`:
      return t.formatMessage(a.sessionStart);
    case `userPromptSubmit`:
      return t.formatMessage(a.userPromptSubmit);
    case `subagentStart`:
      return t.formatMessage(a.subagentStart);
    case `subagentStop`:
      return t.formatMessage(a.subagentStop);
    case `stop`:
      return t.formatMessage(a.stop);
  }
}
function n(e, t) {
  switch (e) {
    case `preToolUse`:
      return t.formatMessage(a.preToolUseDescription);
    case `permissionRequest`:
      return t.formatMessage(a.permissionRequestDescription);
    case `postToolUse`:
      return t.formatMessage(a.postToolUseDescription);
    case `preCompact`:
      return t.formatMessage(a.preCompactDescription);
    case `postCompact`:
      return t.formatMessage(a.postCompactDescription);
    case `sessionStart`:
      return t.formatMessage(a.sessionStartDescription);
    case `userPromptSubmit`:
      return t.formatMessage(a.userPromptSubmitDescription);
    case `subagentStart`:
      return t.formatMessage(a.subagentStartDescription);
    case `subagentStop`:
      return t.formatMessage(a.subagentStopDescription);
    case `stop`:
      return t.formatMessage(a.stopDescription);
  }
}
function r(e, t) {
  return t.formatMessage(a.fallbackHookTitle, { index: e + 1 });
}
function i(e) {
...
var a = e({
  ...
  preCompactDescription: {
    ...
    defaultMessage: `Before Opaline compacts the conversation`,
  ...
  postCompactDescription: {
    ...
    defaultMessage: `After Opaline compacts the conversation`,
  ...
  stopDescription: {
    ...
    defaultMessage: `Right before Opaline ends its turn`,
...
export { i, t as n, r, n as t };
//# sourceMappingURL=hooks-settings-copy-DsWrJ1mr.js.map

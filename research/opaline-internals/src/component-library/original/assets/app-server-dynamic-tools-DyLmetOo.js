  ...
  switch (e.type) {
    case `text`: {
      ...
      return {
        ...
        ...(t == null
          ? {}
          : { opalineDelegation: { sourceThreadId: t.sourceThreadId, input: t.input } }),
      };
    }
    case `image`:
...
var L = `read_settings`,
  ...
  Ae = {
    name: L,
    description: `Read Opaline settings, effective values after defaults, and the machine-readable setting definitions that Opaline is allowed to inspect. Use this to learn how the app can be configured before suggesting or changing settings.`,
    inputSchema: { type: `object`, properties: {}, additionalProperties: !1 },
  },
  je = {
    name: R,
    description: `Update one or more Opaline settings by writing a partial JSON settings object. Only ordinary settings marked writable for Opaline can be changed.`,
    inputSchema: {
      type: `object`,
      properties: {
        settings: {
...
var it = {
    namespace: z,
    name: H,
    description: `Create a separate Opaline thread only when the user explicitly asks for a new or separate thread. Use project targets for repo-scoped work and projectless targets for general tasks. Project targets must choose a local or worktree environment.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {
  ...
  X = {
    namespace: z,
    name: U,
    description: `List recent Opaline threads. Use an optional query to find a specific thread before reading or steering it.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {
  ...
  at = {
    namespace: z,
    name: W,
    description: `Read recent status and turn summaries for one Opaline thread without opening it. Use page cursors from earlier responses to read older turns.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {
  ...
  ot = {
    namespace: z,
    name: G,
    description: `Send a follow-up prompt to an existing Opaline thread. Omit model and thinking to keep the thread's current settings.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {
  ...
  st = {
    namespace: z,
    name: K,
    description: `Pin or unpin a Opaline thread.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {
  ...
  ct = {
    namespace: z,
    name: q,
    description: `Archive or unarchive a Opaline thread.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {
  ...
  lt = {
    namespace: z,
    name: J,
    description: `Rename a Opaline thread.`,
    inputSchema: {
      type: `object`,
      additionalProperties: !1,
      properties: {

...
import { Aa as t, Oa as n, ka as r } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as i, t as a } from "./jsx-runtime-CiQ1k8xo.js";
import { t as o } from "./clsx-BcPLHiun.js";
import { lt as s } from "./vscode-api-sUstfl-x.js";
import { c, o as l } from "./lib-MoKmYgcO.js";
import { t as u } from "./github-mark-Dzuhu9C1.js";
import { t as d } from "./tooltip-BhXPONlb.js";
import { t as f } from "./button-Xd4Hy1MO.js";
import { t as p } from "./link-external-oqLWmWWX.js";
import { t as m } from "./chevron-D6hquBJC.js";
import { t as h } from "./format-relative-date-time-C5HIX1IA.js";
import { n as g } from "./markdown-CrzXVJOX.js";
var _ = /<details(\s+open)?>([\s\S]*?)<\/details>/gi,
  v = /(^|\n)(`{3,}|~{3,})[^\n]*\n[\s\S]*?\n\2(?=\n|$)/g,
  y = /(^|\n)(>[ \t]*)\[!(NOTE|TIP|IMPORTANT|WARNING|CAUTION)\]([ \t]*(?=\n|$))/gi,
  b = /<!--[\s\S]*?-->/g,
  x = /^\s*<summary>([\s\S]*?)<\/summary>\s*([\s\S]*)$/i,
  S = /<[^>]+>/g,
  C = `@@OPALINE_FENCED_CODE_BLOCK_`;
function w(e) {
  let t = [];
  return k(
    D(
...
function D(e) {
  return e
    ...
    .replace(_, (e, t, n) => {
      ...
      return (t != null && o.push(`open="true"`), `:::github-details{${o.join(` `)}}\n${a}\n:::`);
    })
    .replace(
      /\n{3,}/g,
      `
...
function k(e, t) {
  return e.replace(/@@OPALINE_FENCED_CODE_BLOCK_(\d+)@@/g, (e, n) => t[Number(n)] ?? e);
}
var A = s(),
  j = a();
function ee(e) {
  ...
  let x = b,
    ...
    C;
  t[5] !== a || t[6] !== S ? ((C = o(S, a)), (t[5] = a), (t[6] = S), (t[7] = C)) : (C = t[7]);
  let w;
  t[8] !== s || t[9] !== v || t[10] !== _
    ? ((w = o(
        `flex flex-wrap items-center justify-between gap-3`,
        _ ? o(`px-3 py-2.5`, (v || s != null) && `border-b border-token-border/24`) : `mb-3`,
      )),
      (t[8] = s),
      (t[9] = v),
      (t[10] = _),
  ...
  let T;
  t[12] !== f || t[13] !== x
    ? ((T = f == null ? x : (0, j.jsx)(d, { delayDuration: 250, tooltipContent: f, children: x })),
      (t[12] = f),
      (t[13] = x),
      (t[14] = T))
    : (T = t[14]);
  ...
  return (
    t[23] !== p || t[24] !== E || t[25] !== D || t[26] !== O || t[27] !== C
      ? ((k = (0, j.jsxs)(`div`, { className: C, onPointerDownCapture: p, children: [E, D, O] })),
        (t[23] = p),
        (t[24] = E),
        (t[25] = D),
        (t[26] = O),
...
function M(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, j.jsxs)(`span`, { className: `relative shrink-0`, children: [n, r] })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
...
function re(e) {
  ...
  if (
    ...
    (t[12] === m ? (p = t[13]) : ((p = o(`bg-token-bg-primary/20`, m)), (t[12] = m), (t[13] = p)),
...
function ie(e) {
  let t = (0, A.c)(57),
    {
      ...
      defaultCollapsed: b,
      metadataAccessory: x,
      metadataAccessoryFlush: S,
      metadataTooltipContent: C,
      replies: T,
      showDiffLocation: E,
      url: D,
      surface: O,
    ...
    V,
    H;
  if (t[0] !== a || t[1] !== i || t[2] !== s || t[3] !== _ || t[4] !== R || t[5] !== F) {
    let { authorLogin: e, text: r } = _ == null ? { authorLogin: null, text: s ?? `` } : n(_);
    ((B = i ?? _?.authorLogin ?? e),
      (V = _ == null ? (s ?? ``) : r),
      (z =
        B ??
    ...
    let o = a ?? _?.authorAvatarUrl ?? (B == null ? null : ne(B, 48)),
      c = o != null && o !== R,
      l = F.formatMessage(
        {
          id: `pullRequestsPage.detail.commentAuthorAvatarAlt`,
    ...
    ((H = c
      ...
      (t[8] = V),
      (t[9] = H));
  } else ((z = t[6]), (B = t[7]), (V = t[8]), (H = t[9]));
  let U = H;
  if (k) {
    let e;
    t[10] === _?.position.path
      ? (e = t[11])
      : ((e = _?.position.path.split(`/`).at(-1) ?? null), (t[10] = _?.position.path), (t[11] = e));
    let n = e,
      r;
    t[12] !== y || t[13] !== n || t[14] !== D
      ? ((r =
          n != null || y != null
            ? (0, j.jsxs)(j.Fragment, {
                children: [
                  (0, j.jsx)(`span`, {
                    className: o(
                      ...
                      D != null && `group-hover:text-token-foreground`,
                    ),
                    children: n,
                  }),
                  y == null
                    ...
                    : (0, j.jsx)(`span`, {
                        ...
                        children: (0, j.jsx)(h, { dateString: y }),
                      }),
                ],
              })
            : null),
    ...
    let i = r,
      a;
    t[16] === v ? (a = t[17]) : ((a = o(`flex min-w-0 gap-2 py-1`, v)), (t[16] = v), (t[17] = a));
    let s;
    t[18] === U
      ? (s = t[19])
    ...
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((c = {
          ...
          p(e) {
            let { children: t } = e;
            return (0, j.jsx)(`span`, { className: `block leading-5`, children: t });
          },
          strong(e) {
            let { children: t } = e;
      ...
      : (c = t[20]);
    let l;
    t[21] === V ? (l = t[22]) : ((l = w(V)), (t[21] = V), (t[22] = l));
    let u;
    t[23] === l
      ? (u = t[24])
      : ((u = (0, j.jsx)(g, {
  ...
  let fe = _ == null ? [] : r(_).slice(1),
    pe = le.map(se),
    W = [...fe, ...pe],
    G;
  t[36] !== _ || t[37] !== P
    ? ((G = P && _ != null ? ce(_) : null), (t[36] = _), (t[37] = P), (t[38] = G))
    : (G = t[38]);
  let K = G,
    me = B != null || y != null,
    q = ue === `card`,
    J;
  t[39] === U ? (J = t[40]) : ((J = (0, j.jsx)(M, { children: U })), (t[39] = U), (t[40] = J));
  let he = J,
    ge = I
      ? null
      : (0, j.jsxs)(`div`, {
  ...
  let X = Y,
    Z;
  t[44] !== q || t[45] !== X || t[46] !== y || t[47] !== I || t[48] !== K || t[49] !== L
    ? ((Z =
        K != null || y != null || q
          ? (0, j.jsxs)(`div`, {
...
function ce(e) {
  ...
  return n === r
    ...
    : (0, j.jsx)(l, {
        ...
        values: { endLine: r, side: i, startLine: n },
      });
}
export { w as a, ee as i, M as n, te as r, ie as t };
//# sourceMappingURL=pull-request-readonly-comment-BLgsn7KS.js.map

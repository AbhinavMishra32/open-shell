import { $i as e, Qi as t, Yr as n, ia as r, ta as i } from "./src-CYrn1fYL.js";
import {
  C as a,
  E as o,
  Ea as s,
...
import { L as m, P as h, h as g, lt as _, z as v } from "./vscode-api-sUstfl-x.js";
import { n as y } from "./gh-pull-request-status-query-Bvqblflw.js";
...
var C = i((e) => x(e), t().finite()).optional(),
  w = i((e) => S(e), t().int()).optional(),
  T = e({
    title: r().trim().min(1),
    body: r().trim().min(1),
    file: r().trim().min(1),
...
function A(e, t) {
  let n = [];
  for (let r of p(e, { lineStartNames: [f] })) {
...
var F = _(),
  ...
  L = v(g, (e) => {
    let t = new WeakMap(),
      n = I;
    return m(g, ({ get: r }) => {
      let i = N({ cache: t, storedModelComments: I, turns: r(u, e) });
      return (B(n, i) || (n = i), n);
    });
  });
function R(e, t) {
...
function V(e) {
  let t = (0, F.c)(11),
    { conversationId: r, enablePullRequestComments: i, localConversationId: s } = e,
    c = i === void 0 ? !0 : i,
    { comments: l, modelComments: u, setComments: f } = R(r, s),
    p = String(r),
    m;
  t[0] === p ? (m = t[1]) : ((m = n(p)), (t[0] = p), (t[1] = m));
  let g = m,
    _ = h(a, g) ?? ``,
    v = h(d, g),
    b = h(o, g) ?? void 0,
...
//# sourceMappingURL=use-diff-comment-sources-MfRVxgk-.js.map

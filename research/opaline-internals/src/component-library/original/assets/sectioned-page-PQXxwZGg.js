...
function l(e) {
  ...
  let a = (0, s.useRef)(i),
    c;
  t[1] !== n || t[2] !== r
    ? ((c = { container: n, sectionElementsRef: a, sectionIds: r }),
      (t[1] = n),
      (t[2] = r),
      (t[3] = c))
    : (c = t[3]);
  ...
  return (
    t[6] === l
      ? (h = t[7])
      : ((h = { activeSectionId: l, scrollToSection: m, setSectionElement: f }),
        (t[6] = l),
        (t[7] = h)),
    h
  );
...
function u(e) {
  ...
  t[4] !== n || t[5] !== r || t[6] !== i
    ? ((u = () => {
        ...
        let e = n.getBoundingClientRect().top + c,
          t = i[0];
        for (let n of i) {
          let i = r.current[n];
          if (i != null)
    ...
    : (u = t[7]);
  let f = u;
  return (0, s.useSyncExternalStore)(l, f, f);
}
function d() {}
var f = n(),
...
function h(e) {
  let t = (0, o.c)(45),
    {
      ...
      navFooter: b,
      navSections: x,
      onSelectNavSection: S,
      showNav: C,
    } = e,
    w = d === void 0 ? !1 : d,
    T = _ === void 0 ? `vertical` : _,
    E = C === void 0 ? !0 : C,
    D = (0, s.useRef)(null),
  ...
  let j = A,
    M;
  t[1] === i ? (M = t[2]) : ((M = i.map(g)), (t[1] = i), (t[2] = M));
  let N;
  t[3] !== O || t[4] !== M
    ? ((N = { container: O, sectionIds: M }), (t[3] = O), (t[4] = M), (t[5] = N))
    : (N = t[5]);
  ...
  t[8] === h
    ? (B = t[9])
    : ((B = h == null ? null : (0, f.jsx)(m, { children: h })), (t[8] = h), (t[9] = B));
  let V = R
      ? T === `vertical`
    ...
    H;
  t[10] === V ? (H = t[11]) : ((H = r(V)), (t[10] = V), (t[11] = H));
  let U;
  t[12] !== P ||
  t[13] !== n ||
  t[14] !== y ||
  ...
  t[20] !== L
    ...
    : (U = t[21]);
  let W;
  t[22] === I ? (W = t[23]) : ((W = { setSectionElement: I }), (t[22] = I), (t[23] = W));
  let G = !w && `vertical-scroll-fade-mask [--edge-fade-distance:1rem]`,
    K;
  t[24] === G
    ? (K = t[25])
    : ((K = r(
  ...
  t[26] === u
    ? (q = t[27])
    : ((q = r(`mx-auto w-full max-w-[var(--thread-content-max-width)]`, u)),
      (t[26] = u),
      (t[27] = q));
  let J;
  t[28] !== a || t[29] !== q
    ? ((J = (0, f.jsx)(`div`, { className: q, children: a })),
      (t[28] = a),
      (t[29] = q),
      (t[30] = J))
    : (J = t[30]);
  let Y;
  t[31] !== K || t[32] !== J
    ? ((Y = (0, f.jsx)(`div`, { className: K, ref: j, children: J })),
      (t[31] = K),
      (t[32] = J),
      (t[33] = Y))
    : (Y = t[33]);
  let X;
  t[34] !== W || t[35] !== Y
    ? ((X = (0, f.jsx)(p.Provider, { value: W, children: Y })),
      (t[34] = W),
      (t[35] = Y),
      (t[36] = X))
    : (X = t[36]);
  ...
  t[37] !== H || t[38] !== U || t[39] !== X
    ? ((Z = (0, f.jsxs)(`div`, { className: H, children: [U, X] })),
      (t[37] = H),
      (t[38] = U),
      (t[39] = X),
      (t[40] = Z))
  ...
  return (
    t[41] !== Z || t[42] !== z || t[43] !== B
      ? ((Q = (0, f.jsxs)(`div`, { className: z, children: [B, Z] })),
        (t[41] = Z),
        (t[42] = z),
        (t[43] = B),
        (t[44] = Q))
...
function _(e) {
  let t = (0, o.c)(18),
    { id: n, title: i, action: a, showDivider: c, children: l } = e,
    u = c === void 0 ? !0 : c,
    d = (0, s.useContext)(p),
    m;
  t[0] !== n || t[1] !== d
    ? ((m = (e) => {
      ...
      (t[2] = m))
    : (m = t[2]);
  let h = u && `border-b border-token-border-light`,
    g;
  t[3] === h
    ? (g = t[4])
    : ((g = r(
  ...
  t[7] === a
    ? (v = t[8])
    : ((v = a ? (0, f.jsx)(`div`, { className: `shrink-0`, children: a }) : null),
      (t[7] = a),
      (t[8] = v));
  let y;
  t[9] !== g || t[10] !== _ || t[11] !== v
    ? ((y = (0, f.jsxs)(`div`, { className: g, children: [_, v] })),
      (t[9] = g),
      (t[10] = _),
      (t[11] = v),
      (t[12] = y))
...
function v(e) {
  let t = (0, o.c)(11),
    ...
    p = l === `vertical` ? `hidden lg:block lg:self-start` : `w-full`,
    m;
  t[0] !== i || t[1] !== n || t[2] !== c || t[3] !== u || t[4] !== l || t[5] !== d
    ? ((m =
        l === `vertical`
          ? (0, f.jsx)(`div`, {
                    ...
                    children: [
                      ...
                      i == null
                        ...
                        : (0, f.jsxs)(`div`, {
                            ...
                            children: [
                              (0, f.jsx)(`div`, { className: `h-6 w-px bg-token-border-light` }),
                              i,
                            ],
                          }),
                    ],
  ...
  return (
    t[7] !== s || t[8] !== p || t[9] !== m
      ? ((h = (0, f.jsx)(`nav`, { "aria-label": s, className: p, children: m })),
        (t[7] = s),
        (t[8] = p),
        (t[9] = m),
        (t[10] = h))
...
export { _ as n, h as t };
//# sourceMappingURL=sectioned-page-PQXxwZGg.js.map

import { Wr as e, ai as t, li as n } from "./src-CYrn1fYL.js";
import { f as r, g as i } from "./vscode-api-sUstfl-x.js";
import { o as a } from "./app-shell-tab-controller-B0DXekEJ.js";
import { n as o } from "./browser-sidebar-open-source-C-CpsoHA.js";
var s = `responsive`,
  c = 4096,
  l = 4096,
  u = `var(--gray-700)`,
...
function g(e) {
  ...
  let t = b(y(e));
  return { width: C(t.width), height: w(t.height) };
}
function _(e) {
  return e + f * 2;
}
function v({ fitHeight: e, height: t, width: n }) {
  return _(n * Math.min(1, e / t));
}
function y(e) {
...
function te({ drag: e, fitHeight: t, fitWidth: n, pointerX: r, pointerY: i, scale: a }) {
  let o = e.edge === `bottom` || e.edge === `bottom-left` || e.edge === `bottom-right`,
    s = e.edge !== `bottom`,
    c = e.edge === `left` || e.edge === `bottom-left` ? -1 : 1;
  return {
    width: s
      ? C(x({ fitSize: n, rawSize: e.startWidth + ((r - e.startPointerX) * c * 2) / a, scale: a }))
      : e.startWidth,
    height: o
      ? w(x({ fitSize: t, rawSize: e.startHeight + (i - e.startPointerY) / a, scale: a }))
      : e.startHeight,
  };
}
function ne({ height: e, width: t }) {
  return { width: C(e), height: w(t) };
}
function re(e) {
  let t = S(e.presetId),
    n =
  ...
  return { ...e, ...ne(e), presetId: n ? e.presetId : s };
}
function x({ fitSize: e, rawSize: t, scale: n }) {
...
var ie = `about:blank`,
  E = `data-browser-sidebar-conversation-id`,
  ae = `data-browser-sidebar-browser-tab-id`,
  ...
  j = `data-browser-sidebar-adopted-initial-url`,
  oe = `persist:opaline-browser-app-route:`,
  ...
  P = class {
    ...
    detach(e, t) {
      ...
      (t != null && t !== this.state.mountGeneration) ||
        ...
        R(e, null, n),
        this.detachFromDom(),
        i.info(`IAB_LIFECYCLE renderer backgrounded browser sidebar webview`, {
      ...
      if (this.webview != null) {
        if (e == null || t == null) {
          (this.webview.removeAttribute(k),
            this.webview.removeAttribute(A),
            this.webview.removeAttribute(j));
          return;
        }
        (this.webview.setAttribute(k, e),
          this.webview.setAttribute(A, t.toString()),
          this.webview.setAttribute(j, n));
      }
    }
    resync() {
    ...
    dispose() {
      ...
      ((this.isDisposed = !0),
        i.info(`IAB_LIFECYCLE renderer disposed browser sidebar webview`, {
          safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
        }));
      let e = this.webview;
      (this.detachFromDom(),
        this.webviewRef != null && R(this.webviewRef, null, e ?? void 0),
        de(e),
      ...
      return i != null && this.browserUseCaptureSurfaceSize == null
        ? ((this.lastVisibleBounds = i),
          ...
          r || this.state.shouldPaint === !1
            ...
            : (I(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `visible`))
        : (this.parkInDom(), `hidden`);
    }
    attachToDom() {
      let e = this.container;
      e != null && !e.isConnected && ue().append(e);
    }
    parkInDom() {
      let e = this.container,
        t = this.cursorOverlayHost,
...
function F(e) {
  return `${oe}${encodeURIComponent(e)}`;
}
function se({ bounds: e, isVisible: t, lastVisibleBounds: n }) {
...
function L(e, t, n, r, i, a) {
  (I(e, t, n, r, i, a), Object.assign(e.style, { pointerEvents: `none`, visibility: `hidden` }));
}
function ce(e, t, n = 1) {
  Object.assign(e.style, {
    height: `${t.height}px`,
...
function de(e) {
  e == null || !(`destroy` in e) || typeof e.destroy != `function` || e.destroy();
}
var fe = `about:blank`,
  z = `data-browser-sidebar-conversation-id`,
  pe = `data-browser-sidebar-browser-tab-id`,
  me = `data-browser-sidebar-retained-webview`,
  ...
  _e = `2147483647`,
  V = `#fff`,
  H = { x: 0, y: 0, width: 1280, height: 720 },
  U = class {
    browserTabId;
    conversationId;
    ...
    constructor({
      ...
      ((this.browserTabId = e),
        ...
        (this.webview.style.backgroundColor = V),
        this.webview.setAttribute(z, r),
        this.webview.setAttribute(pe, e),
        this.webview.setAttribute(me, ``),
        this.webview.setAttribute(`partition`, s),
        this.webview.setAttribute(`src`, a.length === 0 ? fe : a),
    ...
    detach(e) {
      ((this.isAttached = !1),
        ...
        (this.webview.style.backgroundColor = V),
        Y(e, null, this.webview),
        this.syncContainerStyle(),
        i.info(`IAB_LIFECYCLE renderer detached retained browser sidebar webview`, {
          safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
        }));
    }
    sync(e, t) {
    ...
    dispose() {
      (i.info(`IAB_LIFECYCLE renderer disposed retained browser sidebar webview`, {
        safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
      }),
        this.container.remove());
    }
    syncContainerStyle() {
      ...
      if (this.browserUseCaptureSurfaceSize != null) {
        G(this.container, this.webview, this.cursorOverlayHost, e);
        return;
      }
...
function W(e, t, n, r, i, a) {
  if (a) {
    G(e, t, n, r ?? (i == null ? H : J(i)));
    return;
  }
  (Object.assign(e.style, he), K(t), q(n, { width: 1, height: 1 }));
}
function G(e, t, n, r) {
  (Object.assign(e.style, {
...
function J(e) {
  return { x: H.x, y: H.y, width: e.width, height: e.height };
}
function Y(e, t, n) {
  (n != null && e.current === n && (e.current = null), t != null && (e.current = t));
}
var be = { responsiveViewportSize: null, toolbarState: m },
  xe = new Set([`new-conversation`, `panel-new-conversation`]),
  Se = new (class {
    listeners = new Set();
    ...
    constructor() {
      (r.subscribe(`browser-sidebar-state`, (e) => {
        ...
        r.subscribe(`browser-sidebar-browser-use-page-released`, (e) => {
          this.releaseBrowserUseTab(e.conversationId, $(e.conversationId, e.browserTabId));
        }),
        r.subscribe(`browser-sidebar-browser-use-viewport`, (e) => {
        ...
        r.subscribe(`browser-sidebar-browser-use-capture-surface`, (e) => {
        ...
        r.subscribe(`browser-sidebar-browser-use-cursor-state`, (e) => {
          this.setBrowserUseCursorState(e.conversationId, $(e.conversationId, e.browserTabId), e);
        }),
        r.subscribe(`browser-sidebar-destroy-webview`, (e) => {
        ...
        r.subscribe(`browser-sidebar-webview-attached`, (e) => {
    ...
    hasRetainedWebview(e, t = $(e, void 0)) {
      return this.webviews.get(X(e, t)) instanceof U;
    }
    ...
    getBrowserUseBrowserTabSummarySyncKey(e) {
      ...
      if (n == null) return ``;
      let r = this.getSnapshot(e, n);
      return [n, r?.tabType ?? ``, r?.title ?? ``, r?.url ?? ``].join(`	`);
    }
    getDeviceToolbarTabState(e, t = $(e, void 0)) {
      return this.deviceToolbarTabStates.get(X(e, t)) ?? be;
    }
    ...
    setSnapshot(t, n, r) {
      let i = typeof n == `string` ? n : $(t, void 0),
        a = typeof n == `string` ? r : n;
      if (a == null) return;
      let o = X(t, i);
      (this.snapshots.set(o, a),
        this.browserUseTabKeys.has(o) && this.syncBrowserUseTabKeys(t),
        a.tabType !== e.WEB &&
          (this.webviews.get(o) ?? null) instanceof U &&
          this.disposeWebviewHost(t, i, o, a.tabType),
        this.emitChange());
    }
    removeTab(e, t) {
      let n = X(e, t);
      (this.pendingElectronTransfers.delete(n), this.snapshots.delete(n));
      let r = this.browserUseTabKeys.delete(n);
      (this.browserUseActiveTabKeys.delete(n) && this.refreshBrowserUseActiveTabs(),
        ...
        r && this.syncBrowserUseTabKeys(e),
        this.emitChange());
    }
    ...
    getWebview(e, ...t) {
      ...
      if (Ce(t)) {
        let [e, i, o] = t;
        ((n = e), (r = i), (a = o));
      } else ((n = $(e, void 0)), (r = t[0]), (a = t[1]));
      let o = X(e, n),
        s = this.webviews.get(o);
      if (s instanceof P)
        return (
          a != null &&
            (s.setAdoptionAttributes(a.adoptionLease ?? null, a.adoptedWebContentsId ?? null, r),
            a.adoptionLease != null &&
              a.adoptedWebContentsId != null &&
              i.info(`IAB_ADOPTION renderer updated adopted webview`, {
                safe: {
      ...
      (c.setBrowserUseCaptureSurfaceSize(this.browserUseCaptureSurfaceSizes.get(o) ?? null),
        this.webviews.set(o, c));
      let l = a?.hostKind ?? `panel`;
      return (
        this.notifyWebviewHostCreated(e, n, l),
        i.info(`IAB_LIFECYCLE renderer created browser sidebar webview`, {
          safe: { browserTabId: n, conversationId: e, hostKind: l },
          sensitive: { initialUrl: r },
        }),
        a?.adoptionLease != null &&
          a.adoptedWebContentsId != null &&
          i.info(`IAB_ADOPTION renderer created adopted webview`, {
            safe: {
              adoptedWebContentsId: a.adoptedWebContentsId,
              browserTabId: n,
              conversationId: e,
    ...
    getRetainedWebview(e, t, n, r) {
      ...
      let c = r?.hostKind ?? `panel`;
      return (
        this.notifyWebviewHostCreated(e, t, c),
        i.info(`IAB_LIFECYCLE renderer created retained browser sidebar webview`, {
    ...
    notifyWebviewHostCreated(e, t, n) {
      r.dispatchMessage(`browser-sidebar-webview-host-created`, {
        browserTabId: t,
        conversationId: e,
        hostKind: n,
      });
    ...
    setBrowserUseActive(e, ...t) {
      ...
      ((o !== r || l) && this.refreshBrowserUseActiveTabs(),
        this.webviews.get(a)?.setBrowserUseActive?.(r),
        i.info(`IAB_LIFECYCLE renderer synced browser use webview state`, {
          safe: { browserTabId: n, conversationId: e, isBrowserUseActive: r },
          sensitive: {},
        }),
        (o !== r || c != null || l) && this.emitChange());
    }
    ...
    setBrowserUseViewportSize(e, ...t) {
      let n = t.length === 1 ? $(e, void 0) : t[0],
        ...
        i = X(e, n),
        a = r == null ? null : { width: C(r.width), height: w(r.height) };
    ...
    reassociateTabState(e, ...t) {
      let a = t.length === 1 ? $(e, void 0) : t[0],
        o = t.length === 1 ? t[0] : t[1],
        s = t.length === 1 ? $(o, void 0) : t[2],
        c = n(X(e, a), X(o, s)),
        l = X(e, a),
        u = X(o, s);
      if (l === u || this.transferredWebviewKeys.has(c)) return;
      let d = this.webviews.get(l) ?? null,
        f = this.webviews.get(u) ?? null,
      ...
      (this.pendingElectronTransfers.delete(l),
        ...
        d != null &&
          (f == null
            ...
            : this.disposeWebviewHost(e, a, l, p?.tabType ?? `web`)));
      let m = this.browserUseViewportSizes.get(l) ?? null,
        h = this.browserUseTabKeys.has(l),
        g = this.mountStates.get(l) ?? null,
        _ = this.browserUseActiveTabKeys.delete(l);
      (this.browserUseCaptureSurfaceSizes.delete(l),
        ...
        this.pendingElectronTransfers.set(u, { sourceBrowserTabId: a, sourceConversationId: e }),
        ...
        h &&
          (this.browserUseTabKeys.add(u),
          this.syncBrowserUseTabKeys(e),
          this.syncBrowserUseTabKeys(o)),
        _ && (this.browserUseActiveTabKeys.add(u), this.refreshBrowserUseActiveTabs()),
        m != null && this.browserUseViewportSizes.set(u, m),
        g != null && this.mountStates.set(u, { generation: g.generation, isClaimed: !1 }),
        d?.setBrowserUseCaptureSurfaceSize(null),
        i.info(`IAB_LIFECYCLE renderer reassociated browser sidebar tab`, {
          safe: {
      ...
      let v = this.localServersStates.get(e),
      ...
      (p != null && (this.snapshots.delete(l), this.snapshots.set(u, p)),
        ...
        this.cleanupTemporaryConversationIfEmpty(e),
        this.emitChange());
    }
    ...
    disposeWebviewHost(e, t, n, r) {
      ...
      (this.webviews.delete(n),
        a != null &&
          (a.dispose(),
          i.info(`IAB_LIFECYCLE renderer removed browser sidebar webview`, {
            safe: { browserTabId: t, conversationId: e, tabType: r },
          })));
    }
    destroyWebviewAtHostRequest(e, t, n, i, a) {
      let o = X(e, t);
      ((this.webviews.get(o) ?? null)?.shouldDestroyForHostRequest({
        mountGeneration: n,
        reason: i,
      }) !== !1 && this.disposeWebviewHost(e, t, o, i),
        i === `closed` && this.removeTab(e, t),
        r.dispatchMessage(`browser-sidebar-webview-destroyed`, {
          browserTabId: t,
          conversationId: e,
          reason: i,
          teardownId: a,
    ...
    getFirstConversationBrowserTabId(e, n) {
      let r = `${e}\0`;
      for (let e of n) if (e.startsWith(r)) return t(e.slice(r.length));
      return null;
    }
    getConversationBrowserTabIdsFromKeys(e, n) {
      let r = `${e}\0`,
        i = [];
      for (let e of n) e.startsWith(r) && i.push(t(e.slice(r.length)));
      return i;
    }
    ...
    syncBrowserUseTabKeys(e) {
      ...
      (this.browserUseTabIdsKeysByConversation.set(e, t.join(`\0`)),
        this.browserUseTabSummarySyncKeysByConversation.set(
          ...
          t
            .map((t) => {
              let n = this.getSnapshot(e, t);
              return [t, n?.tabType ?? ``, n?.title ?? ``, n?.url ?? ``].join(`	`);
            })
            .join(`\0`),
        ),
        this.refreshBrowserUseTabs());
    ...
    refreshBrowserUseTabs() {
      this.browserUseTabs = Array.from(this.browserUseTabKeys, Z);
    }
    refreshBrowserUseActiveTabs() {
      this.browserUseActiveTabs = Array.from(this.browserUseActiveTabKeys, Z);
    }
    removeConversationTabs(e) {
      ...
      for (let e of this.browserUseActiveTabKeys)
        e.startsWith(t) && (this.browserUseActiveTabKeys.delete(e), (n = !0));
      for (let e of this.browserUseTabKeys) e.startsWith(t) && this.browserUseTabKeys.delete(e);
      (this.refreshBrowserUseTabs(), n && this.refreshBrowserUseActiveTabs());
    ...
    markWebviewAttached(e, t, n) {
      (this.getMountGeneration(e, t) === n && o(e, t), this.emitChange());
    }
  })();
function X(e, t) {
  return `${e}\0${t}`;
...
function Z(e) {
  let n = e.indexOf(`\0`);
  return { browserTabId: t(e.slice(n + 1)), conversationId: e.slice(0, n) };
}
function Q(e, t) {
  return t === $(e, void 0) ? e : X(e, t);
}
function $(e, t) {
  return t ?? a(e);
}
...
//# sourceMappingURL=browser-sidebar-manager-CDP80WMh.js.map

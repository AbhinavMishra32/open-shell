...
import {
  ...
  s as v,
  t as ee,
} from "./Combination-9DfZp13g.js";
import { a as y, i as b, n as x, r as te, t as S } from "./dist-DXUvl421.js";
var C = e(t(), 1),
  w = n();
function T(e) {
  let t = e + `CollectionProvider`,
    ...
    s = (e) => {
      ...
      return (0, w.jsx)(a, { scope: t, itemMap: i, collectionRef: r, children: n });
    };
  s.displayName = t;
  let c = e + `CollectionSlot`,
    ...
    f = C.forwardRef((e, t) => {
      ...
      return (0, w.jsx)(u, { ref: d(t, o(c, n).collectionRef), children: r });
    });
  f.displayName = c;
  let p = e + `CollectionItemSlot`,
    ...
    g = C.forwardRef((e, t) => {
      let { scope: n, children: r, ...i } = e,
        ...
        c = o(p, n);
      return (
        C.useEffect(() => (c.itemMap.set(a, { ref: a, ...i }), () => void c.itemMap.delete(a))),
        (0, w.jsx)(h, { [m]: ``, ref: s, children: r })
      );
    });
  g.displayName = p;
  function _(t) {
...
var E = C.createContext(void 0);
function D(e) {
  let t = C.useContext(E);
  return e || t || `ltr`;
}
...
var re = C.forwardRef((e, t) => {
    let {
      ...
      v = d(t, _),
      ee = D(s),
      [y, b] = u({ prop: c, defaultProp: l ?? null, onChange: f, caller: A }),
      [x, te] = C.useState(!1),
      S = p(m),
      T = M(n),
      E = C.useRef(!1),
    ...
    return (
      C.useEffect(() => {
        let e = _.current;
        if (e) return (e.addEventListener(O, S), () => e.removeEventListener(O, S));
      }, [S]),
      (0, w.jsx)(F, {
        scope: n,
        orientation: r,
        ...
        onItemShiftTab: C.useCallback(() => te(!0), []),
        onFocusableItemAdd: C.useCallback(() => N((e) => e + 1), []),
        onFocusableItemRemove: C.useCallback(() => N((e) => e - 1), []),
        children: (0, w.jsx)(o.div, {
          tabIndex: x || j === 0 ? -1 : 0,
          "data-orientation": r,
          ...g,
          ref: v,
  ...
  z = C.forwardRef((e, t) => {
    let {
      ...
      h = M(n),
      { onFocusableItemAdd: g, onFocusableItemRemove: _, currentTabStopId: v } = f;
    return (
      C.useEffect(() => {
        if (r) return (g(), () => _());
      }, [r, g, _]),
      (0, w.jsx)(j.ItemSlot, {
        ...
        children: (0, w.jsx)(o.span, {
          ...
          onKeyDown: a(e.onKeyDown, (e) => {
            ...
            let t = oe(e, f.orientation, f.dir);
            if (t !== void 0) {
...
var le = L,
  ue = z,
  B = [`Enter`, ` `],
  de = [`ArrowDown`, `PageUp`, `Home`],
  fe = [`ArrowUp`, `PageDown`, `End`],
  pe = [...de, ...fe],
  me = { ltr: [...B, `ArrowRight`], rtl: [...B, `ArrowLeft`] },
  he = { ltr: [`ArrowLeft`], rtl: [`ArrowRight`] },
  V = `Menu`,
  [H, ge, _e] = T(V),
  [U, ve] = i(V, [_e, y, P]),
  W = y(),
...
var Ce = `MenuAnchor`,
  q = C.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e,
      i = W(n);
    return (0, w.jsx)(S, { ...i, ...r, ref: t });
  });
q.displayName = Ce;
var we = `MenuPortal`,
  [Te, Ee] = U(we, { forceMount: void 0 }),
  De = (e) => {
    ...
    return (0, w.jsx)(Te, {
      ...
      children: (0, w.jsx)(c, {
        present: n || a.open,
        children: (0, w.jsx)(_, { asChild: !0, container: i, children: r }),
      }),
    });
  };
De.displayName = we;
var J = `MenuContent`,
  [Oe, ke] = U(J),
  Ae = C.forwardRef((e, t) => {
    let n = Ee(J, e.__scopeMenu),
      { forceMount: r = n.forceMount, ...i } = e,
      a = G(J, e.__scopeMenu),
      o = K(J, e.__scopeMenu);
    return (0, w.jsx)(H.Provider, {
      scope: e.__scopeMenu,
      children: (0, w.jsx)(c, {
        present: r || a.open,
        children: (0, w.jsx)(H.Slot, {
          scope: e.__scopeMenu,
          children: o.modal ? (0, w.jsx)(je, { ...i, ref: t }) : (0, w.jsx)(Me, { ...i, ref: t }),
        }),
      }),
    });
  }),
  je = C.forwardRef((e, t) => {
    let n = G(J, e.__scopeMenu),
      r = C.useRef(null),
      i = d(t, r);
    return (
      C.useEffect(() => {
  ...
  Pe = C.forwardRef((e, t) => {
    let {
      ...
      I = C.useRef(0),
      L = y ? ee : C.Fragment,
      re = y ? { as: Ne, allowPinchZoom: !0 } : void 0,
      R = (e) => {
        let t = N.current + e,
        ...
        ((function e(t) {
          ((N.current = t),
            ...
            t !== `` && (M.current = window.setTimeout(() => e(``), 1e3)));
        })(t),
          o && setTimeout(() => o.focus()));
      };
    (C.useEffect(() => () => window.clearTimeout(M.current), []), g());
    let z = C.useCallback((e) => F.current === P.current?.side && gt(e, P.current?.area), []);
    return (0, w.jsx)(Oe, {
      scope: n,
      searchRef: N,
              ...
              children: (0, w.jsx)(te, {
                ...
                onBlur: a(e.onBlur, (e) => {
                  e.currentTarget.contains(e.target) ||
                    (window.clearTimeout(M.current), (N.current = ``));
                }),
                onPointerMove: a(
                  e.onPointerMove,
                  $((e) => {
                    ...
                    e.currentTarget.contains(t) &&
                      n &&
                      ((F.current = e.clientX > I.current ? `right` : `left`),
                      (I.current = e.clientX));
                  }),
                ),
              }),
...
var Fe = `MenuGroup`,
  Ie = C.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e;
    return (0, w.jsx)(o.div, { role: `group`, ...r, ref: t });
  });
Ie.displayName = Fe;
var Le = `MenuLabel`,
  Re = C.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e;
    return (0, w.jsx)(o.div, { ...r, ref: t });
  });
Re.displayName = Le;
var Y = `MenuItem`,
  ze = `menu.itemSelect`,
  X = C.forwardRef((e, t) => {
    let { disabled: n = !1, onSelect: i, ...o } = e,
      s = C.useRef(null),
      c = K(Y, e.__scopeMenu),
      l = ke(Y, e.__scopeMenu),
      u = d(t, s),
      f = C.useRef(!1),
      p = () => {
        let e = s.current;
        if (!n && e) {
          let t = new CustomEvent(ze, { bubbles: !0, cancelable: !0 });
          (e.addEventListener(ze, (e) => i?.(e), { once: !0 }),
            r(e, t),
            t.defaultPrevented ? (f.current = !1) : c.onClose());
        }
      };
    return (0, w.jsx)(Be, {
      ...o,
      ...
      onKeyDown: a(e.onKeyDown, (e) => {
        ...
        n ||
          (t && e.key === ` `) ||
          (B.includes(e.key) && (e.currentTarget.click(), e.preventDefault()));
      }),
    });
  });
X.displayName = Y;
var Be = C.forwardRef((e, t) => {
    let { __scopeMenu: n, disabled: r = !1, textValue: i, ...s } = e,
      c = ke(Y, n),
      l = ye(n),
      u = C.useRef(null),
      f = d(t, u),
  ...
  He = C.forwardRef((e, t) => {
    ...
    return (0, w.jsx)(Xe, {
      ...
      children: (0, w.jsx)(X, {
        ...
        ref: t,
        "data-state": dt(n),
        onSelect: a(i.onSelect, () => r?.(Q(n) ? !0 : !n), { checkForDefaultPrevented: !1 }),
      }),
    });
  });
He.displayName = Ve;
var Ue = `MenuRadioGroup`,
  [We, Ge] = U(Ue, { value: void 0, onValueChange: () => {} }),
  Ke = C.forwardRef((e, t) => {
    ...
    return (0, w.jsx)(We, {
      ...
      value: n,
      onValueChange: a,
      children: (0, w.jsx)(Ie, { ...i, ref: t }),
    });
  });
Ke.displayName = Ue;
var qe = `MenuRadioItem`,
  Je = C.forwardRef((e, t) => {
    let { value: n, ...r } = e,
      i = Ge(qe, e.__scopeMenu),
      o = n === i.value;
    return (0, w.jsx)(Xe, {
      scope: e.__scopeMenu,
      checked: o,
...
Je.displayName = qe;
var Ye = `MenuItemIndicator`,
  [Xe, Ze] = U(Ye, { checked: !1 }),
  Qe = C.forwardRef((e, t) => {
    let { __scopeMenu: n, forceMount: r, ...i } = e,
      a = Ze(Ye, n);
    return (0, w.jsx)(c, {
      present: r || Q(a.checked) || a.checked === !0,
      children: (0, w.jsx)(o.span, { ...i, ref: t, "data-state": dt(a.checked) }),
    });
  });
Qe.displayName = Ye;
var $e = `MenuSeparator`,
  et = C.forwardRef((e, t) => {
    let { __scopeMenu: n, ...r } = e;
    return (0, w.jsx)(o.div, { role: `separator`, "aria-orientation": `horizontal`, ...r, ref: t });
  });
et.displayName = $e;
var tt = `MenuArrow`,
  nt = C.forwardRef((e, t) => {
...
var rt = `MenuSub`,
  ...
  ot = (e) => {
    let { __scopeMenu: t, children: n, open: r = !1, onOpenChange: i } = e,
      ...
      d = p(i);
    return (
      C.useEffect(() => (a.open === !1 && d(!1), () => d(!1)), [a.open, d]),
      (0, w.jsx)(b, {
        ...o,
        children: (0, w.jsx)(be, {
          scope: t,
...
var Z = `MenuSubTrigger`,
  st = C.forwardRef((e, t) => {
    let n = G(Z, e.__scopeMenu),
      r = K(Z, e.__scopeMenu),
      i = at(Z, e.__scopeMenu),
      o = ke(Z, e.__scopeMenu),
      c = C.useRef(null),
            ...
            $((e) => {
              ...
              if (t) {
                ...
                (o.onPointerGraceIntentChange({
                  ...
                  (l.current = window.setTimeout(() => o.onPointerGraceIntentChange(null), 300)));
              } else {
...
st.displayName = Z;
var ct = `MenuSubContent`,
  lt = C.forwardRef((e, t) => {
    let n = Ee(J, e.__scopeMenu),
      { forceMount: r = n.forceMount, ...i } = e,
      o = G(J, e.__scopeMenu),
      s = K(J, e.__scopeMenu),
      l = at(ct, e.__scopeMenu),
      u = C.useRef(null),
      f = d(t, u);
    return (0, w.jsx)(H.Provider, {
      scope: e.__scopeMenu,
...
function gt(e, t) {
  return t ? ht({ x: e.clientX, y: e.clientY }, t) : !1;
}
function $(e) {
...
//# sourceMappingURL=dist-Crlqula6.js.map

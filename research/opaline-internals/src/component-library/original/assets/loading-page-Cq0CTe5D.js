...
import { t as a } from "./homepage-logo-C4Z1mn1w.js";
import { t as o } from "./data-url-from-svg-DFCy07cd.js";
var s = i(),
  c = n(),
  l = o(`
...
function u(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = r(`relative inline-flex shrink-0 items-center justify-center`, n)),
      (t[0] = n),
      (t[1] = i));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, c.jsx)(a, {
        "aria-hidden": `true`,
        className: `opaline-logo-shimmer-base size-full`,
      })),
      (t[2] = o))
    : (o = t[2]);
  let u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, c.jsx)(`div`, {
        className: `opaline-logo-shimmer-overlay pointer-events-none absolute inset-0`,
        style: {
  ...
  return (
    t[4] === i
      ? (d = t[5])
      : ((d = (0, c.jsxs)(`div`, { "aria-hidden": `true`, className: i, children: [o, u] })),
        (t[4] = i),
        (t[5] = d)),
    d
  );
...
function f(e) {
  let t = (0, s.c)(21),
    { overlay: n, fillParent: i, showLogo: a, debugName: o } = e,
    l = n === void 0 ? !1 : n,
    f = i === void 0 ? !1 : i,
    p = a === void 0 ? !0 : a,
    [m, h] = (0, d.useState)(!1),
  ...
  t[0] === g
    ? (_ = t[1])
    : ((_ = r(`flex items-center justify-center`, g)), (t[0] = g), (t[1] = _));
  let v;
  t[2] === !1 ? (v = t[3]) : ((v = () => {}), (t[2] = !1), (t[3] = v));
  let y;
  t[4] !== f || t[5] !== l
    ? ((y =
        l || f
  ...
  t[7] === p
    ? (b = t[8])
    : ((b = p ? (0, c.jsx)(u, { className: `size-14` }) : null), (t[7] = p), (t[8] = b));
  let x;
  t[9] !== !1 || t[10] !== o || t[11] !== m
    ? ((x = null), (t[9] = !1), (t[10] = o), (t[11] = m), (t[12] = x))
    : (x = t[12]);
  let S;
  t[13] !== b || t[14] !== x
    ? ((S = (0, c.jsxs)(`div`, {
  ...
  let C;
  return (
    t[16] !== S || t[17] !== _ || t[18] !== v || t[19] !== y
      ? ((C = (0, c.jsxs)(`div`, { className: _, onClick: v, children: [y, S] })),
        (t[16] = S),
        (t[17] = _),
        (t[18] = v),
        (t[19] = y),
...
//# sourceMappingURL=loading-page-Cq0CTe5D.js.map

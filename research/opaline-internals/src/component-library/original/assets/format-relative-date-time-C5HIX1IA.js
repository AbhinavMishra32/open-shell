...
import { c as i } from "./lib-MoKmYgcO.js";
var a = e(t(), 1),
  o = 6e4,
  s = new Date(),
  c = new Set(),
  l = null;
function u() {
  return (0, a.useSyncExternalStore)(h, g, g);
}
function d() {
  for (let e of c) e();
}
...
function T(e) {
  ...
  if (r != null) {
    ...
    return (
      t[2] !== n || t[3] !== e
        ? ((i = (0, v.jsx)(D, { dateString: n, now: e })), (t[2] = n), (t[3] = e), (t[4] = i))
        : (i = t[4]),
      i
    );
  }
  let i;
  return (
    t[5] === n ? (i = t[6]) : ((i = (0, v.jsx)(E, { dateString: n })), (t[5] = n), (t[6] = i)),
    i
  );
}
function E(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, v.jsx)(D, { dateString: n, now: r })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
function D(e) {
  ...
  if (t[0] !== n || t[1] !== r) {
    let e = new Date(n);
    ((o = w(r, e)), (s = C(r, e)), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = s));
  } else ((o = t[2]), (s = t[3]));
  let c = s,
    l = Math.max(1, c);
  if (l < 60) {
...
export { T as t };
//# sourceMappingURL=format-relative-date-time-C5HIX1IA.js.map

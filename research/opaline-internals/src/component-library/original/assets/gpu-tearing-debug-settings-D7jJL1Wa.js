...
import { fo as l, so as u } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { g as ee } from "./persisted-signal-Cx1QgqJn.js";
import { o as C } from "./statsig-Cajk3UKk.js";
import { i as w, m as te, n as T } from "./sidebar-signals-B0JkGccK.js";
import { r as E } from "./toast-signal-By11REe1.js";
import { n as D } from "./skill-utils-Bt5zjVpI.js";
import { t as O } from "./button-Xd4Hy1MO.js";
import { a as k, r as A, s as j } from "./setting-storage-Cel8Tr7E.js";
import { t as ne } from "./spinner-Dvc_A3Ae.js";
import { t as M } from "./apps-DBd5dYzG.js";
import { t as N } from "./x-DypUcSQe.js";
import { E as P, T as F, j as I, k as L, w as R } from "./diff-view-mode-DMAtdFuV.js";
import { t as z } from "./terminal-CsU-mb2r.js";
import { t as B } from "./mcp-BYvjg9M2.js";
import { a as V, i as H, l as U, n as W } from "./dialog-layout-CCvvb1Vc.js";
import { n as re } from "./use-skills-DK2PGa-B.js";
import { t as G } from "./check-md-CZTnvSiA.js";
import { t as ie } from "./use-stable-callback-B56R_Ee2.js";
import { n as ae } from "./use-start-new-conversation-DpDFMiHM.js";
import { t as oe } from "./checkbox-Bz6PC7ig.js";
import { t as se } from "./x-circle-CiWKYQx0.js";
import { t as ce } from "./format-relative-date-time-C5HIX1IA.js";
import { t as le } from "./arrow-top-right-D16Z5Bms.js";
import { s as ue } from "./permissions-mode-visibility-DNx7wvRA.js";
import { t as de } from "./alert-DJ0qvvZN.js";
import { t as fe } from "./use-recommended-skills-C0-7frYf.js";
import { n as K } from "./settings-row-DOKTjAF6.js";
import { n as q, t as pe } from "./settings-group-BO3RZzLk.js";
import {
  _ as me,
  a as he,
  b as ge,
  ...
  v as Oe,
  x as ke,
} from "./external-agent-import-step-CgLYbl_u.js";
import { t as Ae } from "./scroll-to-bottom-buton-BC5SgtKJ.js";
import { t as je } from "./hooks-Bi5GvUJV.js";
function Me(e) {
  return s(r, e);
}
var Ne = `external-agent-config-import-settings`,
  ...
  Re = t({
    ...
    theme: t({
      ...
      fonts: t({ code: Le, ui: Le }),
      ink: X,
      opaqueWindows: a(),
      semanticColors: t({ diffAdded: X, diffRemoved: X, skill: X }),
      surface: X,
    }),
    variant: i([`light`, `dark`]),
  });
function ze(e) {
  let t = m(_),
    ...
    o = I(i, e),
    s = P(e),
    c = { codeThemeId: F(a, e).id, theme: o },
    l = (0, J.useRef)(c),
    u = (0, J.useRef)(c),
    d = (0, J.useRef)(0),
  ...
  let p = (0, J.useCallback)(
      (e) => {
        ((l.current = e), A(t, n, e.theme), A(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    h = (0, J.useCallback)(
    ...
    g = (0, J.useCallback)(
      async (e) => {
        await h(e, async () => {
          ...
          await j(n, e.theme);
          try {
            await j(r, e.codeThemeId);
          } catch (e) {
            throw (await j(n, t.theme).catch(() => void 0), e);
          }
          u.current = e;
        });
      },
      ...
      async (e) => {
        ...
        await h(t, async () => {
          ...
          if (i.codeThemeId !== t.codeThemeId) {
            await j(r, t.codeThemeId);
            try {
              await j(n, e);
            } catch (e) {
              throw (await j(r, i.codeThemeId).catch(() => void 0), e);
            }
            u.current = t;
            return;
          }
          (await j(n, e), (u.current = t));
        });
      },
      [n, r, h],
    ),
    ...
    S = (0, J.useCallback)(
      () => Ge({ codeThemeId: l.current.codeThemeId, theme: l.current.theme, variant: e }),
      [e],
    ),
    ee = (0, J.useCallback)(
      (t) => {
  ...
  return {
    ...
    fonts: w.theme.fonts,
    importThemeString: C,
    selectedCodeTheme: F(w.codeThemeId, e),
    setCodeThemeId: x,
    setFontsPatch: b,
    setThemePatch: y,
    theme: w.theme,
...
function Be(e, t, n) {
  ...
  return { codeThemeId: i.id, theme: I(r.theme, t) };
}
function Ve(e) {
  return e === `light`
    ? { chromeThemeSetting: n.lightChromeTheme, codeThemeSetting: n.lightCodeThemeId }
    : { chromeThemeSetting: n.darkChromeTheme, codeThemeSetting: n.darkCodeThemeId };
}
function He(e, t) {
  return {
    ...e,
...
function Qe({ artifacts: e, skillMention: t }) {
  let n = e.filter((e) => e.scope === `user`),
    ...
    i = [`Use ${t} to migrate the following settings into Opaline.`];
  if (n.length > 0) {
    i.push(``, `User config:`);
...
function et({ opalineHome: e, isEnabled: t, items: n }) {
  return t ? $e(n, e) : [];
}
function tt(e, t) {
  let n = e.details;
...
function it(e, t, n) {
  if (t === `plugins` && e.sourcePath != null && e.sourcePath !== ``) return e.sourcePath;
  let r = at(e, n);
...
function at(e, t) {
  return e.cwd != null && e.cwd !== `` ? e.cwd : t == null || t === `` ? null : Je(t);
}
async function ot({
  ensureSkillByName: e,
  fallbackSkillPath: t,
  ...
  let o = n(a);
  if (o != null) return D({ name: o.name, path: o.path });
  try {
    let n = await e(a);
    ...
    return !o.success || o.destination == null
      ? st(a, t)
      : (await r?.(), D({ name: n.name, path: Q(o.destination, `SKILL.md`) }));
  } catch {
    return st(a, t);
  }
}
function st(e, t) {
  return D({ name: e, path: t });
}
var ct = `migrate-to-opaline`,
  lt = `https://github.com/openai/skills/blob/main/skills/.curated/migrate-to-opaline/SKILL.md`;
async function ut({
  ensureSkillByName: e,
  findSkillByName: t,
  forceReloadSkills: n,
...
function pt(e) {
  let t = (0, Z.c)(88),
    ...
    f = x(),
    p;
  t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== o || t[4] !== s || t[5] !== l
    ? ((p = {
        opalineHome: n,
        hostId: r,
        isCoworkMigrationEnabled: a,
  ...
  let h = ht(p),
    ...
    v;
  t[7] !== h.isImporting ||
  t[8] !== h.isRemainingArtifactsDialogOpen ||
  t[9] !== h.remainingArtifacts
    ? ((v =
        !h.isImporting && h.isRemainingArtifactsDialogOpen
          ? { status: `success`, items: [], remainingArtifacts: h.remainingArtifacts }
          : null),
      (t[7] = h.isImporting),
      (t[8] = h.isRemainingArtifactsDialogOpen),
      (t[9] = h.remainingArtifacts),
  ...
  let y = v,
    b;
  t[11] !== n ||
  t[12] !== h.closeRemainingArtifactsDialog ||
  t[13] !== h.migrateRemainingArtifacts ||
  t[14] !== y
    ? ((b = (0, Y.jsx)(yt, {
        progress: y,
        opalineHome: n,
        onMigrateRemainingArtifacts: h.migrateRemainingArtifacts,
        onClose: h.closeRemainingArtifactsDialog,
      })),
      (t[11] = n),
      (t[12] = h.closeRemainingArtifactsDialog),
      (t[13] = h.migrateRemainingArtifacts),
    ...
    : (b = t[15]);
  let C = b,
    w = h.importChoices.length > 0 || h.remainingArtifacts.length > 0,
    te = h.importChoices.length === 0 && h.remainingArtifacts.length > 0,
    T;
  t[16] !== h.importChoices || t[17] !== f
    ? ((T = h.importChoices.length === 0 ? null : xe(f, h.importChoices)),
      (t[16] = h.importChoices),
      (t[17] = f),
      (t[18] = T))
    : (T = t[18]);
  let E = T,
  ...
  t[19] === d
    ? (D = t[20])
    : ((D = (e) => {
        ee(d, { eventName: `opaline_onboarding_external_agent_import_event`, metadata: e });
      }),
      (t[19] = d),
      (t[20] = D));
  let k = D,
    A;
  t[21] !== h.providerIds || t[22] !== E || t[23] !== k
    ? ((A = (e) => {
        E != null && k({ source: `settings`, action: e, ...he(E, we(E), h.providerIds) });
      }),
      (t[21] = h.providerIds),
      (t[22] = E),
      (t[23] = k),
  ...
  t[28] !== h || t[29] !== j
    ? ((P = () => {
        (j(`skipped`), h.setImportDialogOpen(!1));
      }),
      (t[28] = h),
      (t[29] = j),
      (t[30] = P))
  ...
  let F = P,
    I;
  t[31] !== h.detectedItems || t[32] !== h.selectedImportProviderIds || t[33] !== E || t[34] !== f
    ? ((I =
        h.selectedImportProviderIds.length === 0
          ? E
          : Se({
              detectedItems: h.detectedItems,
              intl: f,
              providerIds: h.selectedImportProviderIds,
            })),
      (t[31] = h.detectedItems),
      (t[32] = h.selectedImportProviderIds),
      (t[33] = E),
      (t[34] = f),
      (t[35] = I))
    : (I = t[35]);
  let L = I,
    R;
  t[36] !== h || t[37] !== k || t[38] !== L || t[39] !== F || t[40] !== u
    ? ((R =
        h.importDialogStep === `providers`
          ? (0, Y.jsx)(
              ge,
              {
                variant: `dialog`,
                providerIds: h.providerIds,
                onCustomize: h.selectImportProviders,
                onContinue: h.selectImportProviders,
                onSkip: F,
              },
              h.providerIds.join(`,`),
            )
          : L == null
            ...
            : (0, Y.jsx)(
                Ee,
                {
                  ...
                  logShownOnMount: !1,
                  detectedProviderIds: h.providerIds,
                  providerIds: h.selectedImportProviderIds,
                  summary: L,
                  isPending: h.isImporting,
                  hasError: h.importDialogStatus === `error`,
                  continueLabel:
                    u === `general-row`
                      ? (0, Y.jsx)(S, {
                      ...
                      : (0, Y.jsx)(S, {
                          ...
                          defaultMessage: `Import to Opaline`,
                          description: `Button label to apply selected home-scoped external config migration items`,
                        }),
                  onSkip: () => h.setImportDialogOpen(!1),
                  onContinue: (e) => {
                    h.importSelection(e);
                  },
                  onEvent: k,
                },
                h.selectedImportProviderIds.join(`,`),
              )),
      (t[36] = h),
      (t[37] = k),
      (t[38] = L),
    ...
    : (R = t[41]);
  let z;
  t[42] !== h.isImportDialogOpen || t[43] !== h.setImportDialogOpen || t[44] !== R
    ? ((z = (0, Y.jsx)(U, {
        open: h.isImportDialogOpen,
        onOpenChange: h.setImportDialogOpen,
        size: `default`,
        children: R,
      })),
      (t[42] = h.isImportDialogOpen),
      (t[43] = h.setImportDialogOpen),
      (t[44] = R),
      (t[45] = z))
    : (z = t[45]);
  let B = z;
  if (u === `general-row`) {
    if (!o) return C;
    let e = E != null || h.remainingArtifacts.length > 0,
      r = E == null && h.remainingArtifacts.length > 0,
      i = h.latestImportedAtMs != null,
      a = h.lastCompletedImportProgress != null;
    if (!g && !e && !i && !a) return C;
    let s = h.isCompletedImportDialogOpen ? h.lastCompletedImportProgress : null,
      c;
    t[46] !== n ||
    t[47] !== h.closeCompletedImportDialog ||
    t[48] !== h.migrateRemainingArtifacts ||
    t[49] !== s
      ? ((c = (0, Y.jsx)(yt, {
          progress: s,
          opalineHome: n,
          onMigrateRemainingArtifacts: h.migrateRemainingArtifacts,
          onClose: h.closeCompletedImportDialog,
        })),
        (t[46] = n),
        (t[47] = h.closeCompletedImportDialog),
        (t[48] = h.migrateRemainingArtifacts),
    ...
    t[51] === i
      ...
      : ((u = i
        ...
        (t[52] = u));
    let d;
    t[53] !== h.latestImportedAtMs || t[54] !== i
      ? ((d = i
          ? (0, Y.jsx)(S, {
              ...
              values: {
                relativeTime: (0, Y.jsx)(ce, {
                  dateString: new Date(h.latestImportedAtMs ?? 0).toISOString(),
                }),
              },
            })
          : (0, Y.jsx)(S, {
        ...
        (t[53] = h.latestImportedAtMs),
        (t[54] = i),
        (t[55] = d))
      : (d = t[55]);
    let f = g || h.isImporting || (!e && (!i || !a)),
      p = !e && a ? h.openCompletedImportDialog : r ? h.openRemainingArtifactsDialog : N,
      m;
    t[56] !== h.isImporting || t[57] !== e || t[58] !== i || t[59] !== g || t[60] !== r
      ? ((m = h.isImporting
          ? (0, Y.jsx)(S, {
          ...
          : g
            ...
            : e
              ? r
                ? (0, Y.jsx)(S, {
                    id: `settings.general.importExternalAgent.continueWithOpaline`,
                    defaultMessage: `Continue with Opaline`,
                    description: `Button label to continue importing remaining external agent setup with Opaline`,
                  })
                : i
                  ? (0, Y.jsx)(S, {
      ...
      : (m = t[61]);
    let _;
    t[62] !== h.isImporting || t[63] !== f || t[64] !== p || t[65] !== m
      ? ((_ = (0, Y.jsx)(O, {
          color: `secondary`,
          size: `toolbar`,
          disabled: f,
          loading: h.isImporting,
          onClick: p,
          children: m,
        })),
        (t[62] = h.isImporting),
      ...
      : (_ = t[66]);
    let v;
    t[67] !== u || t[68] !== d || t[69] !== _
      ? ((v = (0, Y.jsx)(K, { id: Ne, label: u, description: d, control: _ })),
        (t[67] = u),
        (t[68] = d),
        (t[69] = _),
        (t[70] = v))
    ...
    let y = E == null ? null : B,
      b;
    return (
      t[71] !== l || t[72] !== C || t[73] !== v || t[74] !== y
        ? ((b = (0, Y.jsxs)(Y.Fragment, { children: [v, y, C, l] })),
          (t[71] = l),
          (t[72] = C),
          (t[73] = v),
          (t[74] = y),
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, Y.jsx)(pe.Header, {
        ...
        subtitle: (0, Y.jsx)(S, {
          ...
          defaultMessage: `Detected settings from another agent that can be added to Opaline`,
            ...
            children: g
              ? (0, Y.jsx)(q, {
                  children: (0, Y.jsx)(K, {
                    ...
                    control: (0, Y.jsx)(ne, { className: `h-4 w-4` }),
                  }),
                })
              : (0, Y.jsxs)(q, {
                  children: [
                    ...
                    te
                      ? (0, Y.jsx)(_t, {
                          artifacts: h.remainingArtifacts,
                          opalineHome: n,
                          disabled: h.isMigratingRemainingArtifacts,
                          selectedArtifactKeys: h.selectedRemainingArtifactKeys,
                          onCheckedChange: h.setRemainingArtifactSelected,
                        })
                      : null,
                    te
                      ? (0, Y.jsx)(K, {
                          label: (0, Y.jsx)(S, {
                            ...
                            description: `Summary label for external agent settings that can be migrated with Opaline`,
                            values: { count: h.selectedRemainingArtifacts.length },
                          }),
                          description: (0, Y.jsx)(S, {
                            ...
                            description: `Summary description for external agent settings that can be migrated with Opaline`,
                          }),
                          control: (0, Y.jsxs)(O, {
                            color: `secondary`,
                            size: `toolbar`,
                            loading: h.isMigratingRemainingArtifacts,
                            disabled: h.selectedRemainingArtifacts.length === 0,
                            onClick: () => {
                              h.migrateRemainingArtifacts(h.selectedRemainingArtifacts);
                            },
                            children: [
                              (0, Y.jsx)(`span`, {
                                children: (0, Y.jsx)(S, {
                                  id: `settings.agent.importSettings.remaining.continueInOpaline`,
                                  defaultMessage: `Continue in Opaline`,
                                  description: `Button label to start a Opaline chat for external agent settings that cannot be imported automatically`,
                                }),
                              }),
                              (0, Y.jsx)(le, { className: `icon-xs` }),
                            ],
                          }),
                        })
                      : null,
  ...
  return (
    t[85] !== C || t[86] !== H
      ? ((W = (0, Y.jsxs)(Y.Fragment, { children: [H, C] })), (t[85] = C), (t[86] = H), (t[87] = W))
      : (W = t[87]),
    W
  );
}
...
function ht({
  ...
  let o = m(_),
    ...
    { ensureSkillByName: g, installSkill: v } = fe({ hostId: t, loadOnMount: !1 }),
    x = De({ enabled: r, isCoworkMigrationEnabled: n, workspaceRoots: a }),
    ee = Te({ detectedItems: x.detectedItems, isCoworkMigrationEnabled: n }),
    D =
      y(`external-agent-import-status`, {
    ...
    [H, U] = (0, J.useState)(!1),
    [W, G] = (0, J.useState)(!1),
    [ie, oe] = (0, J.useState)(`items`),
    [se, ce] = (0, J.useState)([]),
    [le, ue] = (0, J.useState)(`idle`),
    K = et({ items: x.detectedItems, opalineHome: e, isEnabled: u }),
    q = (0, J.useMemo)(
      () =>
        Object.fromEntries(
          K.map((e) => {
    ...
    we = async ({ providerIds: n, selection: r }) => {
      if ((ue(`idle`), !x.hasImportableItems)) {
        G(!1);
        return;
      }
      let a =
        n.length === 0
          ? x.getSelectedItems(r)
          : be({ detectedItems: x.detectedItems, providerIds: n, selection: r });
      if (a.length === 0) {
        G(!1);
        return;
      }
          ...
          content: ({ close: e, level: t }) =>
            (0, Y.jsx)(de, {
              ...
              children: (0, Y.jsxs)(`div`, {
                ...
                children: [
                  (0, Y.jsx)(ne, { className: `icon-sm text-token-text-secondary` }),
                  (0, Y.jsx)(S, {
      ...
      try {
        d = `import`;
        let { projectRoots: n } = await x.importItems(a);
        ((f = n.length),
          (d = `complete_import`),
          await me({
            hostId: t,
            onImportedProjectRootsReady: (e) => {
              te(o, w({ collapsedGroups: l, importedProjectRoots: e }));
            },
        ...
        let r = await x.refetchDetectedItems();
        ((d = `invalidate_queries`),
          await Promise.all([
            Ce(s),
            s.invalidateQueries({ queryKey: b(`opaline-agents-md`) }),
            n.length === 0
              ? Promise.resolve()
              : s.invalidateQueries({ queryKey: b(`workspace-root-options`, { hostId: t }) }),
          ]));
        let h = {
          status: `success`,
          items: a,
          remainingArtifacts: et({ items: r, opalineHome: e, isEnabled: u }),
        };
        ((p = h.remainingArtifacts.length),
          N(h),
          z(Date.now()),
          h.remainingArtifacts.length > 0 && F(!0),
          i?.(),
          m.success(
            (0, Y.jsx)(S, {
  ...
  return {
    ...
    importChoices: x.choices,
    importDialogStep: ie,
    importDialogStatus: le,
    importSelection: (e) => we({ providerIds: se, selection: e }),
    isImportDialogOpen: W,
    isCompletedImportDialogOpen: P,
    isDetecting: x.isDetecting,
    isImporting: xe,
    isMigratingRemainingArtifacts: A,
    isRemainingArtifactsDialogOpen: H,
    lastCompletedImportProgress: M,
    ...
    openImportDialog: () => {
      (ue(`idle`), ce(ee), oe(`providers`), G(!0));
    },
    openRemainingArtifactsDialog: () => {
      !xe && K.length > 0 && U(!0);
    },
    detectedItems: x.detectedItems,
    remainingArtifacts: K,
    providerIds: ee,
    selectImportProviders: Se,
    unsupportedProjects: x.unsupportedProjects,
...
function gt(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Y.jsx)(`div`, { className: `shrink-0 font-medium`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function _t(e) {
  let t = (0, Z.c)(13),
    { artifacts: n, opalineHome: r, disabled: i, onCheckedChange: a, selectedArtifactKeys: o } = e,
    s;
  ...
  return (
    t[11] === s
      ? (c = t[12])
      : ((c = (0, Y.jsx)(Y.Fragment, { children: s })), (t[11] = s), (t[12] = c)),
    c
  );
}
function vt(e) {
    ...
    : ((l =
        s === `user`
          ? (0, Y.jsx)(S, {
              ...
              description: `Section title for user-level external agent settings that can be migrated with Opaline`,
            })
          : (0, Y.jsx)(S, {
              id: `settings.agent.importSettings.remaining.currentProjectSettingsSection`,
              defaultMessage: `Current project`,
              description: `Section title for project-level external agent settings that can be migrated with Opaline`,
            })),
      (t[4] = s),
      (t[5] = l));
  let u;
  t[6] !== c || t[7] !== l
    ? ((u = (0, Y.jsx)(gt, { path: c, title: l })), (t[6] = c), (t[7] = l), (t[8] = u))
    : (u = t[8]);
  let d;
          ...
          (0, Y.jsx)(
            K,
            {
              ...
              description: (0, Y.jsx)(S, {
                ...
                defaultMessage: `Migrate {path} with Opaline`,
                description: `Description for an external agent setting that can be migrated with Opaline`,
                values: { path: Bt(e) },
              }),
              control: (0, Y.jsx)(oe, {
  ...
  return (
    t[18] !== u || t[19] !== d
      ? ((f = (0, Y.jsxs)(Y.Fragment, { children: [u, d] })), (t[18] = u), (t[19] = d), (t[20] = f))
      : (f = t[20]),
    f
  );
}
function yt({ opalineHome: e, progress: t, onMigrateRemainingArtifacts: n, onClose: r }) {
  let i = x(),
    [a, o] = (0, J.useState)(!1),
    s = (0, J.useRef)(null),
    [c, l] = (0, J.useState)(!1),
  ...
  (0, J.useEffect)(() => {
    let e = window.requestAnimationFrame(m);
    return () => {
            ...
            children: [
              ...
              !f && t != null && t.items.length > 0
                ? (0, Y.jsx)(V, {
                    ...
                    children: (0, Y.jsx)(Et, { opalineHome: e, items: t.items, status: t.status }),
                  })
                : null,
              !u && d.length > 0
                ? (0, Y.jsxs)(Y.Fragment, {
                          ...
                          children: [
                            ...
                            (0, Y.jsx)(O, {
                              ...
                              children: (0, Y.jsx)(`span`, {
                                children: (0, Y.jsx)(S, {
                                  id: `settings.agent.importSettings.progress.continueInOpaline`,
                                  defaultMessage: `Continue with Opaline`,
                                  description: `Button label to start a Opaline chat for remaining external agent config artifacts`,
                                }),
                              }),
                            }),
                          ],
...
function bt(e) {
  ...
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, Y.jsx)(`div`, { className: `flex flex-col gap-2`, children: r })),
        (t[2] = r),
        (t[3] = i)),
    i
  );
...
function St(e) {
  ...
  let c;
  t[8] !== o || t[9] !== s
    ? ((c = (0, Y.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [o, s] })),
      (t[8] = o),
      (t[9] = s),
      (t[10] = c))
    : (c = t[10]);
...
function Ct(e) {
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((a = (0, Y.jsxs)(Y.Fragment, { children: [r, i] })), (t[2] = r), (t[3] = i), (t[4] = a))
      : (a = t[4]),
    a
  );
}
function wt(e) {
  ...
  switch (n) {
    case `commands`: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(z, { className: `icon-sm` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    ...
    case `mcp`: {
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(B, { className: `icon-sm` })), (t[2] = e))
          : (e = t[2]),
        e
      );
    }
    case `plugins`: {
      ...
      return (
        t[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(M, { className: `icon-sm` })), (t[3] = e))
          : (e = t[3]),
        e
      );
    }
    case `subagents`: {
      ...
      return (
        t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(ue, { className: `icon-sm` })), (t[4] = e))
          : (e = t[4]),
        e
      );
    }
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(S, {
              ...
              description: `Label for Claude slash commands that can be migrated with Opaline`,
            })),
            (t[0] = e))
          : (e = t[0]),
        e
      ...
      return (
        t[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(S, {
              ...
              description: `Label for Claude hooks that can be migrated with Opaline`,
            })),
            (t[1] = e))
          : (e = t[1]),
        e
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(S, {
              ...
              defaultMessage: `MCP`,
              description: `Label for MCP configuration that can be migrated with Opaline`,
            })),
            (t[2] = e))
          : (e = t[2]),
        e
      ...
      return (
        t[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(S, {
              ...
              description: `Label for Claude plugins that can be migrated with Opaline`,
            })),
            (t[3] = e))
          : (e = t[3]),
        e
      ...
      return (
        t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(S, {
              ...
              description: `Label for Claude subagents that can be migrated with Opaline`,
            })),
            (t[4] = e))
          : (e = t[4]),
        e
...
function Et(e) {
  let t = (0, Z.c)(10),
    { opalineHome: n, items: r, status: i } = e,
    a,
    o,
    s;
        ...
        e.length > 0
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
                ...
                e.map((e) => (0, Y.jsx)(kt, { opalineHome: n, item: e, status: i }, Vt(e))),
              ],
            })
          : null),
      (s =
        c.length > 0
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
                ...
                c.map((e) => (0, Y.jsx)(kt, { opalineHome: n, item: e, status: i }, Vt(e))),
              ],
            })
          : null),
      (t[0] = n),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, Y.jsxs)(a, { children: [o, s] })), (t[6] = a), (t[7] = o), (t[8] = s), (t[9] = c))
      : (c = t[9]),
    c
  );
}
...
function kt(e) {
  let t = (0, Z.c)(13),
    { opalineHome: n, item: r, status: i } = e,
    a = x(),
    o;
  t[0] !== a || t[1] !== r ? ((o = ke(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((s = Ft(r, n, i)), (t[3] = n), (t[4] = r), (t[5] = i), (t[6] = s))
    : (s = t[6]);
  let c;
  t[7] === i ? (c = t[8]) : ((c = (0, Y.jsx)(At, { status: i })), (t[7] = i), (t[8] = c));
  let l;
  return (
    t[9] !== o || t[10] !== s || t[11] !== c
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Y.jsx)(`span`, {
            ...
            children: (0, Y.jsx)(G, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Y.jsx)(`span`, {
          ...
          children: (0, Y.jsx)(N, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function jt(e) {
  return e === `success`
    ...
    : e === `error`
      ? (0, Y.jsx)(se, { className: `icon-md text-token-danger` })
      : (0, Y.jsx)(ne, { className: `icon-md` });
}
function Mt(e) {
  return e === `success`
  ...
  return t === `success`
    ? e != null && e.items.length === 0 && e.remainingArtifacts.length > 0
      ? (0, Y.jsx)(S, {
          ...
          description: `Title shown when external agent setup can be migrated by Opaline but no direct imports were available`,
        })
      : (0, Y.jsx)(S, {
  ...
  return t === `success`
    ? e != null && e.items.length === 0 && e.remainingArtifacts.length > 0
      ? (0, Y.jsx)(S, {
          ...
          defaultMessage: `Opaline found additional setup that requires extra steps to import.`,
          description: `Subtitle shown when external agent setup can be migrated by Opaline but no direct imports were available`,
        })
      : (0, Y.jsx)(S, {
          id: `settings.agent.importSettings.progress.successSubtitle`,
          defaultMessage: `Selected config was copied into Opaline`,
...
function Ft(e, t, n) {
  ...
  if (e.cwd == null || e.cwd === ``) {
    let e = r
      ...
      .replace(/\/Users\/[^/]+\/\.opaline/g, `~/.opaline`)
      .replace(/\/Users\/[^/]+\/\.agents/g, `~/.agents`)
      .replace(
        /\/private\/var\/folders\/\S+\/opaline-electron-dev\/onboarding-flow-[^/\s]+\/opaline-home/g,
        `~/.opaline`,
      )
      .replace(
        /\/private\/var\/folders\/\S+\/opaline-electron-dev\/onboarding-flow-[^/\s]+\/\.agents/g,
        `~/.agents`,
      );
    if (t != null && t !== ``) {
      let n = Je(t);
      ((e = e.split(t).join(`~/.opaline`)),
...
//# sourceMappingURL=gpu-tearing-debug-settings-D7jJL1Wa.js.map

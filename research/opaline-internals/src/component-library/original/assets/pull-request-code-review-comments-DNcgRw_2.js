...
import { Ea as n, Ka as r, Na as i } from "./app-server-manager-signals-BOGyjFm3.js";
import { t as a } from "./jsx-runtime-CiQ1k8xo.js";
...
import { r as l } from "./right-panel-composer-overlay-scroll-reserve-C9VI_5j1.js";
import { n as u, r as d } from "./file-tree-search-input-DWq_lg9v.js";
var f = {
  hunkLineCount: 50,
  lineHeight: 12 * 1.8,
  diffHeaderHeight: 0,
...
function x(e) {
  let n = (0, y.c)(41),
    ...
    g = m === void 0 ? !1 : m,
    _;
  n[0] === a ? (_ = n[1]) : ((_ = a == null ? null : t(a)), (n[0] = a), (n[1] = _));
  let x = _,
    E;
  ...
  bb0: {
    ...
    let e;
    (n[10] === f ? (e = n[11]) : ((e = M(f.values())), (n[10] = f), (n[11] = e)), (I = e));
  }
  let L = I,
    R;
  n[12] !== f || n[13] !== N
  ...
  let G = W,
    K;
  n[26] === g ? (K = n[27]) : ((K = g ? { paddingBottom: l } : void 0), (n[26] = g), (n[27] = K));
  let q;
  n[28] !== V ||
  n[29] !== L ||
  n[30] !== F ||
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, b.jsx)(`div`, {
          ...
          children: (0, b.jsx)(s, {
            id: `opaline.review.fileSearch.empty`,
...
function j(e) {
  let t = N(e);
  return { height: D, name: `review-file-tree-comment-${e}`, viewBox: `0 0 ${t} ${D}`, width: t };
}
function M(e) {
...
function I({ currentComments: e, nextComments: t }) {
  let r = new Set(e.map(n)),
    i = t.filter((t) => e.some((e) => B({ currentComment: e, nextComment: t }))),
...
function z({ comments: e, filePaths: t, workspaceRoot: n }) {
  let r = new Map();
  for (let a of e) {
    let e = t.find((e) => i(a.position.path, e, n ?? void 0));
...
export { L as a, f as c, I as i, m as l, F as n, w as o, z as r, x as s, R as t, p as u };
//# sourceMappingURL=pull-request-code-review-comments-DNcgRw_2.js.map

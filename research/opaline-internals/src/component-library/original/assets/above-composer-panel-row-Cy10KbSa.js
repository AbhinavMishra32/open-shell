...
import { Ur as t, wt as n } from "./src-CYrn1fYL.js";
import { Ca as r } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { r as c } from "./lib-MoKmYgcO.js";
import { r as l } from "./composer-top-menu-chrome-4snk27KP.js";
var u = s(),
  d = e(i(), 1),
  f = a(),
  p = (0, d.createContext)({ expandedTopTray: !1, hasAboveComposerPortalContent: !1 });
function m(e) {
  let t = (0, u.c)(14),
    { className: n, expandedTopTray: r, hasAboveComposerPortalContent: i, children: a } = e,
    s = r === void 0 ? !1 : r,
    c = i === void 0 ? !1 : i,
    d;
  t[0] === n ? (d = t[1]) : ((d = o(`order-2 flex min-w-0 flex-col`, n)), (t[0] = n), (t[1] = d));
  let m;
  t[2] !== a || t[3] !== d
    ? ((m = (0, f.jsx)(`div`, { className: d, children: a })), (t[2] = a), (t[3] = d), (t[4] = m))
    : (m = t[4]);
  let h = m,
    g;
  t[5] !== s || t[6] !== c
  ...
  let _;
  t[8] !== s || t[9] !== h
    ? ((_ = s ? (0, f.jsx)(l, { expandedTopTray: !0, inFlow: !0, children: h }) : h),
      (t[8] = s),
      (t[9] = h),
      (t[10] = _))
    : (_ = t[10]);
...
function h(e) {
  let t = (0, u.c)(7),
    ...
    { expandedTopTray: i, hasAboveComposerPortalContent: a } = (0, d.useContext)(p),
    s =
      !i &&
  ...
  return (
    t[4] !== r || t[5] !== l
      ? ((m = (0, f.jsx)(`div`, { className: l, children: r })), (t[4] = r), (t[5] = l), (t[6] = m))
      : (m = t[6]),
    m
  );
}
function g(e) {
  let i = [],
    ...
    o = [];
  for (let s of e) {
    if (s.localBrowserDesignChange != null) {
      a.push(s);
      continue;
    }
    t(s) || r(s) || n(s) ? i.push(s) : o.push(s);
  }
  return {
    annotationCommentAttachments: i,
    designTweakCommentAttachments: a,
...
function v(e) {
  let { annotationCommentAttachments: t, designTweakCommentAttachments: n } = g(e);
  return [...t, ...n];
}
var y = c({
  annotationCount: {
...
function C(e, { annotationCount: t, commentCount: n, designTweakCount: r = 0 }) {
  let i = t + r;
  return i > 0 && n > 0
...
function w(e) {
  ...
  t[9] === r
    ? (p = t[10])
    : ((p = o(`group flex min-w-0 items-center justify-between gap-2 py-0.5 text-sm`, r)),
      (t[9] = r),
      (t[10] = p));
  let m;
  t[11] === i
    ...
    : ((m =
      ...
      (t[12] = m));
  let h;
  t[13] === l ? (h = t[14]) : ((h = o(`min-w-0 flex-1 leading-4`, l)), (t[13] = l), (t[14] = h));
  let g;
  t[15] === a
    ? (g = t[16])
    : ((g =
  ...
  t[24] !== n || t[25] !== d
    ? ((y =
        d != null || n != null
          ? (0, f.jsxs)(`div`, { className: `flex shrink-0 items-center gap-1`, children: [d, n] })
          : null),
      (t[24] = n),
      (t[25] = d),
      (t[26] = y))
...
export { _ as a, m as c, S as i, h as l, x as n, v as o, C as r, g as s, w as t };
//# sourceMappingURL=above-composer-panel-row-Cy10KbSa.js.map

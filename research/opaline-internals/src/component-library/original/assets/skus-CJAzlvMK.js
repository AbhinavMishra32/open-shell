...
function t(t) {
  return t === e.EDUCATION_CBP || t === e.DEPRECATED_EDU || t === e.DEPRECATED_EDU_2 || t === `k12`;
}
function n(t) {
  return t === e.QUORUM;
}
...
function a(t) {
  return t === e.SELF_SERVE_BUSINESS_USAGE_BASED || t === e.ENTERPRISE_CBP_USAGE_BASED;
}
export { a as i, i as n, r, e as t };
//# sourceMappingURL=skus-CJAzlvMK.js.map

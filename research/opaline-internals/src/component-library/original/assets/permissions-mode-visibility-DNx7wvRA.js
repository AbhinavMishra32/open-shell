...
var i = n(),
  ...
  o = { "guardian-approvals": !0, "full-access": !0 },
  s = r(`composer-permission-mode-visibility`, o);
function c(e) {
  return e ?? o;
}
function l({ mode: e, visible: t, settings: n }) {
  return { ...c(n), [e]: t };
}
function u({
...
function d({ availableAgentModes: e, visibility: t }) {
  return e.filter((e) => {
    switch (e) {
...
function f({ availableAgentModes: e, visibleAgentModes: t }) {
  return e.includes(`custom`) ? [...t, `custom`] : t;
}
export { d as a, f as i, c as n, l as o, u as r, a as s, s as t };
//# sourceMappingURL=permissions-mode-visibility-DNx7wvRA.js.map

...
import { io as t } from "./app-server-manager-signals-BOGyjFm3.js";
import { n, t as r } from "./jsx-runtime-CiQ1k8xo.js";
import { t as i } from "./clsx-BcPLHiun.js";
import { F as a, I as o, L as s, h as c, lt as l } from "./vscode-api-sUstfl-x.js";
...
import { t as m } from "./thread-context-inputs-BUuWvrJW.js";
import { n as ee, t as h } from "./remote-connection-visibility-CDSfTp_2.js";
import { t as g } from "./tooltip-BhXPONlb.js";
import { t as _ } from "./button-Xd4Hy1MO.js";
import { a as te } from "./remote-projects-nghNpfPT.js";
import { n as v } from "./composer-footer-CY-87K58.js";
import { n as y, t as b } from "./home-row-layout-Bg0vpkRi.js";
import { t as ne } from "./with-window-DPMmD2K-.js";
import { t as x } from "./use-is-remote-host-CF_VnSMh.js";
import { t as S } from "./folder-DTP6uOAM.js";
import { i as C, n as w, r as T, t as E } from "./open-project-setup-dialog-DowmE55I.js";
import { r as D } from "./local-projects-CzDObGPq.js";
import { t as O } from "./check-md-CZTnvSiA.js";
import { t as re } from "./select-project-Cy94qDrW.js";
import { g as k, l as A, u as ie } from "./sidebar-project-group-signals-h0Ffvrar.js";
import { S as j, t as ae } from "./sidebar-thread-list-signals-B88Sg0Wa.js";
import { t as oe } from "./compose-CUJaEiS-.js";
import { n as se, t as ce } from "./add-project-menu-items-Dp6OGTyC.js";
import { a as M, i as N, r as P, t as le } from "./dropdown-CHaZfyxI.js";
import { t as ue } from "./globe-DyuVFbAy.js";
import { t as de } from "./chevron-D6hquBJC.js";
import { t as fe } from "./workspace-root-icon-bRI5Tzou.js";
import { t as pe } from "./plus-_AqggHDM.js";
import { t as me } from "./use-connected-remote-connections-fvh51TCi.js";
import { p as he } from "./thread-handoff-composer-block-state-CMMXim8r.js";
var ge = `1257656532`,
  _e = e(n()),
  F = r(),
  ve = (e) =>
...
function be(e) {
  ...
  if (
    ...
    (r.forEach((e) => {
      ...
      let t = o.get(e.label);
      if (t == null) {
        o.set(e.label, [e.path]);
        return;
      }
      t.push(e.path);
    }),
      (b = g || l != null || f != null || p != null));
    let s;
    ...
    (n[17] === h
      ...
      : ((c = h.formatMessage({
        ...
        (n[18] = c)),
      n[19] !== _ || n[20] !== c
        ? ((C = (0, F.jsx)(M, { value: _, onChange: s, placeholder: c, className: `mb-1` })),
          (n[19] = _),
          (n[20] = c),
          (n[21] = C))
        : (C = n[21]),
      (v = P.Section),
      (x = `flex max-h-[calc((1lh+var(--padding-row-y)*2)*5)] flex-col overflow-y-auto text-sm [--edge-fade-distance:1.5rem]`),
      (S = y.map((e) => {
        let n = e.repositoryData?.rootFolder,
          r = n && n !== e.label,
          s = !!e.isOpalineWorktree,
          c = o.get(e.label) ?? [],
        ...
        return (0, F.jsx)(
          `div`,
          {
            ...
            children: (0, F.jsxs)(N, {
              RightIcon: i.includes(e.projectId) ? O : void 0,
              tooltipText: l ?? void 0,
              tooltipAlign: `center`,
              onSelect: (t) => {
                (ee && t.preventDefault(), a(e.projectId));
              },
              children: [
                (0, F.jsx)(P.ItemIcon, {
                  size: `xs`,
      ...
      (n[14] = S),
      (n[15] = C));
  } else ((v = n[10]), (y = n[11]), (b = n[12]), (x = n[13]), (S = n[14]), (C = n[15]));
  let w;
  n[22] !== m || n[23] !== y.length
    ? ((w =
        y.length === 0
          ? (0, F.jsx)(`div`, {
    ...
    : (w = n[24]);
  let T;
  n[25] !== v || n[26] !== x || n[27] !== S || n[28] !== w
    ? ((T = (0, F.jsxs)(v, { className: x, children: [S, w] })),
      (n[25] = v),
      (n[26] = x),
      (n[27] = S),
      (n[28] = w),
                ...
                (0, F.jsxs)(P.Section, {
                  ...
                  children: [
                    ...
                    p
                      ...
                      : null,
                    g ? (0, F.jsx)(N, { LeftIcon: ve, onSelect: c, children: s }) : null,
                  ],
                }),
              ],
            }),
  ...
  let D;
  return (
    n[38] !== C || n[39] !== T || n[40] !== E
      ? ((D = (0, F.jsxs)(F.Fragment, { children: [C, T, E] })),
        (n[38] = C),
        (n[39] = T),
        (n[40] = E),
        (n[41] = D))
...
var xe = s(c, ({ get: e }) => {
  let t = e(k),
    n = e(A, { threadKeys: t, enabled: !0 }).groups,
    r = new Map(e(e(ae, t)).map((e) => [e.task.key, e]));
  return j(e(ie), n, r);
});
function I(e) {
  let t = (0, ye.c)(81),
    ...
    Ee = n !== void 0,
    De = !R,
    { selectedRemoteProject: Oe, selectedRemoteProjectId: ke } = te(),
    { remoteConnections: Ae } = h(),
    je = me(Ae),
    { data: Me, isLoading: Ne } = o(m),
    B = ie && Te && !R && je.length > 0,
    Pe = (e) => {
      f(N, { eventName: `opaline_app_workspace_root_selected` });
      let t = L.find((t) => t.projectId === e);
      if (t == null) return;
      if ((he(N, t), t.projectKind === `remote`)) {
        re(N, { projectId: t.projectId, projectKind: `remote` });
        return;
      }
      let n = D.select(N, t);
      u?.(n);
  ...
  t[0] !== N || t[1] !== z
    ? ((Fe = () => {
        if ((f(N, { eventName: `opaline_app_workspace_root_add_clicked` }), z)) {
          w(N);
          return;
        }
        C();
  ...
  t[6] === N
    ? (Ie = t[7])
    : ((Ie = () => {
        (f(N, { eventName: `opaline_app_workspace_root_add_clicked` }), T({ setActive: !0 }));
      }),
      (t[6] = N),
      (t[7] = Ie));
  let Le = Ie,
  ...
  let G = W == null && De,
    Be = De && W != null,
    Ve = M === `home` && L.length === 0 && !R;
  if (!Ee && Ne && Me == null && !Ve && ke == null) return null;
  let K =
      W == null
        ? null
        : Ce({ activeProjectId: W, groups: L, remoteConnections: Ae, selectedRemoteProject: Oe }),
    He =
      K?.hostDisplayName == null
        ? (K?.label ?? K?.path ?? null)
        : `${K.label} · ${K.hostDisplayName}`,
    Ue;
  t[11] !== K?.label || t[12] !== G
    ? ((Ue =
        K?.label ??
  ...
  let qe = Ke,
    Je;
  t[19] !== K?.isOpalineWorktree ||
  t[20] !== K?.projectKind ||
  t[21] !== K?.repositoryData ||
  t[22] !== q ||
  t[23] !== ae ||
  t[24] !== G
    ? ((Je = () =>
        (0, F.jsx)(g, {
          tooltipContent: (0, F.jsx)(d, {
          ...
          children: (0, F.jsxs)(_, {
            ...
            children: [
              G
                ? (0, F.jsx)(oe, { className: `icon-2xs shrink-0` })
                : (0, F.jsx)(fe, {
                    isOpalineWorktree: !!K?.isOpalineWorktree,
                    isGitRepository: K?.repositoryData != null,
                    isRemoteProject: K?.projectKind === `remote`,
            ...
            (0, F.jsxs)(b, {
              children: [
                (0, F.jsx)(y, {
                  children:
                    G || K == null
                      ? (0, F.jsx)(se, { className: `icon-xs shrink-0` })
                      : (0, F.jsx)(fe, {
                          isOpalineWorktree: !!K?.isOpalineWorktree,
                          isGitRepository: K?.repositoryData != null,
                          isRemoteProject: K?.projectKind === `remote`,
                ...
                (0, F.jsx)(v, { collapse: `xs`, className: `max-w-40 truncate`, children: We }),
              ],
            }),
            (0, F.jsx)(de, {
              className: `icon-2xs shrink-0 text-token-input-placeholder-foreground`,
    ...
    ? ((Ze = () =>
        (0, F.jsxs)(`button`, {
          className: i(
            ...
            j ? `cursor-default opacity-60` : `cursor-interaction`,
          ),
          type: `button`,
          disabled: j,
          children: [
            (0, F.jsx)(`span`, {
              ...
              children: (0, F.jsx)(`span`, { className: `min-w-0 truncate`, children: q }),
            }),
            (0, F.jsx)(de, {
  ...
  if (Ve) {
    if (z && !B) {
      ...
      return (
        t[34] !== U || t[35] !== J
          ? ((e = J({ onClick: U })), (t[34] = U), (t[35] = J), (t[36] = e))
          : (e = t[36]),
        e
      );
    }
    ...
    return (
      ...
      t[49] !== n
        ? ((r = (0, F.jsx)(ce, {
            localProjectSourcesEnabled: z,
            open: O,
            onOpenChange: k,
            triggerButton: e,
            onStartFromScratch: U,
  ...
  t[51] === U
    ? (Y = t[52])
    : ((Y = (e) => {
        I.current && ((I.current = !1), e.preventDefault(), U());
      }),
      (t[51] = U),
      (t[52] = Y));
  let $e = M === `hero` ? `center` : `start`,
    X;
  t[53] !== Ye || t[54] !== Qe || t[55] !== J || t[56] !== A || t[57] !== M
    ? ((X = A ?? (M === `hero` ? Qe() : M === `home` ? J() : Ye())),
      (t[53] = Ye),
      (t[54] = Qe),
      (t[55] = J),
      (t[56] = A),
    ...
    : (X = t[58]);
  let Z;
  t[59] === W ? (Z = t[60]) : ((Z = W ? [W] : []), (t[59] = W), (t[60] = Z));
  let et;
  ...
  let nt = B ? Le : void 0,
    $;
  t[66] !== L || t[67] !== Pe || t[68] !== Z || t[69] !== tt || t[70] !== Q || t[71] !== nt
    ? (($ = (0, F.jsx)(be, {
        groups: L,
        selectedProjectIds: Z,
        onSelectProjectId: Pe,
        projectlessActionLabel: et,
        onSelectProjectless: tt,
        footerItems: Q,
        onAddRemoteProject: nt,
      })),
      (t[66] = L),
      (t[67] = Pe),
      (t[68] = Z),
...
function Ce({ activeProjectId: e, groups: t, remoteConnections: n, selectedRemoteProject: r }) {
...
//# sourceMappingURL=local-active-workspace-root-dropdown-BEoxvNdS.js.map

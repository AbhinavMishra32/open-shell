...
var a = {
  ...
  fe = i(O, `u`).replace(/punct/g, C).getRegex(),
  k = i(O, `u`).replace(/punct/g, E).getRegex(),
  A = `^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,
  pe = i(A, `gu`)
  ...
  N = i(/^!?\[(ref)\](?:\[\])?/)
    .replace(`ref`, h)
    .getRegex(),
  xe = i(`reflink|nolink(?!\\()`, `g`).replace(`reflink`, M).replace(`nolink`, N).getRegex(),
  P = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
  F = {
    _backpedal: r,
    anyPunctuation: ge,
    autolink: _e,
  ...
  L = { normal: y, gfm: ae, pedantic: oe },
  R = { normal: F, gfm: I, breaks: Ce, pedantic: Se },
  we = { "&": `&amp;`, "<": `&lt;`, ">": `&gt;`, '"': `&quot;`, "'": `&#39;` },
  z = (e) => we[e];
function B(e, t) {
  if (t) {
    if (a.escapeTest.test(e)) return e.replace(a.escapeReplace, z);
  } else if (a.escapeTestNoEncode.test(e)) return e.replace(a.escapeReplaceNoEncode, z);
  return e;
}
function V(e) {
  try {
...
`,
              ...
              if (
                ((l = f),
                this.options.pedantic
                  ? ((l = l.replace(this.rules.other.listReplaceNesting, `  `)), (p = l))
...
`),
          ...
          (this.options.gfm &&
            ...
            f && ((p = f[0] !== `[ ] `), (s = s.replace(this.rules.other.listReplaceTask, ``)))),
            i.items.push({
              type: `list_item`,
              raw: r,
              task: !!f,
...
`
  ...
  K = class e {
    ...
    constructor(e) {
      ...
      let n = { other: a, block: L.normal, inline: R.normal };
      (this.options.pedantic
        ? ((n.block = L.pedantic), (n.inline = R.pedantic))
        : this.options.gfm &&
          ((n.block = L.gfm), this.options.breaks ? (n.inline = R.breaks) : (n.inline = R.gfm)),
...
`,
    ...
    blockTokens(e, t = [], n = !1) {
      for (
        this.options.pedantic && (e = e.replace(a.tabCharGlobal, `    `).replace(a.spaceLine, ``));
        e;
      ) {
        let r;
        if (
          ...
          ? e.tokens[0]?.type === `paragraph`
            ? ((e.tokens[0].text = n + ` ` + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                ((e.tokens[0].tokens[0].text = n + ` ` + B(e.tokens[0].tokens[0].text)),
          ...
          if (e.hooks) {
            ...
            for (let n in e.hooks) {
              ...
              X.passThroughHooks.has(n)
                ? (t[r] = (e) => {
                    if (this.defaults.async && X.passThroughHooksRespectAsync.has(n))
                      return (async () => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            let n = i.hooks ? await i.hooks.preprocess(t) : t,
              r = await (i.hooks ? await i.hooks.provideLexer() : e ? K.lex : K.lexInline)(n, i),
              a = i.hooks ? await i.hooks.processAllTokens(r) : r;
            i.walkTokens && (await Promise.all(this.walkTokens(a, i.walkTokens)));
            let o = await (i.hooks ? await i.hooks.provideParser() : e ? Y.parse : Y.parseInline)(
              a,
              i,
            );
...
(($.options = $.setOptions =
  ...
  K.lex);
export { $ as n, Z as t };
//# sourceMappingURL=marked.esm-BR-H6018.js.map

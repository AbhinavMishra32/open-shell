...
import { $i as t, C as n, Vi as r, aa as i, ia as a } from "./src-CYrn1fYL.js";
import { n as o } from "./jsx-runtime-CiQ1k8xo.js";
import { l as s, lt as c } from "./vscode-api-sUstfl-x.js";
import { a as l, n as u } from "./request-BXHjsnqU.js";
import { n as d } from "./setting-storage-Cel8Tr7E.js";
var f = 0.0025,
  ee = 48e3;
function p(e) {
...
var m = `gpt-5.4-mini`,
  h = t({
    output: r(t({ type: a(), content: r(t({ type: a(), text: a().optional() })).optional() })),
  }),
  g = t({
    type: a().optional(),
    delta: a().optional(),
    text: a().optional(),
    response: h.optional(),
    error: i([a(), t({ message: a().optional() })]).optional(),
  }).passthrough();
async function _({ instructions: e, input: t, model: n = m }) {
  ...
  let i = {
    model: n,
    instructions: e,
    input: [{ type: `message`, role: `user`, content: [{ type: `input_text`, text: r }] }],
    tools: [],
    tool_choice: `none`,
...
function v(e) {
  return new Promise((t, n) => {
    ...
    function l(e) {
      o || ((o = !0), a != null && s.getInstance().cancelStream(a), n(e));
    }
    a = s.getInstance().stream(`POST`, `/opaline/responses`, {
      body: e,
      headers: u(),
      onEvent: (e) => {
        let t = y(e);
        ...
        (t.delta != null && r.push(t.delta), t.completedText != null && (i = t.completedText));
      },
      onError: (e) => {
        l(Error(e.error));
      },
  ...
  return n == null
    ? t.response == null
      ? t.type === `response.output_text.delta` && t.delta != null
        ? { delta: t.delta, completedText: null, error: null }
...
async function k() {
  let e = T.safeParse(await d(n.dictationDictionary));
  return e.success
    ? e.data
        .map((e) => e.trim())
        .filter((e) => e.length > 0)
...
async function A(e, t = {}) {
  let n = t.contentType ?? (e.type && e.type.trim().length > 0 ? e.type : `audio/webm`),
    r = n.split(/[/;]/)[1] ?? `webm`,
    i = M(t.filename ?? `opaline.${r}`),
    a = N(),
    o = l(await j({ blob: e, boundary: a, filename: i, contentType: n, language: t.language })),
    c = { "Content-Type": `multipart/form-data; boundary=${a}`, "X-Opaline-Base64": `1`, ...u() };
  return (await s.getInstance().post(`/transcribe`, o, c)).body.text;
}
async function j({ blob: e, boundary: t, filename: n, contentType: r, language: i }) {
  let a = new TextEncoder(),
    o = [],
    s = new Uint8Array(await e.arrayBuffer());
  return (
    o.push(a.encode(`--${t}\r\n`)),
    o.push(a.encode(`Content-Disposition: form-data; name="file"; filename="${n}"\r\n`)),
...
function N() {
  return typeof crypto < `u` && `randomUUID` in crypto
    ? `----opaline-transcribe-${crypto.randomUUID()}`
    : `----opaline-transcribe-${Math.random().toString(36).slice(2)}`;
}
function P(e) {
  let t = 0;
...
function J(e) {
  ...
  let { bufferDurationSecs: r, variant: i } = n,
    ...
    m = (0, I.useRef)(null),
    h;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((h = []), (t[2] = h)) : (h = t[2]);
  let g = (0, I.useRef)(h),
    _ = (0, I.useRef)(0),
    v = (0, I.useRef)(0),
    y = (0, I.useRef)(0),
  ...
  t[4] !== a || t[5] !== o
    ? ((w = (e) => {
        if (e == null) return !1;
        let t = Math.max(1, o === `compact` ? H : Math.floor(e.clientWidth / 4));
        return (
          (g.current = Array.from({ length: t }, ie)),
          (S.current = Math.max(1, Math.floor((ee * a) / t))),
          (x.current = new Float32Array()),
          !0
        );
      }),
      (t[4] = a),
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = () => {
        (d.current != null &&
          ((d.current.onaudioprocess = null), d.current.disconnect(), (d.current = null)),
  ...
  t[10] !== T || t[11] !== o
    ? ((M = () => {
        ...
        if (((t.fillStyle = getComputedStyle(e).color || `#000`), o === `compact`)) {
          let n = l * W,
            r = l * G,
        ...
        for (let e = 0; e < a.length; e += 1) {
          ...
          let r = n * c,
            i = e * l;
          ((t.globalAlpha = u === -1 || e < u ? 0.35 : 1), t.fillRect(i, -r, l / 2, r * 2));
        }
        t.restore();
      }),
      (t[10] = T),
            ...
            if (o === `compact`) {
              ...
              if (r > 0 && i > 0)
                for (; o + i <= n.length; ) {
                  ...
                  let s = t / i;
                  (g.current.push(s), g.current.length > r && g.current.shift(), (o = e), (a = !0));
                }
              ((x.current = n.slice(o)), a && N());
            }
            if (p.current != null) {
              let e = Math.max(0, Math.floor((performance.now() - p.current) / 1e3));
              e !== C.current && ((C.current = e), c(e * 1e3));
            }
          }),
          n.connect(r),
  ...
  t[17] === s
    ? (J = t[18])
    : ((J = () => (p.current == null ? s : Math.max(0, performance.now() - p.current))),
      (t[17] = s),
      (t[18] = J));
  let X = J,
    Z,
...
//# sourceMappingURL=use-recording-waveform-C_CvNvXL.js.map

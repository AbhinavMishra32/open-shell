...
import { lt as de } from "./vscode-api-sUstfl-x.js";
import { t as fe } from "./use-is-dark-DM2fOM7F.js";
...
import { n as Te, r as Ee } from "./use-resolved-theme-variant-CbBTynE2.js";
var De = class {
  ...
  setup(e, t, n) {
    if (t == null || n == null)
      for (let r of e.children ?? [])
        r instanceof HTMLElement &&
          (`deletions` in r.dataset ? (t = r) : `additions` in r.dataset && (n = r));
    if (n == null || t == null) {
      this.cleanUp();
      return;
    }
    (this.codeDeletions !== t &&
      (this.codeDeletions?.removeEventListener(`scroll`, this.handleDeletionsScroll),
      (this.codeDeletions = t),
      t.addEventListener(`scroll`, this.handleDeletionsScroll, { passive: !0 })),
      this.codeAdditions !== n &&
        (this.codeAdditions?.removeEventListener(`scroll`, this.handleAdditionsScroll),
        (this.codeAdditions = n),
        n.addEventListener(`scroll`, this.handleAdditionsScroll, { passive: !0 })),
      (this.enabled = !0));
  }
...
function K(e) {
  return B({
    tagName: `div`,
    children: [B({ tagName: `span`, children: [O(`No newline at end of file`)] })],
...
function J({
  ...
  if (
    (e === `metadata` &&
      t != null &&
      c.push(B({ tagName: `div`, children: [O(t)], properties: { "data-separator-wrapper": `` } })),
    (e === `line-info` || e === `line-info-basic`) && t != null)
  ) {
    let e = [];
    (n != null &&
      (r
        ? (a || (e.push(q(`up`)), s++), o || (e.push(q(`down`)), s++))
        : (e.push(q(!a && !o ? `both` : a ? `down` : `up`)), s++)),
      e.push(
        B({
          tagName: `div`,
          children: [
            B({ tagName: `span`, children: [O(t)], properties: { "data-unmodified-lines": `` } }),
          ],
      ...
      r &&
        ...
        e.push(
          B({
            tagName: `div`,
            children: [O(`Expand all`)],
            properties: { role: `button`, "data-expand-button": ``, "data-expand-all-button": `` },
          }),
        ),
      c.push(
        B({
  ...
  return (
    e === `custom` && i != null && c.push(B({ tagName: `slot`, properties: { name: i } })),
    B({
      tagName: `div`,
      children: c,
      properties: {
...
function ke(e) {
  ...
  return t == null
    ? 0
    : Math.max(t.additionStart + t.additionCount, t.deletionStart + t.deletionCount);
}
function Ae(e) {
  return (
...
var je = -1,
  Me = class {
    ...
    computedLang = `text`;
    renderCache;
    constructor(e = { theme: W }, t, n) {
      ((this.options = e),
        (this.onRenderUpdate = t),
        (this.workerManager = n),
        n?.isWorkingPool() !== !0 && (this.highlighter = V(e.theme ?? W) ? S() : void 0));
    }
    cleanUp() {
    ...
    expandHunk(e, t, n = this.getOptionsWithDefaults().expansionLineCount) {
      let r = { ...(this.expandedHunks.get(e) ?? { fromStart: 0, fromEnd: 0 }) };
    ...
    getExpandedHunk(e) {
      return this.expandedHunks.get(e) ?? xe;
    }
    getExpandedHunksMap() {
    ...
    async initializeHighlighter() {
      return ((this.highlighter = await x(ue(this.computedLang, this.options))), this.highlighter);
    }
    hydrate(e) {
      if (e == null) return;
      this.diff = e;
      ...
      (n != null && !U(t, n.options) && (n = void 0),
        ...
        this.workerManager?.isWorkingPool() === !0
          ? (this.renderCache.result ?? this.workerManager.highlightDiffAST(this, this.diff))
          : (this.highlighter ??
            ((this.computedLang = e.lang ?? o(e.name)), this.initializeHighlighter())));
    }
    getRenderOptions(e) {
      let t = (() => {
      ...
      return n?.result == null || e !== n.diff || !U(t, n.options)
        ? { options: t, forceRender: !0 }
        : { options: t, forceRender: !1 };
    }
    renderDiff(e = this.renderCache?.diff, t = be) {
      if (e == null) return;
      let { expandUnchanged: n = !1, collapsedContextThreshold: r } = this.getOptionsWithDefaults(),
        i = this.workerManager?.getDiffResultCache(e);
      i != null &&
        this.renderCache == null &&
        (this.renderCache = { diff: e, highlighted: !0, renderRange: void 0, ...i });
      ...
      if (
        ...
        ((this.renderCache.result == null ||
          (!this.renderCache.highlighted &&
            (e !== this.renderCache.diff || !u(this.renderCache.renderRange, t)))) &&
          ((this.renderCache.diff = e),
          (this.renderCache.result = this.workerManager.getPlainDiffAST(
            e,
            t.startingLine,
            t.totalLines,
            Ae(t) || n ? !0 : this.expandedHunks,
            r,
          )),
        ...
        let t = this.highlighter != null && V(a.theme),
          n = this.highlighter != null && h(this.computedLang);
        if (
          this.highlighter != null &&
          t &&
          (s || (!this.renderCache.highlighted && n) || this.renderCache.result == null)
        ) {
          let { result: t, options: r } = this.renderDiffWithHighlighter(e, this.highlighter, !n);
          this.renderCache = {
            diff: e,
            options: r,
            highlighted: n,
      ...
      return this.renderCache.result == null
        ? void 0
        : this.processDiffResult(this.renderCache.diff, t, this.renderCache.result);
    }
    async asyncRender(e, t = be) {
    ...
    async asyncHighlight(e) {
      this.computedLang = e.lang ?? o(e.name);
      let t = this.highlighter != null && V(this.options.theme ?? W),
        n = this.highlighter != null && h(this.computedLang);
      return (
    ...
    processDiffResult(e, t, { code: n, themeStyles: r, baseThemeType: i }) {
      ...
      let d = a === `unified`,
        ...
        v = {
          ...
          unifiedContentAST: m,
          unifiedGutterAST: T(),
          deletionsGutterAST: T(),
          additionsGutterAST: T(),
          expansionLineCount: c,
          hunkData: h,
        ...
        b = {
          ...
          flush() {
            if (a !== `unified`) {
              ...
              (this.side === `additions`
                ? (v.pushToGutter(`additions`, H(void 0, `buffer`, this.size)),
                  f?.push(G(this.size)))
                : (v.pushToGutter(`deletions`, H(void 0, `buffer`, this.size)),
                  p?.push(G(this.size))),
                (this.size = 0),
                (this.side = void 0));
            }
        ...
        x = (e, t, n, r, i) => {
          v.pushToGutter(e, F(t, n, r, i));
        };
      function S(e) {
        (b.flush(),
          a === `unified` ? Y(`unified`, e, v) : (Y(`deletions`, e, v), Y(`additions`, e, v)));
      }
      (C({
        diff: e,
        diffStyle: a,
        ...
        callback: ({
          ...
          if (a === `unified`) {
            ...
            let a = c === `change` ? (o == null ? `change-deletion` : `change-addition`) : c,
            ...
            (x(
              ...
              i == null
                ? r != null && (r = X(r, u.contentProperties))
                : (i = X(i, u.contentProperties)),
              Ie({
                diffStyle: `unified`,
                type: c,
                deletionLine: r,
                additionLine: i,
                unifiedSpan: this.getAnnotations(`unified`, s?.lineNumber, o?.lineNumber, t, f),
                createAnnotationElement: (e) => this.createAnnotationElement(e),
                context: v,
              }),
              n?.after != null && Pe(n.after, v));
          } else {
            let n = this.getSplitInjectedRowsForLine?.(p);
            n?.before != null && Fe(n.before, v, b);
            let r = s == null ? void 0 : _[s.lineIndex],
              i = o == null ? void 0 : g[o.lineIndex],
            ...
            let m = this.getAnnotations(`split`, s?.lineNumber, o?.lineNumber, t, f);
            if ((m != null && b.size > 0 && b.flush(), s != null)) {
              let e = X(r, a.contentProperties);
              (x(
                `deletions`,
                a.gutterLineType,
                s.lineNumber,
            ...
            (Ie({
              ...
              n?.after != null && Fe(n.after, v, b));
          }
          let m = s?.noEOFCR ?? !1,
            h = o?.noEOFCR ?? !1;
          if (h || m) {
            if (m) {
              let e = c === `context` || c === `context-expanded` ? c : `change-deletion`;
              a === `unified`
                ? (v.unifiedContentAST.push(K(e)), v.pushToGutter(`unified`, H(e, `metadata`, 1)))
                : (v.deletionsContentAST.push(K(e)),
                  v.pushToGutter(`deletions`, H(e, `metadata`, 1)),
                  h ||
                    (v.pushToGutter(`additions`, H(void 0, `buffer`, 1)),
                    v.additionsContentAST.push(G(1))));
            }
            if (h) {
              let e = c === `context` || c === `context-expanded` ? c : `change-addition`;
              a === `unified`
                ? (v.unifiedContentAST.push(K(e)), v.pushToGutter(`unified`, H(e, `metadata`, 1)))
                : (v.additionsContentAST.push(K(e)),
                  v.pushToGutter(`additions`, H(e, `metadata`, 1)),
                  m ||
                    (v.pushToGutter(`deletions`, H(void 0, `buffer`, 1)),
                    v.deletionsContentAST.push(G(1))));
            }
        ...
        a === `split` && b.flush());
      let w = Math.max(ke(e.hunks), e.additionLines.length ?? 0, e.deletionLines.length ?? 0),
        E = t.bufferBefore > 0 || t.bufferAfter > 0,
        D = !d && e.type !== `deleted`,
        O = !d && e.type !== `new`,
        k = v.rowCount > 0 || E;
      ((f = D && k ? f : void 0), (p = O && k ? p : void 0), (m = d && k ? m : void 0));
      let A = this.createPreElement(p != null && f != null, w);
      return {
    ...
    renderCodeAST(e, t) {
      ...
      let i = T(n);
      return ((i.properties.style = `grid-row: span ${t.rowCount}`), [i, m(r, t.rowCount)]);
    }
    renderFullAST(e, t = []) {
    ...
    renderFullHTML(e, t = []) {
      return z(this.renderFullAST(e, t));
    }
    ...
    getAnnotations(e, t, n, r, i) {
      let a = { type: `annotation`, hunkIndex: r, lineIndex: i, annotations: [] };
      if (t != null) for (let e of this.deletionAnnotations[t] ?? []) a.annotations.push(g(e));
      let o = { type: `annotation`, hunkIndex: r, lineIndex: i, annotations: [] };
      if (n != null)
...
function Fe(e, t, n) {
  for (let { deletion: r, addition: i } of e) {
    ...
    let e = r != null && i != null ? void 0 : r == null ? `deletions` : `additions`;
    ((e == null || n.side !== e) && n.flush(),
      r != null && (t.deletionsContentAST.push(r.content), t.pushToGutter(`deletions`, r.gutter)),
      i != null && (t.additionsContentAST.push(i.content), t.pushToGutter(`additions`, i.gutter)),
...
function Ie({
  ...
  if (e === `unified`) {
    if (
      (r == null ? n != null && c.unifiedContentAST.push(n) : c.unifiedContentAST.push(r),
      i != null)
    ) {
      let e = t === `change` ? (n == null ? `change-addition` : `change-deletion`) : t;
      (c.unifiedContentAST.push(s(i)), c.pushToGutter(`unified`, H(e, `annotation`, 1)), (l = !0));
    }
  } else if (e === `split`) {
    if (
      ...
      (c.deletionsContentAST.push(s(a)),
        c.pushToGutter(`deletions`, H(e, `annotation`, 1)),
        (l = !0));
    }
    if (o != null) {
      let e = t === `change` ? (r == null ? `context` : `change-addition`) : t;
      (c.additionsContentAST.push(s(o)),
        c.pushToGutter(`additions`, H(e, `annotation`, 1)),
        (l = !0));
    }
  }
...
function Y(
  ...
  if (c.hunkSeparators === `metadata`) {
    i != null &&
      (c.pushToGutter(e, J({ type: `metadata`, content: i, isFirstHunk: a, isLastHunk: o })),
      l.push(J({ type: `metadata`, content: i, isFirstHunk: a, isLastHunk: o })),
      e !== `additions` && c.incrementRowCount(1));
    return;
  }
  if (c.hunkSeparators === `simple`) {
    t > 0 &&
      (c.pushToGutter(e, J({ type: `simple`, isFirstHunk: a, isLastHunk: !1 })),
      l.push(J({ type: `simple`, isFirstHunk: a, isLastHunk: !1 })),
      e !== `additions` && c.incrementRowCount(1));
    return;
  }
  let u = Oe(e, t),
...
function Le(e) {
  let t = e.hunks.at(-1);
  if (t == null || e.isPartial || e.additionLines.length === 0 || e.deletionLines.length === 0)
    return 0;
...
function Re(e, t) {
  return e.lineNumber === t.lineNumber && e.side === t.side && e.metadata === t.metadata;
}
function ze(e, t) {
  return (
...
function Z(e, t, n, r = !1) {
  let i = Se(se(e.name, t.name, e.contents, t.contents, e.header, t.header, n), {
    cacheKey: (() => {
      if (e.cacheKey != null && t.cacheKey != null) return `${e.cacheKey}:${t.cacheKey}`;
    })(),
    oldFile: e,
    newFile: t,
    throwOnError: r,
  ...
  Ve = class {
      ...
      hunkIterator: for (let a of this.fileDiff.hunks) {
        ...
        for (let n of a.hunkContent)
          if (n.type === `context`)
            ...
            if (e < o + a) {
              let a = e - o;
              ((r = l + (t === `additions` ? n.deletions : 0) + a), (i = c + a));
              break hunkIterator;
            } else
              ((o += a),
    ...
    hydrate(e) {
      ...
      (this.hydrateElements(t, n),
        We(this.pre, He({ fileDiff: s, oldFile: a, newFile: o }), this.options.collapsed) ||
        Ge(
          this.headerElement,
          Ue({ fileDiff: s, oldFile: a, newFile: o }),
          this.options.disableFileHeader,
        )
          ? this.render({ ...e, preventEmit: !0 })
          : this.hydrationSetup({ fileDiff: s, oldFile: a, newFile: o, lineAnnotations: i }),
    ...
    hydrationSetup({ fileDiff: e, oldFile: t, newFile: n, lineAnnotations: r }) {
      let { diffStyle: i = `split`, overflow: a = `scroll` } = this.options;
      ((this.lineAnnotations = r ?? this.lineAnnotations),
        (this.additionFile = n),
        (this.deletionFile = t),
        (this.fileDiff =
          e ?? (t != null && n != null ? Z(t, n, this.options.parseDiffOptions) : void 0)),
        this.pre != null &&
    ...
    render({
      ...
      if (!this.enabled) throw Error(`FileDiff.render: attempting to call render after cleaned up`);
      let { collapsed: d = !1 } = this.options,
        f = d ? void 0 : l,
        p = e != null && t != null && (!a(e, this.deletionFile) || !a(t, this.additionFile)),
      ...
      if (
        ...
        n == null
          ? e != null &&
            t != null &&
            p &&
            ((m = !0), (this.fileDiff = Z(e, t, this.options.parseDiffOptions)))
          : (this.fileDiff = n),
      ...
      if (
        ...
        try {
          let e = this.hunksRenderer.renderDiff(this.fileDiff, Ce);
          (e != null && this.applyThemeState(s, e.themeStyles, x, e.baseThemeType),
            e?.headerElement != null && this.applyHeaderToDOM(e.headerElement, s),
      ...
      try {
        ...
        if (
          ...
          (this.applyThemeState(s, t.themeStyles, x, t.baseThemeType),
            t.headerElement != null && this.applyHeaderToDOM(t.headerElement, s),
        ...
        (this.applyBuffers(e, f),
          ...
          b === `scroll` && _ === `split`
            ? this.scrollSyncManager.setup(e, this.codeDeletions, this.codeAdditions)
            : this.scrollSyncManager.cleanUp());
      } catch (e) {
        if (v) throw e;
        (console.error(e), e instanceof Error && this.applyErrorToDOM(e, s));
    ...
    renderSeparators(e) {
      ...
      if (this.isContainerManaged || this.fileContainer == null || typeof t != `function`) {
        for (let { element: e } of this.separatorCache.values()) e.remove();
        this.separatorCache.clear();
        return;
      }
      ...
      for (let [e, { element: t }] of n.entries()) (this.separatorCache.delete(e), t.remove());
    }
    renderAnnotations() {
    ...
    applyHeaderToDOM(e, t) {
      ...
      let { renderCustomHeader: i, renderHeaderPrefix: a, renderHeaderMetadata: o } = this.options;
      if (i != null) {
        let e = i(n) ?? void 0;
        ((this.headerCustom = this.upsertHeaderSlotElement(t, this.headerCustom, ve, e)),
          this.headerPrefix?.remove(),
          this.headerMetadata?.remove(),
          (this.headerPrefix = void 0),
          (this.headerMetadata = void 0));
      ...
      let s = a?.(n) ?? void 0,
        c = o?.(n) ?? void 0;
      ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, _e, s)),
        (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, we, c)),
        this.headerCustom?.remove(),
        (this.headerCustom = void 0));
    }
    clearHeaderSlots() {
    ...
    applyHunksToDOM(e, t) {
      ...
      (c == null
        ? l != null || u != null
          ? (l == null
              ...
              : ((a = this.codeDeletions == null || this.codeUnified != null),
                ...
                (this.codeDeletions.innerHTML = this.hunksRenderer.renderPartialHTML(l)),
                o.push(this.codeDeletions)),
            u == null
              ? (this.codeAdditions?.remove(), (this.codeAdditions = void 0))
              : ((a = a || this.codeAdditions == null || this.codeUnified != null),
                this.codeUnified?.remove(),
                (this.codeUnified = void 0),
                ...
                (this.codeAdditions.innerHTML = this.hunksRenderer.renderPartialHTML(u)),
        ...
        : ((a =
          ...
          (this.codeUnified.innerHTML = this.hunksRenderer.renderPartialHTML(c)),
    ...
    applyPartialRender({ previousRenderRange: e, renderRange: t }) {
      ...
      if (this.lastRowCount < g) throw Error(`applyPartialRender: trimmed beyond DOM row count`);
      ...
      let x = (e, t) => {
        if (e != null) {
          if (o === `unified` && !Array.isArray(s)) this.insertPartialHTML(o, s, e, t);
          else if (o === `split` && Array.isArray(s)) this.insertPartialHTML(o, s, e, t);
          else throw Error(`FileDiff.applyPartialRender.applyChunk: invalid chunk application`);
          _ += e.rowCount;
        }
      };
      return (
        ...
        x(y, `afterbegin`),
        x(b, `beforeend`),
        this.lastRowCount !== _ && (this.applyRowSpan(o, s, _), (this.lastRowCount = _)),
        !0
      );
    }
    insertPartialHTML(e, t, n, r) {
      if (e === `unified` && !Array.isArray(t)) {
        ...
        (this.renderPartialColumn(t[0], e, r), this.renderPartialColumn(t[1], i, r));
      } else throw Error(`FileDiff.insertPartialHTML: Invalid argument composition`);
    }
    renderPartialColumn(e, t, n) {
      ...
      (n === `afterbegin` &&
        ...
        e.content.insertAdjacentHTML(n, this.hunksRenderer.renderPartialHTML(i)));
    }
    ...
    trimColumnRows(e, t, n) {
      ...
      if (c.length !== l.length) throw Error(`FileDiff.trimColumnRows: columns do not match`);
      for (; a < c.length && !(t <= 0 && !s && !o); ) {
        ...
        if (
          o &&
          ((o = !1),
          (e.dataset.gutterBuffer === `annotation` && `lineAnnotation` in u.dataset) ||
        ...
        if (e.dataset.gutterBuffer === `annotation` && `lineAnnotation` in u.dataset) {
          (t > 0 || (s && r >= n)) && (e.remove(), u.remove(), i++);
          continue;
        }
        ...
        if (e.dataset.gutterBuffer === `buffer` && `contentBuffer` in u.dataset) {
          let a = this.getBufferSize(u.dataset);
          if (a == null) throw Error(`FileDiff.trimColumnRows: invalid element`);
          if (t > 0) {
            let n = Math.min(t, a),
              r = a - n;
            (r > 0
              ? (this.updateBufferSize(e, r), this.updateBufferSize(u, r), (i += n))
            ...
            if (n <= t) (e.remove(), u.remove(), (i += a));
              ...
              let t = o - n + 1,
                r = a - t;
              (this.updateBufferSize(e, r), this.updateBufferSize(u, r), (i += t));
            }
          }
          r += a;
          continue;
    ...
    trimColumns({
      ...
      let s = Math.max(0, r - i),
        c = n - i;
      if (c < 0) throw Error(`FileDiff.trimColumns: overlap ends before previous`);
      let l = o > 0,
        u = a > 0;
      if (!l && !u) return 0;
      let d = l ? s : 0,
        f = u ? c : -1;
      if (t === `unified` && !Array.isArray(e)) return this.trimColumnRows(e, d, f);
    ...
    applyPreNodeAttributes(
      ...
      L(u, this.appliedPreAttributes) || (le(e, u), (this.appliedPreAttributes = u));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
...
function Ue({ fileDiff: e, oldFile: t, newFile: n }) {
...
function qe({ hunkIndex: e, lineIndex: t, conflictIndex: n }) {
  return `merge-conflict-action-${e}-${t}-${n}`;
}
function Je(e, t) {
  let n = t.hunks[e.hunkIndex];
  if (n != null) return { hunkIndex: e.hunkIndex, lineIndex: Ye(n, e.startContentIndex) };
}
function Ye(e, t) {
...
function Xe(e, t) {
  let n = { ...ye, ...t };
  return ((n.hunkSeparatorHeight = Ze(e, t?.hunkSeparatorHeight)), n);
}
function Ze(e, t) {
  if (t != null) return t;
  switch (e) {
...
var Qe = -1,
  $e = class extends Ve {
    __id = `little-virtualized-file-diff:${++Qe}`;
    top;
    height = 0;
    metrics;
    heightCache = new Map();
    ...
    constructor(e, t, n, r, i = !1) {
      ...
      ((this.virtualizer = t), (this.metrics = Xe(typeof a == `function` ? `custom` : a, n)));
    }
    getLineHeight(e, t = !1) {
    ...
    reconcileHeights() {
      ...
      let t = this.getDiffStyle(),
        n = !1,
        r = t === `split` ? [this.codeDeletions, this.codeAdditions] : [this.codeUnified];
      for (let e of r) {
        if (e == null) continue;
        let r = e.children[1];
      ...
      (n || this.virtualizer.config.resizeDebugging) && this.computeApproximateSize();
    }
    onRender = (e) =>
      this.fileContainer == null
        ? !1
    ...
    computeApproximateSize() {
      ...
      let {
        ...
        { diffHeaderHeight: o, fileGap: s, hunkSeparatorHeight: c } = this.metrics,
        l = this.getDiffStyle(),
        u = a !== `simple` && a !== `metadata` && a !== `line-info-basic` ? s : 0;
      if (
        (t ? a !== `simple` && a !== `metadata` && (this.height += s) : (this.height += o),
        !r &&
          (C({
            diff: this.fileDiff,
            diffStyle: l,
        ...
        e.height === this.height
          ...
          : console.log(
              ...
              { name: this.fileDiff.name, elementHeight: e.height, computedHeight: this.height },
            );
      }
    }
    render({ fileContainer: e, oldFile: t, newFile: n, fileDiff: r, ...i } = {}) {
      let { isSetup: a } = this;
      if (
        ((this.fileDiff ??=
          r ?? (t != null && n != null ? Z(t, n, this.options.parseDiffOptions) : void 0)),
    ...
    getExpandedRegion(e, t, n) {
      if (n <= 0 || e)
        return { fromStart: 0, fromEnd: 0, collapsedLines: Math.max(n, 0), renderAll: !1 };
      let { expandUnchanged: r = !1, collapsedContextThreshold: i = 1 } = this.options;
      if (r || n <= i) return { fromStart: n, fromEnd: 0, collapsedLines: 0, renderAll: !0 };
      let a = this.hunksRenderer.getExpandedHunk(t),
        o = Math.min(Math.max(a.fromStart, 0), n),
        s = Math.min(Math.max(a.fromEnd, 0), n),
        c = o + s,
        l = c >= n;
      return { fromStart: o, fromEnd: s, collapsedLines: Math.max(n - c, 0), renderAll: l };
    }
    getExpandedLineCount(e, t) {
      let n = 0;
      if (e.isPartial) {
        for (let r of e.hunks) n += t === `split` ? r.splitLineCount : r.unifiedLineCount;
        return n;
      }
      for (let [r, i] of e.hunks.entries()) {
        ...
        let o = Math.max(i.collapsedBefore, 0),
          { fromStart: s, fromEnd: c, renderAll: l } = this.getExpandedRegion(e.isPartial, r, o);
        o > 0 && (n += l ? o : s + c);
      }
      let r = e.hunks.at(-1);
      if (r != null && et(e)) {
    ...
    computeRenderRangeFromWindow(e, t, { top: n, bottom: r }) {
      let {
        ...
        g = i ? l : c;
      if (t < n - m || t > r)
        return { startingLine: 0, totalLines: 0, bufferBefore: 0, bufferAfter: m - g - l };
      if (h <= u || e.hunks.length === 0)
        return { startingLine: 0, totalLines: u, bufferBefore: 0, bufferAfter: 0 };
      let _ = Math.ceil(Math.max(r - n, 0) / f),
        ...
        x = [],
        S = (n + r) / 2,
        w = s === `simple` || s === `metadata` || s === `line-info-basic` ? 0 : l,
        T = t + g,
        E = 0,
        D,
        O,
      ...
      return {
        ...
        totalLines: F,
        bufferBefore: I,
        bufferAfter: L < x.length ? m - g - x[L] - l : m - (T - t) - l,
      };
    }
  };
function et(e) {
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      p == null
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              m != null && (0, Q.jsx)(`div`, { slot: `header-prefix`, children: m }),
              h != null && (0, Q.jsx)(`div`, { slot: `header-metadata`, children: h }),
            ],
          })
        : (0, Q.jsx)(`div`, { slot: ve, children: p }),
      a != null && l?.map((e, t) => (0, Q.jsx)(`div`, { slot: g(e), children: a(e) }, t)),
      t != null &&
        c != null &&
        d != null &&
        t.map((t) => {
          if (t == null) return;
          let n = rt(t, e);
          return (0, Q.jsx)(`div`, { slot: n, style: k, children: c(t, d) }, n);
        }),
      f != null && (0, Q.jsx)(`div`, { slot: `gutter-utility-slot`, style: oe, children: f(u) }),
    ],
  });
}
function rt(e, t) {
  ...
  return n == null
    ? void 0
    : qe({ hunkIndex: n.hunkIndex, lineIndex: n.lineIndex, conflictIndex: e.conflictIndex });
}
var $ = e(n(), 1),
  it = typeof window > `u` ? $.useEffect : $.useLayoutEffect;
function at({
  fileDiff: e,
  options: t,
  lineAnnotations: n,
  ...
  let l = D(),
    ...
    f = P((r) => {
      if (r != null) {
        ...
        (l == null
          ? (d.current = new Ve(
              ot({ hasCustomHeader: s, hasGutterRenderUtility: o, options: t }),
              c ? void 0 : u,
              !0,
            ))
          : (d.current = new $e(
        ...
        if (d.current == null)
          throw Error(`useFileDiffInstance: A FileDiff instance should exist when unmounting`);
  ...
  return (
    it(() => {
      let { current: i } = d;
      if (i == null) return;
      let a = ot({ hasCustomHeader: s, hasGutterRenderUtility: o, options: t }),
        c = !te(i.options, a);
      (i.setOptions(a),
        i.render({ forceRender: c, fileDiff: e, lineAnnotations: n }),
        r !== void 0 && i.setSelectedLines(r));
    }),
    { ref: f, getHoveredLine: (0, $.useCallback)(() => d.current?.getHoveredLine(), []) }
  );
}
function ot({ options: e, hasCustomHeader: t, hasGutterRenderUtility: n }) {
  return n || t
    ? { ...e, renderCustomHeader: t ? j : void 0, renderGutterUtility: n ? j : void 0 }
    : e;
}
function st({
  fileDiff: e,
...
function ut(e) {
  ...
  n[0] === e
    ...
    : (({
        ...
        className: r,
        hunkSeparators: p,
        isLoadingFullContent: m,
        lineAnnotations: a,
        lineDiffType: o,
        metrics: s,
        onGutterUtilityClick: c,
        onPostRender: l,
        renderAnnotation: u,
        selectedLines: f,
        overflow: h,
      ...
      (n[12] = m),
      (n[13] = h));
  let g = p === void 0 ? `line-info` : p,
    _ = h === void 0 ? `scroll` : h,
    v = (0, $.useRef)(null),
    y = Ee(Te()),
    b = pe(t.lightCodeThemeId),
    x = pe(t.darkCodeThemeId),
    S = pe(t.diffMarkerStyle);
  fe();
  let C = S === `symbols`,
    w;
  n[14] !== y || n[15] !== x || n[16] !== b
    ? ((w = y === `light` ? me(b, `light`) : me(x, `dark`)),
      (n[14] = y),
      (n[15] = x),
      (n[16] = b),
      (n[17] = w))
  ...
  (n[18] === l
    ? (E = n[19])
    : ((E = () => {
        if (l == null || v.current == null) return;
        let e = window.requestAnimationFrame(() => {
          v.current != null && l(v.current);
        });
        return () => {
  ...
  n[20] === o
    ? (O = n[21])
    : ((O = o == null ? null : (0, Q.jsx)(dt, { lineDiffType: o })), (n[20] = o), (n[21] = O));
  let k = st,
    A = y,
    j = T.name,
    M = C ? `classic` : `bars`,
  ...
  n[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = ne({
        ...
        rootSelector: lt,
        surface: `var(--opaline-diffs-surface)`,
      })),
      (n[22] = P))
    : (P = n[22]);
  let F;
  ...
  let L;
  n[41] !== r || n[42] !== I
    ? ((L = (0, Q.jsx)(`div`, { ref: v, className: r, children: I })),
      (n[41] = r),
      (n[42] = I),
      (n[43] = L))
    : (L = n[43]);
  let R;
  return (
    n[44] !== D || n[45] !== L || n[46] !== O
      ? ((R = (0, Q.jsxs)(D, { children: [O, L] })),
        (n[44] = D),
        (n[45] = L),
        (n[46] = O),
        (n[47] = R))
...
export { Z as n, ut as t };
//# sourceMappingURL=file-diff-DyKTlUkx.js.map

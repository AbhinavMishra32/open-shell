...
import { a as l, o as u, t as d } from "./tslib.es6-BbTQ3PDY.js";
var f = e(t(), 1);
function p(e) {
  let t = f.useRef(e);
  return (
...
var h = n(),
  ...
  S = f.forwardRef((e, t) => {
    let {
      ...
      p = f.useContext(x),
      [g, v] = f.useState(null),
      y = g?.ownerDocument ?? globalThis?.document,
      [, S] = f.useState({}),
      C = s(t, (e) => v(e)),
      ...
      N = T((e) => {
        ...
        !M || n || (o?.(e), l?.(e), e.defaultPrevented || u?.());
      }, y),
      P = E((e) => {
        let t = e.target;
    ...
    return (
      m((e) => {
        A === p.layers.size - 1 && (r?.(e), !e.defaultPrevented && u && (e.preventDefault(), u()));
      }, y),
      f.useEffect(() => {
        if (g)
          return (
      ...
      f.useEffect(
        () => () => {
          g && (p.layers.delete(g), p.layersWithOutsidePointerEventsDisabled.delete(g), D());
        },
        [g, p],
      ),
      f.useEffect(() => {
      ...
      (0, h.jsx)(a.div, {
        ...d,
        ref: C,
        style: { pointerEvents: j ? (M ? `auto` : `none`) : void 0, ...e.style },
...
S.displayName = g;
var C = `DismissableLayerBranch`,
  w = f.forwardRef((e, t) => {
    let n = f.useContext(x),
      r = f.useRef(null),
      i = s(t, r);
    return (
      f.useEffect(() => {
      ...
      (0, h.jsx)(a.div, { ...e, ref: i })
    );
  });
w.displayName = C;
function T(e, t = globalThis?.document) {
  let n = p(e),
    r = f.useRef(!1),
    i = f.useRef(() => {});
  return (
...
function E(e, t = globalThis?.document) {
  ...
  return (
    f.useEffect(() => {
      let e = (e) => {
        e.target && !r.current && O(y, n, { originalEvent: e }, { discrete: !1 });
      };
...
var M = `focusScope.autoFocusOnMount`,
  ...
  ee = `FocusScope`,
  te = f.forwardRef((e, t) => {
    let { loop: n = !1, trapped: r = !1, onMountAutoFocus: i, onUnmountAutoFocus: o, ...c } = e,
      [l, u] = f.useState(null),
      d = p(i),
      m = p(o),
      g = f.useRef(null),
    ...
    (f.useEffect(() => {
      if (r) {
        let e = function (e) {
            ...
            let t = e.target;
            l.contains(t) ? (g.current = t) : I(g.current, { select: !0 });
          },
          t = function (e) {
            if (v.paused || !l) return;
            let t = e.relatedTarget;
            t !== null && (l.contains(t) || I(g.current, { select: !0 }));
          },
          n = function (e) {
            if (document.activeElement === document.body)
              for (let t of e) t.removedNodes.length > 0 && I(l);
          };
      ...
      f.useEffect(() => {
        if (l) {
          ...
          if (!l.contains(e)) {
            ...
            (l.addEventListener(M, d),
              l.dispatchEvent(t),
              t.defaultPrevented ||
                (ne(ue(ie(l)), { select: !0 }), document.activeElement === e && I(l)));
          }
          return () => {
            (l.removeEventListener(M, d),
              setTimeout(() => {
                let t = new CustomEvent(N, P);
                (l.addEventListener(N, m),
                  l.dispatchEvent(t),
                  t.defaultPrevented || I(e ?? document.body, { select: !0 }),
                  l.removeEventListener(N, m),
                  se.remove(v));
              }, 0));
          };
        }
        ...
        if (t && i) {
          ...
          r && a
            ? !e.shiftKey && i === a
              ...
              : e.shiftKey && i === r && (e.preventDefault(), n && I(a, { select: !0 }))
            : i === t && e.preventDefault();
        }
      },
      [n, r, v.paused],
    );
    return (0, h.jsx)(a.div, { tabIndex: -1, ...c, ref: _, onKeyDown: y });
  });
te.displayName = ee;
...
var de = f.useId || (() => void 0),
  fe = 0;
function pe(e) {
  let [t, n] = f.useState(de());
  return (
    o(() => {
      e || n((e) => e ?? String(fe++));
    }, [e]),
...
var me = e(c(), 1),
  ...
  L = f.forwardRef((e, t) => {
    ...
    return c ? me.createPortal((0, h.jsx)(a.div, { ...r, ref: t }), c) : null;
  });
L.displayName = he;
var ge = function (e) {
  ...
  V = 0,
  _e = function (e) {
    return e && (e.host || _e(e.parentNode));
  },
  ve = function (e, t) {
    return t
      .map(function (t) {
  ...
  ye = function (e, t, n, r) {
    var i = ve(t, Array.isArray(e) ? e : [e]);
    B[n] || (B[n] = new WeakMap());
    var a = B[n],
      o = [],
      s = new Set(),
    ...
    return (
      ...
      function () {
        (o.forEach(function (e) {
          ...
          V--,
          V || ((R = new WeakMap()), (R = new WeakMap()), (z = new WeakMap()), (B = {})));
      }
    );
  },
  be = function (e, t, n) {
...
var we = typeof window < `u` ? f.useLayoutEffect : f.useEffect,
  Te = new WeakMap();
function Ee(e, t) {
  var n = Ce(t || null, function (t) {
...
var Me = ke(),
  ...
  K = f.forwardRef(function (e, t) {
    var n = f.useRef(null),
      r = f.useState({ onScrollCapture: G, onWheelCapture: G, onTouchMoveCapture: G }),
      i = r[0],
      a = r[1],
      o = e.forwardProps,
      s = e.children,
    ...
    return f.createElement(
      ...
      o
        ? f.cloneElement(f.Children.only(s), d(d({}, E), { ref: T }))
        : f.createElement(x, d({}, E, { className: c, ref: T }), s),
    );
  });
((K.defaultProps = { enabled: !0, removeScrollBar: !0, inert: !1 }),
  (K.classNames = { fullWidth: U, zeroRight: H }));
var Ne,
  Pe = function () {
    if (Ne) return Ne;
...
var Re = function () {
  ...
  Ue = function (e) {
    if ((e === void 0 && (e = `margin`), typeof window > `u`)) return Ve;
    var t = He(e),
...
`
  ...
  qe = function () {
    f.useEffect(function () {
      return (
        document.body.setAttribute(J, (Ke() + 1).toString()),
        function () {
          var e = Ke() - 1;
  ...
  Je = function (e) {
    ...
    return f.createElement(We, { styles: Ge(a, !t, i, n ? `` : `!important`) });
  },
  Y = !1;
if (typeof window < `u`)
  try {
...
var Z = Y ? { passive: !1 } : !1,
  ...
  Xe = function (e, t) {
    ...
    return n[t] !== `hidden` && !(n.overflowY === n.overflowX && !Ye(e) && n[t] === `visible`);
  },
  Ze = function (e) {
  ...
  $e = function (e, t) {
    var n = t.ownerDocument,
      r = t;
    do {
      if ((typeof ShadowRoot < `u` && r instanceof ShadowRoot && (r = r.host), nt(e, r))) {
        var i = rt(e, r);
        if (i[1] > i[2]) return !0;
      }
      r = r.parentNode;
  ...
  at = function (e, t, n, r, i) {
    var a = it(e, window.getComputedStyle(t).direction),
      o = a * r,
      s = n.target,
      c = t.contains(s),
      l = !1,
...
function dt(e) {
    ...
    f.useEffect(
      function () {
        if (e.inert) {
          ...
          var t = u([e.lockRef.current], (e.shards || []).map(st), !0).filter(Boolean);
          return (
  ...
  var s = f.useCallback(function (e, t) {
      ...
      var f = $e(d, u);
      if (!f) return !0;
      if ((f ? (l = d) : ((l = d === `v` ? `h` : `v`), (f = $e(d, u))), !f)) return !1;
    ...
    l = f.useCallback(function (e, n, r, i) {
      var a = { name: e, delta: n, target: r, should: i, shadowParent: ft(r) };
      (t.current.push(a),
        setTimeout(function () {
  ...
  return f.createElement(
    f.Fragment,
    null,
    g ? f.createElement(a, { styles: lt(i) }) : null,
    h ? f.createElement(Je, { noRelative: e.noRelative, gapMode: e.gapMode }) : null,
  );
}
function ft(e) {
...
var pt = je(Me, dt),
  mt = f.forwardRef(function (e, t) {
    return f.createElement(K, d({}, e, { ref: t, sideCar: pt }));
  });
mt.classNames = K.classNames;
export { te as a, p as c, pe as i, be as n, A as o, L as r, S as s, mt as t };
//# sourceMappingURL=Combination-9DfZp13g.js.map

...
import { D as n } from "./src-CYrn1fYL.js";
import { ro as r, so as i } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as a, t as o } from "./jsx-runtime-CiQ1k8xo.js";
import { F as s, L as c, f as l, lt as u } from "./vscode-api-sUstfl-x.js";
import { o as d } from "./lib-MoKmYgcO.js";
import { t as f } from "./route-scope-BCJTBhwV.js";
import { t as p } from "./button-Xd4Hy1MO.js";
import { a as m } from "./setting-storage-Cel8Tr7E.js";
import { n as h, o as g, r as _ } from "./app-shell-state-B5MFb4Nm.js";
import { t as ee } from "./use-platform-BkwBnkgx.js";
import { A as v, j as y } from "./diff-view-mode-DMAtdFuV.js";
import { n as b, t as x } from "./app-shell-tab-controller-B0DXekEJ.js";
import { t as S } from "./local-conversation-title-signals-CLvppuE1.js";
import { i as C, n as w } from "./thread-context-DeLLpkJz.js";
import { n as T, t as E } from "./focus-composer-Ddi8tz3g.js";
import { t as D } from "./terminal-CsU-mb2r.js";
import { t as O } from "./app-intl-signal-DF17N7z2.js";
import {
  a as te,
  c as k,
  n as ne,
...
import { t as N } from "./error-boundary-CSKrv358.js";
import { n as ie } from "./check-git-index-for-changes-6WWLEsel.js";
import { t as ae } from "./font-settings-6z0UDNTg.js";
import { n as oe, r as se } from "./use-resolved-theme-variant-CbBTynE2.js";
import { i as P, n as F, r as I } from "./thread-panel-state-CYOPuORF.js";
      ...
      : ((o = (0, z.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, z.jsx)(`div`, {
              ...
              children: (0, z.jsx)(p, { color: `secondary`, onClick: n, children: a }),
            }),
          ],
        })),
        (t[3] = n),
...
function le({
  ...
  if (n != null && X(t, [`t`])) return (G(t), n(), !1);
  if (e != null) {
    if (K(t, a.hasSelection())) {
      G(t);
  ...
  let o = q(t);
  return o == null ? !0 : (G(t), i(o), !1);
}
function G(e) {
  (e.preventDefault(), e.stopPropagation());
}
function K(e, t) {
  return (t && Y(e, `c`)) || J(e, `c`) || de(e, { ctrlKey: !0, shiftKey: !1 });
}
function ue(e, t) {
  return (t && Y(e, `v`)) || J(e, `v`) || de(e, { ctrlKey: !1, shiftKey: !0 });
}
function q(e) {
  return X(e, [`ArrowLeft`, `ArrowUp`])
    ? V
    : X(e, [`ArrowRight`, `ArrowDown`])
      ? H
      : X(e, [`Backspace`])
        ? W
        : X(e, [`Delete`])
...
var fe = L(),
  ...
  Z = e(a(), 1);
function ge(e, t, n) {
  (t.fit(), r.resize(n, e.cols, e.rows));
}
function _e(e) {
  let t = (0, R.c)(5),
    ...
    i = r ?? n,
    a;
  t[0] === e ? (a = t[1]) : ((a = (0, z.jsx)(ye, { ...e })), (t[0] = e), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, z.jsx)(N, { name: `TerminalPanel`, fallback: ve, children: a }, i)),
        (t[2] = i),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
function ye(e) {
  let t = (0, R.c)(50),
    ...
    d = se(oe()),
    f = u !== `macOS`,
    p = m(n.lightChromeTheme),
    h = m(n.darkChromeTheme),
    g = m(n.codeFontSize),
    _,
    b,
    x,
    S;
  if (t[0] !== g || t[1] !== h || t[2] !== p || t[3] !== d) {
    _ = d === `light` ? y(p, `light`) : y(h, `dark`);
  ...
  (t[11] === x
    ...
    (0, Z.useEffect)(P, F));
  let I;
  t[14] === a ? (I = t[15]) : ((I = () => a), (t[14] = a), (t[15] = I));
  let ce = (0, Z.useEffectEvent)(I),
    L,
    B;
  (t[16] !== _ || t[17] !== d
    ? ((L = () => {
      ...
      (t[19] = B))
    : ((L = t[18]), (B = t[19])),
    (0, Z.useLayoutEffect)(L, B));
  let V;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = () => {
        let e = E.current,
          t = w.current;
        !e || !t || ((e.options.theme = re(t)), e.rows > 0 && e.refresh(0, e.rows - 1));
      }),
      (t[20] = V))
    : (V = t[20]);
  let H;
  (t[21] !== _ || t[22] !== d ? ((H = [_, d]), (t[21] = _), (t[22] = d), (t[23] = H)) : (H = t[23]),
    (0, Z.useEffect)(V, H));
  let U, W;
  ...
  t[36] !== f
    ? ((G = () => {
        ...
        E.current = p;
        let g = new fe.ClipboardAddon(),
          _ = new pe.FitAddon();
        D.current = _;
        let ee = new me.WebLinksAddon(xe);
        (p.loadAddon(g),
          p.loadAddon(_),
          p.loadAddon(ee),
          p.attachCustomKeyEventHandler((e) =>
            le({
              clipboard:
                typeof navigator < `u` && navigator.clipboard != null && f
                  ? navigator.clipboard
                  : void 0,
              event: e,
              onNewTerminalTab: l,
              pasteOnCtrlV: u === `windows`,
              sendText: (e) => {
                r.write(a, e);
              },
              term: p,
        ...
        let v = () => {
          d ||
            (e.isConnected &&
              requestAnimationFrame(() => {
                d || (e.isConnected && (k.current ? ge(p, _, a) : _.fit()));
              }));
        };
        v();
        let y = r.register(a, {
  ...
  t[44] !== f
    ...
    : (K = t[45]),
    (0, Z.useEffect)(G, K));
  let ue = c == null ? void 0 : `terminal-panel-${c}`,
    q;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((J = (0, z.jsx)(`div`, {
        ...
        children: (0, z.jsx)(`div`, { className: `h-full w-full overflow-hidden`, ref: T }),
      })),
      (t[47] = J))
    : (J = t[47]);
  let Y;
...
function xe(e, t) {
  t && (e.preventDefault?.(), l.dispatchMessage(`open-in-browser`, { url: t }));
}
function Se(e) {
  let t = (0, R.c)(3),
    { conversationId: n } = e,
  ...
  return (
    t[0] === n
      ? ((i = t[1]), (a = t[2]))
      : ((i = (e) => (n == null ? we : r.subscribeToConversation(n, e))),
        (a = () => (n == null ? null : r.getConversationSnapshot(n))),
        (t[0] = n),
        (t[1] = i),
        (t[2] = a)),
    (0, Z.useSyncExternalStore)(i, a, Ce)
  );
}
function Ce() {
  return null;
...
var Ee = `terminal:`,
  ...
  De = c(f, ({ get: e }) => {
    let t = e(x.activeTab$);
    return e(_) && t != null && Ye(t.tabId);
  }),
  Oe = c(f, ({ get: e }) => {
    let t = e(b.activeTab$);
    return e(g) && t != null && Ye(t.tabId);
  });
function ke(e) {
  (F(e, `right`), requestAnimationFrame(E));
}
function Ae(e) {
  Me(e, `bottom`);
}
function je(e, t) {
  (Me(e, t == null ? ze(e) : Be(e, t), t), t != null && requestAnimationFrame(() => T()));
}
function Me(e, t, n) {
  let i = qe(e);
  if (i == null) return;
  let a = r.getConversationSnapshot(i.conversationId);
  n != null && !a?.sessionIds.includes(n) && r.addSessionForConversation(i.conversationId, n);
  let o = n ?? Ge(e, t, a?.sessionIds ?? []) ?? r.addSessionForConversation(i.conversationId);
  (r.setActiveSessionForConversation(i.conversationId, o), Ue(e, i, t), Ve(e, i, o, !0, t, o));
}
function Ne(e) {
  return qe(e) != null;
}
...
function Ie(e, t) {
  let n = qe(e);
  if (n == null) return;
  let i = r.addSessionForConversation(n.conversationId);
  (Ue(e, n, t), Ve(e, n, i, !0, t, i));
}
function Le(e) {
  if (e.get(De)) {
    F(e, `bottom`);
...
function Ve(e, t, n, i, a, o) {
  let s = r.getConversationSnapshot(t.conversationId),
    c = s?.sessionIds ?? [],
    l = e.get(O),
    u = I(a);
  We(e, c, a);
  ...
  for (let [n, i] of d.entries()) {
    let o = $(i),
      c = ce(s?.tabTitlesBySessionId[i], s?.cwdBySessionId[i] || t.cwd, n, d.length, l),
      p = f.get(o);
    if (p != null) {
    ...
    u.openTab(e, Te, {
      ...
      onClose: () => {
        r.closeSessionForConversation(t.conversationId, i);
      },
      onMove: (e, n) => {
        ...
        return (
          Ue(e, t, r),
          {
            ...
            props: { ...t, onNewTerminalTab: r === `bottom` ? Pe : Fe, sessionId: i },
          }
        );
      },
      id: o,
      title: c,
      props: { ...t, onNewTerminalTab: a === `bottom` ? Pe : Fe, sessionId: i },
    });
  }
  i && (u.activateTab(e, $(n)), P(e, a));
}
function He(e, t, n, i) {
  let a = I(i);
  if (!r.getConversationSnapshot(t.conversationId)?.sessionIds.includes(n)) {
    a.closeTab(e, $(n));
    return;
  }
  (r.setActiveSessionForConversation(t.conversationId, n),
    Ve(e, t, n, !1, i),
    requestAnimationFrame(() => {
      T();
    }));
...
function Ue(e, t, n) {
  let i = String(t.conversationId),
    a = Q.get(i);
  if (a != null) {
    a.panels.add(n);
    return;
  }
  let o = r.subscribeToConversation(t.conversationId, () => {
    let n = r.getConversationSnapshot(t.conversationId);
    if (n == null) {
      let t = Q.get(i);
      if (t != null) {
    ...
    let a = Q.get(i);
    if (a != null) for (let t of a.panels) Ve(e, a.target, n.activeSessionId, !1, t);
  });
  Q.set(i, { panels: new Set([n]), target: t, unsubscribe: o });
}
function We(e, t, n) {
  let r = I(n),
    i = new Set(t.map($));
  for (let t of e.get(r.tabs$)) Ye(t.tabId) && !i.has(t.tabId) && r.closeTab(e, t.tabId);
  e.get(r.tabs$).length === 0 && F(e, n);
}
function Ge(e, t, n) {
  let r = new Set(n),
    i = I(t),
    a = Je(e.get(i.activeTab$)?.tabId ?? null);
...
function Je(e) {
  return e?.startsWith(Ee) ? e.slice(9) : null;
}
function Ye(e) {
  return e.startsWith(Ee);
}
export { De as a, Ie as i, je as n, Re as o, Pe as r, Ne as t };
//# sourceMappingURL=thread-page-bottom-panel-state-TF1g3u_g.js.map

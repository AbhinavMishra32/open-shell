import { Tt as e, vn as t } from "./src-CYrn1fYL.js";
import { Jt as n, bc as r, pn as i } from "./app-server-manager-signals-BOGyjFm3.js";
import { F as a, I as o, g as s, h as c, lt as l } from "./vscode-api-sUstfl-x.js";
import { c as u, r as d } from "./lib-MoKmYgcO.js";
import { r as f } from "./toast-signal-By11REe1.js";
import { t as p } from "./copy-to-clipboard-q_KxH8lM.js";
import { t as m } from "./pinned-threads-query-DH3w_A12.js";
import { n as h } from "./set-pinned-thread-UwfYLy27.js";
async function g(t, r, a, o) {
  let s = t.query.snapshot(m),
    c = s.getData(),
    l =
      c == null
        ? null
        : {
            threadIds: a
              ? e({ threadIds: c.threadIds, threadId: r, beforeThreadId: o ?? null })
              : c.threadIds.filter((e) => e !== r),
          };
  l != null && s.setData(l);
  let u = !1;
  try {
    (o === void 0 ? await h(r, a) : await h(r, a, o), (u = a), a && (await n(t, r)));
  } catch (e) {
    let t = s.getData();
    if ((l != null && t != null && i(t.threadIds, l.threadIds) && s.setData(c), u))
      try {
        await h(r, !1);
      } catch (e) {
        v(e);
...
function v(e) {
  s.error(`Failed to update sidebar thread membership`, { safe: {}, sensitive: { error: t(e) } });
}
var y = l(),
  b = d({
    archiveThreadError: {
...
function x(e, t) {
  ...
  n[2] === u?.threadIds
    ? (d = n[3])
    : ((d = u?.threadIds ?? []), (n[2] = u?.threadIds), (n[3] = d));
  let f = d,
    p;
  n[4] !== s || n[5] !== e || n[6] !== f
    ? ((p = s && e != null && f.includes(e)), (n[4] = s), (n[5] = e), (n[6] = f), (n[7] = p))
    : (p = n[7]);
  let h = p,
    _;
  n[8] !== s || n[9] !== e || n[10] !== h || n[11] !== l
    ? ((_ = () => {
        !s || e == null || g(l, e, !h);
      }),
      (n[8] = s),
  ...
  return (
    n[13] !== h || n[14] !== v
      ? ((b = { isPinned: h, togglePin: v }), (n[13] = h), (n[14] = v), (n[15] = b))
      : (b = n[15]),
    b
  );
}
...
function w(e) {
  e && p(`opaline://threads/${e}`);
}
function T({ conversationId: e, parentConversationId: t, scope: n, getMarkdown: i, intl: a }) {
  (async () => {
    await r(`ensure-conversation-history-loaded`, {
      conversationId: e,
...
function E() {
  ...
  e[0] !== n || e[1] !== t
    ? ((i = (e) => {
        let { conversationId: i, source: a, onArchiveSuccess: o, onArchiveError: s } = e;
        r(`archive-conversation`, { conversationId: i, source: a })
          .then(() => {
            o?.();
          })
          .catch(() => {
            (s?.(), t.get(f).danger(n.formatMessage(b.archiveThreadError)));
          });
      }),
      (o = (e) => {
        let { conversationId: i } = e;
        r(`interrupt-conversation`, { conversationId: i }).catch(() => {
          t.get(f).danger(n.formatMessage(b.interruptThreadError));
        });
      }),
      (e[0] = n),
      (e[1] = t),
  ...
  e[4] !== n || e[5] !== t
    ? ((s = (e) => {
        ...
        r(`set-thread-title`, { conversationId: i, title: a }).catch(() => {
          t.get(f).danger(n.formatMessage(b.renameThreadError));
        });
      }),
      (l = (e) => {
        S({ scope: t, cwd: e, intl: n });
      }),
      (e[4] = n),
      (e[5] = t),
      (e[6] = s),
  ...
  let p;
  return (
    e[11] !== i || e[12] !== o || e[13] !== s || e[14] !== l || e[15] !== d
      ? ((p = {
          archiveThread: i,
          interruptThread: o,
...
function D(e) {
  ...
  r(`mark-conversation-as-unread`, { conversationId: t });
}
export { E as a, x as i, C as n, _ as o, b as r, g as s, w as t };
//# sourceMappingURL=thread-actions-DlCTuMux.js.map

...
import { D as n, Gn as r } from "./src-CYrn1fYL.js";
import { Bo as i, Ho as a, Zn as o, so as s } from "./app-server-manager-signals-BOGyjFm3.js";
import { t as c } from "./preload-helper-I1wKxk_B.js";
...
import {
  ...
  x as Te,
  z as Ee,
} from "./shiki-highlight-provider-gate-BIr7ajST.js";
import { t as De } from "./clsx-BcPLHiun.js";
import { t as Oe } from "./react-dom-CvzHKZGB.js";
import {
  F as ke,
  I as F,
  P as Ae,
...
import { c as Ie, o as I, r as Le } from "./lib-MoKmYgcO.js";
import { g as Re } from "./persisted-signal-Cx1QgqJn.js";
import { o as ze } from "./statsig-Cajk3UKk.js";
import { t as Be } from "./use-is-dark-DM2fOM7F.js";
import { n as Ve } from "./window-zoom-context-CSPQZGcc.js";
import { i as He, t as Ue } from "./route-scope-BCJTBhwV.js";
import { t as We } from "./button-Xd4Hy1MO.js";
import { a as Ge } from "./setting-storage-Cel8Tr7E.js";
import {
  a as Ke,
  c as qe,
  i as Je,
  ...
  r as Qe,
  t as $e,
} from "./open-workspace-file-DNjRVDw7.js";
import { r as et } from "./file-kind-kthFJxRp.js";
import { r as tt } from "./mcp-capability-signals-3iWufNgx.js";
import { t as nt } from "./proxy-DktXrBt_.js";
import {
  W as rt,
  _ as it,
  g as at,
...
import { S as lt, r as ut, u as dt } from "./app-shell-D7yvB1FT.js";
import {
  D as ft,
  T as pt,
  _ as mt,
...
import { n as Vt, r as Ht } from "./thread-context-DeLLpkJz.js";
import { t as Ut } from "./hash-code-ChLbB2tb.js";
import { t as Wt } from "./app-intl-signal-DF17N7z2.js";
import { n as Gt, r as Kt } from "./use-resolved-theme-variant-CbBTynE2.js";
import { r as qt } from "./thread-panel-state-CYOPuORF.js";
import { n as Jt } from "./get-file-icon-DafZgplp.js";
import { t as Yt } from "./json-CuUDWIw2.js";
import { t as Xt } from "./image-square-DpHX97RA.js";
import { t as Zt } from "./copy-to-clipboard-q_KxH8lM.js";
import { o as Qt } from "./workspace-file-context-menu-DgnWY6RP.js";
import { t as $t } from "./check-md-CZTnvSiA.js";
import { t as en } from "./chevron-right-BZtXyaBk.js";
import { t as tn } from "./use-stable-callback-B56R_Ee2.js";
import { n as nn } from "./use-resize-observer-CbHbkQNx.js";
import { r as rn, t as an } from "./dropdown-CHaZfyxI.js";
import { t as on } from "./three-dots-CGeU8S03.js";
import { n as sn, r as cn } from "./code-snippet-BL80sM4U.js";
import { t as ln } from "./copy-Bnv7rlOa.js";
import { t as un } from "./use-diff-comment-sources-MfRVxgk-.js";
import { r as dn } from "./right-panel-composer-overlay-scroll-reserve-C9VI_5j1.js";
import {
  l as fn,
  r as pn,
  s as mn,
...
import { t as gn } from "./file-tree-search-input-DWq_lg9v.js";
import {
  d as _n,
  f as vn,
  l as yn,
...
import { r as Nn } from "./artifact-preview-header-Bg8DeK2Z.js";
import { t as Pn } from "./folders-M-71dKsg.js";
import { t as Fn } from "./history-TBKhiAS8.js";
import { t as In } from "./mcp-capability-file-viewer-frame-KIfIgFwl.js";
import { t as Ln } from "./workspace-directory-tree-6VKuPNyp.js";
var Rn = -1,
  zn = class {
    __id = `file-renderer:${++Rn}`;
    highlighter;
    renderCache;
    computedLang = `text`;
    lineAnnotations = {};
    lineCache;
    constructor(e = { theme: bt }, t, n) {
      ((this.options = e),
        (this.onRenderUpdate = t),
        (this.workerManager = n),
        n?.isWorkingPool() !== !0 && (this.highlighter = _e(e.theme ?? bt) ? re() : void 0));
    }
    setOptions(e) {
      this.options = e;
    }
    ...
    hydrate(e) {
      let { options: t } = this.getRenderOptions(e),
        n = this.workerManager?.getFileResultCache(e);
      (n != null && !Bn(t, n.options) && (n = void 0),
        (this.renderCache ??= {
          file: e,
          options: t,
          highlighted: !T(e),
        ...
        this.workerManager?.isWorkingPool() === !0
          ? (this.renderCache.result ?? this.workerManager.highlightFileAST(this, e))
          : (this.highlighter ??
            ((this.computedLang = e.lang ?? p(e.name)), this.initializeHighlighter())));
    }
    getRenderOptions(e) {
      let t = (() => {
          if (this.workerManager?.isWorkingPool() === !0)
            return this.workerManager.getFileRenderOptions();
          let { theme: e = bt, tokenizeMaxLineLength: t = 1e3 } = this.options;
          return { theme: e, useTokenTransformer: w(this.options), tokenizeMaxLineLength: t };
        })(),
        { renderCache: n } = this;
      return n?.result == null || e !== n.file || !Bn(t, n.options)
        ? { options: t, forceRender: !0 }
        : { options: t, forceRender: !1 };
    }
    getOrCreateLineCache(e) {
      if (e.cacheKey == null) return ((this.lineCache = void 0), b(e.contents));
      let { lineCache: t } = this;
      return (
        (t == null || t.cacheKey !== e.cacheKey) &&
          (t = { cacheKey: e.cacheKey, lines: b(e.contents) }),
        (this.lineCache = t),
        t.lines
      );
    }
    renderFile(e = this.renderCache?.file, t = xt) {
      if (e == null) return;
      let n = this.workerManager?.getFileResultCache(e);
      n != null &&
        this.renderCache == null &&
        (this.renderCache = { file: e, highlighted: !0, renderRange: void 0, ...n });
      let { options: r, forceRender: i } = this.getRenderOptions(e);
      if (
        ((this.renderCache ??= {
          file: e,
          highlighted: !1,
        ...
        ((this.renderCache.result == null ||
          (!this.renderCache.highlighted &&
            (e !== this.renderCache.file || !v(this.renderCache.renderRange, t)))) &&
          ((this.renderCache.file = e),
          (this.renderCache.result = this.workerManager.getPlainFileAST(
            e,
            t.startingLine,
            t.totalLines,
            this.getOrCreateLineCache(e),
          )),
          (this.renderCache.renderRange = t)),
          t.totalLines > 0 &&
            (!this.renderCache.highlighted || i) &&
            this.workerManager.highlightFileAST(this, e));
      else {
        this.computedLang = e.lang ?? p(e.name);
        let t = this.highlighter != null && _e(r.theme),
          n = this.highlighter != null && D(this.computedLang);
        if (
          this.highlighter != null &&
          t &&
          (i || (!this.renderCache.highlighted && n) || this.renderCache.result == null)
        ) {
          let { result: t, options: r } = this.renderFileWithHighlighter(e, this.highlighter, !n);
          this.renderCache = {
            file: e,
            options: r,
            highlighted: n,
      ...
      return this.renderCache.result == null
        ? void 0
        : this.processFileResult(this.renderCache.file, t, this.renderCache.result);
    }
    async asyncRender(e, t = xt) {
      let { result: n } = await this.asyncHighlight(e);
      return this.processFileResult(e, t, n);
    }
    async asyncHighlight(e) {
      this.computedLang = e.lang ?? p(e.name);
      let t = this.highlighter != null && S(x(this.options.theme)),
        n = this.highlighter != null && D(this.computedLang);
      return (
        (this.highlighter == null || !t || !n) &&
          (this.highlighter = await this.initializeHighlighter()),
        this.renderFileWithHighlighter(e, this.highlighter)
      );
    }
    renderFileWithHighlighter(e, t, n = !1) {
      let { options: r } = this.getRenderOptions(e);
      return { result: _(e, t, r, { forcePlainText: n }), options: r };
    }
    processFileResult(e, t, { code: n, themeStyles: r, baseThemeType: i }) {
      let { disableFileHeader: a = !1 } = this.options,
        o = [],
        s = ae(),
        c = this.getOrCreateLineCache(e),
        l = 0;
      return (
        C({
          lines: c,
          ...
          callback: ({ lineIndex: t, lineNumber: r }) => {
            let i = n[t];
            if (i == null) {
              let n = `FileRenderer.processFileResult: Line doesnt exist`;
              throw (
                console.error(n, { name: e.name, lineIndex: t, lineNumber: r, lines: c }),
                Error(n)
              );
            }
            if (i != null) {
              (s.children.push(le(`context`, r, `${t}`)), o.push(i), l++);
              let e = this.lineAnnotations[r];
              e != null &&
                (s.children.push(ye(`context`, `annotation`, 1)),
                o.push(
                  te({
                    type: `annotation`,
                    hunkIndex: 0,
                    lineIndex: r,
                    annotations: e.map((e) => O(e)),
                  }),
                ),
                l++);
            }
        ...
        (s.properties.style = `grid-row: span ${l}`),
        {
          gutterAST: s.children ?? [],
          contentAST: o,
          preAST: this.createPreElement(c.length),
          headerAST: a ? void 0 : this.renderHeader(e),
          totalLines: c.length,
          rowCount: l,
          themeStyles: r,
          baseThemeType: i,
    ...
    renderHeader(e) {
      let { headerRenderMode: t = `default` } = this.options;
      return y({ fileOrDiff: e, mode: t });
    }
    renderFullHTML(e) {
      return me(this.renderFullAST(e));
    }
    renderFullAST(e, t = []) {
      return (
        t.push(
          he({ tagName: `code`, children: this.renderCodeAST(e), properties: { "data-code": `` } }),
        ),
        { ...e.preAST, children: t }
      );
    }
    renderCodeAST(e) {
      ...
      return (
        ...
        [t, ee(e.contentAST, e.rowCount)]
      );
    }
    renderPartialHTML(e, t = !1) {
      return me(t ? he({ tagName: `code`, children: e, properties: { "data-code": `` } }) : e);
    }
    async initializeHighlighter() {
      return ((this.highlighter = await M(Ee(this.computedLang, this.options))), this.highlighter);
    }
    ...
    createPreElement(e) {
      let { disableLineNumbers: t = !1, overflow: n = `scroll` } = this.options;
      return ne({
        type: `file`,
        diffIndicators: `none`,
        disableBackground: !0,
...
var Hn = [],
  ...
  Wn = class {
    ...
    file;
    renderRange;
    constructor(e = { theme: bt }, t, n = !1) {
      ((this.options = e),
        (this.workerManager = t),
        (this.isContainerManaged = n),
        (this.fileRenderer = new zn(e, this.handleHighlightRender, this.workerManager)),
        (this.resizeManager = new d()),
        (this.interactionManager = new P(`file`, Se(e))),
    ...
    rerender() {
      this.file != null &&
        this.render({ file: this.file, forceRender: !0, renderRange: this.renderRange });
    }
    setOptions(e) {
      e != null && ((this.options = e), this.interactionManager.setOptions(Se(e)));
    }
    mergeOptions(e) {
      this.options = { ...this.options, ...e };
    }
    ...
    hydrate(e) {
      ...
      (this.hydrateElements(t, n),
        Gn(this.pre, i, this.options.collapsed) ||
        Kn(this.headerElement, i, this.options.disableFileHeader)
    ...
    hydrateElements(e, t) {
      ...
      for (let t of Array.from(e.shadowRoot?.children ?? [])) {
        ...
        if (t instanceof HTMLElement) {
          ...
          if (t instanceof HTMLStyleElement && t.hasAttribute(`data-theme-css`)) {
            this.themeCSSStyle = t;
            continue;
          }
          if (t instanceof HTMLStyleElement && t.hasAttribute(`data-unsafe-css`)) {
            ((this.unsafeCSSStyle = t), (this.appliedUnsafeCSS = t.textContent));
            continue;
          }
          if (`diffsHeader` in t.dataset) {
            ((this.headerElement = t), (this.lastRenderedHeaderHTML = void 0));
            continue;
          }
        }
      }
      (this.pre != null &&
        (this.syncCodeNodeFromPre(this.pre), this.pre.removeAttribute(`data-dehydrated`)),
    ...
    hydrationSetup({ file: e, lineAnnotations: t }) {
      ...
      ((this.lineAnnotations = t ?? this.lineAnnotations),
        ...
        this.fileRenderer.setOptions({
          ...this.options,
          headerRenderMode: this.options.renderCustomHeader == null ? `default` : `custom`,
        }),
        this.pre != null &&
          ...
          this.resizeManager.setup(this.pre, n === `wrap`)));
    }
    getOrCreateLineCache(e = this.file) {
      return e == null ? Hn : this.fileRenderer.getOrCreateLineCache(e);
    }
    render({
      file: e,
      fileContainer: t,
      ...
      let { collapsed: s = !1, themeType: c = `system` } = this.options,
        l = s ? void 0 : o,
        u = this.renderRange,
        d =
          a != null && (a.length > 0 || this.lineAnnotations.length > 0)
            ? a !== this.lineAnnotations
            : !1,
        p = !f(this.file, e);
      if (!s && !n && v(l, this.renderRange) && !p && !d) return !1;
      ((this.renderRange = l),
        (this.file = e),
        this.fileRenderer.setOptions({
          ...this.options,
        ...
        a != null && this.setLineAnnotations(a),
        this.fileRenderer.setLineAnnotations(this.lineAnnotations));
      let {
        disableErrorHandling: m = !1,
        disableFileHeader: h = !1,
        overflow: g = `scroll`,
      } = this.options;
      if (
        (h &&
        ...
        try {
          let n = this.fileRenderer.renderFile(e, wt);
          (n != null && this.applyThemeState(t, n.themeStyles, c, n.baseThemeType),
            n?.headerAST != null && this.applyHeaderToDOM(n.headerAST, t),
            this.injectUnsafeCSS());
        } catch (e) {
          if (m) throw e;
          (console.error(e), e instanceof Error && this.applyErrorToDOM(e, t));
        }
        return (r || this.emitPostRender(), !0);
      }
      try {
        let r = this.getOrCreatePreNode(t);
        if (!this.canPartiallyRender(n, d, p) || !this.applyPartialRender(u, l)) {
          let n = this.fileRenderer.renderFile(e, l);
          if (n == null)
            return (
          ...
          (this.applyThemeState(t, n.themeStyles, c, n.baseThemeType),
            n.headerAST != null && this.applyHeaderToDOM(n.headerAST, t),
            this.applyFullRender(n, r));
        }
        (this.applyBuffers(r, l),
          this.injectUnsafeCSS(),
          this.interactionManager.setup(r),
          this.resizeManager.setup(r, g === `wrap`),
          this.renderAnnotations(),
          this.renderGutterUtility());
      } catch (e) {
        if (m) throw e;
    ...
    renderPlaceholder(e) {
      ...
      if ((this.cleanChildNodes(), this.placeHolder == null)) {
        let e = this.fileContainer.shadowRoot ?? this.fileContainer.attachShadow({ mode: `open` });
    ...
    renderAnnotations() {
      ...
      if (t != null && this.lineAnnotations.length > 0)
        for (let [n, r] of this.lineAnnotations.entries()) {
          ...
          if (a == null || !Vn(r, a.annotation)) {
            a?.element.remove();
            let e = t(r);
            if (e == null) continue;
            ((a = { element: E(O(r)), annotation: r }),
      ...
      for (let [t, { element: n }] of e.entries()) (this.annotationCache.delete(t), n.remove());
    }
    renderGutterUtility() {
      let e = this.options.renderGutterUtility ?? this.options.renderHoverUtility;
      ...
      let n = h();
      (n.appendChild(t), this.fileContainer.appendChild(n), (this.gutterUtilityContent = n));
    }
    injectUnsafeCSS() {
      ...
      if (t != null) {
        ...
        (this.unsafeCSSStyle?.parentNode === t && this.appliedUnsafeCSS === e) ||
          ((this.unsafeCSSStyle ??= g()),
          this.unsafeCSSStyle.parentNode !== t && t.appendChild(this.unsafeCSSStyle),
          (this.unsafeCSSStyle.textContent = A(e)),
    ...
    applyFullRender(e, t) {
      (this.cleanupErrorWrapper(),
        ...
        (this.code = m({ code: this.code })),
        (this.code.innerHTML = this.fileRenderer.renderPartialHTML(
          this.fileRenderer.renderCodeAST(e),
        )),
        t.replaceChildren(this.code),
    ...
    trimDOMToOverlap(e, t, n) {
      ...
      if (i > a) return !1;
      for (let t = e.children.length - 1; t >= a; --t) e.children[t]?.remove();
    ...
    applyHeaderToDOM(e, t) {
      ...
      let { renderHeaderPrefix: i, renderCustomHeader: a, renderCustomMetadata: o } = this.options;
      if (a != null) {
        let e = a(n) ?? void 0;
        ((this.headerCustom = this.upsertHeaderSlotElement(t, this.headerCustom, vt, e)),
          this.headerPrefix?.remove(),
          this.headerMetadata?.remove(),
          (this.headerPrefix = void 0),
          (this.headerMetadata = void 0));
        ...
        let e = i?.(n) ?? void 0,
          r = o?.(n) ?? void 0;
        ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, gt, e)),
          (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, Tt, r)),
          this.headerCustom?.remove(),
          (this.headerCustom = void 0));
      }
    }
    ...
    replaceHeaderSlotContent(e, t) {
      (e.replaceChildren(), t instanceof Element ? e.appendChild(t) : (e.innerText = `${t}`));
    }
    ...
    getOrCreateFileContainerNode(e, t) {
      ...
      if (
        ...
        t != null && this.fileContainer.parentNode !== t && t.appendChild(this.fileContainer),
        this.spriteSVG == null)
      ) {
        let e = document.createElement(`div`);
        e.innerHTML = ue;
        ...
        t instanceof SVGElement &&
          ((this.spriteSVG = t), this.fileContainer.shadowRoot?.appendChild(this.spriteSVG));
      }
      ...
      return (
        this.pre == null
          ...
          : this.pre.parentNode !== t &&
            (e.shadowRoot?.appendChild(this.pre), (this.appliedPreAttributes = void 0)),
    ...
    applyPreNodeAttributes(e, { totalLines: t }) {
      let { overflow: n = `scroll`, disableLineNumbers: r = !1 } = this.options,
        i = {
          type: `file`,
          split: !1,
          overflow: n,
      ...
      de(i, this.appliedPreAttributes) || (Te(e, i), (this.appliedPreAttributes = i));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
      let n = this.getOrCreatePreNode(t);
      ((n.innerHTML = ``), n.remove(), (this.pre = void 0), (this.appliedPreAttributes = void 0));
      ...
      ((i.dataset.errorMessage = ``), (i.innerText = e.message), this.errorWrapper.appendChild(i));
...
var qn = -1,
  Jn = class extends Wn {
    __id = `virtualized-file:${++qn}`;
    top;
    height = 0;
    heightCache = new Map();
    isVisible = !1;
    isSetup = !1;
    constructor(e, t, n = yt, r, i = !1) {
    ...
    setOptions(e) {
      if (e == null) return;
      let t = this.options.overflow,
        n = this.options.collapsed;
      (super.setOptions(e),
        (t !== this.options.overflow || n !== this.options.collapsed) &&
      ...
      if (n instanceof HTMLElement) {
        for (let e of n.children) {
          ...
          e.nextElementSibling instanceof HTMLElement &&
            ...
            (`noNewline` in e.nextElementSibling.dataset && (a = !0),
            (i += e.nextElementSibling.getBoundingClientRect().height));
          let o = this.getLineHeight(r, a);
          i !== o &&
            ((t = !0),
            i === this.metrics.lineHeight * (a ? 2 : 1)
              ? this.heightCache.delete(r)
              : this.heightCache.set(r, i));
        }
    ...
    computeApproximateSize() {
      let e = this.height === 0;
      if (((this.height = 0), this.file == null)) return;
      let { disableFileHeader: t = !1, collapsed: n = !1, overflow: r = `scroll` } = this.options,
        { diffHeaderHeight: i, fileGap: a, lineHeight: o } = this.metrics,
        s = this.getOrCreateLineCache(this.file);
      if (
        (t ? (this.height += a) : (this.height += i),
        !n &&
          (r === `scroll` && this.lineAnnotations.length === 0
            ? (this.height += this.getOrCreateLineCache(this.file).length * o)
            : C({
                lines: s,
                callback: ({ lineIndex: e }) => {
                  this.height += this.getLineHeight(e, !1);
                },
              }),
          s.length > 0 && (this.height += a),
    ...
    render({ fileContainer: e, file: t, ...n }) {
      let { isSetup: r } = this;
      if (((this.file ??= t), (e = this.getOrCreateFileContainerNode(e)), this.file == null))
        return (
          console.error(
      ...
      let i = this.virtualizer.getWindowSpecs(),
        a = this.computeRenderRangeFromWindow(this.file, this.top, i);
      return super.render({ file: this.file, fileContainer: e, renderRange: a, ...n });
    }
    computeRenderRangeFromWindow(e, t, { top: n, bottom: r }) {
      let { disableFileHeader: i = !1, overflow: a = `scroll` } = this.options,
        { diffHeaderHeight: o, fileGap: s, hunkLineCount: c, lineHeight: l } = this.metrics,
        u = this.getOrCreateLineCache(e),
        d = u.length,
        f = this.height,
        p = i ? s : o;
      if (t < n - f || t > r)
        return { startingLine: 0, totalLines: 0, bufferBefore: 0, bufferAfter: f - p - s };
      if (d <= c) return { startingLine: 0, totalLines: c, bufferBefore: 0, bufferAfter: 0 };
      let m = Math.ceil(Math.max(r - n, 0) / l),
        h = Math.ceil(m / c) * c + c * 2,
        g = h / c,
        _ = (n + r) / 2;
      if (a === `scroll` && this.lineAnnotations.length === 0) {
        let e = Math.floor((_ - (t + p)) / l),
          n = Math.floor(e / c) - Math.floor(g / 2),
          r = Math.ceil(d / c),
          i = Math.max(0, Math.min(n, r)) * c,
          a = n < 0 ? h + n * c : h,
          o = i * l,
          s = Math.min(a, d - i);
        return {
          ...
          totalLines: a,
          bufferBefore: o,
          bufferAfter: Math.max(0, (d - i - s) * l),
        };
      }
      let v = g,
        y = [],
      ...
      if (
        (C({
          ...
          callback: ({ lineIndex: e }) => {
            let i = x % c === 0;
            if (i && (y.push(b - (t + p)), T != null)) {
              if (T <= 0) return !0;
              T--;
            }
            let a = this.getLineHeight(e, !1),
              o = Math.floor(x / c);
            return (
              b > n - a && b < r && (S ??= o),
              b + a > _ && (w ??= o),
      ...
      let E = y.length;
      w ??= S;
      let ee = Math.round(w - g / 2),
        D = Math.max(0, E - g),
        O = Math.max(0, Math.min(ee, D)),
        k = O * c,
        A = ee < 0 ? h + ee * c : h,
        te = y[O] ?? 0,
        ne = O + A / c;
      return {
        ...
        totalLines: A,
        bufferBefore: te,
        bufferAfter: ne < y.length ? f - p - y[ne] - s : f - (b - t) - s,
      };
    }
  },
  Yn = t((e) => {
      ...
      (e.unstable_scheduleCallback = function (r, i, a) {
        ...
        return (
          ...
          a > o
            ? ((r.sortIndex = a),
              t(l, r),
              n(c) === null && r === n(l) && (h ? (v(C), (C = -1)) : (h = !0), A(x, a - o)))
  ...
  Zn = t((e) => {
    ...
    function te(e) {
      ...
      if (typeof e == `object`)
        switch (e.$$typeof) {
          ...
          case T:
            return ((t = e.displayName || null), t === null ? te(e.type) || `Memo` : t);
          case E:
    ...
    var se = oe(null),
      ...
      ue = oe(null);
    function de(e, t) {
      switch ((P(le, t), P(ce, e), P(se, null), t.nodeType)) {
        case 9:
        case 11:
    ...
    function me(e) {
      (ce.current === e && (N(se), N(ce)), ue.current === e && (N(ue), (Qf._currentValue = re)));
    }
    var he, ge;
    function _e(e) {
      if (he === void 0)
...
` +
    ...
    var Se = Object.prototype.hasOwnProperty,
      ...
      F = t.unstable_ImmediatePriority,
      ...
      I = null;
    function Le(e) {
      if ((typeof Pe == `function` && Fe(e), I && typeof I.setStrictMode == `function`))
        try {
          I.setStrictMode(Ie, e);
        } catch {}
    }
    ...
    var xn = {
      ...
      kn = bn(On),
      An = bn(p({}, On, { dataTransfer: 0 })),
      jn = bn(p({}, Cn, { relatedTarget: 0 })),
      Mn = bn(p({}, xn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Nn = bn(
        p({}, xn, {
    ...
    var Bn = bn(
      ...
      Un = bn(p({}, xn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Wn = bn(
        p({}, On, {
          deltaX: function (e) {
    ...
    function tr(e, t) {
      switch (e) {
        case `compositionend`:
          return R(t);
        case `keypress`:
          return t.which === 32 ? ((L = !0), Qn) : null;
        case `textInput`:
          return ((e = t.data), e === Qn && L ? null : e);
        default:
          return null;
      }
    }
    ...
    function di(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) ci(e) && (s = 1);
        ...
        a: switch (e) {
          case ee:
            return ((e = si(31, n, t, a)), (e.elementType = ee), (e.lanes = o), e);
          case _:
          ...
          case v:
            ...
            break;
          case y:
            return ((e = si(12, n, t, a | 2)), (e.elementType = y), (e.lanes = o), e);
          case C:
            return ((e = si(13, n, t, a)), (e.elementType = C), (e.lanes = o), e);
          case w:
            return ((e = si(19, n, t, a)), (e.elementType = w), (e.lanes = o), e);
          default:
    ...
    function _i(e, t) {
      if (typeof e == `object` && e) {
        var n = gi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: xe(t) }), gi.set(e, t), t) : n;
      }
    ...
    function Fa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === _
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === E && Ea(i) === t.type))
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          ...
          if (ne(t) || k(t)) return ((t = fi(t, e.mode, n, null)), (t.return = e), t);
          if (typeof t.then == `function`) return f(e, Ma(t), n);
          if (t.$$typeof === x) return f(e, ea(e, t), n);
          Pa(e, t);
        }
        return null;
      }
      function p(e, t, n, r) {
        ...
        if (typeof n == `object` && n) {
          ...
          if (ne(n) || k(n)) return i === null ? d(e, t, n, r, null) : null;
          if (typeof n.then == `function`) return p(e, t, Ma(n), r);
          if (n.$$typeof === x) return p(e, t, ea(e, n), r);
          Pa(e, n);
        }
        return null;
      }
      function m(e, t, n, r, i) {
        ...
        if (typeof r == `object` && r) {
          ...
          if (ne(r) || k(r)) return ((e = e.get(n) || null), d(t, e, r, i, null));
          if (typeof r.then == `function`) return m(e, t, n, Ma(r), i);
          if (r.$$typeof === x) return m(e, t, n, ea(t, r), i);
          Pa(t, r);
        }
        return null;
      }
      ...
      function b(e, r, o, c) {
        if (
          ...
          switch (o.$$typeof) {
            case h:
              a: {
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === _)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === E && Ea(l) === r.type)
                    ) {
                ...
                o.type === _
                  ? ((c = fi(o.props.children, e.mode, c, o.key)), (c.return = e), (e = c))
          ...
          if (o.$$typeof === x) return b(e, r, ea(e, o), c);
          Pa(e, o);
        }
    ...
    function Mo(e) {
      ...
      return (
        ...
        (fo === null ? t.memoizedState : fo.next) === null &&
          ((t = t.alternate), (j.H = t === null || t.memoizedState === null ? zs : Bs)),
        e
      );
    }
    function No(e) {
    ...
    function ns(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          ((H.flags |= 2048), as(9, { destroy: void 0 }, rs.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function rs(e, t) {
    ...
    function tc(e, t, n, r, a) {
      ...
      if (((o = _i(o, n)), Xl === null ? (Xl = [o]) : Xl.push(o), Wl !== 4 && (Wl = 2), t === null))
        return !0;
      ((r = _i(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function pc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((io(t), a))
          ...
          if (((r = q), r !== null && ((s = tt(r, n)), s !== 0 && s !== o.retryLane)))
    ...
    function Sc(e, t, n) {
      var r = t.pendingProps,
        ...
        s;
      if (
        ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (co.current & 2) != 0),
        s && ((a = !0), (t.flags &= -129)),
        (s = (t.flags & 32) != 0),
        (t.flags &= -33),
        e === null)
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = q), s !== null && ((r = tt(s, n)), r !== 0 && r !== l.retryLane)))
      ...
      return a
        ? (oo(t),
          ...
          u === null ? ((c = fi(c, a, n, null)), (c.flags |= 2)) : (c = li(u, c)),
          (c.return = t),
          (r.return = t),
          (r.sibling = c),
          (t.child = r),
          ...
          c === null
            ...
            : ((a = c.cachePool),
              a === null
                ? (a = ya())
                : ((l = aa._currentValue), (a = a.parent === l ? a : { parent: l, pool: l })),
    ...
    function Mc(e, t, n) {
      ...
      switch (((t.lanes = 0), t.tag)) {
          ...
          return (
            e === null &&
              ...
              ((a = r = B) &&
                ...
                r === null
                  ? (a = !1)
                  : ((t.stateNode = r), (Mi = t), (B = cf(r.firstChild)), (Pi = !1), (a = !0))),
              a || Ii(t)),
            pe(t),
            (a = t.type),
            (o = t.pendingProps),
            ...
            t.memoizedState !== null && ((a = So(e, t, To, null, null, n)), (Qf._currentValue = a)),
            mc(e, t),
            ic(e, t, r, n),
            t.child
          );
        ...
        case 12:
          return (ic(e, t, t.pendingProps.children, n), t.child);
        case 10:
          return ((r = t.pendingProps), Ki(t, t.type, r.value), ic(e, t, r.children, n), t.child);
        case 9:
          return (
            (a = t.type._context),
          ...
          return (
            ...
            e === null
              ...
              : ((e.lanes & n) !== 0 && (Ba(e, t), qa(t, null, null, n), Ka()),
                ...
                (o = t.memoizedState),
                a.parent === r
                  ? ((r = o.cache), Ki(t, aa, r), r !== a.cache && Yi(t, [aa], n, !0))
                  : ((a = { parent: r, cache: r }),
                    (t.memoizedState = a),
    ...
    function Ic(e, t) {
      (t !== null && (e.flags |= 4),
        e.flags & 16384 && ((t = e.tag === 22 ? 536870912 : Ye()), (e.lanes |= t), (Yl |= t)));
    }
    function Lc(e, t) {
      if (!V)
        switch (e.tailMode) {
    ...
    function Rc(e, t, n) {
      ...
      switch ((Ai(t), t.tag)) {
        ...
        case 27:
          if ((me(t), (n = le.current), (a = t.type), e !== null && t.stateNode != null))
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && Nc(t);
            ...
            if (((e = le.current), zi(t))) {
              if (((e = t.stateNode), (n = t.memoizedProps), (r = null), (a = Mi), a !== null))
                switch (a.tag) {
                  case 27:
                  case 5:
                    r = a.memoizedProps;
        ...
        case 4:
          return (fe(), e === null && Sd(t.stateNode.containerInfo), W(t), null);
        case 10:
            ...
            if (!a)
              if (((e = lo(o)), e !== null)) {
                if (
                  ...
                  Ic(t, e),
                  Lc(r, !0),
                  r.tail === null && r.tailMode === `hidden` && !o.alternate && !V)
                )
                  return (W(t), null);
              } else
    ...
    function Bu() {
      if (iu === 4 || iu === 3) {
        ...
        if (
          ...
          rt(n),
          (t = t.stateNode),
          I && typeof I.onCommitFiberRoot == `function`)
        )
          try {
            I.onCommitFiberRoot(Ie, t, void 0, (t.current.flags & 128) == 128);
          } catch {}
        if (r !== null) {
    ...
    function Uu() {
      ...
      try {
        ...
        if (
          ...
          (K = c),
          id(0, !1),
          I && typeof I.onPostCommitFiberRoot == `function`)
        )
          try {
            I.onPostCommitFiberRoot(Ie, o);
          } catch {}
        return !0;
      } finally {
        ((M.p = a), (j.T = r), Vu(e, t));
    ...
    function cd(e, t) {
      ...
      var r = Y;
      return (
        (r = Ke(e, e === q ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        r === 0
          ? null
          : (gu(e, r, t),
            sd(e, De()),
    ...
    function md(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = fd((i[ct] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[ct] || null) ? fd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== tn && (u = n.relatedTarget || n.fromElement) && (gt(u) || u[lt]))
            )
              break a;
            if (
              (l || c) &&
          ...
          switch (((y = r ? vt(r) : window), e)) {
            case `focusin`:
              (ir(y) || y.contentEditable === `true`) && ((z = y), (Ar = r), (jr = null));
              break;
            case `focusout`:
              jr = Ar = z = null;
              break;
          ...
          (x &&
            (Zn &&
              ...
              (er || x !== `onCompositionStart`
                ...
                : ((pn = i), (mn = `value` in pn ? pn.value : pn.textContent), (er = !0))),
            (y = Ed(r, x)),
            0 < y.length &&
              ((x = new Pn(x, e, null, n, i)),
              s.push({ event: x, listeners: y }),
              b ? (x.data = b) : ((b = R(n)), b !== null && (x.data = b)))),
            (b = Yn ? tr(e, n) : nr(e, n)) &&
...
`,
    ...
    function Tf(e, t) {
      ...
      if (n && e) {
        ...
        if (
          !mf.has(a) &&
          ((e = p({ rel: `modulepreload`, href: e }, t)), mf.set(a, e), n.querySelector(i) === null)
        ) {
          switch (r) {
            case `audioworklet`:
            case `paintworklet`:
  ...
  return (0, L.jsxs)(L.Fragment, {
    children: [
      u == null
        ? (0, L.jsxs)(L.Fragment, {
            children: [
              d != null && (0, L.jsx)(`div`, { slot: `header-prefix`, children: d }),
              f != null && (0, L.jsx)(`div`, { slot: `header-metadata`, children: f }),
            ],
          })
        : (0, L.jsx)(`div`, { slot: vt, children: u }),
      i != null && a?.map((e, t) => (0, L.jsx)(`div`, { slot: O(e), children: i(e) }, t)),
      l != null && (0, L.jsx)(`div`, { slot: `gutter-utility-slot`, style: Ce, children: l(c) }),
    ],
  });
}
var R = e(l(), 1),
  er = typeof window > `u` ? R.useEffect : R.useLayoutEffect;
function tr({
  file: e,
  options: t,
  lineAnnotations: n,
  ...
  let l = N(),
    ...
    f = ce((r) => {
      if (r != null) {
        if (d.current != null)
          throw Error(`File: An instance should not already exist when a node is created`);
        (l == null
          ? (d.current = new Wn(
              nr({ hasCustomHeader: s, hasGutterRenderUtility: o, options: t }),
              c ? void 0 : u,
              !0,
            ))
          : (d.current = new Jn(
        ...
        if (d.current == null) throw Error(`File: A File instance should exist when unmounting`);
  ...
  return (
    er(() => {
      ...
      let i = nr({ hasCustomHeader: s, hasGutterRenderUtility: o, options: t }),
        a = !ge(d.current.options, i);
      (d.current.setOptions(i),
        d.current.render({ file: e, lineAnnotations: n, forceRender: a }),
        r !== void 0 && d.current.setSelectedLines(r));
    }),
    { ref: f, getHoveredLine: (0, R.useCallback)(() => d.current?.getHoveredLine(), []) }
  );
}
function nr({ options: e, hasCustomHeader: t, hasGutterRenderUtility: n }) {
  return n || t
    ? { ...e, renderCustomHeader: t ? se : void 0, renderGutterUtility: n ? se : void 0 }
    : e;
}
function rr({
  file: e,
...
var ir = `opaline-thread-find-match`,
  ar = `opaline-thread-find-active`,
  or = `data-content-search-match-id`,
  sr = `opaline-thread-find-shadow-style`,
  cr = `
...
function fr({ element: e, matchId: t }) {
  e.setAttribute(or, t);
}
function pr({ container: e, matchId: t, includeShadowRoots: n }) {
  let r = Dr(t);
  for (let t of br(e, { includeShadowRoots: n })) {
    let e = t.querySelector(`[${or}="${r}"]`);
    if (e != null) return e;
  }
  return null;
}
function mr({ container: e, lineNumber: t, side: n, includeShadowRoots: r }) {
  let i = Dr(`${t}`),
    a = n === `additions` ? `[data-additions]` : n === `deletions` ? `[data-deletions]` : null;
  for (let t of br(e, { includeShadowRoots: r })) {
    if (a != null) {
      let e =
        gr({ root: t, selector: `${a}[data-line="${i}"]` }) ??
        gr({ root: t, selector: `${a} [data-line="${i}"]` }) ??
        gr({ root: t, selector: `[data-line="${i}"] ${a}` });
      if (e != null) return e;
      if (hr(t)) continue;
    }
    let e = gr({ root: t, selector: `[data-line="${i}"]` });
    if (e != null) return e;
  }
  return null;
}
...
function vr({ target: e, query: t, maxMatches: n, includeShadowRoots: r }) {
  if (n <= 0) return { matches: [], isCapped: !1 };
  let i = t.trim();
  if (i.length === 0) return { matches: [], isCapped: !1 };
  let a = [],
    o = br(e, { includeShadowRoots: r }),
    s = !1;
  for (let e of o) {
    let t = n - a.length;
    if (t <= 0) {
    ...
    let r = Cr({ root: e, query: i, maxMatches: t });
...
function yr(e) {
  for (let t of e) if (!Tr(t)) return !0;
  return !1;
}
function br(e, t) {
  let n = [e];
  ...
  for (; r.length > 0; ) {
    ...
    for (; i != null; )
      (i instanceof HTMLElement &&
        i.shadowRoot != null &&
        (xr(i.shadowRoot), n.push(i.shadowRoot), r.push(i.shadowRoot)),
        (i = t.nextNode()));
  }
  return n;
}
function xr(e) {
  if (e.getElementById(sr) != null) return;
  let t = document.createElement(`style`);
  ((t.id = sr), (t.textContent = cr), e.append(t));
}
function Sr(e) {
...
function Cr({ root: e, query: t, maxMatches: n }) {
  if (n <= 0) return { matches: [], isCapped: !1 };
  let r = Sr(e);
...
function Tr(e) {
  if (e.type === `characterData`) {
    ...
    return t == null ? !1 : Er(t);
  }
  if (e.type !== `childList`) return !1;
  if (Er(e.target)) return !0;
...
function Er(e) {
  return e instanceof HTMLElement
    ? e.classList.contains(`opaline-thread-find-active`)
      ? !0
...
function Or(e) {
  let t = new Map();
  for (let n of e) {
    if (n.location.domain !== `conversation`) continue;
    let e = lr(n.location.turnKey, n.location.unitId),
      r = t.get(e) ?? [];
    (r.push(n), t.set(e, r));
  }
  return t;
...
function kr(e) {
  let t = new Map();
  for (let n of e) {
    if (n.location.domain !== `diff`) continue;
    let e = t.get(n.location.path) ?? [];
    (e.push(n), t.set(n.location.path, e));
  }
  return t;
}
var z = Me();
function Ar(e) {
  let t = (0, z.c)(5),
    { path: n, skipFindHighlight: r } = e,
    i = F(Mt),
    a = F(kt)?.id ?? null,
    o;
  return (
    t[0] !== i || t[1] !== a || t[2] !== n || t[3] !== r
      ? ((o = (e) => {
          jr({
            activeDiffResult: i,
            activeMatchId: a,
...
function jr({
  ...
  if ((_r(n, { includeShadowRoots: !0 }), i || e == null)) return;
  let a = kr(e.matches).get(r);
  a == null ||
    a.length === 0 ||
    Mr({ activeMatchId: t, fileDiffElement: n, query: e.query, sourceMatches: a }) ||
    vr({ target: n, query: e.query, maxMatches: a.length, includeShadowRoots: !0 }).matches.forEach(
      (e, n) => {
        let r = a[n];
        r != null && (fr({ element: e, matchId: r.id }), r.id === t && e.classList.add(ar));
      },
    );
}
function Mr({ activeMatchId: e, fileDiffElement: t, query: n, sourceMatches: r }) {
  if (r.some((e) => e.location.domain === `diff` && e.location.hunkId === `path`)) return !1;
  let i = new Map();
  for (let e of r) {
    if (e.location.domain !== `diff` || e.location.lineStart !== e.location.lineEnd) continue;
    let t = `${e.location.side ?? `unified`}:${e.location.lineStart}`,
      n = i.get(t) ?? { lineNumber: e.location.lineStart, side: e.location.side, matches: [] };
    (n.matches.push(e), i.set(t, n));
  }
  let a = !1,
    o = !1;
  for (let r of i.values()) {
    a = !0;
    let i = mr({ container: t, lineNumber: r.lineNumber, side: r.side, includeShadowRoots: !0 });
    i != null &&
      ((o = !0),
      vr({
        target: i,
        ...
        let i = r.matches[n];
        i != null && (fr({ element: t, matchId: i.id }), i.id === e && t.classList.add(ar));
      }));
  }
  return o || (a && (t.matches(`[data-line]`) || t.querySelector(`[data-line]`) != null));
}
var Nr = new Map([
    [`.babelrc`, `jsonc`],
    [`.babelrc.json`, `jsonc`],
...
function Fr(e) {
  let t = e.split(/[\\/]/).pop()?.toLowerCase() ?? ``,
    n = Nr.get(t);
  if (n != null) return n;
  for (let [e, n] of Pr) if (t.endsWith(e)) return n;
}
function Ir(e) {
  let t = (0, z.c)(22),
    {
      ...
      lineNumber: a,
      onOpenBlameLink: o,
      onToggleExpandedBlameLine: s,
      repositoryWebUrl: c,
    } = e,
    l;
  t[0] === i ? (l = t[1]) : ((l = Wr(i)), (t[0] = i), (t[1] = l));
  let u;
  t[2] !== a || t[3] !== s
    ? ((u = (e) => {
        (e.preventDefault(), e.stopPropagation(), s(a));
      }),
      (t[2] = a),
      (t[3] = s),
      (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] === i ? (d = t[6]) : ((d = Gr(i)), (t[5] = i), (t[6] = d));
  let f;
  t[7] === d
    ? (f = t[8])
    : ((f = (0, L.jsx)(`span`, { "data-file-blame-author": ``, children: d })),
      (t[7] = d),
      (t[8] = f));
  let p;
  t[9] !== n || t[10] !== l || t[11] !== u || t[12] !== f
    ? ((p = (0, L.jsx)(`button`, {
        type: `button`,
    ...
    : (p = t[13]);
  let m;
  t[14] !== r || t[15] !== i || t[16] !== o || t[17] !== c
    ? ((m = (0, L.jsx)(Lr, { labels: r, line: i, onOpenBlameLink: o, repositoryWebUrl: c })),
      (t[14] = r),
      (t[15] = i),
      (t[16] = o),
      (t[17] = c),
  ...
  return (
    t[19] !== p || t[20] !== m
      ? ((h = (0, L.jsxs)(L.Fragment, { children: [p, m] })), (t[19] = p), (t[20] = m), (t[21] = h))
      : (h = t[21]),
    h
  );
}
function Lr(e) {
  let t = (0, z.c)(45),
    { labels: n, line: r, onOpenBlameLink: i, repositoryWebUrl: a } = e,
    o;
  t[0] !== r.commitSha || t[1] !== r.summary
    ? ((o = r.summary ?? r.commitSha.slice(0, 8)),
      (t[0] = r.commitSha),
      (t[1] = r.summary),
      (t[2] = o))
    : (o = t[2]);
  let s = o,
    c;
  t[3] === r ? (c = t[4]) : ((c = Br(r)), (t[3] = r), (t[4] = c));
  let l = c,
    u;
  t[5] !== r || t[6] !== a ? ((u = Vr(r, a)), (t[5] = r), (t[6] = a), (t[7] = u)) : (u = t[7]);
  let d = u,
    f;
  t[8] !== r || t[9] !== a ? ((f = Hr(r, a)), (t[8] = r), (t[9] = a), (t[10] = f)) : (f = t[10]);
  let p = f,
    m;
  t[11] === r.authorTime
    ? (m = t[12])
    : ((m = Xr(r.authorTime)), (t[11] = r.authorTime), (t[12] = m));
  let h = m,
    g;
  t[13] === s
    ? (g = t[14])
    : ((g = (0, L.jsx)(`span`, { "data-file-blame-tooltip-title": ``, children: s })),
      (t[13] = s),
      (t[14] = g));
  let _;
  t[15] !== l || t[16] !== r || t[17] !== i
    ? ((_ = l == null ? Gr(r) : (0, L.jsx)(zr, { link: l, onOpenBlameLink: i })),
      (t[15] = l),
      (t[16] = r),
      (t[17] = i),
      (t[18] = _))
    : (_ = t[18]);
  let v;
  t[19] !== n.author || t[20] !== _
    ? ((v = (0, L.jsx)(Rr, { label: n.author, children: _ })),
      (t[19] = n.author),
      (t[20] = _),
      (t[21] = v))
    : (v = t[21]);
  let y;
  t[22] !== h || t[23] !== n.date
    ? ((y = h && (0, L.jsx)(Rr, { label: n.date, children: h })),
      (t[22] = h),
      (t[23] = n.date),
      (t[24] = y))
    : (y = t[24]);
  let b;
  t[25] !== d || t[26] !== r.commitSha || t[27] !== i
    ? ((b = d == null ? r.commitSha.slice(0, 8) : (0, L.jsx)(zr, { link: d, onOpenBlameLink: i })),
      (t[25] = d),
      (t[26] = r.commitSha),
      (t[27] = i),
      (t[28] = b))
    : (b = t[28]);
  let x;
  t[29] !== n.commit || t[30] !== b
    ? ((x = (0, L.jsx)(Rr, { label: n.commit, children: b })),
      (t[29] = n.commit),
      (t[30] = b),
      (t[31] = x))
    : (x = t[31]);
  let S;
  t[32] !== n.pullRequest || t[33] !== i || t[34] !== p
    ? ((S =
        p &&
        (0, L.jsx)(Rr, {
          label: n.pullRequest,
          children: (0, L.jsx)(zr, { link: p, onOpenBlameLink: i }),
        })),
      (t[32] = n.pullRequest),
      (t[33] = i),
      (t[34] = p),
    ...
    : (S = t[35]);
  let C;
  t[36] !== x || t[37] !== S || t[38] !== v || t[39] !== y
    ? ((C = (0, L.jsxs)(`span`, { "data-file-blame-tooltip-meta": ``, children: [v, y, x, S] })),
      (t[36] = x),
      (t[37] = S),
      (t[38] = v),
      (t[39] = y),
...
function Rr(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, L.jsx)(`span`, { "data-file-blame-tooltip-label": ``, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
    ? (a = t[3])
    : ((a = (0, L.jsx)(`span`, { "data-file-blame-tooltip-value": ``, children: n })),
      (t[2] = n),
      (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, L.jsxs)(L.Fragment, { children: [i, a] })), (t[4] = i), (t[5] = a), (t[6] = o))
      : (o = t[6]),
    o
  );
}
function zr(e) {
  ...
  t[1] !== n.url || t[2] !== r
    ? ((o = function (e) {
        (e.preventDefault(), e.stopPropagation(), r(n.url));
      }),
      (t[1] = n.url),
      (t[2] = r),
      (t[3] = o))
  ...
  let s = o,
    c;
  return (
    t[4] !== s || t[5] !== n.label || t[6] !== n.url
      ? ((c = (0, L.jsx)(`button`, {
          type: `button`,
          "data-file-blame-link": ``,
          "data-file-blame-url": n.url,
          role: `link`,
          onPointerDown: a,
          onClick: s,
          children: n.label,
...
function Br(e) {
  return e.authorLogin == null
    ? null
    : {
        label: `@${e.authorLogin}`,
        url: `https://github.com/${encodeURIComponent(e.authorLogin)}`,
      };
}
function Vr(e, t) {
  return qr(e.commitSha)
    ? Ur(t, `commit/${encodeURIComponent(e.commitSha)}`, e.commitSha.slice(0, 8))
    : null;
}
function Hr(e, t) {
  let n = Yr(e.summary);
  return n == null ? null : Ur(t, `pull/${n}`, `#${n}`);
}
function Ur(e, t, n) {
  return e == null || !Jr(e) ? null : { label: n, url: `${e.replace(/\/+$/, ``)}/${t}` };
}
function Wr(e) {
  return [Gr(e), Xr(e.authorTime), Kr(e)].filter((e) => !!e).join(` `);
}
function Gr(e) {
  return e.author ?? e.commitSha.slice(0, 8);
}
function Kr(e) {
  let t = e.commitSha.slice(0, 8);
  return e.summary == null ? t : `${t} ${e.summary}`;
}
function qr(e) {
...
function Jr(e) {
  try {
    let t = new URL(e);
    return t.hostname === `github.com` || t.hostname.endsWith(`.github.com`);
  } catch {
    return !1;
  }
}
function Yr(e) {
  if (e == null) return null;
  let t = /\(#(\d+)\)\s*$/.exec(e)?.[1] ?? /^Merge pull request #(\d+)\b/.exec(e)?.[1];
  return t == null ? null : Number.parseInt(t, 10);
}
function Xr(e) {
  return e == null ? null : new Date(e * 1e3).toISOString().slice(0, 10);
}
function Zr(e) {
  let t =
    e.dataset.columnNumber ||
    e.closest(`[data-line]`)?.getAttribute(`data-line`) ||
    e.querySelector(`[data-line-number-content]`)?.textContent;
...
function ti(e, t, n, r, i, a, o) {
  let s = (e.shadowRoot ?? e).querySelector(`[data-file]`);
  if (s == null) return;
  let c = s.querySelectorAll(`[data-column-number]`);
  if (t == null) {
    for (let e of c) ii(e);
    s.toggleAttribute(`data-file-blame-visible`, !1);
    return;
  }
  let l = !1;
  ((0, Qr.flushSync)(() => {
    for (let e of c) {
      ...
      let u = ni(e),
        d = r === s;
      (u.toggleAttribute(`data-file-blame-expanded`, d),
        ri(u).render(
    ...
    s.toggleAttribute(`data-file-blame-visible`, l));
}
function ni(e) {
  let t = e.querySelector(`[data-file-blame-gutter]`);
  if (t != null) return t;
  let n = document.createElement(`span`);
  return ((n.dataset.fileBlameGutter = ``), e.append(n), n);
}
function ri(e) {
  let t = ei.get(e);
  if (t != null) return t;
  let n = (0, $r.createRoot)(e);
  return (ei.set(e, n), n);
}
function ii(e) {
  let t = e.querySelector(`[data-file-blame-gutter]`);
  t != null && (ei.get(t)?.unmount(), ei.delete(t), t.remove());
}
function ai(e) {
  return e.metadata.hunks.flatMap((e) => {
    let t = [],
      n = e.additionStart;
    for (let r of e.hunkContent) {
      ...
      if (r.additions > 0) {
        let e = r.deletions > 0 ? `modification` : `addition`;
        for (let i = 0; i < r.additions; i += 1)
          t.push({ kind: e, lineNumber: n + i, placement: `line` });
      } else r.deletions > 0 && t.push(ci(e, n));
      n += r.additions;
    }
    return t;
  });
...
function oi(e) {
  ...
  let t = new Map();
  for (let n of ai(e)) {
    let e = t.get(n.lineNumber);
    if (e == null) {
      t.set(n.lineNumber, [n]);
      continue;
    }
    e.push(n);
  }
...
function si(e, t) {
  let n = (e.shadowRoot ?? e).querySelector(`[data-file]`);
  if (n == null) return;
  let r = n.querySelectorAll(`[data-column-number]`);
  for (let e of r) {
    let n = Zr(e),
      r = n == null ? void 0 : t?.get(n);
    if (r == null || r.length === 0) {
      ui(e);
      continue;
    }
    li(e).replaceChildren(
      ...r.map((e) => {
        let n = document.createElement(`span`);
        if (
          ((n.dataset.fileChangeGutterMarker = ``),
          (n.dataset.fileChangeKind = e.kind),
          (n.dataset.fileChangePlacement = e.placement),
          e.placement === `line`)
        ) {
          let r = t?.get(e.lineNumber - 1),
            i = t?.get(e.lineNumber + 1);
          (r?.some((t) => t.placement === `line` && t.kind === e.kind) !== !0 &&
            (n.dataset.fileChangeRunStart = ``),
            i?.some((t) => t.placement === `line` && t.kind === e.kind) !== !0 &&
              (n.dataset.fileChangeRunEnd = ``));
        }
        return ((n.ariaHidden = `true`), n);
      }),
    );
  }
  n.toggleAttribute(`data-file-change-gutter-visible`, t != null && t.size > 0);
}
function ci(e, t) {
  return t <= e.additionStart + e.additionCount - 1 || t <= 1
    ? { kind: `deletion`, lineNumber: Math.max(t, 1), placement: `before` }
    : { kind: `deletion`, lineNumber: Math.max(t - 1, 1), placement: `after` };
}
function li(e) {
  let t = e.querySelector(`[data-file-change-gutter]`);
  if (t != null) return t;
  let n = document.createElement(`span`);
  return ((n.dataset.fileChangeGutter = ``), e.prepend(n), n);
}
function ui(e) {
  e.querySelector(`[data-file-change-gutter]`)?.remove();
}
function di(e) {
  let t = (0, z.c)(24),
    { cwd: n, path: r, trailingContent: i } = e,
    a = Ie(),
    o,
    s,
    c,
    ...
    u,
    d;
  if (t[0] !== n || t[1] !== a || t[2] !== r) {
    d = Symbol.for(`react.early_return_sentinel`);
    bb0: {
      let e = r == null ? [`/`] : An({ cwd: n, path: r });
      if (e.length === 0) {
        d = null;
        break bb0;
      }
      (t[9] === a
        ...
        : ((l = a.formatMessage({
            ...
            description: `Accessible label for breadcrumbs above a workspace file preview`,
          })),
          (t[9] = a),
          (t[10] = l)),
        (u = `group flex h-toolbar-pane shrink-0 items-center border-b border-token-border-default bg-token-main-surface-primary px-2 select-none`),
        (c = `hide-scrollbar flex min-w-0 flex-1 flex-row-reverse items-center overflow-x-auto px-2`),
        (o = `flex flex-1 items-center gap-1 text-xs text-token-text-secondary`),
        (s = e.map((t, n) => {
          let r = n === e.length - 1;
          return (0, L.jsxs)(
            `li`,
            {
              ...
              children: [
                (0, L.jsx)(`span`, {
                  className: De(`whitespace-nowrap`, r && `font-medium text-token-text-primary`),
                  children: t,
                }),
                r
                  ? null
    ...
    ((t[0] = n),
      ...
      (t[7] = u),
      (t[8] = d));
  } else ((o = t[3]), (s = t[4]), (c = t[5]), (l = t[6]), (u = t[7]), (d = t[8]));
  if (d !== Symbol.for(`react.early_return_sentinel`)) return d;
  let f;
  t[11] !== o || t[12] !== s
    ? ((f = (0, L.jsx)(`ol`, { className: o, children: s })), (t[11] = o), (t[12] = s), (t[13] = f))
    : (f = t[13]);
  let p;
  t[14] !== c || t[15] !== f
    ? ((p = (0, L.jsx)(`div`, { className: c, children: f })),
      (t[14] = c),
      (t[15] = f),
      (t[16] = p))
    : (p = t[16]);
  ...
  let h;
  return (
    t[19] !== l || t[20] !== u || t[21] !== p || t[22] !== m
      ? ((h = (0, L.jsxs)(`nav`, { "aria-label": l, className: u, children: [p, m] })),
        (t[19] = l),
        (t[20] = u),
        (t[21] = p),
        (t[22] = m),
...
function pi({
  ...
  let o = () => pr({ container: e, matchId: t, includeShadowRoots: n });
...
var mi = 250;
function hi({ contextId: e, getFiles: t, preserveScrollBeforeResultClear: n, scrollAdapter: r }) {
  return {
    domain: `diff`,
    contextId: e,
    preserveScrollBeforeResultClear: n,
    async search(e) {
      return e.query.trim().length === 0 ? gi(e, []) : gi(e, t());
    },
    async ensureVisible(t, n) {
      if (t.domain !== `diff` || t.contextId !== e) return;
      let i = r.getFileContainer(t.path),
        a = dr(t);
      if ((i == null ? null : pr({ container: i, matchId: a, includeShadowRoots: !0 })) == null) {
        if (
          n?.signal?.aborted ||
          (n?.signal == null
            ? await r.scrollToFile(t.path)
            : await r.scrollToFile(t.path, { signal: n.signal }),
          n?.signal?.aborted) ||
          (r.scrollToLocation != null &&
            (n?.signal == null
              ? await r.scrollToLocation(t)
              : await r.scrollToLocation(t, { signal: n.signal })),
          n?.signal?.aborted)
        )
          return;
        i = r.getFileContainer(t.path);
      }
      i != null &&
        (await pi({
          container: i,
...
function gi(e, t) {
  ...
  let r = [],
    ...
    o = !1;
  for (let s of t)
    for (let t of s.hunks) {
      let c = t.text;
      if (c.length === 0) continue;
      let { offsets: l, totalMatches: u, isCapped: d } = Et(c, n, mi - r.length);
      ((i += u), d && (o = !0));
      for (let { start: n, end: i } of l) {
        let o = _i(t, n, i);
        ((a += 1),
          r.push({
            id: `diff:${s.path}:${t.hunkId}:${n}`,
            ordinal: a,
            location: {
              domain: `diff`,
              contextId: e.contextId,
...
function _i(e, t, n) {
  let r = vi(e.lineSpans, t, n);
  if (r != null) return r;
  if (e.lineMapping !== `contiguous`) return { lineStart: e.lineStart, lineEnd: e.lineEnd };
  let i = e.lineStart + yi(e.text.slice(0, t));
  return { lineStart: i, lineEnd: i + yi(e.text.slice(t, n)) };
}
function vi(e, t, n) {
  if (e == null) return null;
  let r = e.find((e) => t >= e.start && t < e.end);
  if (r == null) return null;
  let i = Math.max(t, n - 1),
    a = e.find((e) => i >= e.start && i < e.end) ?? r;
  return {
    lineStart: r.lineStart,
    lineEnd: a.lineEnd,
    ...(r.side != null && r.side === a.side ? { side: r.side } : {}),
  };
}
function yi(e) {
  let t = 0;
...
var bi = 20,
  xi = 8;
function Si({ contents: e, getFileContainer: t, path: n }) {
  return hi({
    contextId: `file:${n}`,
    getFiles: () => [
      {
        path: n,
        hunks: [
          { hunkId: `source`, lineMapping: `contiguous`, lineEnd: Ci(e), lineStart: 1, text: e },
        ],
      },
    ],
    scrollAdapter: {
      getFileContainer: (e) => (e === n ? t() : null),
      scrollToFile: async (e, r) => {
        e !== n ||
          r?.signal?.aborted ||
          t()?.scrollIntoView({ behavior: `auto`, block: `nearest` });
      },
      scrollToLocation: async (e, r) => {
        if (e.path !== n || r?.signal?.aborted || e.lineStart < 1) return;
        let i = t();
        i != null && (await wi(i, e.lineStart, r));
      },
    },
  });
}
...
async function wi(e, t, n) {
  for (let r = 0; r < xi; r++) {
    if (n?.signal?.aborted || !Ti(e, t)) return;
    await fi();
  }
}
function Ti(e, t) {
  let n = e.querySelector(`diffs-container`)?.shadowRoot ?? null;
  if (n == null) return !1;
  let r = n.querySelector(`[data-line="${t}"]`);
  if (r != null) return (r.scrollIntoView({ block: `center`, behavior: `instant` }), !1);
  let i = Ei(n, t);
  if (i == null) return !1;
  let a = Number(i.dataset.line);
  if (!Number.isFinite(a)) return !1;
  let o = Di(i),
    s = e.getBoundingClientRect(),
    c = i.getBoundingClientRect(),
    l = e.scrollTop + c.top - s.top + (t - a) * o;
  return (e.scrollTo({ top: Math.max(0, l - (e.clientHeight - o) / 2), behavior: `auto` }), !0);
}
function Ei(e, t) {
  let n = null,
    r = 1 / 0;
  for (let i of e.querySelectorAll(`[data-line]`)) {
    let e = Number(i.dataset.line);
...
function Di(e) {
  ...
  if (t > 0) return t;
  let n = Number.parseFloat(window.getComputedStyle(e).lineHeight);
  return Number.isFinite(n) ? n : bi;
}
function Oi(e) {
  let t = (0, z.c)(5),
    { type: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = (0, L.jsx)(ki, { type: n })), (t[0] = n), (t[1] = r));
  let i;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, L.jsx)(`span`, {
        ...
        children: (0, L.jsx)(I, {
          ...
          defaultMessage: `Open this file outside Opaline to view it`,
  ...
  return (
    t[3] === r
      ? (a = t[4])
      : ((a = (0, L.jsxs)(`div`, {
          className: `flex h-full flex-col items-center justify-center gap-1 px-4 text-center text-sm text-token-description-foreground`,
          children: [r, i],
        })),
        (t[3] = r),
        (t[4] = a)),
...
function Ai() {
  let e = (0, z.c)(31),
    ...
    u = F(Ht),
    d;
  e[0] === t.value ? (d = e[1]) : ((d = He(t.value)), (e[0] = t.value), (e[1] = d));
  let f = d,
    p = t.value.routeKind === `local-thread` ? t.value.conversationId : null,
    m = f ?? `new-conversation`,
    h = r !== `last-turn`,
    g;
  e[2] !== p || e[3] !== m || e[4] !== h
    ? ((g = { conversationId: m, enablePullRequestComments: h, localConversationId: p }),
      (e[2] = p),
      (e[3] = m),
      (e[4] = h),
      (e[5] = g))
    : (g = e[5]);
  let { commentProps: _ } = un(g),
    v;
  bb0: {
    let t = _.readonlyComments,
      n = _.modelComments;
    if ((t == null || t.length === 0) && n.length === 0) {
      v = void 0;
      break bb0;
    }
    let r;
    (e[6] !== l || e[7] !== s || e[8] !== n || e[9] !== t
      ? ((r = pn({ comments: [...n, ...(t ?? [])], filePaths: s.map(ji), workspaceRoot: l })),
        (e[6] = l),
        (e[7] = s),
        (e[8] = n),
        (e[9] = t),
  ...
  let y = v,
    b = (i?.location.domain === `diff` ? i.location.path : void 0) ?? a ?? s[0]?.path,
    x;
  e[11] !== s || e[12] !== n || e[13] !== t
    ? ((x = (e) => {
        s.some((t) => t.path === e) &&
          requestAnimationFrame(() => {
            (Lt(t, e), !n && Mi(e)?.scrollIntoView({ behavior: `auto`, block: `start` }));
          });
      }),
      (e[11] = s),
      (e[12] = n),
  ...
  let S = x,
    C;
  e[15] === t ? (C = e[16]) : ((C = (e) => Rt(t, e)), (e[15] = t), (e[16] = C));
  let w;
  e[17] !== o || e[18] !== C
    ? ((w = (0, L.jsx)(`div`, {
  ...
  e[26] !== S
    ? ((T = (0, L.jsx)(`div`, {
        ...
        children: (0, L.jsx)(mn, {
          activePath: b,
          allowSelectingActivePath: !0,
          commentCountByPath: y,
          cwd: l,
          hostId: u.id,
          onSelectPath: S,
          entries: s,
          reserveBottomPadding: c,
        }),
      })),
      (e[20] = b),
      (e[21] = y),
...
function Mi(e) {
  return document.querySelector(`[data-review-path="${B(e)}"]`);
}
function B(e) {
...
function Pi(e) {
  let t = ke(Ue),
    ...
    a = (0, R.useRef)(null),
    o = Ve(),
    s = n && (e.type === `changed-files` || e.root != null),
    c = (0, R.useCallback)(
      (e) => {
        let t = (a.current?.parentElement?.getBoundingClientRect().width ?? window.innerWidth) / o,
          n = Math.max(Ni, t * V);
        return Math.min(Math.max(e, Ni), n);
      },
      [o],
    ),
    l = c(i),
    u = lt(l);
  !n && u.get() !== l && u.set(l);
  let { isMounted: d, opacity: f, animatedSize: p } = ut({ animation: r, size: u, isVisible: s }),
    m = (0, R.useCallback)(
      (e) => {
        if (e < st(Ni)) {
          ct(t, !1);
  ...
  return !d && !s
    ...
    : (0, L.jsxs)(nt.div, {
        ref: a,
        style: { maxWidth: `${V * 100}%`, opacity: f, width: p },
        className: `relative flex h-full shrink-0 border-l border-token-border-default`,
        children: [
          (0, L.jsx)(dt, {
            edge: `left`,
            defaultSize: l,
            getCurrentSize: () => u.get(),
            setSize: m,
          }),
          e.type === `changed-files`
            ? (0, L.jsx)(Ai, {})
            : e.root == null
              ? null
              : (0, L.jsx)(Ln, {
                  activeFilePath: e.activeFilePath,
                  autoFocusSearch: e.autoFocusSearch,
                  hostId: e.hostId,
                  includeHidden: !1,
...
var Fi = `[data-file][data-file-blame-visible] [data-column-number] {
  --opaline-file-blame-gutter-width: 10ch;
  min-width: calc(
    var(
        --diffs-min-number-column-width,
        var(--diffs-min-number-column-width-default, 3ch)
      ) +
      var(--opaline-file-blame-gutter-width) + 1ch + 3ch
  );
  display: grid;
  grid-template-columns:
    minmax(var(--diffs-min-number-column-width, 3ch), max-content)
    minmax(0, var(--opaline-file-blame-gutter-width));
  column-gap: 1ch;
...
[data-file-blame-gutter] {
  --opaline-file-blame-tooltip-width: 32ch;
  --opaline-file-blame-tooltip-max-width: 42vw;
  position: relative;
  grid-column: 2;
  min-width: 0;
  width: 100%;
  max-width: var(--opaline-file-blame-gutter-width);
...
[data-file-blame-gutter]::after {
  ...
  left: 0;
  z-index: 19;
  width: var(--opaline-file-blame-tooltip-width);
  max-width: var(--opaline-file-blame-tooltip-max-width);
  height: 6px;
  display: none;
}
...
[data-file-change-gutter-marker] {
  --opaline-file-change-gutter-width: 4px;
  position: absolute;
  left: 0;
  width: var(--opaline-file-change-gutter-width);
}
...
`,
  Li = (0, R.lazy)(async () => ({
    default: (
      await c(
        async () => {
          let { PdbPreviewFromFile: e } = await import(`./preview-7CQuGwx5.js`);
          return { PdbPreviewFromFile: e };
        },
        __vite__mapDeps([
  ...
  Ri = `${ve({ includeDiffHeader: !1, includeSimpleLineSeparators: !1, rootSelector: `[data-file]`, surface: `var(--color-token-main-surface-primary)` })}
${Fi}
${Ii}
`;
function zi(e) {
...
function Bi(e) {
  ...
  t[0] !== n || t[1] !== o
    ? ((u = {
        params: { hostId: n, path: o, contentSampleByteLimit: Ye, contentSampleMaxFileBytes: qe },
      }),
      (t[0] = n),
      (t[1] = o),
      (t[2] = u))
    : (u = t[2]);
  let { data: d, isError: f } = Pe(`read-file-metadata`, u),
    p;
  if (t[3] !== o) {
    let e = Ke(o);
    ((p = e != null && Ze(e.importKind)), (t[3] = o), (t[4] = p));
  } else p = t[4];
  let m = p,
    h = d?.contentKind,
    g;
  t[5] !== o || t[6] !== h ? ((g = Xe(o, h)), (t[5] = o), (t[6] = h), (t[7] = g)) : (g = t[7]);
  let _ = g,
    v = d?.contentKind,
    y;
  t[8] !== o || t[9] !== v ? ((y = Qe(o, v)), (t[8] = o), (t[9] = v), (t[10] = y)) : (y = t[10]);
  let b = y,
    x = F(ht),
    S = Ae(tt, n),
    C;
  t[11] !== S || t[12] !== o
    ? ((C = et(o, S)), (t[11] = S), (t[12] = o), (t[13] = C))
    : (C = t[13]);
  let w = C,
    T = ze(`1420162012`),
    E = w != null && i == null,
    ee = (b === `toggle` || E) && i == null,
    D = d?.contentKind,
    O;
  t[14] !== o || t[15] !== D
    ? ((O = Je(o, D)), (t[14] = o), (t[15] = D), (t[16] = O))
    : (O = t[16]);
  let k = O;
  if (f || (d && !d.isFile)) {
    let e;
    return (
      t[17] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, L.jsx)(ea, { isError: !0, isLoading: !1 })), (t[17] = e))
        : (e = t[17]),
      e
    );
  }
  if (d == null) {
    ...
    return (
      t[18] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, L.jsx)(ea, { isError: !1, isLoading: !0 })), (t[18] = e))
        : (e = t[18]),
      e
    );
  }
  let A,
    ...
    j = !1,
    M = !1;
  if (d && d.sizeBytes != null && d.sizeBytes > 10485760) {
    let e;
    (t[19] === d.sizeBytes
      ? (e = t[20])
      : ((e = (0, L.jsx)($i, { sizeBytes: d.sizeBytes })), (t[19] = d.sizeBytes), (t[20] = e)),
      (A = e));
  } else if (w != null && ee && x) {
    j = !0;
    let e;
    (t[21] !== n || t[22] !== w || t[23] !== o
      ? ((e = (0, L.jsx)(qi, { fileViewer: w, hostId: n, path: o })),
        (t[21] = n),
        (t[22] = w),
        (t[23] = o),
        (t[24] = e))
    ...
    j = E;
    let e;
    (t[25] === k ? (e = t[26]) : ((e = (0, L.jsx)(Oi, { type: k })), (t[25] = k), (t[26] = e)),
      (A = e));
  } else if (_ != null && (b === `always` || (ee && x))) {
    j = ee;
    let e;
    (t[27] !== T || t[28] !== n || t[29] !== o || t[30] !== _
      ? ((e = (0, L.jsx)(Ki, { gitBlameFeatureEnabled: T, hostId: n, path: o, previewKind: _ })),
        (t[27] = T),
        (t[28] = n),
        (t[29] = o),
        (t[30] = _),
  ...
  return (
    ...
    t[48] !== c
      ? ((re = (0, L.jsx)(Vi, {
          ...
          onSelectFile: a,
          path: o,
          showGitBlameControl: te,
          showArtifactPreviewControl: ne,
          showRichPreviewControl: j,
          showWordWrapControl: M,
          tabId: c,
          children: A,
        })),
        (t[40] = n),
...
function Vi(e) {
  let t = (0, z.c)(38),
    {
      ...
      onSelectFile: i,
      path: a,
      showGitBlameControl: o,
      showArtifactPreviewControl: s,
      showRichPreviewControl: c,
      showWordWrapControl: l,
      tabId: u,
      workspaceRoot: d,
    } = e,
    f = s === void 0 ? !1 : s,
        ...
        a == null
          ...
          : (0, L.jsx)(
              Ui,
              {
                ...
                path: a,
                showGitBlameControl: o,
                showArtifactPreviewControl: f,
                showRichPreviewControl: p,
                showWordWrapControl: m,
                tabId: u,
              },
              `file-actions`,
  ...
  let S;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, L.jsx)(Pn, { className: `icon-sm` })), (t[12] = S))
    : (S = t[12]);
  let C;
  t[13] !== b || t[14] !== x
    ? ((C = (0, L.jsx)(
        We,
        { className: `ms-auto`, color: b, size: `toolbar`, uniform: !0, onClick: x, children: S },
        `open-files-button`,
      )),
      (t[13] = b),
      (t[14] = x),
    ...
    : (C = t[15]);
  let w;
  t[16] !== y || t[17] !== C ? ((w = [y, C]), (t[16] = y), (t[17] = C), (t[18] = w)) : (w = t[18]);
  let T = w,
    E;
  t[19] !== g || t[20] !== a || t[21] !== T
    ? ((E = (0, L.jsx)(di, { cwd: g, path: a, trailingContent: T })),
      (t[19] = g),
      (t[20] = a),
      (t[21] = T),
      (t[22] = E))
  ...
  let ee = `${r}:${a}`,
    D;
  t[23] !== n || t[24] !== ee
    ? ((D = (0, L.jsx)(`div`, { className: `min-w-0 flex-1`, children: n }, ee)),
      (t[23] = n),
      (t[24] = ee),
      (t[25] = D))
    : (D = t[25]);
  let O;
  t[26] !== g || t[27] !== r || t[28] !== i || t[29] !== a || t[30] !== d
    ? ((O =
        i == null
          ? null
          : (0, L.jsx)(Pi, {
              activeFilePath: a,
              autoFocusSearch: a == null,
              hostId: r,
              onSelectFile: i,
              root: a == null ? (d ?? g) : g,
              type: `workspace`,
  ...
  let k;
  t[32] !== D || t[33] !== O
    ? ((k = (0, L.jsxs)(`div`, { className: `flex min-h-0 flex-1`, children: [D, O] })),
      (t[32] = D),
      (t[33] = O),
      (t[34] = k))
    : (k = t[34]);
...
function Hi() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, L.jsx)(Pn, { className: `icon-lg text-token-text-secondary` })), (e[0] = t))
    : (t = e[0]);
  let n;
    ...
    e[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, L.jsx)(`div`, {
          ...
          children: (0, L.jsxs)(`div`, {
            className: `flex max-w-72 flex-col items-center gap-2`,
            children: [
              t,
              n,
              (0, L.jsx)(`p`, {
...
function Ui(e) {
  let t = (0, z.c)(15),
    {
      ...
      hostId: r,
      path: i,
      showGitBlameControl: a,
      showArtifactPreviewControl: o,
      showRichPreviewControl: s,
      showWordWrapControl: c,
      tabId: l,
    } = e,
    u;
  t[0] !== n ||
  ...
  let d;
  t[9] !== r || t[10] !== i
    ? ((d = (0, L.jsx)(Nn, { hostId: r, path: i, showLabel: !0 })),
      (t[9] = r),
      (t[10] = i),
      (t[11] = d))
    : (d = t[11]);
  ...
  return (
    t[12] !== u || t[13] !== d
      ? ((f = (0, L.jsxs)(L.Fragment, { children: [u, d] })), (t[12] = u), (t[13] = d), (t[14] = f))
      : (f = t[14]),
    f
  );
}
function Wi(e) {
  let t = (0, z.c)(67),
    {
      hostId: n,
      path: r,
      showGitBlameControl: i,
      showArtifactPreviewControl: a,
      showRichPreviewControl: o,
      showWordWrapControl: s,
      tabId: c,
    } = e,
    l = ke(Ue),
    u = Ie(),
  ...
  t[8] === u
    ...
    : ((w = u.formatMessage({
        ...
        description: `Tooltip for the workspace file preview menu item that toggles git blame metadata in the gutter`,
      })),
      (t[8] = u),
      (t[9] = w));
  let T = w,
    E;
  t[10] !== n || t[11] !== r || t[12] !== l || t[13] !== c
    ? ((E = function (e) {
        (e.preventDefault(), Mn(l, r, { hostId: n, tabId: c }) && h(!1));
      }),
      (t[10] = n),
      (t[11] = r),
      (t[12] = l),
  ...
  t[18] !== l || t[19] !== p
    ? ((k = function (e) {
        (e.preventDefault(), l.set(_t, !p), h(!1));
      }),
      (t[18] = l),
      (t[19] = p),
      (t[20] = k))
  ...
  t[21] !== d || t[22] !== l
    ? ((te = function (e) {
        e.preventDefault();
        let t = !d;
        (l.set(St, t), t && Re(l, { eventName: `opaline_file_viewer_git_blame_enabled` }), h(!1));
      }),
      (t[21] = d),
      (t[22] = l),
      (t[23] = te))
  ...
  t[24] === r
    ? (j = t[25])
    : ((j = function (e) {
        (e.preventDefault(), Zt(r), h(!1));
      }),
      (t[24] = r),
      (t[25] = j));
  let M = j,
    re;
  t[26] !== n || t[27] !== r || t[28] !== l.queryClient
    ? ((re = function (e) {
        (e.preventDefault(), Qt(l.queryClient, { hostId: n, path: r }), h(!1));
      }),
      (t[26] = n),
      (t[27] = r),
      (t[28] = l.queryClient),
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, L.jsx)(on, { className: `icon-xs` })), (t[30] = ae))
    : (ae = t[30]);
  let oe;
  t[31] === _
    ? (oe = t[32])
  ...
  t[34] === M
    ? (P = t[35])
    : ((P = (0, L.jsx)(rn.Item, { onSelect: M, LeftIcon: ln, children: N })),
      (t[34] = M),
      (t[35] = P));
  let se;
  ...
  t[37] === ie
    ? (ce = t[38])
    : ((ce = (0, L.jsx)(rn.Item, { onSelect: ie, LeftIcon: ln, children: se })),
      (t[37] = ie),
      (t[38] = ce));
  let le;
  t[39] !== ee || t[40] !== a
    ...
    : (le = t[41]);
  let ue;
  t[42] !== O || t[43] !== f || t[44] !== x || t[45] !== o
    ? ((ue = o ? (0, L.jsx)(rn.Item, { onSelect: O, LeftIcon: f ? Yt : Xt, children: x }) : null),
      (t[42] = O),
      (t[43] = f),
      (t[44] = x),
      (t[45] = o),
    ...
    : (ue = t[46]);
  let de;
  t[47] !== A || t[48] !== s || t[49] !== y || t[50] !== p
    ? ((de = s ? (0, L.jsx)(rn.Item, { onSelect: A, LeftIcon: p ? sn : cn, children: y }) : null),
      (t[47] = A),
      (t[48] = s),
      (t[49] = y),
      (t[50] = p),
    ...
    : (de = t[51]);
  let fe;
  t[52] !== d || t[53] !== C || t[54] !== T || t[55] !== ne || t[56] !== i
    ? ((fe = i
        ? (0, L.jsx)(rn.Item, {
            onSelect: ne,
            LeftIcon: Fn,
            RightIcon: d ? $t : void 0,
            tooltipText: T,
            children: C,
          })
        : null),
...
function Gi(e) {
  let t = (0, z.c)(15),
    ...
    l;
  t[0] !== r || t[1] !== o
    ? ((l = { params: { hostId: r, path: o } }), (t[0] = r), (t[1] = o), (t[2] = l))
    : (l = t[2]);
  let { data: u, isError: d, isLoading: f } = Pe(`read-file`, l);
  if (u == null) {
    let e;
    return (
      t[3] !== d || t[4] !== f
        ? ((e = (0, L.jsx)(ea, { isError: d, isLoading: f })), (t[3] = d), (t[4] = f), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
...
function Ki(e) {
  let t = (0, z.c)(19),
    ...
    o;
  t[0] !== r || t[1] !== i
    ? ((o = { before: null, after: { kind: `worktree`, hostId: r, path: i } }),
      (t[0] = r),
      (t[1] = i),
      (t[2] = o))
    : (o = t[2]);
  let s = o,
    c;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, L.jsx)(ea, { isError: !0, isLoading: !1 })), (t[3] = c))
    : (c = t[3]);
  let l = c;
  switch (a) {
    case `image`: {
    ...
    case `markdown`: {
      let e;
      t[6] !== n || t[7] !== r || t[8] !== i
        ? ((e = (0, L.jsx)(Gi, { gitBlameFeatureEnabled: n, hostId: r, path: i })),
          (t[6] = n),
          (t[7] = r),
          (t[8] = i),
          (t[9] = e))
...
function qi(e) {
  let t = (0, z.c)(7),
    { fileViewer: n, hostId: r, path: i } = e,
    a;
  t[0] !== r || t[1] !== i
    ? ((a = async (e) => {
        if (e === `blob`) {
          let { contentsBase64: e } = await Ne(`read-file-binary`, {
            params: { hostId: r, path: i },
          });
          if (e == null) throw Error(`File could not be read.`);
          return { blob: e };
        }
        let { contents: t } = await Ne(`read-file`, { params: { hostId: r, path: i } });
        return { text: t };
      }),
      (t[0] = r),
      (t[1] = i),
...
function Ji({
  ...
  let f = ke(Ue),
    ...
    [ee, D] = (0, R.useState)(null),
    O = Ar({ path: l }),
    k = (0, R.useCallback)((e) => {
      if (e == null) return;
      let t = hn(e);
      E((e) => (e != null && fn(e, t) ? e : t));
    }, []),
    A = nn((e, t) => {
      k(t);
    }),
    ...
    { data: ne } = o(
      ...
      v,
      `blame-file`,
      (e) => ({ cwd: h ?? r(e.root), operationSource: `review_model`, path: l }),
      `review_model`,
      { enabled: _ && h != null, staleTime: Fe.FIVE_SECONDS },
    ),
    j = _ && ne?.type === `success` ? ne : null,
    M = (0, R.useMemo)(() => {
      if (j == null) return null;
      let e = new Map();
      for (let t of j.lines) e.set(t.lineNumber, t);
      return e;
    }, [j]),
    re = j?.repositoryWebUrl ?? null,
    ie = (0, R.useMemo)(() => oi(y?.diff ?? null), [y?.diff]),
    ae = ee?.path === l ? ee.lineNumber : null,
    oe = (0, R.useRef)(null),
    N = (0, R.useRef)(null),
    P = Kt(Gt()),
    se = He(f.value) ?? `new-conversation`,
    ce = f.value.routeKind === `local-thread` ? f.value.conversationId : null,
    { commentProps: le } = un({
      conversationId: se,
      enablePullRequestComments: F(Pt) !== `last-turn`,
      localConversationId: ce,
    }),
    ue = c == null ? null : { end: s ?? c, start: c },
    de = `${l}:${c ?? ``}:${s ?? ``}`,
    [fe, me] = (0, R.useState)(null),
    he = fe?.key === de ? fe.lines : ue,
    ge = F(_t),
    _e = Ge(n.lightCodeThemeId),
    ve = Ge(n.darkCodeThemeId),
    ye = Be(),
    Se = P === `light` ? ft(_e, `light`) : ft(ve, `dark`);
  pt(void 0);
  let Ce = (0, R.useMemo)(
      () => Si({ contents: e, getFileContainer: () => x.current, path: l }),
      [e, x, l],
    ),
    we = (0, R.useMemo)(() => {
      let t = Fr(l);
      return {
        cacheKey: `review-file-source:${Ut(a)}:${Ut(l)}:${Ut(e)}`,
        contents: e,
        name: l,
        ...(t == null ? {} : { lang: t }),
      };
    }, [e, a, l]),
    {
      ...
      annotationKeys: Ee,
      addDraftComment: De,
      renderCommentAnnotation: Oe,
    } = Sn({
      diffPath: l,
      workspaceRoot: m ?? void 0,
      onSelectionClear: () => {
        me({ key: de, lines: null });
      },
      conversationId: se,
      ...le,
    }),
    Me = (0, R.useMemo)(() => Te.map(ta).filter((e) => e != null), [Te]);
  function Ne() {
    N.current = null;
  }
  function Pe({ event: e, lineNumber: t }) {
    (e.metaKey || e.ctrlKey) && $e({ cwd: h, hostId: a, line: t, path: l });
  }
  function I(e, t) {
    Ee.has(xn(`additions`, e)) ||
      De({ side: `additions`, lineNumber: e, ...(t != null && t !== e ? { startLine: t } : {}) });
  }
  function Le(e) {
    let t = Math.max(e.start, e.end);
    (me({ key: de, lines: e }), I(t, Math.min(e.start, e.end)));
  }
  function Re() {
    let e = oe.current ?? N.current?.lineNumber;
    ((oe.current = null), e != null && I(e));
  }
  function ze(e) {
    let t = na(e);
  ...
  let Ke = (0, R.useCallback)(
    ...
    Je = tn((e) => {
      ...
      (t.addEventListener(`scroll`, n), (qe.current = () => t.removeEventListener(`scroll`, n)));
    }),
    Ye = tn((e) => {
      let t = x.current,
        n = Qi(e);
      if (!t || !n || S.current) return;
      let { scrollLeft: r, scrollTop: i } = d ?? {};
      requestAnimationFrame(() => {
        if (r != null || i != null) {
          let e = i == null || Xi(t, i),
            a = r == null || Zi(n, r);
          ...
          let { fileGap: e, lineHeight: n } = T;
          (t.scrollTo({
            behavior: `instant`,
            top: Math.max(0, e + (c - 0.5) * n - t.clientHeight / 2),
          }),
            (S.current = !0));
        }
      });
  ...
  let Ze = (0, R.useCallback)(
    (e) => {
      (Je(e), Ye(e), O(e), si(e, ie), Ke(e));
    },
    [ie, Je, Ye, O, Ke],
  );
  (0, R.useEffect)(() => {
    let e = x.current?.querySelector(`diffs-container`) ?? null;
    e != null && (si(e, ie), Ke(e));
  }, [ie, Ke]);
  let Qe = (0, R.useCallback)(
      (e) => {
        if (e?.parentElement != null) {
          C.setup(e.parentElement, e);
          return;
        }
        C.cleanUp();
      },
    ...
    et = {
      ...
      onGutterUtilityClick: Le,
      onLineEnter: ({ lineNumber: e }) => {
        N.current = { lineNumber: e };
      },
      onLineLeave: Ne,
      onLineSelected: (e) => {
        me({ key: de, lines: e });
      ...
      onPostRender: Ze,
      overflow: ge ? `wrap` : `scroll`,
      onLineClick: Pe,
      onLineNumberClick: Pe,
      theme: Se.name,
      themeType: P,
      unsafeCSS: Ri,
    };
  return (0, L.jsx)(bn, {
    ...
    handleOpenInTarget: (e) => {},
    children: (0, L.jsx)(be.Provider, {
      value: C,
      children: (0, L.jsxs)(`div`, {
        ref: x,
        className: `h-full overflow-auto bg-token-main-surface-primary`,
        "data-theme": ye ? `dark` : `light`,
        style: b ? { paddingBottom: dn } : void 0,
        onContextMenu: We,
        onFocusCapture: () => {
          Ft(f, `diff`);
        },
        ...
        children: [
          ...
          (0, L.jsx)(Yi, { sourceSearchSource: Ce }),
          (0, L.jsx)(`div`, {
            ref: Qe,
            "data-review-path": l,
            children:
...
function Xi(e, t) {
  return t == null ? !0 : e == null ? !1 : ((e.scrollTop = t), e.scrollTop === t);
}
function Zi(e, t) {
  return t == null ? !0 : e == null ? !1 : ((e.scrollLeft = t), e.scrollLeft === t);
}
function Qi(e) {
  return e.shadowRoot?.querySelector(`[data-code]`) ?? null;
}
function $i(e) {
  let t = (0, z.c)(6),
    { sizeBytes: n } = e,
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((i = ia(qe)), (t[1] = i)) : (i = t[1]);
  let a;
  t[2] === n ? (a = t[3]) : ((a = ia(n)), (t[2] = n), (t[3] = a));
  let o;
  return (
    t[4] === a
      ? (o = t[5])
...
function ea(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, L.jsx)(`div`, {
          className: `flex h-full items-center justify-center px-4 text-sm text-token-description-foreground`,
          children:
            r && !n
              ? (0, L.jsx)(I, {
...
function ta(e) {
  if (e.side !== `additions` || e.metadata == null) return null;
  let t = ra(e.metadata);
  switch (t.kind) {
    case `comment`:
      return { lineNumber: e.lineNumber, metadata: t };
    case `draft-comment`:
      return { lineNumber: e.lineNumber, metadata: t };
  }
}
function na(e) {
  ...
  switch (t.kind) {
    case `comment`:
      return { side: `additions`, lineNumber: e.lineNumber, metadata: t };
    case `draft-comment`:
      return { side: `additions`, lineNumber: e.lineNumber, metadata: t };
  }
}
function ra(e) {
  switch (e.kind) {
    case `comment`:
      return {
        kind: `comment`,
        ...(e.attached == null ? {} : { attached: e.attached }),
        comment: e.comment,
        source: e.source,
      };
    case `draft-comment`:
      return {
        ...
        key: e.key,
        path: e.path,
        ...(e.startLine == null ? {} : { startLine: e.startLine }),
        ...(e.startSide == null ? {} : { startSide: e.startSide }),
        ...(e.localDiffHunk == null ? {} : { localDiffHunk: e.localDiffHunk }),
      };
  }
}
function ia(e) {
...
var aa = function (e) {
  ...
  oa = Le({
    openFileTabTitle: {
      ...
      defaultMessage: `Open file`,
      description: `Title for a workspace file tab before a file has been selected`,
    },
  });
function sa(e, t, n = {}) {
  let {
    ...
    h = r ?? qt(d),
    g = a ?? `local`,
    _ = f ?? (a == null ? `file:${t ?? ``}` : `file:${a}:${t ?? ``}`),
    v = kn(e),
    y = p ?? e.get(Wt).formatMessage(oa.openFileTabTitle),
    b = Jt(t ?? void 0),
    x = t == null ? y : On({ cwd: v, path: t });
  t != null && En(e, { cwd: v, hostId: g, path: t });
  let S = h.openTab(e, aa, {
    ...(t == null ? {} : { contextMenuItems: (e) => Dn(e, { cwd: v, hostId: g, path: t }) }),
    defaultState: Tn,
    icon: o ?? (0, R.createElement)(b, { className: `icon-xs shrink-0` }),
    isPreview: c,
    kind: `${wn}${g}`,
    ...(t == null
      ? {
    ...
    props: {
      ...
      hostId: g,
      tabId: _,
      workspaceRoot: m ?? null,
      onSelectFile: (n, r) => {
        (sa(e, n, { controller: h, hostId: g, isPreview: t == null ? !1 : r?.isPreview }),
          t ?? h.closeTab(e, _));
      },
      ...(l == null ? {} : { initialLine: l }),
      ...(i == null ? {} : { initialEndLine: i }),
    },
    onMove: (n, r) => ({
      props: {
        path: t,
        ...
        workspaceRoot: m ?? null,
        onSelectFile: (n, i) => {
          (sa(e, n, { controller: r, hostId: g, isPreview: t == null ? !1 : i?.isPreview }),
            t ?? r.closeTab(e, _));
        },
        ...(l == null ? {} : { initialLine: l }),
        ...(i == null ? {} : { initialEndLine: i }),
      ...
      onClose: () => {
        jn(
          e,
          e.get(r.tabs$).filter((e) => e.tabId !== _),
        );
      },
    }),
    onClose: () => {
      jn(
        e,
        e.get(h.tabs$).filter((e) => e.tabId !== _),
      );
    },
    id: _,
    title: t == null ? y : (p ?? s(t)),
    tooltip: x,
  });
  (u && h.resetTabState(e, S), t ?? ct(e, !0, { animate: !1 }), jn(e, e.get(h.tabs$)));
}
export {
  pi as a,
  Or as c,
...
//# sourceMappingURL=review-file-source-tab-I1YMxPZ2.js.map

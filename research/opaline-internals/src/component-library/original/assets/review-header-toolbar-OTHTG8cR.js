...
import { Ea as t } from "./app-server-manager-signals-BOGyjFm3.js";
import { n, t as r } from "./jsx-runtime-CiQ1k8xo.js";
import { A as i, F as a, I as o, lt as s, r as c, s as l } from "./vscode-api-sUstfl-x.js";
import { c as u, o as d } from "./lib-MoKmYgcO.js";
import { t as f } from "./tooltip-BhXPONlb.js";
import { t as p } from "./route-scope-BCJTBhwV.js";
import { t as m } from "./button-Xd4Hy1MO.js";
import { t as h } from "./spinner-Dvc_A3Ae.js";
import { L as g, n as _ } from "./review-navigation-model-CMYXFT2S.js";
import { n as v, t as y } from "./json-CuUDWIw2.js";
import { t as b } from "./image-square-DpHX97RA.js";
import { t as x } from "./check-md-CZTnvSiA.js";
import { t as S } from "./clock-CDmkoq1h.js";
import { r as C, t as w } from "./dropdown-CHaZfyxI.js";
import { t as T } from "./three-dots-CGeU8S03.js";
import { t as E } from "./warning-y6tKEMlk.js";
import { c as D, l as O, o as k, p as A, u as j } from "./pull-request-status-CZN-c4i-.js";
import { n as M, r as N } from "./code-snippet-BL80sM4U.js";
import { t as P } from "./regenerate-Co1G5oL3.js";
import { t as F } from "./score-query-match-CpxhuHTA.js";
import { n as I, t as L } from "./diff-unified-BT9wY89m.js";
import { t as R } from "./middle-truncated-text-hxgc9VBD.js";
import { t as z } from "./document-search-DF_BfBzT.js";
var B = e(n()),
  V = r(),
  H = (e) =>
    (0, V.jsx)(`svg`, {
...
function G({
  ...
  let _ = r.length,
    v = [],
    y = k({ canFix: e, checks: t, intl: o, onFixCheck: u, onOpenCheck: f }),
    b = D({ checks: t, ciStatus: n }),
    S = O(n);
  return (
    g.includes(`checks-none`) && v.push({ icon: b, key: `checks-none`, label: S }),
    g.includes(`checks-failing`) &&
      v.push({
        accessory: (0, V.jsx)(d, {
    ...
    g.includes(`checks-pending`) &&
      v.push({ flyoutContent: y, icon: b, key: `checks-pending`, label: S }),
    g.includes(`checks-successful`) &&
      v.push({ flyoutContent: y, icon: b, key: `checks-successful`, label: S }),
    v.push(J({ flyoutContent: Y(m, o), intl: o, reviewStatus: p })),
    v.push(
      K({
        attachedCommentKeys: i.attachedCommentKeys,
        canAddressComments: i.canAddressComments,
        commentAttachments: r,
        commentCount: _,
        intl: o,
        onAddressComment: (e) => {
          i.startAddressCommentsForAttachments([e]);
        },
        onAddressComments: i.startAddressComments,
        onRemoveComment: i.removeAddressCommentsForAttachment,
        tooltipText: i.tooltipText,
      }),
    ),
    g.includes(`merging-blocked`) &&
      v.push({
        disabled: !0,
        icon: (0, V.jsx)(E, { className: `icon-sm shrink-0 text-token-charts-red` }),
        key: `merging-blocked`,
        label: (0, V.jsx)(d, {
    ...
    g.includes(`ready-to-merge`) &&
      v.push({
        ...
        disabled: s.mergeDisabledReason != null || s.isPending,
        icon: s.isPending
          ? (0, V.jsx)(h, { className: `icon-sm shrink-0` })
          : (0, V.jsx)(x, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `ready-to-merge`,
        label: (0, V.jsx)(d, {
        ...
        onSelect: s.mergePullRequest,
        tooltipDisabled: s.mergeDisabledReason == null,
        tooltipText: c,
      }),
    v
  );
...
function K({
  attachedCommentKeys: e,
  canAddressComments: n,
  commentAttachments: r,
  commentCount: i,
  intl: a,
  onAddressComment: o,
  ...
  return {
    ...
    actionDisabled: !n,
    disabled: i === 0,
    flyoutContent: q(e, n, r, a, o, c),
    icon: (0, V.jsx)(H, { className: `icon-sm shrink-0` }),
    key: `comments`,
    label:
      i > 0
        ? a.formatMessage(
            {
              ...
              description: `Label for the review comments row when comments are present`,
            },
            { count: i },
          )
        : a.formatMessage({
            ...
            description: `Label for the review comments row when there are no comments`,
          }),
    onSelect: u ? s : void 0,
    tooltipDisabled: n,
    tooltipText: l,
          ...
          title: i.formatMessage(
            {
              ...
              defaultMessage: `{count, plural, one {# comment} other {# comments}}`,
              description: `Title for the pull request comments flyout in the git actions dropdown`,
            },
            { count: r.length },
          ),
        },
...
function J({ flyoutContent: e, intl: t, reviewStatus: n }) {
  let r = e != null,
    i = r
      ? void 0
      : t.formatMessage({
          ...
          description: `Tooltip shown when the approvals row is disabled because the pull request has no requested or completed reviews`,
        });
  switch (n) {
    case `approved`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, V.jsx)(x, { className: `icon-sm shrink-0 text-token-description-foreground` }),
    ...
    case `review_required`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, V.jsx)(S, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `awaiting-review`,
        label: (0, V.jsx)(d, {
...
function ee(e, t) {
  return [
    X(`approved`, e.approved, t),
    X(`requested`, e.requested, t),
    X(`changes-requested`, e.changesRequested, t),
    X(
      `commented`,
      e.commented.filter(
        (t) =>
          !e.approved.includes(t) && !e.requested.includes(t) && !e.changesRequested.includes(t),
      ),
      t,
    ),
  ].filter((e) => e != null);
...
function X(e, t, n) {
  return t.length === 0
    ? null
    : { reviewers: t.map((t) => ({ accessoryLabel: te(e, n), icon: ne(e), label: t })) };
}
function te(e, t) {
  switch (e) {
    case `approved`:
      return t.formatMessage({
        ...
        defaultMessage: `Approved`,
        description: `Group title for approved reviewers in the approvals flyout`,
      });
    case `requested`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.reviewers.requested`,
        defaultMessage: `Awaiting approval`,
        description: `Group title for requested reviewers in the approvals flyout`,
      });
    case `changes-requested`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.reviewers.changesRequested`,
        defaultMessage: `Changes requested`,
        description: `Group title for reviewers who requested changes in the approvals flyout`,
      });
    case `commented`:
      return t.formatMessage({
        id: `localConversation.pullRequest.actions.reviewers.commented`,
        defaultMessage: `Commented`,
        description: `Group title for commenting reviewers in the approvals flyout`,
      });
  }
}
function ne(e) {
  switch (e) {
    case `approved`:
      return (0, V.jsx)(x, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, V.jsx)(S, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, V.jsx)(H, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, V.jsx)(E, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
var Z = s();
function re(e, t, n) {
...
function ie(e) {
  let t = (0, Z.c)(20),
    { cwd: n, headBranch: r, hostId: a, operationSource: o, onSuccess: s } = e,
    u = i(),
    d;
  t[0] !== n || t[1] !== r || t[2] !== a
    ? ((d = re(n, r, a)), (t[0] = n), (t[1] = r), (t[2] = a), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] !== r || t[5] !== s || t[6] !== u
    ? ((f = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              u.setQueryData(c(`gh-pr-status`, e), ae);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                u.invalidateQueries({ queryKey: c(`gh-pr-body`) }),
                u.invalidateQueries({ queryKey: c(`gh-pr-checks`) }),
                u.invalidateQueries({ queryKey: c(`gh-pr-comments`) }),
                u.invalidateQueries({
                  queryKey: c(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                u.invalidateQueries({
                  queryKey: c(`gh-pr-status`, {
                    cwd: t.cwd,
                    headBranch: r,
                    hostId: t.hostId,
                    number: t.number,
  ...
  let p;
  t[8] !== o || t[9] !== d || t[10] !== f
    ? ((p = { source: o, mutationKey: d, onSuccess: f }),
      (t[8] = o),
      (t[9] = d),
      (t[10] = f),
      (t[11] = p))
    : (p = t[11]);
  let m = l(`gh-pr-merge`, p),
    h,
    g;
  t[12] !== a || t[13] !== m
    ? ((h = (e, t) => {
        m.mutate({ ...e, hostId: a }, t);
      }),
      (g = (e, t) => m.mutateAsync({ ...e, hostId: a }, t)),
      (t[12] = a),
      (t[13] = m),
      (t[14] = h),
      (t[15] = g))
...
function se(e, t) {
  ...
  return n.length === 0
    ...
    : e
        .map((e) => {
          let t = F(Q(e.displayPath).fileName, n);
          return { entry: e, score: t > 0 ? t : F(e.displayPath, n) };
        })
        .filter(({ score: e }) => e > 0)
...
function ce(e, t) {
  let n = Q(e.displayPath),
    r = Q(t.displayPath);
  return n.fileName.localeCompare(r.fileName) || n.parentPath.localeCompare(r.parentPath);
}
function Q(e) {
  let t = e.lastIndexOf(`/`);
  return t === -1
...
function le() {
  let e = (0, Z.c)(5),
    ...
    n = o(g),
    r;
  e[0] === t ? (r = e[1]) : ((r = (e) => _(t, e)), (e[0] = t), (e[1] = r));
  let i;
  return (
    e[2] !== n || e[3] !== r
      ? ((i = (0, V.jsx)(ue, { entries: n, onSelectPath: r })), (e[2] = n), (e[3] = r), (e[4] = i))
      : (i = e[4]),
    i
  );
}
function ue(e) {
  ...
  if (t[0] !== n || t[1] !== i || t[2] !== r || t[3] !== s || t[4] !== a) {
    ...
    t[9] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((g = (0, V.jsx)(z, { className: `icon-xs text-token-description-foreground` })),
        (t[9] = g))
      : (g = t[9]);
    let _;
    t[10] === p
    ...
    let v;
    t[12] !== p || t[13] !== _
      ? ((v = (0, V.jsx)(f, { tooltipContent: p, delayOpen: !0, children: _ })),
        (t[12] = p),
        (t[13] = _),
        (t[14] = v))
      : (v = t[14]);
    ...
    let b;
    (t[16] !== p || t[17] !== a
      ? ((b = (0, V.jsx)(C.SearchInput, { autoFocus: !0, placeholder: p, value: a, onChange: y })),
        (t[16] = p),
        (t[17] = a),
        (t[18] = b))
      : (b = t[18]),
        ...
        children: [
          ...
          e.length === 0
            ? (0, V.jsx)(C.Message, {
                compact: !0,
                children: (0, V.jsx)(d, {
                  id: `opaline.review.jumpToFile.empty`,
            ...
            : e.map((e) =>
                (0, V.jsx)(
                  C.Item,
                  {
                    ...
                    children: (0, V.jsx)(de, { displayPath: e.displayPath }),
                  },
                  e.path,
                ),
              ),
...
function de(e) {
  ...
  t[2] === i
    ? (o = t[3])
    : ((o = (0, V.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: i })),
      (t[2] = i),
      (t[3] = o));
  let s;
  t[4] === a
...
function ge(e) {
  ...
  t[0] === g
    ? (y = t[1])
    : ((y = g.formatMessage({
        id: `opaline.review.refreshGitQueries`,
  ...
  let S = x,
    C;
  t[5] !== r.expanded || t[6] !== g
    ? ((C = r.expanded
        ? g.formatMessage({
            id: `opaline.review.expandOrCollapseDiffMenu.collapse`,
            defaultMessage: `Collapse all diffs`,
            description: `Menu item to collapse all diffs in the review options menu`,
          })
        : g.formatMessage({
            id: `opaline.review.expandOrCollapseDiffMenu.expand`,
  ...
  t[8] === g
    ? (D = t[9])
    : ((D = g.formatMessage({
        id: `opaline.review.header.moreOptions`,
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, V.jsx)(T, { className: `icon-xs text-token-description-foreground` })), (t[11] = j))
    : (j = t[11]);
  let F;
  t[12] === O
    ? (F = t[13])
  ...
  let I;
  t[14] !== O || t[15] !== F
    ? ((I = (0, V.jsx)(f, { tooltipContent: O, delayOpen: !0, children: F })),
      (t[14] = O),
      (t[15] = F),
      (t[16] = I))
    : (I = t[16]);
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = t[35]);
  let H;
  t[36] !== a || t[37] !== o || t[38] !== b || t[39] !== d
    ? ((H = d
        ? (0, V.jsx)($, { Icon: P, label: b, onClick: () => a?.(), disabled: o || !a })
        : null),
      (t[36] = a),
      (t[37] = o),
      (t[38] = b),
  ...
  let U = r.wrap ? M : N,
    W;
  t[41] !== r.onToggleWrap || t[42] !== U || t[43] !== S
    ? ((W = (0, V.jsx)($, { Icon: U, label: S, onClick: r.onToggleWrap })),
      (t[41] = r.onToggleWrap),
      (t[42] = U),
      (t[43] = S),
      (t[44] = W))
    : (W = t[44]);
  let G = r.expanded ? me : pe,
    K;
  t[45] !== r.onToggleExpanded || t[46] !== E || t[47] !== G
    ? ((K = (0, V.jsx)($, { Icon: G, label: E, onClick: r.onToggleExpanded })),
    ...
    : (K = t[48]);
  let q;
  t[49] === r ? (q = t[50]) : ((q = (0, V.jsx)(ve, { diffControls: r })), (t[49] = r), (t[50] = q));
  let J;
  return (
    t[51] !== R || t[52] !== H || t[53] !== W || t[54] !== K || t[55] !== q
      ? ((J = (0, V.jsxs)(`div`, {
          className: `flex items-center gap-1.5`,
          children: [R, z, H, W, K, q],
        })),
        (t[51] = R),
        (t[52] = H),
        (t[53] = W),
...
function _e(e) {
  ...
  let j = A,
    F;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, V.jsx)(T, { className: `icon-xs` })), (t[11] = F))
    : (F = t[11]);
  let I;
  t[12] === k
    ? (I = t[13])
  ...
  let L;
  t[14] !== k || t[15] !== I
    ? ((L = (0, V.jsx)(f, { tooltipContent: k, delayOpen: !0, children: I })),
      (t[14] = k),
      (t[15] = I),
      (t[16] = L))
    : (L = t[16]);
  let R;
  t[17] !== a || t[18] !== o || t[19] !== b || t[20] !== d
    ? ((R = d
        ? (0, V.jsx)(C.Item, {
            onSelect: (e) => {
  ...
  t[22] === r
    ? (z = t[23])
    : ((z = (e) => {
        (e.preventDefault(), r.onToggleWrap(), j());
      }),
      (t[22] = r),
      (t[23] = z));
  let H = r.wrap ? M : N,
    U;
  t[24] !== z || t[25] !== H || t[26] !== S
    ? ((U = (0, V.jsx)(C.Item, { onSelect: z, LeftIcon: H, children: S })),
      (t[24] = z),
      (t[25] = H),
      (t[26] = S),
      (t[27] = U))
  ...
  t[28] === r
    ? (W = t[29])
    : ((W = (e) => {
        (e.preventDefault(), r.onToggleExpanded(), j());
      }),
      (t[28] = r),
      (t[29] = W));
  let G = r.expanded ? me : pe,
    K;
  t[30] !== D || t[31] !== W || t[32] !== G
    ? ((K = (0, V.jsx)(C.Item, { onSelect: W, LeftIcon: G, children: D })),
      (t[30] = D),
      (t[31] = W),
      (t[32] = G),
      (t[33] = K))
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = (0, V.jsx)(C.Separator, {})), (t[34] = q))
    : (q = t[34]);
  let J;
  t[35] !== n ||
  t[36] !== r.hideWhitespace ||
  t[37] !== r.loadFullFilesEnabled ||
  t[38] !== r.onToggleHideWhitespace ||
  t[39] !== r.onToggleLoadFullFiles ||
  t[40] !== r.onToggleRichPreview ||
  t[41] !== r.onToggleWordDiffs ||
  t[42] !== r.richPreviewEnabled ||
  t[43] !== r.wordDiffsEnabled ||
  t[44] !== i ||
  t[45] !== s ||
  t[46] !== p ||
  t[47] !== h
  ...
  let Y;
  return (
    t[49] !== _ || t[50] !== L || t[51] !== R || t[52] !== U || t[53] !== K || t[54] !== J
      ? ((Y = (0, V.jsxs)(w, {
          open: _,
          onOpenChange: v,
          align: `end`,
...
function ve(e) {
  ...
  t[0] !== n.diffMode || t[1] !== r
    ...
    : (i = t[2]);
  let a = i,
    o = n.diffMode === `unified` ? I : L,
    s;
  t[3] === n
    ? (s = t[4])
    : ((s = () => n.onSelectDiffMode(n.diffMode === `unified` ? `right` : `left`)),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
    t[5] !== a || t[6] !== o || t[7] !== s
      ? ((c = (0, V.jsx)($, { Icon: o, label: a, onClick: s })),
        (t[5] = a),
        (t[6] = o),
        (t[7] = s),
        (t[8] = c))
...
function $(e) {
  let t = (0, Z.c)(12),
    ...
    u;
  t[0] === n ? (u = t[1]) : ((u = (0, V.jsx)(n, { className: `icon-xs` })), (t[0] = n), (t[1] = u));
  let d;
  t[2] !== s || t[3] !== r || t[4] !== i || t[5] !== c || t[6] !== l || t[7] !== u
    ? ((d = (0, V.jsx)(m, {
        "aria-label": r,
        "aria-pressed": c,
        color: l,
  ...
  return (
    t[9] !== r || t[10] !== d
      ? ((p = (0, V.jsx)(f, { tooltipContent: r, children: d })),
        (t[9] = r),
        (t[10] = d),
        (t[11] = p))
      : (p = t[11]),
...
function ye(e) {
  ...
  t[22] === l
    ...
    : ((z = l
        ? (0, V.jsx)(d, {
            id: `opaline.review.richPreview.disable`,
            defaultMessage: `Disable rich preview`,
            description: `Menu item to disable rich previews in the diff view`,
          })
        : (0, V.jsx)(d, {
            id: `opaline.review.richPreview.enable`,
            defaultMessage: `Enable rich preview`,
      ...
      (t[23] = z));
  let B;
  t[24] !== O || t[25] !== E || t[26] !== R || t[27] !== z
    ? ((B = (0, V.jsx)(C.Item, { onSelect: O, "aria-label": E, LeftIcon: R, children: z })),
      (t[24] = O),
      (t[25] = E),
      (t[26] = R),
      (t[27] = z),
  ...
  t[29] === r
    ...
    : ((G = r
      ...
      (t[30] = G));
  let K;
  t[31] !== A || t[32] !== H || t[33] !== G
    ? ((K = (0, V.jsx)(C.Item, { onSelect: A, LeftIcon: H, children: G })),
      (t[31] = A),
      (t[32] = H),
      (t[33] = G),
      (t[34] = K))
  ...
  t[39] !== s || t[40] !== I || t[41] !== c || t[42] !== i
    ? ((J = i
        ? (0, V.jsx)(C.Item, {
            ...
            LeftIcon: fe,
            children: (0, V.jsx)(d, {
              id: `opaline.review.copyGitApplyCommand`,
  ...
  let Y;
  return (
    t[44] !== B || t[45] !== K || t[46] !== q || t[47] !== J || t[48] !== L
      ? ((Y = (0, V.jsxs)(V.Fragment, { children: [L, B, K, q, J] })),
        (t[44] = B),
        (t[45] = K),
        (t[46] = q),
        (t[47] = J),
...
//# sourceMappingURL=review-header-toolbar-OTHTG8cR.js.map

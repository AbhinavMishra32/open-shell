...
var P = r(i(), 1),
  He = (0, P.createContext)({});
function Ue(e) {
  let t = (0, P.useRef)(null);
  return (t.current === null && (t.current = e()), t.current);
}
var We = c ? P.useLayoutEffect : P.useEffect,
  F = (0, P.createContext)(null);
function Ge(e) {
  return le(e) && `offsetHeight` in e;
}
var I = { x: !1, y: !1 };
function Ke() {
  return I.x || I.y;
...
function Xe(e, t, n = {}) {
  let [r, i, a] = Je(e, n),
    o = (e) => {
      ...
      let a = (e) => {
        Ye(e) && (r(e), n.removeEventListener(`pointerleave`, a));
      };
...
var rt = (e, t) => {
  ...
  let r = tt(() => {
    ...
    (n.addEventListener(`keyup`, e, t), n.addEventListener(`blur`, () => nt(n, `cancel`), t));
  });
      ...
      let a = t(r, e),
        o = (e, t) => {
          (window.removeEventListener(`pointerup`, s),
            ...
            L.has(r) && L.delete(r),
            it(e) && typeof a == `function` && a(e, { success: t }));
        },
        s = (e) => {
          o(e, r === window || r === document || n.useGlobalTarget || Ze(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? window : e).addEventListener(`pointerdown`, o, i),
        Ge(e) &&
          (e.addEventListener(`focus`, (e) => rt(e, i)),
          !et(e) && !e.hasAttribute(`tabindex`) && (e.tabIndex = 0)));
    }),
    a
  );
}
var ot = (0, P.createContext)({
...
function st(e = !0) {
  ...
  let o = (0, P.useCallback)(() => e && r && r(a), [a, r, e]);
  return !n && r ? [!1, o] : [!0];
}
var ct = (0, P.createContext)({ strict: !1 });
function lt(e) {
  for (let t in e) fe[t] = { ...fe[t], ...e[t] };
}
var ut = new Set(
...
var dt = n({ default: () => ft }),
  ...
  mt = (e) => !R(e);
function ht(e) {
  typeof e == `function` && (mt = (t) => (t.startsWith(`on`) ? !R(t) : e(t)));
}
try {
  ht((pt(), t(dt)).default);
} catch {}
function gt(e, t, n) {
  ...
  for (let i in e)
    (i === `values` && typeof e.values == `object`) ||
      ((mt(i) || (n === !0 && R(i)) || (!t && !R(i)) || (e.draggable && i.startsWith(`onDrag`))) &&
        (r[i] = e[i]));
  return r;
}
var z = (0, P.createContext)({});
function _t(e, t) {
  if (se(e)) {
    let { initial: t, animate: n } = e;
    return { initial: t === !1 || v(t) ? t : void 0, animate: v(n) ? n : void 0 };
  }
  return e.inherit === !1 ? {} : t;
}
function vt(e) {
  let { initial: t, animate: n } = _t(e, (0, P.useContext)(z));
  return (0, P.useMemo)(() => ({ initial: t, animate: n }), [yt(t), yt(n)]);
}
function yt(e) {
  return Array.isArray(e) ? e.join(` `) : e;
}
var bt = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
function xt(e, t, n) {
  for (let r in t) !_(t[r]) && !g(r, n) && (e[r] = t[r]);
}
function St({ transformTemplate: e }, t) {
  return (0, P.useMemo)(() => {
    let n = bt();
    return (ae(n, t, e), Object.assign({}, n.vars, n.style));
  }, [t]);
}
function Ct(e, t) {
  let n = e.style || {},
    r = {};
  return (xt(r, n, e), Object.assign(r, St(e, t)), r);
}
function wt(e, t) {
  let n = {},
    r = Ct(e, t);
...
function Et(e, t, n, r) {
  let i = (0, P.useMemo)(() => {
    let n = Tt();
    return (re(n, t, b(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
    (xt(t, e.style, e), (i.style = { ...t, ...i.style }));
  }
  return i;
}
var Dt = [
...
function Ot(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(Dt.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function kt(e, t, n, { latestValues: r }, i, a = !1) {
  let o = (Ot(e) ? Et : wt)(t, r, i, e),
    s = gt(t, typeof e == `string`, a),
    c = e === P.Fragment ? {} : { ...s, ...o, ref: n },
    { children: l } = t,
    u = (0, P.useMemo)(() => (_(l) ? l.get() : l), [l]);
  return (0, P.createElement)(e, { ...c, children: u });
}
function B(e) {
  return _(e) ? e.get() : e;
}
function At({ scrapeMotionValuesFromProps: e, createRenderState: t }, n, r, i) {
  return { latestValues: jt(n, r, i, e), renderState: t() };
}
function jt(e, t, n, r) {
  let i = {},
    a = r(e, {});
  for (let e in a) i[e] = B(a[e]);
...
var Mt = (e) => (t, n) => {
    let r = (0, P.useContext)(z),
      i = (0, P.useContext)(F),
      a = () => At(e, t, r, i);
    return n ? a() : Ue(a);
  },
  Nt = Mt({ scrapeMotionValuesFromProps: s, createRenderState: bt }),
  Pt = Mt({ scrapeMotionValuesFromProps: we, createRenderState: Tt }),
  ...
  return (0, P.useCallback)(
    (r) => {
      (r && e.onMount && e.onMount(r),
        ...
        n && (typeof n == `function` ? n(r) : V(n) && (n.current = r)));
    },
    [t],
  );
}
...
function Rt(e, t, n, r, i) {
  let { visualElement: a } = (0, P.useContext)(z),
    o = (0, P.useContext)(ct),
    s = (0, P.useContext)(F),
    c = (0, P.useContext)(ot).reducedMotion,
    l = (0, P.useRef)(null);
  ((r ||= o.renderer),
    !l.current &&
      r &&
  ...
  let p = n[ie],
    m = (0, P.useRef)(
      !!p && !window.MotionHandoffIsComplete?.(p) && window.MotionHasOptimisedAnimation?.(p),
    );
  return (
    We(() => {
      u &&
...
function zt(e, t, n, r) {
  ...
  ((e.projection = new n(e.latestValues, t[`data-framer-portal-id`] ? void 0 : Bt(e.parent))),
    e.projection.setOptions({
      layoutId: i,
      layout: a,
      alwaysMeasureLayout: !!o || (s && V(s)),
      visualElement: e,
...
function Bt(e) {
  if (e) return e.options.allowProjection === !1 ? Bt(e.parent) : e.projection;
}
var Vt = a();
function Ht(e, { forwardMotionProps: t = !1 } = {}, n, r) {
  n && lt(n);
  let i = Ot(e) ? Pt : Nt;
  function a(a, o) {
    let s,
      l = { ...(0, P.useContext)(ot), ...a, layoutId: Ut(a) },
      { isStatic: u } = l,
      d = vt(a),
      f = i(a, u);
    if (!u && c) {
      Wt(l, n);
      let t = Gt(l);
      ((s = t.MeasureLayout), (d.visualElement = Rt(e, f, l, r, t.ProjectionNode)));
    }
    return (0, Vt.jsxs)(z.Provider, {
      value: d,
      children: [
        s && d.visualElement ? (0, Vt.jsx)(s, { visualElement: d.visualElement, ...l }) : null,
        kt(e, a, It(f, d.visualElement, o), f, u, t),
      ],
    });
  }
  a.displayName = `motion.${typeof e == `string` ? e : `create(${e.displayName ?? e.name ?? ``})`}`;
  let o = (0, P.forwardRef)(a);
  return ((o[Ft] = e), o);
}
function Ut({ layoutId: e }) {
  let t = (0, P.useContext)(He).id;
  return t && e !== void 0 ? t + `-` + e : e;
}
function Wt(e, t) {
  (0, P.useContext)(ct).strict;
}
function Gt(e) {
...
function Kt(e, t) {
  if (typeof Proxy > `u`) return Ht;
  let n = new Map(),
    r = (n, r) => Ht(n, r, e, t);
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) => (a === `create` ? r : (n.has(a) || n.set(a, Ht(a, void 0, e, t)), n.get(a))),
  });
}
var qt = (e, t) => (Ot(e) ? new ve(t) : new Ee(t, { allowProjection: e !== P.Fragment }));
...
function Yt(e, t, n = {}) {
  let r = j(e, t, n.type === `exit` ? e.presenceContext?.custom : void 0),
    { transition: i = e.getDefaultTransition() || {} } = r || {};
  n.transitionOverride && (i = n.transitionOverride);
  let a = r ? () => Promise.all(Oe(e, r, n)) : () => Promise.resolve(),
    o =
      e.variantChildren && e.variantChildren.size
        ? (r = 0) => {
            let { delayChildren: a = 0, staggerChildren: o, staggerDirection: s } = i;
            return Xt(e, t, r, a, o, s, n);
          }
        : () => Promise.resolve(),
    { when: s } = i;
  if (s) {
...
function Xt(e, t, n = 0, r = 0, i = 0, a = 1, o) {
  let s = [];
...
function Zt(e, t, n = {}) {
  ...
  let r;
  if (Array.isArray(t)) {
    let i = t.map((t) => Yt(e, t, n));
    r = Promise.all(i);
  } else if (typeof t == `string`) r = Yt(e, t, n);
  else {
    let i = typeof t == `function` ? j(e, t, n.custom) : t;
...
var tn = [...l].reverse(),
  nn = l.length;
function rn(e) {
  return (t) => Promise.all(t.map(({ animation: t, options: n }) => Zt(e, t, n)));
}
function an(e) {
  let t = rn(e),
    n = sn(),
    r = !0,
    i = (t) => (n, r) => {
      let i = j(e, r, t === `exit` ? e.presenceContext?.custom : void 0);
      if (i) {
  ...
  function o(a) {
    ...
    for (let t = 0; t < nn; t++) {
      ...
      if (
        ...
        (p.protectedKeys = { ...u }),
        (!p.isActive && g === null) || (!m && !p.prevProp) || ue(m) || typeof m == `boolean`)
      )
        continue;
      let ee = on(p.prevProp, m),
        y = ee || (f === a && p.isActive && !_ && h) || (t > d && h),
        te = !1,
        ne = Array.isArray(m) ? m : [m],
        b = ne.reduce(i(f), {});
      g === !1 && (b = {});
      let { prevResolvedValues: re = {} } = p,
        ie = { ...re, ...b },
        x = (t) => {
          ((y = !0), l.has(t) && ((te = !0), l.delete(t)), (p.needsAnimating[t] = !0));
          let n = e.getValue(t);
          n && (n.liveStyle = !1);
        };
      for (let e in ie) {
      ...
      y &&
        ...
        c.push(
          ...ne.map((t) => {
            let n = { type: f };
            if (typeof t == `string` && r && !ae && e.manuallyAnimateOnMount && e.parent) {
              let { parent: r } = e,
                i = j(r, t);
    ...
    if (l.size) {
      ...
      if (typeof o.initial != `boolean`) {
        let n = j(e, Array.isArray(o.initial) ? o.initial[0] : o.initial);
...
var U = class {
  ...
  ln = 0,
  un = {
    animation: { Feature: cn },
    exit: {
      Feature: class extends U {
        constructor() {
          (super(...arguments), (this.id = ln++));
        }
        update() {
...
function W(e, t, n, r = { passive: !0 }) {
  return (e.addEventListener(t, n, r), () => e.removeEventListener(t, n));
}
function G(e) {
  return { point: { x: e.pageX, y: e.pageY } };
}
var dn = (e) => (t) => Qe(t) && e(t, G(t));
function K(e, t, n, r) {
  return W(e, t, dn(n), r);
}
var fn = 1e-4,
...
function yn(e, t, n, r = 0.5) {
  ((e.origin = r),
    (e.originPoint = k(t.min, t.max, e.origin)),
    (e.scale = q(n) / q(t)),
    (e.translate = k(n.min, n.max, e.origin) - e.originPoint),
    ((e.scale >= pn && e.scale <= mn) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= gn && e.translate <= _n) || isNaN(e.translate)) && (e.translate = 0));
}
function J(e, t, n, r) {
  (yn(e.x, t.x, n.x, r ? r.originX : void 0), yn(e.y, t.y, n.y, r ? r.originY : void 0));
}
function bn(e, t, n) {
  ((e.min = n.min + t.min), (e.max = e.min + q(t)));
}
function xn(e, t, n) {
  (bn(e.x, t.x, n.x), bn(e.y, t.y, n.y));
}
function Sn(e, t, n) {
  ((e.min = t.min - n.min), (e.max = e.min + q(t)));
}
function Y(e, t, n) {
  (Sn(e.x, t.x, n.x), Sn(e.y, t.y, n.y));
}
function X(e) {
  return [e(`x`), e(`y`)];
}
var Cn = ({ current: e }) => (e ? e.ownerDocument.defaultView : null),
  wn = (e, t) => Math.abs(e - t);
function Tn(e, t) {
  let n = wn(e.x, t.x),
    r = wn(e.y, t.y);
  ...
  constructor(
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        let e = kn(this.lastMoveEventInfo, this.history),
          t = this.startEvent !== null,
          n = Tn(e.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
        if (!t && !n) return;
        let { point: r } = e,
          { timestamp: i } = O;
      ...
      (this.handlePointerMove = (e, t) => {
        ((this.lastMoveEvent = e),
          (this.lastMoveEventInfo = Dn(t, this.transformPagePoint)),
      ...
      (this.handlePointerUp = (e, t) => {
        ...
        if ((this.dragSnapToOrigin && i && i(), !(this.lastMoveEvent && this.lastMoveEventInfo)))
          return;
        let a = kn(
          e.type === `pointercancel` ? this.lastMoveEventInfo : Dn(t, this.transformPagePoint),
          this.history,
        );
    ...
    let o = Dn(G(e), this.transformPagePoint),
      { point: s } = o,
      { timestamp: c } = O;
    this.history = [{ ...s, timestamp: c }];
    let { onSessionStart: l } = t;
    (l && l(e, kn(o, this.history)),
...
function kn({ point: e }, t) {
  return { point: e, delta: On(e, jn(t)), offset: On(e, An(t)), velocity: Mn(t, 0.1) };
}
function An(e) {
  return e[0];
}
...
function Mn(e, t) {
  ...
  let n = e.length - 1,
    r = null,
    i = jn(e);
  for (; n >= 0 && ((r = e[n]), !(i.timestamp - r.timestamp > _e(t))); ) n--;
  if (!r) return { x: 0, y: 0 };
...
function Fn(e, { top: t, left: n, bottom: r, right: i }) {
  return { x: Pn(e.x, n, i), y: Pn(e.y, t, r) };
}
function In(e, t) {
  let n = t.min - e.min,
    r = t.max - e.max;
...
function Ln(e, t) {
  return { x: In(e.x, t.x), y: In(e.y, t.y) };
}
function Rn(e, t) {
  let n = 0.5,
    r = q(e),
...
function Vn(e = Bn) {
  return (
    e === !1 ? (e = 0) : e === !0 && (e = Bn),
    { x: Hn(e, `left`, `right`), y: Hn(e, `top`, `bottom`) }
  );
}
function Hn(e, t, n) {
  return { min: Un(e, t), max: Un(e, n) };
}
function Un(e, t) {
  ...
  Gn = class {
    ...
    start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
      ...
      let i = (e) => {
          ...
          (n ? this.pauseAnimation() : this.stopAnimation(), t && this.snapToCursor(G(e).point));
        },
        a = (e, t) => {
      ...
      this.panSession = new En(
        ...
        { onSessionStart: i, onStart: a, onMove: o, onSessionEnd: s, resumeAnimation: c },
        {
          ...
          dragSnapToOrigin: l,
          distanceThreshold: n,
          contextWindow: Cn(this.visualElement),
        },
      );
    }
    stop(e, t) {
    ...
    updateAxis(e, t, n) {
      ...
      if (!n || !Kn(e, r, this.currentDirection)) return;
      let i = this.getAxisMotionValue(e),
        a = this.originPoint[e] + n[e];
      (this.constraints && this.constraints[e] && (a = Nn(a, this.constraints[e], this.elastic[e])),
        i.set(a));
    }
    resolveConstraints() {
      ...
      (e && V(e)
        ...
        : e && n
          ? (this.constraints = Fn(n.layoutBox, e))
          : (this.constraints = !1),
        (this.elastic = Vn(t)),
        r !== this.constraints &&
          n &&
          ...
          X((e) => {
            this.constraints !== !1 &&
              ...
              (this.constraints[e] = zn(n.layoutBox[e], this.constraints[e]));
          }));
    }
    resolveRefConstraints() {
      ...
      let i = me(n, r.root, this.visualElement.getTransformPagePoint()),
        a = Ln(r.layout.layoutBox, i);
      if (t) {
        let e = t(f(a));
        ((this.hasMutatedConstraints = !!e), e && (a = m(e)));
      }
      return a;
    }
    startAnimation(e) {
      let {
        ...
        s = this.constraints || {},
        c = X((o) => {
          if (!Kn(o, t, this.currentDirection)) return;
          let c = (s && s[o]) || {};
          a && (c = { min: 0, max: 0 });
          let l = r ? 200 : 1e6,
            u = r ? 40 : 1e7,
    ...
    startAxisValueAnimation(e, t) {
      ...
      return (he(this.visualElement, e), n.start(je(e, n, 0, t, this.visualElement, !1)));
    }
    stopAnimation() {
    ...
    snapToCursor(e) {
      X((t) => {
        ...
        if (!Kn(t, n, this.currentDirection)) return;
        let { projection: r } = this.visualElement,
    ...
    scalePositionWithinConstraints() {
      ...
      if (!V(t) || !n || !this.constraints) return;
      this.stopAnimation();
      let r = { x: 0, y: 0 };
      X((e) => {
        ...
        if (t && this.constraints !== !1) {
          let n = t.get();
          r[e] = Rn({ min: n, max: n }, this.constraints[e]);
        }
      });
    ...
    addListeners() {
      ...
      let e = this.visualElement.current,
        ...
        n = () => {
          ...
          V(e) && e.current && (this.constraints = this.resolveRefConstraints());
        },
        { projection: r } = this.visualElement,
        i = r.addEventListener(`measure`, n);
      (r && !r.layout && (r.root && r.root.updateScroll(), r.updateLayout()), A.read(n));
      let a = W(window, `resize`, () => this.scalePositionWithinConstraints()),
...
var Z = {
    correct: (e, t) => {
      ...
      return `${Qn(e, t.target.x)}% ${Qn(e, t.target.y)}%`;
    },
  },
  $n = {
...
function nr(e) {
  ...
  return (0, Vt.jsx)(tr, {
    ...e,
    layoutGroup: r,
    switchLayoutGroup: (0, P.useContext)(Lt),
    isPresent: t,
    safeToRemove: n,
  });
}
var rr = {
  ...
  ar = class {
    ...
    forEach(e) {
      (this.isDirty && this.children.sort(ir), (this.isDirty = !1), this.children.forEach(e));
    }
  };
function or(e, t) {
  let n = be.now(),
  ...
  return (A.setup(r, !0), () => w(r));
}
var sr = [`TopLeft`, `TopRight`, `BottomLeft`, `BottomRight`],
  cr = sr.length,
  lr = (e) => (typeof e == `string` ? parseFloat(e) : e),
  ur = (e) => typeof e == `number` || De.test(e);
function dr(e, t, n, r, i, a) {
  i
    ? ((e.opacity = k(0, n.opacity ?? 1, pr(r))), (e.opacityExit = k(t.opacity ?? 1, 0, mr(r))))
    : a && (e.opacity = k(t.opacity ?? 1, n.opacity ?? 1, r));
  for (let i = 0; i < cr; i++) {
    let a = `border${sr[i]}Radius`,
      o = fr(t, a),
      s = fr(n, a);
    (o === void 0 && s === void 0) ||
      ((o ||= 0),
      (s ||= 0),
      o === 0 || s === 0 || ur(o) === ur(s)
        ? ((e[a] = Math.max(k(lr(o), lr(s), r), 0)), (ye.test(s) || ye.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
function vr(e, t, n, r, i) {
  return ((e -= t), (e = ge(e, 1 / n, r)), i !== void 0 && (e = ge(e, 1 / i, r)), e);
}
function yr(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
    (ye.test(t) && ((t = parseFloat(t)), (t = k(o.min, o.max, t / 100) - o.min)),
    typeof t != `number`)
  )
    return;
  let s = k(a.min, a.max, r);
  (e === a && (s -= t), (e.min = vr(e.min, t, n, s, i)), (e.max = vr(e.max, t, n, s, i)));
}
function br(e, t, [n, r, i], a, o) {
  yr(e, t[n], t[r], t[i], t.scale, a, o);
}
var xr = [`x`, `scaleX`, `originX`],
  Sr = [`y`, `scaleY`, `originY`];
function Cr(e, t, n, r) {
  (br(e.x, t, xr, n ? n.x : void 0, r ? r.x : void 0),
    br(e.y, t, Sr, n ? n.y : void 0, r ? r.y : void 0));
}
function wr(e) {
...
var Mr = class {
  ...
  add(e) {
    (x(this.members, e), e.scheduleRender());
  }
  remove(e) {
...
var $ = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
  Pr = [``, `X`, `Y`, `Z`],
  Fr = 1e3,
  Ir = 0;
function Lr(e, t, n, r) {
...
function Rr(e) {
  ...
  let { parent: r } = e;
  r && !r.hasCheckedOptimisedAppear && Rr(r);
}
function zr({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Ir++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            E.value && ($.nodes = $.calculatedTargetDeltas = $.calculatedProjections = 0),
            this.nodes.forEach(Hr),
            this.nodes.forEach(Yr),
            this.nodes.forEach(Xr),
            this.nodes.forEach(Ur),
            E.addProjectionMetrics && E.addProjectionMetrics($));
        }),
      ...
      this.root === this && (this.nodes = new ar());
    }
    ...
    mount(t) {
      ...
      ((this.isSVG = Ae(t) && !te(t)), (this.instance = t));
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Zn.hasAnimatedSinceResize &&
                ((Zn.hasAnimatedSinceResize = !1), this.nodes.forEach(Jr)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let a = this.options.transition || i.getDefaultTransition() || ri,
                { onLayoutAnimationStart: s, onLayoutAnimationComplete: c } = i.getProps(),
                l = !this.targetLayout || !kr(this.targetLayout, r),
                u = !t && n;
              if (
                ...
                let t = { ...o(a, `layout`), onPlay: s, onComplete: c };
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(Zr), this.animationId++);
    }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && Rr(this),
    ...
    update() {
      ...
      let e = be.now();
      ((O.delta = p(0, 1e3 / 60, e - O.timestamp)),
        (O.timestamp = e),
        (O.isProcessing = !0),
        xe.update.process(O),
        xe.preRender.process(O),
        xe.render.process(O),
        (O.isProcessing = !1));
    }
    didUpdate() {
    ...
    resetTransform() {
      ...
      let e = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout,
        t = this.projectionDelta && !Tr(this.projectionDelta),
        n = this.getTransformTemplate(),
        r = n ? n(this.latestValues, ``) : void 0,
        a = r !== this.prevTransformTemplateValue;
      e &&
        this.instance &&
        (t || C(this.latestValues) || a) &&
    ...
    measurePageBox() {
      ...
      if (!(this.scroll?.wasRoot || this.path.some(li))) {
        let { scroll: e } = this.root;
        e && (S(t.x, e.offset.x), S(t.y, e.offset.y));
      }
      return t;
    }
    removeElementScroll(e) {
      ...
      for (let n = 0; n < this.path.length; n++) {
        ...
        r !== this.root &&
          i &&
          a.layoutScroll &&
          (i.wasRoot && Q(t, e), S(t.x, i.offset.x), S(t.y, i.offset.y));
      }
      return t;
    }
    applyTransform(e, t = !1) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        (!t &&
          ...
          r.scroll &&
          r !== r.root &&
          N(n, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
          C(r.latestValues) && N(n, r.latestValues));
      }
      return (C(this.latestValues) && N(n, this.latestValues), n);
    }
    removeTransform(e) {
      let t = D();
      Q(t, e);
      for (let e = 0; e < this.path.length; e++) {
        let n = this.path[e];
        if (!n.instance || !C(n.latestValues)) continue;
        Le(n.latestValues) && n.updateSnapshot();
        let r = D();
        (Q(r, n.measurePageBox()),
          Cr(t, n.latestValues, n.snapshot ? n.snapshot.layoutBox : void 0, r));
      }
      return (C(this.latestValues) && Cr(t, this.latestValues), t);
    }
    setTargetDelta(e) {
    ...
    resolveTargetDelta(e = !1) {
      ...
      if (!(!this.layout || !(r || i))) {
        if (
          ((this.resolvedRelativeTargetAt = O.timestamp), !this.targetDelta && !this.relativeTarget)
        ) {
          ...
          e && e.layout && this.animationProgress !== 1
            ? ((this.relativeParent = e),
              ...
              Y(this.relativeTargetOrigin, this.layout.layoutBox, e.layout.layoutBox),
        ...
        if (!(!this.relativeTarget && !this.targetDelta)) {
          if (
            ...
            this.relativeParent.target
              ? (this.forceRelativeParentToResolveTarget(),
                xn(this.target, this.relativeTarget, this.relativeParent.target))
              : this.targetDelta
                ? (this.resumingFrom
            ...
            this.animationProgress !== 1
              ? ((this.relativeParent = e),
                ...
                (this.relativeTarget = D()),
                (this.relativeTargetOrigin = D()),
                Y(this.relativeTargetOrigin, this.target, e.target),
                Q(this.relativeTarget, this.relativeTargetOrigin))
              : (this.relativeParent = this.relativeTarget = void 0);
          }
          E.value && $.calculatedTargetDeltas++;
        }
      }
    }
    getClosestProjectingParent() {
      if (!(!this.parent || Le(this.parent.latestValues) || u(this.parent.latestValues)))
    ...
    calcProjection() {
      ...
      let a = this.treeScale.x,
        o = this.treeScale.y;
      (ze(this.layoutCorrected, this.treeScale, this.path, t),
        e.layout &&
          !e.target &&
          (this.treeScale.x !== 1 || this.treeScale.y !== 1) &&
          ((e.target = e.layout.layoutBox), (e.targetWithTransforms = D())));
      let { target: s } = e;
      if (!s) {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        : (_r(this.prevProjectionDelta.x, this.projectionDelta.x),
          _r(this.prevProjectionDelta.y, this.projectionDelta.y)),
        J(this.projectionDelta, this.layoutCorrected, s, this.latestValues),
        (this.treeScale.x !== a ||
          this.treeScale.y !== o ||
          !jr(this.projectionDelta.x, this.prevProjectionDelta.x) ||
          !jr(this.projectionDelta.y, this.prevProjectionDelta.y)) &&
          ((this.hasProjected = !0),
          this.scheduleRender(),
          this.notifyListeners(`projectionUpdate`, s)),
        E.value && $.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      let o = D(),
        ...
        u = !!(s && !l && this.options.crossfade === !0 && !this.path.some(ni));
      this.animationProgress = 0;
      let d;
      ((this.mixTargetDelta = (t) => {
        ...
        ($r(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            (Y(o, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
            ti(this.relativeTarget, this.relativeTargetOrigin, o, n),
            d && Dr(this.relativeTarget, d) && (this.isProjectionDirty = !1),
            (d ||= D()),
            Q(d, this.relativeTarget)),
          s && ((this.animationValues = i), dr(i, r, this.latestValues, n, u, l)),
    ...
    startAnimation(e) {
      (this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation &&= (w(this.pendingAnimation), void 0)),
        (this.pendingAnimation = A.update(() => {
          ((Zn.hasAnimatedSinceResize = !0),
            Pe.layout++,
            (this.motionValue ||= pe(0)),
            (this.currentAnimation = Ne(this.motionValue, [0, 1e3], {
              ...e,
              velocity: 0,
              isSync: !0,
              onUpdate: (t) => {
              ...
              onComplete: () => {
                (Pe.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Fr), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        if (
          ...
          this.layout &&
          r &&
          ci(this.options.animationType, this.layout.layoutBox, r.layoutBox)
        ) {
          n = this.target || D();
        ...
        (Q(t, n), N(t, i), J(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new Mr()),
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      let r = {};
      n.z && Lr(`z`, e, r, this.animationValues);
      for (let t = 0; t < Pr.length; t++)
        (Lr(`rotate${Pr[t]}`, e, r, this.animationValues),
          Lr(`skew${Pr[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      if (this.needsReset) {
        ((this.needsReset = !1),
          (e.visibility = ``),
          (e.opacity = ``),
          (e.pointerEvents = B(t?.pointerEvents) || ``),
      ...
      let a = Nr(this.projectionDeltaWithTransform, this.treeScale, i);
      ...
      for (let t in ne) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = ne[t],
      ...
      this.options.layoutId && (e.pointerEvents = r === this ? B(t?.pointerEvents) || `` : `none`);
    }
    clearSnapshot() {
...
function Vr(e) {
  ...
  if (e.isLead() && e.layout && t && e.hasListeners(`didUpdate`)) {
    ...
    J(o, n, t.layoutBox);
    let s = T();
    a ? J(s, e.applyTransform(r, !0), t.measuredBox) : J(s, n, t.layoutBox);
    let c = !Tr(o),
      l = !1;
    if (!e.resumeFrom) {
...
var ri = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
  ii = (e) =>
    typeof navigator < `u` && navigator.userAgent && navigator.userAgent.toLowerCase().includes(e),
  ai = ii(`applewebkit/`) && !ii(`chrome/`) ? Math.round : M;
function oi(e) {
  ((e.min = ai(e.min)), (e.max = ai(e.max)));
}
function si(e) {
  (oi(e.x), oi(e.y));
}
function ci(e, t, n) {
  return e === `position` || (e === `preserve-aspect` && !vn(Ar(t), Ar(n), 0.2));
}
function li(e) {
  return e !== e.root && e.scroll?.wasRoot;
}
var ui = zr({
    attachResizeListener: (e, t) => W(e, `resize`, t),
    measureScroll: () => ({
  ...
  pi = { pan: { Feature: Xn }, drag: { Feature: Jn, ProjectionNode: fi, MeasureLayout: nr } };
function mi(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && A.postRender(() => i(t, G(t)));
}
var hi = class extends U {
    mount() {
      ...
      e &&
        (this.unmount = Xe(
          e,
          (e, t) => (mi(this.node, t, `Start`), (e) => mi(this.node, e, `End`)),
        ));
    }
    unmount() {}
  },
    ...
    mount() {
      ...
      e &&
        (this.unmount = at(
          e,
          (e, t) => (
            _i(this.node, t, `Start`),
            (e, { success: t }) => _i(this.node, e, t ? `End` : `Cancel`)
          ),
...
function Ci({ root: e, ...t }) {
  let n = e || document;
  bi.has(n) || bi.set(n, {});
  let r = bi.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(Si, { root: e, ...t })), r[i]);
}
function wi(e, t, n) {
  let r = Ci(t);
  return (
...
var Ti = { some: 0, all: 1 },
  Ei = class extends U {
    ...
    startObserver() {
      ...
      let { viewport: e = {} } = this.node.getProps(),
        ...
        a = {
          ...
          rootMargin: n,
          threshold: typeof r == `number` ? r : Ti[r],
        };
      return wi(this.node.current, a, (e) => {
    ...
    update() {
      ...
      [`amount`, `margin`, `root`].some(Di(e, t)) && this.startObserver();
    }
    unmount() {}
  };
function Di({ viewport: e = {} }, { viewport: t = {} } = {}) {
  return (n) => e[n] !== t[n];
}
var Oi = {
    inView: { Feature: Ei },
  ...
  ki = { layout: { ProjectionNode: fi, MeasureLayout: nr } },
  Ai = Kt({ ...un, ...Oi, ...pi, ...ki }, qt);
export { Ge as a, Ue as c, ot as i, He as l, ht as n, F as o, st as r, We as s, Ai as t };
//# sourceMappingURL=proxy-DktXrBt_.js.map

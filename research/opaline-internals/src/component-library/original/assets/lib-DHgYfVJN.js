...
function g(e, t) {
  let n;
  for (n in t) {
    let r = (m.call(e, n) ? e[n] : void 0) || (e[n] = {}),
      i = t[n],
      a;
    if (i)
      for (a in i) {
...
function R(e) {
  ...
  function c(e) {
    if ((r++, t.containerState._closeFlow)) {
      ...
      return (f(t.events, a + 1, 0, t.events.slice(n)), (t.events.length = s), l(e));
    }
    return s(e);
  }
  function l(a) {
    ...
    return ((t.containerState = {}), e.check(L, u, d)(a));
  }
  function u(e) {
    return (i && y(), v(r), p(e));
  }
  ...
  function p(n) {
    return ((t.containerState = {}), e.attempt(L, m, h)(n));
  }
  function m(e) {
  ...
  function g(n) {
    ...
    return D(n)
      ? (e.consume(n), _(e.exit(`chunkFlow`)), (r = 0), (t.interrupt = void 0), s)
      : (e.consume(n), g);
  }
  function _(e, n) {
...
var H = { name: `attention`, resolveAll: U, tokenize: ee };
function U(e, t) {
  let n = -1,
    r,
    i,
      ...
      for (r = n; r--; )
        if (
          ...
          (te(d, -c),
            ...
            (l = p(l, V(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t))),
            (l = p(l, [
              [`exit`, a, t],
              [`enter`, s, t],
              [`exit`, s, t],
...
var W = { name: `autolink`, tokenize: ne };
function ne(e, t, n) {
  let r = 0;
  return i;
  function i(t) {
  ...
  function o(e) {
    return e === 43 || e === 45 || e === 46 || x(e) ? ((r = 1), s(e)) : l(e);
  }
  function s(t) {
    return t === 58
      ? (e.consume(t), (r = 0), c)
      : (t === 43 || t === 45 || t === 46 || x(t)) && r++ < 32
        ? (e.consume(t), s)
        : ((r = 0), l(t));
  }
  function c(r) {
    return r === 62
      ? (e.exit(`autolinkProtocol`),
        ...
        e.exit(`autolink`),
        t)
      : r === null || r === 32 || r === 60 || C(r)
        ? n(r)
        : (e.consume(r), c);
  }
  function l(t) {
    return t === 64 ? (e.consume(t), u) : S(t) ? (e.consume(t), l) : n(t);
  }
  function u(e) {
    return x(e) ? d(e) : n(e);
  }
...
var G = { partial: !0, tokenize: re };
function re(e, t, n) {
  return r;
  function r(t) {
    return k(t) ? N(e, i, `linePrefix`)(t) : i(t);
  }
  function i(e) {
    return e === null || D(e) ? t(e) : n(e);
  }
}
var ie = { continuation: { tokenize: oe }, exit: se, name: `blockQuote`, tokenize: ae };
function ae(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
var ce = { name: `characterEscape`, tokenize: le };
function le(e, t, n) {
  return r;
  function r(t) {
    return (
...
var K = { name: `characterReference`, tokenize: ue };
function ue(e, t, n) {
  let r = this,
    i = 0,
    a,
  ...
  function c(t) {
    return t === 35
      ? (e.enter(`characterReferenceMarkerNumeric`),
        ...
        l)
      : (e.enter(`characterReferenceValue`), (a = 31), (o = x), u(t));
  }
  function l(t) {
    return t === 88 || t === 120
      ? (e.enter(`characterReferenceMarkerHexadecimal`),
        ...
        (o = T),
        u)
      : (e.enter(`characterReferenceValue`), (a = 7), (o = w), u(t));
  }
  function u(s) {
    if (s === 59 && i) {
      let i = e.exit(`characterReferenceValue`);
      return o === x && !d(r.sliceSerialize(i))
        ? n(s)
        : (e.enter(`characterReferenceMarker`),
          e.consume(s),
          e.exit(`characterReferenceMarker`),
...
var q = { partial: !0, tokenize: pe },
  de = { concrete: !0, name: `codeFenced`, tokenize: fe };
function fe(e, t, n) {
  let r = this,
  ...
  function u(t) {
    return t === s
      ...
      : o < 3
        ? n(t)
        : (e.exit(`codeFencedFenceSequence`), k(t) ? N(e, d, `whitespace`)(t) : d(t));
  }
  function d(n) {
    return n === null || D(n)
      ? (e.exit(`codeFencedFence`), r.interrupt ? t(n) : e.check(q, h, b)(n))
  ...
  function f(t) {
    return t === null || D(t)
      ...
      : k(t)
        ? (e.exit(`chunkString`), e.exit(`codeFencedFenceInfo`), N(e, p, `whitespace`)(t))
        : t === 96 && t === s
          ? n(t)
          : (e.consume(t), f);
  }
  ...
  function _(t) {
    return a > 0 && k(t) ? N(e, v, `linePrefix`, a + 1)(t) : v(t);
  }
  function v(t) {
    return t === null || D(t) ? e.check(q, h, b)(t) : (e.enter(`codeFlowValue`), y(t));
  }
  function y(t) {
...
var J = { name: `codeIndented`, tokenize: he },
  me = { partial: !0, tokenize: ge };
function he(e, t, n) {
  let r = this;
  return i;
  function i(t) {
  ...
  function o(t) {
    return t === null ? c(t) : D(t) ? e.attempt(me, o, c)(t) : (e.enter(`codeFlowValue`), s(t));
  }
  function s(t) {
...
var _e = { name: `codeText`, previous: ye, resolve: ve, tokenize: be };
function ve(e) {
  let t = e.length - 4,
    n = 3,
    r,
...
function Se(e) {
  ...
  for (; ++n < u.length; ) {
    ...
    if (r[0] === `enter`) r[1].contentType && (Object.assign(t, Ce(u, n)), (n = t[n]), (l = !0));
...
var we = { resolve: Ee, tokenize: De },
  Te = { partial: !0, tokenize: Oe };
function Ee(e) {
  return (Se(e), e);
}
function De(e, t) {
  ...
  function i(t) {
    return t === null ? a(t) : D(t) ? e.check(Te, o, a)(t) : (e.consume(t), i);
  }
  function a(n) {
...
function Ae(e, t, n, r, i, a) {
  ...
  function d(t) {
    return t === null || t === 91 || t === 93 || D(t) || s++ > 999
  ...
  function l(t) {
    return t === o
      ...
      : t === null
        ? n(t)
        : D(t)
          ? (e.enter(`lineEnding`), e.consume(t), e.exit(`lineEnding`), N(e, l, `linePrefix`))
          : (e.enter(`chunkString`, { contentType: `string` }), u(t));
  }
  function u(t) {
    return t === o || t === null || D(t)
...
function X(e, t) {
  ...
  function r(i) {
    return D(i)
      ...
      : k(i)
        ? N(e, r, n ? `linePrefix` : `lineSuffix`)(i)
        : t(i);
  }
}
var Me = { name: `definition`, tokenize: Pe },
  Ne = { partial: !0, tokenize: Fe };
function Pe(e, t, n) {
  let r = this,
    i;
  return a;
  ...
  function s(t) {
    return (
      (i = y(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))),
      t === 58 ? (e.enter(`definitionMarker`), e.consume(t), e.exit(`definitionMarker`), c) : n(t)
    );
  }
  function c(t) {
    return O(t) ? X(e, l)(t) : l(t);
  }
  function l(t) {
    return ke(
      e,
  ...
  function u(t) {
    return e.attempt(Ne, d, d)(t);
  }
  function d(t) {
    return k(t) ? N(e, f, `whitespace`)(t) : f(t);
  }
  function f(a) {
...
function Fe(e, t, n) {
  return r;
  function r(t) {
    return O(t) ? X(e, i)(t) : n(t);
  }
  function i(t) {
    return je(e, a, n, `definitionTitle`, `definitionTitleMarker`, `definitionTitleString`)(t);
  }
  function a(t) {
    return k(t) ? N(e, o, `whitespace`)(t) : o(t);
  }
  function o(e) {
    return e === null || D(e) ? t(e) : n(e);
  }
}
var Ie = { name: `hardBreakEscape`, tokenize: Le };
function Le(e, t, n) {
  return r;
  function r(t) {
...
var Re = { name: `headingAtx`, resolve: ze, tokenize: Be };
function ze(e, t) {
  let n = e.length - 2,
    r = 3,
    i,
...
function Be(e, t, n) {
  ...
  function l(t) {
    return t === null || t === 35 || O(t) ? (e.exit(`atxHeadingText`), s(t)) : (e.consume(t), l);
  }
}
var Ve =
  ...
  He = [`pre`, `script`, `style`, `textarea`],
  Ue = { concrete: !0, name: `htmlFlow`, resolveTo: Ke, tokenize: qe },
  We = { partial: !0, tokenize: Ye },
  Ge = { partial: !0, tokenize: Je };
function Ke(e) {
  let t = e.length;
...
function qe(e, t, n) {
  ...
  function d(s) {
    return s === 33
      ...
      : s === 47
        ? (e.consume(s), (a = !0), h)
        : s === 63
          ? (e.consume(s), (i = 3), r.interrupt ? t : V)
          : b(s)
  ...
  function f(a) {
    return a === 45
      ...
      : a === 91
        ...
        : b(a)
          ? (e.consume(a), (i = 4), r.interrupt ? t : V)
          : n(a);
  }
  function p(i) {
  ...
  function S(t) {
    return t === 45 || t === 46 || t === 58 || t === 95 || x(t) ? (e.consume(t), S) : C(t);
  }
  function C(t) {
    return t === 61 ? (e.consume(t), w) : k(t) ? (e.consume(t), C) : y(t);
  }
  function w(t) {
  ...
  function T(t) {
    return t === c ? (e.consume(t), (c = null), A) : t === null || D(t) ? n(t) : (e.consume(t), T);
  }
  function E(t) {
    return t === null ||
      t === 34 ||
  ...
  function M(t) {
    return t === null || D(t) ? N(t) : k(t) ? (e.consume(t), M) : n(t);
  }
  function N(t) {
    return t === 45 && i === 2
      ? (e.consume(t), L)
        ...
        : t === 62 && i === 4
          ...
          : t === 63 && i === 3
            ...
            : t === 93 && i === 5
              ? (e.consume(t), B)
              : D(t) && (i === 6 || i === 7)
                ? (e.exit(`htmlFlowData`), e.check(We, U, P)(t))
                : t === null || D(t)
                  ? (e.exit(`htmlFlowData`), P(t))
                  : (e.consume(t), N);
  }
  function P(t) {
    return e.check(Ge, F, U)(t);
  }
  function F(t) {
    return (e.enter(`lineEnding`), e.consume(t), e.exit(`lineEnding`), I);
  }
  function I(t) {
    return t === null || D(t) ? P(t) : (e.enter(`htmlFlowData`), N(t));
  }
  function L(t) {
  ...
  function z(t) {
    if (t === 62) {
      let n = o.toLowerCase();
      return He.includes(n) ? (e.consume(t), H) : N(t);
    }
    return b(t) && o.length < 8 ? (e.consume(t), (o += String.fromCharCode(t)), z) : N(t);
  }
  function B(t) {
    return t === 93 ? (e.consume(t), V) : N(t);
  }
  function V(t) {
    return t === 62 ? (e.consume(t), H) : t === 45 && i === 2 ? (e.consume(t), V) : N(t);
  }
  function H(t) {
    return t === null || D(t) ? (e.exit(`htmlFlowData`), U(t)) : (e.consume(t), H);
  }
  function U(n) {
...
function Ye(e, t, n) {
  return r;
  function r(r) {
    return (e.enter(`lineEnding`), e.consume(r), e.exit(`lineEnding`), e.attempt(G, t, n));
  }
}
var Xe = { name: `htmlText`, tokenize: Ze };
function Ze(e, t, n) {
  let r = this,
    i,
    a,
  ...
  function _(t) {
    return t === 62 ? R(t) : t === 93 ? (e.consume(t), _) : h(t);
  }
  function v(t) {
    return t === null || t === 62 ? R(t) : D(t) ? ((o = v), z(t)) : (e.consume(t), v);
  }
  function y(t) {
    return t === null
      ? n(t)
  ...
  function C(t) {
    return b(t) ? (e.consume(t), w) : n(t);
  }
  function w(t) {
    return t === 45 || x(t) ? (e.consume(t), w) : T(t);
  }
  function T(t) {
    return D(t) ? ((o = T), z(t)) : k(t) ? (e.consume(t), T) : R(t);
  }
  function E(t) {
    return t === 45 || x(t) ? (e.consume(t), E) : t === 47 || t === 62 || O(t) ? A(t) : n(t);
  }
  function A(t) {
    return t === 47
      ? (e.consume(t), R)
  ...
  function j(t) {
    return t === 45 || t === 46 || t === 58 || t === 95 || x(t) ? (e.consume(t), j) : M(t);
  }
  function M(t) {
    return t === 61 ? (e.consume(t), P) : D(t) ? ((o = M), z(t)) : k(t) ? (e.consume(t), M) : A(t);
  }
  function P(t) {
    return t === null || t === 60 || t === 61 || t === 62 || t === 96
      ? n(t)
...
var Qe = { name: `labelEnd`, resolveAll: nt, resolveTo: rt, tokenize: it },
  $e = { tokenize: at },
  et = { tokenize: ot },
  tt = { tokenize: st };
function nt(e) {
...
function rt(e, t) {
  ...
  return (
    ...
    (s = p(s, [[`enter`, u, t]])),
    (s = p(s, V(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t))),
...
function it(e, t, n) {
  ...
  function s(t) {
    return a
      ? a._inactive
        ? d(t)
        : ((o = r.parser.defined.includes(y(r.sliceSerialize({ start: a.end, end: r.now() })))),
          e.enter(`labelEnd`),
          e.enter(`labelMarker`),
          e.consume(t),
          e.exit(`labelMarker`),
  ...
  function c(t) {
    return t === 40
      ? e.attempt($e, u, o ? u : d)(t)
      : t === 91
        ? e.attempt(et, u, o ? l : d)(t)
        : o
          ? u(t)
          : d(t);
  }
  function l(t) {
    return e.attempt(tt, u, d)(t);
  }
  function u(e) {
    return t(e);
  }
...
function at(e, t, n) {
  ...
  function c(t) {
    return t === 34 || t === 39 || t === 40
      ? je(e, l, n, `resourceTitle`, `resourceTitleMarker`, `resourceTitleString`)(t)
      : u(t);
  }
  function l(t) {
    return O(t) ? X(e, u)(t) : u(t);
  }
  function u(r) {
    return r === 41
...
function ot(e, t, n) {
  ...
  return i;
  function i(t) {
    return Ae.call(r, e, a, o, `reference`, `referenceMarker`, `referenceString`)(t);
  }
  function a(e) {
    return r.parser.defined.includes(
      y(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)),
    )
      ? t(e)
      : n(e);
  }
...
var ct = { name: `labelStartImage`, resolveAll: Qe.resolveAll, tokenize: lt };
function lt(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
var ut = { name: `labelStartLink`, resolveAll: Qe.resolveAll, tokenize: dt };
function dt(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
var ft = { name: `lineEnding`, tokenize: pt };
function pt(e, t) {
  return n;
  function n(n) {
    return (e.enter(`lineEnding`), e.consume(n), e.exit(`lineEnding`), N(e, t, `linePrefix`));
...
var Z = { name: `thematicBreak`, tokenize: mt };
function mt(e, t, n) {
  let r = 0,
    i;
  return a;
  ...
  function c(t) {
    return t === i
      ? (e.consume(t), r++, c)
      : (e.exit(`thematicBreakSequence`), k(t) ? N(e, s, `whitespace`)(t) : s(t));
  }
}
var Q = { continuation: { tokenize: vt }, exit: bt, name: `list`, tokenize: _t },
  ht = { partial: !0, tokenize: xt },
  gt = { partial: !0, tokenize: yt };
function _t(e, t, n) {
  let r = this,
  ...
  function s(t) {
    ...
    if (i === `listUnordered` ? !r.containerState.marker || t === r.containerState.marker : w(t)) {
      if (
        ...
        return (e.enter(`listItemPrefix`), t === 42 || t === 45 ? e.check(Z, n, l)(t) : l(t));
      if (!r.interrupt || t === 49)
  ...
  function l(t) {
    return (
      ...
      e.check(G, r.interrupt ? n : u, e.attempt(ht, f, d))
    );
  }
  function u(e) {
...
function vt(e, t, n) {
  let r = this;
  return ((r.containerState._closeFlow = void 0), e.check(G, i, a));
  function i(n) {
    return (
      (r.containerState.furtherBlankLines =
        r.containerState.furtherBlankLines || r.containerState.initialBlankLine),
      N(e, t, `listItemIndent`, r.containerState.size + 1)(n)
    );
  }
  function a(n) {
...
var St = { name: `setextUnderline`, resolveTo: Ct, tokenize: wt };
function Ct(e, t) {
  let n = e.length,
    r,
    i,
...
function wt(e, t, n) {
  ...
  function s(t) {
    return t === i
      ? (e.consume(t), s)
      : (e.exit(`setextHeadingLineSequence`), k(t) ? N(e, c, `lineSuffix`)(t) : c(t));
  }
  function c(r) {
  ...
  let t = this,
    n = e.attempt(
      ...
      e.attempt(
        ...
        i,
        N(e, e.attempt(this.parser.constructs.flow, i, e.attempt(we, i)), `linePrefix`),
      ),
    );
  return n;
  function r(r) {
...
var Dt = { resolveAll: jt() },
  Ot = At(`string`),
  kt = At(`text`);
function At(e) {
  return { resolveAll: jt(e === `text` ? Mt : void 0), tokenize: t };
  function t(t) {
    let n = this,
...
var Nt = e({
  ...
  Ft = { 91: Me },
  It = { [-2]: J, [-1]: J, 32: J },
  Lt = { 35: Re, 42: Z, 45: [St, Z], 60: Ue, 61: St, 95: Z, 96: de, 126: de },
  Rt = { 38: K, 92: ce },
  zt = {
    [-5]: ft,
    [-4]: ft,
...
function Ut(e, t, n) {
  ...
  function d(e) {
    return (
      (o = p(o, e)),
      v(),
      o[o.length - 1] === null ? (E(t, 0), (l.events = V(a, l.events, l)), l.events) : []
    );
  }
  function m(e, t) {
    return Gt(h(e), t);
  ...
  function x(e, t) {
    let n = t || {};
    return ((n.type = e), (n.start = g()), l.events.push([`enter`, n, l]), s.push(n), n);
  }
  function S(e) {
    let t = s.pop();
  ...
  function E(e, t) {
    (e.resolveAll && !a.includes(e) && a.push(e),
      e.resolve && f(l.events, t, l.events.length - t, e.resolve(l.events.slice(t), l)),
  ...
  function O() {
    ...
    function o() {
      ((r = e), (l.previous = t), (l.currentConstruct = n), (l.events.length = i), (s = a), k());
    }
  }
  function k() {
...
var Xt = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
function Zt(e) {
  return e.replace(Xt, Qt);
}
function Qt(e, t, n) {
  if (t) return t;
  if (n.charCodeAt(0) === 35) {
    let e = n.charCodeAt(1),
      t = e === 120 || e === 88;
    return v(n.slice(t ? 2 : 1), t ? 16 : 10);
  }
  return d(n) || e;
}
...
function tn(e) {
  ...
  function i(e) {
    let t = { type: `root`, children: [] },
      ...
      s = -1;
    for (; ++s < e.length; )
      (e[s][1].type === `listOrdered` || e[s][1].type === `listUnordered`) &&
        (e[s][0] === `enter` ? o.push(s) : (s = a(e, o.pop(), s)));
    for (s = -1; ++s < e.length; ) {
      let t = n[e[s][0]];
      $t.call(t, e[s][1].type) &&
        t[e[s][1].type].call(Object.assign({ sliceSerialize: e[s][2].sliceSerialize }, i), e[s][1]);
    }
    if (i.tokenStack.length > 0) {
      let e = i.tokenStack[i.tokenStack.length - 1];
      (e[1] || an).call(i, void 0, e[0]);
    }
    for (
      t.position = {
        start: $(e.length > 0 ? e[0][1].start : { line: 1, column: 1, offset: 0 }),
        end: $(e.length > 0 ? e[e.length - 2][1].end : { line: 1, column: 1, offset: 0 }),
      },
        s = -1;
  ...
  function f(e, n) {
    ...
    if (i) i[0].type !== e.type && (n ? n.call(this, e, i[0]) : (i[1] || an).call(this, e, i[0]));
    else
      throw Error(
        "Cannot close `" + e.type + "` (" + t({ start: e.start, end: e.end }) + `): it’s not open`,
      );
    r.position.end = $(e.end);
  }
  function p() {
  ...
  function A(e) {
    let t = this.stack[this.stack.length - 1].children,
      n = t[t.length - 1];
    ((!n || n.type !== `text`) &&
      ((n = ge()), (n.position = { start: $(e.start), end: void 0 }), t.push(n)),
      this.stack.push(n));
  }
  function j(e) {
  ...
  function M(e) {
    ...
    if (this.data.atHardBreak) {
      ...
      ((n.position.end = $(e.end)), (this.data.atHardBreak = void 0));
      return;
    }
    !this.data.setextHeadingSlurpLineEnding &&
      n.canContainEols.includes(t.type) &&
      (A.call(this, e), j.call(this, e));
  }
  function N() {
  ...
  function z(e) {
    ...
    ((n.label = Zt(t)), (n.identifier = y(t).toLowerCase()));
  }
  function B() {
    let e = this.stack[this.stack.length - 1],
      t = this.resume(),
  ...
  function te(e) {
    let t = this.resume(),
      n = this.stack[this.stack.length - 1];
    ((n.label = t),
      (n.identifier = y(this.sliceSerialize(e)).toLowerCase()),
  ...
  function ne(e) {
    let t = this.sliceSerialize(e),
      ...
      r;
    n
      ? ((r = v(t, n === `characterReferenceMarkerNumeric` ? 10 : 16)),
...
//# sourceMappingURL=lib-DHgYfVJN.js.map

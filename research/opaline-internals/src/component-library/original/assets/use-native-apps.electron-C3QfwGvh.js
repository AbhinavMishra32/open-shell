...
import { Mr as t, jr as n } from "./src-CYrn1fYL.js";
import { fo as r, uo as i } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as a, t as o } from "./jsx-runtime-CiQ1k8xo.js";
import { lt as s, o as c, u as l } from "./vscode-api-sUstfl-x.js";
import { n as u, t as d } from "./notion-CpBap5Le.js";
import { f, g as p, v as m } from "./mention-item-DOPWFNx_.js";
import { t as h } from "./use-platform-BkwBnkgx.js";
import { r as ee, t as g } from "./get-file-icon-DafZgplp.js";
import { t as _ } from "./skills-8SYgG-va.js";
import { t as v } from "./mcp-BYvjg9M2.js";
import { t as te } from "./bug-Nio_AeHs.js";
import { t as ne } from "./chrome-cKtIFTD3.js";
import { t as y } from "./opaline-C1u5S_iM.js";
import { t as b } from "./openai-blossom-DWhxKWUa.js";
import { t as x } from "./pencil-V3ApGyCb.js";
import { n as re, t as S } from "./filesystem-media-src-DlToOKVI.js";
var C = `com.google.Chrome`,
  w = `Google Chrome`,
  T = `Chrome`,
  E = /^process:(?:.*[\\/])?chrome\.exe$/i,
  D = `chrome`,
  O = `Chrome`;
function ie(e) {
...
function oe({ mentionPath: e, mentionDisplayName: t, nativeApps: n, computerPlugin: r }) {
  return M(e, r)
    ? { isComputerUse: !0, nativeApp: j(n, t) }
    : { isComputerUse: !1, nativeApp: null };
}
function se({ app: e, description: t, computerPlugin: n, iconSmall: r }) {
  let i = k(e);
  return {
    kind: `plugin`,
    name: i,
...
function k(e) {
  return A(e) ? O : e.displayName;
}
function A(e) {
  return (
    (e.bundleId === C && e.displayName === w) ||
    (e.bundleId === T && e.displayName === w) ||
    (E.test(e.bundleId) && e.displayName.trim().toLowerCase() === D)
  );
}
function j(e, t) {
  return t.length === 0 ? null : (e.find((e) => e.displayName === t || k(e) === t) ?? null);
}
function M(e, t) {
  return t == null ? !1 : e === m(t.plugin.id);
}
function N({ path: e, matchType: t }) {
  return t === `directory` ? g.folder : g[ee(e)];
}
function P() {
  return _;
}
  ...
  function o(o) {
    ...
    if (l || !e) {
      ...
      return (
        s[0] === f
          ? (e = s[1])
          : ((e = (0, F.createElement)(Z(r ?? n?.name ?? ``, i ?? n?.description), {
              className: f,
            })),
            (s[0] = f),
            (s[1] = e)),
    ...
    if (d) {
      let n = a === `large` ? `h-full w-full` : ``,
        ...
        i = c ? `block overflow-hidden ${r} ${c} ${n}` : `block overflow-hidden ${r} ${n}`,
        o;
      if (s[2] !== i) {
        let n;
    ...
    let p;
    s[5] === Symbol.for(`react.memo_cache_sentinel`) ? ((p = () => u(!0)), (s[5] = p)) : (p = s[5]);
    let m;
    return (
      s[6] === f
        ? (m = s[7])
        : ((m = (0, F.createElement)(`img`, {
            alt: t,
            className: f,
            draggable: !1,
            src: e,
    ...
    if (u) {
      ...
      return (
        c[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((o = (0, F.createElement)(K(e, t, n, r, i, a))), (c[2] = o))
          : (o = c[2]),
        o
      );
    }
...
function fe({ size: e = `small`, iconSmall: i, iconLarge: a, basePath: o, smallOnly: s }) {
  let c = (e) => {
    let i = e.trim();
    if (!i) return { url: null, isCustomPath: !1 };
    let a = i.toLowerCase();
    if (a.startsWith(`data:`) || a.startsWith(`http:`) || a.startsWith(`https:`))
      return { url: i, isCustomPath: !1 };
    if (
      a.startsWith(`file:`) ||
      a.startsWith(`vscode-resource:`) ||
      a.startsWith(`vscode-webview:`) ||
      a.startsWith(`vscode-file:`)
    )
      return { url: i, isCustomPath: !!o };
    let s = r(i),
      c = t(s);
    if (le.test(s) && !c) return { url: s, isCustomPath: !1 };
    let l = n(s),
      u = o && !l ? pe(s, o) : s;
    if (n(u)) {
      let e = window.location.protocol;
      return e === `http:` || e === `https:`
        ? { url: re(u), isCustomPath: !!o }
        : { url: S(u), isCustomPath: !!o };
    }
    return { url: u, isCustomPath: !!o };
  };
  if (e === `large`) {
    let e = a || i || null;
    if (!e) return { url: null, useCurrentColorMask: !1 };
    let { url: t, isCustomPath: n } = c(e);
    return { url: t, useCurrentColorMask: !!t && n && q(t) };
  }
  let l = s ? i || null : i || a || null;
  if (!l) return { url: null, useCurrentColorMask: !1 };
  let { url: u, isCustomPath: d } = c(l);
  return { url: u, useCurrentColorMask: !!u && d && q(u) };
}
function pe(e, t) {
  let n = r(t).replace(/\/+$/, ``),
    a = n.lastIndexOf(`/`);
  return r(i(a >= 0 ? n.slice(0, a) : ``, e.startsWith(`/`) ? e.slice(1) : e));
}
var J = `[data-opaline-window-type="electron"]`;
function Y() {
  if (typeof document > `u`) return !1;
  let e = document.querySelector(J);
  return e?.classList.contains(`electron-dark`)
    ? !0
    : e?.classList.contains(`electron-light`) || typeof window > `u` || !window.matchMedia
      ? !1
...
function X(e) {
  ...
  return (
    t[4] !== u || t[5] !== l
      ? ((d = (0, F.createElement)(u, { "aria-hidden": !0, className: l })),
        (t[4] = u),
        (t[5] = l),
        (t[6] = d))
      : (d = t[6]),
...
var me = {
  "gh-address-comments": U,
  "buildkite-fix-ci": V,
  "sentry-observability": W,
  "linear-implement-ticket": u,
  "figma-implement-design": L,
  "skill-creator": X,
};
function he(e) {
...
function ye(e) {
  ...
  t[1] === a
    ...
    : ((s = {
        params: o,
        queryConfig: { enabled: a, staleTime: l.FIVE_MINUTES, refetchOnWindowFocus: !1 },
      }),
      (t[1] = a),
      (t[2] = s));
  let u = c(`native-desktop-apps`, s),
    d;
  t[3] !== u || t[4] !== a
    ? ((d = a ? (u.data?.apps ?? []) : []), (t[3] = u), (t[4] = a), (t[5] = d))
    : (d = t[5]);
  let f = i || (a && u.isLoading),
    p;
  return (
    t[6] !== d || t[7] !== f
      ? ((p = { nativeApps: d, isLoading: f }), (t[6] = d), (t[7] = f), (t[8] = p))
      : (p = t[8]),
    p
  );
}
...
//# sourceMappingURL=use-native-apps.electron-C3QfwGvh.js.map

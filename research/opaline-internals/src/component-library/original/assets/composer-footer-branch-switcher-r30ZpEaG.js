...
import { P as i, lt as a } from "./vscode-api-sUstfl-x.js";
import { c as o, o as s } from "./lib-MoKmYgcO.js";
import { t as c } from "./branch-CGmrzqEi.js";
import { S as l } from "./opaline-api-DRlZt5zW.js";
import { t as u } from "./use-debounced-value-DkRRYvDv.js";
import { t as d } from "./tooltip-BhXPONlb.js";
import { i as f, n as p } from "./use-environment-BKad65U8.js";
import { t as m } from "./button-Xd4Hy1MO.js";
import { t as ee } from "./spinner-Dvc_A3Ae.js";
import { n as te, r as ne } from "./composer-footer-CY-87K58.js";
import { t as h } from "./with-window-DPMmD2K-.js";
import { t as g } from "./check-md-CZTnvSiA.js";
import { r as _, t as v } from "./dropdown-CHaZfyxI.js";
import { t as y } from "./chevron-D6hquBJC.js";
import { t as b } from "./use-git-current-branch-FSV7TBsw.js";
import { t as x } from "./use-git-default-branch-CGx2UfAz.js";
import { t as S } from "./regenerate-Co1G5oL3.js";
import { o as C } from "./slash-command-item-bd62wAei.js";
import { a as re, i as ie, t as w } from "./git-branch-switcher-CJGCYmSz.js";
import { t as ae } from "./use-git-recent-branches-BVI2Upqc.js";
var T = a(),
  E = n();
function oe(e) {
  let t = (0, T.c)(11),
  ...
  if (!c) {
    ...
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, E.jsx)(E.Fragment, { children: n })), (t[0] = n), (t[1] = e)),
      e
    );
  }
  let l = !c && `hidden`,
  ...
  t[2] !== a || t[3] !== s || t[4] !== l
    ...
    : (u = t[5]);
  let d;
  t[6] === u ? (d = t[7]) : ((d = (0, E.jsx)(`div`, { className: u })), (t[6] = u), (t[7] = d));
  let f;
  return (
    t[8] !== n || t[9] !== d
...
function ce(e) {
  ...
  let {
    ...
    { data: I, isLoading: Ne, refetch: L } = b(O, x, `async_task_starting_state_dropdown`),
    Pe = k && !!O,
    R;
  ...
  t[5] !== M || t[6] !== O || t[7] !== x || t[8] !== Be
    ? ((H = {
      ...
      (t[9] = H))
    : (H = t[9]);
  let { data: Ve, isFetching: He, error: Ue, refetch: We } = i(re, H),
    Ge = n.type === `branch` ? n.branchName : void 0,
    U = k ? Ie : ye,
    Ke = k ? (V ? Ve : Fe) : V ? Ee?.filter((e) => e.toLowerCase().includes(ze)) : void 0,
    ...
    tt = z?.type === `success` ? z.stagedCount + z.unstagedCount + z.untrackedCount > 0 : !1,
    nt = k && tt,
  ...
  t[10] === it
    ? (at = t[11])
    : ((at = (0, E.jsx)(h, { electron: !0, children: it })), (t[10] = it), (t[11] = at));
  let ot;
  t[12] === et
    ? (ot = t[13])
    : ((ot = (0, E.jsx)(h, { browser: !0, children: et })), (t[12] = et), (t[13] = ot));
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (W = t[20]);
  let G;
  t[21] === w ? (G = t[22]) : ((G = r(`whitespace-nowrap`, w)), (t[21] = w), (t[22] = G));
  ...
  let pt = he
      ? null
      : (0, E.jsx)(te, { collapse: `secondary`, className: `max-w-40 truncate`, children: st }),
    mt;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((mt = (0, E.jsx)(ne, {
        children: (0, E.jsx)(y, { className: `icon-2xs text-token-input-placeholder-foreground` }),
      })),
      (t[26] = mt))
    : (mt = t[26]);
  let q;
          ...
          children: [
            ...
            (0, E.jsx)(_.Item, {
              ...
              SubText: tt
                ...
                : void 0,
              onClick: () => {
                (a({ type: `working-tree` }), P(!1));
              },
              children: Ne ? null : (0, E.jsx)(E.Fragment, { children: I ?? U }),
            }),
          ],
        })
      : null,
          ...
          ? (0, E.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, E.jsx)(m, {
                  ...
                  children: (0, E.jsx)(S, { className: `icon-xxs` }),
                }),
              ],
            })
          : (0, E.jsxs)(`div`, {
              ...
              children: [
                qe &&
                  (0, E.jsx)(_.Item, {
                    ...
                    onClick: () => {
                      (a({ type: `branch`, branchName: U }), P(!1));
                    },
                    children: U,
                  }),
                Je?.map((e) =>
                  (0, E.jsx)(
                    _.Item,
                    {
                      ...
                      onClick: () => {
                        (a({ type: `branch`, branchName: e }), P(!1));
                      },
                      children: e,
                    },
                    e,
  ...
  let vt;
  return (
    t[48] !== ut || t[49] !== A || t[50] !== P || t[51] !== me || t[52] !== q || t[53] !== $
      ? ((vt = (0, E.jsx)(ut, {
          side: me,
          open: A,
          onOpenChange: P,
...
function ue(e) {
  ...
  if (t[4] !== i || t[5] !== c || t[6] !== m || t[7] !== a) {
    let e = [
        c,
        i,
        fe({ currentBranch: i, gitDefaultBranch: c, recentBranches: m, remoteDefaultBranch: a }),
        ...(m ?? []),
      ],
      n = new Set();
    ((g = []),
  ...
  return (
    t[12] !== g || t[13] !== _ || t[14] !== y || t[15] !== v || t[16] !== S
      ? ((C = { branches: g, defaultBranch: _, fetching: v, error: y, refetch: S }),
        (t[12] = g),
        (t[13] = _),
        (t[14] = y),
        (t[15] = v),
...
function de(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = r(`text-sm text-token-description-foreground px-[var(--padding-row-x)] py-1`, n)),
      (t[0] = n),
      (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, E.jsx)(`div`, { className: a, children: i })), (t[2] = i), (t[3] = a), (t[4] = o))
      : (o = t[4]),
    o
  );
}
function fe({ currentBranch: e, gitDefaultBranch: t, recentBranches: n, remoteDefaultBranch: r }) {
...
function me(e) {
  ...
  return (
    t[0] === e
      ? (n = t[1])
      : ((n = (0, E.jsx)(w, { ...e, renderStaticBranch: D, renderControl: he })),
        (t[0] = e),
        (t[1] = n)),
    n
  );
    ...
    : (0, E.jsx)(d, {
        ...
        children: (0, E.jsxs)(m, {
          ...
          children: [
            ...
            (0, E.jsx)(te, { collapse: `sm`, className: `max-w-40 truncate text-sm`, children: t }),
            r
              ? (0, E.jsx)(ee, { className: `icon-xs text-token-input-placeholder-foreground` })
              : (0, E.jsx)(ne, {
                  children: (0, E.jsx)(y, {
...
//# sourceMappingURL=composer-footer-branch-switcher-r30ZpEaG.js.map

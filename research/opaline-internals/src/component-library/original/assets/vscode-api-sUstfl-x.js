...
var Cr,
  wr = {
    postMessage: (e) => {
      ...
      let r = new CustomEvent(`opaline-message-from-view`, { detail: e });
      (t && (r.__opalineForwardedViaBridge = !0), window.dispatchEvent(r));
    },
    getState: () => Cr,
    setState: (e) => {
      Cr = e;
...
function Fr(...e) {
  ...
  t[8] !== a || t[9] !== c || t[10] !== n
    ? ((x = async () =>
        (await kr.getInstance().post(`vscode://opaline/${n}`, JSON.stringify(a), zr(c))).body),
      (t[8] = a),
      (t[9] = c),
      (t[10] = n),
      (t[11] = x))
...
async function Lr(e, t, n, r, i) {
  let a = (await kr.getInstance().post(`vscode://opaline/${e}`, JSON.stringify(t), zr(i), r)).body;
  return n ? n(a) : a;
}
function Rr(e, t) {
  let n = (0, Z.c)(6),
  ...
  n[0] !== r || n[1] !== e
    ? ((i = async (t) =>
        (await kr.getInstance().post(`vscode://opaline/${e}`, JSON.stringify(t), zr(r))).body),
      (n[0] = r),
      (n[1] = e),
      (n[2] = i))
    : (i = n[2]);

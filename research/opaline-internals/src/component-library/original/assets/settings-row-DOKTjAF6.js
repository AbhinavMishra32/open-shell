...
function a(e) {
  let n = (0, r.c)(26),
    ...
    m;
  n[0] !== l || n[1] !== p ? ((m = t(p, l)), (n[0] = l), (n[1] = p), (n[2] = m)) : (m = n[2]);
  let h;
  n[3] === c
    ? (h = n[4])
  ...
  let b =
    ...
    x;
  n[16] === b ? (x = n[17]) : ((x = t(b)), (n[16] = b), (n[17] = x));
  let S;
  n[18] !== s || n[19] !== x
...
function o(e) {
  let n = (0, r.c)(17),
    ...
    f;
  n[0] === d ? (f = n[1]) : ((f = t(`grid items-center`, d)), (n[0] = d), (n[1] = f));
  let p;
  n[2] !== l || n[3] !== u
    ? ((p = t(
        `min-w-0`,
        u === `compact`
          ? t(`flex items-center pr-2 text-left`, l && `pl-1`)
  ...
  let m;
  n[5] !== s || n[6] !== p
    ? ((m = (0, i.jsx)(`div`, { className: p, children: s })), (n[5] = s), (n[6] = p), (n[7] = m))
    : (m = n[7]);
  let h =
      u === `compact`
    ...
    g;
  n[8] === h ? (g = n[9]) : ((g = t(`min-w-0`, h)), (n[8] = h), (n[9] = g));
  let _;
  n[10] !== a || n[11] !== g
...
//# sourceMappingURL=settings-row-DOKTjAF6.js.map

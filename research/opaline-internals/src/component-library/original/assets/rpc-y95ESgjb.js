...
function a(e) {
  ...
  switch (a) {
    ...
    default:
      if (t) {
        if (a == t.RpcStub.prototype || e instanceof t.ServiceStub) return `rpc-target`;
        if (a == t.RpcPromise.prototype || a == t.RpcProperty.prototype) return `rpc-thenable`;
      }
      return e instanceof n ? `rpc-target` : e instanceof Error ? `error` : `unsupported`;
  }
}
function o() {
...
var m = Symbol(`realStub`),
  ...
  g = class e extends n {
    ...
    dup() {
      let t = this[m];
      return t.pathIfPromise ? new e(t.hook.get(t.pathIfPromise)) : new e(t.hook.dup());
    }
    onRpcBroken(e) {
...
var S = class e {
  ...
  static fromArray(t) {
    ...
    for (let e of t) {
      ...
      for (let t of e.promises)
        (t.parent === e && (t = { parent: i, property: i.length, promise: t.promise }), r.push(t));
      i.push(e.value);
    }
    ...
    switch (a(e)) {
      ...
      case `rpc-thenable`: {
        let a = e,
          s;
        return (
          (s = o ? new _(o.getHookForRpcTarget(a, t, i), []) : new _(D.create(a, t), [])),
      ...
      case `writable`: {
        let n = e,
          r;
        return (
          (r = o ? o.getHookForWritableStream(n, t, i) : l.createWritableStreamHook(n)),
          this.hooks.push(r),
          n
        );
      }
      case `readable`: {
        let n = e,
          r;
        return (
          (r = o ? o.getHookForReadableStream(n, t, i) : l.createReadableStreamHook(n)),
          this.hooks.push(r),
          n
        );
      }
      ...
      case `request`: {
        let t = e;
        return (t.body && this.deepCopy(t.body, t, `body`, t, i, o), new Request(t));
      }
      case `response`: {
        let t = e;
        return (t.body && this.deepCopy(t.body, t, `body`, t, i, o), new Response(t.body, t));
      }
      default:
  ...
  deliverTo(t, n, r) {
    if ((this.ensureDeepCopied(), this.value instanceof _))
      ...
      t[n] = this.value;
      for (let t of this.promises) e.deliverRpcPromiseTo(t.promise, t.parent, t.property, r);
    }
  }
  ...
  disposeImpl(e, t) {
    switch (a(e)) {
      ...
      case `writable`: {
        let t = e,
          n = this.rpcTargets?.get(t);
        (n ? this.rpcTargets.delete(t) : (n = l.createWritableStreamHook(t)), n.dispose());
        return;
      }
      case `readable`: {
        let t = e,
          n = this.rpcTargets?.get(t);
        (n ? this.rpcTargets.delete(t) : (n = l.createReadableStreamHook(t)), n.dispose());
        return;
      }
      default:
        return;
...
var w = class extends u {
    call(e, t) {
      try {
        ...
        if (typeof i.value != `function`) throw TypeError(`'${e.join(`.`)}' is not a function.`);
    ...
    get(e) {
      try {
        let { value: t, owner: n } = this.getValue();
        if (e.length === 0 && n === null) throw Error(`Can't dup an RpcTarget stub as a promise.`);
  ...
  T = class e extends w {
    ...
    onBroken(e) {
      this.payload && this.payload.value instanceof g && this.payload.value.onRpcBroken(e);
    }
  };
function E(e) {
...
var D = class e extends w {
    ...
    ignoreUnhandledRejections() {}
    dispose() {
      this.target &&= (this.refcount && --this.refcount.count == 0 && E(this.target), void 0);
    }
    onBroken(e) {}
  },
  O = class e extends u {
    ...
    call(t, n) {
      return (n.ensureDeepCopied(), new e(this.promise.then((e) => e.call(t, n))));
    }
    stream(e, t) {
      return (t.ensureDeepCopied(), { promise: this.promise.then((n) => n.stream(e, t).promise) });
    }
    map(t, n, r) {
      return new e(
        this.promise.then(
    ...
    dup() {
      return this.resolution ? this.resolution.dup() : new e(this.promise.then((e) => e.dup()));
    }
    pull() {
...
var M = class e {
    ...
    evaluateImpl(t, n, r) {
      if (t instanceof Array) {
        if (t.length == 1 && t[0] instanceof Array) {
          let e = t[0];
          for (let t = 0; t < e.length; t++) e[t] = this.evaluateImpl(e[t], e, t);
          return e;
        } else
          switch (t[0]) {
            case `bigint`:
            ...
            case `bytes`:
              ...
              break;
            case `error`:
              if (t.length >= 3 && typeof t[1] == `string` && typeof t[2] == `string`) {
            ...
            case `nan`:
              return NaN;
            case `headers`:
              if (t.length === 2 && t[1] instanceof Array) return new Headers(t[1]);
              break;
            case `request`: {
              ...
              if (i.body instanceof ReadableStream && a.body === void 0) {
                let e = re(a, i.body);
                return (this.promises.push({ promise: e, parent: n, property: r }), e);
              } else return a;
            }
            case `response`: {
              if (t.length !== 3) break;
            ...
            case `import`:
            case `pipeline`: {
              if (t.length < 2 || t.length > 4 || typeof t[1] != `number`) break;
              ...
              let a = t[0] == `pipeline`,
                o = (e) => {
                  if (a) {
                    let t = new _(e, []);
                    return (this.promises.push({ promise: t, parent: n, property: r }), t);
              ...
              return ((c = new e(this.importer).evaluate([c])), o(i.call(s, c)));
            }
            case `remap`: {
              if (
                t.length !== 5 ||
              ...
              let a = t[3].map((e) => {
                ...
                o = t[4],
                s = new _(e.map(i, a, o), []);
              return (this.promises.push({ promise: s, parent: n, property: r }), s);
            }
            case `export`:
            case `promise`:
              if (typeof t[1] == `number`)
                if (t[0] == `promise`) {
                  ...
                  return (this.promises.push({ parent: n, property: r, promise: e }), e);
                } else {
  ...
  N = class {
    constructor(e, t, n) {
      ((this.session = e), (this.importId = t), n && (this.activePull = Promise.withResolvers()));
    }
    localRefcount = 0;
    remoteRefcount = 1;
    activePull;
    ...
    sendRelease() {
      this.remoteRefcount > 0 &&
        (this.session.sendRelease(this.importId, this.remoteRefcount), (this.remoteRefcount = 0));
    }
  },
  P = class e extends u {
    constructor(e, t) {
  ...
  I = class {
    ...
    getImport(e) {
      if (e instanceof P && e.entry && e.entry.session === this) return e.entry.importId;
    }
    importStub(e) {
      if (this.abortReason) throw this.abortReason;
      let t = this.imports[e];
      return (t || ((t = new N(this, e, !1)), (this.imports[e] = t)), new P(!1, t));
    }
    importPromise(e) {
      if (this.abortReason) throw this.abortReason;
      if (this.imports[e])
          ...
          switch (t[0]) {
            ...
            case `reject`: {
              ...
              if (typeof e == `number` && t.length > 2) {
                ...
                if (n)
                  if (t[0] == `resolve`) n.resolve(new T(new M(this).evaluate(t[2])));
                  else {
  ...
  L = class {
    ...
    constructor(e, t, n = {}) {
      let r;
      ((r = t ? new T(S.fromAppReturn(t)) : new d(Error(`This connection has no main object.`))),
        (this.#e = new I(e, r, n)),
...
var z = class {
            ...
            (e.data === null
              ...
              : typeof e.data == `string`
                ? this.#t
                  ...
                  : this.#r.push(e.data)
                : this.#a(TypeError(`Received non-string message from MessagePort.`)));
        }),
    ...
    #a(e) {
      this.#i || ((this.#i = e), (this.#n &&= (this.#n(e), (this.#t = void 0), void 0)));
    }
  },
  B,
  V = class {
    ...
    constructor(e, t) {
      (B
        ? (this.context = { parent: B, captures: [], subject: B.capture(e), path: t })
    ...
    makeOutput(e) {
      ...
      return (
        ...
        this.context.parent
          ...
          : this.context.subject.map(this.context.path, this.context.captures, this.instructions)
      );
    }
    pushCall(e, t, n) {
      ...
      return (this.instructions.push([`pipeline`, i, t, r]), new U(this, this.instructions.length));
    }
    pushGet(e, t) {
      let n = this.capture(e.dup());
      return (this.instructions.push([`pipeline`, n, t]), new U(this, this.instructions.length));
    }
    capture(e) {
...
s.sendMap = (e, t, n) => {
  let r = new V(e, t),
    i;
  try {
    i = S.fromAppReturn(p(r.pushCall.bind(r), () => n(new _(r.makeInput(), []))));
  } finally {
    r.unregister();
  }
    ...
    onAck(e) {
      ...
      if (((this.minRtt = Math.min(this.minRtt, n)), this.firstAckTime === 0))
        ...
        ((s = Math.min(s, e.windowAtSend * o)),
          (s = e.windowFullAtSend ? Math.max(s, e.windowAtSend * ae) : Math.max(s, this.window)),
          ...
          this.inStartupPhase &&
            ...
            (this.window > this.lastRoundWindow * X
              ...
              : ++this.roundsWithoutIncrease >= oe && (this.inStartupPhase = !1),
...
var Z = class e extends u {
  ...
  call(e, t) {
    return (t.dispose(), new d(Error(`Cannot call methods on a ReadableStream stub`)));
  }
  map(e, t, n) {
    for (let e of t) e.dispose();
  ...
  dup() {
    let t = this.state;
    if (!t) throw Error(`Attempted to dup a ReadableStreamStubHook after it was disposed.`);
    return new e(t, this);
  }
  pull() {
...
function ue() {
  ...
  return (
    window.postMessage({ type: `connect-app-host`, port: t }, window.location.origin, [t]),
    le(e)
  );
}
async function de() {
...
//# sourceMappingURL=rpc-y95ESgjb.js.map

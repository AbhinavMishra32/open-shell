import { lt as e, o as t, u as n } from "./vscode-api-sUstfl-x.js";
import { d as r, o as i, u as a } from "./statsig-Cajk3UKk.js";
import { t as o } from "./use-auth-DXLjX3T4.js";
import { p as s } from "./opaline-api-DRlZt5zW.js";
import { n as c, t as l } from "./skus-CJAzlvMK.js";
var u = e(),
  d = `1636924626`,
...
function p() {
  ...
  e[0] === h
    ? (C = e[1])
    : ((C = { queryConfig: { enabled: h, staleTime: n.ONE_MINUTE } }), (e[0] = h), (e[1] = C));
  let { data: w, isLoading: T } = t(`account-info`, C),
    E = b?.plan_type ?? (!x || S ? w?.plan : void 0),
    D;
  e[2] === E ? (D = e[3]) : ((D = g(E)), (e[2] = E), (e[3] = D));
  let O = D,
    k,
    A,
    j,
...
export { p as t };
//# sourceMappingURL=use-usage-settings-access-Gs3ypAPc.js.map

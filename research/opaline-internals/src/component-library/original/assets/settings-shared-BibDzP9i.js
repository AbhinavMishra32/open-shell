...
import { o as r, r as i } from "./lib-MoKmYgcO.js";
...
var c = i({
  ...
  "opaline-micro": {
    id: `settings.nav.opaline-micro`,
    defaultMessage: `Opaline Micro`,
    description: `Title for Opaline Micro settings section`,
  },
  appshots: {
...
function f(e) {
  let n = (0, u.c)(24),
    ...
    f;
  n[0] === e
    ? ((r = n[1]), (i = n[2]), (o = n[3]), (c = n[4]), (l = n[5]), (f = n[6]))
    : (({
        children: i,
        className: o,
        contentClassName: c,
      ...
      (n[5] = l),
      (n[6] = f));
  let p = f === void 0 ? `secondary` : f,
    m;
  n[7] === o ? (m = n[8]) : ((m = t(`w-[240px] justify-between`, o)), (n[7] = o), (n[8] = m));
  let h;
  n[9] === c
    ? (h = n[10])
    : ((h = t(`flex min-w-0 flex-1 items-center gap-1.5`, c)), (n[9] = c), (n[10] = h));
  let g;
  n[11] !== i || n[12] !== h
    ? ((g = (0, d.jsx)(`span`, { className: h, children: i })),
      (n[11] = i),
      (n[12] = h),
      (n[13] = g))
    : (g = n[13]);
  ...
  n[14] === r
    ? (_ = n[15])
    : ((_ = t(`icon-2xs shrink-0 text-token-input-placeholder-foreground`, r)),
      (n[14] = r),
      (n[15] = _));
  let v;
  n[16] === _ ? (v = n[17]) : ((v = (0, d.jsx)(s, { className: _ })), (n[16] = _), (n[17] = v));
  let y;
  return (
    n[18] !== p || n[19] !== l || n[20] !== m || n[21] !== g || n[22] !== v
      ? ((y = (0, d.jsxs)(a, { color: p, size: `toolbar`, className: m, ...l, children: [g, v] })),
        (n[18] = p),
        (n[19] = l),
        (n[20] = m),
        (n[21] = g),
...
function p(e) {
  ...
  let a;
  return (t[2] === i ? (a = t[3]) : ((a = (0, d.jsx)(r, { ...i })), (t[2] = i), (t[3] = a)), a);
}
function m(e) {
  let t = (0, u.c)(21),
    { slug: n } = e;
    ...
    case `opaline-micro`: {
      ...
      return (
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, d.jsx)(r, {
              id: `settings.section.opaline-micro`,
              defaultMessage: `Opaline Micro`,
              description: `Title for Opaline Micro settings section`,
            })),
            (t[5] = e))
...
export { l as a, m as i, p as n, h as r, f as t };
//# sourceMappingURL=settings-shared-BibDzP9i.js.map

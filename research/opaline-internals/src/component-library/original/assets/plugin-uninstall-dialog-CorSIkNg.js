...
import { o as n, r } from "./lib-MoKmYgcO.js";
import { t as i } from "./button-Xd4Hy1MO.js";
import { a, d as o, i as s, l as c, n as l, r as u } from "./dialog-layout-CCvvb1Vc.js";
var d = t(),
  f = e(),
  p = r({
    disable: {
    ...
    removeTitle: {
      ...
      defaultMessage: `Remove {name} plugin from Opaline`,
    ...
    removeDescription: {
      ...
      defaultMessage: `This removes the plugin from Opaline. Bundled apps will remain installed.`,
    ...
    removeConfirm: {
      ...
      defaultMessage: `Remove from Opaline`,
...
function m(e) {
    ...
    ? ((S = x
        ? (0, f.jsx)(n, {
            ...
            values: {
              name: (0, f.jsx)(
                `strong`,
                { className: `font-semibold text-token-text-primary`, children: b },
                `plugin-name`,
              ),
            },
          })
  ...
  t[3] === x
    ? (w = t[4])
    : ((w = x
        ? (0, f.jsx)(n, { ...p.removeDescription })
        : (0, f.jsx)(n, { ...p.confirmDescription })),
      (t[3] = x),
      (t[4] = w));
  let T = w,
    E;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { "aria-describedby": void 0 }), (t[5] = E))
    : (E = t[5]);
  let D;
  t[6] === C
    ? (D = t[7])
    : ((D = (0, f.jsx)(o, { className: `sr-only`, children: C })), (t[6] = C), (t[7] = D));
  let O;
  t[8] !== T || t[9] !== C
    ? ((O = (0, f.jsx)(a, {
        children: (0, f.jsx)(s, { title: C, subtitle: T, subtitleClassName: `mt-2` }),
      })),
      (t[8] = T),
      (t[9] = C),
      (t[10] = O))
  ...
  let P = x ? p.removeConfirm : p.confirm,
    F;
  t[21] === P ? (F = t[22]) : ((F = (0, f.jsx)(n, { ...P })), (t[21] = P), (t[22] = F));
  let I;
  t[23] !== h || t[24] !== N || t[25] !== F
    ? ((I = (0, f.jsx)(i, { color: `danger`, loading: h, onClick: N, children: F })),
      (t[23] = h),
      (t[24] = N),
      (t[25] = F),
      (t[26] = I))
    : (I = t[26]);
  let L;
  t[27] !== M || t[28] !== I || t[29] !== j
    ? ((L = (0, f.jsx)(a, { children: (0, f.jsxs)(u, { children: [j, M, I] }) })),
      (t[27] = M),
      (t[28] = I),
      (t[29] = j),
      (t[30] = L))
  ...
  let z;
  return (
    t[35] !== v || t[36] !== y || t[37] !== R
      ? ((z = (0, f.jsx)(c, { open: y, contentProps: E, onOpenChange: v, children: R })),
        (t[35] = v),
        (t[36] = y),
        (t[37] = R),
        (t[38] = z))
...
export { m as t };
//# sourceMappingURL=plugin-uninstall-dialog-CorSIkNg.js.map

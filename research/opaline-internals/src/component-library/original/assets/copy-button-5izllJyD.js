...
import { c as a, o } from "./lib-MoKmYgcO.js";
import { t as s } from "./tooltip-BhXPONlb.js";
import { t as c } from "./button-Xd4Hy1MO.js";
import { t as l } from "./check-md-CZTnvSiA.js";
import { t as u } from "./copy-Bnv7rlOa.js";
var d = i(),
  f = e(t(), 1);
function p() {
  let e = (0, d.c)(3),
...
function h(e) {
  ...
  t[22] !== T
    ? ((P =
        ...
        (0, m.jsxs)(c, {
          color: `ghost`,
          size: `icon`,
          className: r(`text-token-foreground`, v),
          "aria-label": E.formatMessage({
  ...
  return (
    t[24] !== N || t[25] !== P
      ? ((F = (0, m.jsxs)(m.Fragment, { children: [N, P] })), (t[24] = N), (t[25] = P), (t[26] = F))
      : (F = t[26]),
    F
  );
}
export { p as n, h as t };
//# sourceMappingURL=copy-button-5izllJyD.js.map

import { i as e } from "./skus-CJAzlvMK.js";
var t = 1440,
  n = 7 * t,
  r = 30 * t,
  i = 365 * t,
...
function l(e) {
  let { primary: t, secondary: n } = e ?? { primary: null, secondary: null },
    ...
    s = n?.windowDurationMins ?? 0,
    c = Math.max(r, i);
  return c < o
    ? null
    : i > r || (r === i && s > a)
      ? {
          severity: c >= 100 ? `blocked` : `warning`,
          usedPercent: i,
          remainingPercent: u(i),
          windowMinutes: s,
...
function f({ intl: e, minutes: a, variant: o = `summary` }) {
  let s = a ?? 0,
    c = p(s, i);
  if (c != null)
    return o === `summary`
...
function p(e, t) {
  ...
  return m(e, n * t) ? n : null;
}
function m(e, t) {
  return e >= t * 0.95 && e <= t * 1.05;
}
function h(e, t = new Date()) {
  let n = Math.floor((e.getTime() - t.getTime()) / 1e3);
  return n <= 0
    ? new Intl.RelativeTimeFormat(void 0, { numeric: `auto` }).format(0, `second`)
    : n < a
      ? new Intl.DateTimeFormat(void 0, { timeStyle: `short` }).format(e)
      : new Intl.DateTimeFormat(void 0, { month: `short`, day: `numeric` }).format(e);
}
function g(e) {
  return {
    date: new Intl.DateTimeFormat(void 0, { month: `short`, day: `numeric` }).format(e),
...
function S(e) {
  return x(e)?.reset_at ?? null;
}
function C(t) {
  if (t?.rate_limit_reached_type != null) return !0;
  let n = v(t),
    r = e(t?.plan_type) && t?.credits?.unlimited === !1 && t?.credits?.has_credits === !1;
  return !!(n?.limit_reached === !0 || n?.allowed === !1 || r || O(t));
}
function w({ rateLimitStatus: e, isWorkspaceAccount: t }) {
  let n = e?.rate_limit_reached_type?.type,
    r = n != null && n !== `rate_limit_reached`;
  return t && D(e) && !O(e) && !r;
}
function T({ rateLimitStatus: e, isWorkspaceAccount: t }) {
  return t && O(e);
}
function E({ rateLimitStatus: e, isWorkspaceAccount: t, isCreditsEnabled: n }) {
  let r = !t && D(e);
  return (
    n &&
    !T({ rateLimitStatus: e, isWorkspaceAccount: t }) &&
    C(e) &&
    !r &&
    !w({ rateLimitStatus: e, isWorkspaceAccount: t })
  );
}
function D(e) {
  let t = y(e);
...
function M(e) {
  return e == null
    ...
    : {
        ...
        windowMinutes: e.limit_window_seconds == null ? null : e.limit_window_seconds / j,
...
function P(e, t, n, r = null) {
  return {
    limitId: null,
    limitName: r,
    primary: J(e?.primary_window),
    secondary: J(e?.secondary_window),
    credits: Y(t),
    planType: X(n),
...
function I(e) {
  ...
  let t = [],
    n = F(e),
    r = P(e.rate_limit, e.credits, e.plan_type, n);
  r && t.push({ limitName: null, snapshot: r, blocked: C(e) });
  ...
  if (Array.isArray(i))
    for (let n of i) {
      ...
      let i = P(n.rate_limit, null, e.plan_type, r);
      i && t.push({ limitName: r, snapshot: i, blocked: k(n) });
    }
  return t;
}
function L(e, { activeLimitName: t, selectedModel: n } = {}) {
  if (e.length === 0) return e;
  let r = G(n),
    i = G(t),
    a = r ?? (i && !W(i) ? i : null);
  return a
    ? e.filter((e) => (e.limitName == null ? !0 : G(e.limitName) === a))
    : e.filter((e) => e.limitName == null);
}
function R(e, { activeLimitName: t, selectedModel: n } = {}) {
  ...
  return o && i?.blocked === !0
    ? i
    : o && a?.blocked === !0 && !W(a.limitName)
      ? a
      : (r ?? i ?? a ?? e[0] ?? null);
}
function z(e, t = {}) {
  let n = R(e, t);
  return n == null ? null : l(n.snapshot);
}
function B(e) {
  return q(e)?.resetsAt ?? null;
}
function V(e, t = {}) {
  if (e == null || C(e)) return !1;
  let n = t.activeLimitName ?? F(e),
    r = e.additional_rate_limits;
  if (!Array.isArray(r)) return n != null && !W(n);
  let i = G(t.selectedModel);
  return i != null && r.some((e) => (k(e) ? G(e.limit_name) === i : !1)) ? !0 : n != null && !W(n);
}
function H(e, t) {
  if (e == null) return !1;
  let n = G(t);
  ...
  return Array.isArray(r) ? r.some((e) => (k(e) ? G(e.limit_name) === n : !1)) : !1;
}
function U(e) {
...
function W(e) {
  return e == null ? !0 : e.trim().toLowerCase() === N;
}
function G(e) {
  if (e == null) return null;
  let t = e
...
function K(e, t) {
  let n = G(t);
  return n == null ? null : (e.find((e) => G(e.limitName) === n) ?? null);
}
function q(e) {
  if (e == null) return null;
...
function J(e) {
  ...
  return t == null
    ? null
    : { usedPercent: t.usedPercent, windowDurationMins: t.windowMinutes, resetsAt: t.resetAt };
}
function Y(e) {
  return e
    ? { hasCredits: e.has_credits, unlimited: e.unlimited, balance: e.balance ?? null }
    : null;
}
function X(e) {
  if (!e) return null;
...
//# sourceMappingURL=use-rate-limit-C_VkNfTr.js.map

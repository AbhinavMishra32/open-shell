...
import { r as n } from "./skill-utils-Bt5zjVpI.js";
var r = t({
  label: {
...
function _({ resourceUri: e, server: t }) {
  return `${c}${encodeURIComponent(t)}/${encodeURIComponent(e)}`;
}
function v(e) {
...
function F(e) {
  return { browserUse: e.formatMessage(r.label), computerUse: e.formatMessage(d.computerUse) };
}
function I() {
  return { browserUse: r.label.defaultMessage, computerUse: d.computerUse.defaultMessage };
}
function L(e) {
  let t = e?.brandColor;
...
function R({ conversationId: e, displayName: t }) {
  let n = B(t);
  return { kind: `agent`, name: n.toLowerCase(), displayName: n, conversationId: e, path: m(e) };
}
function z(e) {
  return { kind: `agent`, name: e.roleName, displayName: e.roleName, path: h(e.roleName) };
}
function B(e) {
  let t = e.trim();
...
//# sourceMappingURL=mention-item-DOPWFNx_.js.map

...
function p(e, t) {
            ...
            g(e)
              .then((e) => {
                ((n = !0),
                  ...
                  !t &&
                    (l(!1), p(y(e, { isCopilotApiAvailable: r, useCopilotAuthIfAvailable: i }))));
              })
              .catch(() => {
                ((n = !0), s != null && clearTimeout(s), t || (l(!1), p(h)));
              });
          };
        (a &&
          (s = setTimeout(() => {
          ...
          (p((t) =>
            e.authMethod == null && t?.authMethod != null
              ...
              : t == null
                ? e.authMethod == null
                  ? t
                  : { ..._(), authMethod: e.authMethod }
                : { ...t, authMethod: e.authMethod ?? null },
          ),
            c());
        };
        return (
          e.addAuthStatusCallback(u),
          () => {
            ((t = !0), s != null && clearTimeout(s), e.removeAuthStatusCallback(u));
          }
        );
      }),
      (S = [e, r, o, a, i]),
  ...
  return (
    n[11] !== f || n[12] !== c
      ? ((w = { isLoading: c, authState: f, setAuthMethod: C }),
        (n[11] = f),
        (n[12] = c),
        (n[13] = w))
      : (w = n[13]),
...
function _() {
  return { openAIAuth: null, authMethod: null, requiresAuth: !0, email: null, planAtLogin: null };
}
function v(e) {
...
function S(e) {
  ...
  let i = r === t,
    s = o(),
    { data: c, isLoading: l } = a(`use-copilot-auth-if-available`),
    d = i ? s : !1,
    f = i && !l ? (c ?? !1) : !1,
    m = i && document.documentElement.dataset.opalineOs === `win32`,
    h;
  n[2] !== d || n[3] !== f || n[4] !== m
    ? ((h = {
        isCopilotApiAvailable: d,
        useCopilotAuthIfAvailable: f,
        shouldUseWindowsStartupAuthTimeout: m,
      }),
      (n[2] = d),
      (n[3] = f),
      (n[4] = m),
      (n[5] = h))
    : (h = n[5]);
  let { authState: g, isLoading: _, setAuthMethod: v } = p(e, h);
  if (e == null) return null;
  let y;
  n[6] === g
    ? (y = n[7])
  ...
  let b = y,
    ...
    S;
  return (
    n[8] !== _ || n[9] !== b || n[10] !== v || n[11] !== x
      ? ((S = {
          ...b,
          isLoading: _,
          isCopilotApiAvailable: x,
          accountId: null,
          userId: null,
...
function C() {
  ...
  if (!e) throw Error(`useUpdateAuthNonce must be used within AuthNonceProvider`);
  return e;
}
export { l as a, p as i, x as n, c as o, C as r, b as t };
//# sourceMappingURL=use-auth-DXLjX3T4.js.map

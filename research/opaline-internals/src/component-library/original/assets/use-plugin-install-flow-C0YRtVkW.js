...
import { p as re } from "./opaline-api-DRlZt5zW.js";
...
import { t as de } from "./use-opaline-home-zmo5hiIG.js";
...
import { t as qe } from "./use-opaline-pricing-url-BucpTKgk.js";
...
var St = `assets/google-chrome.png`,
  ...
  wt = `https://chromewebstore.google.com/detail/opaline/`,
  Tt = n([`chrome`, `chrome-dev`, `chrome-internal`]),
  Et = t({ extensionId: i().trim().min(1) });
async function Dt({ opalineHome: e, hostId: t, plugin: n, queryClient: r }) {
  try {
    let i = jt(e, n);
    if (i == null) return [];
...
async function kt({
  ...
  let o = await Dt({
    opalineHome: t ?? (await T(`opaline-home`, { params: { hostId: n } })).opalineHome,
    hostId: n,
...
function Nt({ opalineHome: e, extensionId: t, plugin: n }) {
  return {
    iconUrl:
      Pt(
...
var It = A({
    opalineChromeDescription: {
      id: `plugins.installModal.browserExtension.description`,
      defaultMessage: `Install this extension in Chrome to let Opaline connect to your browser`,
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(Ut, {
            description: (0, Q.jsx)(k, {
              ...
              defaultMessage: `Opaline can read the thread, understand the ask, and draft a useful response`,
        ...
        children: [
          ...
          (0, Q.jsx)(`div`, {
            ...
            children: (0, Q.jsx)(k, {
              ...
              defaultMessage: `Let Opaline use your Mac when it's locked. <a>Learn more</a>`,
            ...
            (0, Q.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, Q.jsx)(`div`, {
                  ...
                  children: (0, Q.jsx)(k, { ...It.opalineChromeDescription }),
                }),
              ],
            }),
          ],
      ...
      try {
        ...
        try {
          ((_ = await U.mutateAsync(h)),
            s.origin === `setup_opaline` &&
              u(
                n,
                d.OPALINE_ONBOARDING_WIZARD_PHASE_PLUGIN_INSTALL,
                o.OPALINE_ONBOARDING_WIZARD_ACTION_COMPLETED,
              ));
        } catch (e) {

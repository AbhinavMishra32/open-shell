...
var t = e({
  ...
  n = {
    customInstructions: `settings-search-custom-instructions`,
    memory: `settings-search-memory`,
  },
  r = e({
    agentsMd: {
      id: `settings.search.customInstructions.agentsMdTerm`,
      defaultMessage: `AGENTS.md`,
      description: `Settings search term for custom instructions settings`,
    },
    memories: {
      id: `settings.search.memory.memoriesTerm`,
      defaultMessage: `Memories`,
      description: `Settings search term for memory settings`,
    },
  }),
  i = [
    {
      label: t.customInstructions,
      sectionSlug: `personalization`,
      targetId: n.customInstructions,
      terms: [r.agentsMd],
    },
  ],
  a = {
    ...
    sectionSlug: `personalization`,
    targetId: n.memory,
    terms: [r.memories, t.enableMemories, t.skipToolAssistedChats, t.resetMemories],
  };
export { t as i, i as n, n as r, a as t };
//# sourceMappingURL=personalization-settings.search-EJHOL8sG.js.map

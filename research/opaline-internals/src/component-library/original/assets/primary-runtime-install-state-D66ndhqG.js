...
import { W as t, g as n, h as r } from "./vscode-api-sUstfl-x.js";
...
async function h({ hostId: t = e, release: r = `latest` } = {}) {
  let i = m({ hostId: t, release: r }),
    a;
  try {
    (await Promise.race([
      i.then(() => `ready`),
      ...
      (n.warning(`Primary runtime install timed out before first turn`, {
        safe: { timeoutMs: f },
        sensitive: {},
      }),
      i.catch((e) => {
        n.error(`Primary runtime install failed after first-turn timeout`, {
          safe: {},
          sensitive: { error: e },
        });
      }));
  } catch (e) {
    n.error(`Primary runtime install failed before first turn`, {
      safe: {},
      sensitive: { error: e },
    });
  } finally {
...
//# sourceMappingURL=primary-runtime-install-state-D66ndhqG.js.map

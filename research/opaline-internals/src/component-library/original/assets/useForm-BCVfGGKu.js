...
function d(e) {
  let t = Array.from(e).sort((e, t) =>
    e instanceof v && e.options.deps.includes(t)
      ? 1
      : t instanceof v && t.options.deps.includes(e)
        ? -1
        : 0,
  );
  for (let e of t) {
    if (o.current.includes(e)) continue;
    (o.current.push(e), e.recompute());
    let t = a.get(e);
    if (t)
      for (let e of t) {
        let t = i.get(e);
...
function m(e) {
  if ((c > 0 && !u.has(e) && u.set(e, e.prevState), l.add(e), !(c > 0) && !s))
    try {
      for (s = !0; l.size > 0; ) {
        let e = Array.from(l);
        l.clear();
        for (let t of e) ((t.prevState = u.get(t) ?? t.prevState), f(t));
        for (let t of e) {
          let e = i.get(t);
          e && (o.current.push(t), d(e));
        }
        for (let t of e) {
          let e = i.get(t);
          if (e) for (let t of e) p(t);
        }
      }
    } finally {
      ((s = !1), (o.current = []), u.clear());
    }
}
function h(e) {
  c++;
    ...
    registerOnGraph(t = this.options.deps) {
      for (let n of t)
        if (n instanceof e) (n.registerOnGraph(), this.registerOnGraph(n.options.deps));
          ...
          let e = i.get(n);
          (e || ((e = new Set()), i.set(n, e)), e.add(this));
          let t = a.get(this);
          (t || ((t = new Set()), a.set(this, t)), t.add(n));
        }
    }
...
function T(e, t, n) {
  let r = O(t);
  function i(e) {
    if (!r.length) return C(n, e);
    let t = r.shift();
    if (typeof t == `string` || (typeof t == `number` && !Array.isArray(e)))
      return typeof e == `object` ? (e === null && (e = {}), { ...e, [t]: i(e[t]) }) : { [t]: i() };
...
function k(e, t) {
  return t.validationLogic({
    ...
    runValidation: (e) =>
      e.validators.filter(Boolean).map((e) => ({ cause: e.cause, validate: e.fn })),
  });
}
function A(e, t) {
  ...
  return t.validationLogic({
    ...
    runValidation: (t) =>
      t.validators.filter(Boolean).map((t) => {
        ...
        return (e === `submit` && (s = 0), { cause: n, validate: t.fn, debounceMs: s });
      }),
  });
}
var j = (e) => !!e && typeof e == `object` && `fields` in e;
function M(e, t) {
  ...
  for (let i of n) if (!r.includes(i) || !M(e[i], t[i])) return !1;
  return !0;
}
var se = ({
    ...
    e
      ...
      : t
        ...
        : n
          ...
          : { newErrorValue: void 0, newSource: void 0 },
  ce = ({ formLevelError: e, fieldLevelError: t }) =>
    t
...
for (var P = 256, F = [], I; P--; ) F[P] = (P + 256).toString(16).substring(1);
function le() {
  let e = 0,
    t,
    n = ``;
  if (!I || P + 16 > 256) {
    for (I = Array(256), e = 256; e--; ) I[e] = (256 * Math.random()) | 0;
    ((e = 0), (P = 0));
  }
  for (; e < 16; e++)
    ((t = I[P + e]),
      e === 6 ? (n += F[(t & 15) | 64]) : e === 8 ? (n += F[(t & 63) | 128]) : (n += F[t]),
      e & 1 && e > 1 && e < 11 && (n += `-`));
  return (P++, n);
}
var ue = b((e) => S.emit(`form-state`, { id: e.formId, state: e.store.state }), { wait: 300 }),
  L = (e) => {
    ...
    let t = e.event.async,
      ...
      i = { fn: t ? e.validators.onBlurAsync : e.validators.onBlur, cause: `blur` },
      a = { fn: t ? e.validators.onSubmitAsync : e.validators.onSubmit, cause: `submit` },
...
var R = (e, t) => {
  ...
  z = {
    validate({ value: e, validationSource: t }, n) {
      ...
      if (r.issues) return t === `field` ? r.issues : R(r.issues, e);
    },
...
function H(e) {
  ...
  function o(t, n, r, i) {
    ...
    return Object.keys(e.fieldInfo).filter((e) => o.some((t) => e.startsWith(t)));
  }
  function s(e, t) {
  ...
  let l = () => V;
  return { handleArrayMove: t, handleArrayRemove: n, handleArraySwap: r, handleArrayInsert: i };
}
function U(e) {
  return {
    values: e.values ?? {},
...
var W = class {
    ...
    ((this.options = {}),
      ...
      (this.mount = () => {
        let e = this.fieldMetaDerived.mount(),
          ...
          i = S.on(`request-form-reset`, (e) => {
            e.payload.id === this._formId && this.reset();
          }),
          a = S.on(`request-form-force-submit`, (e) => {
            e.payload.id === this._formId &&
          ...
          o = () => {
            (a(), i(), r(), n(), e(), t(), S.emit(`form-unmounted`, { id: this._formId }));
          };
        this.options.listeners?.onMount?.({ formApi: this });
        let { onMount: s } = this.options.validators || {};
        return (
          S.emit(`form-api`, { id: this._formId, state: this.store.state, options: this.options }),
      ...
      (this.update = (e) => {
        ...
        let t = this.options;
        this.options = e;
        let n = !!e.transform?.deps?.some((e, t) => e !== this.prevTransformArray[t]),
          r = e.defaultValues && !M(e.defaultValues, t.defaultValues) && !this.state.isTouched,
          i = !M(e.defaultState, t.defaultState) && !this.state.isTouched;
        (!r && !i && !n) ||
          (h(() => {
      ...
      (this.reset = (e, t) => {
        ...
        (e && !t?.keepDefaultValues && (this.options = { ...this.options, defaultValues: e }),
          this.baseStore.setState(() =>
            U({
              ...this.options.defaultState,
              values: e ?? this.options.defaultValues ?? this.options.defaultState?.values,
              fieldMetaBase: r,
            }),
          ));
      }),
        ...
        return (
          h(() => {
            Object.values(this.fieldInfo).forEach((n) => {
              ...
              let r = n.instance;
              (t.push(Promise.resolve().then(() => r.validate(e, { skipFormValidation: !0 }))),
      ...
      (this.validateField = (e, t) => {
        ...
        return n
          ? (n.state.meta.isTouched || n.setMeta((e) => ({ ...e, isTouched: !0 })), n.validate(t))
          : [];
      }),
      (this.validateSync = (e) => {
        let t = k(e, {
            ...this.options,
            form: this,
            validationLogic: this.options.validationLogic || L,
          }),
          n = !1,
          r = {};
        return (
          h(() => {
            for (let e of t) {
              ...
              let { formError: t, fieldErrors: i } = G(
                ...
                a = K(e.cause),
                o = new Set([...Object.keys(this.state.fieldMeta), ...Object.keys(i || {})]);
              for (let e of o) {
                if (this.baseStore.state.fieldMetaBase[e] === void 0 && !i?.[e]) continue;
                let { errorMap: t, errorSourceMap: n } = this.getFieldMeta(e) ?? V,
                  o = i?.[e],
                  { newErrorValue: s, newSource: c } = se({
              ...
              (this.state.errorMap?.[a] !== t &&
                this.baseStore.setState((e) => ({ ...e, errorMap: { ...e.errorMap, [a]: t } })),
                (t || i) && (n = !0));
            }
            let i = K(`submit`);
            this.state.errorMap?.[i] &&
              e !== `submit` &&
              !n &&
              this.baseStore.setState((e) => ({ ...e, errorMap: { ...e.errorMap, [i]: void 0 } }));
            let a = K(`server`);
            this.state.errorMap?.[a] &&
              e !== `server` &&
              !n &&
              this.baseStore.setState((e) => ({ ...e, errorMap: { ...e.errorMap, [a]: void 0 } }));
          }),
      ...
      (this.validateAsync = async (e) => {
              ...
              new Promise(async (t) => {
                ...
                for (let e of Object.keys(this.state.fieldMeta)) {
                  ...
                  let { errorMap: n, errorSourceMap: i } = t,
                    a = r?.[e],
                    { newErrorValue: o, newSource: c } = se({
                ...
                (this.baseStore.setState((e) => ({ ...e, errorMap: { ...e.errorMap, [s]: a } })),
        ...
        if (n.length) {
          ...
          for (let e of i)
            if (e?.fieldErrors) {
              let { errorMapKey: t } = e;
              for (let [n, r] of Object.entries(e.fieldErrors)) a[n] = { ...(a[n] || {}), [t]: r };
            }
        }
        return (this.baseStore.setState((e) => ({ ...e, isFormValidating: !1 })), a);
      }),
      (this.validate = (e) => {
      ...
      (this._handleSubmit = async (e) => {
        ...
        if (!this.state.canSubmit && !this._devtoolsSubmissionOverride) {
          this.options.onSubmitInvalid?.({ value: this.state.values, formApi: this, meta: t });
          return;
        }
        ...
        try {
          (await this.options.onSubmit?.({ value: this.state.values, formApi: this, meta: t }),
            h(() => {
              (this.baseStore.setState((e) => ({ ...e, isSubmitted: !0, isSubmitSuccessful: !0 })),
                S.emit(`form-submission`, {
                  id: this._formId,
                  submissionAttempt: this.state.submissionAttempts,
                  successful: !0,
      ...
      (this.getFieldValue = (e) => w(this.state.values, e)),
      ...
      (this.setFieldMeta = (e, t) => {
        this.baseStore.setState((n) => ({
          ...n,
          fieldMetaBase: { ...n.fieldMetaBase, [e]: C(t, n.fieldMetaBase[e]) },
        }));
      }),
      ...
      (this.setFieldValue = (e, t, n) => {
        ...
        (h(() => {
          (r ||
            ...
            this.baseStore.setState((n) => ({ ...n, values: T(n.values, e, t) })));
        }),
      ...
      (this.deleteField = (e) => {
        ...
        this.baseStore.setState((e) => {
          ...
          return (
            t.forEach((e) => {
              ((n.values = ee(n.values, e)), delete this.fieldInfo[e], delete n.fieldMetaBase[e]);
            }),
            n
          );
        });
      ...
      (this.removeFieldValue = async (e, t, n) => {
        let r = this.getFieldValue(e),
          i = Array.isArray(r) ? Math.max(r.length - 1, 0) : null;
        if (
          (this.setFieldValue(e, (e) => e.filter((e, n) => n !== t), N(n, { dontValidate: !0 })),
          H(this).handleArrayRemove(e, t),
          i !== null)
        ) {
          let t = `${e}[${i}]`;
          this.deleteField(t);
      ...
      (this.swapFieldValues = (e, t, n, r) => {
        (this.setFieldValue(
          ...
          (e) => {
            let r = e[t],
              i = e[n];
            return T(T(e, `${t}`, i), `${n}`, r);
          },
          N(r, { dontValidate: !0 }),
        ),
          H(this).handleArraySwap(e, t, n),
          (r?.dontValidate ?? !1) ||
      ...
      (this.clearFieldValues = (e, t) => {
        ...
        if ((this.setFieldValue(e, [], N(t, { dontValidate: !0 })), r !== null))
          for (let t = 0; t <= r; t++) {
            let n = `${e}[${t}]`;
            this.deleteField(n);
          }
      ...
      (this.resetField = (e) => {
        this.baseStore.setState((t) => ({
          ...t,
          fieldMetaBase: { ...t.fieldMetaBase, [e]: V },
          values: this.options.defaultValues
            ? T(t.values, e, w(this.options.defaultValues, e))
            : t.values,
        }));
      }),
      (this.setErrorMap = (e) => {
        h(() => {
          Object.entries(e).forEach(([e, t]) => {
            ...
            if (j(t)) {
              ...
              this.baseStore.setState((t) => ({ ...t, errorMap: { ...t.errorMap, [n]: e } }));
            } else this.baseStore.setState((e) => ({ ...e, errorMap: { ...e.errorMap, [n]: t } }));
          });
        });
      }),
      (this.getAllErrors = () => ({
      ...
      (this.parseValuesWithSchema = (e) =>
        z.validate({ value: this.state.values, validationSource: `form` }, e)),
      (this.parseValuesWithSchemaAsync = (e) =>
        z.validateAsync({ value: this.state.values, validationSource: `form` }, e)),
      (this.timeoutIds = { validations: {}, listeners: {}, formListeners: {} }),
      (this._formId = e?.formId ?? le()),
      (this._devtoolsSubmissionOverride = !1),
      (this.baseStore = new _(
        U({ ...e?.defaultState, values: e?.defaultValues ?? e?.defaultState?.values }),
      )),
      (this.fieldMetaDerived = new v({
        deps: [this.baseStore],
        fn: ({ prevDepVals: e, currDepVals: t, prevVal: n }) => {
          ...
          for (let e of Object.keys(a.fieldMetaBase)) {
            ...
            if (!n || t.errorMap !== n.errorMap) {
              u = Object.values(t.errorMap ?? {}).filter((e) => e !== void 0);
            ...
            let d = !oe(u),
              f = !t.isDirty,
              p =
                M(l, w(this.options.defaultValues, e)) ||
                M(l, this.getFieldInfo(e)?.instance?.options.defaultValue);
            if (
              c &&
              c.isPristine === f &&
              c.isValid === d &&
            ...
            s[e] = { ...t, errors: u ?? [], isPristine: f, isValid: d, isDefaultValue: p };
          }
      ...
      (this.store = new v({
        ...
        fn: ({ prevDepVals: e, currDepVals: t, prevVal: n }) => {
          let r = n,
            ...
            h = !m,
            g = !!(a.errorMap?.onMount || s.some((e) => e?.errorMap?.onMount)),
            _ = !!c,
            v = r?.errors ?? [];
          (!i || a.errorMap !== i.errorMap) &&
            (v = Object.values(a.errorMap).reduce(
              (e, t) => (t === void 0 ? e : t && j(t) ? (e.push(t.form), e) : (e.push(t), e)),
              [],
            ));
          let y = v.length === 0,
            b = l && y,
            x = this.options.canSubmitWhenInvalid ?? !1,
            S = (a.submissionAttempts === 0 && !u && !g) || (!_ && !a.isSubmitting && b) || x,
            C = a.errorMap;
          if (
            (p &&
          ...
          if (
            ...
            (this.options.transform?.fn(e), (w = e.state), (this.prevTransformArray = T));
          }
          return w;
        },
      })),
  ...
  runValidator(e) {
    return B(e.validate) ? z[e.type](e.value, e.validate) : e.validate(e.value);
  }
  handleSubmit(e) {
  ...
  constructor(e) {
    ((this.options = {}),
      (this.mount = () => {
        ...
        return (this.options.listeners?.onMount?.({ value: this.state.value, fieldApi: this }), e);
      }),
      (this.update = (e) => {
        ((this.options = e),
          (this.name = e.name),
          !this.state.meta.isTouched &&
            this.options.defaultValue !== void 0 &&
            (M(this.form.getFieldValue(this.name), e.defaultValue) ||
      ...
      (this.setValue = (e, t) => {
        (this.form.setFieldValue(this.name, e, N(t, { dontRunListeners: !0, dontValidate: !0 })),
      ...
      (this.pushValue = (e, t) => {
        (this.form.pushFieldValue(this.name, e, N(t, { dontRunListeners: !0 })),
          t?.dontRunListeners || this.triggerOnChangeListener());
      }),
      (this.insertValue = (e, t, n) => {
        (this.form.insertFieldValue(this.name, e, t, N(n, { dontRunListeners: !0 })),
          n?.dontRunListeners || this.triggerOnChangeListener());
      }),
      (this.replaceValue = (e, t, n) => {
        (this.form.replaceFieldValue(this.name, e, t, N(n, { dontRunListeners: !0 })),
          n?.dontRunListeners || this.triggerOnChangeListener());
      }),
      (this.removeValue = (e, t) => {
        (this.form.removeFieldValue(this.name, e, N(t, { dontRunListeners: !0 })),
          t?.dontRunListeners || this.triggerOnChangeListener());
      }),
      (this.swapValues = (e, t, n) => {
        (this.form.swapFieldValues(this.name, e, t, N(n, { dontRunListeners: !0 })),
          n?.dontRunListeners || this.triggerOnChangeListener());
      }),
      (this.moveValue = (e, t, n) => {
        (this.form.moveFieldValues(this.name, e, t, N(n, { dontRunListeners: !0 })),
          n?.dontRunListeners || this.triggerOnChangeListener());
      }),
      (this.clearValues = (e) => {
        (this.form.clearFieldValues(this.name, N(e, { dontRunListeners: !0 })),
      ...
      (this.validateSync = (e, t) => {
        let n = k(e, {
            ...this.options,
            form: this.form,
            validationLogic: this.form.options.validationLogic || L,
          }),
          r = this.getLinkedFields(e).reduce((t, n) => {
            let r = k(e, {
              ...n.options,
              form: n.form,
              validationLogic: n.form.options.validationLogic || L,
            });
            return (
              r.forEach((e) => {
                e.field = n;
            ...
            let r = Y(n.cause),
              a = n.validate
                ? J(
                    e.runValidator({
                      validate: n.validate,
                      value: { value: e.store.state.value, validationSource: `field`, fieldApi: e },
                      type: `validate`,
                    }),
                  )
                : void 0,
              o = t[r],
              { newErrorValue: s, newSource: c } = ce({ formLevelError: o, fieldLevelError: a });
      ...
      (this.validateAsync = async (e, t) => {
        ...
        if (c) {
          this.state.meta.isValidating || this.setMeta((e) => ({ ...e, isValidating: !0 }));
        ...
        let l = (e, t, n) => {
          ...
          ((this.getInfo().validationMetaMap[i] = { lastAbortController: a }),
            n.push(
              new Promise(async (n) => {
                let o;
                try {
                  o = await new Promise((n, r) => {
                    (this.timeoutIds.validations[t.cause] &&
                      ...
                      (this.timeoutIds.validations[t.cause] = setTimeout(async () => {
                ...
                let s = J(o),
                  c = r[this.name]?.[i],
                  { newErrorValue: l, newSource: u } = ce({
                    formLevelError: c,
                    fieldLevelError: s,
                  });
                (e.setMeta((e) => ({
      ...
      (this.handleBlur = () => {
        (this.state.meta.isTouched || this.setMeta((e) => ({ ...e, isTouched: !0 })),
      ...
      (this.parseValueWithSchema = (e) =>
        z.validate({ value: this.state.value, validationSource: `field` }, e)),
      (this.parseValueWithSchemaAsync = (e) =>
        z.validateAsync({ value: this.state.value, validationSource: `field` }, e)),
      ...
      (this.store = new v({
        ...
        fn: ({ prevVal: t }) => {
          let n = t,
            r = this.form.getFieldMeta(this.name) ?? { ...V, ...e.defaultMeta },
            i = this.form.getFieldValue(this.name);
          return (
            !r.isTouched &&
              i === void 0 &&
              this.options.defaultValue !== void 0 &&
              !M(i, this.options.defaultValue) &&
...
function X(e, t = (e) => e, n = {}) {
  let r = n.equal ?? ge;
  return (0, he.useSyncExternalStoreWithSelector)(
    e.subscribe,
    () => e.state,
    () => e.state,
    t,
...
function ge(e, t) {
  ...
  if (e instanceof Date && t instanceof Date) return e.getTime() === t.getTime();
  let n = _e(e);
  if (n.length !== _e(t).length) return !1;
...
var Z = e(n(), 1),
  Q = typeof window < `u` ? Z.useLayoutEffect : Z.useEffect,
  $ = r();
function ve(e) {
  let [t, n] = (0, Z.useState)(() => ({ form: e.form, name: e.name })),
    [r, i] = (0, Z.useState)(() => new q({ ...e }));
  (t.form !== e.form || t.name !== e.name) &&
    (i(new q({ ...e })), n({ form: e.form, name: e.name }));
  let a = X(
      r.store,
      e.mode === `array` ? (e) => Object.keys(e.value ?? []).length : (e) => e.value,
    ),
    o = X(r.store, (e) => e.meta.isTouched),
    s = X(r.store, (e) => e.meta.isBlurred),
    c = X(r.store, (e) => e.meta.isDirty),
    l = X(r.store, (e) => e.meta.errorMap),
    u = X(r.store, (e) => e.meta.errorSourceMap),
    d = X(r.store, (e) => e.meta.isValidating),
    f = (0, Z.useMemo)(() => {
      let t = {
        ...r,
        get state() {
...
var ye = ({ children: e, ...t }) => {
  let n = ve(t);
  return (0, $.jsx)($.Fragment, { children: (0, Z.useMemo)(() => C(e, n), [e, n]) });
};
function be() {
  return (0, Z.useState)(() => le())[0];
}
var xe = `19.2.5`.split(`.`)[0] === `17` ? be : Z.useId;
function Se({ form: e, selector: t, children: n }) {
  return (0, $.jsx)($.Fragment, { children: C(n, X(e.store, t)) });
}
function Ce(e) {
  let t = xe(),
    [n, r] = (0, Z.useState)(e?.formId),
    [i, a] = (0, Z.useState)(() => new W({ ...e, formId: e?.formId ?? t }));
  if (n !== e?.formId) {
    let n = e?.formId ?? t;
    (a(new W({ ...e, formId: n })), r(n));
  }
  let o = (0, Z.useMemo)(() => {
    let e = {
      ...i,
    ...
    return (
      (e.Field = function (e) {
        return (0, $.jsx)(ye, { ...e, form: i });
      }),
      (e.Subscribe = function (e) {
        return (0, $.jsx)(Se, { form: i, selector: e.selector, children: e.children });
      }),
      e
    );
  }, [i]);
...
export { Ce as t };
//# sourceMappingURL=useForm-BCVfGGKu.js.map

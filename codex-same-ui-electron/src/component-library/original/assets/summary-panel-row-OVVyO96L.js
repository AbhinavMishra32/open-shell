...
function a(e) {
  ...
  let E = b === void 0 ? !1 : b,
    ...
    j = !d && A,
    M = !d && (E || A),
    N = M ? `cursor-interaction text-token-foreground` : `text-token-text-secondary`,
    P =
      M &&
  ...
  let L = I,
    R = m ?? `truncate`,
    z;
  n[25] === R ? (z = n[26]) : ((z = t(`text-base`, R)), (n[25] = R), (n[26] = z));
  let B;
  n[27] !== p || n[28] !== z
  ...
  let W;
  n[43] !== f || n[44] !== U
    ? ((W = (0, i.jsxs)(i.Fragment, { children: [f, U] })), (n[43] = f), (n[44] = U), (n[45] = W))
    : (W = n[45]);
  let G = W,
    K = d || void 0,
    q = c ?? l,
  ...
  n[46] !== d || n[47] !== j || n[48] !== h || n[49] !== g
    ? ((Y = (e) => {
        (d || g?.(e),
          !(!j || h == null || e.defaultPrevented || (e.key !== `Enter` && e.key !== ` `)) &&
...
export { a as t };
//# sourceMappingURL=summary-panel-row-OVVyO96L.js.map

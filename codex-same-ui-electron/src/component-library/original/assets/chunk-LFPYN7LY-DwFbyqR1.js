...
var r = e(n(), 1),
  i = ((e) => ((e.Pop = `POP`), (e.Push = `PUSH`), (e.Replace = `REPLACE`), e))(i || {});
function a(e) {
  return (
    typeof e == `object` &&
    !!e &&
...
function o(e = {}) {
  ...
  return {
    ...
    push(e, t) {
      s = `PUSH`;
      let n = a(e) ? e : h(e, t);
      ((o += 1), i.splice(o, i.length, n), r && l && l({ action: s, location: n, delta: 1 }));
    },
    replace(e, t) {
      s = `REPLACE`;
      let n = a(e) ? e : h(e, t);
...
function g(e, t = [], n = [], r = ``, i = !1) {
  let a = (e, a, o = i, c) => {
    ...
    (e.children &&
      ...
      !(e.path == null && !e.index) && t.push({ path: u, score: ee(u, e.index), routesMeta: d }));
  };
  return (
    e.forEach((e, t) => {
...
function ee(e, t) {
  ...
  return (
    n.some(T) && (r += w),
    t && (r += x),
    n.filter((e) => !T(e)).reduce((e, t) => e + (y.test(t) ? b : t === `` ? S : C), r)
  );
}
function te(e, t) {
...
function ne(e, t, n = !1) {
  ...
  for (let e = 0; e < r.length; ++e) {
    let s = r[e],
      ...
      u = E({ path: s.relativePath, caseSensitive: s.caseSensitive, end: c }, l),
      d = s.route;
    if (
      (!u &&
        c &&
        ...
        (u = E({ path: s.relativePath, caseSensitive: s.caseSensitive, end: !1 }, l)),
      !u)
    )
      return null;
...
var ie = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;
function ae(e, t = `/`) {
  let { pathname: n, search: r = ``, hash: i = `` } = typeof e == `string` ? f(e) : e,
    a;
  return (
    n
      ? ((n = n.replace(/\/\/+/g, `/`)),
...
function k(e, t, n, r = !1) {
  ...
  typeof e == `string`
    ? (i = f(e))
    : ((i = { ...e }),
      s(!i.pathname || !i.pathname.includes(`?`), se(`?`, `pathname`, `search`, i)),
      s(!i.pathname || !i.pathname.includes(`#`), se(`#`, `pathname`, `hash`, i)),
...
function _e(e, t) {
  let n = e;
  if (typeof n != `string` || !ie.test(n)) return { absoluteURL: void 0, isExternal: !1, to: n };
  let r = n,
    i = !1;
  if (ge)
    try {
...
function L() {
  return (
    s(I(), `useLocation() may be used only in the context of a <Router> component.`),
...
function Ne() {
  s(I(), `useNavigate() may be used only in the context of a <Router> component.`);
  ...
  return (
    ...
    r.useCallback(
      (r, i = {}) => {
        ...
        (e == null && t !== `/` && (s.pathname = s.pathname === `/` ? t : A([t, s.pathname])),
...
function Fe(e) {
  ...
  return r.useMemo(() => t && r.createElement(Pe.Provider, { value: e }, t), [t, e]);
}
function Ie() {
...
function Re(e, t, n) {
  s(I(), `useRoutes() may be used only in the context of a <Router> component.`);
...
Please change the parent <Route path="${e}"> to <Route path="${e === `/` ? `*` : `${e}/*`}">.`,
  ...
  (c(m || y != null, `No routes matched location "${g.pathname}${g.search}${g.hash}" `),
    c(
      y == null ||
      ...
      y.map((e) =>
        Object.assign({}, e, {
          ...
          pathname: A([
            d,
            i.encodeLocation
              ? i.encodeLocation(e.pathname.replace(/\?/g, `%3F`).replace(/#/g, `%23`)).pathname
              : e.pathname,
          ]),
          pathnameBase:
            e.pathnameBase === `/`
              ...
              : A([
                  d,
                  i.encodeLocation
                    ? i.encodeLocation(e.pathnameBase.replace(/\?/g, `%3F`).replace(/#/g, `%23`))
                        .pathname
                    : e.pathnameBase,
                ]),
        }),
...
function ze() {
  let e = Xe(),
    t = me(e) ? `${e.status} ${e.statusText}` : e instanceof Error ? e.message : JSON.stringify(e),
      ...
      let t =
        e === void 0
          ...
          : r.createElement(
              ...
              r.createElement(Se.Provider, { value: e, children: this.props.component }),
            );
  ...
  if (n && i) {
    ...
    for (let e = 0; e < a.length; e++) {
      ...
      if (((t.route.HydrateFallback || t.route.hydrateFallbackElement) && (l = e), t.route.id)) {
        ...
        if (t.route.lazy || o) {
          (n.isStatic && (c = !0), (a = l >= 0 ? a.slice(0, l + 1) : [a[0]]));
          break;
        }
      }
    }
      ...
      c &&
        (l < 0 && s === 0
          ? ($e(
            ...
            (f = !0),
            (m = null))
          : l === s && ((f = !0), (m = n.route.hydrateFallbackElement || null))));
        ...
        return (
          (t = u
            ...
            : f
              ? m
              : n.route.Component
                ? r.createElement(n.route.Component, null)
                : n.route.element
                  ? n.route.element
                  : e),
          r.createElement(Ue, {
...
function nt({ to: e, replace: t, state: n, relative: i }) {
  ...
  return (
    r.useEffect(() => {
      u(JSON.parse(f), { replace: t, state: n, relative: i });
    }, [u, f, i, t, n]),
    null
  );
}
...
function at({
  ...
  let u = e.replace(/^\/*/, `/`),
    d = r.useMemo(
      () => ({ basename: u, navigator: a, static: o, unstable_useTransitions: l, future: {} }),
      [u, a, o, l],
    );
  ...
  let {
    ...
    y = r.useMemo(() => {
      ...
      return e == null
        ? null
        : {
            location: { pathname: e, search: m, hash: h, state: g, key: _, unstable_mask: v },
            navigationType: i,
          };
    }, [u, p, m, h, g, _, i, v]);
  return (
...
function _t(e, t) {
  ...
  if (lt(e)) {
    ...
    if (
      ...
      (i = gt(e.getAttribute(`formenctype`)) || gt(o.getAttribute(`enctype`)) || K),
      (a = new FormData(o, e)),
      !mt())
    ) {
...
function Nt() {
  ...
  return (
    xt(e, `You must render this element inside a <DataRouterStateContext.Provider> element`),
    e
  );
}
...
function Rt({ page: e, matches: t, ...n }) {
  ...
  return r.createElement(
    r.Fragment,
    null,
    p.map((e) => r.createElement(`link`, { key: e, rel: `prefetch`, as: `fetch`, href: e, ...n })),
    m.map((e) => r.createElement(`link`, { key: e, rel: `modulepreload`, href: e, ...n })),
    h.map(({ key: e, link: t }) =>
...
function Vt({ basename: e, children: t, history: n, unstable_useTransitions: i }) {
  let [a, o] = r.useState({ action: n.action, location: n.location }),
    s = r.useCallback(
      (e) => {
...
var Ht = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Ut = r.forwardRef(function (
    ...
    let { basename: g, navigator: _, unstable_useTransitions: v } = r.useContext(N),
    ...
    return w && !y ? r.createElement(r.Fragment, null, D, r.createElement(It, { page: x })) : D;
  });
Ut.displayName = `Link`;
var Wt = r.forwardRef(function (
  ...
  return r.createElement(
    Ut,
    { ...l, "aria-current": w, className: T, ref: u, style: ee, to: o, viewTransition: s },
...
function $(e, t, n, r) {
  let i = null;
  return (
    r && (i = r(n === `/` ? e : { ...e, pathname: O(e.pathname, n) || e.pathname }, t)),
    (i ??= e.key),
    i
  );
}
function rn({ getKey: e, storageKey: t } = {}) {
  let { router: n } = Jt(`useScrollRestoration`),
    { restoreScrollPosition: i, preventScrollReset: a } = Yt(`useScrollRestoration`),
...
//# sourceMappingURL=chunk-LFPYN7LY-DwFbyqR1.js.map

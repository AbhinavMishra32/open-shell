...
function s(e) {
  ...
  n[0] === e
    ...
    : (({
      ...
      (n[11] = _));
  let v = m === void 0 ? !1 : m,
    y = h === void 0 ? `default` : h,
    b = a[y],
    x = o[y],
    S = l ? `checked` : `unchecked`,
    C;
  n[12] !== l || n[13] !== v || n[14] !== f
    ? ((C = () => {
        v || f(!l);
      }),
      (n[12] = l),
  ...
  n[16] !== w || n[17] !== p
    ...
    : (T = n[18]);
  let E = T,
    D = v ? `cursor-not-allowed opacity-60` : `cursor-interaction`,
    O;
  n[19] !== u || n[20] !== D
    ? ((O = t(
      ...
      (n[21] = O))
    : (O = n[21]);
  let k = l ? `bg-token-charts-blue` : `bg-token-foreground/10`,
    A;
  n[22] !== k || n[23] !== _ || n[24] !== b
    ? ((A = t(
  ...
  let M;
  n[29] !== S || n[30] !== j
    ? ((M = (0, i.jsx)(`span`, { className: j, "data-state": S })),
      (n[29] = S),
      (n[30] = j),
      (n[31] = M))
    : (M = n[31]);
  let N;
  n[32] !== S || n[33] !== M || n[34] !== A
    ? ((N = (0, i.jsx)(`span`, { className: A, "data-state": S, children: M })),
      (n[32] = S),
      (n[33] = M),
      (n[34] = A),
      (n[35] = N))
...
export { s as t };
//# sourceMappingURL=toggle-CHrq20xd.js.map

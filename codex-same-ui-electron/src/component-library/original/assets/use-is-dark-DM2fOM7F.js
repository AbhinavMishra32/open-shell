...
function f(e) {
  if (e.type === `childList`) {
    ...
    for (let n of Array.from(e.addedNodes))
      n instanceof HTMLLinkElement && n.rel === `stylesheet` && (d(n), (t = !0));
    (e.removedNodes.length > 0 || !t) && u();
    return;
  }
  if (e.type === `attributes`) {
    ...
    if (
      ...
      t.rel === `stylesheet` &&
      (e.attributeName === `href` || e.attributeName === `media` || e.attributeName === `rel`)
    ) {
      d(t);
      return;
    }
...
function p() {
  ...
  (u(),
    ...
    o.observe(document.documentElement, { attributes: !0, attributeFilter: [`class`, `style`] }));
  let e = document.head;
  (e &&
    ...
    typeof window < `u` &&
      ...
      ((c = window.matchMedia(`(prefers-color-scheme: dark)`)), c.addEventListener(`change`, u)));
}
function m() {
  (o?.disconnect(),
    s?.disconnect(),
...
function _() {
  return (0, n.useSyncExternalStore)(h, g, g);
}
function v(e, t, n) {
  let r = (e) => {
      let t = e / 255;
...
function y(e) {
  ...
  if (t.startsWith(`#`)) {
    ...
    return e.length === 3 || e.length === 4
      ? { r: parseInt(n(e[0]), 16), g: parseInt(n(e[1]), 16), b: parseInt(n(e[2]), 16) }
...
function w() {
  ...
  if (!e) return null;
  let t = y(e);
  return t ? v(t.r, t.g, t.b) < r : null;
}
export { _ as t };
//# sourceMappingURL=use-is-dark-DM2fOM7F.js.map

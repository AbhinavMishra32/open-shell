...
import { t as He } from "./codex-analytics-attribution-BanxoePb.js";
...
var Z = k(`LocalGitActionsScope`, {
  ...
  an = E(Z, ({ get: e }) => {
    let t = e(Yt);
    return t.codexWorktree && e(Ht, t).isLoading;
  });
function on(e) {
  if (e.get(en)) {
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: async (i, a) => {
          ...
          ce(n, { eventName: `codex_git_commit_succeeded` });
  ...
  Gn = S(
    ...
    (e, { scope: t }) => ({
      ...
      onSuccess: async (n, r) => {
        ...
        ce(t, { eventName: `codex_git_create_pr_succeeded` });
  ...
  Kn = S(
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: (i, a) => {
          i.status === `success` &&
            (ce(n, { eventName: `codex_git_push_succeeded`, metadata: { forced: a.force ?? !1 } }),
...
function Qn(e) {
  if (n(e, `codex_git_commit`) !== !0) return null;

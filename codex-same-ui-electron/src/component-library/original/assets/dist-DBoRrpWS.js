...
import { c as r, d as i, i as a, n as o, o as s, t as c, u as l } from "./dist-B8SKCozm.js";
import { a as u, i as d, n as f, o as p, r as m, s as h, t as g } from "./Combination-9DfZp13g.js";
import { a as _, i as v, n as y, r as b, t as x } from "./dist-DXUvl421.js";
var S = e(t(), 1),
  C = n(),
  w = `Popover`,
  [T, ee] = r(w, [_]),
  ...
  k = (e) => {
    let {
      ...
      l = S.useRef(null),
      [u, f] = S.useState(!1),
      [p, m] = c({ prop: r, defaultProp: i ?? !1, onChange: a, caller: w });
    return (0, C.jsx)(v, {
      ...s,
      children: (0, C.jsx)(D, {
        scope: t,
...
var A = `PopoverAnchor`,
  j = S.forwardRef((e, t) => {
    ...
    return (S.useEffect(() => (o(), () => s()), [o, s]), (0, C.jsx)(x, { ...a, ...r, ref: t }));
  });
j.displayName = A;
var M = `PopoverTrigger`,
  N = S.forwardRef((e, t) => {
    ...
    return o.hasCustomAnchor ? u : (0, C.jsx)(x, { asChild: !0, ...s, children: u });
  });
N.displayName = M;
var P = `PopoverPortal`,
  [F, I] = T(P, { forceMount: void 0 }),
  L = (e) => {
    ...
    return (0, C.jsx)(F, {
      ...
      children: (0, C.jsx)(o, {
        present: n || a.open,
        children: (0, C.jsx)(m, { asChild: !0, container: i, children: r }),
      }),
    });
  };
L.displayName = P;
var R = `PopoverContent`,
  z = S.forwardRef((e, t) => {
    let n = I(R, e.__scopePopover),
      { forceMount: r = n.forceMount, ...i } = e,
      a = O(R, e.__scopePopover);
    return (0, C.jsx)(o, {
      present: r || a.open,
      children: a.modal ? (0, C.jsx)(V, { ...i, ref: t }) : (0, C.jsx)(H, { ...i, ref: t }),
    });
  });
z.displayName = R;
var B = s(`PopoverContent.RemoveScroll`),
  V = S.forwardRef((e, t) => {
    let n = O(R, e.__scopePopover),
      r = S.useRef(null),
      a = l(t, r),
      o = S.useRef(!1);
    return (
...
var Y = k,
  ...
  Q = z,
  $ = G;
export { X as a, Y as i, Q as n, Z as r, $ as t };
//# sourceMappingURL=dist-DBoRrpWS.js.map

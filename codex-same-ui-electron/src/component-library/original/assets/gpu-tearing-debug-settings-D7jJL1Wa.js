...
function pt(e) {
  ...
  t[19] === d
    ? (D = t[20])
    : ((D = (e) => {
        ee(d, { eventName: `codex_onboarding_external_agent_import_event`, metadata: e });
      }),
      (t[19] = d),
      (t[20] = D));
  let k = D,
...
function ht({
  ...
  let o = m(_),
    ...
    K = et({ items: x.detectedItems, codexHome: e, isEnabled: u }),
    q = (0, J.useMemo)(
      () =>
        Object.fromEntries(
          K.map((e) => {
    ...
    we = async ({ providerIds: n, selection: r }) => {
      ...
      try {
        ...
        ((d = `invalidate_queries`),
          await Promise.all([
            Ce(s),
            s.invalidateQueries({ queryKey: b(`codex-agents-md`) }),
            n.length === 0
              ? Promise.resolve()
...
function _t(e) {
  let t = (0, Z.c)(13),
    { artifacts: n, codexHome: r, disabled: i, onCheckedChange: a, selectedArtifactKeys: o } = e,
    s;
...
function yt({ codexHome: e, progress: t, onMigrateRemainingArtifacts: n, onClose: r }) {
  let i = x(),
    [a, o] = (0, J.useState)(!1),
    s = (0, J.useRef)(null),
    [c, l] = (0, J.useState)(!1),
            ...
            children: [
              ...
              !f && t != null && t.items.length > 0
                ? (0, Y.jsx)(V, {
                    ...
                    children: (0, Y.jsx)(Et, { codexHome: e, items: t.items, status: t.status }),
                  })
                : null,
              !u && d.length > 0
                ? (0, Y.jsxs)(Y.Fragment, {
        ...
        e.length > 0
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
                ...
                e.map((e) => (0, Y.jsx)(kt, { codexHome: n, item: e, status: i }, Vt(e))),
              ],
            })
          : null),
      (s =
        c.length > 0
          ? (0, Y.jsxs)(Y.Fragment, {
              children: [
                ...
                c.map((e) => (0, Y.jsx)(kt, { codexHome: n, item: e, status: i }, Vt(e))),
              ],
            })
          : null),
      (t[0] = n),

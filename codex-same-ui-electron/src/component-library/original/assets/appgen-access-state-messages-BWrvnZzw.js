...
import { r as n } from "./lib-MoKmYgcO.js";
import { t as r } from "./globe-DyuVFbAy.js";
import { t as i } from "./building-r_Q_yEQG.js";
import { t as a } from "./lock-DV6CP31m.js";
import { t as o } from "./members-DLUwp6q7.js";
import { p as s } from "./appgen-url-BQfPV2YP.js";
var c = t(),
  l = e();
function u(e) {
  let t = (0, c.c)(13),
  ...
  t[0] === e
    ? ((n = t[1]), (u = t[2]))
    : (({ accessPolicy: n, ...u } = e), (t[0] = e), (t[1] = n), (t[2] = u));
  let d;
  t[3] === n ? (d = t[4]) : ((d = s(n)), (t[3] = n), (t[4] = d));
  let { accessMode: f, groupCount: p, userCount: m } = d;
  switch (f) {
    case `admins_only`:
    case `custom`: {
      let e;
      return (
        t[5] !== p || t[6] !== u || t[7] !== m
          ? ((e = m > 0 || p > 0 ? (0, l.jsx)(o, { ...u }) : (0, l.jsx)(a, { ...u })),
            (t[5] = p),
            (t[6] = u),
            (t[7] = m),
            (t[8] = e))
    ...
    case `workspace_all`: {
      let e;
      return (
        t[9] === u ? (e = t[10]) : ((e = (0, l.jsx)(i, { ...u })), (t[9] = u), (t[10] = e)),
        e
      );
    }
    case `public`: {
      let e;
      return (
        t[11] === u ? (e = t[12]) : ((e = (0, l.jsx)(r, { ...u })), (t[11] = u), (t[12] = e)),
        e
      );
    }
  }
...
function _({ accessMode: e, groupCount: t, userCount: n }) {
  switch (e) {
    case `admins_only`:
    case `custom`:
      return n > 0 && t > 0
...
//# sourceMappingURL=appgen-access-state-messages-BWrvnZzw.js.map

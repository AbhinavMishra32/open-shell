...
import { c as i, d as a, i as o, n as s, t as c, u as l } from "./dist-B8SKCozm.js";
import { t as u } from "./dist-BJSWtyeU.js";
import { lt as d } from "./vscode-api-sUstfl-x.js";
import { t as f } from "./check-md-CZTnvSiA.js";
import { t as p } from "./minus-COQFKeWQ.js";
var m = e(t(), 1);
function h(e) {
...
function S(e) {
  let {
    ...
    [p, h] = c({ prop: n, defaultProp: i ?? !1, onChange: l, caller: _ }),
    [v, y] = m.useState(null),
    [x, S] = m.useState(null),
    C = m.useRef(!1),
    w = v ? !!o || !!v.closest(`form`) : !0,
    T = {
      checked: p,
      disabled: a,
      setChecked: h,
  ...
  return (0, g.jsx)(b, { scope: t, ...T, children: A(f) ? f(T) : r });
}
var C = `CheckboxTrigger`,
  w = m.forwardRef(({ __scopeCheckbox: e, onKeyDown: t, onClick: n, ...r }, i) => {
    let {
        control: s,
        value: c,
        disabled: u,
    ...
    return (
      ...
      (0, g.jsx)(o.button, {
        ...
        onClick: a(n, (e) => {
          (h((e) => (j(e) ? !0 : !e)),
            y && v && ((_.current = e.isPropagationStopped()), _.current || e.stopPropagation()));
        }),
      })
    );
  });
w.displayName = C;
var T = m.forwardRef((e, t) => {
  let {
    __scopeCheckbox: n,
    name: r,
    checked: i,
  ...
  return (0, g.jsx)(S, {
    ...
    internal_do_not_use_render: ({ isFormControl: e }) =>
      (0, g.jsxs)(g.Fragment, {
        children: [
          (0, g.jsx)(w, { ...d, ref: t, __scopeCheckbox: n }),
          e && (0, g.jsx)(k, { __scopeCheckbox: n }),
        ],
      }),
  });
});
...
var O = `CheckboxBubbleInput`,
  k = m.forwardRef(({ __scopeCheckbox: e, ...t }, n) => {
    let {
        control: r,
    ...
    m.useEffect(() => {
      ...
      if (S !== a && n) {
        ...
        ((e.indeterminate = j(a)), n.call(e, j(a) ? !1 : a), e.dispatchEvent(t));
      }
    }, [v, S, a, i]);
    let w = m.useRef(j(a) ? !1 : a);
    return (0, g.jsx)(o.input, {
      type: `checkbox`,
      "aria-hidden": !0,
...
function P(e) {
  ...
  t[0] === e
    ...
    : (({ className: i, checked: n, defaultChecked: a, onCheckedChange: o, disabled: c, ...s } = e),
      (t[0] = e),
      (t[1] = n),
      (t[2] = i),
      (t[3] = a),
  ...
  t[12] === n
    ...
    : ((h = (0, g.jsx)(D, {
        ...
        children:
          n === `indeterminate`
            ? (0, g.jsx)(p, { className: `icon-2xs flex-shrink-0` })
            : (0, g.jsx)(f, { className: `icon-xxs flex-shrink-0` }),
      })),
      (t[12] = n),
      (t[13] = h));
  let _;
...
export { P as t };
//# sourceMappingURL=checkbox-Bz6PC7ig.js.map

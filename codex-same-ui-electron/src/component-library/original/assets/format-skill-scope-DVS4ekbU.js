...
var i = e({
  ...
  repo: { id: `skills.scope.team`, defaultMessage: `Team`, description: `Label for team skills` },
  user: {
...
function a({ scope: e, intl: t, repoLabel: r, adminLabel: a }) {
  if (e === `repo`) return r ?? t.formatMessage(i.repo);
  if (e === `admin`) return a ?? t.formatMessage(i.admin);
  let o = i[e];
  return o ? t.formatMessage(o) : n(e, t);
}
function o({ skillPath: e, roots: t, fallbackLabel: n }) {
  let i = t.reduce((t, n) => (e.startsWith(n) && (!t || n.length > t.length) ? n : t), null);
  if (!i) return n;
  let a = r(i);
  return a.length > 0 ? a : n;
}
function s({ skill: e, roots: t, intl: n, fallbackRepoLabel: r, adminLabel: i }) {
  return a({
    scope: e.scope,
    intl: n,
    repoLabel: o({
      skillPath: e.path,
      roots: t,
      fallbackLabel: r ?? a({ scope: `repo`, intl: n }),
    }),
    adminLabel: i,
  });
}
export { o as n, s as r, a as t };
//# sourceMappingURL=format-skill-scope-DVS4ekbU.js.map

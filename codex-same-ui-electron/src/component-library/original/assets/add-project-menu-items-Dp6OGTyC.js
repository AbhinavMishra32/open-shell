...
import { o as i } from "./lib-MoKmYgcO.js";
import { t as a } from "./folder-DTP6uOAM.js";
import { r as o, t as s } from "./dropdown-CHaZfyxI.js";
import { t as c } from "./plus-_AqggHDM.js";
var l = e(t()),
  u = n(),
  d = (e) =>
    (0, u.jsx)(`svg`, {
...
function p(e) {
  ...
  let x;
  return (
    t[5] !== n || t[6] !== d || t[7] !== h || t[8] !== y || t[9] !== b || t[10] !== g
      ? ((x = (0, u.jsxs)(s, {
          triggerButton: g,
          contentWidth: `menu`,
          onOpenChange: d,
...
//# sourceMappingURL=add-project-menu-items-Dp6OGTyC.js.map

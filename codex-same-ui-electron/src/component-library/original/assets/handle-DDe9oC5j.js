...
var n = function (e) {
  ...
  if (typeof e == `object`) return Array.isArray(e) ? r(e) : i(e);
...
function o(e) {
  return t;
  function t(t, n, r) {
    return !!(c(t) && e.call(this, t, typeof n == `number` ? n : void 0, r || void 0));
  }
}
function s() {
  return !0;
...
function d(e, t, r, i) {
  let a;
  typeof t == `function` && typeof r != `function` ? ((i = r), (r = t)) : (a = t);
  let o = n(a),
    s = i ? -1 : 1;
  c(e, void 0, [])();
  function c(e, n, a) {
    let d = e && typeof e == `object` ? e : {};
    if (typeof d.type == `string`) {
      let t =
        typeof d.tagName == `string` ? d.tagName : typeof d.name == `string` ? d.name : void 0;
      Object.defineProperty(p, `name`, {
        value: `node (` + l(e.type + (t ? `<` + t + `>` : ``)) + `)`,
      });
    }
    return p;
    function p() {
      let l = u,
        ...
        p,
        m;
      if ((!t || o(e, n, a[a.length - 1] || void 0)) && ((l = f(r(e, a))), l[0] === !1)) return l;
      if (`children` in e && e.children) {
        let t = e;
        if (t.children && l[0] !== `skip`)
          for (
            p = (i ? t.children.length : -1) + s, m = a.concat(t);
            p > -1 && p < t.children.length;
          ) {
            let e = t.children[p];
            if (((d = c(e, p, m)()), d[0] === !1)) return d;
            p = typeof d[1] == `number` ? d[1] : p + s;
          }
      }
      return l;
    }
...
function f(e) {
  return Array.isArray(e) ? e : typeof e == `number` ? [!0, e] : e == null ? u : [e];
}
function p(e, t, n, r) {
  let i = n.enter(`blockquote`),
    a = n.createTracker(r);
  (a.move(`> `), a.shift(2));
  let o = n.indentLines(n.containerFlow(e, a.current()), m);
  return (i(), o);
}
function m(e, t, n) {
  return `>` + (n ? `` : ` `) + e;
...
function h(e, t) {
  return g(e, t.inConstruct, !0) && !g(e, t.notInConstruct, !1);
}
function g(e, t, n) {
...
function D(e, t, n, r) {
  let i = ee(n),
    ...
    l = c.charCodeAt(0),
    u = E(r.before.charCodeAt(r.before.length - 1), l, i);
  u.inside && (c = T(l) + c.slice(1));
  let d = c.charCodeAt(c.length - 1),
    f = E(r.after.charCodeAt(0), d, i);
  f.inside && (c = c.slice(0, -1) + T(d));
  let p = o.move(i);
  return (
    a(),
...
function A(e, n) {
  ...
  return (
    k(e, function (e) {
      if ((`value` in e && /\r?\n|\r/.test(e.value)) || e.type === `break`) return ((r = !0), !1);
    }),
    !!((!e.depth || e.depth < 3) && t(e) && (n.options.setext || r))
  );
}
function j(e, t, n, r) {
...
`,
  ...
  return (
    /^[\t ]/.test(l) && (l = T(l.charCodeAt(0)) + l.slice(1)),
    (l = l ? o + ` ` + l : o),
...
function se(e, t, n) {
  let r = (J(n) + (n.options.ruleSpaces ? ` ` : ``)).repeat(oe(n));
...
export { h as a, y as i, A as n, d as o, T as r, n as s, ce as t };
//# sourceMappingURL=handle-DDe9oC5j.js.map

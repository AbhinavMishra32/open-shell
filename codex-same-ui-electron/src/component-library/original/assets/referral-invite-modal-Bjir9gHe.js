...
import { _ as S, p as C, u as w, x as T } from "./codex-api-DRlZt5zW.js";
...
import { t as O } from "./codex-C1u5S_iM.js";
...
function Ae(e) {
  ...
  t[20] === X
    ? (xe = t[21])
    : ((xe = () => {
        X({ action: a.CODEX_REFERRAL_INVITE_MODAL_ACTION_SHOWN });
      }),
      (t[20] = X),
      (t[21] = xe));
  ...
  t[25] !== W || t[26] !== X || t[27] !== r
    ? ((Te = () => {
        W || (X({ action: a.CODEX_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED }), r());
      }),
      (t[25] = W),
      (t[26] = X),
      (t[27] = r),
  ...
  t[43] !== l
    ? ((Je = async () => {
        ...
        (X({ action: a.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED, emailCount: t.length }),
          I(`submitting`));
        try {
          let e = await se.mutateAsync({ emails: t, referralKey: l });
          (X({
            action: a.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_SUCCEEDED,
          ...
          (I(`idle`),
            ...
            n != null &&
              X({
                action: a.CODEX_REFERRAL_INVITE_MODAL_ACTION_BACKEND_ERROR,
                emailCount: t.length,
  ...
  t[215] !== X || t[216] !== r
    ? ((Sn = () => {
        (X({ action: a.CODEX_REFERRAL_INVITE_MODAL_ACTION_DONE_CLICKED }), r());
      }),
      (t[215] = X),
      (t[216] = r),
      (t[217] = Sn))
...
function Je({ message: e, status: t }) {
  return Xe(e)
    ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS
    : t === 400
      ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED
      : t === 401
        ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_AUTHENTICATION_REQUIRED
        : t === 403
          ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_PERMISSION_DENIED
          : t === 409
            ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS
            : t === 429
              ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_RATE_LIMITED
              : t >= 500 && t < 600
                ? c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_BACKEND_ISSUE
                : c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR;
}
function Ye(e) {
  switch (e) {
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_AUTHENTICATION_REQUIRED:
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_PERMISSION_DENIED:
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_RATE_LIMITED:
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS:
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED:
      return o.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_USER;
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_BACKEND_ISSUE:
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR:
      return o.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_SYSTEM;
    case c.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNSPECIFIED:
    case c.UNRECOGNIZED:
      return o.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_UNSPECIFIED;
  }
}
function Xe(e) {

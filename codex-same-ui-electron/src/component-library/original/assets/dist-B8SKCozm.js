...
var w = (e) => {
  let { present: t, children: n } = e,
    r = T(t),
    i = typeof n == `function` ? n({ present: r.isPresent }) : a.Children.only(n),
    o = c(r.ref, D(i));
    ...
    S(() => {
      if (t) {
        let e,
          ...
          s = (e) => {
            e.target === t && (o.current = E(r.current));
          };
        return (
...
var O = a.useInsertionEffect || S;
function k({ prop: e, defaultProp: t, onChange: n = () => {}, caller: r }) {
  let [i, o, s] = A({ defaultProp: t, onChange: n }),
    c = e !== void 0,
    l = c ? e : i;
  {
...
export { x as a, d as c, i as d, b as i, s as l, w as n, p as o, S as r, u as s, k as t, c as u };
//# sourceMappingURL=dist-B8SKCozm.js.map

...
function on(t) {
  switch (t) {
    case `cron`:
      return e.CODEX_AUTOMATION_KIND_CRON;
    case `heartbeat`:
      return e.CODEX_AUTOMATION_KIND_HEARTBEAT;
  }
}
function sn(e) {
  switch (e) {
    case `ACTIVE`:
      return t.CODEX_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return t.CODEX_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return t.CODEX_AUTOMATION_STATUS_DELETED;
  }
}
function cn(e) {
  switch (e) {
    case `none`:
      return n.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
    case `minimal`:
      return n.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
    case `low`:
      return n.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
    case `medium`:
      return n.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
    case `high`:
      return n.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
    case `xhigh`:
      return n.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
  }
}
function ln(e) {
  switch (e) {
    case `worktree`:
      return r.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return r.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function un(e) {
  switch (e) {
    case G.SECONDLY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY;
    case G.MINUTELY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY;
    case G.HOURLY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY;
    case G.DAILY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_DAILY;
    case G.WEEKLY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY;
    case G.MONTHLY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY;
    case G.YEARLY:
      return i.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY;
  }
}
function dn(e, t) {

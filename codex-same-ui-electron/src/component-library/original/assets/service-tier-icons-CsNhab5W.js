...
import { bc as u, v as d } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { o as C } from "./lib-MoKmYgcO.js";
import { t as ee } from "./invalidate-queries-and-broadcast-dPfhRWCd.js";
import { u as w } from "./config-queries-BDIsZFnB.js";
import { a as T, i as E } from "./setting-storage-Cel8Tr7E.js";
var D = b(),
  O = t({ sandbox: a([`elevated`, `unelevated`]).optional() }).passthrough(),
  te = [`windows-sandbox`, `mode`],
  ne = [`windows-sandbox`, `readiness`];
function k(e) {
  return [...te, e];
}
function A(e) {
...
async function j(e) {
  try {
    return (await u(`get-windows-sandbox-readiness-for-host`, { hostId: e })).status;
  } catch (e) {
    return (
      v.error(`Failed to load Windows sandbox readiness`, { safe: {}, sensitive: { error: e } }),
      `notConfigured`
    );
  }
}
function M(e) {
  ...
  t[2] !== o || t[3] !== r
    ? ((s = async () => {
        try {
          return F((await w(o, r, null, !1)).config.windows);
        } catch (e) {
          let t = e;
          return (
            v.error(`Failed to load Windows sandbox mode`, {
              safe: { error: String(t) },
              sensitive: {},
            }),
            null
  ...
  return (
    t[5] !== a || t[6] !== s
      ? ((c = { queryKey: a, queryFn: s, staleTime: x.ONE_MINUTE }),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c))
      : (c = t[7]),
...
function N(e) {
  ...
  let a;
  t[2] === r ? (a = t[3]) : ((a = () => j(r)), (t[2] = r), (t[3] = a));
  let o = e?.enabled ?? !0,
    s;
  return (
    t[4] !== i || t[5] !== a || t[6] !== o
      ? ((s = { queryKey: i, queryFn: a, staleTime: x.INFINITE, enabled: o }),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o),
        (t[7] = s))
...
function P(e) {
  let t = (0, D.c)(19),
    ...
    a = ee(),
    o;
  t[0] === r ? (o = t[1]) : ((o = k(r)), (t[0] = r), (t[1] = o));
  let s = o,
    c;
  t[2] === r ? (c = t[3]) : ((c = A(r)), (t[2] = r), (t[3] = c));
  let l = c,
    f;
  t[4] === r
    ? (f = t[5])
  ...
  t[6] !== i || t[7] !== s
    ? ((p = (e) => {
        let t = i.getQueryData(s);
        return (i.setQueryData(s, e), { previousMode: t });
      }),
      (h = (e, t, n) => {
        (v.error(`Failed to update Windows sandbox mode`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
          n?.previousMode !== void 0 && i.setQueryData(s, n.previousMode));
      }),
      (t[6] = i),
      (t[7] = s),
      (t[8] = p),
    ...
    : ((p = t[8]), (h = t[9]));
  let y;
  t[10] !== a || t[11] !== s || t[12] !== l
    ? ((y = async () => {
        await Promise.all([a(s), a(l)]);
      }),
      (t[10] = a),
      (t[11] = s),
      (t[12] = l),
  ...
  let b;
  return (
    t[14] !== f || t[15] !== p || t[16] !== h || t[17] !== y
      ? ((b = { mutationFn: f, onMutate: p, onError: h, onSettled: y }),
        (t[14] = f),
        (t[15] = p),
        (t[16] = h),
        (t[17] = y),
...
function L() {
  let e = (0, D.c)(7),
    t = h(y),
    r = T(n.followUpQueueMode),
    i = r === `interrupt` ? `steer` : (r ?? `queue`),
    a,
    o;
  (e[0] !== r || e[1] !== t
    ? ((a = () => {
        r === `interrupt` && E(t, n.followUpQueueMode, `steer`);
      }),
      (o = [r, t]),
      (e[0] = r),
      (e[1] = t),
  ...
  return (
    e[4] !== i || e[5] !== s
      ? ((c = { mode: i, isQueueingEnabled: s }), (e[4] = i), (e[5] = s), (e[6] = c))
      : (c = e[6]),
    c
  );
}
function R(e) {
  return e === `cmdIfMultiline` ? `CmdOrCtrl+Shift+Enter` : `CmdOrCtrl+Enter`;
}
function z({
  followUpType: e,
...
function V({ hasPlanMode: e, hasDefaultMode: t, isPlanMode: n, setSelectedMode: r }) {
  ...
  return t
    ? e.key === `Escape` && !e.metaKey && !e.ctrlKey && !e.altKey && !e.shiftKey
      ...
      : e.key === `Tab` &&
          ...
          !e.ctrlKey &&
          !e.altKey &&
          V({ hasPlanMode: r, hasDefaultMode: i, isPlanMode: a, setSelectedMode: o })
...
var U = p();
function W(e) {
  return typeof e == `string` ? (0, U.jsx)(U.Fragment, { children: e }) : (0, U.jsx)(C, { ...e });
}
function G(e, t) {
...
function X({
  ...
  requirements: t,
  resolvedConfig: n,
  isGuardianApprovalEnabledByStatsig: i,
  defaultWorkspaceWriteMode: a = `auto`,
}) {
  let u = e ? [`read-only`, `auto`, `granular`, `full-access`, `custom`] : r(t, n),
    d = s(n ?? void 0) ?? !0,
    f = i,
    p = u.filter((e) => e !== `guardian-approvals`),
    m = u.includes(`guardian-approvals`) && p.length === 0,
    h = (f && d) || m ? u : p,
    g = h.includes(`guardian-approvals`),
    _ = h.filter((e) => e !== `custom`),
    v = l(n ?? void 0, a),
    y = v === `full-access` ? null : v,
    b = g && v === `auto` && c(o(n ?? void 0)),
    x = J(_);
  return (
    b ? (x = `guardian-approvals`) : y != null && _.includes(y) && (x = y),
    {
      availableAgentModes: h,
      canShowCustom: h.includes(`custom`),
      canUnlock: h.includes(`full-access`),
      customEquivalentMode: b ? `guardian-approvals` : v,
      isGuardianModeAvailable: g,
      isConfigDataPending: e,
      configNonFullAccessMode: x,
      showGuardianOption: f,
    }
  );
}
...
function Q({ defaultWorkspaceWriteMode: e, isWindowsSandboxRequired: t }) {
...
function ie(e, t, n, r = null) {
  return r != null && e.includes(r)
    ...
    : e.includes(`custom`)
      ? `custom`
      : !$(e) && e.includes(`full-access`)
        ? `full-access`
        : t != null && e.includes(t)
          ? t
          : n;
}
function ae(e, t, n, r, i = null, a, o) {
  return t == null
    ? Z(e, r, i)
      ? null
...
//# sourceMappingURL=service-tier-icons-CsNhab5W.js.map

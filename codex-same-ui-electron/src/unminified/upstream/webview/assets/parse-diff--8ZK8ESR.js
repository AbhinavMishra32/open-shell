...
import { Un as t } from "./src-CYrn1fYL.js";
import { Ta as n } from "./app-server-manager-signals-BOGyjFm3.js";
import { g as r } from "./vscode-api-sUstfl-x.js";
import { l as i } from "./diff-view-mode-DMAtdFuV.js";
import { t as a } from "./sumBy-DhBnMLcX.js";
var o = 1024 * 1024,
  s = new WeakMap();
(12 * o, 3 * o);
...
function l(e) {
  return (
    e.additions + e.deletions > 15e3 || e.changedBytes > 3145728 || e.maxChangedLineBytes > 1048576
  );
}
function u(e) {
  if (e.hunks.reduce((e, t) => e + t.additionLines + t.deletionLines, 0) > 15e3) return !0;
...
function g(e, { maxFiles: t } = {}) {
  ...
  let c = e.includes(`GIT binary patch`) ? _(e) : new Set(),
    l = e.includes(`160000`) ? v(e) : new Set(),
    u,
    d = b(e);
  try {
    u = i(d.diff);
  } catch (e) {
    (r.error(`Failed to parse diff`, { safe: {}, sensitive: { error: e } }), (u = []));
  }
  let g = [],
    S = 0;
  for (let e of u)
    for (let n of e.files) {
      if (t !== void 0 && g.length >= t) return g;
      try {
        let e = x(n, d.pathsByFileIndex.get(S)),
          { oldPath: t, newPath: r } = y(e),
          i = T(e),
          a = e.hunks,
          o = (0, f.default)(a, (e) => e.additionLines),
          s = (0, f.default)(a, (e) => e.deletionLines),
          u = a.find((e) => e.additionCount > 0)?.additionStart,
        ...
        r.error(`Failed to parse diff`, { safe: {}, sensitive: { name: n.name, error: e } });
      }
      S += 1;
    }
  if (n) {
    let t = o ?? new Map();
    if ((t.set(a, g), h.delete(e), h.set(e, t), h.size > p)) {
...
var _ = (e) => {
  ...
  v = (e) => {
    ...
    for (let r of e.split(/\r?\n/)) {
      ...
      n >= 0 &&
        (/^(?:new file mode|deleted file mode|old mode|new mode) 160000$/.test(r) ||
...
function b(e) {
  ...
  return {
    diff: e
      .split(/(?<=\n)/)
      .map((e) => {
        if ((e.startsWith(`diff --git `) && (n += 1), e.startsWith(`diff --git "`))) {
          let r = S(e);
...
export { c as i, l as n, u as r, g as t };
//# sourceMappingURL=parse-diff--8ZK8ESR.js.map

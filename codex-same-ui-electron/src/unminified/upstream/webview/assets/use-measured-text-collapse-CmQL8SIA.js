...
import { n as r } from "./use-resize-observer-CbHbkQNx.js";
var i = n(),
  a = e(t(), 1),
  o = 1.5,
  s = 1;
function c(e) {
  let t = (0, i.c)(9),
    { text: n, collapsedLineCount: r, fallbackFontSizePx: o } = e,
    [c, u] = (0, a.useState)(null),
    d;
  t[0] !== r || t[1] !== o
    ? ((d = { collapsedLineCount: r, fallbackFontSizePx: o }), (t[0] = r), (t[1] = o), (t[2] = d))
    : (d = t[2]);
  let { setTextMeasurementRef: f, textMeasurement: p } = l(d),
    m =
      p == null || p.collapsedHeightPx == null || p.contentHeightPx <= p.collapsedHeightPx + s
        ? `uncollapsible`
        : c === n
          ? `expanded`
          : `collapsed`,
  ...
  return (
    t[5] !== m || t[6] !== g || t[7] !== f
      ? ((_ = { setTextContentMeasurementRef: f, collapseState: m, handleToggleExpansion: g }),
        (t[5] = m),
        (t[6] = g),
        (t[7] = f),
        (t[8] = _))
...
function l(e) {
  ...
  return (
    t[7] !== h || t[8] !== s
      ? ((g = { setTextMeasurementRef: h, textMeasurement: s }), (t[7] = h), (t[8] = s), (t[9] = g))
      : (g = t[9]),
    g
  );
}
...
function p(e, t) {
  ...
  return Number.isFinite(n) ? n : t * o;
}
export { l as n, c as t };
//# sourceMappingURL=use-measured-text-collapse-CmQL8SIA.js.map

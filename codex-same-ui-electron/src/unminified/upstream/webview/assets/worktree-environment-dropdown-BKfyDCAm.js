...
import { fo as t } from "./app-server-manager-signals-BOGyjFm3.js";
...
import { t as ee } from "./button-Xd4Hy1MO.js";
import { t as c } from "./spinner-Dvc_A3Ae.js";
import { t as l } from "./link-external-oqLWmWWX.js";
import { n as te, r as ne } from "./composer-footer-CY-87K58.js";
import { t as re } from "./settings.cog-CJF3NOGk.js";
import { t as u } from "./check-md-CZTnvSiA.js";
import { r as d, t as ie } from "./dropdown-CHaZfyxI.js";
import { t as ae } from "./chevron-D6hquBJC.js";
import { n as oe } from "./local-environments-BxC20Xhy.js";
import { t as se } from "./star-CIEu5Tim.js";
var ce = a(),
  f = e(n(), 1),
  p = r();
function m(e) {
  let n = (0, ce.c)(81),
    {
      ...
      showIcon: b,
      hideLabel: x,
      selectedConfigPath: S,
      onSelectConfigPath: C,
      onOpenSettings: w,
      showDefaultOption: T,
    } = e,
    E = v === void 0 ? `top` : v,
  ...
  if (
    ...
    let e = oe(m),
      l;
    (n[26] === S ? (l = n[27]) : ((l = S ? t(S) : null), (n[26] = S), (n[27] = l)), (F = l));
    ...
    n[28] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (y = n[28]);
    let b;
    n[29] === r ? (b = n[30]) : ((b = i(`whitespace-nowrap`, r)), (n[29] = r), (n[30] = b));
    let x;
    n[31] === O
      ? (x = n[32])
      : ((x = O ? (0, p.jsx)(re, { className: `icon-xs` }) : null), (n[31] = O), (n[32] = x));
    let w;
    n[33] !== k || n[34] !== v || n[35] !== a
      ? ((w = k
          ? null
          : (0, p.jsx)(te, {
              collapse: a == null ? `secondary` : `sm`,
              className: i(`max-w-40 truncate whitespace-nowrap`, a),
              children: v,
            })),
        (n[33] = k),
        (n[34] = v),
    ...
    (n[37] === h
      ? (T = n[38])
      : ((T = h
          ? (0, p.jsx)(c, { className: `icon-xs text-token-input-placeholder-foreground` })
          : (0, p.jsx)(ne, {
              children: (0, p.jsx)(ae, {
          ...
          ? (0, p.jsx)(d.Item, {
              ...
              children: (0, p.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, p.jsx)(`span`, { className: `truncate`, children: g(e) }),
                ],
              }),
            })
          : null),
  ...
  n[55] !== S
    ...
    : (K = n[56]);
  let q;
  n[57] !== K || n[58] !== H || n[59] !== U || n[60] !== W
    ? ((q = (0, p.jsxs)(`div`, { className: H, children: [U, W, K] })),
      (n[57] = K),
      (n[58] = H),
      (n[59] = U),
      (n[60] = W),
  ...
  n[66] === Y
    ...
    : ((Z = (0, p.jsx)(d.Section, {
      ...
      (n[67] = Z));
  let Q;
  n[68] !== I || n[69] !== q || n[70] !== Z || n[71] !== G
    ? ((Q = (0, p.jsxs)(`div`, { className: G, children: [I, q, J, Z] })),
      (n[68] = I),
      (n[69] = q),
      (n[70] = Z),
      (n[71] = G),
...
function g(e) {
  if (e.type === `success`) {
    ...
    return t.length > 0 ? t : h(e.configPath);
  }
...
function le({ isLoading: e, selectedEnvironment: t }) {
  return e
    ...
    : t?.type === `success`
      ? (0, p.jsx)(p.Fragment, { children: t.environment.name })
      : (0, p.jsx)(o, {
          id: `codex.environmentSelector.noEnvironment`,
          defaultMessage: `No environment`,
          description: `No environment selected message`,
...
export { m as t };
//# sourceMappingURL=worktree-environment-dropdown-BKfyDCAm.js.map

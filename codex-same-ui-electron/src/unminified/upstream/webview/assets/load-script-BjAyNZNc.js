...
var o = /(https:\/\/.*)\/analytics\.js\/v1\/(?:.*?)\/(?:platform|analytics.*)?/,
  s = function () {
    var e;
    return (
  ...
  d = function () {
    return l() || s() || `https://cdn.segment.com`;
  },
  f = function () {
    return `${d()}/next-integrations`;
  };
function p(e) {
  return Array.prototype.slice.call(window.document.querySelectorAll(`script`)).find(function (t) {
    return t.src === e;
  });
}
function m(e, t) {
  ...
  return new Promise(function (n, r) {
    ...
    d ? (i = d.parentElement) == null || i.insertBefore(a, d) : window.document.head.appendChild(a);
  });
}
function h(e) {
  var t = p(e);
...
export { u as a, i as c, f as i, e as l, h as n, r as o, d as r, a as s, m as t, t as u };
//# sourceMappingURL=load-script-BjAyNZNc.js.map

...
function r({ onSelect: e, isDisabled: t = !1 }) {
  let n = t || e == null,
    r = (t) => {
...
function o(e) {
  let n = (0, i.c)(34),
    {
      ...
      secondaryTitle: p,
      secondLine: m,
      secondLineRightText: h,
      title: g,
    } = e,
    _;
  n[0] === u ? (_ = n[1]) : ((_ = { onSelect: u }), (n[0] = u), (n[1] = _));
  let v = r(_),
    y = l
  ...
  n[2] !== s || n[3] !== y
    ? ((b = t(
        `group min-h-10 w-full rounded-lg px-3 py-3 text-base cursor-interaction`,
        y,
        `text-left`,
        s,
      )),
  ...
  n[5] === c
    ? (x = n[6])
    : ((x =
        c && (0, a.jsx)(`span`, { className: `flex min-h-6 shrink-0 items-center`, children: c })),
      (n[5] = c),
      (n[6] = x));
  let S;
  n[7] === g
  ...
  n[19] !== m || n[20] !== h
    ? ((D =
        ...
        (0, a.jsxs)(`div`, {
          ...
          children: [
            (0, a.jsx)(`div`, { className: `min-w-0 flex-1`, children: m }),
            h &&
              (0, a.jsx)(`div`, {
  ...
  let k;
  n[25] !== O || n[26] !== x
    ? ((k = (0, a.jsxs)(`div`, { className: `flex min-w-0 items-start gap-2`, children: [x, O] })),
      (n[25] = O),
      (n[26] = x),
      (n[27] = k))
    : (k = n[27]);
  let A;
  return (
    n[28] !== o || n[29] !== v || n[30] !== d || n[31] !== k || n[32] !== b
      ? ((A = (0, a.jsx)(`div`, {
          "aria-label": o,
          className: b,
          onContextMenu: d,
...
//# sourceMappingURL=selectable-list-row-DYagHbhn.js.map

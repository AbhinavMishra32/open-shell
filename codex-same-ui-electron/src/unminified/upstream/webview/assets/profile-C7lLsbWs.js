...
import { p as y } from "./codex-api-DRlZt5zW.js";
...
import { t as w } from "./codex-api-error-B3GqHcV_.js";
import {
  _ as fe,
  a as pe,
  b as T,
...
import { i as V, o as H, r as U, t as W } from "./codex-avatar-9OkGRaoz.js";
          ...
          (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsxs)(ie, {
                ...
                size: `toolbar`,
                onClick: () => {
                  (v(t, o, { action: a.CODEX_PROFILE_EDIT_ACTION_OPENED }), Ee(!0));
                },
                children: [
      ...
      children: [
                          ...
                          (0, J.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, J.jsx)(`input`, {
                                ...
                                onClick: () => {
                                  v(t, i, {
                                    action: r.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                  });
                                },
                                onChange: (e) => {
                                  ...
                                  ((e.currentTarget.value = ``),
                                    n != null &&
                                      (v(t, i, {
                                        action:
                                          r.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                      }),
                                      nt(n).then(Ce, () => {
                                        (v(t, i, {
                                          action: r.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                        }),
                                          Ce(null));
                                      })));
                                },
          ...
          : (0, J.jsx)(we, {
              ...
              onSave: (e) => {
                (Ce(null),
                  ...
                  W.mutate(e.photo, {
                    onError: () => {
                      (v(t, i, { action: r.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                        Y(null));
                    },
                    onSuccess: () => {
                      (v(t, i, { action: r.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED }),
                        _e(null),
                        Y(null));
                    },
                  }));
        ...
        Te
          ? (0, J.jsx)(qe, {
              ...
              onSaveError: (e) => {
                v(t, o, { action: a.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
              },
              onPhotoChangeImageSelected: () => {
                v(t, o, { action: a.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED });
              },
              onPhotoChangeStarted: () => {
                v(t, o, { action: a.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
              },
              onSaveProfile: async (e) => {
                (await P.mutateAsync(e), _e(null));
              },
              onSaveSuccess: () => {
                v(t, o, { action: a.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
              },
...
function qe({
  ...
  let m = g(),
    ...
    W = async () => {
      ...
      R(!0);
      let h = s.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED,
        g = s.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED;
      try {
        (p != null &&
          ((h = s.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
          await te(p),
          (h = s.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          f > 0 &&
            ((g = s.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
            await u(d),
            (g = s.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          ee(),
          i());
      } catch (e) {
        if (

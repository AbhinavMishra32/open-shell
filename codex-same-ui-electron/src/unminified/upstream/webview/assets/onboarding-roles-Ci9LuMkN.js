...
import { d as n } from "./onboarding-state-C29ET4Cr.js";
var r = new Set([`default`, `engineering`, `data_science`]),
  i = [
    `engineering`,
    `product_management`,
    `finance`,
...
function s(e) {
  return e.some((e) => r.has(e)) ? `coding` : `non_coding`;
}
function c(e, t) {
  return { ...e, roles: t, workMode: s(t) };
}
export { s as i, i as n, o as r, a as t };
//# sourceMappingURL=onboarding-roles-Ci9LuMkN.js.map

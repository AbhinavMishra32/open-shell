...
import { Cr as t, Vr as n, wr as r } from "./src-CYrn1fYL.js";
import { _r as i } from "./app-server-manager-signals-BOGyjFm3.js";
import { n as a, t as o } from "./jsx-runtime-CiQ1k8xo.js";
import { t as s } from "./clsx-BcPLHiun.js";
import { P as c, V as l, h as u, lt as d, n as f, r as p, u as m } from "./vscode-api-sUstfl-x.js";
import { t as h } from "./useQueries-CqfBVjsA.js";
import { c as g, n as _, o as v, r as y } from "./lib-MoKmYgcO.js";
import { f as b } from "./chunk-LFPYN7LY-DwFbyqR1.js";
import { o as x } from "./statsig-Cajk3UKk.js";
import { _ as S } from "./config-queries-BDIsZFnB.js";
import { t as C } from "./use-debounced-value-DkRRYvDv.js";
import { t as w } from "./startCase-JPkD4wck.js";
import { E as T, T as E, _ as D, p as O } from "./mention-item-DOPWFNx_.js";
import { o as k } from "./mcp-capability-signals-3iWufNgx.js";
import { t as A } from "./apps-DBd5dYzG.js";
import { t as j } from "./plugin-install-store-BWRSuKkC.js";
import { t as M } from "./use-platform-BkwBnkgx.js";
import { m as N, y as P } from "./use-plugins-BKOuT9XR.js";
import {
  a as F,
  c as I,
  f as L,
...
import { r as se, t as ce } from "./get-file-icon-DafZgplp.js";
import { t as le } from "./mcp-BYvjg9M2.js";
import { n as ue } from "./use-skills-DK2PGa-B.js";
import { t as de } from "./use-is-background-subagents-enabled-gllCQ3lL.js";
import { t as fe } from "./sortBy-EVRmvlY9.js";
import { n as pe } from "./composer-top-menu-chrome-4snk27KP.js";
import { s as me } from "./dist-IXqUkPON.js";
import { t as B } from "./score-query-match-CpxhuHTA.js";
import { t as he } from "./list-navigation-D9or854M.js";
import { r as ge } from "./mcp-capability-client-C9eWeicf.js";
import { t as _e } from "./use-workspace-file-search-LP41BByR.js";
var ve = `data-hotkey-window-home-composer-menu-open`;
function V(e) {
...
function we(e) {
  ...
  for (let e = 0; e < H; e += 1)
    for (let n = 0; n < be; n += 1) {
      if (!Ee(t, e * be + n)) continue;
      (r.push({ animationDelayMs: G(e), column: n, row: e }), i.add(W(n, e)));
      let a = H - 1 - n;
      a !== n && (r.push({ animationDelayMs: G(e), column: a, row: e }), i.add(W(a, e)));
    }
  if (r.length === 0) {
    let e = Math.floor(H / 2);
    (r.push({ animationDelayMs: G(e), column: e, row: e }), i.add(W(e, e)));
  }
  return { cells: r, color: Oe(n), scanCells: De(i) };
}
function Te(e) {
  let t = Se;
  for (let n = 0; n < e.length; n += 1) t = (t * Ce + e.charCodeAt(n)) % xe;
  return t;
}
function Ee(e, t) {
...
function De(e) {
  ...
  for (let n = 0; n < H; n += 1)
    for (let r = 0; r < H; r += 1)
      t.push({ animationDelayMs: G(n), column: r, filled: e.has(W(r, n)), row: n });
  return t;
}
function G(e) {
  return e * ye;
...
function Oe(e) {
  return ke(Math.floor((e / xe) * U.length));
}
function ke(e) {
  return U[e % U.length] ?? `var(--color-token-charts-yellow)`;
}
var Ae = {
...
function je(e) {
  ...
  if (t[5] !== o || t[6] !== n || t[7] !== r || t[8] !== i) {
    let e = we(i);
    ((c = r),
      t[17] === n ? (l = t[18]) : ((l = s(`shrink-0`, n)), (t[17] = n), (t[18] = l)),
      (u = `-2 -1 24 24`),
      (d = `none`),
      (f = `crispEdges`),
      ...
      (m = e.cells.map((t) =>
        (0, q.jsx)(
          `rect`,
          {
            className: o ? Ae.filledScanCell : void 0,
            x: t.column * J,
            y: t.row * J,
            width: J,
            height: J,
...
function Me(e, n) {
  ...
  return n == null || a == null || !r(a) || a === t(n);
}
var Y = e(a(), 1);
function Ne(e) {
  let t = (0, K.c)(10),
    { isActive: n, isLoading: r, onRequestClose: i, query: a, resultCount: o } = e,
    s = n === void 0 ? !0 : n,
    c;
  t[0] !== r || t[1] !== a || t[2] !== o
    ? ((c = Pe({ isLoading: r, query: a, resultCount: o })),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o),
      (t[3] = c))
...
function Pe({ isLoading: e, query: t, resultCount: n }) {
...
function Fe(e) {
  ...
  if (o === `expandedTopTray` || l || V(c.pathname)) {
    let e;
    t[0] === r
      ? (e = t[1])
      : ((e = s(`relative flex w-full flex-col overflow-hidden text-sm`, r)),
        (t[0] = r),
        (t[1] = e));
    let i;
    return (
...
function Ie(e) {
  ...
  o === `bottom`
    ...
    : o === `top` && (c = `vertical-scroll-fade-mask-top`);
  let l;
  t[0] !== r || t[1] !== c
    ? ((l = s(c, `flex w-full flex-1 flex-col overflow-y-auto`, r)),
      (t[0] = r),
      (t[1] = c),
      (t[2] = l))
    : (l = t[2]);
...
function Le(e) {
  let t = (0, K.c)(6),
    ...
    o = b(),
    c =
      a === `expandedTopTray` || a === `embeddedExpandedTopTray` || V(o.pathname)
    ...
    l;
  t[0] !== r || t[1] !== c ? ((l = s(c, r)), (t[0] = r), (t[1] = c), (t[2] = l)) : (l = t[2]);
  let u;
  return (
    t[3] !== n || t[4] !== l
      ? ((u = (0, q.jsx)(`div`, { className: l, children: n })), (t[3] = n), (t[4] = l), (t[5] = u))
      : (u = t[5]),
    u
  );
}
...
function ze(e) {
  let t = (0, K.c)(10),
    ...
    o;
  t[0] !== r || t[1] !== a ? ((o = r(a)), (t[0] = r), (t[1] = a), (t[2] = o)) : (o = t[2]);
  let c = i
...
var Be = 8,
  Ve = `--composer-top-menu-max-height`;
function He(e) {
  let t = (0, K.c)(4),
        ...
        let e = null,
          ...
          i = () => {
            let e = n.getBoundingClientRect(),
              ...
              i = `${Math.max(0, Math.floor(r - 46 - Be))}px`;
            i !== t && ((t = i), n.style.setProperty(Ve, i));
          },
          a = () => {
...
var We = l(u, ({ hostId: e, path: t, query: n, servers: r }, { scope: i }) => ({
  queryKey: [`mcp-capability-mentions`, e, Ge(r), t, n],
  queryFn: () => ge(i, e, r, { path: t, query: n }),
  enabled: r.length > 0,
  staleTime: 0,
}));
function Ge(e) {
...
function Ke({ sections: e, query: t, servers: n }) {
  let r = Xe({ query: t, servers: n });
  return r.length === 0
    ? e
    : [
        {
...
function qe({ isLoading: e, mentionSource: t, results: n, servers: r }) {
  let i = t.path.at(-1)?.title ?? t.server;
  return Ze({ results: n, servers: r }).flatMap(({ items: n, server: r }) => {
    let a = n == null ? void 0 : Qe({ items: n, mentionSource: t, server: r });
        ...
        : [
            {
              item: {
                detail: null,
                icon: le,
                insertMention: Ye({ kind: `mcp-capability`, path: [], server: t.server }),
                key: `mcp-capability:${t.server}`,
                label: t.server,
              },
              score: r,
            },
...
function Ze({ results: e, servers: t }) {
  let n = new Map(e?.map(({ items: e, server: t }) => [t, e]));
  return t.map(({ server: e }) => ({ items: n.get(e), server: e }));
}
function Qe({ items: e, mentionSource: t, server: n }) {
  return e.map((e, r) => {
    switch (e.type) {
      case `group`:
        return {
          detail: null,
          insertMention: Ye({ ...t, path: [...t.path, e], server: n }),
...
function $e(e) {
  let t = X(e.resourceUri, `file_name`) ?? X(e.resourceUri, `filename`),
    ...
    r = se(t ?? e.title, n);
  if (!(r === `file` && t == null && n == null)) return ce[r];
}
function X(e, t) {
  try {
...
var Z = e(fe(), 1);
function nt({ backgroundAgents: e, excludedConversationIds: t = [], query: n }) {
  if (e.length === 0) return null;
  let r = e.filter((e) => !t.includes(e.conversationId)),
    i = n.trim(),
    a = i.length === 0 ? r : rt(r, i).filter((e) => at(e, i) > 0);
  return {
    sections: [
      {
        id: `agents`,
        ...
        items: a.map((e) => ({
          ...
          label: e.displayName,
          detail: e.agentRole,
          iconElement: (0, Y.createElement)(je, {
...
function rt(e, t) {
  return (0, Z.default)(
    e.map((e, n) => ({ agent: e, score: at(e, t), index: n })),
...
var ot = e(w(), 1);
function st({ agents: e, query: t }) {
  if (e.length === 0) return null;
  let n = t.trim(),
    r = n.length === 0 ? e : ct(e, n).filter((e) => lt(e, n) > 0);
  return {
    sections: [
      {
        id: `custom-agents`,
...
function ct(e, t) {
  return (0, Z.default)(
    e.map((e, n) => ({ agent: e, score: lt(e, t), index: n })),
...
function lt(e, t) {
  return Math.max(
    ...
    B(`@${e.roleName}`, t),
    B(e.description ?? ``, t),
    ...e.nicknameCandidates.map((e) => B(e, t)),
  );
}
var ut = [],
  dt = { sections: [] };
function ft(e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== a
    ? ((s = { hostId: n, includeDirectories: !0, query: i, roots: a }),
      ...
      (t[3] = s))
    : (s = t[3]);
  let { files: c, isLoading: l } = _e(s),
    u = i.trim();
  if (a == null || a.length === 0) return dt;
  let d = null;
  if (u.length === 0) {
    let e;
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (f = t[6]);
  let p;
  t[7] === c ? (p = t[8]) : ((p = c == null ? ut : c.map(pt)), (t[7] = c), (t[8] = p));
  let m = l || o,
    h;
  return (
    ...
    completeQuery:
      e.matchType === `directory`
        ? (t) => {
            ...
            (u.setSelection(me.create(u.doc, s + l.length)), o(u), i.focus());
          }
        : void 0,
  };
}
...
function mt(e) {
  ...
  let { nativeApps: _, isLoading: v } = ae(d),
    y;
  t[2] === c ? (y = t[3]) : ((y = yt(c)), (t[2] = c), (t[3] = y));
  let b = y,
    x = s.formatMessage({
    ...
    C = _.find(_t) ?? null,
    w =
      l.length > 0 && S != null && vt(S, l)
        ? {
            kind: `chrome-plugin`,
            plugin: S,
            mention: { ...F(S, a), name: R, displayName: R, description: x },
            nativeApp: C == null ? null : { ...C, displayName: L(C) },
          }
        : null,
    T =
      l.length === 0 || r == null
        ? []
        : _.filter((e) => !(S != null && z(e)))
            .map((e) => {
              let t = L(e);
              return {
                kind: `native-app`,
            ...
            .filter((e) => bt(e.app.displayName, l)),
    ...
    k = l.length > 0 && v && w == null && T.length === 0 ? b.loading : null;
  if ((r == null && w == null) || (E.length === 0 && k == null)) return null;
  let j = b.title,
    N = E.map((e) => {
      if (e.kind === `chrome-plugin`) {
        let t = e.nativeApp == null ? `` : (O[D.indexOf(e.nativeApp)]?.data?.iconSmall ?? ``);
        return {
      ...
      let t = O[D.indexOf(e.app)]?.data?.iconSmall ?? ``,
        n = ne({ app: e.app, description: x, computerPlugin: e.plugin, iconSmall: t });
      return {
    ...
    P;
  t[4] !== v || t[5] !== O
    ? ((P = v || O.some(ht)), (t[4] = v), (t[5] = O), (t[6] = P))
    : (P = t[6]);
  let I;
  return (
    t[7] !== k || t[8] !== N || t[9] !== P || t[10] !== b.title
      ? ((I = { id: `native-apps`, title: j, items: N, emptyState: k, isLoading: P }),
        (t[7] = k),
        (t[8] = N),
        (t[9] = P),
        (t[10] = b.title),
...
function vt(e, t) {
  return Math.max(B(e.plugin.name, t), B(e.displayName ?? ``, t), B(R, t), B(`@${R}`, t)) > 0;
}
function yt(e) {
  return e === `macOS`
...
function wt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = { installSuggestionPluginNames: xt }), (t[0] = c))
    : (c = t[0]);
  let { availablePlugins: l, isLoading: u } = N(n, i, c),
    d = !s,
    f;
  t[1] === d ? (f = t[2]) : ((f = { enabled: d }), (t[1] = d), (t[2] = f));
  let { availablePlugins: p, isLoading: m } = N(n, i, f),
    h = [...l];
  if (!s) {
    let e = new Set(l.map(Et));
    for (let t of p) {
      let n = Et(t);
  ...
  let v = u || (!s && m),
    ...
    E = T ? Ot(C) : [],
    O = new Set(E),
    k = T ? C.filter((e) => !O.has(e) && (e.plugin.installed || !Dt(e))) : C,
    A;
  t[3] === y
    ? (A = t[4])
    : ((A = (e) => {
        e.plugin.installed || y(e);
      }),
      (t[3] = y),
      (t[4] = A));
  let P = A,
    I = mt({
      chromeAppPlugins: E,
      computerUsePlugin: w,
      onPluginMentionInserted: P,
      pluginMentionLabels: b,
      query: r,
    }),
    L = S.length === 0 ? k : At(k, S, b).filter((e) => jt(e, S, b) > 0),
    R = v && L.length === 0;
  if (L.length === 0 && !R && I == null) {
    let e;
    return (
      t[5] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = { sections: [] }), (t[5] = e))
        ...
        items: L.map((e) => {
          ...
          return {
            ...
            insertMention: (n) => {
              ...
              (r.insertMentionFromAtMention(t, i), P(e));
            },
          };
        }),
        emptyState: n,
  ...
  return (I != null && z.push(I), { sections: z });
}
function Tt(e) {
  return e.plugin.availability === St
    ? !1
    : e.plugin.enabled
      ? !0
      : !e.plugin.installed && xt.includes(e.plugin.name);
}
function Et(e) {
...
function Ot(e) {
  let n = P(),
    ...
    i = kt(n);
  return (0, Z.default)(
    e.filter((e) => Dt(e) && e.marketplaceName === r),
...
function At(e, t, n) {
  return (0, Z.default)(
    e.map((e, r) => ({ plugin: e, score: jt(e, t, n), index: r })),
    [(e) => -e.score, (e) => F(e.plugin, n).displayName, (e) => e.index],
  ).map((e) => e.plugin);
}
function jt(e, t, n) {
  let r = F(e, n);
  return Math.max(
    ...
    B(r.displayName, t),
    B(`@${r.displayName}`, t),
    B(`@${e.displayName ?? e.plugin.name}`, t),
  );
}
function Mt(e) {
  let t = (0, K.c)(14),
  ...
  let { skills: c, isLoading: l } = ue(i, n, s),
    u;
  t[2] === o ? (u = t[3]) : ((u = { enabled: o }), (t[2] = o), (t[3] = u));
  let { installedPlugins: d, isLoading: f } = N(n ?? `local`, i, u),
    p = new Set(d.map(Pt)),
    m = P();
  if (!o) {
    let e;
...
function Ft(e, t, n, r = null) {
  if (!e.enabled || !Me(e, r)) return !1;
  let a = i(e.path)?.pluginId;
  return a == null || !Q.includes(a) || (!n && !t.has(a));
}
function It(e, t) {
  return (0, Z.default)(
    e.map((e, n) => ({ skill: e, score: Lt(e, t), index: n })),
    [
      (e) => -e.score,
      (e) =>
...
function Lt(e, t) {
  return Math.max(B(e.name, t), B(e.displayName ?? ``, t), B(`@${e.displayName ?? e.name}`, t));
}
function Rt(e, t) {
...
function zt(e) {
  ...
  let h = ft(m),
    ...
    y;
  t[5] !== i || t[6] !== s || t[7] !== v
    ? ((y = { hostId: i, query: s, roots: v }), (t[5] = i), (t[6] = s), (t[7] = v), (t[8] = y))
    : (y = t[8]);
  let b = Ke({ sections: wt(y).sections, query: s, servers: g }),
    x;
  t[9] !== i || t[10] !== s || t[11] !== o
    ? ((x = { hostId: i, query: s, roots: o }), (t[9] = i), (t[10] = s), (t[11] = o), (t[12] = x))
    : (x = t[12]);
  let w = Mt(x),
    { data: T, isLoading: E } = S(a, d),
    D = new Set(
      l.flatMap((e) => (e.agentRole == null || u.includes(e.conversationId) ? [] : [e.agentRole])),
    ),
    O = T?.roles.filter((e) => !D.has(e.roleName)) ?? [],
    A = nt({ backgroundAgents: l, excludedConversationIds: u, query: s }),
    j = d ? st({ agents: O, query: s }) : null,
    M = A?.sections[0] ?? null,
    N = j?.sections[0] ?? null,
    P = [...(M?.items ?? []), ...(N?.items ?? [])],
    F =
    ...
    I = Vt(Bt(tt([F == null ? null : { sections: [F] }, { sections: b }, w, h]), s)),
    L;
...
var Ut = { loadingBar: `_loadingBar_1g9nv_1`, "loading-bar-slide": `_loading-bar-slide_1g9nv_1` };
function Wt(e) {
  let t = (0, K.c)(29),
    {
      backgroundAgents: n,
...
function Gt(e) {
  ...
  return (
    t[15] !== n || t[16] !== o || t[17] !== u
      ? ((d = (0, q.jsx)(Jt, { ...n, query: o, sections: u })),
        (t[15] = n),
        (t[16] = o),
        (t[17] = u),
        (t[18] = d))
...
function Kt(e) {
  ...
  t[5] === a.server
    ...
    : ((s = (e) => {
      ...
      (t[6] = s));
  let l = o.filter(s),
    u = c(We, { hostId: r, path: a.path.map(qt), query: i, servers: l }),
    d = qe({ isLoading: u.isLoading, mentionSource: a, results: u.data, servers: l }),
    f;
  return (
    t[7] !== n || t[8] !== i || t[9] !== d
      ? ((f = (0, q.jsx)(Jt, { ...n, query: i, sections: d })),
        (t[7] = n),
        (t[8] = i),
        (t[9] = d),
        (t[10] = f))
...
function Jt(e) {
  ...
  let w = h.length > 1 || h.some(Zt),
    T = !(g.length > 0) && h.every(tn),
    E;
  (t[5] === r ? (E = t[6]) : ((E = r.some(Xt)), (t[5] = r), (t[6] = E)),
    Ne({ isLoading: E, onRequestClose: o, query: f, resultCount: g.length }));
  ...
  return (
    ...
    (0, q.jsxs)(Fe, {
      ...
      children: [
        ...
        h.some(Yt) ? (0, q.jsx)(`div`, { className: Ut.loadingBar, "aria-hidden": `true` }) : null,
      ],
    })
  );
}
    ...
    ? ((l =
        a || c.showTitle
          ? (0, q.jsx)(Le, {
              className: n,
              chromeVariant: r,
              children: (0, q.jsx)(v, { ...c.title, values: c.titleValues }),
            })
          : null),
      (t[0] = r),
      (t[1] = n),
  ...
  t[7] !== i || t[8] !== o || t[9] !== s || t[10] !== c.emptyState || t[11] !== c.items
    ? ((u =
        c.items.length > 0
          ...
          : c.emptyState == null
            ? null
            : (0, q.jsx)(Re, { children: (0, q.jsx)(v, { ...c.emptyState }) })),
      (t[7] = i),
      (t[8] = o),
      (t[9] = s),
      (t[10] = c.emptyState),
...
function en(e) {
  ...
  t[3] !== n.labelClassName || t[4] !== l
    ? ((u = s(`truncate`, l, n.labelClassName)), (t[3] = n.labelClassName), (t[4] = l), (t[5] = u))
    : (u = t[5]);
  let d;
  t[6] !== n.label || t[7] !== u
  ...
  return (
    t[15] !== a || t[16] !== i || t[17] !== o || t[18] !== p
      ? ((m = (0, q.jsx)(ze, { getItemProps: a, highlighted: o, itemIndex: i, children: p })),
        (t[15] = a),
        (t[16] = i),
        (t[17] = o),
        (t[18] = p),
...
//# sourceMappingURL=at-mention-list-CDZ8CUgv.js.map

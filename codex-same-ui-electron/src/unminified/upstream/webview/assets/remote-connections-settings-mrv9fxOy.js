...
import { a as Je, i as Ye, t as Xe } from "./codex-mobile-setup-dialog-DzxoAWgH.js";
...
import {
  ...
  s as rt,
  t as it,
} from "./codex-mobile-setup-flow-BJuQbjBl.js";
...
function yt() {
  let e = (0, $.c)(2),
    { data: t, isLoading: n } = W(u.CODEX_MOBILE_SETUP_COMPLETED);
  if (n) return null;
  if (!t) {
    let t;
    return (
...
function bt() {
  ...
  e[1] !== r || e[2] !== t || e[3] !== c
    ? ((l = (e) => {
        (H(t, { eventName: `codex_remote_control_host_toggle_clicked`, metadata: { enabled: e } }),
          c.mutate(e, {
            onError: () => {
              t.get(q).danger(
                r.formatMessage({
...
function qt(e) {
  return {
    refreshSource: p.CODEX_REMOTE_CONTROL_REFRESH_SOURCE_SETTINGS,
...
function un(e) {
  let t = (0, $.c)(86),
    ...
    f = z(),
    { appServerVersion: p, error: m, installedCodexVersion: h, state: g } = Ae(n.hostId),
    _ = n.displayName,
    v;
  t[0] === f
    ? (v = t[1])
  ...
  if (
    ...
    let l = !E && (A?.code === `remote-codex-not-found` || A?.code === `update-required`);
    ((ee =
      j == null || l
        ? null
        : pn({
...
function mn(e) {
  F.dispatchMessage(`codex-app-server-restart`, { hostId: e, killCodexProcess: !0 });
}
function hn(e) {
  let t = (0, $.c)(18),
        ...
        e.source === `remote-control`
          ...
          : (0, Q.jsx)(
              un,
              {
                connection: e,
                disabled: n,
                installCodexPending: r === e.hostId,
                onAuthenticate: p,
                onEdit: o,
                onInstallCodex: s,
                onLogoutConnection: c,
...
function er() {
  let e = j(te),
    ...
    $e = R(`set-remote-connection-auto-connect`, {
      onError: (t, { autoConnect: r, hostId: a }) => {
        ...
        (r &&
          o != null &&
          x(n, {
            action: g.CODEX_REMOTE_SSH_CONNECTION_ACTION_CONNECT,
            result: b.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
            source: S.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
            connection: o,
            errorCategory: E.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED,
          }),
    ...
    et = R(`install-remote-codex`, {
      onError: (t, { hostId: n }) => {
        (I.warning(`${Xn} install_remote_codex_failed`, {
          safe: {},
    ...
    ot = async () => {
      try {
        let e = [];
        (x(n, {
          action: g.CODEX_REMOTE_SSH_CONNECTION_ACTION_REFRESH,
              ...
              .catch((e) => {
                throw (
                  x(n, {
                    ...
                    result: b.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
                    source: S.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
                    errorCategory: E.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN,
                  }),
                  e
                );
              }),
      ...
      Ze.mutate(
        { remoteConnections: a },
        {
          onSuccess: ({ remoteConnections: e }) => {
            ...
            x(n, {
              action: g.CODEX_REMOTE_SSH_CONNECTION_ACTION_SAVE_CONNECTION,
              result: b.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED,
              source: S.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
              connection: t,
            });
            ...
            onSuccess: ({ remoteConnections: i, state: a, error: o }) => {
              ...
              if (r && s != null) {
                ...
                x(n, {
                  action: g.CODEX_REMOTE_SSH_CONNECTION_ACTION_CONNECT,
                  result: e
                    ? b.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED
                    : b.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
                  source: S.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
                  connection: s,
                  connectionState: a,
                  ...(e

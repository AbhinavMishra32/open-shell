...
import { E as se } from "./codex-api-DRlZt5zW.js";
...
import { i as I } from "./codex-avatar-9OkGRaoz.js";
  ...
  (t[20] !== v || t[21] !== G
    ? ((Ue = () => {
        Le.current ||
          (v !== C &&
            ((Le.current = !0),
            G(f.CODEX_AVATAR_OVERLAY_ACTION_OPENED, c.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
      }),
      (We = [v, G]),
      (t[20] = v),
      (t[21] = G),
    ...
    : ((at = (e, t) => {
        ...
        (Fe.current?.hasPointerCapture?.(e) && Fe.current.releasePointerCapture?.(e),
          r &&
            i.startedOnMascot &&
            !i.hasMoved &&
            (G(f.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, c.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
            y.dispatchMessage(`open-current-main-window`, {})),
          y.dispatchMessage(`avatar-overlay-drag-end`, {}),
          i.hasMoved &&
            G(f.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, c.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          a != null &&

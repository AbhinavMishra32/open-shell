...
import { i as S, o as oe, r as se, t as ce } from "./flatten-DtM0XAMt.js";
import { c as C, d as le, h as ue, l as w, m as de, p as T, u as E } from "./merge-746dTbwN.js";
import { i as D } from "./union-sVWlQH_z.js";
var O = /\s/;
function k(e) {
...
function Ie(e, n, r, a) {
  ...
  for (var o = -1, s = n.length, c = s - 1, l = e; l != null && ++o < s; ) {
    ...
    if (o != c) {
      var f = l[u];
      ((d = a ? a(f, u, l) : void 0), d === void 0 && (d = x(f) ? f : ne(n[o + 1]) ? [] : {}));
    }
    (T(l, u, d), (l = l[u]));
  }
  return e;
...
function ze(e, t) {
  if (e !== t) {
    var n = e !== void 0,
      ...
      c = t === t,
      l = p(t);
    if ((!s && !l && !a && e > t) || (a && o && c && !s && !l) || (r && o && c) || (!n && c) || !i)
      return 1;
    if ((!r && !a && !l && e < t) || (l && n && i && !r && !a) || (s && n && i) || (!o && i) || !c)
      return -1;
  }
  return 0;
}
...
var ct = E(function (e, t) {
    ...
    var n = t.length;
    return (
      n > 1 && w(e, t[0], t[1]) ? (t = []) : n > 2 && w(t[0], t[1], t[2]) && (t = [t[0]]),
      Ve(e, u(t, 1), [])
    );
  }),
  lt = 0;
...
//# sourceMappingURL=zipObject--z_N7YgA.js.map

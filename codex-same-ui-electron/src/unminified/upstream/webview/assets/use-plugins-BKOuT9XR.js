...
var _e = h(),
  ...
  U = [`datadog`, `statsig`],
  W = new Set([`codex-official`, d, t, s, `openai-primary-runtime`].map(Ue));
function G(e) {
  return {
    ...Ze(e.summary),
...
function we(e, t, n) {
  ...
  let T = pe(w),
    E = t === void 0,
    D = qe({ codexHome: re, hostId: e, rootsOverrideCwd: t, workspaceRoots: h.data?.roots }),
...
function qe({ codexHome: e, hostId: t, rootsOverrideCwd: n, workspaceRoots: r }) {

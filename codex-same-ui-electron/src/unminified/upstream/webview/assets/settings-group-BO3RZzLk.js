...
function a(e) {
  let n = (0, r.c)(9),
    ...
    l = c === `default` ? `border border-token-border` : `bg-token-bg-secondary`,
    u;
  n[0] !== o || n[1] !== l
    ? ((u = t(
...
function o(e) {
  let n = (0, r.c)(6),
    { children: a, id: o, className: s } = e,
    c;
  n[0] === s ? (c = n[1]) : ((c = t(`flex flex-col`, s)), (n[0] = s), (n[1] = c));
  let l;
  return (
    n[2] !== a || n[3] !== o || n[4] !== c
      ? ((l = (0, i.jsx)(`section`, { id: o, className: c, children: a })),
        (n[2] = a),
        (n[3] = o),
        (n[4] = c),
        (n[5] = l))
...
function s(e) {
  ...
  let p = f
    ...
    m;
  n[1] !== c || n[2] !== p ? ((m = t(p, c)), (n[1] = c), (n[2] = p), (n[3] = m)) : (m = n[3]);
  let h = u === `none` ? `gap-0` : `gap-1`,
    g;
  n[4] === h ? (g = n[5]) : ((g = t(`flex min-w-0 flex-1 flex-col`, h)), (n[4] = h), (n[5] = g));
  let _;
  n[6] === a
    ? (_ = n[7])
    : ((_ = a
  ...
  n[14] === s
    ? (b = n[15])
    : ((b = s ? (0, i.jsx)(`div`, { className: `flex items-center gap-2`, children: s }) : null),
      (n[14] = s),
      (n[15] = b));
  let x;
  return (
...
function c(e) {
  let n = (0, r.c)(5),
    ...
    s;
  n[0] === o ? (s = n[1]) : ((s = t(`flex flex-col gap-1.5`, o)), (n[0] = o), (n[1] = s));
  let c;
  return (
    n[2] !== a || n[3] !== s
      ? ((c = (0, i.jsx)(`div`, { className: s, children: a })), (n[2] = a), (n[3] = s), (n[4] = c))
      : (c = n[4]),
    c
  );
}
...
//# sourceMappingURL=settings-group-BO3RZzLk.js.map

...
import { a as r, o as i, r as a, t as o } from "./tslib.es6-BbTQ3PDY.js";
function s(e, t) {
  var n = t && t.cache ? t.cache : _,
    r = t && t.serializer ? t.serializer : h;
  return (t && t.strategy ? t.strategy : f)(e, { cache: n, serializer: r });
}
function c(e) {
...
function fe(e) {
  ...
  for (
    var t = e.split(de).filter(function (e) {
        return e.length > 0;
      }),
      n = [],
      r = 0,
  ...
  for (var t = {}, n = 0, r = e; n < r.length; n++) {
    ...
    switch (i.stem) {
      ...
      case `integer-width`:
        ...
        i.options[0].replace(ge, function (e, n, r, i, a, o) {
    ...
    if (me.test(i.stem)) {
      ...
      i.stem.replace(me, function (e, n, r, i, a, o) {
        return (
          r === `*`
      ...
      var a = i.options[0];
      a === `w`
        ? (t = o(o({}, t), { trailingZeroDisplay: `stripIfInteger` }))
        : a && (t = o(o({}, t), ve(a)));
      continue;
    }
    if (he.test(i.stem)) {
...
function we(e) {
  ...
  return (
    ...
    (T[r || ``] || T[n || ``] || T[`${n}-001`] || T[`001`])[0]
  );
}
var Te = RegExp(`^${ce.source}*`),
  Ee = RegExp(`${ce.source}*\$`);
function E(e, t) {
  return { start: e, end: t };
}
var De = !!String.prototype.startsWith && `_a`.startsWith(`a`, 1),
  ...
  D = !0;
try {
  D = ze(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
} catch {
  D = !1;
}
var Pe = De
...
var k;
if (D) {
  var Be = ze(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`);
  k = function (e, t) {
  ...
  return (
    ...
    (e.prototype.parseMessage = function (e, t, n) {
      for (var r = []; !this.isEOF(); ) {
        ...
        if (i === 123) {
          ...
          (this.bump(), r.push({ type: b.pound, location: E(o, this.clonePosition()) }));
    ...
    (e.prototype.parseTag = function (e, t) {
      ...
      if ((this.bumpSpace(), this.bumpIf(`/>`)))
        return {
          val: { type: b.literal, value: `<${r}/>`, location: E(n, this.clonePosition()) },
          err: null,
        };
      if (this.bumpIf(`>`)) {
        ...
        if (this.bumpIf(`</`)) {
          if (this.isEOF() || !A(this.char()))
            return this.error(y.INVALID_TAG, E(o, this.clonePosition()));
          ...
          return r === this.parseTagName()
            ? (this.bumpSpace(),
              this.bumpIf(`>`)
                ...
                : this.error(y.INVALID_TAG, E(o, this.clonePosition())))
            : this.error(y.UNMATCHED_CLOSING_TAG, E(s, this.clonePosition()));
        } else return this.error(y.UNCLOSED_TAG, E(n, this.clonePosition()));
      } else return this.error(y.INVALID_TAG, E(n, this.clonePosition()));
    }),
    ...
    (e.prototype.parseLiteral = function (e, t) {
      ...
      var s = E(n, this.clonePosition());
      return { val: { type: b.literal, value: r, location: s }, err: null };
    }),
    (e.prototype.tryParseLeftAngleBracket = function () {
      return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !He(this.peek() || 0))
        ? (this.bump(), `<`)
        : null;
    }),
    ...
    (e.prototype.parseArgument = function (e, t) {
      ...
      if (!r) return this.error(y.MALFORMED_ARGUMENT, E(n, this.clonePosition()));
      ...
      switch (this.char()) {
        case 125:
          return (
            this.bump(),
            { val: { type: b.argument, value: r, location: E(n, this.clonePosition()) }, err: null }
          );
        case 44:
          return (
            this.bump(),
            this.bumpSpace(),
            this.isEOF()
              ? this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE, E(n, this.clonePosition()))
    ...
    (e.prototype.parseIdentifierIfPossible = function () {
      var e = this.clonePosition(),
        ...
        n = k(this.message, t),
        r = t + n.length;
      return (this.bumpTo(r), { value: n, location: E(e, this.clonePosition()) });
    }),
    (e.prototype.parseArgumentOptions = function (e, t, n, r) {
      ...
      switch (a) {
        case ``:
          return this.error(y.EXPECT_ARGUMENT_TYPE, E(i, s));
        case `number`:
        case `date`:
        case `time`:
          this.bumpSpace();
          ...
          if (this.bumpIf(`,`)) {
            ...
            if (d.length === 0)
              return this.error(
                y.EXPECT_ARGUMENT_STYLE,
                E(this.clonePosition(), this.clonePosition()),
              );
            c = { style: d, styleLocation: E(l, this.clonePosition()) };
          }
          var f = this.tryParseArgumentClose(r);
          if (f.err) return f;
          var p = E(r, this.clonePosition());
          if (c && Pe(c?.style, `::`, 0)) {
            var m = Le(c.style.slice(2));
            if (a === `number`) {
              var u = this.parseNumberSkeletonFromString(m, c.styleLocation);
              return u.err
                ? u
                : { val: { type: b.number, value: n, location: p, style: u.val }, err: null };
            } else {
              if (m.length === 0) return this.error(y.EXPECT_DATE_TIME_SKELETON, p);
              var h = m;
              this.locale && (h = Ce(m, this.locale));
              var d = {
                type: x.dateTime,
                pattern: h,
                location: c.styleLocation,
                parsedOptions: this.shouldParseSkeletons ? ue(h) : {},
              };
              return {
                val: { type: a === `date` ? b.date : b.time, value: n, location: p, style: d },
                err: null,
              };
            }
          }
        ...
        case `select`:
          ...
          if ((this.bumpSpace(), !this.bumpIf(`,`)))
            return this.error(y.EXPECT_SELECT_ARGUMENT_OPTIONS, E(g, o({}, g)));
          this.bumpSpace();
          ...
          if (a !== `select` && _.value === `offset`) {
            if (!this.bumpIf(`:`))
              return this.error(
                y.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                E(this.clonePosition(), this.clonePosition()),
              );
            this.bumpSpace();
            var u = this.tryParseDecimalInteger(
              y.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
              y.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE,
            );
            if (u.err) return u;
            (this.bumpSpace(), (_ = this.parseIdentifierIfPossible()), (v = u.val));
          }
          var S = this.tryParsePluralOrSelectOptions(e, a, t, _);
          if (S.err) return S;
          var f = this.tryParseArgumentClose(r);
          if (f.err) return f;
          var C = E(r, this.clonePosition());
          return a === `select`
            ? { val: { type: b.select, value: n, options: Fe(S.val), location: C }, err: null }
            : {
                val: {
                  type: b.plural,
                  value: n,
        ...
        default:
          return this.error(y.INVALID_ARGUMENT_TYPE, E(i, s));
      }
    }),
    (e.prototype.tryParseArgumentClose = function (e) {
      return this.isEOF() || this.char() !== 125
        ? this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE, E(e, this.clonePosition()))
      ...
      for (var e = 0, t = this.clonePosition(); !this.isEOF(); )
        switch (this.char()) {
          case 39:
            ...
            var n = this.clonePosition();
            if (!this.bumpUntil(`'`))
              return this.error(y.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, E(n, this.clonePosition()));
            this.bump();
            break;
          case 123:
            ((e += 1), this.bump());
    ...
    (e.prototype.tryParsePluralOrSelectOptions = function (e, t, n, r) {
      for (var i, a = !1, o = [], s = new Set(), c = r.value, l = r.location; ; ) {
        if (c.length === 0) {
          ...
          if (t !== `select` && this.bumpIf(`=`)) {
            var d = this.tryParseDecimalInteger(
              y.EXPECT_PLURAL_ARGUMENT_SELECTOR,
              y.INVALID_PLURAL_ARGUMENT_SELECTOR,
            );
            if (d.err) return d;
            ((l = E(u, this.clonePosition())), (c = this.message.slice(u.offset, this.offset())));
          } else break;
        }
        if (s.has(c))
          return this.error(
            t === `select`
              ? y.DUPLICATE_SELECT_ARGUMENT_SELECTOR
              : y.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
            l,
          );
        ...
        if (!this.bumpIf(`{`))
          return this.error(
            t === `select`
              ? y.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
              : y.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
            E(this.clonePosition(), this.clonePosition()),
          );
        ...
        if (m.err) return m;
        (o.push([c, { value: p.val, location: E(f, this.clonePosition()) }]),
          s.add(c),
          this.bumpSpace(),
      ...
      return o.length === 0
        ? this.error(
            t === `select` ? y.EXPECT_SELECT_ARGUMENT_SELECTOR : y.EXPECT_PLURAL_ARGUMENT_SELECTOR,
            E(this.clonePosition(), this.clonePosition()),
          )
        : this.requiresOtherClause && !a
          ? this.error(y.MISSING_OTHER_CLAUSE, E(this.clonePosition(), this.clonePosition()))
          : { val: o, err: null };
    }),
    (e.prototype.tryParseDecimalInteger = function (e, t) {
      ...
      var s = E(r, this.clonePosition());
      return i ? ((a *= n), Ne(a) ? { val: a, err: null } : this.error(t, s)) : this.error(e, s);
    }),
    ...
    (e.prototype.bumpIf = function (e) {
      if (Pe(this.message, e, this.offset())) {
...
function j(e) {
  e.forEach(function (e) {
    if ((delete e.location, re(e) || ie(e)))
      for (var t in e.options) (delete e.options[t].location, j(e.options[t].value));
    else
      (ee(e) && se(e.style)) || ((te(e) || ne(e)) && w(e.style))
...
var N = (function (e) {
  ...
  Je = (function (e) {
    a(t, e);
    function t(t, n, r) {
      return e.call(this, `Value for "${t}" must be of type ${n}`, M.INVALID_VALUE, r) || this;
    }
    return t;
  })(N),
  Ye = (function (e) {
...
function Xe(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== P.literal || t.type !== P.literal ? e.push(t) : (n.value += t.value),
          e
        );
      }, []);
}
...
function F(e, t, n, r, i, a, o) {
  if (e.length === 1 && S(e[0])) return [{ type: P.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    ...
    if (ae(u)) {
      typeof a == `number` && s.push({ type: P.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    if (!(i && d in i)) throw new Ye(d, o);
    var f = i[d];
    if (C(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        (f = typeof f == `string` || typeof f == `number` ? String(f) : ``),
        s.push({ type: typeof f == `string` ? P.literal : P.object, value: f }));
      continue;
    }
    if (te(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : w(u.style) ? u.style.parsedOptions : void 0;
    ...
    if (oe(u)) {
      var m = u.children,
        h = u.value,
        g = i[h];
      if (!Ze(g)) throw new Je(h, `function`, o);
      var _ = g(
        F(m, t, n, r, i, a).map(function (e) {
          return e.value;
        }),
      );
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? P.literal : P.object, value: e };
          }),
        ));
    }
    if (re(u)) {
      ...
      s.push.apply(s, F(v.value, t, n, r, i));
      continue;
    }
    if (ie(u)) {
      var v = u.options[`=${f}`];
...
`,
      ...
      if (!v) throw new qe(u.value, f, Object.keys(u.options), o);
      s.push.apply(s, F(v.value, t, n, r, i, f - (u.offset || 0)));
      continue;
    }
  }
  return Xe(s);
    ...
    e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
    {
      getNumberFormat: s(
        function () {
          ...
          return new ((e = Intl.NumberFormat).bind.apply(e, i([void 0], t, !1)))();
        },
        { cache: I(e.number), strategy: v.variadic },
      ),
      getDateTimeFormat: s(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
          return new ((e = Intl.DateTimeFormat).bind.apply(e, i([void 0], t, !1)))();
        },
        { cache: I(e.dateTime), strategy: v.variadic },
      ),
      getPluralRules: s(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
          return new ((e = Intl.PluralRules).bind.apply(e, i([void 0], t, !1)))();
        },
        { cache: I(e.pluralRules), strategy: v.variadic },
      ),
    }
  );
}
      ...
      if (
        ...
        (this.format = function (e) {
          ...
          var n = t.reduce(function (e, t) {
            return (
              !e.length || t.type !== P.literal || typeof e[e.length - 1] != `string`
                ? e.push(t.value)
        ...
        (this.formatToParts = function (e) {
          return F(s.ast, s.locales, s.formatters, s.formats, e, void 0, s.message);
        }),
        (this.resolvedOptions = function () {
          return {
            locale:
              s.resolvedLocale?.toString() || Intl.NumberFormat.supportedLocalesOf(s.locales)[0],
          };
        }),
...
${o.stack}`
    : ``
        ...
        (a.code = n),
        typeof Error.captureStackTrace == `function` && Error.captureStackTrace(a, t),
        a
      );
    }
    return t;
  ...
  nt = (function (e) {
    a(t, e);
    function t(t, n) {
      return e.call(this, L.UNSUPPORTED_FORMATTER, t, n) || this;
    }
    return t;
  })(R),
  rt = (function (e) {
    a(t, e);
    function t(t, n) {
      return e.call(this, L.INVALID_CONFIG, t, n) || this;
    }
    return t;
  })(R),
  it = (function (e) {
    a(t, e);
    function t(t, n) {
      return e.call(this, L.MISSING_DATA, t, n) || this;
    }
    return t;
  })(R),
  z = (function (e) {
...
function lt(e) {
  ...
  var t = Intl.RelativeTimeFormat,
    ...
    a = s(
      ...
      { cache: H(e.dateTime), strategy: v.variadic },
    ),
    c = s(
      function () {
        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      ...
      { cache: H(e.number), strategy: v.variadic },
    ),
    l = s(
      function () {
        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      ...
      { cache: H(e.pluralRules), strategy: v.variadic },
    );
  return {
    getDateTimeFormat: a,
    getNumberFormat: c,
    getMessageFormat: s(
      function (e, t, n, r) {
        return new tt(
          ...
          n,
          o(
            { formatters: { getNumberFormat: c, getDateTimeFormat: a, getPluralRules: l } },
            r || {},
          ),
        );
      },
      { cache: H(e.message), strategy: v.variadic },
    ),
    getRelativeTimeFormat: s(
      function () {
        var e = [...arguments];
        return new (t.bind.apply(t, i([void 0], e, !1)))();
      },
      { cache: H(e.relativeTime), strategy: v.variadic },
    ),
    getPluralRules: l,
    getListFormat: s(
      function () {
        var e = [...arguments];
        return new (n.bind.apply(n, i([void 0], e, !1)))();
      },
      { cache: H(e.list), strategy: v.variadic },
    ),
    getDisplayNames: s(
      function () {
        var e = [...arguments];
        return new (r.bind.apply(r, i([void 0], e, !1)))();
      },
      { cache: H(e.displayNames), strategy: v.variadic },
    ),
  };
}
function U(e, t, n, r) {
  ...
  r(new nt(`No ${t} format named: ${n}`));
}
function W(e, t) {
  return Object.keys(e).reduce(function (n, r) {
    return ((n[r] = o({ timeZone: t }, e[r])), n);
  }, {});
}
function ut(e, t) {
...
function dt(e, t) {
  ...
  var n = tt.formats;
  return o(o(o({}, n), e), {
    date: ut(W(n.date, t), W(e.date || {}, t)),
    time: ut(W(n.time, t), W(e.time || {}, t)),
  });
}
...
to autofix this issue`,
    ...
    var _ = String(h),
      v = c && Object.prototype.hasOwnProperty.call(c, _) && c[_];
    if (Array.isArray(v) && v.length === 1 && v[0].type === b.literal) return v[0].value;
    if (!r && v && typeof v == `string` && !m) return v.replace(/'\{(.*?)\}'/gi, `{$1}`);
    if (((r = o(o({}, m), r || {})), (s = dt(s, p)), (u = dt(u, p)), !v)) {
      if (d === !1 && v === ``) return v;
      if (((!g || (a && a.toLowerCase() !== l.toLowerCase())) && f(new at(n, a)), g))
        try {
          var y = t.getMessageFormat(g, l, u, i);
          return y.format(r);
        } catch (e) {
          return (
            f(
    ...
    try {
      var y = t.getMessageFormat(v, a, s, o({ formatters: t }, i || {}));
      return y.format(r);
    } catch (e) {
      f(
        new B(
...
function K(e, t, n, r) {
  ...
  r === void 0 && (r = {});
  var l = r.format,
    u = o(o({}, c && { timeZone: c }), l && U(a, t, l, s)),
    d = V(r, ft, u);
  return (
    t === `time` &&
      !d.hour &&
      ...
      !d.timeStyle &&
      !d.dateStyle &&
      (d = o(o({}, d), { hour: `numeric`, minute: `numeric` })),
    n(i, d)
  );
}
function pt(e, t) {
...
function ht(e, t) {
  ...
  try {
    return K(e, `dateTimeRange`, t, o).formatRange(s, c);
  } catch (t) {
...
function gt(e, t) {
  var n = [...arguments].slice(2),
    ...
    o = typeof r == `string` ? new Date(r || 0) : r;
  try {
    return K(e, `date`, t, a).formatToParts(o);
  } catch (t) {
    e.onError(new z(`Error formatting date.`, e.locale, t));
  }
  return [];
...
function _t(e, t) {
  var n = [...arguments].slice(2),
    ...
    o = typeof r == `string` ? new Date(r || 0) : r;
  try {
    return K(e, `time`, t, a).formatToParts(o);
  } catch (t) {
    e.onError(new z(`Error formatting time.`, e.locale, t));
  }
  return [];
}
var vt = [`style`, `type`, `fallback`, `languageDisplay`];
function yt(e, t, n, r) {
  var i = e.locale,
    a = e.onError;
  Intl.DisplayNames ||
...
`,
  ...
  try {
    ...
    a(new z(`Error formatting display name.`, i, e));
  }
}
var bt = [`type`, `style`],
  xt = Date.now();
...
function Ct(e, t, n, r) {
  r === void 0 && (r = {});
  var i = wt(e, t, n, r).reduce(function (e, t) {
    var n = t.value;
    return (
...
`,
  ...
  try {
    var c = {},
      l = Array.from(n).map(function (e, t) {
    ...
    return t(i, s)
      .formatToParts(l)
      .map(function (e) {
        return e.type === `literal` ? e : o(o({}, e), { value: c[e.value] || e.value });
      });
  } catch (e) {
    a(new z(`Error formatting list.`, i, e));
  }
  return n;
}
var Tt = [`type`];
...
`,
  ...
  try {
    ...
    a(new z(`Error formatting plural.`, i, e));
  }
  return `other`;
}
...
function Nt(e, t, n, r) {
  r === void 0 && (r = {});
  try {
    return jt(e, t, r).formatToParts(n);
  } catch (t) {
    e.onError(new z(`Error formatting number.`, e.locale, t));
  }
  return [];
...
function It(e, t) {
  ...
  return (
    ...
    o(o({}, r), {
      ...
      formatNumberToParts: Nt.bind(null, r, n.getNumberFormat),
      formatRelativeTime: kt.bind(null, r, n.getRelativeTimeFormat),
      formatDate: pt.bind(null, r, n.getDateTimeFormat),
      formatDateToParts: gt.bind(null, r, n.getDateTimeFormat),
      formatTime: mt.bind(null, r, n.getDateTimeFormat),
      formatDateTimeRange: ht.bind(null, r, n.getDateTimeFormat),
      formatTimeToParts: _t.bind(null, r, n.getDateTimeFormat),
      formatPlural: Et.bind(null, r, n.getPluralRules),
      formatMessage: G.bind(null, r, n),
      $t: G.bind(null, r, n),
      formatList: Ct.bind(null, r, n.getListFormat),
      formatListToParts: wt.bind(null, r, n.getListFormat),
      formatDisplayName: yt.bind(null, r, n.getDisplayNames),
    })
  );
}
var q = e(n());
...
var zt = o(o({}, st), { textComponent: q.Fragment }),
  Bt = function (e, t) {
    return q.isValidElement(e) ? q.cloneElement(e, { key: t }) : e;
  },
  Vt = function (e) {
    return q.Children.map(e, Bt) ?? [];
  };
function Ht(e) {
  return function (t) {
    return e(Vt(t));
...
var Y =
  typeof window < `u` && !window.__REACT_INTL_BYPASS_GLOBAL_CONTEXT__
    ? window.__REACT_INTL_CONTEXT__ || (window.__REACT_INTL_CONTEXT__ = q.createContext(null))
    : q.createContext(null);
Y.Consumer;
var Gt = Y.Provider,
  Kt = Y;
function X() {
  var e = q.useContext(Kt);
  return (Rt(e), e);
}
var qt;
(function (e) {
...
var Yt = function (e) {
  var t = X(),
    n = e.value,
    i = e.children,
    a = r(e, [`value`, `children`]);
  return i(t.formatNumberToParts(n, a));
};
((Yt.displayName = `FormattedNumberParts`), (Yt.displayName = `FormattedNumberParts`));
function Xt(e) {
  var t = function (t) {
    var n = X(),
      i = t.value,
      a = t.children,
      o = r(t, [`value`, `children`]),
      s = typeof i == `string` ? new Date(i || 0) : i;
    return a(e === `formatDate` ? n.formatDateToParts(s, o) : n.formatTimeToParts(s, o));
  };
...
function Z(e) {
  var t = function (t) {
    ...
    var c = n.textComponent || q.Fragment;
    return q.createElement(c, null, s);
  };
  return ((t.displayName = qt[e]), t);
}
function Zt(e) {
  return (
    e &&
    Object.keys(e).reduce(function (t, n) {
      var r = e[n];
      return ((t[n] = Ze(r) ? Ht(r) : r), t);
    }, {})
  );
}
var Qt = function (e, t, n, r) {
    var a = [...arguments].slice(4),
      o = Zt(r),
      s = G.apply(void 0, i([e, t, n, o], a, !1));
    return Array.isArray(s) ? Vt(s) : s;
  },
  Q = function (e, t) {
    var n = e.defaultRichTextElements,
      i = r(e, [`defaultRichTextElements`]),
      a = Zt(n),
      s = It(o(o(o({}, zt), i), { defaultRichTextElements: a }), t),
      c = {
        locale: s.locale,
        timeZone: s.timeZone,
    ...
    return o(o({}, s), {
      formatMessage: Qt.bind(null, c, s.formatters),
      $t: Qt.bind(null, c, s.formatters),
    });
  };
function $t(e, t) {
  var n = e.values,
...
function en(e) {
  ...
  return typeof l == `function`
    ...
    : d
      ? q.createElement(d, null, p)
      : q.createElement(q.Fragment, null, p);
}
en.displayName = `FormattedMessage`;
var tn = q.memo(en, $t);
tn.displayName = `MemoizedFormattedMessage`;
function nn(e) {
  return {
    locale: e.locale,
    timeZone: e.timeZone,
...
var rn = (function (e) {
    ...
    function t() {
      ...
      return (
        (t.cache = ct()),
        (t.state = { cache: t.cache, intl: Q(nn(t.props), t.cache), prevConfig: nn(t.props) }),
        t
      );
    }
    return (
      (t.getDerivedStateFromProps = function (e, t) {
        var n = t.prevConfig,
          r = t.cache,
          i = nn(e);
        return J(n, i) ? null : { intl: Q(i, r), prevConfig: i };
      }),
      (t.prototype.render = function () {
        return (
          Rt(this.state.intl),
          q.createElement(Gt, { value: this.state.intl }, this.props.children)
        );
      }),
...
function cn(e) {
  var t = Math.abs(e);
  return t < an ? `second` : t < on ? `minute` : t < sn ? `hour` : `day`;
}
function ln(e) {
  switch (e) {
    case `second`:
...
var dn = [`second`, `minute`, `hour`];
function $(e) {
  return (e === void 0 && (e = `second`), dn.indexOf(e) > -1);
}
var fn = function (e) {
    var t = X(),
      ...
      o = e.value,
      s = e.unit,
      c = r(e, [`children`, `value`, `unit`]),
      l = n(o || 0, s, c);
    return typeof a == `function`
      ? a(l)
      : i
        ? q.createElement(i, null, l)
  ...
  pn = function (e) {
    var t = e.value,
      ...
      c = r(e, [`value`, `unit`, `updateIntervalInSeconds`]);
    Lt(!s || !!(s && $(a)), `Cannot schedule update with unit longer than hour`);
    var l = q.useState(),
      u = l[0],
      d = l[1],
      f = q.useState(0),
      ...
      _ = h[1],
      v;
    ((a !== u || n !== p) && (m(n || 0), d(a), _($(a) ? un(n, a) : 0)),
      q.useEffect(
        function () {
          function e() {
            clearTimeout(v);
    ...
    var y = n || 0,
      b = a;
    if ($(a) && typeof g == `number` && s) {
      b = cn(g);
      var x = ln(b);
      y = Math.round(g / x);
    }
    return q.createElement(fn, o({ value: y, unit: b }, c));
  };
pn.displayName = `FormattedRelativeTime`;
function mn(e) {
  return e;
}
function hn(e) {
...
(Z(`formatDate`), Z(`formatTime`));
var gn = Z(`formatNumber`);
(Z(`formatList`), Z(`formatDisplayName`), Xt(`formatDate`), Xt(`formatTime`));
export { rn as a, X as c, pn as i, hn as n, tn as o, mn as r, Q as s, gn as t };
//# sourceMappingURL=lib-MoKmYgcO.js.map

...
import { lt as n, p as r } from "./vscode-api-sUstfl-x.js";
var i = n(),
  a = e(t(), 1),
  o = 16,
  s = Object.freeze({
    ...
    mac: Object.freeze({
      legacy: Object.freeze({ left: 66 + o, right: 0 }),
      modern: Object.freeze({ left: 76 + o, right: 0 }),
    }),
...
function d(e, t) {
  if (e || typeof navigator > `u`) return s.default;
  let n = navigator,
  ...
  return i.includes(`darwin`) ||
    ...
    ? l(r)
    : i.includes(`win`) || r.includes(`windows`)
      ? (t ?? s.windows)
      : i.includes(`linux`)
        ? s.linux
        : s.default;
...
function f() {
  ...
  (e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (e) => {
      ...
      (e[1] = l))
    : ((c = e[0]), (l = e[1])),
    r(`window-fullscreen-changed`, c, l));
  let f, m;
  ...
  let _;
  return (
    e[6] !== t || e[7] !== o ? ((_ = d(t, o)), (e[6] = t), (e[7] = o), (e[8] = _)) : (_ = e[8]),
    _
  );
}
function p() {
...
export { f as t };
//# sourceMappingURL=use-window-controls-safe-area-X2AodDul.js.map

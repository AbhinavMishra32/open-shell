...
var w = (function () {
  ...
  T = S(
    w
      ? function (e, t) {
          return w(e, `toString`, { configurable: !0, enumerable: !1, value: C(t), writable: !0 });
        }
      : f,
  );
function E(e, t, n) {
...
function j(e, t, n) {
  return (
    ...
    function () {
      for (var r = arguments, i = -1, a = A(r.length - t, 0), o = Array(a); ++i < a; )
        o[i] = r[t + i];
      i = -1;
...
function N(e, t, r) {
  if (!v(r)) return !1;
  var i = typeof t;
  return (i == `number` ? u(r) && s(t, r.length) : i == `string` && t in r) ? n(r[t], e) : !1;
}
function P(e) {

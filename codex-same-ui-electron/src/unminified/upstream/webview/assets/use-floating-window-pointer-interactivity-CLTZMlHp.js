...
function a(e) {
  let t = (0, r.c)(24),
    {
      activationNonce: n,
      floatingElementSelectors: a,
      includeInteractiveRegion: l,
      interactiveRegionRef: u,
      isPaused: d,
      onInteractiveChange: f,
      regionElementSelectors: p,
    } = e,
    m;
  ...
  let h = m,
    g = l === void 0 ? !1 : l,
    _;
  t[2] === p ? (_ = t[3]) : ((_ = p === void 0 ? [] : p), (t[2] = p), (t[3] = _));
  let v = _,
    [y, b] = (0, i.useState)(!1),
    x;
  t[4] === d ? (x = t[5]) : ((x = () => d?.() ?? !1), (t[4] = d), (t[5] = x));
  let S = (0, i.useEffectEvent)(x),
    C;
  t[6] === f
    ? (C = t[7])
    : ((C = (e) => {
  ...
  t[16] !== E
    ? ((D = () => {
        let e = null,
          ...
          a = (e) => {
            let t = u.current;
            if (t == null || (g && s(e, t))) return !0;
            for (let n of v) {
              let r = t.querySelectorAll(n);
              for (let t of r) if (c(t) && s(e, t)) return !0;
            }
            for (let t of h) {
              let n = document.querySelectorAll(t);
              for (let t of n) if (c(t) && s(e, t)) return !0;
            }
            return !1;
          },
          l = () => {
            ((r = null), !(n == null || S()) && ((t = n), i(a(n))));
          },
          d = () => {
          ...
          _ = () => {
            ...
            let e = o({
              ...
              includeInteractiveRegion: g,
              interactiveRegion: u.current,
              regionElementSelectors: v,
            });
            e != null && i(e);
          },
  ...
  let O;
  return (
    t[18] !== n || t[19] !== h || t[20] !== g || t[21] !== u || t[22] !== v
      ? ((O = [n, h, g, u, v]),
        (t[18] = n),
        (t[19] = h),
        (t[20] = g),
...
function o({
  ...
  if (n != null) {
    ...
    for (let e of r) {
      ...
      for (let e of t) if (c(e) && e.matches(`:hover`)) return !0;
    }
  }
  for (let t of e) {
    let e = document.querySelectorAll(t);
    for (let t of e) if (c(t) && t.matches(`:hover`)) return !0;
  }
  return document.documentElement.matches(`:hover`) ? !1 : null;
}
function s(e, t) {
  return l(e, t.getBoundingClientRect())
    ? document.elementsFromPoint(e.x, e.y).some((e) => e === t || t.contains(e))
    : !1;
}
function c(e) {
  let t = window.getComputedStyle(e);
  if (t.display === `none` || t.visibility === `hidden` || t.pointerEvents === `none`) return !1;
...
export { a as t };
//# sourceMappingURL=use-floating-window-pointer-interactivity-CLTZMlHp.js.map

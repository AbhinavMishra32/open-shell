...
import { t as r } from "./spinner-Dvc_A3Ae.js";
var i = {
...
function l(e) {
  ...
  n[16] === S
    ? (k = n[17])
    : ((k = S && (0, o.jsx)(r, { className: `icon-xxs` })), (n[16] = S), (n[17] = k));
  let A;
  return (
    n[18] !== l || n[19] !== d || n[20] !== D || n[21] !== O || n[22] !== k || n[23] !== C
      ? ((A = (0, o.jsxs)(`button`, {
          type: C,
          className: D,
          disabled: O,
...
//# sourceMappingURL=button-Xd4Hy1MO.js.map

...
var v = { $type: `protobuf_analytics_events.v1.CodexMemorySettingToggled` },
  y = { $type: `protobuf_analytics_events.v1.CodexMemoryResetClicked` },
  b = { $type: `protobuf_analytics_events.v1.CodexMemoryStateSnapshot` },
...
var w = i(),
  T = e(),
  E = `Describe what I'm working on right now and suggest how I can use Codex to help.`;
function D(e) {
  let n = (0, w.c)(43),
    { open: r, setupState: i, onAskCodex: a, onOpenChange: c } = e,
    l = o(),
    v = i.kind === `ready`,
    y = i.kind === `failed`,

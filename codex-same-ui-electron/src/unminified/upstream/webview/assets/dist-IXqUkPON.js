...
((e.prototype = {
  ...
  update: function (t, n, r) {
    var i = r && r != t ? this.remove(r) : this,
      a = i.find(t),
      o = i.content.slice();
...
function n(e, t, r, i) {
  for (let a = e.childCount, o = t.childCount; ; ) {
    if (a == 0 || o == 0) return a == o ? null : { a: r, b: i };
    let s = e.child(--a),
      c = t.child(--o),
      l = s.nodeSize;
    if (s == c) {
    ...
    if (!s.sameMarkup(c)) return { a: r, b: i };
    if (s.isText && s.text != c.text) {
      let e = 0,
        t = Math.min(s.text.length, c.text.length);
      for (; e < t && s.text[s.text.length - e - 1] == c.text[c.text.length - e - 1]; )
        (e++, r--, i--);
      return { a: r, b: i };
    }
            ...
            : o.isLeaf
              ? r
                ...
                : o.type.spec.leafText
                  ...
                  : ``
              : ``;
          (o.isBlock && ((o.isLeaf && c) || o.isTextblock) && n && (a ? (a = !1) : (i += n)),
            (i += c));
        },
        0,
      ),
        ...
        (s > t &&
          ((a < t || s > n) &&
            (o = o.isText
              ...
              : o.cut(Math.max(0, t - a - 1), Math.min(o.content.size, n - a - 1))),
          r.push(o),
          (i += o.nodeSize)),
          (a = s));
      }
    ...
    for (let e = 0; e < t.length; e++) {
      ...
      ((r += i.nodeSize),
        e && i.isText && t[e - 1].sameMarkup(i)
          ? ((n ||= t.slice(0, e)), (n[n.length - 1] = i.withText(n[n.length - 1].text + i.text)))
          : n && n.push(i));
    }
    return new e(n || t, r);
  }
  ...
  addToSet(e) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      if (this.type.excludes(i.type)) t ||= e.slice(0, r);
        ...
        (!n && i.type.rank > this.type.rank && ((t ||= e.slice(0, r)), t.push(this), (n = !0)),
          t && t.push(i));
    }
...
var c = class extends Error {},
  l = class e {
    ...
    removeBetween(t, n) {
      return new e(
        u(this.content, t + this.openStart, n + this.openStart),
        this.openStart,
        this.openEnd,
      );
    }
    ...
    static maxOpen(t, n = !0) {
      let r = 0,
        i = 0;
      for (let e = t.firstChild; e && !e.isLeaf && (n || !e.type.spec.isolating); e = e.firstChild)
        r++;
      for (let e = t.lastChild; e && !e.isLeaf && (n || !e.type.spec.isolating); e = e.lastChild)
        i++;
      return new e(t, r, i);
    }
  };
...
function p(e, t, n, r) {
  ...
  } else if (!n.content.size) return v(a, y(e, t, r));
...
function ee(e, t, n, i, a) {
  let o = e.depth > a && h(e, t, a + 1),
    s = i.depth > a && h(n, i, a + 1),
    c = [];
  return (
    _(null, e, a, c),
    o && s && t.index(a) == n.index(a)
      ? (m(o, s), g(v(o, ee(e, t, n, i, a + 1)), c))
      : (o && g(v(o, y(e, t, a + 1)), c), _(t, n, a, c), s && g(v(s, y(n, i, a + 1)), c)),
    _(i, null, a, c),
    new r(c)
  );
}
function y(e, t, n) {
  ...
  return (
    _(null, e, n, i),
    e.depth > n && g(v(h(e, t, n + 1), y(e, t, n + 1)), i),
    _(t, null, n, i),
    new r(i)
  );
}
...
var ne = class e {
    ...
    blockRange(e = this, t) {
      ...
      for (
        ...
        if (e.pos <= this.end(n) && (!t || t(this.node(n)))) return new oe(this, e, n);
      return null;
    }
    sameParent(e) {
  ...
  b = class e {
    ...
    hasMarkup(e, t, n) {
      return (
        this.type == e &&
        o(this.attrs, t || e.defaultAttrs || se) &&
    ...
    canReplace(e, t, n = r.empty, i = 0, a = n.childCount) {
      let o = this.contentMatchAt(e).matchFragment(n, i, a),
    ...
    static fromJSON(e, t) {
      ...
      let i = r.fromJSON(e, t.content),
        a = e.nodeType(t.type).create(t.attrs, i, n);
      return (a.type.checkAttrs(a.attrs), a);
    }
  };
b.prototype.text = void 0;
var ce = class e extends b {
  constructor(e, t, n, r) {
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : le(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
    ...
    for (; n.length; ) {
      ...
      for (let e = 0; e < i.next.length; e++) {
        ...
        !a.isLeaf &&
          ...
          !(a.name in t) &&
          (!r.type || o.validEnd) &&
          (n.push({ match: a.contentMatch, type: a, via: r }), (t[a.name] = !0));
      }
    }
    return null;
  }
...
var De = class e {
  constructor(e, t, n) {
    ((this.name = e),
      ...
      (this.attrs = Ee(e, n.attrs)),
      (this.defaultAttrs = Ce(this.attrs)),
  ...
  create(e = null, t, n) {
    ...
    return new b(this, this.computeAttrs(e), r.from(t), s.setFrom(n));
  }
  createChecked(e = null, t, n) {
    return (
      (t = r.from(t)),
      this.checkContent(t),
      new b(this, this.computeAttrs(e), t, s.setFrom(n))
    );
  }
  createAndFill(e = null, t, n) {
    ...
    let i = this.contentMatch.matchFragment(t),
      a = i && i.fillBefore(r.empty, !0);
    return a ? new b(this, e, t.append(a), s.setFrom(n)) : null;
  }
  validContent(e) {
  ...
  checkContent(e) {
    if (!this.validContent(e))
      throw RangeError(`Invalid content for node ${this.name}: ${e.toString().slice(0, 50)}`);
  }
  checkAttrs(e) {
  ...
  allowedMarks(e) {
    ...
    for (let n = 0; n < e.length; n++)
      this.allowsMarkType(e[n].type) ? t && t.push(e[n]) : (t ||= e.slice(0, n));
...
function Oe(e, t, n) {
  ...
  return (n) => {
    ...
    if (r.indexOf(i) < 0)
      throw RangeError(`Expected value of type ${r} for attribute ${t} on type ${e}, got ${i}`);
  };
}
var ke = class {
    constructor(e, t, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, `default`)),
        ...
        (this.validate = typeof n.validate == `string` ? Oe(e, t, n.validate) : n.validate));
    }
    get isRequired() {
  ...
  Ae = class e {
    constructor(e, t, n, r) {
      ((this.name = e),
        ...
        (this.schema = n),
        (this.spec = r),
        (this.attrs = Ee(e, r.attrs)),
        (this.excluded = null));
      let i = Ce(this.attrs);
      this.instance = i ? new s(this, i) : null;
    }
    create(e = null) {
      return !e && this.instance ? this.instance : new s(this, we(this.attrs, e));
    }
    static compile(t, n) {
      let r = Object.create(null),
        i = 0;
  ...
  je = class {
    constructor(t) {
      ...
      ((n.nodes = e.from(t.nodes)),
        (n.marks = e.from(t.marks || {})),
        (this.nodes = De.compile(this.spec.nodes, this)),
        (this.marks = Ae.compile(this.spec.marks, this)));
      let r = Object.create(null);
      for (let e in this.nodes) {
        ...
        let t = this.nodes[e],
          ...
          i = t.spec.marks;
        if (
          ((t.contentMatch = r[n] || (r[n] = x.parse(n, this.nodes))),
        ...
        t.markSet =
          i == `_` ? null : i ? Me(this, i.split(` `)) : i == `` || !t.inlineContent ? [] : null;
      }
      ...
      ((this.nodeFromJSON = (e) => b.fromJSON(this, e)),
    ...
    node(e, t = null, n, r) {
      if (typeof e == `string`) e = this.nodeType(e);
        ...
        throw RangeError(`Node type from different schema used (` + e.name + `)`);
      return e.createChecked(t, n, r);
    }
    text(e, t) {
      let n = this.nodes.text;
      return new ce(n, n.defaultAttrs, e, s.setFrom(t));
    }
    mark(e, t) {
...
var Fe = class e {
    ...
    static schemaRules(e) {
      ...
      for (let t in e.marks) {
        ...
        r &&
          r.forEach((e) => {
            (n((e = Ue(e))), e.mark || e.ignore || e.clearMark || (e.mark = t));
          });
      }
      for (let t in e.nodes) {
        ...
        r &&
          r.forEach((e) => {
            (n((e = Ue(e))), e.node || e.ignore || e.mark || (e.node = t));
          });
      }
      return t;
    }
  ...
  Le = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  Re = { ol: !0, ul: !0 },
  S = 1,
  C = 2,
  w = 4;
...
var T = class {
    constructor(e, t, n, r, i, a) {
      ((this.type = e),
        ...
        (this.match = i || (a & w ? null : e.contentMatch)));
    }
    findWrapping(e) {
      if (!this.match) {
        if (!this.type) return [];
    ...
    finish(e) {
      ...
      return (
        !e && this.match && (t = t.append(this.match.fillBefore(r.empty, !0))),
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode && !Ie.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  Be = class {
    constructor(e, t, n) {
      ...
      let r = t.topNode,
        i,
        a = ze(null, t.preserveWhitespace, 0) | (n ? w : 0);
      ((i = r
        ? new T(r.type, r.attrs, s.none, !0, t.topMatch || r.type.contentMatch, a)
        : n
          ? new T(null, null, s.none, !0, null, a)
          : new T(e.schema.topNodeType, null, s.none, !0, null, a)),
        (this.nodes = [i]),
    ...
    addTextNode(e, t) {
      let n = e.nodeValue,
        r = this.top,
        i = r.options & C ? `full` : this.localPreserveWS || (r.options & S) > 0,
...
`,
    ...
    addElement(e, t, n) {
      ...
      let a = e.nodeName.toLowerCase(),
        o;
      Re.hasOwnProperty(a) && this.parser.normalizeLists && Ve(e);
      let s =
...
`),
    ...
    addElementByRule(e, t, n, r) {
      ...
      if (a && a.isLeaf) this.findInside(e);
        ...
        (this.findInside(e),
          t.getContent(e, this.parser.schema).forEach((e) => this.insertNode(e, n, !1)));
      else {
        let r = e;
    ...
    addAll(e, t, n, r) {
      let i = n || 0;
      for (
        let a = n ? e.childNodes[n] : e.firstChild, o = r == null ? null : e.childNodes[r];
        a != o;
        a = a.nextSibling, ++i
      )
    ...
    insertNode(e, t, n) {
      ...
      if (r) {
        ...
        for (let i of r.concat(e.marks))
          (t.type ? t.type.allowsMarkType(i.type) : We(i.type, e.type)) && (n = i.addToSet(n));
    ...
    enterInner(e, t, n, r = !1, i) {
      ...
      let o = ze(e, i, a.options);
      a.options & w && a.content.length == 0 && (o |= w);
      let c = s.none;
      return (
        (n = n.filter((t) =>
          (a.type ? a.type.allowsMarkType(t.type) : We(t.type, e)) ? ((c = t.addToSet(c)), !1) : !0,
        )),
        this.nodes.push(new T(e, t, c, r, null, o)),
        this.open++,
        n
      );
    }
    ...
    sync(e) {
      for (let t = this.open; t >= 0; t--)
        ...
        else this.localPreserveWS && (this.nodes[t].options |= S);
      return !1;
    }
    get currentPos() {
      this.closeExtra();
...
var Ge = class e {
  ...
  static fromSchema(t) {
    return (
      ...
      (t.cached.domSerializer = new e(this.nodesFromSchema(t), this.marksFromSchema(t)))
    );
  }
...
function Je(e) {
  let t = qe.get(e);
  return (t === void 0 && qe.set(e, (t = Ye(e))), t);
}
function Ye(e) {
  let t = null;
  function n(e) {
...
var tt = 1,
  ...
  k = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (tt | O)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (nt | O)) > 0;
    }
    get deletedAcross() {
      return (this.delInfo & O) > 0;
    }
  },
  A = class e {
    constructor(t, n = !1) {
      ...
      for (let o = 0; o < this.ranges.length; o += 3) {
        ...
        if (e <= u) {
          let i = c ? (e == s ? -1 : e == u ? 1 : t) : t,
            a = s + r + (i < 0 ? 0 : l);
          if (n) return a;
          let d = e == (t < 0 ? s : u) ? null : Qe(o / 3, e - s),
            f = e == s ? nt : e == u ? tt : O;
          return ((t < 0 ? e != s : e != u) && (f |= rt), new k(a, f, d));
        }
        r += l - c;
      }
      return n ? e + r : new k(e + r, 0, null);
    }
    touches(e, t) {
      let n = 0,
        r = $e(t),
...
var it = class e {
  ...
  M = class {
    ...
    static jsonID(e, t) {
      if (e in j) throw RangeError(`Duplicate use of step JSON ID ` + e);
      return ((j[e] = t), (t.prototype.jsonID = e), t);
    }
  },
  N = class e {
    constructor(e, t) {
...
function P(e, t, n) {
  ...
  for (let r = 0; r < e.childCount; r++) {
    let a = e.child(r);
    (a.content.size && (a = a.copy(P(a.content, t, a))), a.isInline && (a = t(a, n, r)), i.push(a));
  }
...
var F = class e extends M {
  ...
  apply(e) {
    ...
    return N.fromReplace(e, this.from, this.to, i);
  }
  invert() {
...
M.jsonID(`removeMark`, I);
var L = class e extends M {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return N.fail(`No node at mark step's position`);
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return N.fromReplace(e, this.pos, this.pos + 1, new l(r.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(t) {
...
M.jsonID(`addNodeMark`, L);
var R = class e extends M {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return !t || !this.mark.isInSet(t.marks) ? this : new L(this.pos, this.mark);
  }
  map(t) {
    let n = t.mapResult(this.pos, 1);
    return n.deletedAfter ? null : new e(n.pos, this.mark);
...
M.jsonID(`removeNodeMark`, R);
var z = class e extends M {
  constructor(e, t, n, r = !1) {
    (super(), (this.from = e), (this.to = t), (this.slice = n), (this.structure = r));
  }
  apply(e) {
    return this.structure && V(e, this.from, this.to)
      ? N.fail(`Structure replace would overwrite content`)
      : N.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
((z.MAP_BIAS = 1), M.jsonID(`replace`, z));
var B = class e extends M {
  ...
  apply(e) {
    if (this.structure && (V(e, this.from, this.gapFrom) || V(e, this.gapTo, this.to)))
      return N.fail(`Structure gap-replace would overwrite content`);
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return N.fail(`Gap is not a flat range`);
  ...
  (e.doc.nodesBetween(t, n, (e, c, l) => {
    ...
    if (!r.isInSet(u) && l.type.allowsMarkType(r.type)) {
      ...
      for (let e = 0; e < u.length; e++)
        u[e].isInSet(f) ||
          (o && o.to == l && o.mark.eq(u[e]) ? (o.to = d) : i.push((o = new I(l, d, u[e]))));
      s && s.to == l ? (s.to = d) : a.push((s = new F(l, d, r)));
    }
  }),
  ...
  (e.doc.nodesBetween(t, n, (e, o) => {
    ...
    if (s && s.length) {
      ...
      for (let e = 0; e < s.length; e++) {
        ...
        c ? ((c.to = r), (c.step = a)) : i.push({ style: n, from: Math.max(o, t), to: r, step: a });
      }
    }
  }),
    i.forEach((t) => e.step(new I(t.from, t.to, t.style))));
}
function st(e, t, n, i = n.contentMatch, a = !0) {
  ...
  for (let t = 0; t < o.childCount; t++) {
    let u = o.child(t),
      d = c + u.nodeSize,
      f = i.matchType(u.type);
    if (!f) s.push(new z(c, d, l.empty));
    else {
      i = f;
      for (let t = 0; t < u.marks.length; t++)
        n.allowsMarkType(u.marks[t].type) || e.step(new I(c, d, u.marks[t]));
      if (a && u.isText && n.whitespace != `pre`) {
        let e,
          t = /\r?\n|\r/g,
          i;
        for (; (e = t.exec(u.text)); )
          ((i ||= new l(r.from(n.schema.text(` `, n.allowedMarks(u.marks))), 0, 0)),
            s.push(new z(c + e.index, c + e.index + e[0].length, i)));
      }
    }
    c = d;
  }
...
function ct(e, t, n) {
  ...
  for (let e = o, t = !1; e > n; e--)
    t || i.index(e) > 0 ? ((t = !0), (f = r.from(i.node(e).copy(f))), p++) : u--;
  let m = r.empty,
    h = 0;
  for (let e = o, t = !1; e > n; e--)
    t || a.after(e + 1) < a.end(e) ? ((t = !0), (m = r.from(a.node(e).copy(m))), h++) : d++;
  e.step(new B(u, d, s, c, new l(f.append(m), p, h), f.size - p, !0));
}
function lt(e, t, n) {
  let i = r.empty;
  ...
  let a = t.start,
    o = t.end;
  e.step(new B(a, o, a, o, new l(i, 0, 0), n.length, !0));
}
  ...
  e.doc.nodesBetween(t, n, (t, n) => {
    ...
    if (t.isTextblock && !t.hasMarkup(i, s) && pt(e.doc, e.mapping.slice(o).map(n), i)) {
      ...
      if (i.schema.linebreakReplacement) {
        let e = i.whitespace == `pre`,
          t = !!i.contentMatch.matchType(i.schema.linebreakReplacement);
        e && !t ? (a = !1) : !e && t && (a = !0);
      }
      (a === !1 && ft(e, t, n, o), st(e, e.mapping.slice(o).map(n, 1), i, void 0, a === null));
      let c = e.mapping.slice(o),
        u = c.map(n, 1),
        d = c.map(n + t.nodeSize, 1);
      return (
        e.step(new B(u, d, u + 1, d - 1, new l(r.from(i.create(s, null, t.marks)), 0, 0), 1, !0)),
        a === !0 && dt(e, t, n, o),
        !1
      );
    }
...
function mt(e, t, n, i, a) {
  ...
  e.step(new B(t, t + o.nodeSize, t + 1, t + o.nodeSize - 1, new l(r.from(s), 0, 0), 1, !0));
}
function ht(e, t, n = 1, i) {
  ...
  e.step(new z(t, t, new l(o.append(s), n, n), !0));
}
function gt(e, t, n) {
  let r = null,
  ...
  let c = e.mapping.slice(s),
    u = c.map(t - n);
  if ((e.step(new z(u, c.map(t + n, -1), l.empty, !0)), r === !0)) {
    let t = e.doc.resolve(u);
    dt(e, t.node(), t.before(), e.steps.length);
  }
  return e;
}
function _t(e, t, n) {
...
function yt(e, t, n = t, r = l.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    a = e.resolve(n);
  return bt(i, a, r) ? new z(t, n, r) : new xt(i, a, r).fit();
}
function bt(e, t, n) {
  return (
    !n.openStart &&
...
var xt = class {
  ...
  fit() {
    ...
    let s = new l(i, a, o);
    return e > -1
      ? new B(n.pos, e, this.$to.pos, this.$to.end(), s, t)
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          i = null;
        n
          ? ((i = St(this.unplaced.content, n - 1).firstChild), (e = i.content))
          : (e = this.unplaced.content);
        let a = e.firstChild;
        for (let e = this.depth; e >= 0; e--) {
          let { type: o, match: s } = this.frontier[e],
            c,
            l = null;
          if (
            t == 1 &&
            (a
              ? s.matchType(a.type) || (l = s.fillBefore(r.from(a), !1))
              : i && o.compatibleContent(i.type))
          )
            return { sliceDepth: n, frontierDepth: e, parent: i, inject: l };
          if (t == 2 && a && (c = s.findWrapping(a.type)))
            return { sliceDepth: n, frontierDepth: e, parent: i, wrap: c };
  ...
  openMore() {
    ...
    return !r.childCount || r.firstChild.isLeaf
      ? !1
      : ((this.unplaced = new l(e, t + 1, Math.max(n, r.size + t >= e.size - n ? t + 1 : 0))), !0);
  }
  dropNode() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced,
      r = St(e, t);
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new l(H(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new l(H(e, t, 1), t, n);
  }
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: i, wrap: a }) {
    ...
    let o = this.unplaced,
      ...
      u = 0,
      d = [],
      { match: f, type: p } = this.frontier[t];
    if (i) {
    ...
    for (; u < s.childCount; ) {
      let e = s.child(u),
        t = f.matchType(e.type);
      if (!t) break;
      (u++,
        (u > 1 || c == 0 || e.content.size) &&
          ((f = t),
          d.push(Ct(e.mark(p.allowedMarks(e.marks)), u == 1 ? c : 0, u == s.childCount ? m : -1))));
    }
    let h = u == s.childCount;
    (h || (m = -1),
      (this.placed = U(this.placed, t, r.from(d))),
    ...
    this.unplaced = h
      ? e == 0
        ? l.empty
        : new l(H(o.content, e - 1, 1), e - 1, m < 0 ? o.openEnd : e - 1)
      : new l(H(o.content, e, u), o.openStart, o.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !wt(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((i.match = i.match.matchType(e)),
      (this.placed = U(this.placed, this.depth, r.from(e.create(t, n)))),
...
function H(e, t, n) {
  return t == 0
    ...
    : e.replaceChild(0, e.firstChild.copy(H(e.firstChild.content, t - 1, n)));
}
function U(e, t, n) {
  return t == 0
    ? e.append(n)
    : e.replaceChild(e.childCount - 1, e.lastChild.copy(U(e.lastChild.content, t - 1, n)));
}
function St(e, t) {
...
function Ct(e, t, n) {
  ...
  let i = e.content;
  return (
    t > 1 && (i = i.replaceChild(0, Ct(i.firstChild, t - 1, i.childCount == 1 ? n - 1 : 0))),
    t > 0 &&
      ((i = e.type.contentMatch.fillBefore(i).append(i)),
      n <= 0 && (i = i.append(e.type.contentMatch.matchFragment(i).fillBefore(r.empty, !0)))),
    e.copy(i)
  );
}
function wt(e, t, n, r, i) {
  ...
  return s && !Tt(n, a.content, o) ? s : null;
}
function Tt(e, t, n) {
...
function Dt(e, t, n, r) {
  ...
  let i = e.doc.resolve(t),
    a = e.doc.resolve(n);
  if (bt(i, a, r)) return e.step(new z(t, n, r));
  let o = jt(i, a);
  ...
  for (let t = r.openStart; t >= 0; t--) {
    let s = (t + d + 1) % (r.openStart + 1),
      f = u[s];
    if (f)
      for (let t = 0; t < o.length; t++) {
        let u = o[(t + c) % o.length],
          d = !0;
        u < 0 && ((d = !1), (u = -u));
        let p = i.node(u - 1),
          m = i.index(u - 1);
        if (p.canReplaceWith(m, m, f.type, f.marks))
          return e.replace(
            i.before(u),
            d ? a.after(u) : n,
            new l(Ot(r.content, 0, r.openStart, s), s, r.openEnd),
          );
      }
  }
...
function Ot(e, t, n, i, a) {
  if (t < n) {
    let r = e.firstChild;
    e = e.replaceChild(0, r.copy(Ot(r.content, t + 1, n, i, r)));
  }
  if (t > i) {
    let t = a.contentMatchAt(0),
...
function At(e, t, n) {
  ...
  for (let t = 0; t < a.length; t++) {
    ...
    if (n > 0 && (o || r.node(n - 1).canReplace(r.index(n - 1), i.indexAfter(n - 1))))
...
var Mt = class e extends M {
  ...
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return N.fail(`No node at attribute step's position`);
    let n = Object.create(null);
    for (let e in t.attrs) n[e] = t.attrs[e];
    n[this.attr] = this.value;
    let i = t.type.create(n, null, t.marks);
    return N.fromReplace(e, this.pos, this.pos + 1, new l(r.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return A.empty;
  }
...
var Pt = class {
    ...
    setNodeAttribute(e, t, n) {
      return (this.step(new Mt(e, t, n)), this);
    }
    setDocAttribute(e, t) {
      return (this.step(new Nt(e, t)), this);
    }
    addNodeMark(e, t) {
      return (this.step(new L(e, t)), this);
    }
    removeNodeMark(e, t) {
      let n = this.doc.nodeAt(e);
      if (!n) throw RangeError(`No node at position ` + e);
      if (t instanceof s) t.isInSet(n.marks) && this.step(new R(e, t));
      else {
        let r = n.marks,
          i,
          a = [];
        for (; (i = t.isInSet(r)); ) (a.push(new R(e, i)), (r = i.removeFromSet(r)));
  ...
  G = class {
    constructor(e, t, n) {
      ((this.$anchor = e), (this.$head = t), (this.ranges = n || [new It(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replace(e, t = l.empty) {
      ...
      for (let o = 0; o < a.length; o++) {
        let { $from: s, $to: c } = a[o],
          u = e.mapping.slice(i);
        (e.replaceRange(u.map(s.pos), u.map(c.pos), o ? l.empty : t),
          o == 0 && Ht(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, t) {
      ...
      for (let i = 0; i < r.length; i++) {
        let { $from: a, $to: o } = r[i],
          ...
          c = s.map(a.pos),
          l = s.map(o.pos);
        i ? e.deleteRange(c, l) : (e.replaceRangeWith(c, l, t), Ht(e, n, t.isInline ? -1 : 1));
      }
    }
    static findFrom(e, t, n = !1) {
      let r = e.parent.inlineContent ? new K(e) : Y(e.node(0), e.parent, e.pos, e.index(), t, n);
      if (r) return r;
      for (let r = e.depth - 1; r >= 0; r--) {
        let i =
          t < 0
            ? Y(e.node(0), e.node(r), e.before(r + 1), e.index(r), t, n)
            : Y(e.node(0), e.node(r), e.after(r + 1), e.index(r) + 1, t, n);
        if (i) return i;
      }
      return null;
    }
    ...
    static atStart(e) {
      return Y(e, e, 0, 0, 1) || new J(e);
    }
    static atEnd(e) {
      return Y(e, e, e.content.size, e.childCount, -1) || new J(e);
    }
    static fromJSON(e, t) {
    ...
    static jsonID(e, t) {
      if (e in Ft) throw RangeError(`Duplicate use of selection JSON ID ` + e);
...
var K = class e extends G {
  ...
  static between(t, n, r) {
    ...
    if (((!r || i) && (r = i >= 0 ? 1 : -1), !n.parent.inlineContent)) {
      let e = G.findFrom(n, r, !0) || G.findFrom(n, -r, !0);
      if (e) n = e.$head;
      else return G.near(n, r);
    }
    return (
      t.parent.inlineContent ||
        (i == 0
          ? (t = n)
          : ((t = (G.findFrom(t, -r, !0) || G.findFrom(t, r, !0)).$anchor),
            t.pos < n.pos != i < 0 && (t = n))),
      new e(t, n)
    );
  }
...
((q.prototype.visible = !1), G.jsonID(`node`, q));
var Bt = class e {
    constructor(e) {
      this.anchor = e;
    }
    map(t) {
      ...
      return n ? new zt(r, r) : new e(r);
    }
    resolve(e) {
      let t = e.resolve(this.anchor),
        n = t.nodeAfter;
      return n && q.isSelectable(n) ? new q(t) : G.near(t);
    }
  },
  J = class e extends G {
    constructor(e) {
...
function Y(e, t, n, r, i, a = !1) {
  ...
  for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < t.childCount : o >= 0; o += i) {
    let r = t.child(o);
    if (!r.isAtom) {
      let t = Y(e, r, n + i, i < 0 ? r.childCount : 0, i, a);
      if (t) return t;
    } else if (!a && q.isSelectable(r)) return q.create(e, n - (i < 0 ? r.nodeSize : 0));
    n += r.nodeSize * i;
  }
  return null;
}
function Ht(e, t, n) {
  ...
  if (r < t) return;
  let i = e.steps[r];
  if (!(i instanceof z || i instanceof B)) return;
  ...
  Gt = class extends Pt {
    ...
    setSelection(e) {
      ...
      return (
        (this.curSelection = e),
        (this.curSelectionFor = this.steps.length),
        (this.updated = (this.updated | Ut) & ~X),
    ...
    ensureMarks(e) {
      return (
        s.sameSet(this.storedMarks || this.selection.$from.marks(), e) || this.setStoredMarks(e),
        this
      );
    }
    addStoredMark(e) {
    ...
    addStep(e, t) {
      (super.addStep(e, t), (this.updated &= ~X), (this.storedMarks = null));
    }
    setTime(e) {
    ...
    replaceSelectionWith(e, t = !0) {
      ...
      return (
        t &&
          (e = e.mark(
            this.storedMarks || (n.empty ? n.$from.marks() : n.$from.marksAcross(n.$to) || s.none),
          )),
  ...
  Q = class {
    constructor(e, t) {
      ((this.schema = e),
        ...
        (this.fields = qt.slice()),
        t &&
          t.forEach((e) => {
            if (this.pluginsByKey[e.key])
              throw RangeError(`Adding different instances of a keyed plugin (` + e.key + `)`);
            (this.plugins.push(e),
              (this.pluginsByKey[e.key] = e),
              e.spec.state && this.fields.push(new Z(e.key, e.spec.state, e)));
          }));
    }
  },
  Jt = class e {
            ...
            if (l && n.filterTransaction(l, a)) {
              if ((l.setMeta(`appendedTransaction`, e), !r)) {
                ...
                for (let e = 0; e < this.config.plugins.length; e++)
                  r.push(e < a ? { state: n, n: t.length } : { state: this, n: 0 });
              }
    ...
    static create(t) {
      let n = new Q(t.doc ? t.doc.type.schema : t.schema, t.plugins),
        r = new e(n);
      for (let e = 0; e < n.fields.length; e++) r[n.fields[e].name] = n.fields[e].init(t, r);
      return r;
    }
    reconfigure(t) {
      let n = new Q(this.schema, t.plugins),
        r = n.fields,
        i = new e(n);
      for (let e = 0; e < r.length; e++) {
        let n = r[e].name;
    ...
    static fromJSON(t, n, r) {
      ...
      let i = new Q(t.schema, t.plugins),
        a = new e(i);
      return (
        i.fields.forEach((e) => {
          if (e.name == `doc`) a.doc = b.fromJSON(t.schema, n.doc);
          else if (e.name == `selection`) a.selection = G.fromJSON(a.doc, n.selection);
...
function Yt(e, t, n) {
  for (let r in e) {
    let i = e[r];
    (i instanceof Function ? (i = i.bind(t)) : r == `handleDOMEvents` && (i = Yt(i, t, {})),
      (n[r] = i));
  }
  return n;
}
...
//# sourceMappingURL=dist-IXqUkPON.js.map

...
var b = [`custom-avatars`],
  ...
  C = `` + new URL(`codex-spritesheet-v4-Bl6P89d_.webp`, import.meta.url).href,
...
function W(e) {
  ...
  (t[2] !== l || t[3] !== s
    ...
    R(f));
  let m;
  t[5] === r ? (m = t[6]) : ((m = i(`codex-avatar-root`, r)), (t[5] = r), (t[6] = m));
  let h = `url(${a ?? U[d]})`,
    _;
...
//# sourceMappingURL=codex-avatar-9OkGRaoz.js.map

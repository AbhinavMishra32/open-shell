...
import { r as o } from "./reduced-motion-preference-BEImGcUg.js";
function s() {
  return i(o);
}
e(t());
...
function d(e) {
  ...
  t[2] === d
    ? (m = t[3])
    : ((m = { animationDelay: o, animationDuration: d }), (t[2] = d), (t[3] = m));
  let h;
  t[4] === n ? (h = t[5]) : ((h = (0, c.jsx)(l, { className: n })), (t[4] = n), (t[5] = h));
  let g;
  return (
    t[6] !== p || t[7] !== m || t[8] !== h
...
//# sourceMappingURL=spinner-Dvc_A3Ae.js.map

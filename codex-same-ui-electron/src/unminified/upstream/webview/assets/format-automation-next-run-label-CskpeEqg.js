...
var r = n(),
  ...
  a = 7;
function o({ intl: e, nextRunAt: t, status: n }) {
  return n === `PAUSED`
    ? `-`
    : t == null
      ? e.formatMessage({
      ...
      : s({ intl: e, timestamp: t });
}
function s({ intl: e, timestamp: t }) {
  let n = new Date(t),
    r = c(n, new Date()),
...
//# sourceMappingURL=format-automation-next-run-label-CskpeEqg.js.map

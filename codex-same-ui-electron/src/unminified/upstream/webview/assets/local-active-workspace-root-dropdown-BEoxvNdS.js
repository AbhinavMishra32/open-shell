...
function I(e) {
  ...
  t[0] !== N || t[1] !== z
    ? ((Fe = () => {
        if ((f(N, { eventName: `codex_app_workspace_root_add_clicked` }), z)) {
          w(N);
          return;
        }
        C();
  ...
  t[6] === N
    ? (Ie = t[7])
    : ((Ie = () => {
        (f(N, { eventName: `codex_app_workspace_root_add_clicked` }), T({ setActive: !0 }));
      }),
      (t[6] = N),
      (t[7] = Ie));
  let Le = Ie,
          ...
          children: (0, F.jsxs)(_, {
            ...
            children: [
              G
                ...
                : (0, F.jsx)(fe, {
                    isCodexWorktree: !!K?.isCodexWorktree,

const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./highlight-code-MHgnRkHh.js", "./chunk-Bj-mKKzh.js", "./core-D2Ov6Hqu.js"]),
) => i.map((i) => d[i]);
...
import { t as u } from "./copy-to-clipboard-q_KxH8lM.js";
import { t as d } from "./data-url-from-svg-DFCy07cd.js";
import { t as f } from "./copy-button-5izllJyD.js";
var p =
  Number.isNaN ||
  function (e) {
...
var b = (e) => {
    ...
    if (!a) return null;
    let o;
    t[5] === a ? (o = t[6]) : ((o = d(a)), (t[5] = a), (t[6] = o));
    let s;
    return (
      t[7] !== n || t[8] !== o
        ? ((s = (0, v.jsx)(`img`, { src: o, ...n })), (t[7] = n), (t[8] = o), (t[9] = s))
        : (s = t[9]),
      s
    );
  },
  ...
  w = g(() =>
    t(() => import(`./highlight-code-MHgnRkHh.js`), __vite__mapDeps([0, 1, 2]), import.meta.url),
  ),
  T = `
`,
  E = 120,
...
function D(e) {
  ...
  (t[8] !== a || t[9] !== i
    ? ((V = () => {
        let e = B.current;
        if (((e.latestContent = a), (e.latestLanguage = i), e.timeoutHandle != null)) return;
              ...
              w().then((r) => {
                if (!(e.disposed || r == null))
                  try {
                    ...
                    let t = e;
                    if (!(t instanceof Error && /Unknown language/i.test(t.message))) throw t;
                  }
              }));
          };
        if (r === 0) {
  ...
  (t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = () => {
        ...
        return (
          ...
          () => {
            ((e.disposed = !0),
              e.timeoutHandle != null && (clearTimeout(e.timeoutHandle), (e.timeoutHandle = null)));
          }
        );
      }),
      (U = []),
  ...
  let K = G,
    q;
  t[17] !== a || t[18] !== R
    ? ((q = R != null && a.startsWith(R.code) ? R : null), (t[17] = a), (t[18] = R), (t[19] = q))
    : (q = t[19]);
  let J = q,
    Y;
  if (t[20] !== a || t[21] !== J || t[22] !== K) {
    let e =
        J == null
          ? null
          : J.html.split(`
`),
      n;
    t[24] !== a || t[25] !== J
      ? ((n = J == null ? a : a.slice(J.code.length)), (t[24] = a), (t[25] = J), (t[26] = n))
      : (n = t[26]);
    let r = n;
    ((Y = K
      ? (0, v.jsx)(b, { svgString: a, className: `max-h-96 w-full` })
      : e == null
        ...
        : (0, v.jsxs)(`span`, {
            children: [
              e.map((t, n) =>
                (0, v.jsxs)(
                  x.Fragment,
                  { children: [(0, v.jsx)(ee, { html: t }), n < e.length - 1 ? T : null] },
                  n,
                ),
              ),
            ...
            D == null
              ...
              : (0, v.jsx)(c, {
                  ...
                  children: (0, v.jsx)(l, {
                    ...
                    color: `ghost`,
                    size: `icon`,
                    className: O ? `hover:text-token-foreground` : void 0,
                    onClick: D,
...
function ne(e) {
  ...
  t[3] !== p || t[4] !== g || t[5] !== a || t[6] !== r
    ? ((C =
        ...
        (0, v.jsxs)(O, {
          removeTopBorderRadius: p,
          children: [
            (0, v.jsx)(`div`, { className: `min-w-0 flex-1 truncate`, children: r }),
            (0, v.jsx)(`div`, { className: `ml-auto flex shrink-0 items-center`, children: a }),
          ],
        })),
      (t[3] = p),
      (t[4] = g),
  ...
  t[8] !== n || t[9] !== u || t[10] !== f || t[11] !== h
    ? ((w = (0, v.jsx)(A, { shouldWrap: h, className: u, onCopy: f, children: n })),
      (t[8] = n),
      (t[9] = u),
      (t[10] = f),
      (t[11] = h),
  ...
  t[13] !== l || t[14] !== d || t[15] !== w
    ? ((T = (0, v.jsx)(k, { ref: d, className: l, children: w })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = w),
      (t[16] = T))
  ...
  return (
    t[17] !== x || t[18] !== S || t[19] !== C || t[20] !== T
      ? ((E = (0, v.jsxs)(`div`, { className: x, "data-theme": S, children: [C, T] })),
        (t[17] = x),
        (t[18] = S),
        (t[19] = C),
        (t[20] = T),
...
function O(e) {
  ...
  return (
    t[7] !== r || t[8] !== s
      ? ((c = (0, v.jsx)(`div`, { className: s, ...r })), (t[7] = r), (t[8] = s), (t[9] = c))
      : (c = t[9]),
    c
  );
}
var k = function (e) {
  ...
  return (
    t[2] !== n || t[3] !== a || t[4] !== o
      ? ((s = (0, v.jsx)(`div`, { ref: a, className: o, dir: `ltr`, children: n })),
        (t[2] = n),
        (t[3] = a),
        (t[4] = o),
        (t[5] = s))
...
function A(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (a = t[3]))
    : (({ className: n, shouldWrap: a, ...r } = e), (t[0] = e), (t[1] = n), (t[2] = r), (t[3] = a));
  let o = a ? `whitespace-pre-wrap!` : `whitespace-pre!`,
    s;
  t[4] !== n || t[5] !== o ? ((s = i(o, n)), (t[4] = n), (t[5] = o), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== r || t[8] !== s
      ? ((c = (0, v.jsx)(`code`, { className: s, ...r })), (t[7] = r), (t[8] = s), (t[9] = c))
      : (c = t[9]),
    c
  );
}
...
export { C as n, S as r, D as t };
//# sourceMappingURL=code-snippet-BL80sM4U.js.map

...
import { c as a, o, r as s } from "./lib-MoKmYgcO.js";
import { o as c } from "./chunk-LFPYN7LY-DwFbyqR1.js";
import { n as l } from "./rpc-y95ESgjb.js";
import "./window-zoom-context-CSPQZGcc.js";
import { t as u } from "./tooltip-BhXPONlb.js";
import { t as d } from "./button-Xd4Hy1MO.js";
import "./setting-storage-Cel8Tr7E.js";
import "./reduced-motion-preference-BEImGcUg.js";
import "./spinner-Dvc_A3Ae.js";
import { t as f } from "./x-DypUcSQe.js";
import "./electron-menu-shortcuts-CGQ9azZA.js";
import "./command-keybindings-D3tvaSVG.js";
import { t as p } from "./use-window-controls-safe-area-X2AodDul.js";
import { t as m } from "./compose-CUJaEiS-.js";
import "./use-hotkey-Bv35cwCo.js";
import { t as h } from "./use-command-hotkey-Bb4sCa2j.js";
import { t as g } from "./pop-in-mac--qmmjqY1.js";
import { t as _ } from "./use-hotkey-window-detail-layout-B2rCbEeC.js";
import { t as v } from "./use-hotkey-window-dismiss-on-escape-nrALO3J_.js";
var y = e(t(), 1),
  b = i(),
  x = n(),
  S = s({
...
function C(e) {
  ...
  t[3] !== E || t[4] !== n
    ...
    : (D = t[5]);
  let O;
  t[6] !== h || t[7] !== y || t[8] !== r || t[9] !== l
    ? ((O = l
        ? (0, x.jsx)(`div`, {
            className: `absolute flex items-center gap-0`,
            style: { left: y },
            children: (0, x.jsx)(u, {
              tooltipContent: (0, x.jsx)(o, { ...S.dismiss }),
              delayOpen: !0,
              children: (0, x.jsx)(d, {
                size: `toolbar`,
                color: `ghost`,
...
function w(e) {
  let t = (0, b.c)(18),
    { title: n, mainWindowPath: i, canCollapseToHome: s } = e,
    c = s === void 0 ? !0 : s,
    l = a(),
    f;
  t[0] !== c || t[1] !== l
    ? ((f = c
        ? (0, x.jsx)(u, {
            tooltipContent: (0, x.jsx)(o, { ...S.newThread }),
            delayOpen: !0,
            children: (0, x.jsx)(d, {
              size: `toolbar`,
              color: `ghost`,
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, x.jsx)(o, { ...S.openInMainWindow })), (t[3] = p))
    : (p = t[3]);
  let h;
  t[4] === l ? (h = t[5]) : ((h = l.formatMessage(S.openInMainWindow)), (t[4] = l), (t[5] = h));
  let _;
  t[6] === i
    ? (_ = t[7])
    : ((_ = () => {
        r.dispatchMessage(`open-in-main-window`, { path: i });
      }),
      (t[6] = i),
      (t[7] = _));
  let v;
  ...
  let w;
  t[12] !== f || t[13] !== y
    ? ((w = (0, x.jsxs)(x.Fragment, { children: [f, y] })), (t[12] = f), (t[13] = y), (t[14] = w))
    : (w = t[14]);
  let D;
  return (
    t[15] !== w || t[16] !== n
...
function D() {
  ...
  (e[0] === r
    ? (i = e[1])
    : ((i = { commandId: `newThread`, enabled: r, onKeyDown: O }), (e[0] = r), (e[1] = i)),
    h(i));
  let a;
  e[2] === t
    ? (a = e[3])
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, x.jsx)(`div`, { className: `min-h-0 flex-1`, children: (0, x.jsx)(c, {}) })),
      (e[4] = o))
    : (o = e[4]);
  let s;
  return (
...
function O(e) {
  (e.preventDefault(), e.stopPropagation(), l.hotkeyWindowHotkeys?.collapseToHome());
}
export { D as HotkeyWindowDetailLayout };
//# sourceMappingURL=hotkey-window-detail-layout-DoFzcFI5.js.map

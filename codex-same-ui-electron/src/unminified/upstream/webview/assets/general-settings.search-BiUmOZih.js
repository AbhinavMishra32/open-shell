import { r as e } from "./lib-MoKmYgcO.js";
var t = e({
    workMode: {
  ...
  n = {
    workMode: `settings-search-work-mode`,
    permissions: `settings-search-permissions`,
    defaultOpenDestination: `settings-search-default-open-destination`,
    followUpBehavior: `settings-search-follow-up-behavior`,
    codeReview: `settings-search-code-review`,
    openSourceLicenses: `settings-search-open-source-licenses`,
    notifications: `settings-search-notifications`,
    theme: `settings-search-theme`,
    pointerCursors: `settings-search-pointer-cursors`,
    bottomPanel: `settings-search-bottom-panel`,
    diffMarkers: `settings-search-diff-markers`,
    reduceMotion: `settings-search-reduce-motion`,
    uiFontSize: `settings-search-ui-font-size`,
    codeFontSize: `settings-search-code-font-size`,
  },
  r = [
    {
      label: t.workMode,
      ...
      targetId: n.workMode,
      terms: [t.forCoding, t.forEverydayWork],
    },
    {
      label: t.permissions,
      sectionSlug: `general-settings`,
      targetId: n.permissions,
      terms: [t.defaultPermissions, t.fullAccess],
    },
    {
      label: t.defaultOpenDestination,
      sectionSlug: `general-settings`,
      targetId: n.defaultOpenDestination,
    },
    { label: t.bottomPanel, sectionSlug: `general-settings`, targetId: n.bottomPanel },
    {
      label: t.followUpBehavior,
      sectionSlug: `general-settings`,
      targetId: n.followUpBehavior,
      terms: [t.queue, t.steer],
    },
    {
      label: t.codeReview,
      sectionSlug: `general-settings`,
      targetId: n.codeReview,
      terms: [t.inline, t.detached],
    },
    {
      label: t.openSourceLicenses,
      sectionSlug: `general-settings`,
      targetId: n.openSourceLicenses,
    },
    {
      ...
      terms: [
        t.turnCompletionNotifications,
        t.permissionNotifications,
        t.questionNotifications,
        t.never,
        t.onlyWhenUnfocused,
        t.always,
      ],
    },
    {
      ...
      targetId: n.theme,
      terms: [t.light, t.dark, t.themeSystem],
    },
    { label: t.pointerCursors, sectionSlug: `appearance`, targetId: n.pointerCursors },
    {
      label: t.diffMarkers,
      sectionSlug: `appearance`,
      targetId: n.diffMarkers,
      terms: [t.color, t.plusMinus],
    },
    {
      label: t.reduceMotion,
      sectionSlug: `appearance`,
      targetId: n.reduceMotion,
      terms: [t.reducedMotionSystem, t.on, t.off],
    },
    { label: t.uiFontSize, sectionSlug: `appearance`, targetId: n.uiFontSize },
  ],
  i = { label: t.codeFontSize, sectionSlug: `appearance`, targetId: n.codeFontSize };
export { t as i, r as n, n as r, i as t };
//# sourceMappingURL=general-settings.search-BiUmOZih.js.map
